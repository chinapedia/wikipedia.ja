...
[SaoriFKiss002.png](https://ja.wikipedia.org/wiki/File:SaoriFKiss002.png "fig:SaoriFKiss002.png") 多数の機能がKISSに追加されてきたが、メインKISS[形式へ公式に組み込まれたものは](../Page/ファイルフォーマット.md "wikilink")1つもない。[互換性](../Page/互換性.md "wikilink")を維持するためと未サポートのビューアから隠すために、これらの機能は設定ファイル内で[コメントに見せかけられてきた](../Page/コメント_\(コンピュータ\).md "wikilink")。各種の拡張は (ユーザーグルーピングを除き) まず日本で導入されたが、 (Cherry Kissを除き) すべて後に国際ビューアで拡張された。
