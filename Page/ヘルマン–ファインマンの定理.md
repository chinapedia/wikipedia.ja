...
**ヘルマン–ファインマンの定理**（ヘルマン–ファインマンのていり、）とは、[量子力学](https://ja.wikipedia.org/wiki/量子力学 "wikilink")において、パラメータ依存した[ハミルトニアン](../Page/ハミルトニアン.md "wikilink")とその[エネルギー固有値](https://ja.wikipedia.org/wiki/エネルギー固有値 "wikilink")に関する定理である。[量子化学](../Page/量子化学.md "wikilink")および数理[固体物理学](https://ja.wikipedia.org/wiki/固体物理学 "wikilink")において特に**ヘルマン–ファインマン力**（ヘルマン–ファインマンりょく、）の計算に応用され、重要である。定理の名は、ドイツの物理学者と米国の物理学者[R. P. ファインマンに因む](https://ja.wikipedia.org/wiki/リチャード・P・ファインマン "wikilink")。定理を最初に明示的な形で表したのは、P. Güttingerであるが\[1\]、[W. パウリやヘルマンの論文にも記されている](https://ja.wikipedia.org/wiki/ヴォルフガング・パウリ "wikilink")\[2\]\[3\]。特にヘルマンは分子への適用に向けて、[変分](https://ja.wikipedia.org/wiki/変分 "wikilink")形式で表現した。また、1939年に当時、[マサチューセッツ工科大学](../Page/マサチューセッツ工科大学.md "wikilink")の学生であったファインマンは、この定理を示すともに、[化学結合](../Page/化学結合.md "wikilink")した原子において、[電子](https://ja.wikipedia.org/wiki/電子 "wikilink")及び他の[原子核](../Page/原子核.md "wikilink")が原子核に及ぼす力は古典的な[静電力](https://ja.wikipedia.org/wiki/静電力 "wikilink")として、扱えることを示した\[4\]。「ヘルマン–ファインマンの定理」の名が定着したのは、[J. C. スレイターがその著書の中でその名で呼んだことによる](https://ja.wikipedia.org/wiki/ジョン・クラーク・スレイター "wikilink")\[5\]\[6\]。

## 定理

系のハミルトニアンが、あるパラメータ  に依存するとして、それを  と表現する。  の[固有状態](https://ja.wikipedia.org/wiki/固有状態 "wikilink")  があって、 *E*(*λ*)}} 及び[規格化](https://ja.wikipedia.org/wiki/規格化 "wikilink")条件 1}} が満足されるとする。このとき、
...
電子及び位置が固定された原子核からなる系において、ポテンシャル  を原子核の位置座標で微分したものは、原子核に働く力に相当する。例えば、電子の位置を  (*x<sub>i</sub>*, *y<sub>i</sub>*, *z<sub>i</sub>*) (*i* {{=}}1, …,*n*)}} とし、原子核の位置を (*X<sub>α</sub>*, *Y<sub>α</sub>*, *Z<sub>α</sub>*) (*α* {{=}}1,…,*m*)}} とする。このとき、系のハミルトニアン  は[ボルン–オッペンハイマー近似](https://ja.wikipedia.org/wiki/ボルン–オッペンハイマー近似 "wikilink")により、[運動エネルギー](../Page/運動エネルギー.md "wikilink")
...
と書き表すことができる。第1項は電子の電荷密度と電子による[電場](https://ja.wikipedia.org/wiki/電場 "wikilink")の積であり、第2項は電荷  を持つほかの原子核による電場の効果である。この結果を**静電定理** () と呼ぶ。
