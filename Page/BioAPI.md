...
**BioAPI**（**Biometric Application Programming Interface**、バイオエーピーアイまたはバイオアピー） は、[生体認証](../Page/生体認証.md "wikilink")([バイオメトリクス](https://ja.wikipedia.org/wiki/バイオメトリクス "wikilink")認証)に関連する[アプリケーションのプログラミングインタフェース仕様の](../Page/アプリケーションプログラミングインタフェース.md "wikilink")[国際標準規格](https://ja.wikipedia.org/wiki/国際標準規格 "wikilink")。
