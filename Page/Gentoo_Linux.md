...
Gentoo は元々 [x86](https://ja.wikipedia.org/wiki/x86 "wikilink") 環境用に設計されたが、[Linux](../Page/Linux.md "wikilink")、[GCC](../Page/GNUコンパイラコレクション.md "wikilink")、[glibc](https://ja.wikipedia.org/wiki/glibc "wikilink") や [Portage](../Page/Portage.md "wikilink") の高移植性により、多くの他の[環境へ移植された](../Page/コンピュータ・アーキテクチャ.md "wikilink")。
...
[GentooFamilyTree1210.svg](https://ja.wikipedia.org/wiki/File:GentooFamilyTree1210.svg "fig:GentooFamilyTree1210.svg") ※[Gentoo Linux派生版一覧に掲載されるもの](https://ja.wikipedia.org/wiki/:en:List_of_Linux_distributions#Gentoo-based "wikilink")。
...
<td><p>Chrome OS[14][15]は、Googleが開発しているOS。2010年2月に、母体となるOSを<a href="https://ja.wikipedia.org/wiki/ubuntu" title="wikilink">ubuntu</a>からGentooに変更した。<a href="https://ja.wikipedia.org/wiki/Chromium_OS" title="wikilink">Chromium OSは</a>、Google Chrome OSの<a href="../Page/オープンソース.md" title="wikilink">オープンソース</a>版。</p></td>
</tr>
<tr class="even">
...
<td><p>Gentoo Linuxの派生GNU/Linux。Gentooの特徴である<a href="https://ja.wikipedia.org/wiki/機能拡張" title="wikilink">機能拡張</a>はなりを潜めているが、様々な<a href="https://ja.wikipedia.org/wiki/アプリケーション" title="wikilink">アプリケーション</a>が同梱されているLive DVD。</p></td>
</tr>
<tr class="even">
<td></td>
<td><p>WindowsとLinux修理用のツールをまとめた <a href="../Page/Linuxカーネル.md" title="wikilink">Linux 2.6 カーネル</a>（核）母体の<a href="../Page/Live_CD.md" title="wikilink">Live CD</a>。</p></td>
</tr>
</tbody>
</table>
...
[Category:Gentoo_Linux](https://ja.wikipedia.org/wiki/Category:Gentoo_Linux "wikilink") [Category:Gentoo_Linux派生ディストリビューション](https://ja.wikipedia.org/wiki/Category:Gentoo_Linux派生ディストリビューション "wikilink") [Category:オープンソースソフトウェア](https://ja.wikipedia.org/wiki/Category:オープンソースソフトウェア "wikilink") [Category:2002年のソフトウェア](https://ja.wikipedia.org/wiki/Category:2002年のソフトウェア "wikilink")
