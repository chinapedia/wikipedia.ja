...
全ての製品を単一のドライバパッケージで提供するNVIDIA Unified Driver Architecture (UDA) が特長で、当初は[RIVA](https://ja.wikipedia.org/wiki/RIVA "wikilink")シリーズにも対応していたが、古い製品は次第にサポート外になった。

  - 各製品の最終バージョン

<!-- end list -->

  - GeForce 2・GeForce 3・GeForce 4の各シリーズ: 93.71 ([Windows 2000](https://ja.wikipedia.org/wiki/Windows_2000 "wikilink")/[Windows XP用](https://ja.wikipedia.org/wiki/Windows_XP "wikilink")、2006年)
  - GeForce 5 FXシリーズ: 175.19 (Windows XP用、2008年)、96.85 ([Windows Vista](https://ja.wikipedia.org/wiki/Windows_Vista "wikilink") 32bit用、2006年)
...
## 外部リンク
  ...
  - [NVIDIAダウンロード案内ページ](http://www.nvidia.co.jp/Download/index.aspx?lang=jp)
  - [NVIDIA日本語公式HP](http://jp.nvidia.com/page/home.html)
  - [NVIDIAダウンロード案内ページ（英語）](http://www.nvidia.com/content/drivers/drivers.asp)-日本語ページではドライバ更新が遅れることがある

[Category:システムソフトウェア](https://ja.wikipedia.org/wiki/Category:システムソフトウェア "wikilink") [Category:グラフィックカード](https://ja.wikipedia.org/wiki/Category:グラフィックカード "wikilink")