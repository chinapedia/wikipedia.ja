...
無料なサービスで、[アルファ](../Page/アルファ.md "wikilink")のステージである。

## ガイアゴールド

ガイアゴールドとはガイアオンラインの[通貨](../Page/通貨.md "wikilink")である。色々な風に稼ぎ取っている。

  - 新しいスレッドを作ること。
  - スレッドに返事を書くこと。
  - ポールで[投票](../Page/投票.md "wikilink")すること。
  - サイト内でクリックすること。
  - アートアリーナに絵を出すこと。
  - アートアリーナで[投票](../Page/投票.md "wikilink")する、又はコメントすること。
  - 友達をガイアオンラインに招待すること。
  - ミニショップとしてアートと自分のサービスを売ること。
  - 他のユーザーからのプレゼントをもらうこと。
...
## ガイアのNPC達 (ノンプレイヤーキャラクター)
  ...
  - The Von Helson Sisters (ヴォン・ヘルソン姉妹)
  - Ian (イアン)
  - Rufus (ルーファス)
  - Leon (リーオン)
  - Rina (リーナ)
  ...
  - Flynn (フリーン)
  - Mirai (ミライ)
  - The LabTechs (ラッブ・テック)
  - Grunny (グランニ)
  - LabTechX (ラッブ・テック・エックス)
  - Jack (ジャック)
  - The Easter Bunny
  - Louie
  - Diedrich
...
## 外部リンク
  ...
  - [ガイアオンライン](http://www.gaiaonline.com)

[Category:コミュニティサイト](https://ja.wikipedia.org/wiki/Category:コミュニティサイト "wikilink") [Category:娯楽のウェブサイト](https://ja.wikipedia.org/wiki/Category:娯楽のウェブサイト "wikilink") [Category:アメリカ合衆国のウェブサイト](https://ja.wikipedia.org/wiki/Category:アメリカ合衆国のウェブサイト "wikilink")