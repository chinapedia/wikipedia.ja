...
JDKには主要なコンポーネントとして以下のようなプログラミングツールが含まれる :
  ...
  - idlj – IDL-to-Javaコンパイラ。このユーティリティは指定されたJava IDLファイルからJava[バインディングを生成する](../Page/束縛_\(情報工学\).md "wikilink")。
...
開発中やメンテナンスモードの状態であるもの:
  ...
  - [オラクルの](../Page/オラクル_\(企業\).md "wikilink") JDK – Windows、Linux、Solaris用\[9\]
