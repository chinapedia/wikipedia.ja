...
[ローゼンバウムはこの現象をtough構文と命名した](https://ja.wikipedia.org/wiki/ピーター・スティーヴン・ローゼンバウム "wikilink")。この名は、先の(1)のような原型の例が tough という語を含むことに由来する。 先の２例において、this problem は論理的には solve の目的語であり、 Chris は please の目的語である。従って以下のように[パラフレーズ](../Page/パラフレーズ.md "wikilink")可能である。
...
また形容詞に限らず、 *a pleasure*, *a breeze*, *a cinch*などの名詞もこの構造を取る事が可能である。
...
## 参考文献
  ...
  - Rosenbaum, P. (1967). *[The grammar of English predicate complement constructions](https://dspace.mit.edu/bitstream/handle/1721.1/16391/03190468-MIT.pdf?sequence=2).* Cambridge, MA: MIT Press.

[Category:生成文法](https://ja.wikipedia.org/wiki/Category:生成文法 "wikilink") [Category:統語関係](https://ja.wikipedia.org/wiki/Category:統語関係 "wikilink")