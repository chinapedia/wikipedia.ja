...
**レジスタマシン**（[英](../Page/英語.md "wikilink"): **Register machine**）とは、[数理論理学](../Page/数理論理学.md "wikilink")や[理論計算機科学](https://ja.wikipedia.org/wiki/理論計算機科学 "wikilink")で使われる汎用[計算模型](https://ja.wikipedia.org/wiki/計算模型 "wikilink")の一種であり、[チューリングマシン](../Page/チューリングマシン.md "wikilink")と似たような使われ方をされる。レジスタマシンのモデルは全てチューリング等価である。

また、[スタックマシン](https://ja.wikipedia.org/wiki/スタックマシン "wikilink")の対として、オペランドがレジスタである機械を指してもレジスタマシンと言う。実機ではほとんどにあてはまるのでわざわざ言わないが、[仮想機械では](https://ja.wikipedia.org/wiki/仮想機械#プロセス仮想機械 "wikilink")、たとえば[Lua](../Page/Lua.md "wikilink") 5の仮想機械を指して使われる。
...
1.  **有限個数でかつ無限長のレジスタ**: 有限個（またはモデルによっては無限個）のレジスタ群  があり、個々のレジスタは無限長で1つの非負整数（0, 1, 2, ...）を格納する。レジスタ同士の算術ができるか、一部のレジスタが[アキュムレータとして算術に使われたり](https://ja.wikipedia.org/wiki/アキュムレータ_\(コンピュータ\) "wikilink")、アドレスレジスタとして使われたりする。
...
後者の名前を挙げた順序は、[ユーリ・マチャセビッチ](https://ja.wikipedia.org/wiki/ユーリ・マチャセビッチ "wikilink")がリストアップした順序である。彼は、次のように述べている。
...
[エミール・ポスト](https://ja.wikipedia.org/wiki/エミール・ポスト "wikilink")の1936年の論文の基づいた Wang の研究により、Wang はBマシンの定義に到達した。これは、2種類のシンボルと4種類の命令を持つ[ポスト-チューリング機械](https://ja.wikipedia.org/wiki/ポスト-チューリング機械 "wikilink")であった。命令は以下の通り。
...
1971年、[ユリス・ハルトマニス](https://ja.wikipedia.org/wiki/ユリス・ハルトマニス "wikilink")は、RASPモデルでの間接指定を単純化した。間接指定とは、ポインタレジスタを使って命令が実際に利用するレジスタを（番号またはアドレスで）指定することである。ポインタレジスタに制限がなければ、RAM や RASP はチューリング等価となる。間接指定されるレジスタは命令形式上の指定される位置によって、演算の入力にも出力先にもなる。
...
## 参考文献
  ...
  - Arthur Burks, Herman Goldstine, [John von Neumann](../Page/ジョン・フォン・ノイマン.md "wikilink") (1946), *Preliminary discussion of the logical design of an electronic computing instrument*, reprinted pp. 92ff in [Gordon Bell](https://ja.wikipedia.org/wiki/ゴードン・ベル "wikilink") and [Allen Newell](../Page/アレン・ニューウェル.md "wikilink") (1971), *Computer Structures: Readings and Examples*, mcGraw-Hill Book Company, New York. ISBN 0070043574 .
  ...
  - Calvin Elgot and [Abraham Robinson](https://ja.wikipedia.org/wiki/アブラハム・ロビンソン "wikilink") (1964), *Random-Access Stored-Program Machines, an Approach to Programming Languages*, Journal of the Association for Computing Machinery, Vol. 11, No. 4 (October, 1964), pp. 365-399.

  - [J. Hartmanis](https://ja.wikipedia.org/wiki/ユリス・ハルトマニス "wikilink") (1971), "Computational Complexity of Random Access Stored Program Machines," Mathematical Systems Theory 5, 3 (1971) pp. 232-245.

  - [John Hopcroft](https://ja.wikipedia.org/wiki/ジョン・ホップクロフト "wikilink"), Jeffrey Ullman (1979). *Introduction to Automata Theory, Languages and Computation*, 1st ed., Reading Mass: Addison-Wesley. ISBN 0-201-02988-X. A difficult book centered around the issues of machine-interpretation of "languages", NP-Completeness, etc.
...
1.  Harold Abelson and Gerald Jay Sussman with Julie Sussman, [Structure and Interpretation of Computer Programs](https://ja.wikipedia.org/wiki/計算機プログラムの構造と解釈 "wikilink"), MIT Press, [Cambridge, Massachusetts](https://ja.wikipedia.org/wiki/ケンブリッジ_\(マサチューセッツ州\) "wikilink"), 2nd Ed, 1996