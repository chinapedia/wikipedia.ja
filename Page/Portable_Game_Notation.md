...
### 駒の初期配置に関するタグ
  ...
  - FEN: 駒の初期配置を[FEN形式で記述する](https://ja.wikipedia.org/wiki/Forsyth-Edwards_Notation "wikilink")。対局の途中から記録が始まる場合、[フィッシャー・ランダム・チェスのように特殊な駒配置から始まる場合などに用いられる](../Page/チェス960.md "wikilink")。
