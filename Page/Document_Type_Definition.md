...
**Document Type Definition**（文書型定義、**DTD**）とは、[マークアップ言語](../Page/マークアップ言語.md "wikilink")の[SGMLおよび](../Page/Standard_Generalized_Markup_Language.md "wikilink")[XMLにおいて](../Page/Extensible_Markup_Language.md "wikilink")、文書構造（文書型）を定義するための[スキーマ言語](../Page/スキーマ言語.md "wikilink")の一つである。
...
この問題を解決するために、新たなスキーマ言語として[RELAX NGや](../Page/RELAX_NG.md "wikilink")[W3C](../Page/World_Wide_Web_Consortium.md "wikilink") [XML Schemaなどが開発され](https://ja.wikipedia.org/wiki/XML_Schema "wikilink")、それらを採用する事例が増えている。
