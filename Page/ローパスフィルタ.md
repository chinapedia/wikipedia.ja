...
[thumb](https://ja.wikipedia.org/wiki/ファイル:Active_lowpass_filter.svg "wikilink") [オペアンプ](../Page/オペアンプ.md "wikilink")を用いて、*アクティブ*ローパスフィルタを構成することが可能である。右図の回路は1次アクティブ・ローパスフィルタであり、[遮断周波数](https://ja.wikipedia.org/wiki/遮断周波数 "wikilink")（[Hz](https://ja.wikipedia.org/wiki/Hz "wikilink")）は、  = \\frac{1}{2 \\pi R_2 C}</math>}} となり、遮断角周波数（rad/s）は、  = \\frac{1}{R_2 C}</math>}} で表される。[通過域](https://ja.wikipedia.org/wiki/通過域 "wikilink")での利得は\(\frac{-R_2}{R_1}\)であり、[減衰域](https://ja.wikipedia.org/wiki/減衰域 "wikilink")での[減衰傾度](https://ja.wikipedia.org/wiki/減衰傾度 "wikilink")は1次の[フィルタ回路](../Page/フィルタ回路.md "wikilink")で−6dB/oct=-20dB/dec となる。
