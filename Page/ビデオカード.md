...
IBM PCはビデオサブシステム（ビデオチップなど）を本体（[マザーボード](../Page/マザーボード.md "wikilink")）にではなく、[拡張カード](../Page/拡張カード.md "wikilink")（[IBM](../Page/IBM.md "wikilink")はアダプターと呼ぶ）に搭載した。IBM PCの発売時には2種類のビデオカード（テキストモードのみの**[MDA](../Page/Monochrome_Display_Adapter.md "wikilink")**と、グラフィックモードを持つ**[CGA](../Page/Color_Graphics_Adapter.md "wikilink")**）が提供され、用途により選択・交換できた。
...
世界の中でも日本だけは、[PC-9801シリーズ](../Page/PC-9800シリーズ.md "wikilink")、[FMRシリーズ](../Page/FMRシリーズ.md "wikilink")、[マルチステーション5550](https://ja.wikipedia.org/wiki/マルチステーション5550 "wikilink")などや、更にはIBM PC互換機ベースであるダイナブック、[AX](../Page/AX.md "wikilink")([JEGA](../Page/Japanese_Enhanced_Graphics_Adapter.md "wikilink"))、[PS/55](https://ja.wikipedia.org/wiki/PS/55 "wikilink")（前半）でも、日本語表示モードでは**固定解像度**が主流の時代が続いた。
