...
高性能なGPUの利用を前提とする[Aeroを搭載した](../Page/Windows_Aero.md "wikilink")[Windows Vistaの登場以降](https://ja.wikipedia.org/wiki/Windows_Vista "wikilink")、チップセット内、およびCPUパッケージ内に統合されているGPUコアの性能が向上してきたため、[ローエンド](https://ja.wikipedia.org/wiki/ローエンド "wikilink")の物からGPU単体の製品は[3D](../Page/3D.md "wikilink")ゲームの快適なプレイや[CAD](../Page/CAD.md "wikilink")オペレーション・[3DCG](https://ja.wikipedia.org/wiki/3DCG "wikilink")制作におけるプレビュー用途を想定した、比較的高価で高性能なものへとシフトしている。
