...
[入力機器](https://ja.wikipedia.org/wiki/入力機器 "wikilink")もまだ[テンキー](https://ja.wikipedia.org/wiki/テンキー "wikilink")の様なボタンが付いているだけだった。これは0からFまでの[16進数](https://ja.wikipedia.org/wiki/16進数 "wikilink")を入力するボタンと、[アセンブリ言語](../Page/アセンブリ言語.md "wikilink")の[ニーモニック](https://ja.wikipedia.org/wiki/ニーモニック "wikilink")入力などに使用するキーが9個程度の、計25個程度しか無かった。また東芝のEXシリーズではテンキー程度のボタンさえもなく、単位スイッチ（ONかOFFかの二方向しかない）が8～12列並んでおり、これらを上下させて[2進数](https://ja.wikipedia.org/wiki/2進数 "wikilink")で入力する機種も存在した（これはホビー用マイコンとして初期のヒットした機種である[Altair 8800と同じだが](https://ja.wikipedia.org/wiki/Altair_8800 "wikilink")、Altair 8800自体はワンボードでなく、ケースに入っていた）。

出力機器としては、8桁程度の[7セグメント](https://ja.wikipedia.org/wiki/7セグメントディスプレイ "wikilink")[LEDを標準で備えているものが多かった](../Page/発光ダイオード.md "wikilink")。ワンボードマイコンでプログラミングを覚えても、目に見える変化は7セグメントLEDの数字が変わるものしか作れなかった。しかしこうした貧弱な表示でも楽しむ要素を作ろうと、例えば7セグメントLEDの"|"と"＿"と"￣" を使って「[プロペラ](https://ja.wikipedia.org/wiki/プロペラ "wikilink")」を表してみたり、7セグメントLEDを横倒しにして縦8段×横3列の[ブロックくずし](../Page/ブロックくずし.md "wikilink")を作るなど、涙ぐましい努力が見られた。また、汎用[I/Oポートを備えているものが多かったので](../Page/入出力ポート.md "wikilink")、外付け回路により、様々な制御を試みることが行われた。
...
黎明期の初端においては、日本は米国と同様にエンジニアや好事家が独自に部品を調達してワンボードマイコンなどを設計・制作し、あるいはもっぱら輸入された評価キットやワンボードマイコンなどが[秋葉原](https://ja.wikipedia.org/wiki/秋葉原 "wikilink")の電子デバイス店などの小売店で細々と売られる程度であった\[1\]。米国では1974年末に発売された[Altair 8800がヒットすると](https://ja.wikipedia.org/wiki/Altair_8800 "wikilink")、その互換機も複数登場して拡がりを見せていた。日本でもこれらの輸入品を取り扱う店舗がいくつか登場したが、高価であったため購入できた者は少数であった\[2\]。
...
日本では[1976年](https://ja.wikipedia.org/wiki/1976年 "wikilink")5月に[東芝](https://ja.wikipedia.org/wiki/東芝 "wikilink")より[TLCS-12A](https://ja.wikipedia.org/wiki/TLCS-12A "wikilink") EX-0\[6\]（定価99,000円）が発売された\[7\]。電源装置さえ別途用意すれば、12ビットのLED表示とディップスイッチを使って[テレタイプ端末](../Page/テレタイプ端末.md "wikilink")などの入出力機器を必要とせずに動作させることができる日本国産初のワンボードマイコンである。米国でも同時期に[モステクノロジー](https://ja.wikipedia.org/wiki/モステクノロジー "wikilink")からテレタイプが不要な[KIM-1](https://ja.wikipedia.org/wiki/KIM-1 "wikilink")が発売されて好評を博した\[8\]。

日本において後の「国産マイコン」に連なる最初の製品は、[1976年](https://ja.wikipedia.org/wiki/1976年 "wikilink")8月3日に[日本電気](../Page/日本電気.md "wikilink")(NEC)から発売された[TK-80](https://ja.wikipedia.org/wiki/TK-80 "wikilink")（定価88,500円）とされる。本機はTK(Training Kit)という名前からも分かるように、元来は[8080互換マイクロプロセッサの評価](../Page/Intel_8080.md "wikilink")・教育用ツールで、ボードに16進キーボードと[LED表示器がついただけのものだった](../Page/発光ダイオード.md "wikilink")。しかし同年9月13日\[9\]に[秋葉原ラジオ会館](https://ja.wikipedia.org/wiki/秋葉原ラジオ会館 "wikilink")に開設した[Bit-INN](https://ja.wikipedia.org/wiki/Bit-INN "wikilink")でサポートが行われるようになると、本来のターゲットである技術者を上回る勢いでアマチュアの好事家や学生に売れていることが明らかになった。同年10月にNECマイコンクラブを結成するなど積極的なユーザ支援体制もあって、企画当初の予想を超えたベストセラーになった\[10\]。TK-80の立ち上がりを受けて他社からもワンボードマイコンが相次いで発売された。サードパーティからはその周辺機器が開発され、ブルーバックスの『マイ・コンピュータ入門』以下3部作や、[月刊アスキー](https://ja.wikipedia.org/wiki/月刊アスキー "wikilink")や[月刊マイコン](https://ja.wikipedia.org/wiki/月刊マイコン "wikilink")などの専門誌も登場して、いわゆる「（第一次）マイコンブーム」を形成した\[11\]。

しかし1970年代後半（日本ではその数年後）、手間をかける事なく、すぐに動かせる、後に[パーソナルコンピュータ](../Page/パーソナルコンピュータ.md "wikilink")と呼ばれるようなマシンが生産されるようになった。海外では[Apple II以下陸続と](../Page/Apple_II.md "wikilink")（特にこの世代を指して「ホームコンピュータ」（[:en:Home computer](https://ja.wikipedia.org/wiki/:en:Home_computer "wikilink")）という分類もあるが日本では一般的でない）、日本のマシンではどれをもって最初とするかは議論があるが、決定付けたのは[PC-8001であろう](https://ja.wikipedia.org/wiki/PC-8000シリーズ "wikilink")\[12\]。ホビーの主力はそちらに移り（いわゆる「第二次マイコンブーム」。[ホビーパソコン](https://ja.wikipedia.org/wiki/ホビーパソコン "wikilink")の記事も参照）、またビジネス用には1980年代前半にあらわれた[Macintosh](../Page/Macintosh.md "wikilink")や[IBM PCといった高性能](https://ja.wikipedia.org/wiki/IBM_PC "wikilink")・高機能なランクのパーソナルコンピュータが使われるようになり、マイコンボードは評価用、トレーニング用、制御組み込み用といった元々の位置に戻ることとなった。その後、2000年代に入り、[Arduino](https://ja.wikipedia.org/wiki/Arduino "wikilink")や[Raspberry Pi](https://ja.wikipedia.org/wiki/Raspberry_Pi "wikilink")、[Intel Galileo](https://ja.wikipedia.org/wiki/Intel_Galileo "wikilink")、[BeagleBoard](https://ja.wikipedia.org/wiki/BeagleBoard "wikilink")等の趣味や教育用の[シングルボードコンピュータ](https://ja.wikipedia.org/wiki/シングルボードコンピュータ "wikilink")が各社から発売され、活況を呈している。
...
### 日本国外製品
  ...
  - [アップルコンピュータ](../Page/アップル_\(企業\).md "wikilink") - [Apple I](https://ja.wikipedia.org/wiki/Apple_I "wikilink")
  - [モステクノロジー](https://ja.wikipedia.org/wiki/モステクノロジー "wikilink") - [KIM-1](https://ja.wikipedia.org/wiki/KIM-1 "wikilink")（発売元:日本テクセル）
  - [Synertek](https://ja.wikipedia.org/wiki/:en:Synertek "wikilink") - [SYM-1](https://ja.wikipedia.org/wiki/SYM-1 "wikilink")
  - [ロックウェル・インターナショナル](https://ja.wikipedia.org/wiki/ロックウェル・インターナショナル "wikilink") - [AIM-65](https://ja.wikipedia.org/wiki/AIM-65 "wikilink")
  - 宏碁（Multitech，現: [エイサー](https://ja.wikipedia.org/wiki/エイサー_\(企業\) "wikilink")） - [マイクロ・プロフェッサー I](https://ja.wikipedia.org/wiki/マイクロ・プロフェッサー_I "wikilink")（小教授一號、Microprofessor I、MPF I）
  ...
  - [Mostek](https://ja.wikipedia.org/wiki/Mostek "wikilink") - KIM-1、Evalution（発売元:システム・マーケティング）
  - [フェアチャイルドセミコンダクター](https://ja.wikipedia.org/wiki/フェアチャイルドセミコンダクター "wikilink") - [F-8KIT 1A](https://ja.wikipedia.org/wiki/フェアチャイルド_F8 "wikilink")（発売元:TDKフェアチャイルド）
  - [IMSAI](https://ja.wikipedia.org/wiki/IMSAI "wikilink") - IMSAI-8048
  - [RCA](https://ja.wikipedia.org/wiki/RCA "wikilink") - CDP18SO20
...
### 日本国内製品
  ...
  - [日本電気](../Page/日本電気.md "wikilink") - [TK-80](https://ja.wikipedia.org/wiki/TK-80 "wikilink"),TK-80E,TK-85
  - [東芝](https://ja.wikipedia.org/wiki/東芝 "wikilink") - [EXシリーズ](https://ja.wikipedia.org/wiki/EX-80 "wikilink")
  ...
  - パナファコム（現:[PFU](https://ja.wikipedia.org/wiki/PFU "wikilink")） - Lkit-16（日本初の16[ビット](../Page/ビット.md "wikilink")マイコン）
  - ロジックシステムズ - MP-80
  - MTコーポレーション - PROTO-80
...
8.
9.
10. 加藤明、「[PC-8001の開発](https://doi.org/10.1587/bplus.2010.15_58)」 『電子情報通信学会 通信ソサイエティマガジン』 2010年 2010巻 15号 p.15_58-15_65, , [電子情報通信学会](https://ja.wikipedia.org/wiki/電子情報通信学会 "wikilink")
11.
12.
13. SDK-80はi8080A系でSBC80/10の基本部分を組立てキット化、SDK-85はi8085を搭載
14. IM6100を搭載していて[PDP-8](https://ja.wikipedia.org/wiki/PDP-8 "wikilink")とソフトウェアが互換