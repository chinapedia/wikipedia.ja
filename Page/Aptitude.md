...
[thumb](https://ja.wikipedia.org/wiki/ファイル:Screenshot-aptitude-ja.png "wikilink") **aptitude**は、[Debian](../Page/Debian.md "wikilink")などが採用する[APT](https://ja.wikipedia.org/wiki/APT "wikilink")システムにおける[CUI](../Page/キャラクタユーザインタフェース.md "wikilink")[フロントエンド](../Page/フロントエンド.md "wikilink")の一つ。[APT](https://ja.wikipedia.org/wiki/APT "wikilink")システムにおける代表的なコマンドであるapt-getなどに比べて、より強力なパッケージ管理機能（高機能な検索、対話的なソフトウェアの追加・削除ができる）を有する。
...
aptitudeには隠し機能があり、[apt-getの隠し機能と対になっている](https://ja.wikipedia.org/wiki/APT#イースターエッグ "wikilink")（""は[バックスラッシュ](https://ja.wikipedia.org/wiki/バックスラッシュ "wikilink")である）。
...
「[ウワバミに食べられた象](https://ja.wikipedia.org/wiki/うわばみ "wikilink")」というのは[星の王子さま](https://ja.wikipedia.org/wiki/星の王子さま "wikilink")の一節に由来する。
