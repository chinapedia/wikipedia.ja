...
本作は前作と同様に初回盤と通常盤ではジャケット違い、収録曲の違いがある。初回盤は歌詞カードのジャケット写真が計6ページでインスト版を収録。通常盤は計4ページであるが、こちらはインスト版がない代わりに、新曲が追加収録されている。ちなみに前作では初回盤に新曲が収録されていた。
...
4.  **Funky Party (Backing Track)**

### 通常盤

1.  **永遠のBLOODS**
2.  **Funky Party**
3.  **その花を見るな (BONUS TRACK)**
      -
