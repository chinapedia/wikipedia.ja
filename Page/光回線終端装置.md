...
ただし日本では、[NTTグループ](../Page/NTTグループ.md "wikilink")や[電力系通信事業者](https://ja.wikipedia.org/wiki/電力系通信事業者 "wikilink")など多くの事業者において、「ONU」と呼んだ場合は1芯式（[光ファイバー](../Page/光ファイバー.md "wikilink")1本で信号の送受信を[ピンポン伝送方式で行う](https://ja.wikipedia.org/wiki/時分割複信 "wikilink")）の装置を指す。2芯式（信号の送受信にそれぞれ別々の光ファイバーを1本ずつ使用するもの）の装置については**加入者回線終端装置** (Digital Service Unit : **DSU**) と呼び、ONUと区別している\[1\]。
...
[電気通信事業者](https://ja.wikipedia.org/wiki/電気通信事業者 "wikilink")側の光回線終端装置である。ONUと対となる。
...
## 関連項目
  ...
  - [主配線盤](https://ja.wikipedia.org/wiki/主配線盤 "wikilink")
  ...
  - [ハブ (ネットワーク機器)](https://ja.wikipedia.org/wiki/ハブ_\(ネットワーク機器\) "wikilink") - ONUにはLANケーブルが4本接続できるものもある。
