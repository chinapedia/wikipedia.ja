...
[仮想化技術として](../Page/仮想機械.md "wikilink")[シンクライアント](../Page/シンクライアント.md "wikilink")を実現するために[Xenが使われることがある](https://ja.wikipedia.org/wiki/Xen_\(仮想化ソフトウェア\) "wikilink")。また、最近では無料で利用できる[VMware](../Page/VMware.md "wikilink")などが使われることも多い。
