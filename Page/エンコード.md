...
特に[コンピュータ](../Page/コンピュータ.md "wikilink")（特に[パーソナルコンピュータ](../Page/パーソナルコンピュータ.md "wikilink")）分野では、エンコードとは、音声や動画などを[コーデック](https://ja.wikipedia.org/wiki/コーデック "wikilink")を用いて圧縮する事を言う。一部では「エンコ」と略して呼ぶこともある。

## アナログ信号のエンコード／デコード

録音機のノイズリダクションにしばしば用いられた。例えば[dbx](https://ja.wikipedia.org/wiki/dbx "wikilink")では、音声信号の大きさによって[増幅](https://ja.wikipedia.org/wiki/増幅 "wikilink")率が変化する特殊な増幅器を用いて、音量の変化を（対数で）1/2に抑えて録音し、再生時にそれを2倍にする。録音機やテープ由来の雑音／歪みは信号に比べかなり小さいので、再生時に対数伸長することでますます小さくなり、音楽信号にまぎれて聞こえづらくなる。似た原理の雑音低減装置がHiFiビデオやカセットレコーダに広く用いられた。
...
**デコード**（）は、復号ともいい、エンコードの対義語\[2\]。エンコードした情報を元に戻すこと。復号する機能を「デコーダ」（）という。情報の[通信や](../Page/電気通信.md "wikilink")[記録](../Page/記録.md "wikilink")を行う装置によっては、エンコーダとデコーダの両方を備える場合があり、このような双方向の変換機能あるいは変換装置、アルゴリズム等は[コーデック](https://ja.wikipedia.org/wiki/コーデック "wikilink")と呼ばれる。
...
※それぞれの詳細については関連項目（記事）を参照の事。
  ...
  - デジタル映像・音楽再生専用機
      -
        例：[DVDプレーヤ](https://ja.wikipedia.org/wiki/DVDプレーヤー "wikilink")、[CDプレーヤ](https://ja.wikipedia.org/wiki/CDプレーヤー "wikilink")、[MDプレーヤ](https://ja.wikipedia.org/wiki/MDプレーヤー "wikilink")、[ダウンロード](https://ja.wikipedia.org/wiki/ダウンロード "wikilink")音楽プレーヤなど
        搭載機能：デコーダのみ（再生用）
  - デジタル映像録画機・デジタル音楽録音機\[3\]
      -
        例：[BDレコーダ](https://ja.wikipedia.org/wiki/BDレコーダー "wikilink")、[DVDレコーダ](../Page/DVDレコーダー.md "wikilink")、[D-VHSレコーダ](https://ja.wikipedia.org/wiki/D-VHSレコーダー "wikilink")、[CDレコーダ](https://ja.wikipedia.org/wiki/CDレコーダー "wikilink")、[DATレコーダ](https://ja.wikipedia.org/wiki/DATレコーダー "wikilink")、[MDレコーダ](https://ja.wikipedia.org/wiki/MDレコーダー "wikilink")（[Hi-MD](https://ja.wikipedia.org/wiki/Hi-MD "wikilink")レコーダ含む）、[リニアPCMレコーダ](https://ja.wikipedia.org/wiki/リニアPCMレコーダー "wikilink")（一部の[ICレコーダ含む](https://ja.wikipedia.org/wiki/ICレコーダー "wikilink")）、[デジタルビデオカメラ](https://ja.wikipedia.org/wiki/デジタルビデオカメラ "wikilink")、録音機能付きダウンロード音楽プレーヤ、[HDDレコーダなど](https://ja.wikipedia.org/wiki/HDDレコーダー "wikilink")
  ...
  - [デジタル放送](https://ja.wikipedia.org/wiki/デジタル放送 "wikilink")[受信機](../Page/受信機.md "wikilink")\[4\]\[5\]
      -
...
## 関連項目
  ...
  - [ゲーデル数](https://ja.wikipedia.org/wiki/ゲーデル数 "wikilink")
...
4.  [デジタル放送](https://ja.wikipedia.org/wiki/デジタル放送 "wikilink")は[地上波放送](https://ja.wikipedia.org/wiki/地上デジタル放送 "wikilink")、[BS放送](https://ja.wikipedia.org/wiki/BS放送 "wikilink")、[CS放送](https://ja.wikipedia.org/wiki/CS放送 "wikilink")全て（単載、混載を問わない）を含む。
