...
そして発売前の2006年5月10日、ソフトバンクモバイル社長の[孫正義](../Page/孫正義.md "wikilink")が決算説明会において「**905SHはAQUOSケータイだ**」と発言。当端末の大ヒットによりAQUOSケータイという言葉は一般的になった。広告面では、独特の機構であるサイクロイドスタイルを**「予想外の動き」**と呼び、当端末の代名詞になった。この「予想外」という言葉が、後のソフトバンクモバイルの経営戦略上で重要なキーワードとなる。
...
当初は「90°ninety」という名称で発売予定であったが、発売直前になって「AQUOSケータイ」に変更された。初期ロットの箱に「90°ninety」と印刷されており、その上に「AQUOSケータイ」のシールを貼って隠していた。

## 主なサービス・機能

  - ミュージックプレイヤー（Music Manager使用)及び別売りで[SD-Jukebox](../Page/SD-Jukebox.md "wikilink")(SD-Audio)も利用可能
...
<!-- end list -->
  ...
  - [カスタムスクリーン](https://ja.wikipedia.org/wiki/カスタムスクリーン "wikilink")（[カスタモ](http://www.custamo.com/pc/)）
  ...
  - ケータイカラオケV-kara
  - Vodafone live\! CAST（現[S\!情報チャンネル](../Page/S!情報チャンネル.md "wikilink")）対応
  - Vodafone Address Book（現[S\!電話帳バックアップ](https://ja.wikipedia.org/wiki/S!電話帳バックアップ "wikilink")）対応
...
| 1GB                 | 約5時間20分  | 約4時間48分 |
| 2GB<small>※</small> | 約10時間40分 | 約9時間36分 |

**miniSDメモリーカードの録画時間目安**

<small>※2GBのminiSDカードはカードメーカー側で動作確認がとれているものもあるが、一部のカードでは正常に反応しない場合がある。</small>
...
## 不具合　
  ...
  - 2006年[6月26日](../Page/6月26日.md "wikilink") - タイトルの文字数が多い一部楽曲を着信音に設定できない不具合
...
### 付属品
  ...
  - 急速充電器
  - ユーティリティソフトウェア[CD-ROM](../Page/CD-ROM.md "wikilink")
  - マイク付きステレオヘッドフォン
...
## 外部リンク
  ...
  - [Vodafone 905SH｜SoftBank](http://mb.softbank.jp/mb/product/3G/model/vodafone_905sh/)
  - [Vodafone 905SH｜SHARP](http://www.sharp.co.jp/products/905sh/)
  - [SoftBank 905SH｜SoftBank](http://mb.softbank.jp/mb/product/3G/905sh/)
  - [SoftBank 905SH｜SHARP](http://www.sharp.co.jp/products/sb905sh/)
  - [905SHのまとめ miniSDカード動作確認](http://905sh.v3g.info/index.php?FAQ%2FminiSD%C6%B0%BA%EE%B3%CE%C7%A7)
