...
NuBusは、よくデザインされたMITのNuMachineの派生品である、テキサス・インスツルメンツが開発したTI Explorerという[LISPマシン](../Page/LISPマシン.md "wikilink")に最初に用いられた。その後まもなく、[1986年](../Page/1986年.md "wikilink")にテキサス・インスツルメンツはS1500マルチプロセッサUNIXシステムに採用した。
