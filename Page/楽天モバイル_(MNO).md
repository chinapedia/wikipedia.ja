> この記事は[楽天モバイル \(MNO\)](https://ja.wikipedia.org/wiki/楽天モバイル_\(MNO\))から翻訳されています。


**楽天モバイル**（らくてんモバイル）は、[楽天モバイル株式会社が提供する](https://ja.wikipedia.org/wiki/楽天モバイル_\(企業\) "wikilink")[移動体通信](../Page/移動体通信.md "wikilink")事業のサービスブランドである。
...
正式サービス開始時に提供する端末（すべて[スマートフォン](https://ja.wikipedia.org/wiki/スマートフォン "wikilink")）は以下の通り。

  - [Galaxy S10・Galaxy S10+](https://ja.wikipedia.org/wiki/Samsung_Galaxy_S10 "wikilink")（[サムスン電子](../Page/サムスン電子.md "wikilink")製）
  - Galaxy A7（サムスン電子製）
  - nova 5T（[ファーウェイ](../Page/ファーウェイ.md "wikilink")製）
  - OPPO A5 2020（[OPPO](https://ja.wikipedia.org/wiki/OPPO "wikilink")製）
  - Reno A（OPPO製）
