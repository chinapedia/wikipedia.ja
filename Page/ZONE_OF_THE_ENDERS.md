...
50音順で表記
  ...
  - セルキス (SELKIS)
    ...
    付属肢をすべて格納した飛行形態から、背面側を前に倒立状態で、二股の機首を両足、左右から四本腕を展開した異形の人型となる。さらに[サソリ](../Page/サソリ.md "wikilink")のシンボルを持つ女神[セルケト](../Page/セルケト.md "wikilink")に由来し機体名のとおり、後部から蠍の尾のようにコクピットを擁する真の上半身が展開する多段可変型OF。ネビュラやオルタネイトを凌駕する高機動性と、本機を袖にしたノウマンも「火力だけなら一級品」と評価する攻撃力を併せ持った高性能機。その分操縦難度は高いとされる。劇中ではOFの最高峰であるアヌビス、ドロレスと相手が悪く、性能ほどの活躍はできなかった。
  ...
  - ネフティス (NEPHTIS)
    ...
    デザイン上のイメージソースは「華」。
    モデルはエジプト神話における、夜を司る女神[ネフティス](../Page/ネフティス.md "wikilink")。
...
### プラモデル
  ...
  - [コトブキヤ](https://ja.wikipedia.org/wiki/コトブキヤ "wikilink") ANUBIS ZONE OF THE ENDERS ジェフティ
