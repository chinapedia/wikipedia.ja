...
**ブラウザクラッシャー**とは、[ウェブブラウザ](../Page/ウェブブラウザ.md "wikilink")や[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink")(OS)の仕様・[バグ](https://ja.wikipedia.org/wiki/バグ "wikilink")を悪用する[スクリプト言語](../Page/スクリプト言語.md "wikilink")または [HTML](../Page/HyperText_Markup_Language.md "wikilink") 文書を記述した[ウェブページ](../Page/ウェブページ.md "wikilink")のこと。

## 概要

[ウェブブラウザ](../Page/ウェブブラウザ.md "wikilink")で当該ページに[アクセス](https://ja.wikipedia.org/wiki/アクセス "wikilink")することにより、ウェブブラウザや OS の動作に異常を発生させる。「クラッシャー」は[ソフトウェア](../Page/ソフトウェア.md "wikilink")をクラッシュ\[1\]させる動作を意味している。ソフトウェアの構成や[ハードウェア](../Page/ハードウェア.md "wikilink")に直接の破壊的な影響を及ぼす場合もある（[FDDアタックなど](https://ja.wikipedia.org/wiki/#FDD_アタック・CD-ROM_アタック "wikilink")）。
...
このタイプのブラクラが最も有名なブラクラであるといえる。このブラクラは「JS_SPAWN.A」と呼ばれ、該当のページにアクセスすると、新しい[ウィンドウ](https://ja.wikipedia.org/wiki/ウィンドウ "wikilink")を[無限](../Page/無限.md "wikilink")に開き続けることで、メモリの使用量が爆発的に増加し、最悪の場合フリーズする。

ユーザーがウィンドウを一つでも閉じると、ウインドウが[ねずみ算](https://ja.wikipedia.org/wiki/ねずみ算 "wikilink")式に開かれる様になっている場合がほとんどである。[トロイの木馬として分類されている場合があるが](https://ja.wikipedia.org/wiki/トロイの木馬_\(ソフトウェア\) "wikilink")、ファイルやレジストリなどの改変を行わないものが大半である。しかし、悪質なものになると単にブラクラとして動作するだけでなく、[ウイルスをダウンロードさせるなどの](https://ja.wikipedia.org/wiki/コンピュータウイルス "wikilink")[二次災害](https://ja.wikipedia.org/wiki/二次災害 "wikilink")を引き起こすサイトもある。

**対応策**

  - [プロセス](../Page/プロセス.md "wikilink")を強制終了する。
      - [Windowsでは](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink") Ctrl + Alt + Delete キーで、[タスクマネージャを開き](https://ja.wikipedia.org/wiki/Windows_タスク_マネージャー "wikilink")、「プロセス」タブでウェブブラウザを終了する。このとき終了するプロセスは、[Internet Explorerの場合は](../Page/Internet_Explorer.md "wikilink")「iexplore.exe」、[Mozilla Firefoxを使用している場合は](../Page/Mozilla_Firefox.md "wikilink")「firefox.exe」である（[Windows 9x系OSの場合](https://ja.wikipedia.org/wiki/Windows_9x系 "wikilink")、「強制終了の選択」というダイアログが表示されるので、そこから使用しているブラウザをクリックして強制終了する）。
      - [macOS](https://ja.wikipedia.org/wiki/macOS "wikilink")では、command + option + esc キーでアプリケーションの強制終了を開き、ウェブブラウザを強制終了する。
      - [Unix系](https://ja.wikipedia.org/wiki/Unix系 "wikilink")OSでは [ps](https://ja.wikipedia.org/wiki/ps_\(UNIX\) "wikilink") コマンドでウェブブラウザの[PIDを調べ](https://ja.wikipedia.org/wiki/プロセス識別子 "wikilink")、[kill](https://ja.wikipedia.org/wiki/kill "wikilink")コマンドでプロセスを終了する。
  - 「新しいウィンドウ」ではなく、「新しい[タブで開く](https://ja.wikipedia.org/wiki/タブ_\(GUI\) "wikilink")」設定に変更する（[タブブラウザ](https://ja.wikipedia.org/wiki/タブブラウザ "wikilink")、タブブラウジングの場合）。
...
もっとも、Windows XP以降の市販パソコンではフロッピーディスクドライブが[レガシーデバイス](https://ja.wikipedia.org/wiki/レガシーデバイス "wikilink")と化し、別売のオプション扱いとするものが出てきている。このようなパソコンにはAドライブが存在しないため、フロッピーディスクドライブアタックは効かない（やむなく使用する必要がある場合、[USB接続の外付けドライブなどで代用する](../Page/ユニバーサル・シリアル・バス.md "wikilink")）。なお、Windows以外のプラットフォームは影響を受けない。

### テーブルネスト

`table` タグの中に `table` タグを入れ、さらにその中に `table` タグを入れ、これを[故意](../Page/故意.md "wikilink")に深く[ネスティング](https://ja.wikipedia.org/wiki/ネスティング "wikilink")させたもの。古い[ブラウザ](https://ja.wikipedia.org/wiki/ブラウザ "wikilink")、特にバージョンの古い [Netscape Navigator](https://ja.wikipedia.org/wiki/Netscape_Navigator_\(ネットスケープコミュニケーションズ\) "wikilink")（4.x あたりまで）では[フリーズ](https://ja.wikipedia.org/wiki/フリーズ "wikilink")してしまう。 [意図](https://ja.wikipedia.org/wiki/意図 "wikilink")しなくてもページレイアウトのために `table` タグを多用した場合、同じことが起こりうる。
...
アラートを多数回または無限に開かせる。一部のウェブブラウザではアラートは[ダイアログボックス](https://ja.wikipedia.org/wiki/ダイアログボックス "wikilink")で実装され警告を促すため最前面に表示されるようになっているため、メッセージボックスが表示されている間は操作できない。このブラクラではアラートを閉じると次のステップでまたアラートを表示する。したがって、アラートがダイアログボックスであるブラウザではアラートが終了するか、プロセスを終了しない限り操作が何もできなくなる。
...
**防御策**
  ...
  - [プロセス](../Page/プロセス.md "wikilink")を強制終了する。
      ...
      - [UNIX 系](https://ja.wikipedia.org/wiki/Unix系 "wikilink") OS では [ps](https://ja.wikipedia.org/wiki/ps_\(UNIX\) "wikilink") コマンドでウェブブラウザの [PID](https://ja.wikipedia.org/wiki/プロセス識別子 "wikilink") を調べ、[kill](https://ja.wikipedia.org/wiki/kill "wikilink") コマンドでプロセスを終了する。
  - 再起動する。
...
**防御策**
  ...
  - [タブブラウザ](https://ja.wikipedia.org/wiki/タブブラウザ "wikilink")（[Firefox](../Page/Mozilla_Firefox.md "wikilink")、Microsoft Internet Explorer 7 など）を使用する。
...
何度閉じても、[ゾンビ](../Page/ゾンビ.md "wikilink")のごとく復活するウィンドウのことをいう。消した数よりも開くウィンドウが多い場合もある。この場合、ウィンドウが[ねずみ算](https://ja.wikipedia.org/wiki/ねずみ算 "wikilink")式に増えることになる。悪質な[ポップアップ広告](https://ja.wikipedia.org/wiki/ポップアップ広告 "wikilink")にしばしば使われている。
...
I'm Feeling Lucky ブラクラとは、[Google](https://ja.wikipedia.org/wiki/Google "wikilink") のトップページの、「検索」ボタンの横にある「I'm Feeling Lucky」ボタンを悪用したブラクラのことである。I'm Feeling Lucky とは、Google の機能の一つで、検索結果の一覧を表示せずに直接検索結果のトップに挙がったウェブページにジャンプする機能のことだが、その機能を利用して、ブラクラサイトが検索結果のトップに表示されるような検索語をリンク先の [URL](../Page/Uniform_Resource_Locator.md "wikilink") に仕掛けるとクリックした者をブラクラに誘導することが可能になる。

[掲示板などにリンクが貼られていた場合](https://ja.wikipedia.org/wiki/電子掲示板 "wikilink")、普段は多少怪しいと思うようなリンク先であっても、I'm Feeling Lucky を使った URL の場合、<https://www.google.co.jp/#q=>`○○&btnI=I%27m%20Feeling%20Lucky` というような URL になり、[ドメインが](https://ja.wikipedia.org/wiki/ドメイン名 "wikilink") Google であることから安心してクリックしてしまい、ひっかかりやすいとされている。

また、`=I%27m%20Feeling%20Lucky` の部分は省略でき、さらに btnI は `%62%74%6e%49` と [URL エンコードもできるため](https://ja.wikipedia.org/wiki/パーセントエンコーディング "wikilink")、<https://www.google.co.jp/#q=>`○○&%62%74%6e%49` となる。このように、偽装が容易である。
...
ブラクラを踏まないようにするためにも、次のような[対策](https://ja.wikipedia.org/wiki/対策 "wikilink")を行うべきである。
  ...
  - [タブブラウザ](https://ja.wikipedia.org/wiki/タブブラウザ "wikilink")を使用する。
  ...
  - ブラウザの設定で[ポップアップを無効にするように設定する](https://ja.wikipedia.org/wiki/ポップアップ広告 "wikilink")。

## 精神的ブラクラ

派生した用語として「**精神的ブラクラ**」がある。これは、閲覧者に精神的な不快感を与えさせる[グロ](https://ja.wikipedia.org/wiki/グロ "wikilink")系や[恐怖](https://ja.wikipedia.org/wiki/恐怖 "wikilink")系の画像・音声・動画（死体の写真や動画など）にそれと気づかないようにアクセスさせることである。
