...
**Distributed Management Task Force**（**DMTF**）は、企業やインターネットにおける[IT環境の](../Page/情報技術.md "wikilink")[システム管理](../Page/システム管理.md "wikilink")のための標準を策定・保守する[標準化団体](https://ja.wikipedia.org/wiki/標準化団体 "wikilink")である。当初、"Desktop Management Task Force" と称していた。

## 概要

DMTF は[1992年](https://ja.wikipedia.org/wiki/1992年 "wikilink")に創設された。オープンな団体であり、営利企業でも非営利組織でも個人でも参加できる。[2005年](https://ja.wikipedia.org/wiki/2005年 "wikilink")現在、DMTF には 200 以上の企業や組織から 3500 人が参加している。
...
団体の取締役企業として[ブロードコム](https://ja.wikipedia.org/wiki/ブロードコム "wikilink")、[CAテクノロジーズ](https://ja.wikipedia.org/wiki/CAテクノロジーズ "wikilink")、[デル](../Page/デル.md "wikilink")、[ヒューレット・パッカード](../Page/ヒューレット・パッカード.md "wikilink")、[日立製作所](../Page/日立製作所.md "wikilink")、[インテル](https://ja.wikipedia.org/wiki/インテル "wikilink")、[レノボ](https://ja.wikipedia.org/wiki/レノボ "wikilink")、[ネットアップ](../Page/ネットアップ.md "wikilink")、、、[VMware](https://ja.wikipedia.org/wiki/VMware "wikilink")が名を連ねている\[1\]。
...
## DMTFが策定した標準
  ...
  - [System Management BIOS](https://ja.wikipedia.org/wiki/SMBIOS "wikilink") (SMBIOS)
...
DMTF以外で策定された標準として以下のようなものがある。
  ...
  - [Java Community Process](https://ja.wikipedia.org/wiki/Java_Community_Process "wikilink") は、CIMクライアントアプリケーションの[Java](https://ja.wikipedia.org/wiki/Java "wikilink")APIとして JSR-48 を策定中。
...
CIM/WBEM をサポートする製品や[オープンソース](../Page/オープンソース.md "wikilink")プロジェクトとして以下のものがある。
  ...
  - **[SBLIM](http://sblim.sourceforge.net/)** - [Linux](https://ja.wikipedia.org/wiki/Linux "wikilink")での CIM/WBEM 実装のオープンソースプロジェクト
