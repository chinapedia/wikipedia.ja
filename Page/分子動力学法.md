...
[thumb](https://ja.wikipedia.org/wiki/ファイル:Cudeposition.gif "wikilink")[原子](https://ja.wikipedia.org/wiki/原子 "wikilink")のCu [(001)](https://ja.wikipedia.org/wiki/ミラー指数 "wikilink") [表面への堆積](https://ja.wikipedia.org/wiki/表面科学 "wikilink")。それぞれの円は単一原子の位置を示す。現在のシミュレーションにおいて用いられる実際の原子的相互作用は図中の2次元剛体球の相互作用よりも複雑である。\]\] [MD_water.gif](https://ja.wikipedia.org/wiki/File:MD_water.gif "fig:MD_water.gif")

**分子[動力学](https://ja.wikipedia.org/wiki/動力学 "wikilink")法**（ぶんしどうりきがくほう、、MD法）は、[原子](https://ja.wikipedia.org/wiki/原子 "wikilink")ならびに[分子](../Page/分子.md "wikilink")の[物理的な動きの](https://ja.wikipedia.org/wiki/運動_\(物理学\) "wikilink")[コンピューターシミュレーション](https://ja.wikipedia.org/wiki/コンピューターシミュレーション "wikilink")手法である。原子および分子はある時間の間相互作用することが許され、これによって原子の動的発展の光景が得られる。最も一般的なMD法では、原子および分子の[トラクジェクトリは](https://ja.wikipedia.org/wiki/弾道 "wikilink")、相互作用する粒子の系についての[古典力学](../Page/古典力学.md "wikilink")における[ニュートンの運動方程式を](../Page/ニュートン力学.md "wikilink")[数値的に解くことによって決定される](https://ja.wikipedia.org/wiki/数値積分 "wikilink")。この系では粒子間の[力および](../Page/力_\(物理学\).md "wikilink")[ポテンシャルエネルギー](https://ja.wikipedia.org/wiki/ポテンシャルエネルギー "wikilink")は[原子間ポテンシャル](https://ja.wikipedia.org/wiki/原子間ポテンシャル "wikilink")（[分子力学](https://ja.wikipedia.org/wiki/分子力学 "wikilink")[力場](https://ja.wikipedia.org/wiki/力場_\(化学\) "wikilink")）によって定義される。MD法は元々は1950年代末に理論物理学分野で考え出されたが\[1\]\[2\]、今日では主に[化学物理学](https://ja.wikipedia.org/wiki/化学物理学 "wikilink")、[材料科学](https://ja.wikipedia.org/wiki/材料科学 "wikilink")、[生体分子](https://ja.wikipedia.org/wiki/生体分子 "wikilink")のモデリングに適用されている。系の静的、動的安定構造や、動的過程（ダイナミクス）を解析する手法。

分子の系は莫大な数の粒子から構成されるため、このような[複雑系](https://ja.wikipedia.org/wiki/複雑系 "wikilink")の性質を解析的に探ることは不可能である。MDシミュレーションは [数値的手法を用いることによってこの問題を回避する](https://ja.wikipedia.org/wiki/数値解析 "wikilink")。しかしながら、長いMDシミュレーションは数学的に[悪条件であり](https://ja.wikipedia.org/wiki/条件数 "wikilink")、[数値積分](https://ja.wikipedia.org/wiki/数値積分 "wikilink")において累積誤差を生成してしまう。これはアルゴリズムとパラメータの適切な選択によって最小化することができるが、完全に取り除くことはできない。

[エルゴード仮説](https://ja.wikipedia.org/wiki/エルゴード仮説 "wikilink")に従う系では、単一の分子動力学シミュレーションの展開は系の巨視的[熱力学](../Page/熱力学.md "wikilink")的性質を決定するために使うことができる。エルゴード系の時間平均は[ミクロカノニカルアンサンブル](https://ja.wikipedia.org/wiki/ミクロカノニカルアンサンブル "wikilink")（小正準集団）平均に対応する。MDは自然の力をアニメーションすることによって未来を予測する、原子スケールの分子の運動についての理解を可能にする「数による統計力学」や「[ニュートン力学](../Page/ニュートン力学.md "wikilink")の[ラプラス的視点](https://ja.wikipedia.org/wiki/ピエール＝シモン・ラプラス "wikilink")」とも称されている\[3\]\[4\]。

MDシミュレーションでは等温、定圧、[等温・定圧](https://ja.wikipedia.org/wiki/等温定圧集団 "wikilink")、定エネルギー、定積、定ケミカルポテンシャル、グランドカノニカルといった様々なアンサンブル（[統計集団](https://ja.wikipedia.org/wiki/統計集団 "wikilink")）の計算が可能である。また、結合長や位置の固定など様々な拘束条件を付加することもできる。計算対象は、[バルク](https://ja.wikipedia.org/wiki/バルク_\(界面化学\) "wikilink")、[表面](https://ja.wikipedia.org/wiki/表面 "wikilink")、[界面](https://ja.wikipedia.org/wiki/界面 "wikilink")、[クラスターなど多様な系を扱える](https://ja.wikipedia.org/wiki/クラスター_\(物質科学\) "wikilink")。
...
[モンテカルロシミュレーションの先行する成功に続いて](../Page/モンテカルロ法.md "wikilink")、1950年代末に[アルダーとウェインライトによって](https://ja.wikipedia.org/wiki/バーニ・アルダー "wikilink")\[5\]、1960年代に[ラーマンによって](https://ja.wikipedia.org/wiki/アニーサー・ラーマン "wikilink")\[6\]それぞれ独立にMD法が開発された。1957年、アルダーおよびウェインライトは[剛体球](https://ja.wikipedia.org/wiki/剛体球 "wikilink")間の弾性衝突を完全にシミュレーションするために[IBM 704計算機を使用した](https://ja.wikipedia.org/wiki/IBM_704 "wikilink")\[7\]。1960年、ギブソンらはボルン＝マイヤー型の反発相互作用と凝集面積力を用いることによって固体[銅](https://ja.wikipedia.org/wiki/銅 "wikilink")の放射線障害をシミュレーションした\[8\]。1964年、ラーマンは[レナード＝ジョーンズ・ポテンシャルを利用した液体](https://ja.wikipedia.org/wiki/レナード-ジョーンズ・ポテンシャル "wikilink")[アルゴン](https://ja.wikipedia.org/wiki/アルゴン "wikilink")の画期的シミュレーションを発表した。[自己拡散](https://ja.wikipedia.org/wiki/自己拡散 "wikilink")係数といった系の性質の計算は実験データと遜色がなかった\[9\]。
...
### 年表
  ...
  - [1991年](https://ja.wikipedia.org/wiki/1991年 "wikilink")：大正準集団（集合）系への拡張 (Cagin and Pettit)

## 応用領域

理論[物理学](../Page/物理学.md "wikilink")分野で始まったMD法は[材料科学](https://ja.wikipedia.org/wiki/材料科学 "wikilink")において人気を得て、1970年代からは[生化学](https://ja.wikipedia.org/wiki/生化学 "wikilink")および[生物物理学](https://ja.wikipedia.org/wiki/生物物理学 "wikilink")での人気を得ている。MDは[X線結晶構造解析](https://ja.wikipedia.org/wiki/X線結晶構造解析 "wikilink")あるいは[NMR](https://ja.wikipedia.org/wiki/NMR "wikilink")分光法から得られた実験的拘束情報に基づいて[タンパク質](https://ja.wikipedia.org/wiki/タンパク質 "wikilink")やその他の[高分子](https://ja.wikipedia.org/wiki/高分子 "wikilink")の三次元構造を洗練するために頻繁に用いられる。物理学において、MDは薄膜成長やイオン-サブプランテーションといった直接観測することができない原子レベルの現象のダイナミクスを調べるために使われる。また、まだ作成されていないあるいは作成することができない[ナノテクノロジー](https://ja.wikipedia.org/wiki/ナノテクノロジー "wikilink")装置の物理的性質を調べるためにも使われる。[生物物理学](https://ja.wikipedia.org/wiki/生物物理学 "wikilink")および[構造生物学](https://ja.wikipedia.org/wiki/構造生物学 "wikilink")では、MD法は[リガンドドッキング](https://ja.wikipedia.org/wiki/ドッキング_\(分子\) "wikilink")、[脂質二重膜](https://ja.wikipedia.org/wiki/脂質二重膜 "wikilink")のシミュレーション、[ホモロジーモデリング](https://ja.wikipedia.org/wiki/ホモロジーモデリング "wikilink")、さらに[ランダムコイル](https://ja.wikipedia.org/wiki/ランダムコイル "wikilink")から[ポリペプチド鎖](https://ja.wikipedia.org/wiki/ポリペプチド鎖 "wikilink")の[折り畳みをシミュレーションすることによって](https://ja.wikipedia.org/wiki/フォールディング "wikilink")[タンパク質構造](https://ja.wikipedia.org/wiki/タンパク質構造 "wikilink")をab initioに予測するためにも頻繁に適用されている。
...
古典的MDシミュレーションの間、CPUを消費するほとんどのタスクは粒子の内部座標の関数としての[ポテンシャルの評価である](https://ja.wikipedia.org/wiki/力場_\(化学\) "wikilink")。このエネルギー評価内で最も計算コストが高いのが非結合（非共有結合）部分である。[ランダウの*O*-記法では](https://ja.wikipedia.org/wiki/ランダウの記号 "wikilink")、全ての対[静電相互作用および](https://ja.wikipedia.org/wiki/静電気学 "wikilink")[ファンデルワールス相互作用があらわに考慮されるとすると](https://ja.wikipedia.org/wiki/ファンデルワールス力 "wikilink")、一般的な分子動力学シミュレーションは\(O(n^2)\)で[スケールする](https://ja.wikipedia.org/wiki/アルゴリズム解析 "wikilink")。この計算コストは[粒子メッシュエバルト (PME) 法](https://ja.wikipedia.org/wiki/エバルト和#粒子・メッシュ・エバルト_\(PME\)_法 "wikilink")（\(O(n \log(n))\)）、[P3M](https://ja.wikipedia.org/wiki/P3M "wikilink")法あるいはより球面カットオフ手法（\(O(n)\)）といった静電的手法を利用することによって低減することができる。
...
よくある混乱の源の一つはMDにおける[温度](https://ja.wikipedia.org/wiki/温度 "wikilink")の意味である。一般に、我々が経験しているのは膨大な数の粒子を含む巨視的温度である。しかし温度は統計的量である。もし、十分大きな数の原子が存在すれば、統計的温度は「瞬間温度」から見積ることができる。これは、系の運動エネルギーをnk<sub>B</sub>T/2（kBはボルツマン定数、nは系の自由度の数）と同じと見なすことで得られる。
...
[正準集団](https://ja.wikipedia.org/wiki/正準集団 "wikilink")（カノニカルアンサンブル）では、物質の量（N）、容積（V）、温度（T）が保存される。これは等温分子動力学（constant temperature molecular dynamics、CTMD）と呼ばれることもある。NVTでは、吸熱的過程と発熱的過程のエネルギーは[サーモスタット](https://ja.wikipedia.org/wiki/サーモスタット "wikilink")（温度調整器）によって交換される。
...
分子動力学シミュレーションは[ポテンシャル関数](https://ja.wikipedia.org/wiki/ポテンシャル関数 "wikilink")（シミュレーション中の粒子の相互作用を決定する項の記述）を必要とする。化学および生物学では通常これは[力場と呼ばれ](https://ja.wikipedia.org/wiki/力場_\(化学\) "wikilink")、材料物理学では原子間ポテンシャルと呼ばれる。ポテンシャルは多くの段階の物理学的正確性で定義できる。化学で最も一般的に用いられているものは[分子力学法](https://ja.wikipedia.org/wiki/分子力学法 "wikilink")に基づいており、粒子-粒子相互作用の[古典的取扱い](../Page/古典力学.md "wikilink")（構造変化や[コンホメーション変化](https://ja.wikipedia.org/wiki/コンホメーション変化 "wikilink")は再現できるが、[化学反応](https://ja.wikipedia.org/wiki/化学反応 "wikilink")は再現できない）を具体化している。
...
化学におけるほとんどの力場は経験的なものであり、[化学結合](https://ja.wikipedia.org/wiki/化学結合 "wikilink")と関連する結合力、結合角、結合[二面角](https://ja.wikipedia.org/wiki/二面角 "wikilink")、[ファンデルワールス力](https://ja.wikipedia.org/wiki/ファンデルワールス力 "wikilink")および[静電価と関連する非結合力の和から成る](https://ja.wikipedia.org/wiki/電荷 "wikilink")。経験的ポテンシャルはアドホックな機能的近似によって限定的に量子力学的効果を表わす。これらのポテンシャルは[原子電荷](https://ja.wikipedia.org/wiki/電荷 "wikilink")、[原子半径](https://ja.wikipedia.org/wiki/原子半径 "wikilink")の推定値を反映するファンデルワールスパラメータ、平衡[結合長](https://ja.wikipedia.org/wiki/結合長 "wikilink")、結合角、結合二面角といった自由なパラメータを含む。これらは、詳細な電子構造（量子化学シミュレーション）あるいは[弾性係数](https://ja.wikipedia.org/wiki/ヤング率 "wikilink")、格子パラメータ、[分光測定といった経験的な物理的性質に対してフィッティングを行うことで得られる](https://ja.wikipedia.org/wiki/分光学 "wikilink")。
...
化学力場は一般にあらかじめ設定された結合様式を用いる（[非経験的動力学法を除く](https://ja.wikipedia.org/wiki/非経験的分子軌道法 "wikilink")）。したがって、化学力場は化学結合の切断の過程や反応を露にモデル化することができない。一方で、[結合次数形式に基づいたもののような物理学におけるポテンシャルの多くは](https://ja.wikipedia.org/wiki/結合次数ポテンシャル "wikilink")、系の複数の異なる接続や結合の切断を記述することができる\[15\]\[16\]。こういったポテンシャルの例としては、炭化水素のためのブレナー・ポテンシャル\[17\]やそれをC-Si-H系\[18\]とC-O-H系\[19\]にさらに発展させたものがある。[ReaxFF](https://ja.wikipedia.org/wiki/ReaxFF "wikilink")ポテンシャル\[20\]は、結合次数ポテンシャルと化学力場とを組み合わせた完全な反応力場と見なすことができる。

### 対ポテンシャルと多体ポテンシャル

非結合性エネルギーを表わすポテンシャル関数は、系の粒子間の相互作用全体の和として定式化される。多くの人気のある[力場で採用されている最も単純な選択肢は](https://ja.wikipedia.org/wiki/力場_\(化学\) "wikilink")、全ポテンシャルエネルギーが原子の対の間のエネルギー寄与の和から計算できる「対ポテンシャル」である。こういった対ポテンシャルの一例は非結合性[レナード＝ジョーンズ・ポテンシャルであり](https://ja.wikipedia.org/wiki/レナード-ジョーンズ・ポテンシャル "wikilink")、ファンデルワールス力を計算するために使われる。
...
[多体ポテンシャルにおいて](https://ja.wikipedia.org/wiki/多体問題 "wikilink")、ポテンシャルエネルギーは互いに相互作用する3つ以上の粒子の効果を含む。対ポテンシャルを用いたシミュレーションでは、系の包括的な相互作用も存在するが、対ポテンシャル項を通じてのみ生じる。多体ポテンシャルにおいて、ポテンシャルエネルギーは原子の対全体の和によって表わすことができない。これは、これらの相互作用が高次項の組合せとして明確に計算されるためである。統計的見方では、変数間の依存性は一般に自由度の対ごとの積のみを用いて表現することはできない。例えば、[炭素](https://ja.wikipedia.org/wiki/炭素 "wikilink")、[ケイ素](https://ja.wikipedia.org/wiki/ケイ素 "wikilink")、[ゲルマニウム](https://ja.wikipedia.org/wiki/ゲルマニウム "wikilink")のシミュレーションに元々使われ、その他の幅広い材料に対しても用いられている[ターソフ・ポテンシャル](https://ja.wikipedia.org/wiki/結合次数ポテンシャル "wikilink")\[21\]は3個の原子の群についての和を含む。このポテンシャルでは、原子間の角度が重要な要素である。その他の例としては、[原子挿入法](https://ja.wikipedia.org/wiki/原子挿入法 "wikilink")（EAM）\[22\]や強結合二次モーメント近似（TBSMA）ポテンシャル\[23\]がある。TBSMAポテンシャルでは、原子の領域における状態の電子密度は周囲の原子からの寄与の和から計算され、ポテンシャルエネルギー寄与はこの和の関数である。

### 半経験的ポテンシャル

[半経験的ポテンシャルは](https://ja.wikipedia.org/wiki/半経験的分子軌道法 "wikilink")、量子力学からの行列表示を使用する。しかしながら、行列要素の値は特定の原子軌道の重なりの度合いを見積る経験式によって決定される。次に、この行列は異なる原子軌道の占有率を決定するために対角化され、軌道のエネルギー寄与を決定するために再び経験式が使われる。

[強結合ポテンシャルとして知られる半経験的ポテンシャルには様々な種類があり](https://ja.wikipedia.org/wiki/強結合近似 "wikilink")、これらはモデル化される原子によって異なる。

### 分極可能なポテンシャル

ほとんどの古典的力場は[分極率](https://ja.wikipedia.org/wiki/分極率 "wikilink")の効果を黙示的に含む（例えば量子化学計算から得られた部分電荷を拡大することによって）。これらの部分電荷は原子の質量に関して固定である。しかし、分子動力学シミュレーションは[ドルーデ粒子](https://ja.wikipedia.org/wiki/ドルーデ粒子 "wikilink")や変動電荷といった異なる手法を用いた誘導双極子の導入によって分極率を明示的にモデル化できる。これによって、局所的な化学的環境に応答する原子間の電荷の動的再分配が可能になる。
...
より洗練された実装では、QM/MM法は量子効果に対して敏感な軽い核（例えば水素）と電子状態の両方を扱うために存在する。これによって、水素の波動関数の生成を行うことができる。この方法論は、水素のトンネリングといった現象を調べるために有用である。QM/MM法が新たな発見をもたらした一つの例は、肝臓の[アルコール脱水素酵素におけるヒドリド転移の計算である](https://ja.wikipedia.org/wiki/アルコールデヒドロゲナーゼ "wikilink")。この場合、水素原子の[トンネリングが重要である](https://ja.wikipedia.org/wiki/トンネル効果 "wikilink")（反応速度を決定する）\[27\]。
...
これらの非常に粗視的なモデルのパラメータ化は、モデルの挙動を適切な実験的データあるいは全原子シミュレーションへ合致させることによって、経験的に行われる。理想的には、これらのパラメータは自由エネルギーへの[エンタルピー](https://ja.wikipedia.org/wiki/エンタルピー "wikilink")寄与と[エントロピー](https://ja.wikipedia.org/wiki/エントロピー "wikilink")寄与の両方を黙示的に考慮しなければならない。粗視化がより高い水準で行われる時、動力学的記述の正確性はより信頼できなくなる。しかし、よく粗視化されたモデルは、構造生物学、液晶の組織化、高分子ガラスの分野における幅広い疑問を調べるためにうまく使われてきている。

粗視化の応用の例を以下に挙げる。

  - [タンパク質のフォールディングの研究はアミノ酸毎に単一](https://ja.wikipedia.org/wiki/フォールディング "wikilink")（あるいはいくつかの）擬原子を使ってしばしば行なわれる。
  - [液晶](../Page/液晶.md "wikilink")の相転移は制限された幾何構造と異方性種を記述するGay-Berneポテンシャルを用いた計算の一方あるいは両方で調べられている。
  - 変形中の[ポリマーガラスは](https://ja.wikipedia.org/wiki/重合体 "wikilink")、レナード＝ジョーンズポテンシャルによって記述され球を接続する単純な調和バネあるいは有限伸張性の非線形バネ (FENE; Finitely Extensible Nonlinear Elastic) を用いて研究されている。
  ...
  - [リボソーム](https://ja.wikipedia.org/wiki/リボソーム "wikilink")やその他の大きな系におけるRNA構造はヌクレオチド当たり1つの擬原子を用いてモデル化されている。
...
分子動力学は多くの科学分野で使われている。
  ...
  - MDシミュレーションは[ゴーシェ病](https://ja.wikipedia.org/wiki/ゴーシェ病 "wikilink")の原因である最も一般的なタンパク質変異N370Sの分子基盤を予測することにうまく応用された\[40\]。後続の論文では、これらの目隠し予測が同じ変異についての実験結果と驚く程に高い相関を見せることが示された\[41\]。
  - MDシミュレーションは金属表面上の水薄膜の分離圧に対する表面電荷の影響について調べるために用いられている\[42\]。
  - MDシミュレーションは[透過型電子顕微鏡](https://ja.wikipedia.org/wiki/透過型電子顕微鏡 "wikilink")の画像特徴を理解するために[マルチスライス](https://ja.wikipedia.org/wiki/マルチスライス "wikilink")画像シミュレーションと共に用いられる\[43\]。
...
### 積分器
  ...
  - [ルンゲ＝クッタ積分](https://ja.wikipedia.org/wiki/ルンゲ＝クッタ法 "wikilink")
...
## 分子動力学シミュレーションソフトウエアパッケージ
  ...
  - [GROMACS](https://ja.wikipedia.org/wiki/GROMACS "wikilink")
  - [Materials Explorer](https://ja.wikipedia.org/wiki/Materials_Explorer "wikilink")
...
## 関連項目
  ...
  - [多体問題](https://ja.wikipedia.org/wiki/多体問題 "wikilink")
...
24.
25.
26. こういった手法のための方法論は[ウォーシェルと共同研究者らによって発表された](https://ja.wikipedia.org/wiki/アリー・ウォーシェル "wikilink")。近年、[アリー・ウォーシェル](https://ja.wikipedia.org/wiki/アリー・ウォーシェル "wikilink")（[南カリフォルニア大学](https://ja.wikipedia.org/wiki/南カリフォルニア大学 "wikilink")）、Weitao Yang（[デューク大学](https://ja.wikipedia.org/wiki/デューク大学 "wikilink")）、Sharon Hammes-Schiffer（[ペンシルベニア州立大学](https://ja.wikipedia.org/wiki/ペンシルベニア州立大学 "wikilink")）、Donald TruhlarおよびJiali Gao（[ミネソタ大学](https://ja.wikipedia.org/wiki/ミネソタ大学 "wikilink")）、Kenneth Merz（[フロリダ大学](https://ja.wikipedia.org/wiki/フロリダ大学 "wikilink")）を含む複数のグループによって開拓された。
27.
28.
29.
30.
