...
[TRPG冬の時代](https://ja.wikipedia.org/wiki/TRPG冬の時代 "wikilink")を超えた新しい時代のTRPG総合雑誌を目指して創刊された雑誌。

TRPG雑誌は[1990年代](../Page/1990年代.md "wikilink")前半までは多数の出版社から発行されていたのだが、1990年代後半の「TRPG冬の時代」に入ってTRPGの出版点数が減少すると、それに比例するように多くの雑誌が休刊してしまった。21世紀に入るとTRPGの出版点数は復調していったが、TRPGを扱う雑誌は特定ゲームメーカーの会報誌しか存在せず、多くのゲームがユーザーサポートを[インターネット](../Page/インターネット.md "wikilink")に頼っている状態になっていた。
...
## 主な記事
  ...
  - ゲームサポート
    毎号、発売されているゲームの中から何タイトルかをピックアップして詳細なゲーム紹介記事や[サプリメント的なサポート記事を載せている](https://ja.wikipedia.org/wiki/サプリメント_\(TRPG\) "wikilink")。この時、他社の雑誌でサポート記事の連載を一つも持っていないゲームについて優先的に記事が書かれる傾向にある。記事が連載されるゲームもあれば、掲載が一回きりのゲームもある。
...
## サポートする・されたTRPG
  ...
  - [ガープス](../Page/ガープス.md "wikilink") (GURPS)
      - ガープス・ユエル
  - [駆け出しアイドルRPG　ビギニングアイドル](https://ja.wikipedia.org/wiki/ビギニングアイドル "wikilink") ※
  - [神我狩](https://ja.wikipedia.org/wiki/神我狩 "wikilink") ※
  - [艦隊これくしょんRPG -艦これRPG-](https://ja.wikipedia.org/wiki/艦隊これくしょん_-艦これ- "wikilink")
...
## 関連項目
  ...
  - [うちのファンタジー世界の考察](https://ja.wikipedia.org/wiki/うちのファンタジー世界の考察 "wikilink") - [小林裕也](https://ja.wikipedia.org/wiki/小林裕也 "wikilink")による連載記事。

[Category:テーブルトークRPG雑誌](https://ja.wikipedia.org/wiki/Category:テーブルトークRPG雑誌 "wikilink") [Category:新紀元社](https://ja.wikipedia.org/wiki/Category:新紀元社 "wikilink")

1.  [Role\&Roll RPG](http://r-r.arclight.co.jp/rpg)。2017年7月8日閲覧。