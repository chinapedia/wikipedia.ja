...
**変調方式**（へんちょうほうしき）とは、[電気通信](../Page/電気通信.md "wikilink")において、基本信号（[搬送波](https://ja.wikipedia.org/wiki/搬送波 "wikilink")）に対して、その[振幅](https://ja.wikipedia.org/wiki/振幅 "wikilink")、[周波数](../Page/周波数.md "wikilink")、[位相](https://ja.wikipedia.org/wiki/位相 "wikilink")などを変化させる（変調する）ことにより信号を伝送する方式である。

## 概要

[モールス通信やアナログ式の](https://ja.wikipedia.org/wiki/モールス符号 "wikilink")[電話](../Page/電話.md "wikilink")などでは、信号を断続させたり、音波をそのまま電気信号に変換して通信を行っている（[ベースバンド伝送](https://ja.wikipedia.org/wiki/ベースバンド伝送 "wikilink")）。
...
これは20世紀の始め頃、三極管に始まる各種の増幅作用を持つ真空管の発明により始まった、エレクトロニクスにより実用的に可能になった技術である。有線においても同じ頃に、通信の[多重化](https://ja.wikipedia.org/wiki/多重化 "wikilink")による設備の有効利用などを目的とし、無線と同様に搬送波を変調する方式の通信が始まった。現代の、媒体として[光ケーブル](../Page/光ケーブル.md "wikilink")を用いる光通信でも、搬送波が電気信号でなく[光](../Page/光.md "wikilink")になる以外は同様である。
...
[Amfm3-en-de.gif](https://ja.wikipedia.org/wiki/File:Amfm3-en-de.gif "fig:Amfm3-en-de.gif") アナログ通信のための、振幅や周波数や位相などを連続的に変化させる変調方式である。ラジオで用いられている。
  ...
  - 角度変調
      ...
      - [位相変調](https://ja.wikipedia.org/wiki/位相変調 "wikilink") (PM、) : 搬送波の[位相](https://ja.wikipedia.org/wiki/位相 "wikilink")の変化。

## ディジタル変調

ディジタルな（離散的な、不連続な）情報の通信のための、振幅や周波数や位相などを不連的に変化させる変調方式である。

  - [位相偏移変調](https://ja.wikipedia.org/wiki/位相偏移変調 "wikilink") (PSK、) : 一定周波数の搬送波の位相を変化させることで変調するもの。変調1回あたりの送信ビット数を増やすごとに、BPSK、QPSKなどと呼ばれる。
...
搬送波が[矩形波](https://ja.wikipedia.org/wiki/矩形波 "wikilink")である方式の総称である。
...
アナログな情報を、いわゆるAD変換によって標本化・量子化し、ディジタルで通信する、という方式を指すものがパルス符号変調 (PCM）である。他は、パルスの振幅・幅・位相などを変調する方式で、変化量が連続的な場合と離散的な場合の、両方がある。
  ...
  - [パルス幅変調](https://ja.wikipedia.org/wiki/パルス幅変調 "wikilink") (PWM、)
  - [パルス振幅変調](https://ja.wikipedia.org/wiki/パルス振幅変調 "wikilink") (PAM、)
...
## 関連項目
  ...
  - [電波型式の表記法](https://ja.wikipedia.org/wiki/電波型式の表記法 "wikilink")
