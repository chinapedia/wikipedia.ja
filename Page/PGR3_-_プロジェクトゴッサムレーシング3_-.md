...
前作『PGR2』よりグラフィック、システム共に大幅に進化をとげている。前作の都市1つ分のポリゴンが車1台に集約され、約10万ポリゴンとなっている。フレームレートは30fpsだが、これだけの品質で[Xbox 360のCPUの](../Page/Xbox_360.md "wikilink")1コアしか使っていない。
...
### ディスクに収録されている車種
  ...
  - Aston Martin
    ...
    DBR9
  - Bentley
    [Continental GT](../Page/ベントレー・コンチネンタルGT.md "wikilink")
  - Cadillac
    [Sixteen](https://ja.wikipedia.org/wiki/:en:Cadillac_Sixteen "wikilink")
  - Callaway
  ...
  - [Elfin](https://ja.wikipedia.org/wiki/:en:Elfin_Sports_Cars "wikilink")
    MS8
  - [Farboud](https://ja.wikipedia.org/wiki/:en:Arash_Farboud "wikilink")
    GTS
  - Ferrari
    [288 GTO Evo](../Page/フェラーリ・288GTOEvoluzione.md "wikilink")
  ...
  - Ford
    ...
    SVT Mustang Cobra R
  - Honda
    [NSX](../Page/ホンダ・NSX.md "wikilink") GT2
  - Jaguar
    [XJ220](../Page/ジャガー・XJ220.md "wikilink")
    [XKR](../Page/ジャガー・XK.md "wikilink")
  - Joss
  ...
  - Palmer Jaguar
    JP1
  - Panoz
    [GTR-1 Coupe](https://ja.wikipedia.org/wiki/:en:Panoz_Esperante_GTR-1 "wikilink")
    [Panoz Esperante](https://ja.wikipedia.org/wiki/:en:Panoz_Esperante "wikilink") GTLM
  - [Radical](https://ja.wikipedia.org/wiki/:en:Radical_Sportscars "wikilink")
    SR3 Turbo
  - RUF
    [CTR](https://ja.wikipedia.org/wiki/RUF・CTR "wikilink") "Yellow Bird"
    [CTR-2](https://ja.wikipedia.org/wiki/:en:Ruf_CTR2 "wikilink")
    [RGT](https://ja.wikipedia.org/wiki/RUF・RGT "wikilink")
    [R Turbo](https://ja.wikipedia.org/wiki/:en:Ruf_RTurbo "wikilink")
    SuperCar Concept
  - Saleen
    [S281E](https://ja.wikipedia.org/wiki/サリーン・S281 "wikilink")
  ...
  - TVR
    ...
    [Typhon](https://ja.wikipedia.org/wiki/:en:TVR_Typhon "wikilink")
  - Ultima
    [GTR](https://ja.wikipedia.org/wiki/:en:Ultima_GTR "wikilink")
  - Volkswagen
    [W12 Nardo](https://ja.wikipedia.org/wiki/フォルクスワーゲン・W12ナルド "wikilink") Coupe
  - [Wiesmann](https://ja.wikipedia.org/wiki/:en:Wiesmann "wikilink")
    GT

### XBOX Live マーケットプレースで追加可能な車種

  - Aston Martin
    [V8 vantage](https://ja.wikipedia.org/wiki/アストンマーティン・V8ヴァンテージ "wikilink")(無料) ◎
  - Audi
  ...
  - Dodge
    Viper SRT-10 Coupe ◎
  - Ferrari
    [F612 Scaglietti](https://ja.wikipedia.org/wiki/フェラーリ・612スカリエッティ "wikilink") ◎
    [365 GTB4](https://ja.wikipedia.org/wiki/フェラーリ・365GTB/4 "wikilink") ("Daytona") ☆
    430 Challenge ☆
  - Gumpert
    [Apollo](https://ja.wikipedia.org/wiki/グンペルト・アポロ "wikilink") Coupe 4.2 V8 ☆
  - Lambolghini
    Gallardo SE ◎
  - Mitsubishi
    [Lancer Evolution](../Page/三菱・ランサーエボリューション.md "wikilink") VIII FQ-400 ◎
  - Nissan
    Nismo R34GT-R Z-Tune ◎
  - Mercedes-Benz
    [CLK](../Page/メルセデス・ベンツ・CLKクラス.md "wikilink") DTM AMG ☆
  - Pagani
    Zonda F ☆
  - Pontiac
    [GTO](../Page/ポンティアック・GTO.md "wikilink") ◎
  - Radical
    SR8 ◎
  - RUF
    [RT12](https://ja.wikipedia.org/wiki/:en:Ruf_Rt_12 "wikilink") ◎
