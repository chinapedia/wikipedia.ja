> この記事は[S@DE Communication](https://ja.wikipedia.org/wiki/S@DE_Communication)から翻訳されています。


**S@DE Communication**（サデ・コミュニケーション）は、[1999年](../Page/1999年.md "wikilink")4月 - [2003年](../Page/2003年.md "wikilink")3月に[FM山口が平日夕方のリクエストプログラムとして放送していた番組](https://ja.wikipedia.org/wiki/エフエム山口 "wikilink")。通称「**さでこみ**」。放送時間は月曜 - 木曜 19:00 - 19:55。
...
エンディングは月ごとに違う曲を使用。これは「paradise radio」に引き継いだ。
...
<!-- end list -->
  ...
  - 火曜日：井上尚美
  - 水曜日：品川佳奈子
  - 木曜日：古薗健作（ブラック）→引き続き、エフエム山口のパーソナリティとして「PROSOUND MUSIUM」や「COCO PARTY」の番宣などに出演していた
...
<!-- end list -->
  ...
  - 月曜日：川淵海（うみちゃん）
  - 火曜日：安部杏実（あずみん）→2008年まで[山口県立大学](../Page/山口県立大学.md "wikilink")在学中のままエフエム山口のパーソナリティとして「[Morning Street](https://ja.wikipedia.org/wiki/Morning_Street "wikilink")」「[Music Soldiers](https://ja.wikipedia.org/wiki/Music_Soldiers "wikilink")」などのパーソナリティーを務めていた。
  - 水曜日：上村咲予子（さよべぇ）
...
[Category:エフエム山口の帯番組](https://ja.wikipedia.org/wiki/Category:エフエム山口の帯番組 "wikilink") [Category:1999年のラジオ番組_(日本)](https://ja.wikipedia.org/wiki/Category:1999年のラジオ番組_\(日本\) "wikilink")