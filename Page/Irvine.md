...
なお、Iriaにおいても同様に、**OpenIria**のオープンソースでの開発が頓挫した経緯が有る。
  ...
  - 機能
    ...
    [CRC](../Page/巡回冗長検査.md "wikilink")・[MD5](../Page/MD5.md "wikilink")・[SHA-1](https://ja.wikipedia.org/wiki/SHA-1 "wikilink")のといった[ハッシュ関数](../Page/ハッシュ関数.md "wikilink")によるファイルの同一性の確認
    中断したダウンロードの[レジューム](https://ja.wikipedia.org/wiki/レジューム "wikilink")
    スクリプトによる機能拡張
    ファイルの[分割ダウンロード](https://ja.wikipedia.org/wiki/分割ダウンロード "wikilink")
    [インターネットエクスプローラー](../Page/Internet_Explorer.md "wikilink")・[ネットスケープ](https://ja.wikipedia.org/wiki/ネットスケープ "wikilink")・[モジラのメニュー拡張](../Page/Mozilla.md "wikilink")
    その他
...
## 外部リンク
  ...
  -
  -   -
[Category:ダウンロードマネージャ](https://ja.wikipedia.org/wiki/Category:ダウンロードマネージャ "wikilink") [Category:ネットワークソフト](https://ja.wikipedia.org/wiki/Category:ネットワークソフト "wikilink") [Category:フリーウェア](https://ja.wikipedia.org/wiki/Category:フリーウェア "wikilink") [Category:オープンソースソフトウェア](https://ja.wikipedia.org/wiki/Category:オープンソースソフトウェア "wikilink")