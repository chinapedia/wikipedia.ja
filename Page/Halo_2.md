...
『**ヘイロー 2**』（*Halo 2*）は、[バンジースタジオ](https://ja.wikipedia.org/wiki/バンジースタジオ "wikilink")により製作され[マイクロソフト](../Page/マイクロソフト.md "wikilink")により2004年に発売された[Xbox用ゲームソフトである](../Page/Xbox_\(ゲーム機\).md "wikilink")。本作は『[Halo: Combat Evolved](https://ja.wikipedia.org/wiki/Halo:_Combat_Evolved "wikilink")』に続く、[Haloシリーズの第二作目となる](https://ja.wikipedia.org/wiki/HALO_\(ビデオゲームシリーズ\) "wikilink")。
...
2007年9月13日にはXbox用の1作目と本作を同梱し、[Xbox 360用初代Xboxゲーム互換性アップデート](https://ja.wikipedia.org/wiki/Xbox_360 "wikilink") インストールディスクとXbox 360コントローラー対応表が付属する『Haloヒストリーパック』が発売された。
...
[前作同様の](https://ja.wikipedia.org/wiki/Halo:_Combat_Evolved "wikilink")[ファーストパーソン・シューティングゲーム](../Page/ファーストパーソン・シューティングゲーム.md "wikilink")（FPS）であり、主人公の視点がそのままゲーム画面となっている。基本的なシステムは前作を踏襲している。
...
## ストーリー
  ...
  -
    『[Halo 1](https://ja.wikipedia.org/wiki/Halo:_Combat_Evolved "wikilink")』と『Halo 2』の間のストーリーについては、小説『[Halo: First Strike](https://ja.wikipedia.org/wiki/Halo:_First_Strike "wikilink")』（日本語版はTOブックスより発売）で語られている。
...
結局元の英語版台詞“**Sir, finishing this fight**”を（『[Halo 3](https://ja.wikipedia.org/wiki/Halo_3 "wikilink")』があることを前提に）訳すと「**ケリをつけにきた**」が最適な訳になるため、現在では誤訳を元にした吹き替えという見方が強い。**ストーリーの根幹に関わる部分**であるが、最後発であるヒストリーパック版でも修正されていなかった。

2014年に発売された『Anniversary』では「ケリをつけてきます」と修正されている

[Xbox Liveマーケットプレイスにてダウンロードできる](https://ja.wikipedia.org/wiki/Xbox_Live "wikilink")『[Halo 3](https://ja.wikipedia.org/wiki/Halo_3 "wikilink")』ドキュメント映像『**Halo 3 ViDoc: Journey's End**』では、「**戦いを終わらせるのです**」という翻訳がなされている。
...
### 人類
  ...
  - [マスターチーフ](https://ja.wikipedia.org/wiki/マスターチーフ "wikilink")（Master Chief Petty Officer SPARTAN-117, John）
    前作に引き続き、本ゲームの[主人公](https://ja.wikipedia.org/wiki/主人公 "wikilink")となるキャラクター。通称「チーフ」。
    [アルファ・ヘイローから](https://ja.wikipedia.org/wiki/Halo:_Combat_Evolved "wikilink")[地球](https://ja.wikipedia.org/wiki/地球 "wikilink")に帰還するものの、コヴナントの突然の侵攻により、最新鋭の「ミョルニル・アーマー MkVI」に身を包んで戦火の中にその身を投じる。
  - コルタナ（Cortana）
  ...
  - ジョンソン軍曹（Sergent Major Avery J. Johnson）
    何故かチーフと共に生還を成し遂げた人類最強のタフネスと[根性](https://ja.wikipedia.org/wiki/根性 "wikilink")を持つ[軍曹](https://ja.wikipedia.org/wiki/軍曹 "wikilink")。
    小麦色の肌と[葉巻](https://ja.wikipedia.org/wiki/葉巻 "wikilink")、[帽子](../Page/帽子.md "wikilink")が[トレードマーク](https://ja.wikipedia.org/wiki/トレードマーク "wikilink")であり、印象的な[台詞](https://ja.wikipedia.org/wiki/台詞 "wikilink")が多い。マスターチーフより体力が大きいかもしれない。
  ...
  - テレンス・フッド提督（Freet Admiral Terrence Hood）
    地球防衛[プラットフォーム](https://ja.wikipedia.org/wiki/プラットフォーム "wikilink")である「ステーション・カイロ」の[司令官](https://ja.wikipedia.org/wiki/司令官 "wikilink")。『Halo 2』の戦闘の始まりは、彼がチーフ、キース中佐、ジョンソン軍曹にメダルを提示した直後に発生する。
    戦闘開始後はステーション・カイロにて、カイロに隣接する防衛ステーション「ヴァルター」「アテネ」そしてハーパー元帥率いる[艦隊](https://ja.wikipedia.org/wiki/艦隊 "wikilink")と共に、コヴナント軍から地球を守ろうとする。
...
### コヴナント
  ...
  - タルタロス（Tartarus）
    ブルート族の首領。[アルビノ](https://ja.wikipedia.org/wiki/アルビノ "wikilink")。真実の預言者の側近を務める。重力を操る巨大な槌を手に持ち、戦闘時には強靭なシールドを展開し身を守る。[モヒカンがトレードマーク](https://ja.wikipedia.org/wiki/モヒカン刈り "wikilink")。HALO起動直前にアービターにより殺害される。
  - アールタス・ヴァダム（Rtas 'Vadum）
    コヴナントの特殊部隊の司令官を務めるエリート。アービターとともに異端者掃討の任に当たる。劇中での呼称は「リーダー」。
  - セサ・レフュミー（Sesa 'Refumee）
    反乱を起こした異端者のリーダー。コヴナント艦隊パーティキュラー・ジャスティスの元司令官。同艦隊を率いてガス惑星の調査に来た際にギルティ・スパークと遭遇、HALOの真の機能を知ることになった。これを機にコヴナントに対して反旗を翻す。ゲーム中では「異端者」と呼ばれるだけで具体的な名前は不明であったが、[アクションフィギュア](https://ja.wikipedia.org/wiki/アクションフィギュア "wikilink")より名前が判明した。
...
### フラッド
  ...
  - [キャリア](https://ja.wikipedia.org/wiki/無症候性キャリア "wikilink")（Flood Carrier Form）
...
### 武器
  ...
  - コヴナントカービン（Covenant Carbine）
    文字通りコヴナントの[カービン](https://ja.wikipedia.org/wiki/カービン "wikilink")銃。威力はバトルライフルに匹敵し、2倍ズーム可能。セミオートなので、トリガーを引き続けても、連射できない。
  ...
  - ロッドガン（Fuel Rod Cannon）
    高放射性[燃料ロッドを発射する](https://ja.wikipedia.org/wiki/燃料棒 "wikilink")、コヴナントのバズーカ。前作より弾道が直線的になった一方、弾速は遅くなった。本作以降はバッテリー式ではなくマガジンタイプになる。
...
複数のプレイヤーが参加して、各種ルールの下で戦うモード。システムリンクのみに対応していた前作とは異なり、本作ではシステムリンクだけではなく[Xbox Liveを利用したオンラインでのマルチプレイが可能となっている](https://ja.wikipedia.org/wiki/Xbox_Live "wikilink")。またWindows Vista版では[Games for Windows - Live対応となっている](https://ja.wikipedia.org/wiki/Games_for_Windows_-_Live "wikilink")。
...
本作では、バランス・バグの修正やチート・不正対策を含むタイトルアップデートだけではなく、マルチプレイヤーモード用の対戦マップを[Xbox Liveを通して配信している](https://ja.wikipedia.org/wiki/Xbox_Live "wikilink")。

  - Bonus Map Pack - 2005年4月25日に[マウンテンデュー](https://ja.wikipedia.org/wiki/マウンテンデュー "wikilink")をスポンサーとしてフリーでリリースされた。マルチプレイヤー用マップの"Containment"と"Warlock"を収録。
...
2005年7月7日に『**ヘイロー 2 マルチプレイヤーマップパック**』（***Halo 2 Multiplayer Map Pack***）が1480円で限定生産・発売された（北米での発売日は2005年7月5日）。 これは[Xbox Liveを利用できないユーザ向けに](https://ja.wikipedia.org/wiki/Xbox_Live "wikilink")、タイトル・アップデートのほか、Bonusmap Map Pack、Killtacular Pack、Maptacular Packに加えて以下のものを収録したものとなっている。
...
Haloシリーズの音楽はシリーズを通して評価が高く、今回もその例外ではない。前作のメインテーマは男性コーラスのみだったが、今回はその逆で女性コーラスとなっている。『Halo ２』の音楽は前作と比べ、[ロック要素などが入れられており](../Page/ロック_\(音楽\).md "wikilink")、前作とは一味違った部分も感じられる。また、それらの楽曲には[スティーヴ・ヴァイ](https://ja.wikipedia.org/wiki/スティーヴ・ヴァイ "wikilink")や[インキュバス](../Page/インキュバス_\(バンド\).md "wikilink")、[フーバスタンク](https://ja.wikipedia.org/wiki/フーバスタンク "wikilink")が参加している。
...
また、2004年ホリデーシーズンにおけるXbox本体の売上げが前年同期間より約50%増加するなど、本作はプラットフォームの販売を強力に牽引する[キラータイトルになった](https://ja.wikipedia.org/wiki/キラーソフト "wikilink")\[5\]。
