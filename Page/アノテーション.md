...
**アノテーション**（[英語](../Page/英語.md "wikilink")：annotation）とは、ある[データ](../Page/データ.md "wikilink")に対して関連する情報（[メタデータ](https://ja.wikipedia.org/wiki/メタデータ "wikilink")）を注釈として付与すること。[XML等の記述形式を用いてメタデータを](../Page/Extensible_Markup_Language.md "wikilink")[タグ付けする場合が多い](https://ja.wikipedia.org/wiki/タギング_\(コンピュータ\) "wikilink")。付与したメタデータや[タグ](https://ja.wikipedia.org/wiki/タグ "wikilink")を指してアノテーションという場合もある。

## Javaにおけるアノテーション

Javaの**アノテーション**は[クラスや](../Page/クラス_\(コンピュータ\).md "wikilink")[インタフェース](https://ja.wikipedia.org/wiki/インタフェース_\(抽象型\) "wikilink")、[メソッドや](../Page/メソッド_\(計算機科学\).md "wikilink")[フィールド](../Page/フィールド_\(計算機科学\).md "wikilink")、[パッケージなどに対して](../Page/パッケージ_\(Java\).md "wikilink")[メタデータ](https://ja.wikipedia.org/wiki/メタデータ "wikilink")として付加情報を記入する機能で、[Java SE](../Page/Java_Platform,_Standard_Edition.md "wikilink") 5 で追加された。
...
### Java標準APIの主なアノテーション
  ...
  - – 対象となる[クラスや](../Page/クラス_\(コンピュータ\).md "wikilink")[メソッド](https://ja.wikipedia.org/wiki/メソッド "wikilink")が非推奨であることを情報として付加する。[Javadoc](https://ja.wikipedia.org/wiki/Javadoc "wikilink")の@deprecatedと同じ。

  - – その[メソッド](https://ja.wikipedia.org/wiki/メソッド "wikilink")が[スーパークラスの](../Page/スーパークラス_\(計算機科学\).md "wikilink")[メソッド](https://ja.wikipedia.org/wiki/メソッド "wikilink")を[オーバーライド](https://ja.wikipedia.org/wiki/オーバーライド "wikilink")していることを示す。[C\#のoverride修飾子とほぼ同等の機能を果たす](../Page/C_Sharp.md "wikilink")。
...
### JUnit4 から利用可能になったアノテーション
  ...
  - @Test – そのメソッドがテストメソッドであることを示す。このメソッドにテストを記述する。従来の[JUnit](https://ja.wikipedia.org/wiki/JUnit "wikilink")でメソッド名が`test`で始まるメソッドと同じ。
...
クラスやメソッドにマーカーアノテーションを付加するには以下のようクラスやメソッドの接頭辞に最低一つ以上のスペースまたは[改行コード](https://ja.wikipedia.org/wiki/改行コード "wikilink")を入れて[修飾子](https://ja.wikipedia.org/wiki/修飾子 "wikilink")のように記述する。 この例は、クラスに非推奨、メソッドに、スーパークラスからのメソッドをオーバーライドしていることを意味するマーカーアノテーションを付加している例である。
...
[Microsoft Visual C++は](https://ja.wikipedia.org/wiki/Microsoft_Visual_C++ "wikilink")、SAL注釈 (SAL annotation) と呼ばれる独自のソースコード注釈言語をサポートする\[1\]。SAL注釈は[関数の](https://ja.wikipedia.org/wiki/サブルーチン "wikilink")[引数](../Page/引数.md "wikilink")や[戻り値](https://ja.wikipedia.org/wiki/戻り値 "wikilink")、[構造体](../Page/構造体.md "wikilink")やクラスのメンバー変数（フィールド）といった[C言語](../Page/C言語.md "wikilink")/[C++](../Page/C++.md "wikilink")の構文要素を修飾し、振る舞いや仕様を規定することで、これらを利用するコード上の誤りをコンパイラによって指摘することができるようになる。また、SAL注釈によって仕様が明確になり、公開されたヘッダーファイルそのものが[APIドキュメントとして利用できるようになる](https://ja.wikipedia.org/wiki/Application_Programming_Interface "wikilink")。Visual C++がサポートするコード分析機能（`/analyze`）はSAL注釈に対応しており\[2\]、通常のコンパイラ警告よりも詳細なヒントやアドバイスを出力することができる。

## 脚注

## 関連項目

  - [注釈](https://ja.wikipedia.org/wiki/注釈 "wikilink")
