...
## ゲームモード
  ...
  - キャリア
    本作のメインモード。
    エンジェルシティを舞台に8人のライバルたちとレースをしながら自分のスキルを向上させ、すべてのライバルから最高の尊敬を勝ち取るのが最終目的になる。
  - アーケード
    全5戦のシリーズを戦うもの。様々なイベントをクリアすることで「カスタムレース」で使えるクルマやコースが増えていく。
  - カスタムレース
    「アーケード」でアンロックしたクルマとコースで、自分の好きな様にレースを作れるモード。
  - マルチプレイ
    分割画面による2人対戦ができる。
  - オプション
    ゲームの各種設定が行える。
...
## 登場車両
  ...
  - [プジョー](../Page/プジョー.md "wikilink")
      - [206GTI](../Page/プジョー・206.md "wikilink")
  - [フォルクスワーゲン](https://ja.wikipedia.org/wiki/フォルクスワーゲン "wikilink")
      - [ゴルフMKIV](../Page/フォルクスワーゲン・ゴルフ.md "wikilink")
      - [ビートルGLS1.8T](https://ja.wikipedia.org/wiki/フォルクスワーゲン・ビートル "wikilink")
      - [コラードVR6](../Page/フォルクスワーゲン・コラード.md "wikilink")
  ...
  - [スバル](https://ja.wikipedia.org/wiki/スバル "wikilink")
      - [インプレッサWRX STi（GDB丸目）](../Page/スバル・インプレッサ.md "wikilink")
...
## サウンド
  ...
  - [モノラル](https://ja.wikipedia.org/wiki/モノラル "wikilink")

から選べる。

## 外部リンク

  - [公式サイト](http://juiced.sega.jp/)

[Category:カーレースゲーム](https://ja.wikipedia.org/wiki/Category:カーレースゲーム "wikilink") [Category:セガのゲームソフト](https://ja.wikipedia.org/wiki/Category:セガのゲームソフト "wikilink") [Category:PlayStation_2用ソフト](https://ja.wikipedia.org/wiki/Category:PlayStation_2用ソフト "wikilink") [Category:2005年のコンピュータゲーム](https://ja.wikipedia.org/wiki/Category:2005年のコンピュータゲーム "wikilink")