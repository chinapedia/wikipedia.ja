...
### 以降のシリーズにも引き継がれた大きな変更点
  ...
  - モモトラマン・金太郎カードは持っているだけでは効果が発動せず、事前にカードを使用しスてタンバイさせることが必要となった。負けない限り、何度出動してもスタンバイは解除されない。
  ...
  - 初登場の「銀河鉄道カード」により、宇宙マップに行けるようになった\[2\]。シリーズ初の別マップである。
  ...
  - 「ゲーム途中で新たに出現する駅」が初登場。
      ...
      - エロマンガ島駅・[関西国際空港](https://ja.wikipedia.org/wiki/関西国際空港 "wikilink")の登場の影響で海外のマップが大幅に変更された。
...
<div style="float: left; vertical-align: top; white-space: nowrap; margin-right: 1em;">
  ...
  - **[エロマンガ](https://ja.wikipedia.org/wiki/イロマンゴ島 "wikilink")**（イベントで出現）
  - 秋田沖（イベントで出現）
...
### ロボット研究所（4駅）
  ...
  - [知床](https://ja.wikipedia.org/wiki/知床駅 "wikilink")
...
## 関連書籍
  ...
  - ワンダーライフスペシャル ハドソン公式ガイドブック スーパー桃太郎電鉄DX (ISBN 4-09-102525-0)
  - ベストセラーズ スーパー桃太郎電鉄DX究極本 (ISBN 4584160317)
      - ベストセラーズ版の本によると、女湯イベントの画像は、元々もう少し露出があった事が画像付きで記されている。
  - 月刊ファミ通Bros.攻略本シリーズ Super桃太郎電鉄DXプレイングマニュアル (ISBN 4893664522)
  - 覇王ゲームスペシャル スーパー桃太郎電鉄DXいい日旅立ち攻略ガイド (ISBN 4063292428)
