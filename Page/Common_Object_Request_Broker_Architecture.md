...
## CORBA 実装例
  ...
  - [Oracle Tuxedo](https://ja.wikipedia.org/wiki/Oracle_Tuxedo "wikilink") - CORBA 2.5 対応の商用 ORB （[Java](https://ja.wikipedia.org/wiki/Java "wikilink")、[C++](../Page/C++.md "wikilink")用）[オラクル](../Page/オラクル_\(企業\).md "wikilink")
