...
*C* が[アーベル圏](https://ja.wikipedia.org/wiki/アーベル圏 "wikilink")ならば任意個（無限個でもよい）の対象の直和が存在する（グロタンディークの公理 AB3)）から、\(\varinjlim F\) は任意の函手 *F*: *I* → *C* に対して表現可能であり、
...
## 例
  ...
  - 直極限と逆極限の間には
    ...
    を通じた相互関係がある。
  - 列 {*A*<sub>*n*</sub>, φ<sub>*n*</sub>} で *A*<sub>*n*</sub> は[C\*-環](https://ja.wikipedia.org/wiki/C*-環 "wikilink")、φ<sub>*n*</sub>: *A*<sub>*n*</sub> → *A*<sub>*n*+1</sub> は \*-準同型とする。直極限構成の C\*-類似は上述の普遍性を満足する C\*-環によって与えられる。
