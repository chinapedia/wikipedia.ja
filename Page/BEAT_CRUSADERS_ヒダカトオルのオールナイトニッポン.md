...
<!-- end list -->
  ...
  - コーナー終了間際の週から、ライブでのマナーについての議論も繰り広げるようになり、その時間帯は**マナークルセイダース**と呼ばれる。
...
<!-- end list -->
  ...
  - 「エロイ陸上」から、カトウタロウが**オダユウゾウ**（[織田裕二](../Page/織田裕二.md "wikilink")をもじっている）というキャラクターで登場する。
...
<!-- end list -->
  ...
  - 温暖化が進み叫ばれるエコな時代に、無駄なアイドリングをストップさせるなら、無駄な[エレクトも止めるべきだというコンセプト](https://ja.wikipedia.org/wiki/勃起 "wikilink")。
...
#### ロック・パンク学部 パンクス・ノット・デット
  ...
  - 基本的に笑えるネタが多く、最近ではヤマネ（あるリスナーの友人）シリーズが鉄板となっている。
...
<!-- end list -->
  ...
  - [とんねるずのみなさんのおかげでした](../Page/とんねるずのみなさんのおかげでした.md "wikilink")の「新・食わず嫌い王決定戦」をモチーフとしたゲストクイズコーナー。
...
### 2008年
  ...
  - [1月28日](../Page/1月28日.md "wikilink")：[bonobos](https://ja.wikipedia.org/wiki/bonobos "wikilink")（蔡忠浩、佐々木康之、森本夏子）
...
## 外部リンク
  ...
  - [ヒダカトオルのオールナイトニッポン](http://www.allnightnippon.com/omen/)
  - [ザ・ライバル公式サイト](http://www.the-rival.net/)
      - 番組内コーナー「ザ・ライバル」に関するサイト。

[Category:BEAT_CRUSADERS](https://ja.wikipedia.org/wiki/Category:BEAT_CRUSADERS "wikilink") [Category:オールナイトニッポン](https://ja.wikipedia.org/wiki/Category:オールナイトニッポン "wikilink") [Category:2007年のラジオ番組_(日本)](https://ja.wikipedia.org/wiki/Category:2007年のラジオ番組_\(日本\) "wikilink") [Category:長大な項目名](https://ja.wikipedia.org/wiki/Category:長大な項目名 "wikilink")