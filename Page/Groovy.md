...
[Category:スクリプト言語](https://ja.wikipedia.org/wiki/Category:スクリプト言語 "wikilink") [Category:Java_specification_requests](https://ja.wikipedia.org/wiki/Category:Java_specification_requests "wikilink") [Category:オブジェクト指向言語](https://ja.wikipedia.org/wiki/Category:オブジェクト指向言語 "wikilink") [Category:Java仮想マシンで動作するプログラミング言語](https://ja.wikipedia.org/wiki/Category:Java仮想マシンで動作するプログラミング言語 "wikilink")
