> この記事は[BIS](https://ja.wikipedia.org/wiki/BIS)から翻訳されています。


**BIS**

  - [Bank for International Settlements (BIS)](../Page/国際決済銀行.md "wikilink") - 国際決済銀行の英称略。国際特殊銀行。
  - [BlackBery Internet Service (BIS)](../Page/BlackBerry_Internet_Service.md "wikilink") - ブラックベリーインターネットサービスの略
  ...
  - [bispectral index (BIS)](https://ja.wikipedia.org/wiki/バイスペクトラルインデックス "wikilink") - 麻酔深度・鎮静度を表す指標。

-----

**bis**

  - [bis (ISO 639)](https://ja.wikipedia.org/wiki/bis_\(ISO_639\) "wikilink")

  - 「二度」「第二の」等の意を持ち、戦車等の兵器に「改良型」「2型」という意でよく用いられる。また、フランス語で「[アンコール](../Page/アンコール.md "wikilink")」を表す。

  - [言語](../Page/言語.md "wikilink")の名称の[国際標準](https://ja.wikipedia.org/wiki/国際標準化機構 "wikilink")、[ISO 639において](../Page/ISO_639.md "wikilink")[ビスラマ語](https://ja.wikipedia.org/wiki/ビスラマ語 "wikilink")を表すコード。
...
**BiS**
  ...
  - [BiS](https://ja.wikipedia.org/wiki/BiS "wikilink") - 新生アイドル研究会。[プー・ルイ](https://ja.wikipedia.org/wiki/プー・ルイ "wikilink")が立ち上げた女性アイドルグループ。
