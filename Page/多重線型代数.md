...
次の自由  –加群（ が体のときには  次元のベクトル空間） の[対称代数は](https://ja.wikipedia.org/wiki/#対称代数 "wikilink")  を係数とする  変数の[多項式環](https://ja.wikipedia.org/wiki/多項式環 "wikilink") *X* ,..., *X* {{)\!}}}} と見なせる。
...
## 関連項目
  ...
  - [テンソル代数](https://ja.wikipedia.org/wiki/テンソル代数 "wikilink")
  - [対称代数](https://ja.wikipedia.org/wiki/対称代数 "wikilink")
  - [外積代数](https://ja.wikipedia.org/wiki/外積代数 "wikilink")
  - [ファイバー束](https://ja.wikipedia.org/wiki/ファイバー束 "wikilink")
