...
以上の手順でBotを使用する準備が出来ました。Botの実行には、OSのコマンドラインを使用します。
  ...
  - **Linux**または**Unix**系OSでは、[gnome-terminal](../Page/GNOME_端末.md "wikilink")、[Konsole](../Page/Konsole.md "wikilink")、[xterm](https://ja.wikipedia.org/wiki/xterm "wikilink")、テキストモードコンソールなど何を使ってもいいです。
...
## 関連項目
  ...
  - [プロジェクト:Bot](../Page/プロジェクト:Bot.md "wikilink")
