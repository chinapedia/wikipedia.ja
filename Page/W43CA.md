...
2007年3月29日に以下の不具合の修正がケータイアップデートにより行われた。
  ...
  - [au ICカードの情報を読み込み中に電源の再起動を繰り返す場合がある](https://ja.wikipedia.org/wiki/au_ICカード "wikilink")

## 関連項目

  - [QUICPay](../Page/QUICPay.md "wikilink") - ネイビーインクがCMで使用

## 外部リンク

  - [au by KDDI](http://www.au.kddi.com/)
  - [KDDI au: オンラインマニュアル \> W43CA](http://www.au.kddi.com/manual/w43ca/index.html)
