...
日本の[義務教育](https://ja.wikipedia.org/wiki/義務教育 "wikilink")ではこの公式は学習しないことが多い。
...
ピックの定理を用いると全ての[頂点](https://ja.wikipedia.org/wiki/頂点 "wikilink")が格子点上にある**格子[正多角形](https://ja.wikipedia.org/wiki/正多角形 "wikilink")**は[正四角形以外には存在しないことが示せる](../Page/正方形.md "wikilink")。
例えば一辺が a の[正三角形](../Page/正三角形.md "wikilink")の[面積](../Page/面積.md "wikilink") S は

\[S = \frac{\sqrt{3}}{4} a^2\] である。\(a^2 \,\) は格子点間の[距離](../Page/距離.md "wikilink")の二乗なので、[三平方の定理から](../Page/ピタゴラスの定理.md "wikilink")\(a^2 \,\) は整数である。したがって格子正三角形の面積 S は [√3](https://ja.wikipedia.org/wiki/3の平方根 "wikilink") が
...
[Category:ユークリッド幾何学の定理](https://ja.wikipedia.org/wiki/Category:ユークリッド幾何学の定理 "wikilink") [Category:多角形](https://ja.wikipedia.org/wiki/Category:多角形 "wikilink") [Category:格子点](https://ja.wikipedia.org/wiki/Category:格子点 "wikilink") [Category:数学に関する記事](https://ja.wikipedia.org/wiki/Category:数学に関する記事 "wikilink")