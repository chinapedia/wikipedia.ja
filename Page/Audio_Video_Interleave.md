...
AVIを含むRIFFファイルは、バイナリのままでも[可読性](https://ja.wikipedia.org/wiki/可読性 "wikilink")が高く構造を理解しやすい。また、AVIを扱うAPI（Video for Windows）をWindowsが提供しているため、対応ソフトウェアを開発しやすく、実際に多数のソフトウェアが公開されている。
...
## 利用例
  ...
  - [ファイル共有ソフト](https://ja.wikipedia.org/wiki/ファイル共有ソフト "wikilink")での動画の交換、共有。
...
<!-- end list -->
  ...
  - [WMV7](https://ja.wikipedia.org/wiki/Windows_Media_Video "wikilink")/WMV8/WMV9（WMV1/WMV2/WMV3） - 通常は[ASF](https://ja.wikipedia.org/wiki/ASF "wikilink")コンテナが使われる。
  ...
  - [H.264](https://ja.wikipedia.org/wiki/H.264 "wikilink")（AVC1/DAVC/H264/X264）
  - [H.263](https://ja.wikipedia.org/wiki/H.263 "wikilink")/[H.263](https://ja.wikipedia.org/wiki/H.263 "wikilink")+（H263/S263）
  - [H.261](https://ja.wikipedia.org/wiki/H.261 "wikilink")（H261）
  ...
  - [Theora](https://ja.wikipedia.org/wiki/Theora "wikilink")（THEO） - 通常は[Ogg](https://ja.wikipedia.org/wiki/Ogg "wikilink")コンテナが使われる。
  ...
  - [VC-1](https://ja.wikipedia.org/wiki/VC-1 "wikilink")（WVC1）
...
<!-- end list -->
  ...
  - [HE-AAC](https://ja.wikipedia.org/wiki/HE-AAC "wikilink")
  ...
  - [Vorbis](https://ja.wikipedia.org/wiki/Vorbis "wikilink") - VBR（[可変ビットレート](../Page/可変ビットレート.md "wikilink")）メインで設計されており、CBR（[固定ビットレート](https://ja.wikipedia.org/wiki/固定ビットレート "wikilink")）は擬似方式のみサポートのため、互換性に難がある。
