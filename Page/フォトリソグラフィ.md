...
[Clean_room.jpg](https://ja.wikipedia.org/wiki/File:Clean_room.jpg "fig:Clean_room.jpg")内で行われる。\]\] **フォトリソグラフィ**（）は、感光性の物質を塗布した物質の表面を、パターン状に露光（パターン露光、像様露光などとも言う）することで、露光された部分と露光されていない部分からなるパターンを生成する技術。主に、[半導体](../Page/半導体.md "wikilink")素子、[プリント基板](../Page/プリント基板.md "wikilink")、[印刷](../Page/印刷.md "wikilink")版、[液晶ディスプレイ](https://ja.wikipedia.org/wiki/液晶ディスプレイ "wikilink")パネル、[プラズマディスプレイ](https://ja.wikipedia.org/wiki/プラズマディスプレイ "wikilink")パネルなどの製造に用いられる。

## 半導体素子の製造

半導体素子の製造においてフォトリソグラフィは次のように行われる。[シリコン](https://ja.wikipedia.org/wiki/シリコン "wikilink")、[ヒ化ガリウム](../Page/ヒ化ガリウム.md "wikilink")等の[半導体](../Page/半導体.md "wikilink")[ウェハー](https://ja.wikipedia.org/wiki/ウェハー "wikilink")上に**[フォトレジスト](../Page/フォトレジスト.md "wikilink")**と呼ばれる[感光性有機物質](https://ja.wikipedia.org/wiki/感光性有機物質 "wikilink")を塗布し、**[ステッパー](https://ja.wikipedia.org/wiki/ステッパー "wikilink")**と呼ばれる[露光](https://ja.wikipedia.org/wiki/露光 "wikilink")装置を用いて、**[レチクル](https://ja.wikipedia.org/wiki/レチクル "wikilink")**と呼ばれる[フォトマスク](https://ja.wikipedia.org/wiki/フォトマスク "wikilink")に描かれた素子・回路のパターンを焼き付ける。以下、工程をさらに詳しく説明する。
...
ウェハーに単に凹凸を付けたい場合、あるいは元々ウェハー上にパターンが作成されていた場合などは、[エッチング](https://ja.wikipedia.org/wiki/エッチング "wikilink")によって不要な部分を除去する。[ドライエッチング](https://ja.wikipedia.org/wiki/ドライエッチング "wikilink")と[ウェットエッチング](https://ja.wikipedia.org/wiki/ウェットエッチング "wikilink")が存在する。レジストの残っている部分はエッチングによって除去されないため、残したいパターンがウェハー上に形成される。最後に溶剤などによってレジストを完全に除去する。
