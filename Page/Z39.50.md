...
**Z39.50**は遠隔の[データベース](../Page/データベース.md "wikilink")に対して[情報検索](https://ja.wikipedia.org/wiki/情報検索 "wikilink")を行うための[クライアント・サーバ型](https://ja.wikipedia.org/wiki/クライアント・サーバ型 "wikilink")[通信プロトコル](../Page/通信プロトコル.md "wikilink")である。[ANSI](https://ja.wikipedia.org/wiki/ANSI "wikilink")/[NISO](https://ja.wikipedia.org/wiki/NISO "wikilink")標準および[ISO国際標準](https://ja.wikipedia.org/wiki/国際標準化機構 "wikilink")（ISO 23950）となっており、標準の管理は[米国議会図書館](https://ja.wikipedia.org/wiki/米国議会図書館 "wikilink")が行っている。

## 概要

Z39.50プロトコルは異なるプラットフォーム上で動作するオンライン検索システム間の相互運用性を確保する目的で開発され、しばしば総合目録システムや統合検索を実現するために利用されてきた\[1\]。1990年代には欧米の[図書館](../Page/図書館.md "wikilink")業界で広く採用され、[図書館管理システム](https://ja.wikipedia.org/wiki/図書館管理システム "wikilink")および個人用の[参照文献管理ソフトウェア](https://ja.wikipedia.org/wiki/参照文献管理ソフトウェア "wikilink")等で利用されている。[図書館間相互貸借](https://ja.wikipedia.org/wiki/図書館間相互貸借 "wikilink")用の[蔵書検索](https://ja.wikipedia.org/wiki/蔵書検索 "wikilink")もZ39.50を通じて行う実装も出ている。

Z39.50の開発は[1970年代](../Page/1970年代.md "wikilink")に始まり、[1988年](../Page/1988年.md "wikilink")、[1992年](https://ja.wikipedia.org/wiki/1992年 "wikilink")、[1995年](https://ja.wikipedia.org/wiki/1995年 "wikilink")にそれぞれプロトコルの第1版から第3版が発表された。情報検索に関わる要求として、検索(Search)、表示(Retrieve)、ソート(Sort)、索引語ブラウズ(Scan)などの多くの機能を含んでいる。検索要求はアトリビュートと呼ばれる属性を用いて表現され、通常は「Bib-1」アトリビュートセットが使われる。
...
Z39.50は[WWW出現以前の技術であり](../Page/World_Wide_Web.md "wikilink")、ウェブ普及以降のより現代的な環境に沿うように作り変えようという試みもいくつかある。これらの試みは ZING (Z39.50 International: Next Generation) と呼ばれるグループおよび仕様群としてまとめられ、新たな方向性を打ち出している。最も重要な提案は2つのほぼ対となる仕様 [Search/Retrieve via URL](https://ja.wikipedia.org/wiki/Search/Retrieve_via_URL "wikilink")/[Search/Retrieve Web Service](https://ja.wikipedia.org/wiki/Search/Retrieve_Web_Service "wikilink") (SRU/SRW) である。この2つの仕様ではZ39.50通信プロトコルへの対応を完全に廃止し、[HTTPプロトコルに基づくものとした上で](../Page/Hypertext_Transfer_Protocol.md "wikilink")、検索要求の構造といった利点を活かそうとする方向で仕様が作られた。SRUは[RESTに基づくもので](https://ja.wikipedia.org/wiki/Representational_State_Transfer "wikilink")、検索要求を[URLのquery](../Page/Uniform_Resource_Locator.md "wikilink")-stringにて表現できるようにしたものである。一方、SRWは[SOAPを使い](../Page/SOAP_\(プロトコル\).md "wikilink")、検索要求を[XMLに基づく表現で送る](../Page/Extensible_Markup_Language.md "wikilink")。どちらも、検索要求に対するサーバからの応答には、XMLを使用することを前提としている。これらのプロトコルは、広く採用されている[Webサービス](https://ja.wikipedia.org/wiki/Webサービス "wikilink")向けツールを採用することで、図書館向けソフトウェアという比較的狭い範囲の市場に対してもその適用が容易になり、Z39.50プロトコルよりも開発者の参入障壁が低くなることが期待できる。Z39.50仕様に基づいた検索式記述言語[CQL](https://ja.wikipedia.org/wiki/CQL "wikilink")も同時に開発された(CQLはSRU Vesion1.1ではCommon Query Languageを表すものとされたが, Version1.2で[Contextual Query Languageに改められた](https://ja.wikipedia.org/wiki/Contextual_Query_Language "wikilink"))。

## 参照文献

## 関連項目

  - [Wide Area Information Server](https://ja.wikipedia.org/wiki/Wide_Area_Information_Server "wikilink") (WAIS)
