...
その後、IEEE 1076-1993\[1\]、IEEE 1076-2000\[2\]、IEEE 1076-2002\[3\]、IEEE 1076-2008\[4\] と改定し、IECが同一規格を発行するようになった。[WTO/TBT協定で](../Page/貿易の技術的障害に関する協定.md "wikilink")、国際取引の技術基準は国際規格を尊重することになっているため、IECの規格文書として発行することに合意したものである。
