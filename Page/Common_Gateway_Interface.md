...
CGI は環境変数や標準入出力の扱える[プログラミング言語](../Page/プログラミング言語.md "wikilink")であれば、どの言語を用いても作成することができるが、主にPHP、Perl、Javaで作成されることが多い。
...
このため、比較的新しいウェブサーバアプリケーションでは、CGIを直接動作させる機能を持たないものも存在する。
  ...
  - [H2O](../Page/H2O_\(Webサーバ\).md "wikilink"): [fastcgi-cgi](https://h2o.examp1e.net/configure/cgi.html)により、FastCGIとして動作させる。
...
## 参考文献
  ...
  - [The CGI Specification(archive.org)](https://web.archive.org/web/20070809114039/hoohoo.ncsa.uiuc.edu/cgi/interface.html)
