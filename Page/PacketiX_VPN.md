...
PacketiX VPN では、接続先のVPNサーバが提示するX.509証明書とSSLプロトコル内で行われる正当性検証手続きにより、接続先のVPNサーバが本物であるかどうかの検証が可能である。検証に失敗した場合はVPN接続を中止し、[中間者攻撃](../Page/中間者攻撃.md "wikilink")を防止する。
