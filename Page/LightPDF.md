...
## 機能
  ...
  - PDFの変換（PDFとパワーポイント/エクセル/Word/JPG/PNGの相互変換＆PDFからTXTへの変換）
  - PDFの編集
  - PDFに注釈を追加
  - PDFの圧縮 ・結合・分割・回転
  - PDFに署名・透かしを追加
...
## 外部リンク
  ...
  - [LightPDF](https://lightpdf.com/jp/)
  - [LightPDFの評価・使い方 - フリーソフト100](https://freesoft-100.com/review/lightpdf.html)
  - [PDF編集・無料OCRソフトのおすすめ「LightPDF」の使い方を解説](https://aprico-media.com/posts/2460)
