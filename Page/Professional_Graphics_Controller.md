> この記事は[Professional Graphics Controller](https://ja.wikipedia.org/wiki/Professional_Graphics_Controller)から翻訳されています。
...
PGCは次の機能を持っている。
  ...
  - [CGA互換のテキストおよびグラフィックモード](../Page/Color_Graphics_Adapter.md "wikilink")\[5\]。テキストモードは[EGAの](../Page/Enhanced_Graphics_Adapter.md "wikilink")14ドットフォントを使用し、縦400ラインで表示する。\[6\]
...
PGCに対応するディスプレイはIBM 5175である。これは独自仕様のアナログRGBモニターで、他のビデオカードとはそのままでは互換性がない。ハードウェアを改変すれば、5175はVGA、[Macintosh](../Page/Macintosh.md "wikilink")、その他様々なアナログRGB信号を映すことができる。\[8\]
...
## ハードウェア互換品
  ...
  - Vermont Microsystems IM-640, IM-1024\[10\]
...
## 脚注
  ...
  - [A Professional Graphics Controller](http://domino.research.ibm.com/tchjr/journalindex.nsf/0/6829ccaf443f3a6c85256bfa00685b97?OpenDocument) by K. A. Duke and W. A. Wall, IBM Systems Journal

## 外部リンク

  - [Professional Graphics Controller: Notes - Pictures and programming information](http://www.seasip.info/VintagePC/pgc.html)
...
5.
6.
7.  [Professional Graphics Adapter pictures](http://incolor.inebraska.com/bill_r/ibm_pga_graphics_adapter.htm)
8.
9.
10.