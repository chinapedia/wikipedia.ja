...
PlayStation 2版に[CEROレーティング表示はない](../Page/コンピュータエンターテインメントレーティング機構.md "wikilink")（ただし、廉価版では全年齢対象とされている）。

操作感の大きな特徴として[回生失効](https://ja.wikipedia.org/wiki/回生失効 "wikilink")が再現されており、そのパターンもブレーキをかけ始めた時点で失効していたり、最初は回生制動が立ち上がるものの中速度以下で失効したり、最初は失効するものの停止直前で回生制動が復帰したりと複数ある。

この他にも[桜新町駅](https://ja.wikipedia.org/wiki/桜新町駅 "wikilink")、[江田駅における優等列車](https://ja.wikipedia.org/wiki/江田駅_\(神奈川県\) "wikilink")（急行）の通過待ちや、終着駅で乗客を降ろした後で車庫入れ運転をするなど映像の点でも新しい要素が取り入れられた作品である。
...
#### 東横線
  ...
  - [8590系](../Page/東急8090系電車.md "wikilink")
      -
        ...
        8000系に比べ加速性能、応答性は高めだが、ブレーキの効きがやや弱い。
  - [8000系](../Page/東急8000系電車.md "wikilink")
      -
        界磁チョッパ制御やワンハンドルマスコンなど、新機軸を多数導入した車両。
        ブレーキの効きは強めだが、応答性が悪い。加速性能も中高速域では伸び悩む。
...
**田園都市線**
  ...
  - 37-081　　各停長津田行き　渋谷→長津田{渋谷→長津田 2000系(2000系)}
      -
        ...
        全体的にダイヤに余裕がない上、他のダイヤに比べ回生失効の発生確率が高くなっている。さらに試験では扱いの難しい2000系を使用するため、難易度は非常に高い。
