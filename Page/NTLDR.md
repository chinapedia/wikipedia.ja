...
**NTLDR**（NT Loader）は過去の[Windows NT系における標準の](https://ja.wikipedia.org/wiki/Windows_NT系 "wikilink")[ブートローダ](https://ja.wikipedia.org/wiki/ブートローダ "wikilink")である。
...
NTLDRはプライマリ[ハードディスクドライブ](https://ja.wikipedia.org/wiki/ハードディスクドライブ "wikilink")かブート可能\[1\]なリムーバブルメディア（CD-ROM/USBメモリ/FDDなど）から起動することができる。もちろん、NTLDRはWindows NT系の[OSばかりではなく](../Page/オペレーティングシステム.md "wikilink")、[Windows 9x系や](https://ja.wikipedia.org/wiki/Windows_9x系 "wikilink")[PC-UNIX](https://ja.wikipedia.org/wiki/PC-UNIX "wikilink")（[Linux](https://ja.wikipedia.org/wiki/Linux "wikilink")/[FreeBSD](../Page/FreeBSD.md "wikilink")など）などのWindows NT以外のOSも[パーティション](https://ja.wikipedia.org/wiki/パーティション "wikilink")などを設定することにより起動することができる。NTLDRを使用するためには起動ドライブの[ルートディレクトリ](https://ja.wikipedia.org/wiki/ルートディレクトリ "wikilink")に最低でも、NTLDRとBoot.iniを必要とする。また、NT系OSはそれに加えて、ntdetect.comも必要である。さらに、[日本語](../Page/日本語.md "wikilink")版を含む[東アジア](https://ja.wikipedia.org/wiki/東アジア "wikilink")言語バージョンの Windows では Bootfont.bin が必要である\[2\]。
...
4.  ブートメニューで選択されたOSがNT系以外のOSならば、NTLDRは記述されたファイルに起動を任せ、役割を終える。
      ...
      - /win95または/win95dosオプションが指定されている場合、[Windows 9x系と](https://ja.wikipedia.org/wiki/Windows_9x系 "wikilink")[DOS](../Page/DOS_\(OS\).md "wikilink")（[MS-DOS](../Page/MS-DOS.md "wikilink")または[PC DOS](https://ja.wikipedia.org/wiki/IBM_PC_DOS "wikilink")）とのマルチブートのための処理が実行される\[3\]。
...
NTLDRはNT系のOSのセーフモード起動なども制御している。使用されるオプションは以下のとおりである。
  ...
  - /maxmem=nn
  - /nodebug
  - /noexecute=optin ([DEP](https://ja.wikipedia.org/wiki/データ実行防止 "wikilink"))
  - /noguiboot
  - /nopae
  - /noserialmice:comx
  - /numproc
