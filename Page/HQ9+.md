...
HQ9+は4つの[命令だけで構成されており](../Page/命令_\(コンピュータ\).md "wikilink")、それらは'H'、'Q'、'9'、'+'という単一の文字で示される。HQ9+は[チューリング完全](../Page/チューリング完全.md "wikilink")ではなく、[プログラミング言語](../Page/プログラミング言語.md "wikilink")としては不完全であるが、プログラミングの例題としてよく取り上げられるいくつかの問題に対しては極めて効率的である。
...
## 仕様
  ...
  - \+コマンドは[アキュムレータをインクリメント](../Page/アキュムレータ_\(コンピュータ\).md "wikilink")（1だけ増やす）する。
