...
割り当てられるアドレスは2012年11月19日以前は、5.0.0.0/8の範囲が使用された。しかし、この範囲は2010年の終わりに[RIPE NCCに割り当てられた](https://ja.wikipedia.org/wiki/RIPE_NCC "wikilink")。また、この範囲は実際に公のインターネット上で利用され始めている。そのためHamachiは25.0.0.0/8の範囲に切り替えられた\[2\]。
