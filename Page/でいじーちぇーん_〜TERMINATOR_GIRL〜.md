...
なお、題名の「でいじーちぇーん」は、本来は[ひなぎく数十本で花の輪を作る遊びを指しており](../Page/ヒナギク.md "wikilink")、そこから転じて時を超えて結ばれる人間関係を象徴する形で名づけられた。また、パソコンの周辺機器の[デイジーチェーン](https://ja.wikipedia.org/wiki/デイジーチェーン "wikilink")接続もモチーフとなっており、イブリースの髪飾りは、SCSIの[終端子](../Page/終端抵抗.md "wikilink")、つまりデイジーチェーンのターミネータにを模したものになっている。
...
## スタッフ
  ...
  - シナリオ：MILLION-FACE
  - 音楽：ナハトムジーク(BGM)
  - オープニングテーマ：[みるくくるみ](../Page/Riryka.md "wikilink")「RockOnYou」
