...
## 動作原理
  ...
  - 現時点では[ディスプレイアダプタおよびサウンドアダプタは実装されていない](../Page/ビデオカード.md "wikilink")。そのため、[GUI](https://ja.wikipedia.org/wiki/GUI "wikilink")を利用するには[X Window Systemや](../Page/X_Window_System.md "wikilink")[VNCを使ってリモートコンピュータのように接続する](../Page/Virtual_Network_Computing.md "wikilink")。音声はサウンド[サーバ](../Page/サーバ.md "wikilink")を利用することで再生できる。
...
### Cygwinとの比較
  ...
  - [Debian GNU/Linuxや](https://ja.wikipedia.org/wiki/Debian_GNU/Linux "wikilink")[Ubuntu](../Page/Ubuntu.md "wikilink")といった、一般のLinuxディストリビューションを、ほぼそのままcoLinux上で利用できる。
