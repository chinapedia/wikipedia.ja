...
**pst-plot** は、[関数のグラフを描くコマンドを用意している](https://ja.wikipedia.org/wiki/関数_\(数学\) "wikilink")。使用例を以下に示す。
...
**pst-math** は、[三角関数](../Page/三角関数.md "wikilink")での角度の単位を[ラジアン](../Page/ラジアン.md "wikilink")で指定可能にするとともに（PostScript のデフォルトは[度である](https://ja.wikipedia.org/wiki/度_\(角度\) "wikilink")）、[双曲線関数](../Page/双曲線関数.md "wikilink")を利用可能としている。
...
他にも、[回路図](https://ja.wikipedia.org/wiki/回路図 "wikilink")を描くための拡張、[グラフのための拡張](../Page/グラフ理論.md "wikilink")、[木構造のための拡張](../Page/木_\(数学\).md "wikilink")、データの視覚化のための拡張などがある。
...
## 関連項目
  ...
  - [Inkscape](https://ja.wikipedia.org/wiki/Inkscape "wikilink") には、[SVG](../Page/Scalable_Vector_Graphics.md "wikilink") イメージを PSTricks のコードに変換する機能がある。
