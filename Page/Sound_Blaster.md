...
一部の廉価版製品を除き、同社が開発する3Dサウンド[API](../Page/アプリケーションプログラミングインタフェース.md "wikilink")「[EAX](https://ja.wikipedia.org/wiki/Environmental_Audio_Extensions "wikilink")」のハードウェアアクセラレーションをカード上のサウンドプロセッサによって実現し、多彩な音響効果を[CPU](../Page/CPU.md "wikilink")や[バスに大きな負荷をかけることなく実現可能な事実上唯一の選択肢であったが](../Page/バス_\(コンピュータ\).md "wikilink")、[Windows Vistaでのハードウェアアクセラレーション廃止](https://ja.wikipedia.org/wiki/Microsoft_Windows_Vista "wikilink")、CPU能力の大きな向上、対応アプリの少なさからハードウェア処理対応というメリットは薄れていた。

しかし[Creative Alchemyが発表され](https://ja.wikipedia.org/wiki/Creative_Alchemy "wikilink")、このソフトにインストール済みのゲームを登録することによってサウンドを[OpenAL](https://ja.wikipedia.org/wiki/OpenAL "wikilink")形式で出力することが可能になったため、手間はかかるがハードウェアアクセラレーションを有効にすることは可能となった。
...
また、Sound Blaster Proには内蔵ドライブを接続するためのコネクタを備えており、[パナソニック](https://ja.wikipedia.org/wiki/パナソニック "wikilink")製の[CD-ROM](../Page/CD-ROM.md "wikilink")ドライブを接続することができるようになっていた。つまり、この時代のSound Blasterは、サウンドカード、ジョイスティックカード、MIDIカード、CD-ROM接続カードの4つの機能を兼ね備えていたことになる。

このSound Blaster ProにさらにCD品質のPCM音源を追加したSound Blaster 16が1992年に登場する。Sound Blaster 16では、MIDI部分がデファクトスタンダードだった[ローランド](../Page/ローランド.md "wikilink")のMPU-401互換（ただしUARTモードのみ）となった他、ウェーブテーブル音源用のドーターボードを取り付ける為のコネクタを有するようになった。その後、1994年にはE-Mu社の音源モジュールを内蔵したSound Blaster AWE32が、1996年にはその後継品であるSound Blaster AWE64がそれぞれ登場している。
...
## 外部リンク
  ...
  - [クリエイティブメディア](http://jp.creative.com/) - 公式サイト
  - [製品情報](http://jp.creative.com/products/welcome.asp?category=1&)
  - [Sound Blaster](http://www.soundblaster.com/) （英語）

[Category:サウンドカード](https://ja.wikipedia.org/wiki/Category:サウンドカード "wikilink")