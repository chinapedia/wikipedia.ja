...
[FlightGear_-_AN225.jpg](https://ja.wikipedia.org/wiki/File:FlightGear_-_AN225.jpg "fig:FlightGear_-_AN225.jpg")の[FlightGear](https://ja.wikipedia.org/wiki/FlightGear "wikilink")も、多くを[OpenGL](../Page/OpenGL.md "wikilink")を使用して[C++](../Page/C++.md "wikilink")で記述されている\]\] **ゲームプログラミング**とは、読んで字のごとく[ゲーム](../Page/ゲーム.md "wikilink")を[プログラム](../Page/プログラム_\(コンピュータ\).md "wikilink")（[プログラミング](https://ja.wikipedia.org/wiki/プログラミング_\(コンピュータ\) "wikilink")）する行為に他ならない。しかし実際にはゲームそのものだけではなく、各種ゲームから共通に呼び出される基底[ライブラリ](../Page/ライブラリ.md "wikilink")（いわゆる[ゲームエンジン](https://ja.wikipedia.org/wiki/ゲームエンジン "wikilink")）や、ゲーム制作補助ツールといったものまで手広く扱うことが多く、「ゲームプログラミング」という言葉から連想されるよりも地味で目立たない役割も多い。特に大規模なゲームプログラムを開発する際には、補助ツールの開発・保守・ドキュメント化はほぼ必ず行われるため、分業の過程でゲームそのものには携わらなくなるプログラマも当然現れ得るが、それでも彼らもゲームプログラマの肩書きで呼ばれる事が多い。[ソフトウェア開発](https://ja.wikipedia.org/wiki/ソフトウェア開発 "wikilink")の学習の一環としてゲームプログラムを扱っている教育機関も散見される。
