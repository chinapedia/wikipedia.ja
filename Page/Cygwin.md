...
**[UNIX](../Page/UNIX.md "wikilink")的な操作体系を持つが、[エミュレータではなく](../Page/エミュレータ_\(コンピュータ\).md "wikilink")[互換レイヤー](../Page/互換レイヤー.md "wikilink")である。**[POSIX](../Page/POSIX.md "wikilink")に準拠するシステムコール と [Windows API](../Page/Windows_API.md "wikilink") の間のAPI互換を行っている。その結果として、UNIX環境上のツール群をWindows上に再コンパイルのみで移植することを可能にしている。API互換機能は[ランタイムライブラリ](../Page/ランタイムライブラリ.md "wikilink")「Cygwin1.dll」が担っている。
