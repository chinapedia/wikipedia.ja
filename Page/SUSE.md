...
2011年4月27日にノベルはにより買収されたが、その新しいオーナーの下でもSUSEは独立した会社のままであった\[7\]。2012年6月、ノベルの所有中に解雇された多くの元SUSE技術者が戻ってきた\[8\]。

### Attachmateとマイクロフォーカスの合併

2014年11月20日にThe Attachmate Groupと[マイクロフォーカス](https://ja.wikipedia.org/wiki/マイクロフォーカス "wikilink")との合併が決定し、マイクロフォーカスはSUSEの新しい親会社となった\[9\]\[10\]。2016年11月、マイクロフォーカスが[ヒューレット・パッカード・エンタープライズ](https://ja.wikipedia.org/wiki/ヒューレット・パッカード・エンタープライズ "wikilink") (HPE) のソフトウェア資産を買収したことに伴い、SUSEが HPE のソフトウェア資産、人材を継承して吸収した\[11\]。SUSEはマイクロフォーカスグループ内における半自律的なビジネスユニットとして経営されており、元社長であるNils BrauckmannがCEOおよびマイクロフォーカスグループの重役メンバーに昇格している\[12\]。

### EQTへの売却

2018年7月、マイクロフォーカスから[EQT](https://ja.wikipedia.org/wiki/EQT "wikilink")に売却されることが発表\[13\]。2019年3月15日に買収が完了し、再び独立企業となった\[14\]\[15\]。

## 製品

[SUSE_Geeko_plush_toy.jpg](https://ja.wikipedia.org/wiki/File:SUSE_Geeko_plush_toy.jpg "fig:SUSE_Geeko_plush_toy.jpg") 2006年7月にSUSE Linux Enterprise 10プラットフォームが開始され、このプラットフォームはほぼ同一のコードベースを搭載したサーバとデスクトップの両方の基盤となった。
...
[SUSE Linux Enterprise Serverには](https://ja.wikipedia.org/wiki/SUSE_Linux_Enterprise_Server "wikilink")、各パートナーシップの背景で作成された、最適化されたエディションがいくつかある。これらのエディションは基本となるサーバ製品から開発されている:

  - SLES for VMware\[28\] - 権利はVMware vSphereに含まれていた。製品の提供終了が発表されている。
  - SLES for [Amazon EC2](https://ja.wikipedia.org/wiki/Amazon_Elastic_Compute_Cloud "wikilink")\[29\]
  - SLES for [Microsoft Azure](https://ja.wikipedia.org/wiki/Microsoft_Azure "wikilink")\[30\]
  - SLES for [Raspberry Pi](https://ja.wikipedia.org/wiki/Raspberry_Pi "wikilink")\[31\] - Raspberry Pi 3 Model B用に作られたARM用SUSE Linux Enterprise Serverの特別なパッケージバージョン。
...
以下にSUSEソフトウェア管理およびクラウドツールを挙げる:
  ...
  - [SUSE Container as a Service Platform](https://ja.wikipedia.org/wiki/SUSE_Container_as_a_Service_Platform "wikilink")\[38\] - [Kubernetes](https://ja.wikipedia.org/wiki/Kubernetes "wikilink")をベースとした、コンテナベースアプリケーションおよびサービス用プラットフォームを開発およびホストするためのアプリケーション。

  - [SUSE Studio](https://ja.wikipedia.org/wiki/SUSE_Studio "wikilink")\[39\] - オペレーティングシステム、設定、アプリケーションおよびデータを含んだシステムイメージをビルドするフリーのウェブベースのツール。

## 合併と買収

SUSEの最初の技術買収は2016年で、[ドイツ](https://ja.wikipedia.org/wiki/ドイツ "wikilink")のIT企業であるit-novumからopenATTIC、オープンソースであるCeph、およびストレージ管理フレームワークなどのソフトウェア資産を買収した\[40\]。
...
8.
9.
10. <https://www.novell.com/ja-jp/news/press/2014/11/micro-focus-international-completes-merger-with-the-attachmate-group.html> Micro Focus International、Attachmate Groupとの合併完了を発表
11. <https://www.suse.com/newsroom/post/2016/suse-acquires-openstack-iaas-and-cloud-foundry-paas-talent-and-technology-assets-from-hpe-to-accelerate-growth-and-entry-into-new-markets/>
12.
13.
14. <https://www.suse.com/c/ja/news/suse-completes-move-to-independence-reaffirms-commitment-to-customers-partners-and-open-source-communities-as-industrys-largest-independent-open-source-company/>
15.
16.
17.
18.
...
25.
26.
27. [DRBD](https://ja.wikipedia.org/wiki/DRBD "wikilink")
28.
29.
30.
31.
