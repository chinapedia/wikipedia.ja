...
JARを含むこれらのアーカイブの実態はZIPそのものであり、ZIPを扱えるツールで同じように扱うことができる。ただし、JAR, WAR, EAR にはMETA-INF/[ディレクトリ](../Page/ディレクトリ.md "wikilink")内に[マニフェスト](../Page/マニフェスト.md "wikilink")と呼ばれる[メタ情報が格納されている](https://ja.wikipedia.org/wiki/メタデータ "wikilink")。このメタ情報はJARを扱うJavaのツールが解釈する。
