...
CUPSは当初、"Common UNIX Printing System" と呼ばれていたが、UNIX商標の法的な懸念からCUPS 1.4より "CUPS" と短縮されるようになった\[5\]。
