> この記事は[KPDF](https://ja.wikipedia.org/wiki/KPDF)から翻訳されています。
...
## 特徴
  ...
  - 設定ダイアログのユーザー補助の箇所で、[CSS](../Page/Cascading_Style_Sheets.md "wikilink") のようにデフォルトの背景色や文字色を選択できる。
...
## 外部リンク
  ...
  - [kde.org 上の KPDF のホームページ](http://kpdf.kde.org/)

[Category:オープンソースソフトウェア](https://ja.wikipedia.org/wiki/Category:オープンソースソフトウェア "wikilink") [Category:PDFソフト](https://ja.wikipedia.org/wiki/Category:PDFソフト "wikilink")