...
[第三者中継](https://ja.wikipedia.org/wiki/第三者中継 "wikilink")を禁止していないメールサーバ（オープンリレー）と転送サーバは、この問題に関連して不運な立場に置かれる。殆どの場合オープンリレーや転送サーバは、MAIL FROMが*発信者アドレス*を表示する事や、最終的に配達が成功する事を保証できない。
