...
**ストークスの定理**（ストークスのていり、）は、[ベクトル解析](../Page/ベクトル解析.md "wikilink")の[定理](../Page/定理.md "wikilink")のひとつである。3次元[ベクトル場](../Page/ベクトル場.md "wikilink")の[回転を](https://ja.wikipedia.org/wiki/回転_\(数学\) "wikilink")[閉曲線](https://ja.wikipedia.org/wiki/閉曲線 "wikilink")を境界とする[曲面](../Page/曲面.md "wikilink")上で面積分したものが、元のベクトル場を曲面の境界である閉曲線上で[線積分](../Page/線積分.md "wikilink")したものと一致することを述べる\[1\]。定理の名はイギリスの物理学者[ジョージ・ガブリエル・ストークス](../Page/ジョージ・ガブリエル・ストークス.md "wikilink")に因む\[2\]\[3\]。ベクトル解析における[グリーン・ガウス・ストークスの定理を](https://ja.wikipedia.org/wiki/ケルビン・ストークスの定理 "wikilink")、より一般的な向きづけられた[多様体](../Page/多様体.md "wikilink")上に拡張したものも、同様にストークスの定理と呼ばれる。[微分積分学の基本定理](../Page/微分積分学の基本定理.md "wikilink")の、多様体への拡張であるともいえる。

## ストークスの定理

ベクトル解析における**ストークスの定理**は、ベクトル場の[回転を曲面上で面積分したものが](https://ja.wikipedia.org/wiki/回転_\(数学\) "wikilink")、元のベクトル場を曲面の境界で[線積分](../Page/線積分.md "wikilink")したものに一致することを述べたものであり、以下のように記述される。(詳細は、[ケルビン・ストークスの定理](https://ja.wikipedia.org/wiki/ケルビン・ストークスの定理 "wikilink")を参照のこと)
