...
C言語やC++の基本実行[文字集合](../Page/文字集合.md "wikilink")は通常、[ASCII](https://ja.wikipedia.org/wiki/ASCII "wikilink")のサブセットの文字種からなる。ただし実際の[文字コード](../Page/文字コード.md "wikilink")が何であるかは規定されていない。
