...
**ジャーナリングファイルシステム**（Journaling file system）とは、書き換え処理要求（[トランザクション](https://ja.wikipedia.org/wiki/トランザクション "wikilink")）単位で内包するファイル構成情報を含む[メタデータ](https://ja.wikipedia.org/wiki/メタデータ "wikilink")を管理および保持できる機能を持った[ファイルシステム](../Page/ファイルシステム.md "wikilink")のこと。**ジャーナルファイルシステム**ともいう。
...
実際に[ハードディスクにデータを書き込む際のファイルシステムの動きを追ってみる](https://ja.wikipedia.org/wiki/磁気ディスク装置 "wikilink")。 ファイルシステムがデータを記録する場合、まず実データの書き込みを行い、その上でその実データを管理するメタデータを書き出さなくてはならない。
...
ただし、[Linux](https://ja.wikipedia.org/wiki/Linux "wikilink")の[ext3](https://ja.wikipedia.org/wiki/ext3 "wikilink")や[ネットアップ](https://ja.wikipedia.org/wiki/ネットアップ "wikilink")の[WAFL](https://ja.wikipedia.org/wiki/WAFL "wikilink")等、いくつかのジャーナリングファイルシステムでは実データの保護も行っている。

## 経緯

元々、汎用機において重要な業務データを扱う際のファイルのメタデータ保持方法から考案されたものであり、汎用機のファイル管理ツールの設計思想をPCで取り入れるべく考慮された。 そのため、オープン系での最初のジャーナリングファイルシステムは、汎用機及び高可用[トレラントコンピュータ向けのOSを作っていたIBMのJFS](https://ja.wikipedia.org/wiki/フォールトトレラントシステム "wikilink")（[AIX](https://ja.wikipedia.org/wiki/AIX "wikilink") V3.1向け1990年)及び、Tolerant Software([VERITAS](https://ja.wikipedia.org/wiki/VERITAS "wikilink"))の[VxFS](https://ja.wikipedia.org/wiki/VxFS "wikilink")([UNIX System V向け](https://ja.wikipedia.org/wiki/UNIX_System_V "wikilink")1989年)である。

  - JFS
    当初は[OS/2](https://ja.wikipedia.org/wiki/OS/2 "wikilink")に開発が進み、実際のリリースは、1990年にIBMの商用UNIXである[AIX](https://ja.wikipedia.org/wiki/AIX "wikilink")のV3.1に行われた。

<!-- end list -->

  - VxFS
    また、ほぼ同時期に、UNIXの汎用機置き換え需要に合わせ、1987年にTolerant Software（[VERITAS](https://ja.wikipedia.org/wiki/VERITAS "wikilink")社の前身）が[AT\&T](https://ja.wikipedia.org/wiki/AT&T "wikilink") UNIX System Laboratoriesの協力を得て、自社のハイアベイラビリティ・オペレーティングシステムからUNIX System V向けに価値あるコードを抽出し、トランザクションベースのボリュームマネージャと共にUNIX向けジャーナリングファイルシステムを業界で初めて開発した。その後、商用パッケージとして1989年にVxFSとして提供された。
...
### 商用UNIX
  ...
  - [AIX](https://ja.wikipedia.org/wiki/AIX "wikilink"): [JFS](https://ja.wikipedia.org/wiki/JFS "wikilink")、[VxFS](https://ja.wikipedia.org/wiki/VxFS "wikilink")
  ...
  - [IRIX](https://ja.wikipedia.org/wiki/IRIX "wikilink"): [XFS](https://ja.wikipedia.org/wiki/XFS "wikilink")
...
### Linux
  ...
  - [XFS](https://ja.wikipedia.org/wiki/XFS "wikilink")
  - [VxFS](https://ja.wikipedia.org/wiki/VxFS "wikilink")
  - [ZFS](https://ja.wikipedia.org/wiki/ZFS "wikilink")
  - [NTFS](https://ja.wikipedia.org/wiki/NT_File_System "wikilink")

### FreeBSD

  - [GEOM](https://ja.wikipedia.org/wiki/GEOM "wikilink") gjournal
  - [ZFS](https://ja.wikipedia.org/wiki/ZFS "wikilink")
  - Journaled [Soft updates](https://ja.wikipedia.org/wiki/Soft_updates "wikilink") (FreeBSD 9 の途中以降)
...
### Mac
  ...
  - [HFS+](https://ja.wikipedia.org/wiki/HFS_Plus "wikilink") - ジャーナリングはMac OS X 10.2.2から加わった
...
### その他のOSでのジャーナリングファイルシステム
  ...
  - [WAFL](https://ja.wikipedia.org/wiki/WAFL "wikilink") - [ネットアップ](https://ja.wikipedia.org/wiki/ネットアップ "wikilink")の統合ストレージ管理[マイクロカーネル](https://ja.wikipedia.org/wiki/マイクロカーネル "wikilink")[ONTAP](https://ja.wikipedia.org/wiki/ONTAP "wikilink")に実装
