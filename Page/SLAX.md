...
Slax5は公式に4バージョン存在する。
  ...
  - SLAX Popcorn Edition
      - [Xfce](https://ja.wikipedia.org/wiki/Xfce "wikilink")を採用し、115MBまで縮小したもの。
...
## 関連ディストリビューション
  ...
  - GoblinX - デスクトップユーザー向け。カスタマイズされた[KDE](../Page/KDE.md "wikilink")や[Xfce](https://ja.wikipedia.org/wiki/Xfce "wikilink")や[Enlightment](https://ja.wikipedia.org/wiki/Enlightment "wikilink")等のWMをウリにしている。
  - [Ophcrack](https://ja.wikipedia.org/wiki/Ophcrack "wikilink") - [Windows NTのパスワードのクラック用](https://ja.wikipedia.org/wiki/Windows_NT "wikilink")。バージョン3.3.0以降はSLAXではなく、[Slitaz](https://ja.wikipedia.org/wiki/Slitaz "wikilink")ベース\[1\]。
