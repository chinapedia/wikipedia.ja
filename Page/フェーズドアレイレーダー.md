...
[合成開口レーダー](https://ja.wikipedia.org/wiki/合成開口レーダー "wikilink")も、原理は同じである。

天体観測に使う[電波望遠鏡](../Page/電波望遠鏡.md "wikilink")では、複数のアンテナをフェーズドアレイレーダーと同じように（ただし完全パッシブ。受信のみ）に用いて、感度・解像度・捜索範囲を上げていることがある（例えば[アタカマ大型ミリ波サブミリ波干渉計](https://ja.wikipedia.org/wiki/アタカマ大型ミリ波サブミリ波干渉計 "wikilink")では、66台のアンテナを使っている）。
...
[USN1059659_SCANFAR_Radars_(SPS-32,SPS-33)_CVN-65_Enterprise_1962-02-10.jpg](https://ja.wikipedia.org/wiki/File:USN1059659_SCANFAR_Radars_\(SPS-32,SPS-33\)_CVN-65_Enterprise_1962-02-10.jpg "fig:USN1059659_SCANFAR_Radars_(SPS-32,SPS-33)_CVN-65_Enterprise_1962-02-10.jpg")
  ...
  - [AN/SPY-1](https://ja.wikipedia.org/wiki/AN/SPY-1 "wikilink")
    [イージスシステム](../Page/イージスシステム.md "wikilink")用の艦載パルス・レーダー（パッシブ式）。[アメリカ海軍](../Page/アメリカ海軍.md "wikilink")の[タイコンデロガ級ミサイル巡洋艦](../Page/タイコンデロガ級ミサイル巡洋艦.md "wikilink")・[アーレイ・バーク級ミサイル駆逐艦](../Page/アーレイ・バーク級ミサイル駆逐艦.md "wikilink")、[海上自衛隊](https://ja.wikipedia.org/wiki/海上自衛隊 "wikilink")の[こんごう型](../Page/こんごう型護衛艦.md "wikilink")・[あたご型護衛艦](https://ja.wikipedia.org/wiki/あたご型護衛艦 "wikilink")、[スペイン海軍](../Page/スペイン海軍.md "wikilink")の[アルバロ・デ・バサン級フリゲート](../Page/アルバロ・デ・バサン級フリゲート.md "wikilink")、[ノルウェー海軍](../Page/ノルウェー海軍.md "wikilink")の[フリチョフ・ナンセン級フリゲート](../Page/フリチョフ・ナンセン級フリゲート.md "wikilink")、[韓国海軍の](../Page/大韓民国海軍.md "wikilink")[世宗大王級駆逐艦](https://ja.wikipedia.org/wiki/世宗大王級駆逐艦 "wikilink")に搭載。
...
//
  ...
  - [EMPAR](https://ja.wikipedia.org/wiki/EMPAR "wikilink")
    [フランス海軍](https://ja.wikipedia.org/wiki/フランス海軍 "wikilink")の[フォルバン級駆逐艦](../Page/フォルバン級駆逐艦.md "wikilink")と、[イタリア海軍](https://ja.wikipedia.org/wiki/イタリア海軍 "wikilink")の[アンドレア・ドーリア級駆逐艦](../Page/アンドレア・ドーリア級駆逐艦.md "wikilink")・[カルロ・ベルガミーニ級フリゲート](https://ja.wikipedia.org/wiki/カルロ・ベルガミーニ級フリゲート "wikilink")・軽空母「[カヴール](../Page/カヴール_\(空母\).md "wikilink")」に搭載されているパッシブフェーズドアレイレーダー。
...
<!-- end list -->
  ...
  - [OPS-12](https://ja.wikipedia.org/wiki/OPS-12 "wikilink")
    [海上自衛隊](https://ja.wikipedia.org/wiki/海上自衛隊 "wikilink")の艦載用フェーズドアレイレーダー。3次元対空捜索用レーダーとして[しらね型護衛艦](https://ja.wikipedia.org/wiki/しらね型護衛艦 "wikilink")に搭載（パッシブ式）。
  ...
  - [FCS-3](../Page/FCS-3.md "wikilink")
    [海上自衛隊](https://ja.wikipedia.org/wiki/海上自衛隊 "wikilink")の艦載用パルス・レーダー。捜索・射撃指揮用と後に追加された照射用の二種で構成される。[ひゅうが型護衛艦](../Page/ひゅうが型護衛艦.md "wikilink")と[あきづき型護衛艦に搭載されている](../Page/あきづき型護衛艦_\(2代\).md "wikilink")（アクティブ式・[射撃管制装置](https://ja.wikipedia.org/wiki/射撃管制装置 "wikilink")として制式化）。派生型としてFCS-3から照射用レーダーと射撃管制機能を取り除き、機能を対空捜索と航空管制に限定したOPS-50があり、[いずも型護衛艦](https://ja.wikipedia.org/wiki/いずも型護衛艦 "wikilink")に搭載されている。

<!-- end list -->

  - マルス・パッサート
    空母 「[アドミラル・クズネツォフ](../Page/アドミラル・クズネツォフ_\(空母\).md "wikilink")」と空母「[バクー](https://ja.wikipedia.org/wiki/バクー_\(空母\) "wikilink")」に搭載される艦載用フェーズドアレイレーダー（パッシブ式）。簡易型として**フォールム-2M**が存在し、こちらは[ワリヤーグに搭載された](https://ja.wikipedia.org/wiki/ヴァリャーグ_\(空母\) "wikilink")。
  - 3R41
...
### 航空機用
  ...
  - AN/APY-1、AN/APY-2
    アメリカ空軍の[E-3や](https://ja.wikipedia.org/wiki/E-3_\(航空機\) "wikilink")[航空自衛隊](../Page/航空自衛隊.md "wikilink")の[E-767などの](https://ja.wikipedia.org/wiki/E-767_\(航空機\) "wikilink")[早期警戒管制機](../Page/早期警戒管制機.md "wikilink")用パルス・ドップラー・レーダー（パッシブ式）。
  - MESA
  ...
  - AN/ASQ-236
    [ノースロップ・グラマン](../Page/ノースロップ・グラマン.md "wikilink")が開発したF-15E用[合成開口レーダー](https://ja.wikipedia.org/wiki/合成開口レーダー "wikilink")ポッド。アクティブ式のレーダーを搭載する。
...
<!-- end list -->
  ...
  -
    [ロシア空軍の](../Page/ロシア航空宇宙軍.md "wikilink")[MiG-31に搭載されるレーダー](https://ja.wikipedia.org/wiki/MiG-31_\(航空機\) "wikilink")（パッシブ式）。世界で初めて量産戦闘機に装備されたパッシブ式フェーズドアレイレーダーである。

  - レーニネツ
    [Su-34に搭載されるフェーズドアレイレーダー](https://ja.wikipedia.org/wiki/Su-34_\(航空機\) "wikilink")（パッシブ式）。
...
以下のミサイルではスタンドオフレンジや自立誘導距離などの性能向上のため、シーカー部にAESA方式のアンテナを搭載している。
  ...
  - [AAM-4B 99式空対空誘導弾（B）](../Page/99式空対空誘導弾.md "wikilink")\[18\]
    [81式短距離地対空誘導弾](https://ja.wikipedia.org/wiki/81式短距離地対空誘導弾 "wikilink")（C）\[19\]
    [03式中距離地対空誘導弾](https://ja.wikipedia.org/wiki/03式中距離地対空誘導弾 "wikilink")（改）\[20\]
...
## 関連項目
  ...
  - [デジタル・レーダー](https://ja.wikipedia.org/wiki/デジタル・レーダー "wikilink")
