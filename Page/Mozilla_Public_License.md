...
MPL 1.1発表から10年以上が経過した2010年、MPL 2.0のための公開プロセスが開始された\[21\]。21か月に及ぶ作業により、MPLは簡素化され理解しやすくなり、GPLや[Apache Licenseとの互換性が向上し](https://ja.wikipedia.org/wiki/Apache_License "wikilink")、特許保護を盛り込むことによるコード貢献者の権利侵害からの保護が加えられた\[22\]。
