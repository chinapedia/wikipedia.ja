> この記事は[NESSIE](https://ja.wikipedia.org/wiki/NESSIE)から翻訳されています。


**NESSIE**(New European Schemes for Signature, Integrity, and Encryption)は[欧州連合](https://ja.wikipedia.org/wiki/欧州連合 "wikilink") (EU) の制定した[暗号](../Page/暗号.md "wikilink")規格。 ECのIST ([Information Society Technologies](https://ja.wikipedia.org/wiki/:w:Information_Society_Technologies "wikilink")) の一環として2000年1月から活動を開始した。
...
最終的に以下の暗号が採用された\[1\]。
  ...
  - 公開鍵暗号
      - \- [IBM](../Page/IBM.md "wikilink") Zurich Research Laboratory

      - [PSEC-KEM](https://ja.wikipedia.org/wiki/PSEC-KEM "wikilink") - NTT

      - [RSA-KEM](../Page/RSA暗号.md "wikilink")
...
## 外部リンク
  ...
  - [NESSIEプロジェクトサイト](http://www.cryptonessie.org/)
...
1.  [NESSIE Project Announces Final Selection of Crypto Algorithms](https://www.cosic.esat.kuleuven.be/nessie/deliverables/press_release_feb27.pdf) (Bart Preneel) (PDF)