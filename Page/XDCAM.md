...
## 沿革
  ...
  - [2007年](../Page/2007年.md "wikilink")[4月15日](../Page/4月15日.md "wikilink")（現地時間）、[NAB](https://ja.wikipedia.org/wiki/全米放送事業者協会 "wikilink")2007において、記録媒体に[ソニー](../Page/ソニー.md "wikilink")と米[SanDiskが開発した](../Page/サンディスク.md "wikilink")[フラッシュメモリ](../Page/フラッシュメモリ.md "wikilink")の「SxS Memory Card」に記録する「XDCAM EX」の試作機を発表、2層のProfessional Discに対応するXDCAMの発売を発表した\[1\]。
  - 2007年9月：XDCAM EX発売
...
### HD
  ...
  - MPEG HD422
      -
        1920x1080
        サンプリングフォーマット 8bit 4:2:2\[2\]
        ビットレート 50Mbps
  - MPEG HD
      -
        1440x1080
        サンプリングフォーマット 8bit 4:2:0\[3\]
        ビットレート 35Mbps
...
## XDCAM EX
  ...
  - **XDCAM EX**（エックスディカム イーエックス）は、これまでのProfessional Discから[半導体メモリー](https://ja.wikipedia.org/wiki/半導体メモリー "wikilink")カードによる記録方式を採用したシステム。メモリーカードは**S×S**（エス・バイ・エス）と呼ばれ、[ExpressCard](../Page/ExpressCard.md "wikilink")規格に準拠したもので、転送速度は最大で800Mbpsになる。また、[メモリースティック](../Page/メモリースティック.md "wikilink")や[SDカード](https://ja.wikipedia.org/wiki/SDカード "wikilink")で専用アダプターを使って記録することも可能である。コーデックはHDがMPEG HDで、SDはDVCAMを採用している。
...
## 外部リンク
  ...
  - [ソニー 映像制作＆編集用機材 XDCAM](http://www.sony.jp/products/Professional/XDCAM/)
  - [ソニー 映像制作＆編集用機材 XDCAM EX](http://www.sony.jp/products/Professional/xdcamex/)
