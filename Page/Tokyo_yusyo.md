> この記事は[Tokyo yusyo](https://ja.wikipedia.org/wiki/Tokyo_yusyo)から翻訳されています。


**tokyo yusyo**（とうきょうゆうしょう）は、[日本](https://ja.wikipedia.org/wiki/日本 "wikilink")の音楽事務所。

音楽レーベル、ライブ・イベントの企画運営、音楽制作、出版、音楽メソッド及び、楽器の研究・開発に至るまで様々なエンタテイメント関連事業を行っている。
...
## 構成
  ...
  - 宝音出版 - [音楽出版](https://ja.wikipedia.org/wiki/音楽出版社 "wikilink")
  - Y2G RECORDS - [インディーズ](../Page/インディーズ.md "wikilink")レーベル

## 楽器の開発

移調が直感的に行える特殊な鍵盤（全音配列）を持ち、容易に習得可能\[2\]と言われる[クロマトーン](https://ja.wikipedia.org/wiki/クロマトーン "wikilink")（[電子楽器](../Page/電子楽器.md "wikilink")）の開発がなされており、所属アーティストによる実演ライブ等も行われている。\[3\]

  - ラピアン (RAPIAN)
  - ホールトーン (WHOLETONE)
  - クロマトーン (CHROMATONE CT-312)

なお、これらの楽器に使用されているメカニズムは「楽器用鍵盤のキートップ」として[特許公開されている](https://ja.wikipedia.org/wiki/日本の特許制度 "wikilink")。\[4\]

## 出典

## 外部リンク

  - [自主レーベル「Y2G RECORDS」](http://y2g.jp/)
...
1.  武藤樹一郎「芸能人というオシゴト」WAVE出版(2007年3月22日)
