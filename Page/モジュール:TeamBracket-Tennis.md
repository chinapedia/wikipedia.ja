> この記事は[モジュール:TeamBracket-Tennis](https://ja.wikipedia.org/wiki/モジュール:TeamBracket-Tennis)から翻訳されています。
...
[Category:Pages_using_a_tennis_bracket_with_deprecated_syntax](https://ja.wikipedia.org/wiki/Category:Pages_using_a_tennis_bracket_with_deprecated_syntax "wikilink") [Category:Pages_using_a_tennis_bracket_with_deprecated_syntax](https://ja.wikipedia.org/wiki/Category:Pages_using_a_tennis_bracket_with_deprecated_syntax "wikilink") [Category:Pages_using_a_tennis_bracket_with_deprecated_syntax](https://ja.wikipedia.org/wiki/Category:Pages_using_a_tennis_bracket_with_deprecated_syntax "wikilink") [Category:Pages_using_a_tennis_bracket_with_deprecated_syntax](https://ja.wikipedia.org/wiki/Category:Pages_using_a_tennis_bracket_with_deprecated_syntax "wikilink") [Category:Pages_using_a_tennis_bracket_with_deprecated_syntax](https://ja.wikipedia.org/wiki/Category:Pages_using_a_tennis_bracket_with_deprecated_syntax "wikilink") [Category:Pages_using_a_tennis_bracket_with_the_default_number_of_sets](https://ja.wikipedia.org/wiki/Category:Pages_using_a_tennis_bracket_with_the_default_number_of_sets "wikilink") [Category:Pages_using_a_tennis_bracket_with_the_default_number_of_sets](https://ja.wikipedia.org/wiki/Category:Pages_using_a_tennis_bracket_with_the_default_number_of_sets "wikilink") [Category:Pages_using_a_team_bracket_with_nbsp](https://ja.wikipedia.org/wiki/Category:Pages_using_a_team_bracket_with_nbsp "wikilink")