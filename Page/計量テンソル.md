...
**計量テンソル**（けいりょうテンソル、）は、[リーマン幾何学](https://ja.wikipedia.org/wiki/リーマン幾何学 "wikilink")において、空間内の[距離](../Page/距離.md "wikilink")と[角度](../Page/角度.md "wikilink")を定義する、[階数](https://ja.wikipedia.org/wiki/階数 "wikilink")（）が2の[テンソル](../Page/テンソル.md "wikilink")である。[多様体](../Page/多様体.md "wikilink")が与えられたとき、多様体の接空間で、滑らかに変化する非負の2次関数を選ぶことができる場合、その多様体を[リーマン多様体](https://ja.wikipedia.org/wiki/リーマン多様体 "wikilink")と呼ぶ。そのため、計量テンソルは、**リーマン計量**（）と呼ばれることもある。

ひとたび、ある座標系  が選ばれると、計量テンソルは[行列](https://ja.wikipedia.org/wiki/行列 "wikilink")形式で定義される。通常、 として表記され、各成分は  と表される。以下では、添え字の和に関して[アインシュタインの縮約記法](https://ja.wikipedia.org/wiki/アインシュタインの縮約記法 "wikilink")を用いる。
...
座標系を替えたユークリッド計量の例をいくつか示す。
  ...
  - 平らな [ミンコフスキー空間](https://ja.wikipedia.org/wiki/ミンコフスキー空間 "wikilink")（）: \((x^0, x^1, x^2, x^3)=(t, x, y, z) \\)
