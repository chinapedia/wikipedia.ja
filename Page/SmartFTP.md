...
他の特徴として、以下のようなものがある\[1\]。
  ...
  - [UTF-8](../Page/UTF-8.md "wikilink")ファイル名をサポート。ひらがな、カタカナ、漢字を含んだファイル名も問題なく[FTP](../Page/File_Transfer_Protocol.md "wikilink")[サーバ](../Page/サーバ.md "wikilink")にアップロードできる。
...
## 外部リンク
  ...
  - [SmartFTP 日本語化 Localization Project](http://www.smartftp.com/localization/projects/japanese/)
  - [FTPクライアント「SmartFTP」日本語化と使い方](http://smartftp.ikuzaki.jp/)

[Category:FTPクライアント](https://ja.wikipedia.org/wiki/Category:FTPクライアント "wikilink")

1.
2.  SSL/TLSサーバー証明書の署名を検証しない版 (3.0.1016.15など) もあったので、なりすましにたいする注意が必要。