...
[BBC Microやその他の](../Page/BBC_Micro.md "wikilink")[エイコーン・コンピュータ](../Page/エイコーン・コンピュータ.md "wikilink")のマシンで使用されたでは、PEEKやPOKEというキーワードはなく、*query*と呼ばれる[疑問符](../Page/疑問符.md "wikilink")(?)を関数とコマンドの両方の操作に使用していた。以下にその例を示す（BBC BASICでは日本語は使えないが、以下の例ではREMの後のコメント内の説明を日本語で表記している）。
