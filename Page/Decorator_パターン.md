...
Decorator パターンの[クラス図](../Page/クラス図.md "wikilink")を以下に挙げる。
...
Decorator パターンは、既存のクラスを拡張する際に[クラスの継承の代替手段として用いられる](../Page/継承_\(プログラミング\).md "wikilink")。継承がコンパイル時に機能を拡張するのに対し、Decorator パターンはプログラムの実行時に機能追加をする点が異なる。
