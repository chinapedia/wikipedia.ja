...
国際通信社は[ウォー・シミュレーションゲーム](../Page/ウォー・シミュレーションゲーム.md "wikilink")雑誌である『[コマンドマガジン日本版](../Page/コマンドマガジン日本版.md "wikilink")』を出版しており、『RPGmer』の内容や体裁にはコマンドマガジン日本版の影響が垣間見える（雑誌を高額にして付録ゲームを毎号つけるのはウォー・シミュレーションゲーム雑誌では標準的な販売形態である）。
...
基本的には毎号の特集記事のテーマに添うものが付録ゲームに選ばれていた。下記リストを見れば分かるように、TRPG専門誌を銘打ってはいるが付録についてくるものは[ボードゲーム](../Page/ボードゲーム.md "wikilink")がメインである。ただ、ボードゲームでも基本的にはTRPGと親和性が深いゲームが付録についてくるようになっていた。
...
<!-- end list -->
  ...
  -
    SPI社のダンジョン探索ゲームを復刻。デザインは[グレッグ・コスティキャン](https://ja.wikipedia.org/wiki/グレッグ・コスティキャン "wikilink")。
...
<!-- end list -->
  ...
  -
    国際通信社オリジナルゲーム。19世紀ヨーロッパを舞台としたスチームパンク・ファンタジー・ボードゲーム。
...
<!-- end list -->
  ...
  -
    WingnutGames社の[ソープオペラ](https://ja.wikipedia.org/wiki/ソープオペラ "wikilink")RPGの翻訳。
...
<!-- end list -->
  ...
  -
    ゾンビ兵士が溢れるナチス地下要塞に潜入し機密を奪取するという[バイオハザードシリーズ](https://ja.wikipedia.org/wiki/バイオハザードシリーズ "wikilink")風のボードゲーム。
...
<!-- end list -->
  ...
  -
    SPI社のボードゲームを復刻。様々な種族や勢力を率いて大陸の覇権を争うファンタジーボードゲーム。

<!-- end list -->

  - 聖者の行進・キャッスル・ファルケンシュタイン（Vol.4付録）
...
<!-- end list -->
  ...
  -
    『キャッスル・ファルケンシュタイン』のシナリオ。

<!-- end list -->

  - 凶兆の九星座 - 〈喉斬り道化師〉の支離滅裂な妄言（Vol.7付録）
...
<!-- end list -->
  ...
  -
    Westend GamesのB級SF[ウォー・シミュレーションゲーム](../Page/ウォー・シミュレーションゲーム.md "wikilink")。デザインはグレッグ・コスティキャン。
...
<!-- end list -->
  ...
  -
    国際通信社オリジナルゲーム。TV時代劇の再現を目的としたTRPG。
...
<!-- end list -->
  ...
  -
    海賊船による[接舷戦闘](https://ja.wikipedia.org/wiki/移乗攻撃 "wikilink")（アボルダージュ）を再現したボードゲーム。システムはVol.10付録の「ファイティング・ダンジョン」と同等のものを使用。

<!-- end list -->

  - [シーボイガンを喰った怪獣](https://ja.wikipedia.org/wiki/シーボイガンを喰った怪獣 "wikilink")（Vol.14付録）
...
<!-- end list -->
  ...
  -
    城壁の模型を作ることができる[ペーパークラフト](../Page/ペーパークラフト.md "wikilink")。モンスターメーカーレジェンドでそのまま使用できる。

## 外部リンク

  - [RPGamer公式ページ](http://www.kokusaig.co.jp/RPG/index_1.html)

[Category:ゲーム雑誌_(休廃刊)](https://ja.wikipedia.org/wiki/Category:ゲーム雑誌_\(休廃刊\) "wikilink") [Category:テーブルトークRPG雑誌](https://ja.wikipedia.org/wiki/Category:テーブルトークRPG雑誌 "wikilink") [Category:D20システム](https://ja.wikipedia.org/wiki/Category:D20システム "wikilink") [Category:2003年創刊の雑誌](https://ja.wikipedia.org/wiki/Category:2003年創刊の雑誌 "wikilink") [Category:2006年休廃刊の雑誌](https://ja.wikipedia.org/wiki/Category:2006年休廃刊の雑誌 "wikilink")