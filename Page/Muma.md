...
## 使い方
  ...
  - ELシリーズ・HSシリーズ
    1.  本体のタッチパネルで、購入したい楽曲を選択する。
    2.  伝票が発行されるので、レジで料金を支払う。
    3.  本体にパスワードを入力すると、データの記録されたフロッピーディスクを受け取れる。
  - STAGEAシリーズ
    1.  **記録したいスマートメディアまたはUSBメモリを持参する。**
    2.  本体のタッチパネルで、購入したい楽曲を選択する。
    3.  伝票が発行されるので、レジで料金を支払う。
    4.  本体にメディアを挿入しパスワードを入力すると、データが記録される。

楽曲を購入する場合、スマートメディアは**ID付**のものでなくてはならない。（アップデータの場合は不要）

USBメモリは基本的にヤマハミュージックメディアの動作確認済機種を使用する。[1](http://www.ymm.co.jp/muma/usb.php)

## 外部リンク

  - [Muma | ヤマハミュージックメディア](https://www.ymm.co.jp/muma/)

[Category:ヤマハ](https://ja.wikipedia.org/wiki/Category:ヤマハ "wikilink") [Category:自動販売機](https://ja.wikipedia.org/wiki/Category:自動販売機 "wikilink")