...
**ターミナル** (Terminal) は、[アップルの](../Page/アップル_\(企業\).md "wikilink")[macOS](https://ja.wikipedia.org/wiki/macOS "wikilink")に標準で付属している[UNIX](../Page/UNIX.md "wikilink")[端末エミュレータ](https://ja.wikipedia.org/wiki/端末エミュレータ "wikilink")。
...
ターミナルを起動すると、UNIXとしてのmacOSの標準[CLI](../Page/キャラクタユーザインタフェース.md "wikilink")[シェル](../Page/シェル.md "wikilink")である[Bash](https://ja.wikipedia.org/wiki/Bash "wikilink")が起動し、UNIXコマンドを打ち込むことができる。もちろん、UNIX用の[アプリケーションをインストールして](../Page/アプリケーションソフトウェア.md "wikilink")、実行することもできる。（ただし、UNIX用のアプリケーションを[インストール](../Page/インストール.md "wikilink")するためには、[MacPorts](https://ja.wikipedia.org/wiki/MacPorts "wikilink")や[Xcode](https://ja.wikipedia.org/wiki/Xcode "wikilink")といった開発環境のインストールが必要となる。）
...
sayコマンドは、ユニバーサルアクセス用に使用されるコマンドで、入力された引数の文字を読み上げる。（日本語にも対応\[1\]）
...
1.  macOS Sierra以降は日本語がデフォルト言語環境の場合、日本語音声が読み上げ時のデフォルトになっている。macOS Sierra以前の場合は、システム音声に日本語音声モジュール"*Kyoko*"を別途インストールすることで日本語での読み上げに対応可。