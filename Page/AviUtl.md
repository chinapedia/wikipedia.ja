...
[AVIファイル](https://ja.wikipedia.org/wiki/Audio_Video_Interleave "wikilink")を[編集したり](https://ja.wikipedia.org/wiki/ノンリニア編集 "wikilink")、各種[コーデック](../Page/コーデック.md "wikilink")で[圧縮することができる](../Page/エンコード.md "wikilink")。[フリーウェア](../Page/フリーウェア.md "wikilink")として公開されている。

動作には[MMX](https://ja.wikipedia.org/wiki/MMX "wikilink")が使える[CPU](../Page/CPU.md "wikilink")が必要\[2\]。
...
version0.99aからは[マルチスレッド](https://ja.wikipedia.org/wiki/マルチスレッド "wikilink")対応となり、主要なプラグインのマルチスレッド化が促進され[SIMD](https://ja.wikipedia.org/wiki/SIMD "wikilink")最適化、[GPUの利用ができるようになる](../Page/Graphics_Processing_Unit.md "wikilink")。
...
## 関連項目
  ...
  - [Audio Video Interleave](https://ja.wikipedia.org/wiki/Audio_Video_Interleave "wikilink") (AVI)
