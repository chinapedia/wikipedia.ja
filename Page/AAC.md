...
**Advanced Audio Coding**（略称: **AAC**、先進的音響符号化）は、不可逆のデジタル[音声圧縮](https://ja.wikipedia.org/wiki/音声圧縮 "wikilink")を行う音声符号化規格のひとつである。[1997年](https://ja.wikipedia.org/wiki/1997年 "wikilink")に[ISO/IEC JTC 1の](https://ja.wikipedia.org/wiki/ISO/IEC_JTC_1 "wikilink")[Moving Picture Experts Group](../Page/Moving_Picture_Experts_Group.md "wikilink") (MPEG) において規格化された。[MP3](../Page/MP3.md "wikilink")の後継フォーマットとして策定され、一般的にAACは同程度のビットレートであればMP3より高い音声品質を実現している。
...
MPEG-2 AACは主に日本の[BSデジタル放送と](https://ja.wikipedia.org/wiki/衛星放送 "wikilink")[地上デジタル波放送の](https://ja.wikipedia.org/wiki/デジタル放送の一覧 "wikilink")[ISDB](https://ja.wikipedia.org/wiki/ISDB "wikilink")規格や[SD-Audio](https://ja.wikipedia.org/wiki/SD-Audio "wikilink")のAACフォーマット、ヨーロッパ圏の[DVD](../Page/DVD.md "wikilink")などで利用できる。北米や日本のDVDでは、AACではなく[AC-3や](../Page/ドルビーデジタル.md "wikilink")[DTSが採用されている](https://ja.wikipedia.org/wiki/デジタル・シアター・システムズ "wikilink")。

MPEG-4 AACはiPodなどの[デジタルオーディオプレーヤー](https://ja.wikipedia.org/wiki/デジタルオーディオプレーヤー "wikilink")、[PlayStation Portableや](https://ja.wikipedia.org/wiki/PlayStation_Portable "wikilink")[DSiなどのゲーム機](https://ja.wikipedia.org/wiki/ニンテンドーDSi "wikilink")、[携帯電話](../Page/携帯電話.md "wikilink")等、多くの機器やソフトウェアがサポートしている。また、第三世代携帯電話用の動画フォーマットである[3GPP](https://ja.wikipedia.org/wiki/3GPP "wikilink")や[3GPP2](https://ja.wikipedia.org/wiki/3GPP2 "wikilink")の[音声圧縮](https://ja.wikipedia.org/wiki/音声圧縮 "wikilink")方式としても採用されている。

音楽配信サービスでは、パソコン、iPod向けの**[iTunes Store](https://ja.wikipedia.org/wiki/iTunes_Store "wikilink")**や携帯電話向けの**[着うた](https://ja.wikipedia.org/wiki/着うた "wikilink")**でAACが採用されている。ただし、これらのファイルの一部には[DRMが導入され](https://ja.wikipedia.org/wiki/デジタル著作権管理 "wikilink")、同じAACであるが互換性がないものがある\[1\]。デジタルオーディオプレーヤーの代表格であるiPodおよびiTunes（標準でAACを使用する）がAACに対応していることもあり、以前はAACに対応していなかったソニーや[パナソニック](https://ja.wikipedia.org/wiki/パナソニック "wikilink")、[ケンウッド](https://ja.wikipedia.org/wiki/ケンウッド "wikilink")（現・[JVCケンウッド](https://ja.wikipedia.org/wiki/JVCケンウッド "wikilink")）などのデジタルオーディオプレーヤーも現在ではAACに対応している。
...
1.  [MDCTによる](https://ja.wikipedia.org/wiki/修正離散コサイン変換 "wikilink")[直交変換](https://ja.wikipedia.org/wiki/直交行列 "wikilink")
      - 入力は窓長 2048 もしくは 256 のMDCTを用いてそれぞれ 1024 点 (long block)、128 点 (short block) の[周波数領域](https://ja.wikipedia.org/wiki/周波数領域 "wikilink")のデータに変換される。MP3が一旦時間領域のフィルタで 32 サブバンドに分割した後にMDCTを行っていたのに対し、AACでは入力サンプルに対してそのままMDCTが行われる。
...
2.  TNS
      ...
      - 周波数領域での[ARモデル](https://ja.wikipedia.org/wiki/ARモデル "wikilink")化は[時間領域](https://ja.wikipedia.org/wiki/時間領域 "wikilink")でのノイズ特性を持ち、人間の聴覚の持つ継時マスキング特性を再現するのに都合が良い。
      - この処理は省く事ができる。
3.  ステレオ・コーディング
...
5.  [ハフマン符号](https://ja.wikipedia.org/wiki/ハフマン符号 "wikilink")化
      - 量子化された値を固定ハフマン符号化する。符号帳は 11 種類の中からサブバンド毎に選択される。

## コンテナ対応

  - [AVI](https://ja.wikipedia.org/wiki/Audio_Video_Interleave "wikilink"), [MOV](../Page/QuickTime.md "wikilink"), [MP4](https://ja.wikipedia.org/wiki/MP4 "wikilink"), [Matroska](https://ja.wikipedia.org/wiki/Matroska "wikilink"), [MPEG-2 TS](https://ja.wikipedia.org/wiki/MPEG-2システム#トランスポートストリーム "wikilink")

## 備考

AACは[ドルビーラボラトリーズ](https://ja.wikipedia.org/wiki/ドルビーラボラトリーズ "wikilink")も共同開発の一員で、AACロゴはドルビーラボラトリーズの登録商標である（日本国特許庁商標登録番号：第4693750号）。AACにはドルビーのほか[AT\&T](https://ja.wikipedia.org/wiki/AT&T "wikilink")、[Fraunhofer IIS](https://ja.wikipedia.org/wiki/フラウンホーファー協会 "wikilink")、[ソニー](../Page/ソニー.md "wikilink")、[ノキア](https://ja.wikipedia.org/wiki/ノキア "wikilink")の特許技術が使用されている\[3\]ためソフトウェアメーカーなどから納付されたライセンス料はこれらの企業に分配されている。また、ライセンス管理はドルビーの子会社[Via Licensingが行っている](https://ja.wikipedia.org/wiki/Via_Licensing "wikilink")。
...
AACやHE-AACは下記に採用されており、実際に利用されている。
  ...
  - [PSP](https://ja.wikipedia.org/wiki/PlayStation_Portable "wikilink"), [PSVita](https://ja.wikipedia.org/wiki/PlayStation_Vita "wikilink"),[PS3](https://ja.wikipedia.org/wiki/PlayStation_3 "wikilink"),[PS4](https://ja.wikipedia.org/wiki/PlayStation_4 "wikilink")
  - [DSi](https://ja.wikipedia.org/wiki/ニンテンドーDSi "wikilink")（DSiサウンド）, [Wii](https://ja.wikipedia.org/wiki/Wii "wikilink")（[写真チャンネル](https://ja.wikipedia.org/wiki/写真チャンネル "wikilink")） - v1.1から対応。
  - [Blu-ray Disc](../Page/Blu-ray_Disc.md "wikilink") ([BDAV](https://ja.wikipedia.org/wiki/BDAV "wikilink"))
  ...
  - [BSデジタル放送](https://ja.wikipedia.org/wiki/デジタル放送の一覧 "wikilink")
  - [スカパー\!プレミアムサービス](https://ja.wikipedia.org/wiki/スカパー!プレミアムサービス "wikilink")
  - [着うたフルプラス](https://ja.wikipedia.org/wiki/着うたフルプラス "wikilink") - [KDDI](../Page/KDDI.md "wikilink")および[沖縄セルラー電話](https://ja.wikipedia.org/wiki/沖縄セルラー電話 "wikilink")の一部の[au携帯電話向け音楽配信サービス](https://ja.wikipedia.org/wiki/Au_\(携帯電話\) "wikilink")。
  ...
  - [mora](https://ja.wikipedia.org/wiki/mora "wikilink") - ソニーグループの音楽配信サービス。2012年10月よりAACによる配信を開始（それ以前は[ATRAC](https://ja.wikipedia.org/wiki/ATRAC "wikilink")3による配信）。
...
## 関連項目
  ...
  - [FairPlay](https://ja.wikipedia.org/wiki/FairPlay "wikilink") - [デジタル著作権管理](https://ja.wikipedia.org/wiki/デジタル著作権管理 "wikilink")技術
  ...
  - [SD-Audio](https://ja.wikipedia.org/wiki/SD-Audio "wikilink")
  - [D-dock](https://ja.wikipedia.org/wiki/D-dock "wikilink")
...
1.  例えばiTunes Storeでは以前、拡張子が .m4p のAACが配信フォーマットとして用いられていたが、これにはiTunes Store独自の[FairPlay](https://ja.wikipedia.org/wiki/FairPlay "wikilink")というDRMが付加されていたため携帯電話で再生することができなかった。2009年にはiTunes Storeにおいて大半の曲がDRMフリーでリリースされた。ただし一部のメタ情報やデータコンテナの相違から、そのままのオーディオファイルを使用する場合に非互換性が残る場合がある。
