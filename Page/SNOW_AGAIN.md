> この記事は[SNOW AGAIN](https://ja.wikipedia.org/wiki/SNOW_AGAIN)から翻訳されています。


「**SNOW AGAIN**」（スノー・アゲイン）は、1997年11月19日に[森高千里](../Page/森高千里.md "wikilink")が発表した楽曲、及び 34枚目のシングル。CDコードはEPDA-53。

## 概要

[明治チョコレート](../Page/明治製菓.md "wikilink")「[Meltykiss](https://ja.wikipedia.org/wiki/Meltykiss "wikilink")」CMソングに使われ、このTVCMには本曲のPVの一部が使われるほか、音源化された本曲と違うバージョンが使われている（途中途中で商品名「Melty kiss」と呼んでおり、このCM曲バージョンは現在も音源化されていない）。
