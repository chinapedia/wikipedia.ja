...
Adaでは、[プログラマ](../Page/プログラマ.md "wikilink")による[データ型](../Page/データ型.md "wikilink")の生成が比較的自在にできるため、型自体ではなく，型の***定義***にかかわる予約語について分類する。 [Ada_types.png](https://ja.wikipedia.org/wiki/File:Ada_types.png "fig:Ada_types.png")
