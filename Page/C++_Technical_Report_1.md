...
次のような実装が存在する。
  ...
  - [Visual C++](https://ja.wikipedia.org/wiki/Microsoft_Visual_C++ "wikilink") 2008のFeature Pack\[3\]そしてその後に出たサービスパック1\[4\]
...
### [メタプログラミング](https://ja.wikipedia.org/wiki/メタプログラミング "wikilink")と型特性
  ...
  - [データ型](https://ja.wikipedia.org/wiki/データ型 "wikilink")に関しての問い合わせを容易にすることによってメタプログラミングの支援をする。
...
## 関連項目
  ...
  - [Standard Template Library](https://ja.wikipedia.org/wiki/Standard_Template_Library "wikilink") - 現標準C++ライブラリの一部である。
