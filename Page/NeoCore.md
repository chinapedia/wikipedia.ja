...
独自のDPP ([Digital Pattern Processing](https://ja.wikipedia.org/wiki/Digital_Pattern_Processing "wikilink")) 技術を用いてXMLドキュメントの格納・検索を行う。 [富士通](../Page/富士通.md "wikilink")の[Interstage Shunsaku Data Manager](../Page/Interstage_Shunsaku_Data_Manager.md "wikilink")、東芝ソリューションのTX1などとともに第二世代XMLデータベースとも呼ばれる。
