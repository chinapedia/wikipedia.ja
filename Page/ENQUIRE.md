...
当時CERNには約1万人の人々が働いており、様々な機種のコンピュータとその上の[ソフトウェア](../Page/ソフトウェア.md "wikilink")が使われていた。業務上は[電子メール](../Page/電子メール.md "wikilink")とファイルのやりとりが頻繁に行われていた\[9\]。科学者らは複数の仕事に携わり\[10\]、個々のプロジェクトは相互に関連していた\[11\]。バーナーズ＝リーは1980年6月23日から6ヶ月間CERNで働き、ENQUIREを開発した\[12\]。CERN内では様々なネットワーク、データフォーマット、文字コードが使用されており、異なるシステム間の情報転送が難しかったため、ENQUIREはそれに対処することを要求された\[13\]。ENQUIRE以前のハイパーテキストシステム、[Memex](../Page/Memex.md "wikilink")や[NLS](../Page/NLS.md "wikilink")はそういった要件を備えていなかった\[14\]。
...
ENQUIREは[ウェブブラウザ](../Page/ウェブブラウザ.md "wikilink")よりも以下のような点で[ウィキ](../Page/ウィキ.md "wikilink")に近い。
  ...
  - 双方向リンク（[ウィキペディア](../Page/ウィキペディア.md "wikilink")および[MediaWiki](../Page/MediaWiki.md "wikilink")では「リンク元」機能に対応）。双方向リンクはリンク対象の作者が気づかないうちに行うことができる。そのようにしてアイデアが生きてくるようになる\[21\]\[22\]。
  - サーバから直接編集可能（ウィキや[CMS](../Page/コンテンツ管理システム.md "wikilink")/[ブログ](../Page/ブログ.md "wikilink")と類似）\[23\]。
...
## 関連項目
  ...
  - [ザナドゥ計画](../Page/ザナドゥ計画.md "wikilink")
  - [NLS](../Page/NLS.md "wikilink")
