...
#### 使用機材
  ...
  - 現在のメインはKarmasterとUltratone SEの2つ。Karmasterはジャズマスターと同じXJシェイプで今までの滝モデルと異なり、極薄ボディのギターである。薄さを追求したため、シールドプラグやボリュームノブがブリッジからストラップピンに間に配置している。ピックアップはネック・ブリッジともにToneZoneを付けている。Ultratone SEについては初期型のボディにSUFFERのネックを付けており、ドロップDの曲は持ち替えて演奏している。
