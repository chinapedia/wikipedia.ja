...
**IBM MQ**は、[IBM](../Page/IBM.md "wikilink")が開発・販売する[メッセージングミドルウェアである](https://ja.wikipedia.org/wiki/メッセージ指向ミドルウェア "wikilink")。1992年に**MQSeries**の名称で登場し、2002年に[WebSphere](../Page/WebSphere.md "wikilink")ブランドに組み込まれ**WebSphre MQ**と改名され、2014年に現在のIBM MQと改名された。[メッセージキュー](https://ja.wikipedia.org/wiki/メッセージキュー "wikilink")方式の信頼性が高く非同期通信も可能なマルチプラットフォーム対応の[メッセージ](../Page/メッセージ.md "wikilink")通信を提供する。このためシステム連携のためのメッセージング・[ミドルウェア](https://ja.wikipedia.org/wiki/ミドルウェア "wikilink")として使用される場合が多い。
...
## 歴史
  ...
  - MQSeriesリリース前
      ...
      - [1971年](https://ja.wikipedia.org/wiki/1971年 "wikilink")12月 [CICS](https://ja.wikipedia.org/wiki/CICS "wikilink")とTCAMの連携が発表され、[1972年](../Page/1972年.md "wikilink")12月にリリース。
...
<!-- end list -->
  ...
  - MQSeries時代
      ...
      - [2001年](../Page/2001年.md "wikilink") MQSeries V5.2（パフォーマンス改善、[Linux](https://ja.wikipedia.org/wiki/Linux "wikilink")のサポート）
...
<!-- end list -->
  ...
  - WebSphere MQ時代
      ...
      - [2005年](https://ja.wikipedia.org/wiki/2005年 "wikilink") WebSphere MQ V6（[64ビット](https://ja.wikipedia.org/wiki/64ビット "wikilink")対応、[Eclipseベースの](../Page/Eclipse_\(統合開発環境\).md "wikilink")[ユーザインタフェース](../Page/ユーザインタフェース.md "wikilink")）
...
MQ は時間に依存しないアーキテクチャを構成する機構も提供する。メッセージをあるアプリケーションから別のアプリケーションに送信するとき、相手のアプリケーションがその時点で動作していなくてもよい。受信側アプリケーションが動作していないときにメッセージが送られた場合、キューマネージャが受信側が問い合わせてくるまでそれを保持しておく。メッセージの順序性は[FIFO](https://ja.wikipedia.org/wiki/FIFO "wikilink")順で保持される。これは WebSphere MQ のキューマネージャに限った機能ではない。
...
この技術の利点は以下の通り。
  ...
  - メッセージは[TCP/IP](https://ja.wikipedia.org/wiki/TCP/IP "wikilink")のような純粋な[パケット](../Page/パケット.md "wikilink")通信による転送に依存しない。このため、送受信を行うアプリケーション同士の[結合度](https://ja.wikipedia.org/wiki/結合度 "wikilink")が弱く、非同期な運用も可能である。
...
WebSphere MQ の機能を利用する方法はいくつもある。IBM がサポートする [API](../Page/アプリケーションプログラミングインタフェース.md "wikilink") として以下のものがある。
  ...
  - IBM Message Queue Interface (MQI) : [C言語](../Page/C言語.md "wikilink")、[COBOL](https://ja.wikipedia.org/wiki/COBOL "wikilink")、[PL/I](https://ja.wikipedia.org/wiki/PL/I "wikilink")、[Java](https://ja.wikipedia.org/wiki/Java "wikilink")
...
IBMがサポートする以外にも各種APIが存在する。例えば、[モルガン・スタンレー](https://ja.wikipedia.org/wiki/モルガン・スタンレー "wikilink")が開発した[Perl](../Page/Perl.md "wikilink")用インタフェースが[CPAN](https://ja.wikipedia.org/wiki/CPAN "wikilink")から入手可能である。[3](http://search.cpan.org/~hbiersma/MQSeries-1.23/MQSeries.pm)
