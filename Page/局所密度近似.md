...
**局所密度近似**（きょくしょみつどきんじ、, **LDA**)は、[密度汎関数理論](https://ja.wikipedia.org/wiki/密度汎関数理論 "wikilink")に基づく[コーン・シャム理論に現れる](https://ja.wikipedia.org/wiki/密度汎関数理論#コーン・シャム理論 "wikilink")[交換相関エネルギー](https://ja.wikipedia.org/wiki/交換相関エネルギー "wikilink")に対する近似のひとつ。
...
実際に用いられる\(\epsilon_{\rm xc}\)の関数形は、厳密に求められる低密度、高密度の極限からの[外挿](https://ja.wikipedia.org/wiki/外挿 "wikilink")によるもの\[1\]\[2\]\[3\]\[4\]\[5\]や、[モンテカルロ法](https://ja.wikipedia.org/wiki/モンテカルロ法 "wikilink")を使ったもの\[6\]\[7\]\[8\]などがある。
...
## 関連項目
  ...
  - [電子相関](https://ja.wikipedia.org/wiki/電子相関 "wikilink")
