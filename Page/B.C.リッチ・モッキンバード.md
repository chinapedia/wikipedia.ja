...
[1974年](../Page/1974年.md "wikilink")にデビューしたモデルで、ボディーの“ツノ”が特徴。ボディーは、演奏性を考慮してデザインが2種類あり、ツノの長いロングホーンと、短いショートホーン（代わりにボディ左側が突き出しており、ストラップを掛けた際のバランスが向上）が存在する。基本的には628mm（ミディアム）スケール、2基の[ハムバッカー](https://ja.wikipedia.org/wiki/ハムバッキング "wikilink")・[ピックアップが搭載されているが](../Page/ピックアップ_\(楽器\).md "wikilink")、アーティストモデルなどでは特殊な仕様も存在する。 また、ヒールレスタイプのスルーネック方式により、ハイポジションでの使い勝手を容易にしている。

日本ではXでhideが使用したことで著名。ただし、ブラックに自らペイントマーカーでデザインした“PAINT”と称されるギター以後は、モッキンバードをモチーフとした[フェルナンデス](../Page/フェルナンデス_\(楽器メーカー\).md "wikilink")（その後はバーニー・ブランドで製作されている）MGである。これらが彼のシグネチャーモデルとしてリリースされたことで、国内ではhideのトレードマークのギターとしてのイメージが強い。
