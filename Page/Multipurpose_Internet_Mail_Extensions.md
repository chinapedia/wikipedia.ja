...
<!-- end list -->
  ...
  - RFC 2231では、MIMEパラメータの値に非US-ASCII文字を指定する方法を規定している。これによれば、[添付ファイル](../Page/添付ファイル.md "wikilink")名など、MIMEパラメータの値としての「`ISO-2022-JP''%1B$BF|K%5C8l%1B%28B`」を「日本語」と解釈することができる\[2\]。また、RFC 5322に適合しない長さの文字列を短く分割して指定する方法も規定している。
