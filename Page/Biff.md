...
新しいメールメッセージが届けられたときに、**biff**はすぐにそれを読むことが出来るように受信者に知らせる。この通知には、メールの送信者名、件名と数行の本文が含まれており、メールの受信者がログインしている間、[tty](https://ja.wikipedia.org/wiki/tty "wikilink")に送られる。通知の際にはより確実にメールの着信を気づかせるために[ビープ音](https://ja.wikipedia.org/wiki/ビープ音 "wikilink")が鳴る。
