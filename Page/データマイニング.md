...
**データマイニング**（）とは、[統計学](../Page/統計学.md "wikilink")、[パターン認識](https://ja.wikipedia.org/wiki/パターン認識 "wikilink")、[人工知能](../Page/人工知能.md "wikilink")等のデータ解析の技法を[大量のデータに網羅的に適用することで](https://ja.wikipedia.org/wiki/ビッグデータ "wikilink")[知識](../Page/知識.md "wikilink")を取り出す技術のことである。**DM**と略して呼ばれる事もある。通常のデータの扱い方からは想像が及びにくい、[ヒューリスティク](../Page/ヒューリスティクス.md "wikilink")（heuristic、発見的）な知識獲得が可能であるという期待を含意していることが多い。とくに[テキスト](../Page/テキスト.md "wikilink")を対象とするものを[テキストマイニング](https://ja.wikipedia.org/wiki/テキストマイニング "wikilink")、そのなかでも[ウェブページ](../Page/ウェブページ.md "wikilink")を対象にしたものを[ウェブマイニング](https://ja.wikipedia.org/wiki/ウェブマイニング "wikilink")と呼ぶ。英語では"Data mining"の語の直接の起源となった研究分野である****（データベースからの知識発見）の頭文字をとって**KDD**とも呼ばれる。
...
1989年に起きた"Knowledge Discovery in Databases"と呼ばれる学術研究分野の確立が、データマイニングという研究分野の直接の起源である。データマイニングの発展には、1990年以降の計算機の性能向上や大量のデータ蓄積が可能となったことが直接的に関係している。[デジタル](../Page/デジタル.md "wikilink")形式でのデータの収集は、コンピュータを用いてデータ解析をすることを念頭に置いて1960年代には既に行われつつあった。[関係データベース](https://ja.wikipedia.org/wiki/関係データベース "wikilink")とその操作用の言語[SQL](../Page/SQL.md "wikilink")が1980年代に出現し、オンデマンドで動的なデータ解析が可能となった。1990年代に至り、データ量は爆発的に増大した。[データウェアハウス](https://ja.wikipedia.org/wiki/データウェアハウス "wikilink")がデータの蓄積に用いられ始めた。 これに伴い、データベースにおける大量データを処理するための手法としてデータマイニングの概念が現れ、統計解析の手法や人工知能分野での検索技術等が応用されるようになった。[2010年代](../Page/2010年代.md "wikilink")には膨大なデータを利用してデータマイニングを行う[ビッグデータ](https://ja.wikipedia.org/wiki/ビッグデータ "wikilink")解析を用いた実用的な[サービス](../Page/サービス.md "wikilink")が多数登場して提供されている。

### 1960年代

[メインフレーム](https://ja.wikipedia.org/wiki/メインフレーム "wikilink")が金融企業の基幹業務システムとして稼働開始した。同時に、デジタルデータの収集,蓄積,利用の試みが開始された。

### 1970年代

1971年から1973年にかけて、[チリ](../Page/チリ.md "wikilink")で[サイバーシン計画](https://ja.wikipedia.org/wiki/サイバーシン計画 "wikilink")が実行される。コントロールセンターが、[テレックス](https://ja.wikipedia.org/wiki/テレックス "wikilink")を介して実時間でチリ各地に点在する工場からデータを収集して、収集したデータを元に、[オペレーションズ・リサーチ](https://ja.wikipedia.org/wiki/オペレーションズ・リサーチ "wikilink")を用いて最適化した生産計画を作成し、工場に対して生産計画をフィードバックするシステムであった。

論文上で"Data mining"という語の使用が行われる。但し、語の定義は現在とは大きく異なっており、[1970年代](../Page/1970年代.md "wikilink")においては否定的なニュアンスで使用されている。

### 1980年代

現在の"Data mining"の定義と類似する"Knowledge Discovery in Databases"という語が出現する。[関係データベース](https://ja.wikipedia.org/wiki/関係データベース "wikilink")システムとその操作用言語である[SQL](../Page/SQL.md "wikilink")が出現する。[データウェアハウス](https://ja.wikipedia.org/wiki/データウェアハウス "wikilink")の運用が開始される。
...
[インターネット](https://ja.wikipedia.org/wiki/インターネット "wikilink")への常時接続が一般家庭にも普及する。インターネット上に蓄積されたデータが加速度的に増加する。後にデータの主要な供給源の1つとなる友人紹介型の[ソーシャル・ネットワーキング・サービス](https://ja.wikipedia.org/wiki/ソーシャル・ネットワーキング・サービス "wikilink")が2002年より相次いで提供され始める。コンピュータとインターネットの普及に着目し、ビジネスにおいて膨大に蓄積され活用しきれなくなったデータの分析を専門に行う企業も徐々に出現し始める。
...
[ディープラーニング](https://ja.wikipedia.org/wiki/ディープラーニング "wikilink")の実用化が急速に進み、非常に多数の人工知能サービスが現れた。
  ...
  - [2011年](../Page/2011年.md "wikilink")2月16日 - データマイニングと[推論](https://ja.wikipedia.org/wiki/推論 "wikilink")を応用した[質問応答システム](https://ja.wikipedia.org/wiki/質問応答システム "wikilink")である"IBM Watson"が[アメリカ](https://ja.wikipedia.org/wiki/アメリカ "wikilink")のクイズ番組"Jeopady\!"に出場して人間に勝利する。(後にコグニティブ・コンピューティング・システムとして初の商用の実用化を達成する。)
...
データ集合の中から，高頻度で発生する特徴的なパターンを見つける。
  ...
  - 相関ルール抽出
      - データベースに蓄積された大量のデータから、頻繁に同時に生起する事象同士を相関の強い事象の関係、すなわち相関ルールとして抽出する技術。[POSや](../Page/販売時点情報管理.md "wikilink")[Eコマースの取引ログに含まれる購買履歴を利用した](https://ja.wikipedia.org/wiki/電子商取引 "wikilink")[バスケット解析](https://ja.wikipedia.org/wiki/バスケット解析 "wikilink")が著名である。
...
クラス分類は与えられたデータに対応するカテゴリを予測する問題。
  ...
  - 代表的な手法：[単純ベイズ分類器](https://ja.wikipedia.org/wiki/単純ベイズ分類器 "wikilink"), [決定木](https://ja.wikipedia.org/wiki/決定木 "wikilink"), [サポートベクターマシン](https://ja.wikipedia.org/wiki/サポートベクターマシン "wikilink")
...
与えられたデータに対応する実数値を予測する問題
  ...
  - 代表的な手法：線形回帰、[ロジスティック回帰](https://ja.wikipedia.org/wiki/ロジスティック回帰 "wikilink")、サポートベクトル回帰
...
### 商業ソフトウェア
  ...
  - **[SAS](https://ja.wikipedia.org/wiki/SAS "wikilink")** **[Enterprise Miner](https://ja.wikipedia.org/wiki/Enterprise_Miner "wikilink")**
  - **[SPSS](https://ja.wikipedia.org/wiki/SPSS "wikilink")** **[Clementine](https://ja.wikipedia.org/wiki/Clementine "wikilink")**
  ...
  - **[CART (HULINKS)](http://www.hulinks.co.jp/software/cart/)**： 巨大な[2進木](https://ja.wikipedia.org/wiki/2進木 "wikilink")でも短時間で作成可能な[決定木](https://ja.wikipedia.org/wiki/決定木 "wikilink")解析ソフト。
  ...
  - **[:en:Oracle |Data Mining](https://ja.wikipedia.org/wiki/:en:Oracle\<!--_[[:ja:神託 "wikilink")** ([Oracle Data Mining](http://www.oracle.com/technetwork/jp/database/options/odm/index.html))：　[Oracle Database](https://ja.wikipedia.org/wiki/Oracle_Database "wikilink") Enterprise EditionのオプションAPI。自動的にマイニングして予測・発見を報告する機能を開発しOracleアプリケーションに組み込むことを支援する。
  - Data Robot ([1](http://datarobot.com/)) 複数のアルゴリズムを並列計算させ、評価関数で順位付けする。

### 無償ソフトウェア

  - **[GNU R](https://ja.wikipedia.org/wiki/GNU_R "wikilink")** ([r-project.org](http://www.r-project.org/))：　[GNUプロジェクト](../Page/GNUプロジェクト.md "wikilink")による[S言語](https://ja.wikipedia.org/wiki/S言語 "wikilink")仕様をGNU GPL実装した汎用統計可視化環境。一般的に"[R言語](https://ja.wikipedia.org/wiki/R言語 "wikilink")"や"R"とも呼ばれる。無償の貢献プログラムパッケージは6000を越え、[Weka](https://ja.wikipedia.org/wiki/Weka "wikilink")を利用するRwekaや[Random forestなどもある](https://ja.wikipedia.org/wiki/Random_forest "wikilink")。[UIは](../Page/ユーザインタフェース.md "wikilink")、R GUIか[ターミナル](https://ja.wikipedia.org/wiki/ターミナル "wikilink")経由の[コマンドライン](https://ja.wikipedia.org/wiki/コマンドライン "wikilink")入力のみ。下記RED Rなどの援用でダイアグラム入力も出来る。R自体は[インタプリタ](../Page/インタプリタ.md "wikilink")だが、速度が必要なら[C言語](../Page/C言語.md "wikilink")や[Fortran](https://ja.wikipedia.org/wiki/Fortran "wikilink")のコードを直接記述して[コンパイル](https://ja.wikipedia.org/wiki/コンパイル "wikilink")実行でき、パッケージRcpp併用で[C++](../Page/C++.md "wikilink")も混在可能。信頼性に定評があり、[米国FDA公認](https://ja.wikipedia.org/wiki/アメリカ食品医薬品局 "wikilink")。[マルチプラットフォーム](https://ja.wikipedia.org/wiki/マルチプラットフォーム "wikilink")。GNU GPLオープンソース。
  - **[Weka](https://ja.wikipedia.org/wiki/Weka "wikilink")** ([waikato.ac.nz/ml/weka](http://www.cs.waikato.ac.nz/ml/weka/))：　[ワイカト大学](https://ja.wikipedia.org/wiki/ワイカト大学 "wikilink")で開発された、[java](https://ja.wikipedia.org/wiki/java "wikilink")ベースのデータマイニングソフトウェア。ダイアグラムなど多様なグラフィカルインタフェースで高度なマイニング手法を視覚的に構築し駆使できる。[連関規則や](https://ja.wikipedia.org/wiki/:en:Association_rule_learning "wikilink")[ニューラルネットワーク](https://ja.wikipedia.org/wiki/ニューラルネットワーク "wikilink")、[SVM](https://ja.wikipedia.org/wiki/SVM "wikilink")、決定木などさまざまな分析手法があらかじめ数多くモジュールとして組み込まれており、コードを書く事なくモジュールをリンクで結んでいけば入力・分析・出力までの流れを構築できる。ゼロからコードを書いてモジュール登録もできる他、プラグインによる機能拡張も可能。ただデータマイニング研究用のツールとして産まれただけに、的確に使うには分析手法の専門的な評価知識が必要。GNU GPLオープンソース。
  ...
  - **[Julia (プログラミング言語)](https://ja.wikipedia.org/wiki/Julia_\(プログラミング言語\) "wikilink")** ([julialang.org](http://julialang.org/))：　[科学技術計算](https://ja.wikipedia.org/wiki/科学技術計算 "wikilink")を主たる目的として設計された汎用高水準プログラミング言語とその実行環境。その開発動機として「[R言語](https://ja.wikipedia.org/wiki/R言語 "wikilink")の柔軟性は良いが、処理速度に幻滅した」ことを上げ、高速処理を開発の最優先目標としている。公式ページには既に統計やマイニングに適用できる多数の分野別パッケージが公開されている。[LLVM](https://ja.wikipedia.org/wiki/LLVM "wikilink")を利用しており、移植性にも優れる。MIT License オープンソース。
  ...
  - **D3.js** ([d3js.org](http://d3js.org/))：　ブラウザを使って統計データを様々な表現で[可視化](https://ja.wikipedia.org/wiki/可視化 "wikilink")するための [JavaScript](../Page/JavaScript.md "wikilink")ライブラリ。
  - **[OpenCV](https://ja.wikipedia.org/wiki/OpenCV "wikilink")**：　イメージや形状データの認識・抽出・予測処理を目的としたコンピュータビジョンライブラリであるが、[パターン認識](https://ja.wikipedia.org/wiki/パターン認識 "wikilink")、[機械学習](https://ja.wikipedia.org/wiki/機械学習 "wikilink")など汎用性ある関数が数多く収録され、データマイニングでの可用性も高い。[インテル](https://ja.wikipedia.org/wiki/インテル "wikilink")が開発。オープンソース。
  - **[Shogun toolbox](https://ja.wikipedia.org/wiki/:en:Shogun_\(toolbox\) "wikilink")** ([Shogun](http://www.shogun-toolbox.org/doc/en/current/index.html))：　マルチカーネル学習(MKL)など[サポートベクターマシン](https://ja.wikipedia.org/wiki/サポートベクターマシン "wikilink")を中心として最先端のアルゴリズムを網羅した機械学習ツールボックス。[C++](../Page/C++.md "wikilink")で実装され、[MATLAB](https://ja.wikipedia.org/wiki/MATLAB "wikilink")、[GNU R](https://ja.wikipedia.org/wiki/GNU_R "wikilink")、[GNU Octave](https://ja.wikipedia.org/wiki/GNU_Octave "wikilink")、[Python](../Page/Python.md "wikilink")、[Java](https://ja.wikipedia.org/wiki/Java "wikilink")、[Lua](https://ja.wikipedia.org/wiki/Lua "wikilink")、[Ruby](../Page/Ruby.md "wikilink")、[C\#](https://ja.wikipedia.org/wiki/C# "wikilink") から利用可能なインタフェースがある。GNU GPL3。
