...
**擬ポテンシャル**（ぎポテンシャル、）は、[第一原理計算](../Page/第一原理計算.md "wikilink")において[原子核](https://ja.wikipedia.org/wiki/原子核 "wikilink")近傍の[内核電子](https://ja.wikipedia.org/wiki/内核電子 "wikilink")を直接取り扱わず、これを[価電子](https://ja.wikipedia.org/wiki/価電子 "wikilink")に対する単なる[ポテンシャル関数](https://ja.wikipedia.org/wiki/ポテンシャル関数 "wikilink")に置き換える手法である。これは原子間結合距離など、多くの物性において、内核電子の直接の影響が小さいことを利用したものである。[平面波基底](https://ja.wikipedia.org/wiki/平面波基底 "wikilink")を用いて第一原理計算を行う場合、計算コストの問題から、何らかの擬ポテンシャルを使う場合がほとんどである。

こうした擬ポテンシャルは、内核電子が与える静電相互作用や交換相関相互作用とは全く無関係に、原子核から或る半径よりも外側では、波動関数が全電子計算の結果と一致することだけを指針に作成される。そのため平均場近似といった物理的な近似や洞察を含むものではなく、あくまでも計算のための便宜的な手法といえる。価電子帯の波動関数は、原子核近傍で同径方向に節(ノード)を持つが、擬ポテンシャルを作製する際には、こうした節を取り除き、滑らかな波動関数となるように問題をすり替える。このため、擬ポテンシャル法により得られる波動関数([密度汎関数法に用いる場合は](https://ja.wikipedia.org/wiki/密度汎関数理論 "wikilink")[Kohn-Sham軌道](https://ja.wikipedia.org/wiki/コーン–シャム軌道 "wikilink"))は擬波動関数と呼ばれることもある。こうした操作が、カットオフエネルギーの大幅な削減へと繋がる。
...
ただし、どこまでを内殻電子とし、どこからを価電子として取り扱うかには任意性が残る。たとえば[ガリウム](https://ja.wikipedia.org/wiki/ガリウム "wikilink")の3d軌道など浅い内殻電子を価電子として擬ポテンシャルの手法を利用することは可能である。そうした取り扱いでは、内殻軌道からの効果も部分的に計算に取り込むことが出来る。

## フェルミの擬ポテンシャル

[エンリコ・フェルミ](https://ja.wikipedia.org/wiki/エンリコ・フェルミ "wikilink")は、[原子核](https://ja.wikipedia.org/wiki/原子核 "wikilink")による自由[中性子](https://ja.wikipedia.org/wiki/中性子 "wikilink")の散乱を記述するために擬ポテンシャル\(V\)を導入した。\[1\] 散乱体から遠く離れた中性子の波動関数は、球面波で表される*s* 波の散乱波と入射平面波との和で表されると仮定する。よってポテンシャルは動径\(r\)の関数で与えられる。

\[V(r)=\frac{2\pi\hbar^2}{m}b\,\delta(r)\]

ここで\(\hbar\)は[プランク定数](https://ja.wikipedia.org/wiki/プランク定数 "wikilink")を\(2\pi\)で割ったもの、\(m\) は[質量](https://ja.wikipedia.org/wiki/質量 "wikilink")、\(\delta(r)\) は [ディラックのデルタ関数](https://ja.wikipedia.org/wiki/ディラックのデルタ関数 "wikilink")、\(b\) は中性子[散乱長](https://ja.wikipedia.org/wiki/散乱長 "wikilink")、\(r=0\) は[原子核](https://ja.wikipedia.org/wiki/原子核 "wikilink")の[重心](https://ja.wikipedia.org/wiki/重心 "wikilink")である。\[2\] この\(\delta\)関数のフーリエ変換によって中性子の[形状因子](https://ja.wikipedia.org/wiki/形状因子 "wikilink")が得られる。
...
## 第一原理による擬ポテンシャル
  ...
  - [ノルム保存型擬ポテンシャル](https://ja.wikipedia.org/wiki/ノルム保存型擬ポテンシャル "wikilink")
  - [ウルトラソフト擬ポテンシャル](https://ja.wikipedia.org/wiki/ウルトラソフト擬ポテンシャル "wikilink")

## 関連項目

  - [第一原理バンド計算](../Page/第一原理バンド計算.md "wikilink")
  - [Kleinman-Bylander近似](https://ja.wikipedia.org/wiki/Kleinman-Bylander近似 "wikilink")
