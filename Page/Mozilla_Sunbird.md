...
2006年10月リリースのバージョン0.3ではGeckoのバージョンを1.9a1に変更し、オプションの画面やアドオンの管理機能など複数の点が新しくなっている。また、このバージョンより[Intel Macに対応した](../Page/Intel_Mac.md "wikilink")。

2007年3月リリースのバージョン0.3.1では2007年からの[アメリカ合衆国](https://ja.wikipedia.org/wiki/アメリカ合衆国 "wikilink")での[夏時間](../Page/夏時間.md "wikilink")の変更に対応した。これに伴いWindows版ではOSのタイムゾーン更新プログラムを導入する必要がある\[2\]。

2007年6月リリースのバージョン0.5より、拡張機能を導入することで[Googleカレンダー](https://ja.wikipedia.org/wiki/Googleカレンダー "wikilink")との同期が可能になった\[3\]。またバージョン0.8以降では、[CalDAV](https://ja.wikipedia.org/wiki/CalDAV "wikilink")サポートを設定することで拡張機能を導入することなく直接 Googleカレンダーと同期することも可能である\[4\]。
...
## 関連項目
  ...
  - [Mozilla Foundation](../Page/Mozilla_Foundation.md "wikilink") - 開発元団体
  - [Mozilla Japan](https://ja.wikipedia.org/wiki/Mozilla_Japan "wikilink") - 日本国内でMozilla製品のサポートを行う団体
  - [もじら組](../Page/もじら組.md "wikilink")
  - [Mozilla](../Page/Mozilla.md "wikilink") - SunBirdのベースとなったソフトウェア
...
## 外部リンク
  ...
  - [Calendarプロジェクト(日本語)](http://www.mozilla-japan.org/projects/calendar/) - 本家ページの翻訳版
  - [Lightning Calendar](https://www.thunderbird.net/ja/calendar/) - 本家サイト
  - [CPSS](http://f17.aaa.livedoor.jp/~every/products/Sunbird/sunbird-jlp.html) - 非公式日本語化パックを配布

[Category:オープンソースソフトウェア](https://ja.wikipedia.org/wiki/Category:オープンソースソフトウェア "wikilink") [Category:Mozilla](https://ja.wikipedia.org/wiki/Category:Mozilla "wikilink") [Category:クロスプラットフォームのソフトウェア](https://ja.wikipedia.org/wiki/Category:クロスプラットフォームのソフトウェア "wikilink") [Category:2005年のソフトウェア](https://ja.wikipedia.org/wiki/Category:2005年のソフトウェア "wikilink")

1.  [Sunbird 1.0 beta1 now available for download (last release of Sunbird)](http://weblogs.mozillazine.org/calendar/2010/04/sunbird_10_beta1_now_available.html)
2.  [Sunbird 0.5 Release Notes](http://www.mozilla.org/projects/calendar/releases/sunbird0.5.html#issues-windows)
3.  [Calendar:GDATA Provider](https://wiki.mozilla.org/Calendar:GDATA_Provider)
4.  [CalDAV スタート ガイド - Google カレンダー ヘルプ](https://support.google.com/calendar/answer/99358?hl=ja)