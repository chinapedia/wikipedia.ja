...
**構造体**（こうぞうたい、）は[プログラミング言語](../Page/プログラミング言語.md "wikilink")における[データ型](https://ja.wikipedia.org/wiki/データ型 "wikilink")の一つで、1つもしくは複数の値をまとめて格納できる型。それぞれのメンバー（フィールド）は型が異なっていてもよい点が[配列](../Page/配列.md "wikilink")と異なる。

[C](../Page/C言語.md "wikilink")/[C++](../Page/C++.md "wikilink")や[C\#などで](../Page/C_Sharp.md "wikilink")**struct**としてサポートされているほか、[Visual Basicのユーザー定義型や](https://ja.wikipedia.org/wiki/Visual_Basic "wikilink")、[Pascal](../Page/Pascal.md "wikilink")や[Ada](../Page/Ada.md "wikilink")の**record**型も構造体に相当する。

[クラスベース](https://ja.wikipedia.org/wiki/クラスベース "wikilink")の[オブジェクト指向言語](https://ja.wikipedia.org/wiki/オブジェクト指向言語 "wikilink")では、[抽象データ型](https://ja.wikipedia.org/wiki/抽象データ型 "wikilink")としての[クラスが構造体の役割をも内包する](../Page/クラス_\(コンピュータ\).md "wikilink")。[Cの文法を継承した言語では](../Page/C言語.md "wikilink")**struct**キーワードを含むこともあるが、言語によってその役割は異なる。
...
## 関連項目
  ...
  - [再帰データ型](https://ja.wikipedia.org/wiki/再帰データ型 "wikilink")
