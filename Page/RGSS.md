...
2010年3月現在、下記のソフトに右記のバージョンが搭載されている。以下では、これらのソフトをまとめて「RPGツクール」と記す。
  ...
  - [RPGツクールXP](../Page/RPGツクールXP.md "wikilink") - RGSS（以下では区別のため RGSS1 と記す）
...
[RPGツクールXP](../Page/RPGツクールXP.md "wikilink")に搭載された。RGSS の最初のバージョンである。
...
## RGSS の欠点
  ...
  - 初心者にはエラーが起きても原因が分かりにくい。
    以前の[RPGツクール](../Page/RPGツクール.md "wikilink")でも、イベントの組み方に起因する[バグ](../Page/バグ.md "wikilink")には原因が分かりづらいものがあった。しかしさらにRGSSの場合、Rubyにおける文法エラーなどが発生するおそれがある。デフォルトのエラーダイアログでは最低限のエラーメッセージのみ表示されるため、初心者が初見で意味を理解することは難しい。
