...
## 種類
  ...
  - [進入灯](https://ja.wikipedia.org/wiki/進入灯 "wikilink")（Approach Lighting System / ALS）
    着陸しようとする航空機に対し、最終進入経路を示すために進入区域及び着陸帯内に設置する灯火。
  - [進入角指示灯](https://ja.wikipedia.org/wiki/PAPI "wikilink")（Precision Approach Path Indicator / PAPI）
  ...
  - 誘導路灯（Taxiway Edge Lights / TWYL）
    地上走行中の航空機に[転回区域](https://ja.wikipedia.org/wiki/転回区域 "wikilink")を除く誘導路及び[エプロンの縁を示すために設置する灯火](https://ja.wikipedia.org/wiki/エプロン_\(飛行場\) "wikilink")。
