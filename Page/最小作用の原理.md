...
**最小作用の原理**（さいしょうさようのげんり、）は、[物理学](../Page/物理学.md "wikilink")における基本原理の一つで、特に[解析力学](https://ja.wikipedia.org/wiki/解析力学 "wikilink")の構成において、その基礎付けを与える[動力学](https://ja.wikipedia.org/wiki/動力学 "wikilink")の[原理](https://ja.wikipedia.org/wiki/原理 "wikilink")である。最小作用の原理に従って、[力学系](https://ja.wikipedia.org/wiki/力学系 "wikilink")の[運動](https://ja.wikipedia.org/wiki/運動_\(物理学\) "wikilink")（時間発展）は、[作用と呼ばれる](https://ja.wikipedia.org/wiki/作用_\(物理学\) "wikilink")[汎関数](https://ja.wikipedia.org/wiki/汎関数 "wikilink")を最小にするような[軌道に沿って実現される](https://ja.wikipedia.org/wiki/軌道_\(力学\) "wikilink")。

物理学における最大の指導原理の一つであり、[電磁気学](../Page/電磁気学.md "wikilink")における[マクスウェルの方程式](../Page/マクスウェルの方程式.md "wikilink")や[相対性理論](https://ja.wikipedia.org/wiki/相対性理論 "wikilink")における[アインシュタイン方程式](../Page/アインシュタイン方程式.md "wikilink")ですら、対応する作用の極小条件から導かれる。また、[量子力学](https://ja.wikipedia.org/wiki/量子力学 "wikilink")においても、この法則そのものは、[ファインマン](https://ja.wikipedia.org/wiki/ファインマン "wikilink")の[経路積分](https://ja.wikipedia.org/wiki/経路積分 "wikilink")の考え方によって理解できる。物体は運動において様々な運動経路（軌道）をとる事が可能であるが、作用積分が[極値](../Page/極値.md "wikilink")（[鞍点](https://ja.wikipedia.org/wiki/鞍点 "wikilink")値）をとる(すなわち最小作用の原理を満たす)経路が最も量子力学的な[確率密度](https://ja.wikipedia.org/wiki/確率密度 "wikilink")が高くなる事が知られている。

## モーペルテュイの原理

力学における初期の[変分原理](../Page/変分原理.md "wikilink")である**モーペルテュイの原理**（）は、[1747年](../Page/1747年.md "wikilink")にフランスの数学者[モーペルテュイによって考え出された](https://ja.wikipedia.org/wiki/ピエール・ルイ・モーペルテュイ "wikilink")。モーペルテュイの最小作用の原理とも言う。一個の質点からなる系において、運動エネルギー  とすると  が成り立つ経路を運動する。質点が運動する経路の長さを 、質点の速度を  として、 であるから  となる。つまり、質点の運動は、[運動量](../Page/運動量.md "wikilink")  と経路の微小片  の積の積分に対する停留値問題に帰着する。
...
量子力学においても、\(\hbar \rightarrow 0\)の極限によって古典力学に近づくことから、同様の原理が存在することが予想される。通常の正準量子化を行ったハミルトニアンによる量子力学の記述では、このような原理の存在は必ずしも明確ではないが、ファインマンが考案した[経路積分](https://ja.wikipedia.org/wiki/経路積分 "wikilink")の手法を用いることで、量子論における対応原理を理解することができる。経路積分によれば、遷移確率
...
## 関連記事
  ...
  - [経路積分](https://ja.wikipedia.org/wiki/経路積分 "wikilink")
