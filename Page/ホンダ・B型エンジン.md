...
<!-- end list -->
  ...
  - 内径×行程：81.0mm×95.0mm
  - 圧縮比：9.4
  - [バルブ挟み角](../Page/バルブ挟み角.md "wikilink")：吸気26°、排気26°
  - 燃料供給装置形式：電子制御燃料噴射式（PGM-FI）
  - 参考スペック（CA3 アコード）
...
<!-- end list -->
  ...
  - インテグラ （DC2/DB8）
  - [VEMAC RD180](https://ja.wikipedia.org/wiki/Vemac "wikilink")（エンジン提供）
...
<!-- end list -->
  ...
  - [インテグラTYPE R](../Page/ホンダ・インテグラタイプR.md "wikilink") （DC2/DB8）
...
:;SOHC仕様
  ...
  - [プレリュード](../Page/ホンダ・プレリュード.md "wikilink") （BA4/5）
...
<!-- end list -->
  ...
  - [CR-V](../Page/ホンダ・CR-V.md "wikilink") （RD1/2）
  - [ステップワゴン](../Page/ホンダ・ステップワゴン.md "wikilink") （RF1/2）
  - [S-MX](../Page/ホンダ・S-MX.md "wikilink") （RH1/2）
  - オルティア （EL2/3）
