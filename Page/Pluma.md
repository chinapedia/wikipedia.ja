...
plumaは完全にMATEに統合されており、Caja（MATEの[ファイルマネージャ](https://ja.wikipedia.org/wiki/ファイルマネージャ "wikilink")）からのドロップが可能で、MATE Virtual File System、MATEのプリントフレームワーク、MATEのヘルプシステムを使っている\[1\]。
