> この記事は[密告 \(ソフトウェア\)](https://ja.wikipedia.org/wiki/密告_\(ソフトウェア\))から翻訳されています。


**密告**（みっこく）とは、[Shareの](../Page/Share_\(ソフトウェア\).md "wikilink")[キャッシュ](../Page/キャッシュ.md "wikilink")を管理するツールである。 Diffuseキャッシュも含め全てのキャッシュを表示させることが出来ることが特徴である。
