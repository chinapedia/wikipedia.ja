> この記事は[ZOO \(ファイルフォーマット\)](https://ja.wikipedia.org/wiki/ZOO_\(ファイルフォーマット\))から翻訳されています。
...
プログラムソースコードは[Usenet](https://ja.wikipedia.org/wiki/Usenet "wikilink")の comp.sources.miscニュースグループで最初に公開され、多くの[Unix系](../Page/Unix系.md "wikilink")OSで動作した。[実行形式は](../Page/実行ファイル.md "wikilink")、[MS-DOS](../Page/MS-DOS.md "wikilink")ユーザ・コミュニティにも公開された。解凍の機能だけを提供する**booz**という名前の補助的なプログラムも開発された。

ZOOファイルフォーマットは、[ディジタル・イクイップメント・コーポレーション](../Page/ディジタル・イクイップメント・コーポレーション.md "wikilink")(現在の[ヒューレット・パッカード](../Page/ヒューレット・パッカード.md "wikilink"))の[VAX](../Page/VAX.md "wikilink")コンピュータで動作する[OpenVMS](../Page/OpenVMS.md "wikilink")[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink")でよく使用された。[コモドール](../Page/コモドール.md "wikilink")の[Amiga](../Page/Amiga.md "wikilink")のコミュニティでも、ある期間使用された。
...
ファイル拡張子の**.zoo**は[マイクロソフト](../Page/マイクロソフト.md "wikilink")のゲームである、[ズー タイクーンの保存データとしても使用される](../Page/ズー_タイクーン.md "wikilink")。
