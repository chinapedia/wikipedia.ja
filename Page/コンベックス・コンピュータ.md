...
**コンベックス・コンピュータ** (*Convex Computer*) は、[ベクトル型](../Page/ベクトル計算機.md "wikilink")[ミニスーパーコンピュータ](https://ja.wikipedia.org/wiki/ミニスーパーコンピュータ "wikilink")や[スーパーコンピュータ](../Page/スーパーコンピュータ.md "wikilink")を製造した企業である。後に[ヒューレット・パッカード](../Page/ヒューレット・パッカード.md "wikilink") (HP) 社の[PA-RISC](https://ja.wikipedia.org/wiki/PA-RISC "wikilink")を使った*Exemplar*という[並列コンピューティング](https://ja.wikipedia.org/wiki/並列コンピューティング "wikilink")マシンを開発すると、[1995年](https://ja.wikipedia.org/wiki/1995年 "wikilink")にHP社がコンベックスを買収した。HP社は、しばし *Exemplar* を販売していたが、後にその技術を活用して [HP 9000](https://ja.wikipedia.org/wiki/HP_9000 "wikilink") **Vクラス** を開発した。

## 歴史

コンベックス社は[1982年](../Page/1982年.md "wikilink")、Bob Paluck と Steve Wallach が[テキサス州](../Page/テキサス州.md "wikilink")[リチャードソンに設立した](https://ja.wikipedia.org/wiki/リチャードソン_\(テキサス州\) "wikilink")。設立当初の社名は **Parsec**であった。彼らは[クレイ](https://ja.wikipedia.org/wiki/クレイ "wikilink")・リサーチの[ベクトル計算機](../Page/ベクトル計算機.md "wikilink")に良く似た[アーキテクチャのマシンをもっと低価格で提供することを計画していた](../Page/コンピュータ・アーキテクチャ.md "wikilink")。コストを削減するため、コンベックスのデザインはクレイほど先進的なものではなく、一般的な技術に基づいたものであった。また、それによる性能低下は別の方法で解決することを同時に意図していた。

最初のマシン **C1** は[1985年](https://ja.wikipedia.org/wiki/1985年 "wikilink")にリリースされた。C1 の設計は [Cray-1](https://ja.wikipedia.org/wiki/Cray-1 "wikilink") によく似ているが、使用する[メモリ](https://ja.wikipedia.org/wiki/メモリ "wikilink")や[CPU](../Page/CPU.md "wikilink")は普通のものである。彼らは、これにベクターユニットを追加できる機能を持たせた。ベクターユニットは128個の64[ビット](../Page/ビット.md "wikilink")[レジスタを持っていて](../Page/レジスタ_\(コンピュータ\).md "wikilink")、Cray-1 の二倍である。また、クレイのマシンでは採用されていない[仮想記憶](../Page/仮想記憶.md "wikilink")方式を採用しているため、[プログラミングがやりやすくなっている](https://ja.wikipedia.org/wiki/プログラミング_\(コンピュータ\) "wikilink")。[CMOS](../Page/CMOS.md "wikilink")ベースのチップではあるがベクターユニットを追加することで、[倍精度](https://ja.wikipedia.org/wiki/倍精度 "wikilink")（64ビット）で約 20M[FLOPS](../Page/FLOPS.md "wikilink")、[単精度](https://ja.wikipedia.org/wiki/単精度 "wikilink")（32ビット）で約 40MFLOPS の性能を記録しており、Cray-1 の 5分の1 の性能である。彼らは、自動[ベクトル化](../Page/ベクトル化.md "wikilink")機能を劇的に強化した[コンパイラ](../Page/コンパイラ.md "wikilink")を開発し、既存の[プログラムをそのまま移植してコンパイルするだけで性能が劇的に向上するようにした](../Page/プログラム_\(コンピュータ\).md "wikilink")。[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink")は、[BSD](../Page/BSD.md "wikilink")系[UNIX](../Page/UNIX.md "wikilink")の **ConvexOS** である。
...
**C3**・**C4**では、さらなる性能向上策として[ガリウムヒ素チップを実装した](https://ja.wikipedia.org/wiki/ヒ化ガリウム "wikilink")。[Cray-3](https://ja.wikipedia.org/wiki/Cray-3 "wikilink")と同じ方向性であったが、性能向上は限定的で、しかも市場投入が遅すぎた。これによりコンベックスは資金を失った。

[1994年](../Page/1994年.md "wikilink")、コンベックスは全く新しい *'Exemplar* というシステムを発表する。従来の C シリーズの[ベクトル計算機](../Page/ベクトル計算機.md "wikilink")と異なり、Examplar は HP の[PA-RISC](https://ja.wikipedia.org/wiki/PA-RISC "wikilink")チップを使用した並列コンピュータであり、[SCI](https://ja.wikipedia.org/wiki/Scalable_Coherent_Interconnect "wikilink") によるノード間結合技術を使用している。この開発の時点でコンベックスはソフト・ハード両面でHPとの技術提携契約を結んでいた。

1995年、[ヒューレット・パッカード](../Page/ヒューレット・パッカード.md "wikilink")社 (HP) はコンベックス社を買収した。HPは、コンベックス Exemplar マシンを **Sクラス** および **Xクラス** として[HP 9000シリーズの一部として販売していたが](https://ja.wikipedia.org/wiki/HP_9000 "wikilink")、Exemplar の技術を活用して新たに **Vクラス** を開発した。
...
[コンピュータ](../Page/コンピュータ.md "wikilink")関連の有名人にはコンベックス出身の人が何人かいる。
  ...
  - [ロバート・T・モリス](https://ja.wikipedia.org/wiki/ロバート・T・モリス "wikilink")：[モリスワーム](https://ja.wikipedia.org/wiki/モリスワーム "wikilink")（世界初の[インターネットワーム](https://ja.wikipedia.org/wiki/ワーム_\(コンピュータ\) "wikilink")）で有名。コンベックスで研修生として夏の間だけ働いていた。
