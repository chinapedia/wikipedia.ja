...
CLIPS言語の後継として[Jess](https://ja.wikipedia.org/wiki/Jess "wikilink")([Java](https://ja.wikipedia.org/wiki/Java "wikilink")で書き直されたルールベース部を持つが、その後異なる方向に成長)、[ECLiPSe](http://www.icparc.ic.ac.uk/eclipse/)、Haley Eclipse、FuzzyCLIPS (関連性の概念を導入した言語)などがある。
