...
**楕円**（だえん、**橢円**ともいう。）とは、[平面](../Page/平面.md "wikilink")上のある2定点からの距離の和が一定となるような点の集合から作られる[曲線](../Page/曲線.md "wikilink")である。基準となる2定点を[焦点という](../Page/焦点_\(幾何学\).md "wikilink")。[円錐曲線](../Page/円錐曲線.md "wikilink")の一種である。
