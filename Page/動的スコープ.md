...
**動的スコープ**、**ダイナミックスコープ**（）とは、[プログラミング言語](../Page/プログラミング言語.md "wikilink")における[スコープ](https://ja.wikipedia.org/wiki/スコープ "wikilink")の一種である。
...
動的スコープの例としては古典[LISP](https://ja.wikipedia.org/wiki/LISP "wikilink")や[Emacs Lisp](../Page/Emacs_Lisp.md "wikilink")、[LOGO](https://ja.wikipedia.org/wiki/LOGO "wikilink")、[Perl](../Page/Perl.md "wikilink")(「local」宣言した変数)、[Bash](../Page/Bash.md "wikilink")(関数内で「local」宣言した変数)などがある。
