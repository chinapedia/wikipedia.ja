...
プログラムのソースコードが一般に公開されている[オープンソース](../Page/オープンソース.md "wikilink")の3D[レンダリングエンジン](https://ja.wikipedia.org/wiki/レンダリングエンジン "wikilink")（レンダラー）の一つで、独自の[C言語](../Page/C言語.md "wikilink")風の構造化ドキュメントによりデータを入力し、マクロ関数による半自動配置ができるので、[シミュレータとしての利用も可能である](https://ja.wikipedia.org/wiki/シミュレーション "wikilink")。また、数学的モデリングに強い。
...
## POV-Ray用モデラー
  ...
  - [Blender](https://ja.wikipedia.org/wiki/Blender "wikilink") - オープンソースの統合3DCGソフトウェア。POV-Ray用アドオンが同梱されており、それを有効にすることでPOV-Rayに対応する。POVコードの直接編集にも対応している。Blender 2.79でPOVコードの[シンタックスハイライト](https://ja.wikipedia.org/wiki/シンタックスハイライト "wikilink")にも対応した。

### 開発停止中

  - Moray - 古くから存在するPOV-Ray用[モデラー](https://ja.wikipedia.org/wiki/モデラー "wikilink")。2007年、POV-Rayの開発元が買収した\[7\]。開発停止中。
...
[right](https://ja.wikipedia.org/wiki/ファイル:PNG_transparency_demonstration_1.png "wikilink")、[屈折](https://ja.wikipedia.org/wiki/屈折 "wikilink")、[焦点ブラー](https://ja.wikipedia.org/wiki/焦点ブラー "wikilink")などの表現技法を使用している。\]\]

POV-Rayの機能は開発当初から充実していたが、近年のバージョンでは以下の機能を搭載している。

  - マクロとループを搭載した[チューリング完全](https://ja.wikipedia.org/wiki/チューリング完全 "wikilink")のSDL (scene description language)\[9\]
  ...
  - 多種の[光源](https://ja.wikipedia.org/wiki/光源 "wikilink")
  - [霧](https://ja.wikipedia.org/wiki/霧 "wikilink")などの大気エフェクトや媒体（[煙](https://ja.wikipedia.org/wiki/煙 "wikilink")、[雲](https://ja.wikipedia.org/wiki/雲 "wikilink")）
  - [フォトンマッピング](https://ja.wikipedia.org/wiki/フォトンマッピング "wikilink")による[反射](https://ja.wikipedia.org/wiki/反射 "wikilink")や[コースティクス](https://ja.wikipedia.org/wiki/コースティクス "wikilink")（集光模様）
  - [バンプマッピング](https://ja.wikipedia.org/wiki/バンプマッピング "wikilink")による[しわ](https://ja.wikipedia.org/wiki/しわ "wikilink")、[いぼ](https://ja.wikipedia.org/wiki/いぼ "wikilink")、[波](https://ja.wikipedia.org/wiki/波 "wikilink")などの模様
  - [ラジオシティ](https://ja.wikipedia.org/wiki/ラジオシティ "wikilink")
  - [TGA](https://ja.wikipedia.org/wiki/TGA "wikilink")、[PNG](https://ja.wikipedia.org/wiki/Portable_Network_Graphics "wikilink")、[JPEG](https://ja.wikipedia.org/wiki/JPEG "wikilink")などの[テクスチャ](https://ja.wikipedia.org/wiki/テクスチャ "wikilink")や出力画像のフォーマットサポート（JPEGは入力のみ）
  - 豊富なドキュメント

POV-Rayには[サードパーティー](https://ja.wikipedia.org/wiki/サードパーティー "wikilink")によるサポートが多いのが魅力である。多くのツール、テクスチャ、モデル、背景、チュートリアルがWeb上から使用可能である。
