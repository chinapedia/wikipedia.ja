...
**論理演算**（ろんりえんざん、logical operation）は、論理式において、[論理演算子](https://ja.wikipedia.org/wiki/論理演算子 "wikilink")などで表現される論理関数（[ブール関数](https://ja.wikipedia.org/wiki/ブール関数 "wikilink")）を評価し（正確には、関数適用を評価し\[1\]）、変数（変項）さらには論理式全体の値を求める演算である。

[非古典論理](https://ja.wikipedia.org/wiki/非古典論理 "wikilink")など他にも多くの論理の体系があるが、ここでは[古典論理](https://ja.wikipedia.org/wiki/古典論理 "wikilink")のうちの[命題論理](https://ja.wikipedia.org/wiki/命題論理 "wikilink")、特にそれを形式化した[ブール論理](https://ja.wikipedia.org/wiki/ブール論理 "wikilink")に話を絞る。従って対象がとる値は[真理値](https://ja.wikipedia.org/wiki/真理値 "wikilink")の2値のみに限られる。また、その真理値の集合（真理値集合）と演算（演算子）は[ブール代数](../Page/ブール代数.md "wikilink")を構成する。

コンピュータの[プロセッサ](https://ja.wikipedia.org/wiki/プロセッサ "wikilink")や[プログラミング言語](../Page/プログラミング言語.md "wikilink")で多用されるものに、[ブーリアン型](https://ja.wikipedia.org/wiki/ブーリアン型 "wikilink")を対象とした通常の論理演算の他に、ワード等の[ビット](../Page/ビット.md "wikilink")毎に論理演算を行なう演算があり、[ビット演算](https://ja.wikipedia.org/wiki/ビット演算 "wikilink")という。

なお、以上は[モデル論的な議論であり](https://ja.wikipedia.org/wiki/モデル理論 "wikilink")、[証明論](https://ja.wikipedia.org/wiki/証明論 "wikilink")的には、[公理](../Page/公理.md "wikilink")と[推論規則](https://ja.wikipedia.org/wiki/推論規則 "wikilink")に従って論理式を変形（書き換え）する演算がある（[証明論\#証明計算の種類](https://ja.wikipedia.org/wiki/証明論#証明計算の種類 "wikilink")）。
...
以上の演算に対して成り立っている定理として、以下のようなものがある。（証明論的には（「命題論理の証明論」）、以下の等式のいくつかに相当する[公理](../Page/公理.md "wikilink") and・or [推論規則](https://ja.wikipedia.org/wiki/推論規則 "wikilink")が採用される）
  ...
  - [べき等則](https://ja.wikipedia.org/wiki/冪等 "wikilink")
...
（詳細は英語版記事 [:en:Functional completeness](https://ja.wikipedia.org/wiki/:en:Functional_completeness "wikilink") を参照のこと）以上の演算のうち、ごく少数の種類の演算の組み合わせによって、任意の演算を「実装」することができる。そのような演算の組の性質を functional completeness という。∨ と ∧ だけでは完全ではなく、必ず ¬ も必要である。一方 ¬ があれば、∨ と ∧ はどちらか一方でも良い。さらに興味深いものとして、¬ と ∨ あるいは ∧ の組合せである、[否定論理積](https://ja.wikipedia.org/wiki/否定論理積 "wikilink")（[NAND](https://ja.wikipedia.org/wiki/NANDゲート "wikilink")）や[否定論理和](https://ja.wikipedia.org/wiki/否定論理和 "wikilink")（[NOR](https://ja.wikipedia.org/wiki/NORゲート "wikilink")）は、それ一つだけで完全である。なお、→ の記号が使われることが多い「ならば」（imply、[論理包含](https://ja.wikipedia.org/wiki/論理包含 "wikilink")）は微妙な点があり（たとえば、演算子だけでなく定数入力を必要とする）、英語版Wikipediaの Implicational propositional calculus の記事（[:en:Implicational propositional calculus](https://ja.wikipedia.org/wiki/:en:Implicational_propositional_calculus "wikilink")）では「virtual completeness」と表現している。
...
## 関連項目
  ...
  - [ブール関数](https://ja.wikipedia.org/wiki/ブール関数 "wikilink") - [ブール代数](../Page/ブール代数.md "wikilink")
  - [ベン図](https://ja.wikipedia.org/wiki/ベン図 "wikilink") - [オイラー図](https://ja.wikipedia.org/wiki/オイラー図 "wikilink")
