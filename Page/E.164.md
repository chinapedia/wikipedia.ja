...
**E.164**は、[ITU-T](../Page/ITU-T.md "wikilink")による[公衆交換電話網](../Page/公衆交換電話網.md "wikilink")などの[電話網](../Page/電話網.md "wikilink") の[電話番号計画](https://ja.wikipedia.org/wiki/電話番号計画 "wikilink")の勧告である。「+」が頭に付けられた、国番号を除いた部分が15桁以下の[電話番号](../Page/電話番号.md "wikilink")として表記される。多くの国の一般の電話からは、国際電話識別番号を付加してダイヤルされる。
...
| [国番号](../Page/国際電話番号の一覧.md "wikilink") | [事業者識別番号](../Page/電気通信事業者.md "wikilink") | 加入者番号     |
| -------------------------------------- | ---------------------------------------- | --------- |
...
そして、[SIPの](../Page/Session_Initiation_Protocol.md "wikilink")[IP電話](../Page/IP電話.md "wikilink")などのサービスのための[IPアドレス](../Page/IPアドレス.md "wikilink")を調べるためにDNSを使用することができる。 代替方法はDUNDiである。（DUNDiはENUM(\[1\]の[P2P実装](../Page/Peer_to_Peer.md "wikilink")）。 DUNDiはIETFによってまだ規格化されていない。
