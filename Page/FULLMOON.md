...
## 用語
  ...
  - 無限の心臓（[ファフニール](https://ja.wikipedia.org/wiki/ファフニール "wikilink")）
...
<!-- end list -->
  ...
  - 月の世界
    深夜0時以降から太陽が昇るまでの時間帯を示す。そこでは世界から失われたもの（物、人、夢.etc）が全て存在しており、死者や呪いによってその身を封じられた者も月の持つ魔力によって蘇る。ケイも月の世界では、メイの身体を[依り代](https://ja.wikipedia.org/wiki/依り代 "wikilink")（依巫）としてこの世に出て来られる。
  - 黒い逆十字
  ...
  - 月の石（[ギフト](https://ja.wikipedia.org/wiki/ギフト "wikilink")）
...
『FULLMOON』に登場する武器の幾つかは、史実にも存在する[剣](../Page/剣.md "wikilink")（魔剣）である。
  ...
  - 完全なる断罪の剣（[テュルフィング](https://ja.wikipedia.org/wiki/テュルフィング "wikilink")）
    黒い逆十字の一人グリーブが使う武器。身に纏う鎧を構成する無数の刃で敵を切り刻む。
      - 鋭剣乱舞（[エッケザックス](https://ja.wikipedia.org/wiki/エッケザックス "wikilink")）
        テュルフィング第一殺。無数の刃を針山のようにして放出する。
  - 白炎の杖（[レーヴァテイン](https://ja.wikipedia.org/wiki/レーヴァテイン "wikilink")）
