...
[マイクロソフト](../Page/マイクロソフト.md "wikilink")のDOSとWindowsのバッチ[プログラミングはこれらの](https://ja.wikipedia.org/wiki/プログラミング_\(コンピュータ\) "wikilink")[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink") (OS) 製品のリリースとともに発展してきた。これらOSに付属するコマンド[インタプリタ](../Page/インタプリタ.md "wikilink")は2つの動作モードを持つ。一つは対話モード（[コマンドプロンプト](../Page/コマンドプロンプト.md "wikilink")に従ってユーザーがコマンドを入力すると即座に実行される）と[バッチモード](https://ja.wikipedia.org/wiki/バッチ処理 "wikilink")（予め設定されたコマンド列を実行する）である。どちらのモードも[UNIX](../Page/UNIX.md "wikilink")のシェルや1980年代初期の[CP/M](https://ja.wikipedia.org/wiki/CP/M "wikilink")などのコマンドインターフェイスがその考え方のベースとなっている。
...
## 関連項目
  ...
  - [バッチ処理](https://ja.wikipedia.org/wiki/バッチ処理 "wikilink")
