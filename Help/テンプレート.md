...
<td><p>たとえば<a href="https://ja.wikipedia.org/wiki/メインページ" title="wikilink">メインページ</a>で</p></td>
</tr>
<tr class="even">
<td><div style="padding:0.5em; margin:0; border: 1px blue dashed; font-family: monospace">
<p>{{msgnw:すけすけ}}</p>
...
ウィキペデイアの[サーバ](../Page/サーバ.md "wikilink")ー[キャッシュの仕様](https://ja.wikipedia.org/wiki/キャッシュ_\(コンピュータシステム\) "wikilink")（テンプレート等の[トランスクルージョン](../Page/トランスクルージョン.md "wikilink")に対する仕様）が関係して、新規作成・加筆・変更時にそのテンプレートの説明文、カテゴリがすぐに反映されない現象、テンプレートを呼び出したページに内容がすぐに反映されない現象が生じることがあります。通常、1時間から数日経てば自然に反映されます。
