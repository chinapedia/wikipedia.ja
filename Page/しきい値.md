...
[19世紀](../Page/19世紀.md "wikilink")の生理学から[精神物理学](https://ja.wikipedia.org/wiki/精神物理学 "wikilink")を介して[現代](https://ja.wikipedia.org/wiki/現代 "wikilink")の心理学に受け継がれる用法では、[刺激](https://ja.wikipedia.org/wiki/刺激 "wikilink")の存在、あるいは刺激の量的差異を[感覚](../Page/感覚.md "wikilink")するに必要な最小限の刺激値（刺激閾と[弁別閾](https://ja.wikipedia.org/wiki/弁別閾 "wikilink")）を指す。

現代の生理学では、[神経細胞](../Page/神経細胞.md "wikilink")が平常状態から活動状態へ転換するのに必要な最低限の電気的信号の強さの値を指す。

[画像処理](https://ja.wikipedia.org/wiki/画像処理 "wikilink")の分野においては、減色処理で使われる用語である。例えば、ある基準の濃度を超える色を黒、それ以外を白にする2値化処理において、この色濃度の基準（黒とするための最小限の濃度）をしきい値、閾値と呼ぶ。また、このように基準を設定して色を区別する処理のことを**しきい値処理**、または**閾値処理**と呼ぶことがある。

このほか、[電子回路](../Page/電子回路.md "wikilink")におけるオンオフの境界[電圧](../Page/電圧.md "wikilink")、また[放射線](https://ja.wikipedia.org/wiki/放射線 "wikilink")や[毒物](https://ja.wikipedia.org/wiki/毒物 "wikilink")などの分野でも用いられる。
...
デジタル回路では、[信号線の電位がしきい値の付近にある場合](https://ja.wikipedia.org/wiki/信号_\(電気工学\) "wikilink")、電位のごくわずかな揺らぎによって論理「H」として解釈されたり論理「L」として解釈されたりするため、正しい処理ができなくなる。さらに、[CMOS](../Page/CMOS.md "wikilink")による回路ではしきい値付近の電位を入力信号線に与えると内部に大電流が流れて素子破壊の危険がある。このため、しきい値に大きな幅を持たせて、「○○ V以下ならLとする」「○○ V以上ならHとする」というように上下限が規定されていることが多い。
...
このように、入力電位がしきい値範囲内になることを避けなければならないが、[電気回路](../Page/電気回路.md "wikilink")である限り電位の過渡状態は必ず存在し、その時間をゼロにすることはできない。特に[通信線などの](../Page/電気通信.md "wikilink")[配線](https://ja.wikipedia.org/wiki/配線 "wikilink")長が長い回路の場合には、配線部分の[静電容量](../Page/静電容量.md "wikilink")と[抵抗](https://ja.wikipedia.org/wiki/抵抗 "wikilink")により電位変化がゆっくりになり、しきい値範囲に入ってしまう時間が長くなることがある。
