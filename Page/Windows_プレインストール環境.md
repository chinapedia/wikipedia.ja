...
軽量であるがゆえ[ハードディスクドライブ](https://ja.wikipedia.org/wiki/ハードディスクドライブ "wikilink")のみならず[コンパクトディスク](../Page/コンパクトディスク.md "wikilink")や[USBメモリからも](https://ja.wikipedia.org/wiki/USBフラッシュドライブ "wikilink")[ブート](https://ja.wikipedia.org/wiki/ブート "wikilink")でき、[フロッピーディスク](../Page/フロッピーディスク.md "wikilink")からブートできた[MS-DOS](../Page/MS-DOS.md "wikilink")に変わるOSの選択肢の1つとして利用可能である。
...
<!-- end list -->
  ...
  - [サードパーティー](https://ja.wikipedia.org/wiki/サードパーティー "wikilink")製Windowsユーティリティ（例えば[Symantec Ghost](http://www.symantec.com/ja/jp/enterprise/products/overview.jsp?pcid=1025&pvid=865_1)）のプラットフォーム
...
このバージョン以降と以前のバージョンに比して以下の特徴がある。
  ...
  - [WMI](https://ja.wikipedia.org/wiki/WMI "wikilink")アクセス、[Windows Scripting Host](https://ja.wikipedia.org/wiki/Windows_Scripting_Host "wikilink") (WSH)、追加ドライバ、他の[32ビット](https://ja.wikipedia.org/wiki/32ビット "wikilink")アプリケーション（または[64ビット](https://ja.wikipedia.org/wiki/64ビット "wikilink")版のための64ビットのアプリ）といったような、様々なプラグインを含む起動イメージを作成するよう変更可能である。
...
## 関連項目
  ...
  - [BartPE](https://ja.wikipedia.org/wiki/BartPE "wikilink") - WinPEのサードパーティー版と言える。
