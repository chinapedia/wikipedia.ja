...
### DOS版
  ...
  - 1986年9月5日 - 「1-2-3 リリース2J」（NEC PC-98用）を発売\[5\]。（以下、「リリース」を「R」とする。）日本語版独自の機能として、MS-DOS無償再販許諾の制度を利用したMS-DOS 2.0、および日本語入力ソフト「[松茸86](../Page/松_\(ワープロ\).md "wikilink")」をバンドル。また、罫線による作表、[ローソク足チャート](../Page/ローソク足チャート.md "wikilink")などのグラフの追加がある\[6\]。同年10月、IBM [5550用発売](../Page/マルチステーション5550.md "wikilink")。
