...
設計がうまくいけば、運用時の問題を低減できる。経営上の[コンテキストの変化によるビジネスプロセスの変化は現在の研究領域である](https://ja.wikipedia.org/wiki/コンテキストアウェアネス "wikilink")。[ワークフロー](https://ja.wikipedia.org/wiki/ワークフロー "wikilink")をグラフィカルに表現するソフトウェアをそのフローの実装や保守にも利用できるようにすることで、ビジネスプロセスの改善をスムーズに実現できる。
...
主なBPMシステムのベンダーを以下にあげる。
  ...
  - [JFEシステムズ](https://ja.wikipedia.org/wiki/JFEシステムズ "wikilink"): [Ultimus BPM Suite](http://www.jfe-systems.com/products/ultimus_bpm/ultimus_bpm.html)
...
## 関連項目
  ...
  - [ビジネスプロセス](https://ja.wikipedia.org/wiki/ビジネスプロセス "wikilink")
  ...
  - [BPMN](https://ja.wikipedia.org/wiki/ビジネスプロセスモデリング表記法 "wikilink")
