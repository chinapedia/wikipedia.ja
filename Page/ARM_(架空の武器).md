...
#### メル
  ...
  - **バトルスコップ（ジャック）**
      -
        小さな[スコップ](https://ja.wikipedia.org/wiki/スコップ "wikilink")を付けた[ブレスレット](../Page/ブレスレット.md "wikilink")。発動後は銀のスコップ。これといった特殊能力は無いが、使い方によっては盾のようにも槍のようにも使える。石入れ改造された痕跡が残っており、後にネイチャーARMの「大地のスコップ」にパワーアップされた。
  - **リングダガー（ドロシー）**
      -
        小さな短剣が横向きになった[リング](https://ja.wikipedia.org/wiki/指輪 "wikilink")。発動すると[ダガー](../Page/ダガー.md "wikilink")を出すことが出来る。
  - **ガーデス（アルヴィス）**
      -
        十字が入った[盾](../Page/盾.md "wikilink")のリング。発動後は盾になって、ガーディアンの攻撃にも耐えることが出来る。
  - **グリフィンランス（ナナシ）**
      -
...
#### チェスの兵隊
  ...
  - **パイソンウィップ（イアン）**
      -
        [ブレスレット](../Page/ブレスレット.md "wikilink")。発動後は2本の鞭で相手を攻撃する。
  - **オクトパス（イアン）**
      -
  ...
  - **フレイムソード（レノ）**
      -
        [ジャマダハル](../Page/ジャマダハル.md "wikilink")状の剣。炎を纏わせることで攻撃力を高めることができる。
  - **ボールハンマー（パノ）**
      -
        リング。発動後は棒の先に[鉄球](https://ja.wikipedia.org/wiki/鉄球 "wikilink")が付いた武器を出す。鉄球を飛ばして操る。鉄球部分は4つに分割することができる。
  - **スクリューサーベル（Mr.フック）**
      -
        [レイピア](../Page/レイピア.md "wikilink")が巻きついた[ブレスレット](../Page/ブレスレット.md "wikilink")。発動後は付け根から刃先までがスプリングのように曲がったレイピア。
...
<!-- end list -->
  ...
  -
    ...
    リング。発動後はつぎはぎ人形。目はボタン、口はファスナー、下半身は[独楽](../Page/独楽.md "wikilink")のようになっている。歌声は強烈な不快音波である（この技はラプンツェルには効いたが、キメラには効かなかった）。
...
<!-- end list -->
  ...
  -
    ...
    ジャックがカルデアでもらったガーディアンÄRM。発動後は男児型の[ジンの様な姿](../Page/ジン_\(アラブ\).md "wikilink")。ヴィーザルのユグドラシルやブラインディングバードを一瞬にして焼き尽くす火力を持つ。ヴィーザルの魔力の源である頭の木を燃やし勝利した。アニメ版では非常に魔力の消費が大きいとされ、これを使用したジャックは自滅しそうになった。
...
<!-- end list -->
  ...
  -
    ナナシがカルデアでもらったガーディアンÄRM。発動後は巨大な[デンキウナギ](../Page/デンキウナギ.md "wikilink")。ガリアンのトルペディーネを瞬殺、そのままガリアンも倒した。最終決戦ではペタのボディアイを壊し、ルベリアの仇であるペタを殺した。
...
<!-- end list -->
  ...
  -
    シルクハットをした、[ハンプティ・ダンプティ](../Page/ハンプティ・ダンプティ.md "wikilink")の様な丸い紳士。
...
<!-- end list -->
  ...
  - **[イフリート](../Page/イフリート.md "wikilink")（アリババ）**
  - **チェーンソルジャー（ペタ）**
  - **ボディアイ（ペタ）**
...
<!-- end list -->
  ...
  - **[ナイトメア](../Page/ナイトメア.md "wikilink")（マジカル・ロウ）**
...
<!-- end list -->
  ...
  -
    目玉や口のついた不気味な十字架を召喚。アルヴィスの13トーテムポールと酷似している。アニメでは棺桶を出し、その中からゾンビを出現させるダークネスARMとなっている。
...
<!-- end list -->
  ...
  - **デーモン[タランチュラ](../Page/タランチュラ.md "wikilink")（ジョン・ピーチ）**
...
空間を移動したり、別空間を造って次元を越えたりする力を持つÄRM。その能力故、市場でも高額で取引されているようで、店によってはかなり厳重に保管されている。
  ...
  - **門番ピエロ（アルヴィス、アラン）**
      -
        声優 - [松本大](../Page/松本大_\(声優\).md "wikilink")
...
### ガーディアンÄRM
  ...
  - **ホーネット（カイ）**
      -
        [スズメバチ](../Page/スズメバチ.md "wikilink")を模した姿で、3体に分離することもできる。針を敵に刺すことで、動きを封じる能力を持つ。生前のバッボが創造した。
  - **カラドリオ（カイ）**
      -
