...
**SoundFont**（サウンドフォント）とは、[Sound Blaster及び対応ソフトウェアの](../Page/Sound_Blaster.md "wikilink")、[サンプラー](../Page/サンプラー.md "wikilink")機能に与える音色のデータフォーマットである。ファイルの拡張子はファイルフォーマットが“SoundFont 1”の場合が「\*.sbk」、“SoundFont 2”が「\*.sf2」となる。現在の主流は「\*.sf2」フォーマットであり、略称としても**SF2**（エス・エフ・ツー）で親しまれている。本項でも以降「SF2」と略記する。

## 概要

SF2は、服の重ね着をするような感覚で音色を組み合わせることのできる、[サンプラー](../Page/サンプラー.md "wikilink")音源のようなもの。かつては[E-mu Systemsの登録商標だったが](https://ja.wikipedia.org/wiki/:en:E-mu_Systems "wikilink")、現在は[クリエイティブテクノロジー](../Page/クリエイティブテクノロジー.md "wikilink")に移行している。
...
音色の[ピッチや](../Page/音高.md "wikilink")[フィルタ](https://ja.wikipedia.org/wiki/フィルタ "wikilink")の操作、ボリュームの変化やモジュレーションエンベローブ等も操作でき、その他[リバーブやコーラスの操作](../Page/残響.md "wikilink")、[ビブラート](../Page/ビブラート.md "wikilink")の速さのエフェクト操作を簡単に行える。
...
SF2でMIDI再生できるようにするには、高価な専用機材に比べて比較的安価な[Sound Blasterシリーズを購入したり](../Page/Sound_Blaster.md "wikilink")、フリーのプレイヤーソフトウェア\[2\]をインストールすることで安価かつ手軽に導入することができる。
...
2.  例えば、MIDIプレイヤーや[TiMidity++](../Page/TiMidity++.md "wikilink")等がある。