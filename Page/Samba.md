...
[アクセス権を設定できるため](../Page/アクセス制御.md "wikilink")、特定のユーザに同じファイルを提供するといった用途が実現できる。 [ACLをサポートする環境なら](../Page/アクセス制御リスト.md "wikilink")、ユーザやグループ毎に細かく[アクセス権を指定することも可能](../Page/アクセス制御.md "wikilink")。 Windowsサーバと比べて、「$」で終わる共有名でなくても隠し共有にできる利点がある。（隠し共有…共有名の検索やリストアップを行っても画面に現れないが、正しい名前を指定すればアクセスできる共有フォルダ）
...
ユーザアカウントやコンピュータアカウント、[アクセス権などの情報を中央集権的に管理し](../Page/アクセス制御.md "wikilink")、ユーザ認証や[シングルサインオン](../Page/シングルサインオン.md "wikilink")などの[サービス](../Page/サービス.md "wikilink")を提供する。
...
Windows 2000サーバ以降から提供される[Active Directoryドメインへのドメインメンバとしての参加機能](../Page/Active_Directory.md "wikilink")。**Samba** 3から提供された。

[Active Directoryは前述のNT](../Page/Active_Directory.md "wikilink") ドメインに代わるもので、既存のネットワーク技術を応用して構成されている。ユーザアカウントなどの管理情報を[LDAPディレクトリサービスに格納し](../Page/Lightweight_Directory_Access_Protocol.md "wikilink")、認証機構に[ケルベロス](../Page/ケルベロス認証.md "wikilink")、[名前解決](https://ja.wikipedia.org/wiki/名前解決 "wikilink")に[DNS](../Page/Domain_Name_System.md "wikilink")、管理情報の配布やコピーに[TCP/IP](https://ja.wikipedia.org/wiki/TCP/IP "wikilink")のみを使用する。

### Active Directory ドメインコントローラー

2012年12月にリリースされたSamba 4より[Active Directoryドメインのドメインコントローラー機能がサポートされている](../Page/Active_Directory.md "wikilink")。
