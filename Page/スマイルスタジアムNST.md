...
リニューアルを何度も行っているため、ここでは2020年5月現在の項目を記載する。
  ...
  - スマイル競馬
    ...
    *プロジェクトII*で命名された**[スマイルジャック](https://ja.wikipedia.org/wiki/スマイルジャック "wikilink")**が重賞レースを勝つなどの活躍を果たしている。また*プロジェクトIII*をきっかけに**ハシッテホシーノ**が命名された（タレントの[ほしのあき](../Page/ほしのあき.md "wikilink")が命名）。また、NSTアナである廣川はこのプロジェクトに「ヒッショースマイル」という馬名で一般応募し（この際、廣川はペンネーム「ヒッショーアケミ」で応募した）、2010年の同プロジェクトの中の一頭の馬の名に採用された。なお、飛田、廣川の2人は競馬中継『[NSTみんなのKEIBA](../Page/NSTみんなのKEIBA.md "wikilink")』にも関わっており、NSTではこの番組を中心に競馬班がスマイルジャック等、同番組で命名された競走馬の動向を追跡している。
