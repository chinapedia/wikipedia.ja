...
**FFmpeg**（エフエフエムペグ）は[動画](../Page/動画.md "wikilink")と[音声](https://ja.wikipedia.org/wiki/音声 "wikilink")を記録・変換・再生するための[フリーソフトウェア](../Page/フリーソフトウェア.md "wikilink")である\[1\]。[Unix系](https://ja.wikipedia.org/wiki/Unix系 "wikilink")[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink") (OS) 生まれであるが現在では[クロスプラットフォーム](../Page/クロスプラットフォーム.md "wikilink")であり、[libavcodec](https://ja.wikipedia.org/wiki/libavcodec "wikilink")（動画/音声の[コーデック](../Page/コーデック.md "wikilink")[ライブラリ](../Page/ライブラリ.md "wikilink")）、[libavformat](https://ja.wikipedia.org/wiki/libavformat "wikilink")（動画/音声のコンテナライブラリ）、[libswscale](https://ja.wikipedia.org/wiki/libswscale "wikilink")（色空間・サイズ変換ライブラリ）、[libavfilter](https://ja.wikipedia.org/wiki/libavfilter "wikilink")（動画のフィルタリングライブラリ）などを含む。[ライセンス](../Page/ライセンス.md "wikilink")は[コンパイル時のオプションにより](../Page/コンパイラ.md "wikilink")[LGPLか](../Page/GNU_Lesser_General_Public_License.md "wikilink")[GPLに決定される](../Page/GNU_General_Public_License.md "wikilink")。[コマンドラインから使用することができる](https://ja.wikipedia.org/wiki/コマンドラインインタプリタ "wikilink")。対応[コーデック](../Page/コーデック.md "wikilink")が多く、多彩なオプションを使用可能なため、幅広く利用されている。

## 解説

FFmpegは、単体では[GUIを持たないツールで](https://ja.wikipedia.org/wiki/グラフィカルユーザインタフェース "wikilink")[UNIX](../Page/UNIX.md "wikilink")[コマンドのように振る舞う](https://ja.wikipedia.org/wiki/コマンド_\(コンピュータ\) "wikilink")。その為、対話式[アプリケーションとして使用される場合](../Page/アプリケーションソフトウェア.md "wikilink")、[フロントエンド](../Page/フロントエンド.md "wikilink")を用いる事も多い。コマンドラインから実行する[CUIとして配布されているのは](../Page/キャラクタユーザインタフェース.md "wikilink")、ユーザが必要とすればフロントエンドを利用でき、スクリプトなどのバッチ処理を行う際に呼び出す事もできるという利点からである。また、[FFserver](https://ja.wikipedia.org/wiki/FFserver "wikilink")と組み合わせる事により、[ファイルシステム](../Page/ファイルシステム.md "wikilink")や[デバイスファイル](https://ja.wikipedia.org/wiki/デバイスファイル "wikilink")と[ストリーミング](../Page/ストリーミング.md "wikilink")[サーバ](../Page/サーバ.md "wikilink")間のフィルタとしても動作する。

[2011年](../Page/2011年.md "wikilink")[3月13日](../Page/3月13日.md "wikilink")にFFmpegの開発は、開発体制の対立からffmpeg.orgとlibav.orgに分裂した。どちらもffmpegというソフトウェアをリリースしているが、側はavconvに名称を切り替える作業を進めている。この分裂に伴い、[Debian](../Page/Debian.md "wikilink")\[2\]、[Ubuntu](https://ja.wikipedia.org/wiki/Ubuntu "wikilink")\[3\] 11.04、[Gentoo LinuxはLibav側を採用した](../Page/Gentoo_Linux.md "wikilink")。
...
## サポートしているファイル形式
  ...
  - 8088flex TMV
  - Adobe Filmstrip
  - Audio IFF ([AIFF](https://ja.wikipedia.org/wiki/AIFF "wikilink") CD-ROM XA ADPCMを含む)
  - American Laser Games MM
  - [3GPP](https://ja.wikipedia.org/wiki/3GPP "wikilink") AMR
...
<!-- end list -->
  ...
  - MOV/[QuickTime](../Page/QuickTime.md "wikilink")/[MP4](https://ja.wikipedia.org/wiki/MP4 "wikilink")
  - MP2
  ...
  - MSN TCP webcam
  - MTV
  - [Musepack](https://ja.wikipedia.org/wiki/Musepack "wikilink")
  - Musepack SV8
  ...
  - raw [H.261](https://ja.wikipedia.org/wiki/H.261 "wikilink")
  - raw [H.263](https://ja.wikipedia.org/wiki/H.263 "wikilink")
  - raw [H.264](https://ja.wikipedia.org/wiki/H.264 "wikilink")
  - raw Ingenient MJPEG
  ...
  - raw [VC-1](https://ja.wikipedia.org/wiki/VC-1 "wikilink")
  ...
  - raw [PCM](https://ja.wikipedia.org/wiki/PCM "wikilink")
      ...
      - [浮動小数点](https://ja.wikipedia.org/wiki/浮動小数点 "wikilink"): [32ビット](https://ja.wikipedia.org/wiki/32ビット "wikilink")または[64ビット](https://ja.wikipedia.org/wiki/64ビット "wikilink")エンディアンはリトルエンディアンとビックエンディアン
...
<!-- end list -->
  ...
  - [RTP](https://ja.wikipedia.org/wiki/Real-time_Transport_Protocol "wikilink")
  - [RTSP](https://ja.wikipedia.org/wiki/Real_Time_Streaming_Protocol "wikilink")
  - SAP
  - [SDP](https://ja.wikipedia.org/wiki/Session_Description_Protocol "wikilink")
  - Sega FILM/CPK
  - Sierra SOL
  - Sierra VMD
  - Smacker
  ...
  - Sony Wave64 (W64)
  - SoX native format
  - [SUN AU format](https://ja.wikipedia.org/wiki/Sunオーディオファイル "wikilink")
  - [テキストファイル](https://ja.wikipedia.org/wiki/テキストファイル "wikilink")
  - THP
  - Tiertex Limited SEQ
  - True Audio
  - [VC-1](https://ja.wikipedia.org/wiki/VC-1 "wikilink") test bitstream
...
<!-- end list -->
  ...
  - Truevision Targa([TGA](https://ja.wikipedia.org/wiki/TGA "wikilink"))
...
`ffmpeg -i inputfile.vob -f mpeg -vcodec mpeg1video -acodec mp2 -vb 1152k -ab 128k -s 352x240 outputfile.mpg`
  ...
  - 動画を[東芝](https://ja.wikipedia.org/wiki/東芝 "wikilink")の[ハードディスクレコーダー](https://ja.wikipedia.org/wiki/ハードディスクレコーダー "wikilink")、[レグザ](https://ja.wikipedia.org/wiki/レグザ "wikilink")が認識できるMPEG2形式に変換する例
...
### Linux
  ...
  - [RHEL](https://ja.wikipedia.org/wiki/Red_Hat_Enterprise_Linux "wikilink"), [CentOS](https://ja.wikipedia.org/wiki/CentOS "wikilink"), [Fedora](../Page/Fedora.md "wikilink")
...
`yum --enablerepo=rpmforge install ffmpeg`
  ...
  - [Debian](../Page/Debian.md "wikilink"), [Ubuntu](https://ja.wikipedia.org/wiki/Ubuntu "wikilink")など、APTがインストールされた環境
...
## FFmpegを利用・サポートしているアプリケーション
  ...
  - エンコーダ
      ...
      - [HandBrake](https://ja.wikipedia.org/wiki/HandBrake "wikilink")
      - [MediaCoder](https://ja.wikipedia.org/wiki/MediaCoder "wikilink")
      - [携帯動画変換君](../Page/携帯動画変換君.md "wikilink")
      - [WinFF](https://ja.wikipedia.org/wiki/WinFF "wikilink")
  - 動画再生
      - [MPlayer](../Page/MPlayer.md "wikilink")
      - [VLC](https://ja.wikipedia.org/wiki/VLCメディアプレーヤー "wikilink")
      - [Xine](https://ja.wikipedia.org/wiki/Xine "wikilink")
  - コーデック
      - [ffdshow](https://ja.wikipedia.org/wiki/ffdshow "wikilink")
      - [GStreamer](https://ja.wikipedia.org/wiki/GStreamer "wikilink") FFmpeg plug-in
      - [Perian](https://ja.wikipedia.org/wiki/Perian "wikilink")
      - [Bellagio OpenMAX IL](https://ja.wikipedia.org/wiki/Bellagio_OpenMAX_IL "wikilink") - [STマイクロエレクトロニクス](https://ja.wikipedia.org/wiki/STマイクロエレクトロニクス "wikilink")と[ノキア](https://ja.wikipedia.org/wiki/ノキア "wikilink")によって開発されている[オープンソース](../Page/オープンソース.md "wikilink")の実装
  - [3D](https://ja.wikipedia.org/wiki/3D "wikilink")描画
  ...
  - [動画編集](https://ja.wikipedia.org/wiki/動画編集ソフトウェア "wikilink")
      ...
      - [Jahshaka](https://ja.wikipedia.org/wiki/Jahshaka "wikilink")
  - 音声編集
      - [Audacity](https://ja.wikipedia.org/wiki/Audacity "wikilink")(1.3.6以降)
  ...
  - [構内交換機](https://ja.wikipedia.org/wiki/構内交換機 "wikilink") (PBX)
      - [Asterisk](https://ja.wikipedia.org/wiki/Asterisk_\(PBX\) "wikilink")
...
## 関連項目
  ...
  - [KMPlayer](https://ja.wikipedia.org/wiki/KMPlayer "wikilink")
