...
**NuBus**（ニューバス）は[32ビット](../Page/32ビット.md "wikilink")の[パラレルバスである](../Page/バス_\(コンピュータ\).md "wikilink")。当初は[MITでNuMachineワークステーションの一部として開発されたが](../Page/マサチューセッツ工科大学.md "wikilink")、ついには、[アップルコンピュータや](../Page/アップル_\(企業\).md "wikilink")[NeXT](../Page/NeXT.md "wikilink")コンピュータにも採用された。だが[21世紀](../Page/21世紀.md "wikilink")に入る頃には、もはや広く使われることのない規格となった。[テキサス・インスツルメンツ](https://ja.wikipedia.org/wiki/テキサス・インスツルメンツ "wikilink")の登録商標（日本における商標登録番号は第2315207号）である。
...
加えて、NuBusはプロセッサ非依存であった。たいていのバスは基本的には、[CPU](../Page/CPU.md "wikilink")上のピンをそのまま基板上に出しているだけであった。つまり、[拡張カード](https://ja.wikipedia.org/wiki/拡張カード "wikilink")は接続先のマシンのデータ構造(たとえばリトルエンディアン)や信号規格を満たしていなければならなかった。NuBusはこのような仮定を取り除き、適切な[デバイスドライバ](../Page/デバイスドライバ.md "wikilink")が用意されるならば、NuBusカードはどのNuBusマシンにも接続できるようにした。
...
NuMachineはリリースされることがなかったが、[テキサス・インスツルメンツ](https://ja.wikipedia.org/wiki/テキサス・インスツルメンツ "wikilink")は1980年にNuBusを採用し、[IEEE](../Page/IEEE.md "wikilink")1196として標準化した。このバージョンは[VMEバス](https://ja.wikipedia.org/wiki/VMEバス "wikilink") や他のバスで見られる標準の96ピンの3列コネクタを使っていて、10MHzのクロックで最大バースト転送速度40MB/sと10MB/sから20MB/sの平均転送速度を出すことができた。後に追加されたNuBus90は、転送速度を上げるためにクロックは20MHzに引き上げられ、バースト転送速度は70MB/s、平均転送速度は約30MB/sにまで増加した。
...
## 関連項目
  ...
  - [Apple Desktop Bus](https://ja.wikipedia.org/wiki/Apple_Desktop_Bus "wikilink") (ADB)
  ...
  - [PCI Express](https://ja.wikipedia.org/wiki/PCI_Express "wikilink") (PCIe)
