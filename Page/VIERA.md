...
・本年モデルよりSDカードスロット廃止。SDカードに記録した写真・動画データ視聴には市販のUSBまたはHDMI接続式SDカードリーダーが別途必要（ディーガはSDカードスロットを搭載しているため、ディーガ経由でもSDカード画像を視聴可）。
\* **TH-49/43GR770**
...
<!-- end list -->
  ...
  -
    2020年6月下旬発売予定。GX855/755/500シリーズの後継機種。BS・110度CS4Kチューナを2系統、地上・BS・110度CSチューナーを3系統それぞれ搭載しており裏録が可能。「4Kヘキサクロマドライブ」による高画質表現と、左右1対のフルレンジスピーカーで総合出力30ｗの迫力サウンドを表現可能な高音質「ドルビーアトモス」に対応している。アナログAV入力端子と光デジタル出力端子を各1系統・HDMI入力端子を4系統搭載。
