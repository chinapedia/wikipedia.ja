...
## 機能
  ...
  - [iTunes](https://ja.wikipedia.org/wiki/iTunes "wikilink")ライブラリの曲の再生
  - 共有されている曲の再生
  - ビデオフォルダ内の動画の再生
  - 映画予告編の視聴（[英語](../Page/英語.md "wikilink")）
  - 共有されている動画の再生
  - DVD-Videoの再生
  - 共有している写真の[スライドショー](../Page/スライドショー.md "wikilink")（BGM:[メヌエット](../Page/メヌエット.md "wikilink")）
  - [iPhoto](https://ja.wikipedia.org/wiki/iPhoto "wikilink")ライブラリ内の写真のスライドショー（BGM:[メヌエット](../Page/メヌエット.md "wikilink")）
  - Mac本体のスリープ（再生ボタン長押しによる）および解除（MENUボタンによる）
...
## 外部リンク
  ...
  - [アップル iMac Front Row + Apple Remote](http://www.apple.com/jp/imac/software/frontrow.html)

[Category:アップルのソフトウェア](https://ja.wikipedia.org/wiki/Category:アップルのソフトウェア "wikilink") [Category:メディアプレーヤーソフト](https://ja.wikipedia.org/wiki/Category:メディアプレーヤーソフト "wikilink")