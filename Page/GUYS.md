...
PVはすべてレコーディングで滞在していた[ロンドン](../Page/ロンドン.md "wikilink")とその郊外で撮影された。

### 収録曲

1.  **GUYS**
      -
        撮影場所は[バターシー発電所](https://ja.wikipedia.org/wiki/バターシー発電所 "wikilink")周辺。PanasonicのCMではPVの一部が使用された。また、別バージョンのPVも存在する\[12\]\[13\]。
2.  **if**
      -
        音源はアルバム・バージョンである。
3.  **世界にMerry X'mas**
