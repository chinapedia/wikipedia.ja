...
なお、映画「スタートレック」ではゴートレックスがステーション員として[カメオ出演](../Page/カメオ出演.md "wikilink")している。
...
このうち"In Thy Image"は映画「スタートレック」、"The Child"と"Devil's Due" は「[新スタートレック](../Page/新スタートレック.md "wikilink")」の脚本として使用された。
