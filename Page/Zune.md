...
第1世代の機器は[東芝](../Page/東芝.md "wikilink")が製造を請け負っていた。東芝の[gigabeat](https://ja.wikipedia.org/wiki/gigabeat "wikilink") Sに近い製品であった。第2世代は[シンガポール](https://ja.wikipedia.org/wiki/シンガポール "wikilink")の[フレクトロニクス社が製造した](https://ja.wikipedia.org/wiki/Flextronics "wikilink")。

米国外で発売されたのは[カナダ](https://ja.wikipedia.org/wiki/カナダ "wikilink")のみで、[ヨーロッパ](../Page/ヨーロッパ.md "wikilink")や日本など[北米](https://ja.wikipedia.org/wiki/北米 "wikilink")以外の地域で発売されることはなかった。

発売以来、米国では概ねポータブルオーディオプレーヤーの10%前後のシェアを獲得し、[iPod](https://ja.wikipedia.org/wiki/iPod "wikilink")に次ぐ第2位を確保しているが、iPodには大きく引き離されており牙城を崩すには至らなかった。
...
なお、[2010年](https://ja.wikipedia.org/wiki/2010年 "wikilink")にマイクロソフトが発表した[スマートフォン](https://ja.wikipedia.org/wiki/スマートフォン "wikilink")『[KIN](https://ja.wikipedia.org/wiki/KIN_\(携帯電話\) "wikilink")』, Windows Phone シリーズにおいても、Zune Marketplace等のサービスが利用出来る\[2\]。

## 主な仕様

Zuneには2006年に発売されたZune 30、2007年10月2日に発表されたZune 80と[フラッシュメモリ](../Page/フラッシュメモリ.md "wikilink")を搭載したZune 8及びZune 4がある。 内蔵のラジオでは日本、アメリカ、ヨーロッパでの使用が可能。 XNAで作ったゲーム、アプリケーションをZuneに取り込み遊んだり、使用することができる。 ポータブルハードディスクとしての使用は不可能。 ファームウェア2.2からインタフェース言語にフランス語、スペイン語が追加された。 2008年の9月16日に配布されたバージョン3.0のアップデートにより本体に時計機能、ラジオでの曲購入、キーロック機能、インターネットへの無線接続が可能になった。XNAでのゲーム終了後の再起動も改善された。なお、ソフトウエアも改善され様々な情報の表示が可能なMIXVIEWの機能が付加。 曲名等の日本語表示ができず、日本語の文字は□ で表示されてしまう。 Zune HDは曲情報等の日本語表示が可能となっている。

### ゲーム、アプリケーション

Zune boardsのサイトにて様々なゲームやアプリケーションをいろいろな人が公開している。 ゲームではXNAで製作したrunning man（駆け抜けシューティングゲーム）やSIR TET（ZUNE版テトリス）等がある。

Zune boardsのサイトにはアプリケーションも置かれている。これもXNAを使ったもの。数は少ないが、時計機能、アラーム機能、ストップウオッチ、カレンダー、Wi-Fiを使った簡易メッセンジャーがある。
...
### Zune 80, 120
  ...
  - 初代同様[Wi-Fi](../Page/Wi-Fi.md "wikilink")を搭載し、新たにWi-Fiを使ってのPCとの同期が可能になった。音楽のシェアリングは3日以内という制限が変更され、3回再生すると聞けなくなる仕組みになった。
...
## 外部リンク
  ...
  -
[Category:マイクロソフトのハードウェア](https://ja.wikipedia.org/wiki/Category:マイクロソフトのハードウェア "wikilink") [Category:デジタルオーディオプレーヤー](https://ja.wikipedia.org/wiki/Category:デジタルオーディオプレーヤー "wikilink") [Category:携帯音楽プレーヤー](https://ja.wikipedia.org/wiki/Category:携帯音楽プレーヤー "wikilink") [Category:東芝](https://ja.wikipedia.org/wiki/Category:東芝 "wikilink") [Category:音楽配信](https://ja.wikipedia.org/wiki/Category:音楽配信 "wikilink") [Category:Windows_CE端末](https://ja.wikipedia.org/wiki/Category:Windows_CE端末 "wikilink") [Category:2006年のハードウェア](https://ja.wikipedia.org/wiki/Category:2006年のハードウェア "wikilink")
