...
<!-- end list -->
  ...
  -
    『[DAIBAッテキ\!\!](https://ja.wikipedia.org/wiki/DAIBAッテキ!!#主なコーナー "wikilink")』からの継続コーナー。ドリームキャストのネット端末を使用し、チェキッ娘の[ホームページ](../Page/ホームページ.md "wikilink")を、チェキッ娘との3つの約束（「いけない画像は使わないこと」「いけない音声は使わないこと」と、メンバーが独自で考えた3つ目の約束）をしながら紹介していた。なお、司会者である鶴瓶のホームページを紹介することもあった。
