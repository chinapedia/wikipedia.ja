...
**自動推論**（じどうすいろん、Automated Reasoning）は[計算機科学](../Page/計算機科学.md "wikilink")と[数理論理学](../Page/数理論理学.md "wikilink")の一分野であり、[推論](https://ja.wikipedia.org/wiki/推論 "wikilink")の様々な側面を理解することで[コンピュータ](../Page/コンピュータ.md "wikilink")による完全（あるいはほぼ完全）自動な推論を行う[ソフトウェア](../Page/ソフトウェア.md "wikilink")を開発することを目的とする。[人工知能](../Page/人工知能.md "wikilink")研究の一部と考えられるが、[理論計算機科学](https://ja.wikipedia.org/wiki/理論計算機科学 "wikilink")や[哲学](../Page/哲学.md "wikilink")とも深い関係がある。

自動推論のなかでも最も研究が進んでいるのは、[自動定理証明](https://ja.wikipedia.org/wiki/自動定理証明 "wikilink")（および完全自動ではないがより現実的な）と（固定の前提条件下での推論と見なすことができる）であるが、他にも[類推](https://ja.wikipedia.org/wiki/類推 "wikilink")、[帰納](../Page/帰納.md "wikilink")、[アブダクション](../Page/アブダクション.md "wikilink")による推論の研究も盛んである。他の重要なトピックとしては、[不確かさ](https://ja.wikipedia.org/wiki/不確かさ "wikilink")のある状況での推論と[非単調推論である](https://ja.wikipedia.org/wiki/非単調論理 "wikilink")。不確かさに関する研究では[論証](https://ja.wikipedia.org/wiki/論証 "wikilink")（argumentation）が重要である。それはすなわち、標準的な自動推論へのさらなる極小性と一貫性の適用である。John Pollock の Oscar システムは単なる自動定理証明機よりも自動論証システムといえるものである。

自動推論のツールや手法としては、古典的論理学や代数学があるが、他にも[ファジィ論理](https://ja.wikipedia.org/wiki/ファジィ論理 "wikilink")、[ベイズ推定](https://ja.wikipedia.org/wiki/ベイズ推定 "wikilink")、[最大エントロピー原理](https://ja.wikipedia.org/wiki/最大エントロピー原理 "wikilink")に基づく推論、その他のあまり形式的でない技法などがある。
...
1957年、多くの論理学者と計算機科学者が一堂に会した Cornell Summer が自動推論または[自動定理証明](https://ja.wikipedia.org/wiki/自動定理証明 "wikilink")の起源とされることがある\[2\]。それ以前の[アレン・ニューウェル](../Page/アレン・ニューウェル.md "wikilink")、[クリフ・ショー](https://ja.wikipedia.org/wiki/クリフ・ショー "wikilink")、[ハーバート・サイモン](../Page/ハーバート・サイモン.md "wikilink")らが1955年に開発した [Logic Theorist](https://ja.wikipedia.org/wiki/Logic_Theorist "wikilink") や、マーチン・デービスが1954年に[プレスブルガーの決定手続きを実装したもの](https://ja.wikipedia.org/wiki/プレスバーガー算術 "wikilink")（2つの偶数の和が偶数であることを証明）\[3\]が起源だとすることもある。自動推論は重要な領域として盛んに研究が行われていたが、1980年代から90年代初頭の「AIの冬」の時代を経験し、その後運よく復興した。例えば2005年、[マイクロソフト](../Page/マイクロソフト.md "wikilink")は多くの社内プロジェクトでのソフトウェア開発に検証技術を使い始め、[Visual C++](https://ja.wikipedia.org/wiki/Microsoft_Visual_C++ "wikilink") の2012年版に論理的に検証する機能を追加した\[4\]。

## 重要な貢献

[アルフレッド・ノース・ホワイトヘッド](https://ja.wikipedia.org/wiki/アルフレッド・ノース・ホワイトヘッド "wikilink")と[バートランド・ラッセル](../Page/バートランド・ラッセル.md "wikilink")の『[プリンキピア・マテマティカ](https://ja.wikipedia.org/wiki/プリンキピア・マテマティカ "wikilink")』（数学原理）は[数理論理学](../Page/数理論理学.md "wikilink")の画期をなした著作であり、あらゆる[数式](https://ja.wikipedia.org/wiki/数式 "wikilink")を論理によって導出することを目的として書かれた。同書は3巻に分かれており、それぞれ1910年、1912年、1913年に出版された\[5\]。
...
| ---- | --------------------------------------------------------------- | ------------ | ------------- | ---------------------------------------------------------------------------------------------------- |
| 1986 | [第1不完全性定理](../Page/ゲーデルの不完全性定理.md "wikilink")                   | Boyer- Moore | Shankar       | [ゲーデル](https://ja.wikipedia.org/wiki/クルト・ゲーデル "wikilink")                                            |
| 1990 | [平方剰余の相互法則](../Page/平方剰余の相互法則.md "wikilink")                    | Boyer- Moore | Russinoff     | [アイゼンシュタイン](https://ja.wikipedia.org/wiki/フェルディナント・ゴットホルト・マックス・アイゼンシュタイン "wikilink")                 |
...
| 2004 | [素数定理](../Page/素数定理.md "wikilink")                              | Isabelle     | Avigad 他      | [セルバーグ](https://ja.wikipedia.org/wiki/アトル・セルバーグ "wikilink")-[エルデシュ](../Page/ポール・エルデシュ.md "wikilink") |
| 2005 | [ジョルダン曲線定理](https://ja.wikipedia.org/wiki/ジョルダン曲線定理 "wikilink") | HOL Light    | Hales         | [Thomassen](https://ja.wikipedia.org/wiki/:en:Carsten_Thomassen "wikilink")                          |
...
| 2007 | コーシーの[留数](https://ja.wikipedia.org/wiki/留数 "wikilink")定理        | HOL Light    | Harrison      | 古典的                                                                                                  |
