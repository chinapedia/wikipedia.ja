...
GLib に含まれる代表的な機能としては、以下のものがある。
  ...
  - [型システム](../Page/型システム.md "wikilink") [GType](https://ja.wikipedia.org/wiki/GType "wikilink")
...
頻繁に利用されるデータ構造とそれに対する操作が定義されている。以下に主なものを列挙する。
  ...
  - リレーションと[タプル](../Page/タプル.md "wikilink")
