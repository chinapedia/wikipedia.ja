...
純粋な[32ビット](../Page/32ビット.md "wikilink")のロード/ストア・アーキテクチャで、命令キャッシュとデータキャッシュを分離し（[ハーバード・アーキテクチャ](https://ja.wikipedia.org/wiki/ハーバード・アーキテクチャ "wikilink")）、分離されたデータバスとアドレスバスを備えていた。命令セットは小さいが強力で、他のモトローラのCPUと同様セグメント方式は採用していない。
...
他のユーザーは中小企業ばかりである。[Alpha Microsystems](https://ja.wikipedia.org/wiki/:en:Alpha_Microsystems "wikilink") は[68kから](../Page/MC68000.md "wikilink")88kへの乗り換えを計画して [UNIX System V](https://ja.wikipedia.org/wiki/UNIX_System_V "wikilink") を移植したりしていたが、68kの派生品を採用することに決めて、88k採用をあきらめた\[4\]。[NCDは](https://ja.wikipedia.org/wiki/:en:Network_Computing_Devices "wikilink")88kを採用した[X端末](../Page/X端末.md "wikilink")を開発した。倒産した [Norsk Data](https://ja.wikipedia.org/wiki/:en:Norsk_Data "wikilink") からスピンオフした Dolphin Server は88kを採用したサーバを開発し、1992年までに100システムほどを出荷した\[5\]。
