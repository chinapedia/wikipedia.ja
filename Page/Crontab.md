...
この場合、デーモンからは右のような[エラーメッセージ](../Page/エラーメッセージ.md "wikilink")がメール送信される:「/bin/sh: unexpected EOF while looking for \`」
...
## 外部リンク
  ...
  - **ソフトウェア**
      - [<s>Cron for Windows(リンク切れ)</s>](http://www.kalab.com/freeware/cron/cron.htm)
