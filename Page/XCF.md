...
保存される画像データは単純な[RLEアルゴリズムによってのみ圧縮されるが](../Page/連長圧縮.md "wikilink")、GIMPは[gzip](https://ja.wikipedia.org/wiki/gzip "wikilink")と[bzip2](https://ja.wikipedia.org/wiki/bzip2 "wikilink")のどちらを使った圧縮ファイルもサポートしている。圧縮されたファイルは通常の画像ファイルと同じように開ける。
...
いくつかの[画像ビューア](https://ja.wikipedia.org/wiki/画像ビューア "wikilink")と変換ソフトウェアはこの形式を読めるが、対応の度合いはまちまちである:
  ...
  - [Krita](../Page/Krita.md "wikilink")はGraphicsMagickライブラリを使ってXCFファイルをインポートする。
  ...
  - [Inkscape](../Page/Inkscape.md "wikilink")は0.44リリースでXCFエクスポートのサポートを追加した\[2\]。
