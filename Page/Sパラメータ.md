...
**Sパラメータ**([Scattering parameters](https://ja.wikipedia.org/wiki/:en:Scattering_parameters "wikilink"))とは、[高周波](https://ja.wikipedia.org/wiki/高周波 "wikilink")[電子回路](../Page/電子回路.md "wikilink")や高周波[電子部品](https://ja.wikipedia.org/wiki/電子部品 "wikilink")の特性を表すために使用される[回路網パラメータのひとつ](https://ja.wikipedia.org/wiki/二端子対回路 "wikilink")。**散乱行列**（**S行列**）または**散乱パラメータ**とも呼ばれる。回路網の通過・反射電力特性を表現する。
...
S<sub>11</sub>とS<sub>22</sub>の[利得が](https://ja.wikipedia.org/wiki/利得_\(電気工学\) "wikilink")[定在波比](https://ja.wikipedia.org/wiki/定在波比 "wikilink") (VSWR) を示すため、Sパラメータの[利得の](https://ja.wikipedia.org/wiki/利得_\(電気工学\) "wikilink")[デシベル](../Page/デシベル.md "wikilink")表示は、
