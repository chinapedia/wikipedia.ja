...
**C\#**（シーシャープ）は、[アンダース・ヘルスバーグ](https://ja.wikipedia.org/wiki/アンダース・ヘルスバーグ "wikilink")が設計した[プログラミング言語](../Page/プログラミング言語.md "wikilink")であり、構文はその名前にもある通りC系言語（[C言語](../Page/C言語.md "wikilink")、[C++](https://ja.wikipedia.org/wiki/C++ "wikilink")や[Java](https://ja.wikipedia.org/wiki/Java "wikilink")など）の影響があるが、構文以外の言語機能などについてはヘルスバーグが以前の所属である[ボーランド](https://ja.wikipedia.org/wiki/ボーランド "wikilink")で設計した[Delphi](https://ja.wikipedia.org/wiki/Delphi "wikilink")からの影響がある。

マイクロソフトによる謳い文句としては、[マルチパラダイムプログラミング言語](https://ja.wikipedia.org/wiki/マルチパラダイムプログラミング言語 "wikilink")、強い[型付け](https://ja.wikipedia.org/wiki/型システム "wikilink")、[命令型](https://ja.wikipedia.org/wiki/命令型プログラミング "wikilink")、[宣言型](https://ja.wikipedia.org/wiki/宣言型プログラミング "wikilink")、[手続き型](https://ja.wikipedia.org/wiki/手続き型プログラミング "wikilink")、[関数型](../Page/関数型言語.md "wikilink")、[ジェネリック](https://ja.wikipedia.org/wiki/ジェネリックプログラミング "wikilink")、[オブジェクト指向の要素を持つ](https://ja.wikipedia.org/wiki/オブジェクト指向プログラミング "wikilink")、などといった点が強調されている。

[共通言語基盤](https://ja.wikipedia.org/wiki/共通言語基盤 "wikilink") (CLI) といった周辺技術も含め、マイクロソフトのフレームワーク「[.NET Framework](https://ja.wikipedia.org/wiki/.NET_Framework "wikilink")」の一部である他、[Visual J++で](https://ja.wikipedia.org/wiki/Microsoft_Visual_J++ "wikilink")「非互換なJava」をJavaに持ち込もうとしたような以前のマイクロソフトとは異なり、その多くの仕様を積極的に公開し標準化機構に託して自由な利用を許す (ECMA-334, ISO/IEC 23270:2003, JIS X 3015) など、同社の姿勢の変化があらわれている。

## 概要

開発にはボーランドの[Turbo PascalやDelphiを開発したアンダース](https://ja.wikipedia.org/wiki/Turbo_Pascal "wikilink")・ヘルスバーグを筆頭に多数のDelphi開発陣が参加している。

C\#は[共通言語基盤](https://ja.wikipedia.org/wiki/共通言語基盤 "wikilink")（[共通言語ランタイム](https://ja.wikipedia.org/wiki/共通言語ランタイム "wikilink")など）が解釈する[共通中間言語](https://ja.wikipedia.org/wiki/共通中間言語 "wikilink")に[コンパイル](https://ja.wikipedia.org/wiki/コンパイル "wikilink")されて実行される。

[自動ボックス化](https://ja.wikipedia.org/wiki/ボックス化 "wikilink")、[デリゲート](https://ja.wikipedia.org/wiki/デリゲート_\(プログラミング\) "wikilink")、 [プロパティ](https://ja.wikipedia.org/wiki/プロパティ_\(プログラミング\) "wikilink")、[インデクサ](https://ja.wikipedia.org/wiki/インデクサ "wikilink")、[カスタム属性](https://ja.wikipedia.org/wiki/メタデータ_\(共通言語基盤\) "wikilink")、[ポインタ演算操作](https://ja.wikipedia.org/wiki/ポインタ_\(プログラミング\) "wikilink")、[構造体](https://ja.wikipedia.org/wiki/構造体 "wikilink")（値型オブジェクト）、[多次元配列](https://ja.wikipedia.org/wiki/配列 "wikilink")、[可変長引数](https://ja.wikipedia.org/wiki/引数 "wikilink")、などの機能を持つ。また、Javaと同様に大規模[ライブラリ](https://ja.wikipedia.org/wiki/ライブラリ "wikilink")、[プロセッサ・アーキテクチャ](https://ja.wikipedia.org/wiki/プロセッサ・アーキテクチャ "wikilink")に依存しない実行形態、[ガベージコレクション](../Page/ガベージコレクション.md "wikilink")、[JITコンパイルによる実行の高速化](https://ja.wikipedia.org/wiki/ジャストインタイムコンパイル方式 "wikilink")、などが実現されている（もっともこれらはC\#の機能というより.NET Frameworkによるものである）。

.NET構想における中心的な開発言語であり、[XML](https://ja.wikipedia.org/wiki/Extensible_Markup_Language "wikilink") [Webサービス](https://ja.wikipedia.org/wiki/Webサービス "wikilink")や[ASP.NET](https://ja.wikipedia.org/wiki/ASP.NET "wikilink")の記述にも使用される。他の.NET系の言語でも記述可能だが、。マイクロソフトの[統合開発環境](https://ja.wikipedia.org/wiki/統合開発環境 "wikilink")では、[Microsoft Visual C\#がC](https://ja.wikipedia.org/wiki/Microsoft_Visual_C_Sharp "wikilink")\#に対応している。

共通言語仕様のCLSによって、他のCLS準拠の言語（[Visual Basic .NETや](https://ja.wikipedia.org/wiki/Microsoft_Visual_Basic_.NET "wikilink")[Visual C++](https://ja.wikipedia.org/wiki/Microsoft_Visual_C++ "wikilink") ([C++/CLI](https://ja.wikipedia.org/wiki/C++/CLI "wikilink")) など）と相互に連携することができる。
...
<td><p><a href="https://ja.wikipedia.org/wiki/マイクロソフト" title="wikilink">マイクロソフト</a></p></td>
<td></td>
<td></td>
</tr>
<tr class="even">
...
さまざまな意味において、基盤である[CLIの機能をもっとも反映している言語であるといえる](https://ja.wikipedia.org/wiki/共通言語基盤 "wikilink")。C\#にある組み込み型のほとんどは、CLIフレームワークに実装されている値型と対応している。しかし、C\#の言語仕様はコンパイラのコード生成については何も言及していない。つまり、[CLRに対応しなければならないとか](https://ja.wikipedia.org/wiki/共通言語ランタイム "wikilink")、[共通中間言語](https://ja.wikipedia.org/wiki/共通中間言語 "wikilink") (CIL) などの特定のフォーマットのコードを生成しなければならないとかいうことは述べられていない。そのため、理論的には[C++](https://ja.wikipedia.org/wiki/C++ "wikilink")や[FORTRAN](../Page/FORTRAN.md "wikilink")のように環境依存のマシン語を生成することも可能である。しかし、現在存在するすべてのC\#コンパイラはCLIをターゲットにしている。
...
#### 構文や構文以外の改良点
  ...
  - C\#には[ブール型](https://ja.wikipedia.org/wiki/ブーリアン型 "wikilink")`bool`が存在し、[`while`](https://ja.wikipedia.org/wiki/while文 "wikilink")文や[`if`](https://ja.wikipedia.org/wiki/if文 "wikilink")文のように条件をとるステートメントには、`bool`型の式を与えなければならない。C言語では、ブール型が無く`int`型（0を偽とし、非0を真とする）に兼用させた上、（[ヌルポインタ](https://ja.wikipedia.org/wiki/ヌルポインタ "wikilink")を偽とみなすこととするといろいろと便利だった、ということもあり）ポインタでも`while`文や`if`文に与える式にできる、という仕様としていた。これは便利なこともあったが、本来比較式を記述すべきところで誤って代入式を記述してもコンパイル適合となってしまうなど、ミスが見逃されることもあった。C\#ではに、そのような仕様ではなくブール型を独立させ、またブール型を厳密に要求する場所を多くしている。
  ...
  - 組み込み型のサイズおよび内部表現が仕様で定められており、プラットフォームや処理系に依存しない。[浮動小数点数](https://ja.wikipedia.org/wiki/浮動小数点数 "wikilink")は[IEEE 754に準拠する](https://ja.wikipedia.org/wiki/IEEE_754 "wikilink")\[3\]。文字および文字列は[UTF-16](https://ja.wikipedia.org/wiki/UTF-16 "wikilink")エンコーディングを採用する\[4\]。
...
#### 名前空間とオブジェクト指向な型システム
  ...
  - [グローバル変数](https://ja.wikipedia.org/wiki/グローバル変数 "wikilink")やグローバルメソッドは存在しない。すべての[フィールドと](https://ja.wikipedia.org/wiki/フィールド_\(計算機科学\) "wikilink")[メソッドはクラスあるいは構造体の一部として宣言されなければならない](https://ja.wikipedia.org/wiki/メソッド_\(計算機科学\) "wikilink")。

<!-- end list -->

  -
    例えばC/C++の[`printf`](https://ja.wikipedia.org/wiki/printf "wikilink")`()`関数のように[名前空間](https://ja.wikipedia.org/wiki/名前空間 "wikilink")レベルに存在するフリー関数を定義することはできない。ほとんどの場合クラスおよび構造体は名前の衝突を避けるために[名前空間](https://ja.wikipedia.org/wiki/名前空間 "wikilink")に所属する。
...
<!-- end list -->
  ...
  - [アクセサ](https://ja.wikipedia.org/wiki/アクセサ "wikilink")の定義と利用を簡略化するために[プロパティ構文を利用できる](https://ja.wikipedia.org/wiki/プロパティ_\(プログラミング\) "wikilink")。C++およびJavaにおける[カプセル化](https://ja.wikipedia.org/wiki/カプセル化 "wikilink")では、通例getter/setterアクセサとなるメンバー関数あるいはメソッドを定義して利用するが、C\#ではプロパティ機能により、[カプセル化](https://ja.wikipedia.org/wiki/カプセル化 "wikilink")を維持しつつ、あたかも[フィールドを直接読み書きするような直感的な構文でオブジェクトの状態にアクセスすることができる](https://ja.wikipedia.org/wiki/フィールド_\(計算機科学\) "wikilink")。プロパティによってメンバーのアクセス制御やデータの正当性チェックを実行することができる。なお、[イベントハンドラー](https://ja.wikipedia.org/wiki/イベントハンドラー "wikilink")に利用するデリゲートのカプセル化にはイベント構文 (`event`) が用意されている。
...
[ジェネリクスが導入された](https://ja.wikipedia.org/wiki/総称型 "wikilink")。これは.NET Framework 2.0の機能である。クラス、構造体、インターフェイス、デリゲート、メソッドに対して適用することができる。.NETのGenericsはC++の[テンプレート](https://ja.wikipedia.org/wiki/テンプレート_\(プログラミング\) "wikilink")、あるいは[Java](https://ja.wikipedia.org/wiki/Java "wikilink")におけるそれとも異なるもので、コンパイルによってではなく実行時にランタイムによって特殊化される。これによって異なる言語間の運用を可能にし、リフレクションによって型パラメーターに関する情報を取得することができる。また、`where`節によって型パラメーターに制約を与えることができる。一方、C++のように型パラメーターとして[式を指定することはできない](https://ja.wikipedia.org/wiki/式_\(プログラミング\) "wikilink")。なお、ジェネリックメソッドの呼び出し時に引数によって型パラメーターが推論できる場合、型パラメーターの指定は省略できる。

#### 静的クラス

静的クラスが導入された。`static`属性をクラスの宣言につけることで、クラスは[インスタンス](https://ja.wikipedia.org/wiki/インスタンス "wikilink")化できなくなり、静的なメンバーしか持つことができなくなる。

#### yieldキーワード

`yield`キーワードによる[コルーチン](https://ja.wikipedia.org/wiki/コルーチン "wikilink")を使うことで、[イテレータの生成を楽に実装できるようになった](https://ja.wikipedia.org/wiki/ジェネレータ_\(プログラミング\) "wikilink")。

#### 匿名デリゲート

[クロージャ](https://ja.wikipedia.org/wiki/クロージャ "wikilink")の機能を提供する匿名[デリゲートが導入された](https://ja.wikipedia.org/wiki/デリゲート_\(プログラミング\) "wikilink")。
...
`int?`は`Nullable`<int>の[糖衣構文](https://ja.wikipedia.org/wiki/糖衣構文 "wikilink")である。また、nullを保持しているNull許容型のインスタンスを[ボックス化](https://ja.wikipedia.org/wiki/ボックス化 "wikilink")しようとすると、単に空参照 (null) に変換される\[6\]。
...
`var` キーワードが導入され、[型推論](https://ja.wikipedia.org/wiki/型推論 "wikilink")を利用したローカル変数の宣言ができるようになった。
...
拡張メソッドは[糖衣構文](https://ja.wikipedia.org/wiki/糖衣構文 "wikilink")の一種であり、[カプセル化](https://ja.wikipedia.org/wiki/カプセル化 "wikilink")の原則に違反するものではないが、必要な場合に限り注意して実装することがガイドラインとして推奨されている\[7\]。
...
ラムダ式が導入された。この名前は[ラムダ計算](https://ja.wikipedia.org/wiki/ラムダ計算 "wikilink")に由来する。
...
ラムダ式は匿名メソッドと同様に扱えるが、式形式のラムダが`Expression`<TDelegate>型として扱われた場合のみ匿名メソッドとして扱われず、コンパイラによって式木を構築するコードに変換される。匿名デリゲートが実行前にコンパイルされた[CILを保持するのに対し](https://ja.wikipedia.org/wiki/共通中間言語 "wikilink")、式木はCILに実行時コンパイル可能である[DOMのような式の](https://ja.wikipedia.org/wiki/Document_Object_Model "wikilink")[木構造そのものを保持する](https://ja.wikipedia.org/wiki/木構造_\(データ構造\) "wikilink")。これはLINQクエリをSQLクエリなどに変換する際に役立つ。
...
[LINQ](https://ja.wikipedia.org/wiki/Language_Integrated_Query "wikilink") をサポートするために、クエリ式が導入された。これは [SQL](https://ja.wikipedia.org/wiki/SQL "wikilink") の構文に類似しており、最終的に通常のメソッド呼び出しに変換されるものである。以下に例を示す:
...
出井秀行著の『実戦で役立つ C\#プログラミングのイディオム/定石&パターン』（技術評論社、2017年）という書籍ではクエリ構文よりメソッド構文を推奨しており、クエリ構文ではLINQの全ての機能を使用できるわけではないこと、メソッド呼び出しは処理を連続して読める可読性があること、メソッド呼び出しであれば[Microsoft Visual Studioの強力な](https://ja.wikipedia.org/wiki/Microsoft_Visual_Studio "wikilink")[インテリセンス](https://ja.wikipedia.org/wiki/インテリセンス "wikilink")が利用できることを理由に、著者はクエリ構文をほとんど使用していないと記している。

### C\# 4.0からの仕様

#### dynamicキーワード

dynamicキーワードが導入され、[動的型付け](https://ja.wikipedia.org/wiki/動的型付け "wikilink")変数を定義できるようになった。dynamic型として宣言されたオブジェクトに対する操作のバインドは実行時まで遅延される。
...
[VBや](https://ja.wikipedia.org/wiki/Microsoft_Visual_Basic "wikilink")[C++](https://ja.wikipedia.org/wiki/C++ "wikilink")に実装されているオプション引数・名前付き引数が、C\#でも利用できるようになった。
...
[タプル](https://ja.wikipedia.org/wiki/タプル "wikilink")のための軽量な構文が導入された。 従来の`System.Tuple`クラスとは別に、`System.ValueTuple`構造体が新しく追加された。
...
C\#の言語仕様は標準化団体[Ecma Internationalを通じて公開](https://ja.wikipedia.org/wiki/Ecma_International "wikilink")・標準化されており、第三者がマイクロソフトとは無関係にコンパイラや実行環境を実装することができる\[17\]。 現段階で、C\#コンパイラの実装は次の5つが知られている。
  ...
  - [Mono Project](http://www.mono-project.com/)による[Mono内の](https://ja.wikipedia.org/wiki/Mono_\(ソフトウェア\) "wikilink") Mono Compiler Suite (mcs)。
...
## 名称
  ...
  - ECMA-334 3rd/4th/5th edition によると、**C\#** は「**C Sharp**」（シーシャープ）と発音し、**LATIN CAPITAL LETTER C (U+0043)** の後に **NUMBER SIGN \# (U+0023)** と書く\[19\]。 音楽の[シャープ](https://ja.wikipedia.org/wiki/変化記号 "wikilink") (♯, MUSIC SHARP SIGN (U+266F)) ではなく[ナンバーサイン](https://ja.wikipedia.org/wiki/番号記号 "wikilink") (\#) を採用したのは、[フォント](https://ja.wikipedia.org/wiki/フォント "wikilink")や[ブラウザ](https://ja.wikipedia.org/wiki/ブラウザ "wikilink")などの技術的な制約に加え、[ASCII](https://ja.wikipedia.org/wiki/ASCII "wikilink")コードおよび標準的キーボードには前者の記号が存在しないためである。
  - "\#"接尾辞は、他の.NET言語にも使用されており、[J\#](https://ja.wikipedia.org/wiki/J_Sharp "wikilink")（Javaのマイクロソフトによる実装）、[A\#](https://ja.wikipedia.org/wiki/A_Sharp "wikilink")（[Ada](../Page/Ada.md "wikilink")から）、[F\#](https://ja.wikipedia.org/wiki/F_Sharp "wikilink")（[System Fなどから](https://ja.wikipedia.org/wiki/System_F "wikilink")\[20\]）が含まれる。また"\#"接尾辞は[Gtk\#](https://ja.wikipedia.org/wiki/Gtk_Sharp "wikilink")（[GTK+](https://ja.wikipedia.org/wiki/GTK+ "wikilink")などの[GNOME](https://ja.wikipedia.org/wiki/GNOME "wikilink")ライブラリの.NETラッパ）、[Cocoa\#](https://ja.wikipedia.org/wiki/Cocoa_Sharp "wikilink")（[Cocoa](https://ja.wikipedia.org/wiki/Cocoa "wikilink")のラッパ）などのライブラリにも使用されている。そのほか、[SharpDevelop](https://ja.wikipedia.org/wiki/SharpDevelop "wikilink")などの"Sharp"を冠する関連ソフトウェアも存在する。
  - C\#という名称の解釈として、「（A-Gで表された）直前の音を半音上げる」という音楽記号の役割に着目し、「C言語を改良したもの」を意味したのではないか、。これは、[C++](https://ja.wikipedia.org/wiki/C++ "wikilink")の名称が「C言語を1つ進めたもの」という意味でつけられたことにも似ている。
  - [アンダース・ヘルスバーグ](https://ja.wikipedia.org/wiki/アンダース・ヘルスバーグ "wikilink")は、「C\#」が「C++++」（すなわち「C++をさらに進めたもの」）にみえるのが由来である、と語っている\[21\]\[22\]。
...
## 関連項目
  ...
  - 実行環境
      ...
      - [Mono](https://ja.wikipedia.org/wiki/Mono_\(ソフトウェア\) "wikilink")
  ...
  - 開発環境
      ...
      - [SharpDevelop](https://ja.wikipedia.org/wiki/SharpDevelop "wikilink") - フリーの統合開発環境
  - 比較
...
## 外部リンク
  ...
  - [Microsoft Shared Source Common Language Infrastructure 2.0 Release](http://www.microsoft.com/downloads/details.aspx?FamilyId=8C09FD61-3F26-4555-AE17-3121B4F51D4D&displaylang=en)
