...
BREWとはクアルコムが製造販売している携帯電話用プラットフォームMSMチップセット用に構築・拡張されたアプリケーション実行環境である。コンパイルはクアルコム提供のSDK、[Microsoft Visual C++にアドインしたRVCT](../Page/Microsoft_Visual_C++.md "wikilink")（ARMコンパイラ）、もしくは[gccによって行える](../Page/GNUコンパイラコレクション.md "wikilink")。なお、gcc は公式には未サポートである。
