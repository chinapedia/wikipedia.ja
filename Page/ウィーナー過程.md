...
[thumb](https://ja.wikipedia.org/wiki/ファイル:wiener_process_zoom.png "wikilink") [数学](../Page/数学.md "wikilink")における**ウィーナー過程**（ウィーナーかてい、）は、[ノーバート・ウィーナー](https://ja.wikipedia.org/wiki/ノーバート・ウィーナー "wikilink")の名にちなんだ連続時間[確率過程](https://ja.wikipedia.org/wiki/確率過程 "wikilink")である。ウィーナー過程は[ブラウン運動](../Page/ブラウン運動.md "wikilink")の[数理モデル](https://ja.wikipedia.org/wiki/数理モデル "wikilink")であると考えられ、しばしばウィーナー過程自身を**ブラウン運動**と呼ぶ。最もよく知られる[レヴィ過程](https://ja.wikipedia.org/wiki/独立増分過程 "wikilink")（[右連続](https://ja.wikipedia.org/wiki/右連続 "wikilink")かつ[定常な](https://ja.wikipedia.org/wiki/定常過程 "wikilink")[独立増分確率過程](https://ja.wikipedia.org/wiki/独立増分過程 "wikilink")）の一つであり、[純粋数学](https://ja.wikipedia.org/wiki/純粋数学 "wikilink")、応用数学、経済学、物理学などにおいてしばしば現れる。

## 概要

ウィーナー過程は純粋数学、応用数学の両方で重要な役割を演じる。純粋数学においては、ウィーナー過程は連続時間[マルチンゲール](https://ja.wikipedia.org/wiki/マルチンゲール "wikilink")の研究から生じ、より複雑な確率過程を記述する鍵となる確率過程である。それゆえに、[確率解析](https://ja.wikipedia.org/wiki/確率解析 "wikilink")、[拡散過程](https://ja.wikipedia.org/wiki/拡散過程 "wikilink")、あるいは[ポテンシャル論](https://ja.wikipedia.org/wiki/ポテンシャル論 "wikilink")においてさえも、極めて重要な役割を果たすのである。応用数学においては、ウィーナー過程は[ホワイト・ノイズ](https://ja.wikipedia.org/wiki/ホワイト・ノイズ "wikilink")の積分を表すものとして用いられ、それゆえに[電子工学](../Page/電子工学.md "wikilink")におけるノイズ、[フィルタリング理論における機器誤差](https://ja.wikipedia.org/wiki/電子フィルター "wikilink")、[制御理論](https://ja.wikipedia.org/wiki/制御理論 "wikilink")における未知の力 (unknown force) などの[数理モデル](https://ja.wikipedia.org/wiki/数理モデル "wikilink")として有用である。

ウィーナー過程の応用は数理科学の様々なところに現れる。物理学においては、[ブラウン運動](../Page/ブラウン運動.md "wikilink")、流体に浮遊する微粒子の拡散、[フォッカー-プランク方程式](https://ja.wikipedia.org/wiki/フォッカー-プランク方程式 "wikilink")や[ランジュバン方程式](https://ja.wikipedia.org/wiki/ランジュバン方程式 "wikilink")を通した様々な拡散の様子などを研究するのに用いられる。こういった応用は[量子力学](https://ja.wikipedia.org/wiki/量子力学 "wikilink")における[経路積分](../Page/経路積分.md "wikilink")の厳密な定式化（ウィーナー積分として表される[シュレーディンガー方程式](../Page/シュレーディンガー方程式.md "wikilink")の解である[ファインマン-カッツの公式](https://ja.wikipedia.org/wiki/ファインマン-カッツの公式 "wikilink")によるもの）や[宇宙論](../Page/宇宙論.md "wikilink")における[永久インフレーション](https://ja.wikipedia.org/wiki/永久インフレーション "wikilink")の研究の基礎を形成している。また、[数理ファイナンス](../Page/数理ファイナンス.md "wikilink")の理論、特に[ブラックとショールズのオプション価格モデルなどにも顕著に現われている](https://ja.wikipedia.org/wiki/ブラック-ショールズ方程式 "wikilink")。
...
各時間 *t* において、[確率密度関数](https://ja.wikipedia.org/wiki/確率密度関数 "wikilink")は  e^{-x^2/{2 \\alpha t} }</math>}} で、[期待値](../Page/期待値.md "wikilink")は  で、[共分散](https://ja.wikipedia.org/wiki/共分散 "wikilink")・[相関](https://ja.wikipedia.org/wiki/相関 "wikilink")は  で与えられる\[1\]。
