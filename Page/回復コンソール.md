...
Windowsシステムが正常に起動しなくなった場合には、通常[セーフモード](https://ja.wikipedia.org/wiki/セーフモード "wikilink")や、その他のスタートアップオプションを指定してWindowsを一時的に起動しトラブルの原因を取り除く作業を試みる様に作られているが、トラブルの状況によっては、それさえも不可能となることがある。その様な場合に用いられる復旧手段としてこの回復コンソールが用意されている。

なお[マイクロソフト](../Page/マイクロソフト.md "wikilink")では回復コンソールは、高度な知識を持つユーザーだけが使用する事と注意されており\[1\]、使い方を誤ればシステムを完全に破壊し、復旧不可能な状態となる可能性がある。

回復コンソールの使用に際しては管理者権限のある[アカウント](https://ja.wikipedia.org/wiki/アカウント "wikilink")（代表的には組み込みアカウントである "Administrator"）の[パスワード](https://ja.wikipedia.org/wiki/パスワード "wikilink")入力が必要である。

## 出来ること

WindowsセットアップCDや[フロッピーディスク](../Page/フロッピーディスク.md "wikilink")から起動できるため、[ハードディスク](https://ja.wikipedia.org/wiki/ハードディスク "wikilink")からWindowsが起動出来なくなった場合でも、ハードディスク修復の操作や、[CD-ROM](../Page/CD-ROM.md "wikilink")や[フロッピーディスク](../Page/フロッピーディスク.md "wikilink")等の[ファイル操作を行うことができる](https://ja.wikipedia.org/wiki/ファイル_\(コンピュータ\) "wikilink")。また、場合によってはサービスの有効化と無効化等も有効な復旧手段である。

使用するコマンドの多くは[コマンドプロンプト](../Page/コマンドプロンプト.md "wikilink")に類している為、使用に際しては[MS-DOS](../Page/MS-DOS.md "wikilink")を使用する知識が要求される。また、Windows 2000ではコマンドラインのほかに[ブートローダ](https://ja.wikipedia.org/wiki/ブートローダ "wikilink") ([NTLDR](https://ja.wikipedia.org/wiki/NTLDR "wikilink")) やWindowsのシステムファイルの修復を自動的に行う機能が付加されている。

## 光ディスクからの起動

[ハードディスク](https://ja.wikipedia.org/wiki/ハードディスク "wikilink")に[インストール](../Page/インストール.md "wikilink")された、障害を起こしているWindowsと同じバージョンのWindowsセットアップ[光ディスク](../Page/光ディスク.md "wikilink")（CDないしDVD）からシステムを起動する。セットアップディスクからの起動に際しては、コンピュータの[System BIOS設定において光ディスクドライブからの](https://ja.wikipedia.org/wiki/Basic_Input/Output_System "wikilink")[ブート](https://ja.wikipedia.org/wiki/ブート "wikilink")が明示的に許可されている必要がある。
...
回復コンソールを使ったからと言って、起動出来なくなったWindowsシステムを必ず復旧させることが出来るとは限らない。[マイクロソフト](../Page/マイクロソフト.md "wikilink")の技術文献に従い、まず第一に[セーフモード](https://ja.wikipedia.org/wiki/セーフモード "wikilink")等の手段で復旧手段を試みるべきである。それが行えない様な状態に陥った場合、[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink")の再インストールの必要性を覚悟した上で、むしろ最後の頼みの綱的な手段として使用を検討すべきであろう。もちろん可能であれば他にも色々と考えられる手段で、事前に重要なデータの[サルベージ](https://ja.wikipedia.org/wiki/サルベージ "wikilink")を行っておく方がより安全だろう。
