...
**GIMP**（ギンプ、ジンプ、**G**NU **I**mage **M**anipulation **P**rogram）は、[GNU GPL](../Page/GNU_General_Public_License.md "wikilink") の下で配布されている[ビットマップ画像](https://ja.wikipedia.org/wiki/ビットマップ画像 "wikilink")編集・加工ソフトウェア（[ペイントソフト](https://ja.wikipedia.org/wiki/ペイントソフト "wikilink")）。
...
フリーソフトでありながら有料のグラフィック編集ソフトウェアと比べても遜色のないレベルの機能を備えている。レイヤー、トーンカーブ、ヒストグラム、画像の形状からの切り抜き、ブラシエディタ、パスの編集、多種多様なプラグインなどに加え、モザイク編集や、アニメーション合成（[GIFアニメーション](https://ja.wikipedia.org/wiki/GIFアニメーション "wikilink")）を行うなどといったフィルタ機能も数多く備えており、これ一つで、コンピュータ上のほとんどの[画像編集](https://ja.wikipedia.org/wiki/画像編集 "wikilink")は行える。しかし多機能性を外部プラグインやスクリプトなどに頼っているため起動時の読み込み量が多く、時間がかかる。

もともとウェブ用のグラフィック編集を想定して開発されたソフトウェアであるため、[CMYK](https://ja.wikipedia.org/wiki/CMYK "wikilink")カラーをネイティブサポートしていない\[1\]など、本格的な印刷業務には向いていないという面もある。
...
対話的な使い方の他にも[Scheme](../Page/Scheme.md "wikilink")を使った「Script-Fu」を用いてスクリプトを作り自動化することができる。なお、Script-Fuの名は[カンフー](https://ja.wikipedia.org/wiki/功夫 "wikilink") (Kung-fu) からきている。現在では[Perl](../Page/Perl.md "wikilink")、[Python](../Page/Python.md "wikilink")、[Tcl](https://ja.wikipedia.org/wiki/Tcl/Tk "wikilink")、[Rubyなどの言語でスクリプトを書く環境もある](https://ja.wikipedia.org/wiki/Ruby_\(代表的なトピック\) "wikilink")。このスクリプト処理は完全に非対話的な自動処理も書ける。[ImageMagick](https://ja.wikipedia.org/wiki/ImageMagick "wikilink")の方が簡単にすばやく自動化処理を行えるが、GIMPの方がはるかに強力な画像編集機能を使える。
...
## 歴史
  ...
  - [1998年](https://ja.wikipedia.org/wiki/1998年 "wikilink")[6月2日](https://ja.wikipedia.org/wiki/6月2日 "wikilink") - 最初の正式版リリースとなる GIMP 1.0 がリリースされた\[5\]。
  - [2000年](../Page/2000年.md "wikilink")12月25日 - GIMP 1.2.0リリース\[6\]。
  - [2004年](https://ja.wikipedia.org/wiki/2004年 "wikilink")
      - [3月24日](https://ja.wikipedia.org/wiki/3月24日 "wikilink") - GIMP 2 最初のリリースとなる GIMP 2.0 がリリースされた\[7\]。
      - 12月19日 - GIMP 2.2.0 リリース\[8\]。
  - [2007年](https://ja.wikipedia.org/wiki/2007年 "wikilink")10月24日 - GIMP 2.4.0 がリリースされた\[9\]。
  - [2008年](https://ja.wikipedia.org/wiki/2008年 "wikilink")10月1日 - GIMP 2.6.0 がリリースされた\[10\]。
  - [2012年](https://ja.wikipedia.org/wiki/2012年 "wikilink")5月3日 - GIMP 2.8.0 がリリースされた\[11\]。このバージョンからシングルウインドウモードが導入された。
  - [2018年](https://ja.wikipedia.org/wiki/2018年 "wikilink")4月27日 - GIMP 2.10.0 がリリースされた\[12\]。ユーザーインターフェースが更新され、イニシャルHiDPIが導入された。

## ファイル形式

GIMP は以下の[ファイル形式を開いたり保存したりすることができる](https://ja.wikipedia.org/wiki/ファイルフォーマット "wikilink")\[13\]。

  - GIMP [XCF](https://ja.wikipedia.org/wiki/XCF "wikilink")、ネイティブ形式（.xcf、もしくは.xcf[.gzや](https://ja.wikipedia.org/wiki/gzip "wikilink").xcf[.bz2として圧縮されたもの](../Page/Bzip2.md "wikilink")）
  - [Autodesk](https://ja.wikipedia.org/wiki/オートデスク "wikilink") flic動画 (.fli)
  - [DICOM](https://ja.wikipedia.org/wiki/DICOM "wikilink")（.dcmもしくは.dicom）
  ...
  - [Scalable Vector Graphics](https://ja.wikipedia.org/wiki/Scalable_Vector_Graphics "wikilink")、パスのエクスポート用 (.svg)
  - Microsoft Windows の[アイコン](https://ja.wikipedia.org/wiki/ICO_\(ファイルフォーマット\) "wikilink") (.ico)
  - Microsoft の無圧縮[AVIビデオ](https://ja.wikipedia.org/wiki/Audio_Video_Interleave "wikilink") (.avi)
  - [Windows bitmap](https://ja.wikipedia.org/wiki/Windows_bitmap "wikilink") (.bmp)
  - [Corel Paint Shop Pro画像](https://ja.wikipedia.org/wiki/Corel_Paint_Shop_Pro "wikilink")（.pspまたは.tub）
  - [Adobe Photoshop文書](https://ja.wikipedia.org/wiki/Adobe_Photoshop "wikilink") (.psd、.pdd)
  ...
  - [KISSのセル](https://ja.wikipedia.org/wiki/KISekae_Set_system "wikilink") (.cel)
  - [Tagged Image File Format](https://ja.wikipedia.org/wiki/Tagged_Image_File_Format "wikilink")（.tiffか.tif）
  - [TARGA](https://ja.wikipedia.org/wiki/TGA "wikilink") (.tga)
  - [X](https://ja.wikipedia.org/wiki/X_Window_System "wikilink") bitmap画像（.xbm、.icon、もしくは.bitmap）
  - X pixmap画像 (.xpm)
  - X Windowダンプ (.xwd)
  - Zsoft [PCX](https://ja.wikipedia.org/wiki/PCX "wikilink") (.pcx)

GIMP は以下の形式をインポートできる（開けるが保存できない）:

  - Adobe [PDFファイル](https://ja.wikipedia.org/wiki/Portable_Document_Format "wikilink") (.pdf)
  - [RAW画像](https://ja.wikipedia.org/wiki/RAW画像 "wikilink")（多数の拡張）

GIMP は以下の形式をエクスポートできる（保存できるが開けない）:

  - [HTML](https://ja.wikipedia.org/wiki/HyperText_Markup_Language "wikilink")、色つきのセルを使った表として (.html)
  - [C言語](../Page/C言語.md "wikilink")のソースファイル、配列として（.cまたは.h）
  - [Multiple-image Network Graphics](https://ja.wikipedia.org/wiki/Multiple-image_Network_Graphics "wikilink")、レイヤ付き画像ファイル (.mng)
  - [アスキーアート](https://ja.wikipedia.org/wiki/アスキーアート "wikilink")もしくはHTML、画像を構成する文字や記号で

## マスコット

[thumb](https://ja.wikipedia.org/wiki/ファイル:Exquisite-gimp2_0.png "wikilink") 「ウィルバー (Wilber)」がGIMPの[マスコット](https://ja.wikipedia.org/wiki/マスコット "wikilink")である。
...
GIMP をベースにしたいくつかの派生バージョンやカスタマイズパッケージが存在する。
  ...
  - [GIMPshop](https://www.gimpshop.com/)
    [Adobe Photoshop](https://ja.wikipedia.org/wiki/Adobe_Photoshop "wikilink") とメニューの並び順を同じにしている。
  - [Seashore](https://sourceforge.net/projects/seashore/)
    [macOS](https://ja.wikipedia.org/wiki/macOS "wikilink") 向けにシンプル化したもの。

## 競合製品

  - [Adobe Photoshop](https://ja.wikipedia.org/wiki/Adobe_Photoshop "wikilink")、[Corel Paint Shop Pro](https://ja.wikipedia.org/wiki/Corel_Paint_Shop_Pro "wikilink")、[Corel PHOTO-PAINT](https://ja.wikipedia.org/wiki/Corel_PHOTO-PAINT "wikilink") との比較
...
## 関連項目
  ...
  - [Inkscape](https://ja.wikipedia.org/wiki/Inkscape "wikilink")、[Krita](https://ja.wikipedia.org/wiki/Krita "wikilink") -オープンソースで開発されている[ドローソフト](https://ja.wikipedia.org/wiki/ドローソフト "wikilink")
  - [Adobe Photoshop](https://ja.wikipedia.org/wiki/Adobe_Photoshop "wikilink")
