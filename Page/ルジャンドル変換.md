...
最小値が定まる場合でも、もととなる関数  が[凸関数](../Page/凸関数.md "wikilink")でない場合、新たに定義された関数  は逆変換してももとの関数  へは戻らない。

### 滑らかな関数に対する変換

もとの関数  の一階の導関数 (*x*)}} が  について[連続であり](../Page/連続_\(数学\).md "wikilink")[単調増加する場合](../Page/単調写像.md "wikilink")、すなわち関数  が下に凸で[滑らかな場合](../Page/滑らかな関数.md "wikilink")、関数  *f*(*x*) − *px*}} が最小となる  は、 の  の一階の導関数 (*x*)}} が 0 になる点であるから、ルジャンドル変換は次のように書き直せる。
