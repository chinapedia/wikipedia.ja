...
F<sub>1</sub> 部位はATPの反応に寄与しており、それは以下の式で表される。
  ...
  -
    [ATP](../Page/アデノシン三リン酸.md "wikilink") <chem>\<=\></chem> [ADP](../Page/アデノシン二リン酸.md "wikilink")+Pi（[リン酸](../Page/リン酸.md "wikilink")）
...
一方、F<sub>o</sub>部位は[プロトンを透過させる機能があり](../Page/水素イオン.md "wikilink")、以下の式で表される。
  ...
  -
    <chem>H^+in\\ \<=\> H^+out</chem>

プロトン電気化学的ポテンシャルを用いたATP合成の反応は以下の収支式で表される。

  -
    <chem>ADP\\ + Pi\\ + 3 H^+out -\> ATP\\ + 3H^+in</chem>
