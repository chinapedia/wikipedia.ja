...
**Cascading Style Sheets**（CSS、カスケーディング・スタイル・シート、カスケード・スタイル・シート、）とは、[HTML](../Page/HyperText_Markup_Language.md "wikilink") や [XML](../Page/Extensible_Markup_Language.md "wikilink") の要素をどのように修飾（表示）するかを指示する、[W3Cによる仕様の一つ](../Page/World_Wide_Web_Consortium.md "wikilink")。文書の*構造*と*体裁*を[分離させるという理念を実現する為に提唱された](../Page/関心の分離.md "wikilink")[スタイルシート](../Page/スタイルシート.md "wikilink")の、具体的な仕様の一つ。
...
CSSは、[1994年](../Page/1994年.md "wikilink")に[WWW生誕の地である](../Page/World_Wide_Web.md "wikilink")[CERNに勤務する](../Page/欧州原子核研究機構.md "wikilink")[ホーコン・ウィウム・リー](../Page/ホーコン・ウィウム・リー.md "wikilink")氏により提唱された。
...
### Cascading Style Sheets, level 1 (CSS1), 勧告 1996年12月
  ...
  - [色](../Page/色.md "wikilink")及び[背景](../Page/背景.md "wikilink")のプロパティ
...
他方[マイクロソフト](../Page/マイクロソフト.md "wikilink")のボックスのモデルでは width 属性は内容の横幅とパディングとボーダー分を足したもの、即ち要素全ての横幅になる\[2\]。そのためInternet Explorer5.5以下と6.0以上、およびInternet Explorer以外のWebブラウザでの表示の違いを近付けるためには、パディングとボーダーを0にする、もしくは[CSSハック](https://ja.wikipedia.org/wiki/CSSハック "wikilink")を使う必要がある。
