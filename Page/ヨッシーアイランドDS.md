...
全5ワールドでノーマルステージが8つ（4、8コースはボス登場）に加え、エンディング後に各ワールドに隠しステージが登場する。またエンディング後にワールド得点が800点を超えるとスペシャルステージが登場する。そのため全部で50のステージであるため、前作と比べると若干の減少であるが、難易度自体は前作よりも大幅にアップしている。
