...
**確率空間**（かくりつくうかん、）とは、[可測空間](https://ja.wikipedia.org/wiki/可測空間 "wikilink")  に[確率測度](https://ja.wikipedia.org/wiki/確率測度 "wikilink")  を入れた[測度空間](https://ja.wikipedia.org/wiki/測度空間 "wikilink")  をいう。[根元事象](https://ja.wikipedia.org/wiki/根元事象 "wikilink")が無数の場合では、確率を[ラプラスの](../Page/ピエール＝シモン・ラプラス.md "wikilink")[古典的確率で定義することができず](https://ja.wikipedia.org/wiki/確率論#古典的確率論 "wikilink")、確率を[公理的確率として定義することが](https://ja.wikipedia.org/wiki/確率論#公理的確率論 "wikilink")[アンドレイ・コルモゴロフ](https://ja.wikipedia.org/wiki/アンドレイ・コルモゴロフ "wikilink")により提唱されている。確率空間とは、そのために必要な概念である。
...
例えば、[コインを投げて表が出れば](https://ja.wikipedia.org/wiki/コイントス "wikilink") 10 円もらえ、裏が出れば 10 円を失うといった賭けにおいて、表に賭け続けていくという問題を考える。現実的には資金が尽きたら、疲れたら、あるいは満足したらそこで終了となるが、これを半永久的に毎日賭け続けていったらどうなるかという[確率分布](../Page/確率分布.md "wikilink")が考えられる（運命の確率）。この場合、数学的に定式化するには、すべてのコインの出現パターンを集める必要がある。すなわち
...
という無限列全てからなる集合が確率空間となる。全事象の確率は  であり、またこの場合は根元事象の確率は全て等しい（[等確率空間](https://ja.wikipedia.org/wiki/等確率空間 "wikilink")）ため、根元事象の確率は  となる。そうすると、根元事象の可算和に確率を割り当てることは[古典的確率ではできない](https://ja.wikipedia.org/wiki/確率論#古典的確率論 "wikilink")。このような理由から、[測度論](https://ja.wikipedia.org/wiki/測度論 "wikilink")の知識が必要となり、現代的な確率論の成立には測度論や[ルベーグ積分](https://ja.wikipedia.org/wiki/ルベーグ積分 "wikilink")が生まれるまで待たなければならなかったのである。一方で、最近では測度論の研究はほとんど確率論の研究と同義になっている。

直観的に確率空間とは、起こりうる事象を全て集めてきて、それらの起こりやすさを表す確率関数がある空間のことである。

## 定義

[数学](../Page/数学.md "wikilink")、特に[確率論](https://ja.wikipedia.org/wiki/確率論 "wikilink")において、**[確率測度](https://ja.wikipedia.org/wiki/確率測度 "wikilink")**（かくりつそくど）とは、[可測空間](https://ja.wikipedia.org/wiki/完全加法族 "wikilink")  に対し、 上で定義され  1}} を満たす[測度](https://ja.wikipedia.org/wiki/測度論 "wikilink")  のことである。
...
確率測度の定義は、[コルモゴロフによる次の確率の公理の形にまとめることができる](https://ja.wikipedia.org/wiki/アンドレイ・コルモゴロフ "wikilink")。
...
## 関連項目
  ...
  - [測度論](https://ja.wikipedia.org/wiki/測度論 "wikilink")
