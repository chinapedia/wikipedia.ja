...
## 参考文献(学習用)
  ...
  - [OpenMP Architecture Review Board："OpenMP Application Programming Interface Specification Version 5.0"](https://www.openmp.org/wp-content/uploads/OpenMP-API-Specification-5.0.pdf),　ISBN 978-1-7311996-0-7 (2018年12月）。※ OpenMP 5.0 の仕様を記述。
...
## 外部リンク
  ...
  - [OpenMP入門 - Fortran利用者向け (NAG社)](https://www.nag-j.co.jp/openMP/index.html)
