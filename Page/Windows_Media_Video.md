...
## 特徴
  ...
  - WMV9はDVD（[MPEG-2](../Page/MPEG-2.md "wikilink")）の約半分の[ビットレート](../Page/ビットレート.md "wikilink")で同等の画質を得られるとしている。また、[HDTVにも対応している](https://ja.wikipedia.org/wiki/高精細度テレビジョン放送 "wikilink")（WMV HD）。
  ...
  - [デジタル著作権管理](../Page/デジタル著作権管理.md "wikilink")（DRM）対応（ASFコンテナ格納時のみ）によって、著作者の意図しないコピーを防止することができる。
