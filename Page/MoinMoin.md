...
## 特徴
  ...
  - [Python](../Page/Python.md "wikilink")で書かれている
  - 強力なページのリビジョン管理（変更履歴はすべて保存される）。
  - アクセスコントロール機能を持つ。
  - UTF-8出力や国際化に標準で対応。
  - ページの保存にはテキストファイルを使用し、[MySQL](https://ja.wikipedia.org/wiki/MySQL "wikilink")などの[RDBMSを使わない](../Page/関係データベース管理システム.md "wikilink")。
...
**MoinMoin DesktopEdition** を使用することにより、ローカルマシンで簡単に[パーソナルウィキとしての利用ができる](https://ja.wikipedia.org/wiki/ウィキソフトウェア#個人用ウィキ "wikilink")\[4\]。配付パッケージを展開し wikiserver.py を実行すると、localhost の 8080 ポートでWebサーバが起動し、フル機能の MoinMoin にアクセスできるようになる。
...
## 関連項目
  ...
  - [mod python](https://ja.wikipedia.org/wiki/mod_python "wikilink")
  - [ウィキソフトウェア](../Page/ウィキソフトウェア.md "wikilink")

## 外部リンク

  -
  - [DesktopEdition](https://moinmo.in/DesktopEdition)

  - [ThemeMarket](https://moinmo.in/ThemeMarket)

[Category:オープンソースソフトウェア](https://ja.wikipedia.org/wiki/Category:オープンソースソフトウェア "wikilink") [Category:ウィキクローン](https://ja.wikipedia.org/wiki/Category:ウィキクローン "wikilink") [Category:Python](https://ja.wikipedia.org/wiki/Category:Python "wikilink")
