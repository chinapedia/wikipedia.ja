...
また、[TLS/SSLや](../Page/Transport_Layer_Security.md "wikilink")[IPsec](../Page/IPsec.md "wikilink")をはじめとして、[IETF](https://ja.wikipedia.org/wiki/IETF "wikilink")や[ISO/IECなど多くの標準化団体に採用されている](https://ja.wikipedia.org/wiki/ISO/IEC_JTC_1 "wikilink")。主な標準化実績は以下の通りである\[4\]。
