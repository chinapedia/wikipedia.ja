...
関数*f* が適当に[滑らかな関数](https://ja.wikipedia.org/wiki/滑らかな関数 "wikilink")ならば、*f* の零点を求めるための関数*g* を
...
### その他
  ...
  - [二分法](https://ja.wikipedia.org/wiki/二分法 "wikilink")
...
#### 数値線形代数
  ...
  - Traub, J. F. (1982). Iterative methods for the solution of equations. [American Mathematical Society](https://ja.wikipedia.org/wiki/アメリカ数学会 "wikilink").
