...
**デフラグメンテーション**（）とは、[コンピュータ](../Page/コンピュータ.md "wikilink")の[ファイルシステム](../Page/ファイルシステム.md "wikilink")における[フラグメンテーション](https://ja.wikipedia.org/wiki/フラグメンテーション "wikilink")を解消すること。しばしば略して**デフラグ**とも呼ばれる。
...
[ハードディスクドライブ](https://ja.wikipedia.org/wiki/ハードディスクドライブ "wikilink") (HDD) のようなディスク式記憶装置でファイルの生成と削除を繰り返していると、[ファイルが占める領域がだんだんと分断化されてゆく](https://ja.wikipedia.org/wiki/ファイル_\(コンピュータ\) "wikilink")。これをフラグメンテーションまたは断片化という。ファイルが断片化すると、ひとつのデータがディスクのあちこちに点在している状態になり、余分にディスクヘッドを多く動かさなければならないため、ファイルアクセスが遅くなり、またディスク装置の寿命を縮める恐れもある。空き領域が断片化すると、大きなファイルを生成するときに断片化しやすくなる。元々は、ファイルシステムがあえて断片化を許容することでデータの柔軟な管理を可能としているため、断片化は宿命といえる。
...
最も有名なデフラグメンター（デフラグソフト）は、[MS-DOS](../Page/MS-DOS.md "wikilink")と[Windowsにバンドルされている](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")「[デフラグ](https://ja.wikipedia.org/wiki/デフラグ_\(Windows\) "wikilink")」と推測される。[Windows 2000と](../Page/Microsoft_Windows_2000.md "wikilink")[Windows XPには](../Page/Microsoft_Windows_XP.md "wikilink")[Diskeeper](../Page/Diskeeper.md "wikilink")の機能限定版が搭載されている。

他の商用デフラグソフトには Diskeeper、[PerfectDisk](../Page/PerfectDisk.md "wikilink")、[O\&O Defrag](https://ja.wikipedia.org/wiki/O&O_Defrag "wikilink")（廉価版は[驚速デフラグ](https://ja.wikipedia.org/wiki/驚速デフラグ "wikilink")）、[Norton SpeedDisk](https://ja.wikipedia.org/wiki/Norton_SpeedDisk "wikilink")、[TechTool Proなどがある](https://ja.wikipedia.org/wiki/TechTool_Pro "wikilink")。ソフトウェアを使わずに断片化を解消する方法としては、記憶装置の[バックアップ](https://ja.wikipedia.org/wiki/バックアップ "wikilink")をとり、[データ](../Page/データ.md "wikilink")を消去してからバックアップからデータを再度読み込み直せばよい。

## SSDでのデフラグ

[ソリッドステートドライブ](https://ja.wikipedia.org/wiki/ソリッドステートドライブ "wikilink")（SSD）は、[ハードディスクドライブ](https://ja.wikipedia.org/wiki/ハードディスクドライブ "wikilink")（HDD）の代替デバイスとして使われる新たな[補助記憶装置](../Page/補助記憶装置.md "wikilink")である。これはHDDとは根本的に動作原理が異なるため、従来のHDD用に設計されたデフラグメンテーションツール等とは、相性が非常に悪い\[1\]。
...
[ソリッドステートドライブ](https://ja.wikipedia.org/wiki/ソリッドステートドライブ "wikilink")（SSD）の場合と似た理由で、[仮想マシン](https://ja.wikipedia.org/wiki/仮想マシン "wikilink")にアタッチされ、または単体でマウントされた[仮想ハードディスク](https://ja.wikipedia.org/wiki/仮想ハードディスク "wikilink")に対する、HDD用に設計されたデフラグメンテーションツールの適用も、パフォーマンス上の問題を引き起こす場合がある。
...
[Windows 8では](https://ja.wikipedia.org/wiki/Windows_8 "wikilink")、OS標準のデフラグツール「ドライブのデフラグと最適化」で、仮想ハードディスク(VHD/VHDX)のマウント先のドライブに対して、従来のHDD向けデフラグではなく、使用中の[ブロック数が少なくなるようにデータ移動を行う](../Page/ブロック_\(データ\).md "wikilink")（[デフラグ (Windows)を参照](https://ja.wikipedia.org/wiki/デフラグ_\(Windows\) "wikilink")）。
...
## 標準のデフラグ・ツール
  ...
  - [FAT](../Page/File_Allocation_Table.md "wikilink") - [デフラグ](https://ja.wikipedia.org/wiki/デフラグ_\(Windows\) "wikilink")
  ...
  - [NTFS](../Page/NT_File_System.md "wikilink") - [デフラグ](https://ja.wikipedia.org/wiki/デフラグ_\(Windows\) "wikilink")
  - [ReiserFS](https://ja.wikipedia.org/wiki/ReiserFS "wikilink") - デフラグ・ツールを持たない
