...
*f* の[傾き](https://ja.wikipedia.org/wiki/勾配 "wikilink")（ベクトルの意味での一階導関数）∇*f* がある点 *x* で0のとき、*f* は *x* において**[臨界点](https://ja.wikipedia.org/wiki/臨界点_\(数学\) "wikilink")**あるいは**[停留点](https://ja.wikipedia.org/wiki/停留点 "wikilink")**を持つと言う。*x* におけるヘッセ行列の[行列式](../Page/行列式.md "wikilink")は *x* における[判別式](https://ja.wikipedia.org/wiki/判別式 "wikilink")あるいはヘッシアンと呼ばれ、その値が0であるような *x* を *f* の**退化臨界点**または**非モース臨界点**という。ヘッシアンが 0 でない臨界点は**非退化**であると言い、また、*f* の**モース臨界点**と呼ぶ。
...
\((M,g)\) を[リーマン多様体](https://ja.wikipedia.org/wiki/リーマン多様体 "wikilink")とし、\(\nabla\) をその[レビ・チビタ接続とする](https://ja.wikipedia.org/wiki/レヴィ・チヴィタ接続 "wikilink")。\(f\colon M \to \mathbb{R}\) を[滑らかな関数](https://ja.wikipedia.org/wiki/滑らかな関数 "wikilink")とする。すると、ヘッセテンソル
