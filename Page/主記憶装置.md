...
現代的な多くの[コンピュータ](../Page/コンピュータ.md "wikilink")[システム](../Page/システム.md "wikilink")では、[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink")とメモリ管理ハードウェア\[2\]の連携により、プロセスごとに保護された主記憶装置のメモリ空間を仮想的に割り当てる、[仮想記憶](../Page/仮想記憶.md "wikilink")を採用している。そのため、主記憶装置の空間を一定の単位に区切って管理しつつ利用するメモリ管理機能が利用されている。その方法には、[セグメント方式](../Page/セグメント方式.md "wikilink")や[ページング方式](../Page/ページング方式.md "wikilink")がある。
