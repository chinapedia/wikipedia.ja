> この記事は[ETOPS](https://ja.wikipedia.org/wiki/ETOPS)から翻訳されています。


**ETOPS**（、イートップス）とは、民間[旅客機](../Page/旅客機.md "wikilink")の安全性確保のためのルールの1つである\[1\]。[エンジン](../Page/エンジン.md "wikilink")を2基しか持たない旅客機では、仮にそのうちの1基が飛行中に停止した場合でも一定時間以内に代替の[空港](../Page/空港.md "wikilink")へ緊急着陸することが可能な[航空路](../Page/航空路.md "wikilink")でのみ飛行が許されるとして、[国際民間航空機関](../Page/国際民間航空機関.md "wikilink") (ICAO) が取り決めたものである。緊急時にエンジン1基のみでの飛行する場合、飛行可能な時間を定めたものと言い替えることができる。

日本の[国土交通省](../Page/国土交通省.md "wikilink")は、ETOPSを「**双発機による長距離進出運航**」と呼び、実施承認審査基準を設定している。

なお、この規定は今後、新たに提案された**LROPS** () に置き換えられる可能性がある。
...
ETOPSを実際に認定するのは、アメリカ[連邦航空局](../Page/連邦航空局.md "wikilink")（FAA）と[欧州航空安全機関](https://ja.wikipedia.org/wiki/欧州航空安全機関 "wikilink")（EASA）の2機関である。
...
双発機が長距離飛行を行うにあたっては、航空機・エンジンのみならず、空港の要件についても3発・4発機より厳格に定められている。\[9\]

航路周辺の緊急着陸に適した空港は**Adequate Airport**（着陸可能飛行場）\[10\]と呼ばれ、運用時間や飛行場諸元等から安全に着陸できるものでなければならない。これはETOPSでない飛行（空港から60分以内の距離の飛行）にも適用される。

Adequate Airportの要件に加え、より厳しい条件を満足する空港を**Suitable Airport**（着陸に適した飛行場）と呼ぶ。Suitable Airportは滑走路の路面状態を考慮した十分な滑走路長を持ち、気象状態も滑走路の数や進入方式に応じた所定の条件を満たさなければならない。さらに緊急時の救難・消火体制もICAOの定める「カテゴリー4」以上の能力が必要である。通信状況その他についても様々な条件がある。ETOPS運航においては、Suitable Airportの中から、エンルート用の**ETOPS代替空港**（ETOPS Alternate Airport）\[11\]を選定しなければならないことになっている。
...
## 外部リンク
  ...
  - [Great Circle Mapper](http://gc.kls2.com) - Great Circle mapper including ETOPS ranges
...
2.  参考文献：嶋田久典『世界の傑作旅客機50』ソフトバンククリエイティブ
3.  [JALの新LCC「ZIPAIR Tokyo」発表会。「太平洋を渡りたい」と西田社長 初年度は2機の787-8で成田～ソウル/バンコク線から](https://travel.watch.impress.co.jp/docs/news/1173771.html) - トラベル Watch
4.  「エアバスの見据える未来とは」『[航空ファン](https://ja.wikipedia.org/wiki/航空ファン_\(雑誌\) "wikilink")』2010年8月号、P.73
5.  [Boeing to Offer up to 330-Minute ETOPS on 777 - Dec 12, 2011](http://boeing.mediaroom.com/2011-12-12-Boeing-to-Offer-up-to-330-Minute-ETOPS-on-777)
6.  [FAA、787のETOPS 330承認　単発で330分飛行可能に](http://www.aviationwire.jp/archives/37604) - Aviation Wire 2014年5月29日付
7.  [747-8、最大330分のETOPS取得　4発機初](http://www.aviationwire.jp/archives/57377)- Aviation Wire 2015年3月19日付
8.  [A350 XWB、最大370分のETOPS承認](http://www.airbusjapan.com/single-jp/detail/a350-xwb370etops/)
9.  [Suitable Enroute Alternate Aerodromes](http://www.tc.gc.ca/eng/civilaviation/publications/tp6327-tp6327v96-appendices-appendixb-4931.htm) - Transport Canada (英語)
10. [双発機による長距離進出運航実施承認審査基準](http://www.mlit.go.jp/notice/noticedata/pdf/201706/00006724.pdf)
11.