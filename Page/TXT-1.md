> この記事は[TXT-1](https://ja.wikipedia.org/wiki/TXT-1)から翻訳されています。


**TXT-1**（てぃーえっくすてぃーわん）とは、田宮模型（現・[タミヤ](../Page/タミヤ.md "wikilink")）よりリリースされた、1/10電動[RCカー](https://ja.wikipedia.org/wiki/RCカー "wikilink")のビッグフット・モデルである。 TXTは**T**amiya **X**treme **T**ruck（タミヤ・エクストリーム・トラック）の略\[1\]。
...
## 特徴
  ...
  - カンチレバー方式のサスペンション
    前後の[サスペンション](../Page/サスペンション.md "wikilink")はアクスルホーシングを4本のアルミ製リンクロッドで支持する実車同様の4リンク式であるが、4本のオイル[ダンパーをメインフレーム上部に縦置きで搭載し](../Page/ショックアブソーバー.md "wikilink")、それをホーシングから伸ばしたプッシュロッドにより大型のロッカーアーム（ロッキングアーム）を押すことで作動させる「カンチレバー」方式を採用している。
...
<!-- end list -->
  ...
  - 3段変速スイッチ
    2016年現在ではほとんど使われることの無くなった、[機械式スピードコントローラーが標準装備となっている](https://ja.wikipedia.org/wiki/ラジコン模型自動車#スピードコントローラーの種類 "wikilink")。スイッチ用[サーボモーター](https://ja.wikipedia.org/wiki/サーボモーター "wikilink")でスイッチを切り替える事でスピードをコントロールする\[3\]\[4\]。
...
## 主な仕様
  ...
  - シャシ：ジュラルミン/アルミ製ツインバーティカルプレート・[ラダーフレーム](https://ja.wikipedia.org/wiki/ラダーフレーム "wikilink")構造
...
1.  [4×4 モンスターピックアップ　TXT-1](http://web.archive.org/web/20130715064432/http://www.tamiya.com/japan/products/58280txt_1/txt_1.htm)（2013年7月15日時点の[アーカイブ](../Page/インターネットアーカイブ.md "wikilink")）
2.
3.  組立説明図のP17,19参照
4.
5.  組立説明図のP21参照