...
[有限集合](https://ja.wikipedia.org/wiki/有限集合 "wikilink") *E* に対し、*E* の[濃度を](../Page/濃度_\(数学\).md "wikilink") *n* とする。このとき、*E* の元を *I* = {1, 2, …, *n*} で添え字付けて、*E* の元の全体を *I* を添え字集合とする元の列 (*x*) と思うことができる。この列の総乗を
...
また数列 (*x*) に対して無限乗積 \(\textstyle \prod_{n = 1}^\infty (1 + \vert x_n \vert)\) が収束するとき、無限乗積 \(\textstyle \prod_{n = 1}^\infty (1 + x_n)\) は**絶対収束**するという\[3\]。無限乗積 \(\textstyle \prod_{n = 1}^\infty (1 + x_n)\) が絶対収束するのは[無限級数](https://ja.wikipedia.org/wiki/無限級数 "wikilink") \(\textstyle \sum_{n = 1}^\infty x_n\) が[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")するとき、かつそのときに限る\[4\]。

### 例

[三角関数の無限乗積展開](https://ja.wikipedia.org/wiki/三角関数の無限乗積展開 "wikilink")\[5\]
...
\[\cosh \pi z=\prod_{n=1}^{\infty} \left\{ 1+\frac{z^2}{(n-\frac{1}{2})^2} \right\}\] [ウォリス積](https://ja.wikipedia.org/wiki/ウォリス積 "wikilink")\[6\]\[7\]
...
## 関連項目
  ...
  - [超階乗](https://ja.wikipedia.org/wiki/超階乗 "wikilink")
...
2.  [神保道夫](https://ja.wikipedia.org/wiki/神保道夫 "wikilink")、複素関数入門、[岩波書店](../Page/岩波書店.md "wikilink")。
3.
4.
5.
...
8.
9.  時弘哲治、工学における特殊関数、[共立出版](https://ja.wikipedia.org/wiki/共立出版 "wikilink")。
