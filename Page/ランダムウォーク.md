...
*X*<sub>*n*</sub> (*n* = 1, 2, ...) を[独立かつ同分布な](https://ja.wikipedia.org/wiki/独立同分布 "wikilink") *R*<sup>*d*</sup> 値[確率変数](https://ja.wikipedia.org/wiki/確率変数 "wikilink")族とする。この時、
...
[コイントス](https://ja.wikipedia.org/wiki/コイントス "wikilink")において、コインを投げて「裏と表が出る確率」は、共に二分の一である。
...
## 応用
  ...
  - 自己回避ランダムウォーク\[9\]
    軌跡が交差しないランダムウォーク。理論的な解析は困難。[高分子](../Page/高分子.md "wikilink")の幾何学的構造\[10\]、海岸線などのモデル（[自己相似](../Page/自己相似.md "wikilink")）として利用されている。
...
## 関連項目
  ...
  - [ランダム・ウォーク理論](https://ja.wikipedia.org/wiki/ランダム・ウォーク理論 "wikilink")
...
9.  [確率モデルを用いたフラクタル図形の作成](http://chaosweb.complex.eng.hokudai.ac.jp/~j_inoue/JIKKEN2006/jikken_fractal2006.pdf)複雑系工学講座 混沌系工学研究室 井上純一
10. [ランダムウォークと統計力学](http://www.ice.gunma-ct.ac.jp/~tsurumi/courses/Sim/RandomWalk.pdf)岡部豊