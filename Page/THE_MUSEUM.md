...
MUSEUM（[美術館](../Page/美術館.md "wikilink")）の名の通り、これまでのシングルのディスクジャケットに描かれたアイテムを美術館の展示室を思わせる構成で配置している。ちなみにディスクジャケットとフォトブックの撮影は水樹自身による\[1\]。

初回製造分は、スペシャルフォトブック仕様となっており、DVD付属の2枚組になっている。それまでに発表してきたシングル作品より、水樹自身が選出した楽曲を収録。収録に際して、「TRANSMIGRATION」の新録バージョンが「TRANSMIGRATION 2007」として、また、新曲「Crystal Letter」が収録されている。

### 主な記録

2010年2月19日付オリコンアルバムチャートで初登場5位を記録。初動売り上げは40,686枚を記録し、前作の初動35,299枚から約5千枚近く増加。累計売上でも65,010枚を記録した。

## 批評

CDジャーナルは、「パワフルなヴォーカルが気持ちいい。徹底したアイドル性には貫禄すら感じられる。」と評した\[2\]
...
<!-- end list -->
  ...
  - symth programming & key boards:nobuhiro makino
  - guitar:takeshi masuda
  - bass:ataru sumiyoshi
  - drums:syuuichi nakano
  - chorus:nana mizuki
...
<!-- end list -->
  ...
  - guitar:takeshi masuda
  - bass:ataru sumiyoshi
  - rollsnea & drums:syuuichi nakano
  - chorus:nana mizuki

<!-- end list -->

  - The place of hapiness
...
<!-- end list -->
  ...
  - symth programming & key boards& guiters:toshiro yabuki
  - sax:masahiro fujioka
  - chorus:kazue tsuda,hiromi kobayashi
  - call:nana mizuki,toshiya sagara,masaya yagyu,masahiko takahashi,akio mishima
...
<!-- end list -->
  ...
  - all instruments:toshiro yabuki
  - chorus:kazue tsuda,koh-chan,keizo nakajima
  - end chorus:brenda vaughn,kazue tsuda
...
<!-- end list -->
  ...
  - all instruments:toshiro yabuki
  - guitar soro:[kenji kitamura](../Page/北島健二.md "wikilink")
  - chorus:masami okui,kazue tsuda,koh-chan,kousaku tanaka,urara sato,masaya yagyu,akio mishima
...
<!-- end list -->
  ...
  - symth programming & key boards:tsutomu ohira
...
<!-- end list -->
  ...
  - all instruments:takahiro iida
  - guitar solo:toshiro yabuki
...
<!-- end list -->
  ...
  - drums:yusuke akimoto
  - chorus:junko hirotani,go takahashi
...
<!-- end list -->
  ...
  - guitar:masaki suzuki,nozomu kanou
  - strings:gen ittetsu strings,shiozaki strings
  - chorus:eri sugai
  - all other instruments & programming:noriyasu agematsu
...
<!-- end list -->
  ...
  - symth programming& key boards:toshiro yabuki
  - bass:L.A steak box
  - drums:richy lawson
  - a.c guitar:toshiro yabuki,koh-chan
  - keyboards:tsutomu ohira
  - chorus:koh-chan,kosaku tanaka,satomi-dark-takahashi

## 出典

## 外部リンク

  - [キングレコードによる紹介ページ](http://www.kingrecords.co.jp/cs/g/gKIZC-3/)

[Category:水樹奈々のベスト・アルバム](https://ja.wikipedia.org/wiki/Category:水樹奈々のベスト・アルバム "wikilink") [Category:2007年のベスト・アルバム](https://ja.wikipedia.org/wiki/Category:2007年のベスト・アルバム "wikilink")
