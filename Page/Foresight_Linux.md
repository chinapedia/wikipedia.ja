> この記事は[Foresight Linux](https://ja.wikipedia.org/wiki/Foresight_Linux)から翻訳されています。


**Foresight Linux**（フォーサイト・リナックス）は[Linuxディストリビューション](../Page/Linuxディストリビューション.md "wikilink")の一つである。2015年5月に開発を終了した\[1\]。
...
ローリングアップデートは、実質的にローリングリリースと考えてよい。 ローリングリリースを採用している[ディストリビューション](https://ja.wikipedia.org/wiki/ディストリビューション "wikilink")として[Arch Linuxがあるが](https://ja.wikipedia.org/wiki/Arch_Linux "wikilink")、コンセプトは異なる。[Arch Linuxは](https://ja.wikipedia.org/wiki/Arch_Linux "wikilink")「シンプリシティ、ミニマリズム」を重視しており、インストールとその後の環境設定は容易ではない。一方、Foresight Linuxは「ユーザーフレンドリー」を指向しており、インストールは容易であり、インストール後、すぐに使い始めることができるほどアプリケーションが充実している。
...
## 外部リンク
  ...
  - [公式プロジェクトWebサイト](http://www.foresightlinux.org/)
  - [rPath Webサイト](http://www.rpath.com/corp/)
  - [プロジェクト wiki](http://wiki.foresightlinux.com/confluence/dashboard.action)
  - [Foresight LinuxについてのGNOME Journalの記事](http://www.gnomejournal.org/article/22/an-introduction-to-foresight-desktop-linux)
  - [rolling updates\! not rolling releases\!](http://lists.rpath.org/pipermail/foresight-devel/2009-September/001327.html)
...
1.  [Foresight Linux Project announces its retirement](http://article.gmane.org/gmane.linux.foresight.devel/2857)