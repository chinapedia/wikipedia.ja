> この記事は[ELinks](https://ja.wikipedia.org/wiki/ELinks)から翻訳されています。
...
2017年3月17日に[OpenBSD](../Page/OpenBSD.md "wikilink")は、セキュリティ面での不安要素と開発者からの反応の悪さに言及し、OpenBSDのポートツリーからELinksを削除した\[3\]。
...
## 特徴
  ...
  - [テーブルと](https://ja.wikipedia.org/wiki/TABLE要素 "wikilink")のサポート\[6\]。
  - キューを利用したバックグラウンドでのダウンロード。
  - [CSSの部分的サポート](../Page/Cascading_Style_Sheets.md "wikilink")\[7\]。
  - [SpiderMonkey](https://ja.wikipedia.org/wiki/SpiderMonkey "wikilink")を利用した[ECMAScript](../Page/ECMAScript.md "wikilink")の部分サポート\[8\]。
...
## 外部リンク
  ...
  -
  - [Thomas Adam's ELinks page](http://www.xteddy.org/elinks/)

[Category:テキストブラウザ](https://ja.wikipedia.org/wiki/Category:テキストブラウザ "wikilink") [Category:2001年のソフトウェア](https://ja.wikipedia.org/wiki/Category:2001年のソフトウェア "wikilink")
