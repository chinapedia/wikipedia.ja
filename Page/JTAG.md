...
**JTAG**（ジェイタグ、）は、[集積回路](../Page/集積回路.md "wikilink")や[基板](../Page/基板.md "wikilink")の[検査](https://ja.wikipedia.org/wiki/検査 "wikilink")、[デバッグ](../Page/デバッグ.md "wikilink")などに使える、[バウンダリスキャンテスト](https://ja.wikipedia.org/wiki/バウンダリスキャンテスト "wikilink")やテストアクセスポートの標準 [IEEE](../Page/IEEE.md "wikilink") 1149.1 の通称である。本来はこの検査方式を定めた[業界団体](../Page/業界団体.md "wikilink")（Joint European Test Action Group）の名称の略。当初JETAGであったがEuropeanが抜けJTAGとなった。
...
近年、検査目的だけではなく、[組み込みシステム](../Page/組み込みシステム.md "wikilink")の[ソフトウェア](../Page/ソフトウェア.md "wikilink")の[デバッグ](../Page/デバッグ.md "wikilink")などの目的で、[ICEの一種として](../Page/インサーキット・エミュレータ.md "wikilink")、[CPU](../Page/CPU.md "wikilink")や[FPGA](../Page/FPGA.md "wikilink")にアクセスする手段としてJTAGが用いられるようになってきている。その場合、本来のICEの機能である[リアルタイム性の](https://ja.wikipedia.org/wiki/リアルタイムシステム "wikilink")[観測](../Page/観測.md "wikilink")は、再現できない場合もある。
