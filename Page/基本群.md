...
後者の式は、しばしば次のような状況へ応用される。E を B のの空間、F を B のとするか、もしくは、B を [位相群](https://ja.wikipedia.org/wiki/位相群 "wikilink") G の[分類空間](https://ja.wikipedia.org/wiki/分類空間 "wikilink") BG とし、E を普遍 G-バンドル EG とする。
...
[位相群](https://ja.wikipedia.org/wiki/位相群 "wikilink")では、つなぎ合わせではなく各点における積によって、ループの集合に別の群の積を割り当てることもできる。この群がである。
