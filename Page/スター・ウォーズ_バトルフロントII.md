...
映画エピソードIIIのDVDには[Xboxのみで起動できる本作の](../Page/Xbox_\(ゲーム機\).md "wikilink")[体験版](../Page/体験版.md "wikilink")（英語版）が付属したが、国内で本作のXbox版は発売されていない。
...
## 前作からの主な変更点
  ...
  - キャンペーンの仕様変更
    前作のキャンペーンは通常のコンクエストをクリアするだけだったが、本作ではマップ中に通常とは異なる様々な目標が設定されており、特別なユニットやオブジェクトが配置されている場合もある。また、スターファイターやヒーローを操作する場面もある。このモードは後にダース・ベイダー直属のクローントルーパー部隊となる[第501大隊のオリジナルストーリーで構成されており](../Page/スター・ウォーズ登場組織一覧.md "wikilink")、プレイヤーは大隊の一員となって[ジオノーシスの戦いから](https://ja.wikipedia.org/wiki/クローン大戦 "wikilink")[ホスの戦い](https://ja.wikipedia.org/wiki/ホスの戦い "wikilink")までを銀河の歴史に沿って戦い抜く。
  - 新たなゲームモードの追加
