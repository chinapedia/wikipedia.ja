...
**Arm** (以前は正式には**ARM**と表記され、その前は**Advanced RISC Machine**、元々は**Acorn RISC Machine**と表記されていた)は、様々な環境に対応するように構成された[コンピュータプロセッサ用の](../Page/CPU.md "wikilink")[縮小命令セットコンピューティング](../Page/RISC.md "wikilink")(RISC)[アーキテクチャのファミリーである](../Page/命令セット.md "wikilink")。[ARMホールディングス](https://ja.wikipedia.org/wiki/ARMホールディングス "wikilink")は、このアーキテクチャを開発し、他社にライセンス供与しており、他社はこのアーキテクチャを実装した製品（メモリ、インターフェース、無線などを組み込んだ[システム・オン・チップ](../Page/System-on-a-chip.md "wikilink")（SoC）やシステム・オン・モジュール（SoM）など）を設計している。また、この[命令セット](../Page/命令セット.md "wikilink")を実装する[コア設計を行い](../Page/IPコア.md "wikilink")、そのコア設計を自社製品に組み込む多くの企業にライセンス供与している。

RISCアーキテクチャを採用したプロセッサは、複雑な命令セット・コンピューティング（[CISC](../Page/CISC.md "wikilink")）アーキテクチャ（ほとんどの[パーソナルコンピュータ](../Page/パーソナルコンピュータ.md "wikilink")に搭載されている[x86](https://ja.wikipedia.org/wiki/x86 "wikilink")プロセッサなど）を採用したプロセッサに比べて、一般的に必要な[トランジスタ](../Page/トランジスタ.md "wikilink")数が少ないため、コスト、消費電力、放熱性が向上する。これらの特性は、[スマートフォン](https://ja.wikipedia.org/wiki/スマートフォン "wikilink")、[ラップトップ](../Page/ノートパソコン.md "wikilink")、[タブレット](../Page/タブレット_\(コンピュータ\).md "wikilink")、その他の[組み込みシステム](../Page/組み込みシステム.md "wikilink") \[1\]など、軽量で持ち運び可能なバッテリ駆動の機器に望ましいが、[サーバ](../Page/サーバ.md "wikilink")や[デスクトップにもある程度有用である](../Page/デスクトップパソコン.md "wikilink")。大量の電力を消費する[スーパーコンピュータ](../Page/スーパーコンピュータ.md "wikilink")では、Armも電力効率の良いソリューションである\[2\]。

[ARMホールディングス](https://ja.wikipedia.org/wiki/ARMホールディングス "wikilink")は定期的にアーキテクチャのアップデートをリリースしている。アーキテクチャのバージョンArmv3からArmv7では、[32ビット](../Page/32ビット.md "wikilink")の[アドレス空間](../Page/アドレス空間.md "wikilink")(Armv3以前のチップは、[ARMホールディングス](https://ja.wikipedia.org/wiki/ARMホールディングス "wikilink")が設立される前に作られたもので、Acorn Archimedesで使用されていたように26ビットのアドレス空間を持っていた)と32ビットの演算をサポートしており、ほとんどのアーキテクチャでは32ビットの固定長命令が使用されている。Thumbバージョンは、[コード密度を向上させるために](../Page/命令セット.md "wikilink")32ビット命令と16ビット命令の両方を提供する可変長命令セットをサポートしている。古いコアの中には、[Javaバイトコード](https://ja.wikipedia.org/wiki/Javaバイトコード "wikilink")のハードウェア実行が可能なものもあり、新しいコアには[JavaScript](../Page/JavaScript.md "wikilink")用の命令が1つある。2011年にリリースされたArmv8-Aアーキテクチャでは、新しい32ビット固定長命令セットにより、[64ビット](../Page/64ビット.md "wikilink")アドレス空間と64ビット演算のサポートが追加された\[3\]。最近のArm CPUの中には、[同時マルチスレッディング](../Page/同時マルチスレッディング.md "wikilink")(SMT)を搭載したものもあり、例えばArm Neoverse E1は2つのスレッドを同時に実行することができ、総合的なスループット性能を向上させている。車載アプリケーション向けのArm Cortex-A65AEもマルチスレッドプロセッサで、[フォールトトレラント設計のためのデュアルコアロックステップを搭載している](../Page/フォールトトレラントシステム.md "wikilink")（最高レベルのAutomotive Safety Integrity Level Dをサポートしている）。Neoverse N1は、「最小8コア」または「単一のコヒーレント・システム内で64～128個のN1コアを使用する設計」向けに設計されている\[4\]。

2019年時点で1,300億個以上のArmプロセッサが生産されており\[5\] \[6\] \[7\] \[8\]、Armは最も広く使用されている[命令セット](../Page/命令セット.md "wikilink")アーキテクチャ（ISA）であり、最も多く生産されているISAである\[9\] \[10\] \[11\] \[12\] \[13\]。現在、広く使用されているCortex[コア](../Page/IPコア.md "wikilink")、古い「クラシック」コア、特化したSecurCoreコアのバリアントは、それぞれオプション機能を含んだり除外したりすることができる。

## 歴史

ARMの設計は、[1983年](https://ja.wikipedia.org/wiki/1983年 "wikilink")に[エイコーン・コンピュータ](../Page/エイコーン・コンピュータ.md "wikilink")（イギリス）によって開始された。当時エイコーンは[モステクノロジー](../Page/モステクノロジー.md "wikilink")の[MOS 6502を搭載したコンピューターを製造](../Page/MOS_6502.md "wikilink")・販売しており、小さなハードウェア規模でシンプルな命令セットを持つ、より高速なプロセッサを開発することによって、6502を置き換えることが目的であった。
...
2005年には製品ラインナップを一新し、高機能携帯電話などのアプリケーションプロセッサ向けである**Cortex-A**、リアルタイム制御向けである**Cortex-R**、[組み込みシステム](../Page/組み込みシステム.md "wikilink")向けである**Cortex-M**と、ターゲットごとにシリーズを分類した。なお、Cortexの末尾に付く文字は、社名であるARMの一文字ずつをそれぞれ割り当てたものである\[14\]。また、2012年11月にはARM初となる64ビットアーキテクチャによるプロセッサコアである**Cortex-A50**シリーズを発表した\[15\]。
...
### ARM9/9E
  ...
  - 携帯情報端末
      - Handheld Engine CXD2230GA （SONY [CLIE](../Page/CLIE.md "wikilink")に搭載）\[17\]
  - その他
...
### ARM11/11E
  ...
  - [2007年](../Page/2007年.md "wikilink")頃から採用されるようになる。発表は[2002年](../Page/2002年.md "wikilink")[4月29日](../Page/4月29日.md "wikilink")\[18\]。
...
<!-- end list -->
  ...
  - [サムスン電子](../Page/サムスン電子.md "wikilink")は1.7GHzのデュアルコア Exynos 5250 を2012年10月\[19\]から搭載商品を販売開始。メモリ帯域12.8GB/s\[20\]。
  - テキサス・インスルメンツは2GHzのデュアルコアで2012年第3四半期から商品を出荷予定\[21\]。
...
### Cortex-A57
  ...
  - 2012年10月に[64ビット](../Page/64ビット.md "wikilink") ARMのCortex-A57, A53（コードネーム「Atlas」と「Apollo」）が発表され\[22\]、2014年に搭載商品（Samsung Galaxy Note 4 など）が販売開始された。
  - AMD は2015年下半期にサーバー向け Opteron A1100 (Seattle) をリリース予定\[23\]\[24\]。
  - A57やA53では、8コアや全てのコア同時稼働できる4+4コア（A57が4コア、A53が4コア）などが登場した。

### Cortex-A72

  - [2015年](../Page/2015年.md "wikilink")[2月3日](../Page/2月3日.md "wikilink")に発表され\[25\]、2015年に搭載商品が販売される予定\[26\]。Cortex-A57の後継製品。
...
<td><p>なし</p></td>
<td></td>
<td><p><a href="https://ja.wikipedia.org/wiki/BBC_Cheese_Wedge#ARM_Evaluation_System" title="wikilink">ARM Evaluation System</a> second processor for <a href="../Page/BBC_Micro.md" title="wikilink">BBC Micro</a></p></td>
</tr>
<tr class="even">
<td><p>ARM2</p></td>
<td><p>ARMv2</p></td>
...
<td><p><a href="../Page/Risc_PC.md" title="wikilink">Acorn Risc PC 600</a>, <a href="../Page/アップル・ニュートン.md" title="wikilink">アップル・ニュートン</a> 100シリーズ</p></td>
<td></td>
<td></td>
</tr>
<tr class="even">
...
<td><p><a href="../Page/Risc_PC.md" title="wikilink">Acorn Risc PC 700</a>, <a href="../Page/アップル・ニュートン.md" title="wikilink">アップル・ニュートン</a> eMate 300</p></td>
<td></td>
<td></td>
</tr>
<tr class="odd">
...
<td><p>0.8 DMIPS/MHz[27]<br />
最大 136 DMIPS @ 170 MHz[28] (クロックはFPGA依存)</p></td>
<td><p><a href="../Page/アルテラ.md" title="wikilink">Altera</a> Cyclone III[29], Actel FPGA[30]</p></td>
<td></td>
<td></td>
<td></td>
</tr>
...
<td><p>2.14 DMIPS/MHz[31][32]</p></td>
...
<td></td>
<td><p>0.98 DMIPS/MHz[33]</p></td>
<td><p><a href="../Page/Renesas_RAファミリ.md" title="wikilink">Renesas RAファミリ</a>, Renesas Synergy S1JA</p></td>
<td></td>
</tr>
<tr class="odd">
...
<td></td>
<td><p>L1D:64KB,メモリ管理ユニット, TrustZone, 64bit仮想アドレス</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<td><p>2.5GHZ</p></td>
<td><p><a href="https://ja.wikipedia.org/wiki/Apple_A12X" title="wikilink">Apple A12X Bionic, Apple A12Z Bionic</a></p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="odd">
<td><p>v8.3-A</p></td>
<td><p>Lightning Thunder</p></td>
<td><p>アプリケーション向け, 2+4コア, AArch64</p></td>
<td><p>L1 48KB/48KB L2 4MB</p></td>
<td><p>2.65GHz</p></td>
<td><p><a href="https://ja.wikipedia.org/wiki/Apple_A13" title="wikilink">Apple A13 Bionic</a></p></td>
<td></td>
</tr>
<tr class="even">
<td><p>Tegra K1</p></td>
...
以下に『CPUそのもの』『ボード上に実装したもの』などCPUやボードのシリーズ名やブランド名などが明確な主なメーカ名/CPU名/シリーズ名等を記する。
  ...
  - [ルネサス エレクトロニクス](https://ja.wikipedia.org/wiki/ルネサス_エレクトロニクス "wikilink")
      - [RAファミリ](https://ja.wikipedia.org/wiki/RAファミリ "wikilink")
      - RZファミリ
      - REファミリ
      - EMMA Mobile
      - R-Mobile
...
## 外部リンク
  ...
  - [Linux Zaurusでアセンブリプログラミング](https://www.mztn.org/slasm/arm_idx.html)

[Category:ARMアーキテクチャ](https://ja.wikipedia.org/wiki/Category:ARMアーキテクチャ "wikilink") [Category:マイクロプロセッサ](https://ja.wikipedia.org/wiki/Category:マイクロプロセッサ "wikilink") [Category:命令セットアーキテクチャ](https://ja.wikipedia.org/wiki/Category:命令セットアーキテクチャ "wikilink")

1.  ["Some facts about the Acorn RISC Machine"](https://groups.google.com/group/comp.arch/msg/269fe7defd51f29e) [Roger Wilson](https://ja.wikipedia.org/wiki/Sophie_Wilson "wikilink") posting to comp.arch, 2 November 1988. Retrieved 25 May 2007.
2.
3.
4.
5.
6.   The Architecture for the Digital World|accessdate=2020-04-08}}
7.
8.   The Architecture for the Digital World|accessdate=2020-04-08}}
9.
10.
11.
12.
...
14.
15.
16. [2005年](../Page/2005年.md "wikilink")、ARM社のセミナー資料による。
17.  プレスリリース{{\!}} クリエ用新アプリケーションCPU「Handheld EngineTM」の開発について|url=[https://www.sony.co.jp/SonyInfo/News/Press_Archive/200307/03-0717/|website=www.sony.co.jp|accessdate=2019-04-08](https://www.sony.co.jp/SonyInfo/News/Press_Archive/200307/03-0717/%7Cwebsite=www.sony.co.jp%7Caccessdate=2019-04-08)}}
18. [News：米速報：次世代マイクロアーキテクチャ「ARM11」発表](http://www.itmedia.co.jp/news/0204/30/b_0429_01.html)
19. [Googleが新型「Chromebook」を発表、Samsung製で249ドル](http://internet.watch.impress.co.jp/docs/news/20121019_567253.html)
20. [【PC Watch】 Samsung、初のARM Cortex-A15プロセッサ「Exynos 5250」](http://pc.watch.impress.co.jp/docs/news/20111202_495443.html)
21. [日本TI、モバイルの概念を一変させる高性能、高機能のOMAP™5プラットフォームを発表](http://newscenter.ti.com/jp/Blogs/newsroom/archive/2011/02/10/ti-omap-5.aspx)
22. [【後藤弘茂のWeekly海外ニュース】 ARMが次世代CPU「Atlas」と「Apollo」の計画を発表](http://pc.watch.impress.co.jp/docs/column/kaigai/20120214_511793.html)
23. [AMD’s K12 ARM CPU Now In 2017](http://www.anandtech.com/show/9232/amds-k12-arm-cpu-now-in-2017)
24. [苦難の2013年を越え、輝かしい2014年に賭けるAMD (大きな期待が寄せられているサーバー向け64ビットARMプロセッサ)](http://cloud.watch.impress.co.jp/docs/column/virtual/20130702_605540.html)
25. [ARM Sets New Standard for the Premium Mobile Experience - ARM](http://www.arm.com/about/newsroom/arm-sets-new-standard-for-the-premium-mobile-experience.php)
26. [Qualcomm Introduces Next Generation Snapdragon 600 and 400 Tier Processors for High Performance, High-Volume Smartphones with Advanced LTE | Qualcomm](https://www.qualcomm.com/news/releases/2015/02/18/qualcomm-introduces-next-generation-snapdragon-600-and-400-tier-processors)
27. ["ARM Cortex-M1"](http://www.arm.com/products/CPUs/ARM_Cortex-M1.html), ARM product website. Accessed April 11, 2007.
28. ["ARM Extends Cortex Family with First Processor Optimized for FPGA"](http://www.arm.com/news/17017.html), ARM press release, March 19 2007. Accessed April 11, 2007.
29. [ARM Cortex-M1](http://www.altera.co.jp/products/ip/processors/32_16bit/m-arm-cortex-m1.html)
30. [Actel: 製品とサービス: プロセッサ: ARM: Cortex-M1](http://www.actel.com/intl/japan/products/mpu/cortexm1/)
31. [AnandTech | Cortex-M7 Launches: Embedded, IoT and Wearables](http://www.anandtech.com/show/8542/cortexm7-launches-embedded-iot-and-wearables/2)
32. [Cortex-M7 Overview - ARM](https://developer.arm.com/products/processors/cortex-m/cortex-m7)
33. [Cortex-M23 Overview - ARM](https://developer.arm.com/products/processors/cortex-m/cortex-m23)
34. [Cortex-M33 Overview - ARM](https://developer.arm.com/products/processors/cortex-m/cortex-m33)
35.
36.
37. [2.14. The program status registers - Cortex-A8 Technical Reference Manual](http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.ddi0290g/I27695.html)
38. [DSP & SIMD - ARM](http://www.arm.com/ja/products/processors/technologies/dsp-simd.php)