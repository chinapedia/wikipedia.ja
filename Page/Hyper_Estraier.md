...
## 外部リンク
  ...
  - [N.M-gram : ハッシュ値付き N-gram 法による転置インデックスの実現](https://ci.nii.ac.jp/naid/110004849355) [情報処理学会](../Page/情報処理学会.md "wikilink")研究報告. DBS,データベースシステム研究会報告 140(2), 215-222, 2006-07-14 一般社団法人情報処理学会
