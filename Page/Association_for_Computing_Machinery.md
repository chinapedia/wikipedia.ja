...
ACMでは具体的な研究分野ごとに[SIG](../Page/Special_Interest_Group.md "wikilink") (Special Interest Group) と呼ぶ分科会を形成している．各SIGでは分野ごとの国際会議やワークショップの開催，論文誌の編集等を行っている．2007年現在，34のSIGが存在する．
  ...
  - [SIGAda](https://ja.wikipedia.org/wiki/SIGAda "wikilink") (Ada Programming Language)
  - [SIGAPL](https://ja.wikipedia.org/wiki/SIGAPL "wikilink") (APL Programming Language)
  - [SIGAPP](https://ja.wikipedia.org/wiki/SIGAPP "wikilink") (Applied Computing)
  - [SIGARCH](https://ja.wikipedia.org/wiki/SIGARCH "wikilink") (Computer Architecture)
  - [SIGART](https://ja.wikipedia.org/wiki/SIGART "wikilink") (Artificial Intelligence)
  - [SIGBED](https://ja.wikipedia.org/wiki/SIGBED "wikilink") (Embedded Systems)
  - [SIGCAS](https://ja.wikipedia.org/wiki/SIGCAS "wikilink") (Computers and Society)
  - [SIGCHI](https://ja.wikipedia.org/wiki/SIGCHI "wikilink") (Computer-Human Interaction)
  - [SIGCOMM](https://ja.wikipedia.org/wiki/SIGCOMM "wikilink") (Data Communication)
  - [SIGCSE](https://ja.wikipedia.org/wiki/SIGCSE "wikilink") (Computer Science Education)
  - [SIGDA](https://ja.wikipedia.org/wiki/SIGDA "wikilink") (Design Automation)
  ...
  - [SIGKDD](https://ja.wikipedia.org/wiki/SIGKDD "wikilink") (Knowledge Discovery in Data)
  - [SIGMETRICS](https://ja.wikipedia.org/wiki/SIGMETRICS "wikilink") (Measurement and Evaluation)
  - [SIGMICRO](https://ja.wikipedia.org/wiki/SIGMICRO "wikilink") (Microarchitecture)
  - [SIGMIS](https://ja.wikipedia.org/wiki/SIGMIS "wikilink") (Management Information Systems)
  - [SIGMM](https://ja.wikipedia.org/wiki/SIGMM "wikilink") (Multimedia)
  - [SIGMOBILE](https://ja.wikipedia.org/wiki/SIGMOBILE "wikilink") (Mobility of Systems, Users, Data and Computing)
  - [SIGMOD](https://ja.wikipedia.org/wiki/Special_Interest_Group_on_Management_of_Data "wikilink") (Management of Data) - 大規模[データ管理](https://ja.wikipedia.org/wiki/データ管理 "wikilink")の問題および[データベース](../Page/データベース.md "wikilink")
  - [SIGOPS](https://ja.wikipedia.org/wiki/SIGOPS "wikilink") (Operating Systems)
  - [SIGPLAN](https://ja.wikipedia.org/wiki/SIGPLAN "wikilink") (Programming Languages)
  - [SIGSAC](https://ja.wikipedia.org/wiki/SIGSAC "wikilink") (Security, Audit and Control)
  - [SIGSAM](https://ja.wikipedia.org/wiki/SIGSAM "wikilink") (Symbolic and Algebraic Manipulation)
  - [SIGSIM](https://ja.wikipedia.org/wiki/SIGSIM "wikilink") (Simulation and Modeling)
  - [SIGSOFT](https://ja.wikipedia.org/wiki/SIGSOFT "wikilink") (Software Engineering)
  - [SIGUCCS](https://ja.wikipedia.org/wiki/SIGUCCS "wikilink") (University and College Computing Services)
  - [SIGWEB](https://ja.wikipedia.org/wiki/SIGWEB "wikilink") (Hypertext, Hypermedia and Web)
...
## 外部リンク
  ...
  - [ACM portal](http://portal.acm.org/) 電子図書館
  - [ACM Special Interest Groups](http://acm.org/sigs/guide98.html)
  - [List of ACM Fellows](http://fellows.acm.org/)
  - [Making the case for an ACM Fellow](http://horning.blogspot.com/2006/10/making-case-for-acm-fellow.html)
  - [ACM Digital Library](http://portal.acm.org/dl.cfm)

[Category:Association_for_Computing_Machinery](https://ja.wikipedia.org/wiki/Category:Association_for_Computing_Machinery "wikilink") [Category:計算機科学関連の組織](https://ja.wikipedia.org/wiki/Category:計算機科学関連の組織 "wikilink") [Category:アメリカ合衆国の学会](https://ja.wikipedia.org/wiki/Category:アメリカ合衆国の学会 "wikilink") [Category:1947年設立の組織](https://ja.wikipedia.org/wiki/Category:1947年設立の組織 "wikilink")