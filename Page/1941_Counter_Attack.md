...
<!-- end list -->
  ...
  - 階級システム
    ...
    そのため、より高いスコアをあげるためには早い段階での階級昇進が必要となる。なお、一度あがった階級が下がることはない。
...
## ボスキャラクター
  ...
  - ゴータ
    ステージ6のボス。要塞の奥深くに停泊中の飛行船から発進した機体。ボス戦が開始されると飛行船は発進し、全方位に渡る機銃による攻撃を仕掛けてくる。飛行船撃破後、続けて戦う戦闘機がゴータである。変則的な動きや噴射口からの炎、そして丸い誘導弾などで攻撃してくる。
