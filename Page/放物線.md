...
[Parabola_with_focus_and_directrix.svg](https://ja.wikipedia.org/wiki/File:Parabola_with_focus_and_directrix.svg "fig:Parabola_with_focus_and_directrix.svg") [平面幾何学](https://ja.wikipedia.org/wiki/平面幾何学 "wikilink")において**放物線**（ほうぶつせん、parabola）とは、[準線](https://ja.wikipedia.org/wiki/準線 "wikilink") (directrix) と呼ばれる直線 L と、その上にない[焦点](https://ja.wikipedia.org/wiki/焦点_\(幾何学\) "wikilink") (focus) と呼ばれる一点 F が与えられるとき、準線 L と焦点 F とをともに含む唯一つの平面 π 上の点 P であって、P から焦点 F への距離 PF と等しい距離 PQ を持つような準線 L 上の点 Q が存在するようなものの軌跡として定義される平面[曲線](https://ja.wikipedia.org/wiki/曲線 "wikilink")である。
...
[ConicSection_parabola.PNG](https://ja.wikipedia.org/wiki/File:ConicSection_parabola.PNG "fig:ConicSection_parabola.PNG")
  ...
  - [円錐](https://ja.wikipedia.org/wiki/円錐 "wikilink")面を母線に平行な平面で切ると、切断面は放物線になる（[円錐曲線](https://ja.wikipedia.org/wiki/円錐曲線 "wikilink")）。

{{-}}

### 二次曲線

[Square_root.svg](https://ja.wikipedia.org/wiki/File:Square_root.svg "fig:Square_root.svg") 放物線は[二次曲線の一種で](https://ja.wikipedia.org/wiki/円錐曲線 "wikilink")、[離心率](https://ja.wikipedia.org/wiki/離心率 "wikilink")は 1 である。

  - 焦点が (0, *c*)、準線が *y* = -*c* のとき、放物線の式 *x*<sup>2</sup> = 4*cy* となる。
  - 焦点が (*c*, 0)、準線が *x* = -*c* のとき、放物線の式は *y*<sup>2</sup> = 4*cx* となる。
  - [二次関数](https://ja.wikipedia.org/wiki/二次関数 "wikilink") *y* = *ax*<sup>2</sup> + *bx* + *c* （*a* は 0 ではない）が描く[グラフは放物線になる](https://ja.wikipedia.org/wiki/グラフ_\(関数\) "wikilink")。
...
[Parabola_showing_focus_and_reflective_property.png](https://ja.wikipedia.org/wiki/File:Parabola_showing_focus_and_reflective_property.png "fig:Parabola_showing_focus_and_reflective_property.png")
  ...
  - 焦点から準線に引いた垂線は、この放物線の唯一の対称軸になる。放物線とその対称軸との交点を、この放物線の頂点と呼ぶ。放物線をその対称軸の周りに回転させてできる[曲面](https://ja.wikipedia.org/wiki/曲面 "wikilink")を**回転放物面**、または単に**放物面**  と呼ぶ。

{{-}} [Parabola_reflection.svg](https://ja.wikipedia.org/wiki/File:Parabola_reflection.svg "fig:Parabola_reflection.svg")

\*: [パラボラアンテナ](https://ja.wikipedia.org/wiki/パラボラアンテナ "wikilink")の形も放物線の回転により得られる放物面である（パラボラ Parabola\[英\]=放物線）。放物面の形をした反射板は平行な光線（あるいは電波、その他の放射線）を焦点に集めるので、アンテナや[太陽炉](https://ja.wikipedia.org/wiki/太陽炉 "wikilink")に使う[凹面鏡](https://ja.wikipedia.org/wiki/凹面鏡 "wikilink")の形として利用される。発信の際にも、焦点に置いた点源の[球面波](https://ja.wikipedia.org/wiki/球面波 "wikilink")から平行な放射を得るために利用される。 {{-}}
...
ある曲線 γ が（γ 上の）ある点 P において [C<sup>2</sup>-級ならば](https://ja.wikipedia.org/wiki/滑らかな関数 "wikilink")、γ は P の十分近くである放物線（の一部）にほぼ一致する。γ が必ずしも一定の平面上にある曲線ではないとしても、P において C<sup>2</sup>-級という条件から、P の十分近くであれば一定の平面上にほぼ乗っていると考えられる。別な言い方をすれば、任意の *C*<sup>2</sup>-級曲線は各点で放物線と二次の接触を持つ。

  -
    これは、C<sup>1</sup>-級曲線が各点の近傍で[接線](https://ja.wikipedia.org/wiki/接線 "wikilink")と呼ばれる直線（線分）で近似されることの類似である。

[200px](https://ja.wikipedia.org/wiki/画像:Simpsons_method_illustration.svg "wikilink") 関数のグラフを放物線によって近似し、その関数の積分を計算する数値積分法に[シンプソンの方法がある](https://ja.wikipedia.org/wiki/シンプソンの公式 "wikilink")。このときの近似誤差は[テイラーの式の](https://ja.wikipedia.org/wiki/テイラーの定理 "wikilink")3次の剰余項を適当に評価することで測れる。被積分関数が3次までの多項式関数ならば、シンプソンの公式による数値積分は誤差無しに積分値を得ることができる。 {{-}}

## カテナリー曲線

[CatenaryAndParabola.jpg](https://ja.wikipedia.org/wiki/File:CatenaryAndParabola.jpg "fig:CatenaryAndParabola.jpg")と放物線の比較\]\] [カテナリー曲線](https://ja.wikipedia.org/wiki/カテナリー曲線 "wikilink")(懸垂線)は、見た目が放物線と似ていて混同されることがあるが、全く別物である。共通した性質として、
...
## 関連項目
  ...
  - [放物面](https://ja.wikipedia.org/wiki/放物面 "wikilink")
  - [円錐曲線](https://ja.wikipedia.org/wiki/円錐曲線 "wikilink")
  - [楕円](https://ja.wikipedia.org/wiki/楕円 "wikilink")
  - [双曲線](https://ja.wikipedia.org/wiki/双曲線 "wikilink")
