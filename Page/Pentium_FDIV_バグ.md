> この記事は[Pentium FDIV ](https://ja.wikipedia.org/wiki/Pentium_FDIV_)から翻訳されています。
...
[Pentium Pro以後のCPUでは](../Page/Pentium_Pro.md "wikilink")[マイクロコード](https://ja.wikipedia.org/wiki/マイクロコード "wikilink")を修正する手段が盛り込まれている。書き換え可能な[コントロールストア](https://ja.wikipedia.org/wiki/コントロールストア "wikilink")を持ち、[エラッタが生じた場合には](https://ja.wikipedia.org/wiki/正誤表 "wikilink")[BIOSや](https://ja.wikipedia.org/wiki/Basic_Input/Output_System "wikilink")[OSのアップデータを介してこれを回避するマイクロコードを提供する](../Page/オペレーティングシステム.md "wikilink")。これにより、CPUの交換によらずにエラッタを回避する。

## 関連項目

  - [Pentium F00F バグ](https://ja.wikipedia.org/wiki/Pentium_F00F_バグ "wikilink")
  - [ブルン定数](https://ja.wikipedia.org/wiki/ブルン定数 "wikilink") - この計算をPentiumで行わせた過程で、本稿で取り上げたFDIVのバグが発覚した。
