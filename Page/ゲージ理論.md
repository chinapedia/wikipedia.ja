...
**ゲージ理論**（ゲージりろん、）とは、[連続的な局所変換の下で](https://ja.wikipedia.org/wiki/位相群 "wikilink")[ラグランジアンが不変となるような系を扱う](https://ja.wikipedia.org/wiki/ラグランジアン_\(場の理論\) "wikilink")[場の理論](https://ja.wikipedia.org/wiki/場の理論 "wikilink")である。

## 概要

**ゲージ**（ものさし、尺度）という用語は、ラグランジアンの冗長な自由度を表している。可能なゲージを変換することを**ゲージ変換**と呼ぶ。ゲージ変換は、[リー群](https://ja.wikipedia.org/wiki/リー群 "wikilink")を形成し、理論の**対称群**あるいは**ゲージ群**と呼ばれる。リー群には[生成子の](https://ja.wikipedia.org/wiki/リー群#指数写像 "wikilink")[リー代数](https://ja.wikipedia.org/wiki/リー代数 "wikilink")が付随する。それぞれの生成子に対応して**ゲージ場**と呼ばれる[ベクトル場](https://ja.wikipedia.org/wiki/ベクトル場 "wikilink")が導入され、これにより局所変換の下でのラグランジアンの不変性（**ゲージ不変性**）が保証される。ゲージ場を[量子化](https://ja.wikipedia.org/wiki/量子化 "wikilink")して得られる粒子は**[ゲージボゾン](../Page/ゲージ粒子.md "wikilink")**と呼ばれる。[非可換なゲージ群の下でのゲージ理論は](../Page/交換関係_\(量子力学\).md "wikilink")、**非可換ゲージ理論**と呼ばれ、[ヤン＝ミルズ理論](https://ja.wikipedia.org/wiki/ヤン＝ミルズ理論 "wikilink")が代表的である。
...
任意の物理的状況の数学的記述は、通常、過度の[自由度](https://ja.wikipedia.org/wiki/自由度 "wikilink")を持っている。同一の物理状況は、多くの同値な数学的な構成によりうまく記述される。例えば、[ニュートン力学](../Page/ニュートン力学.md "wikilink")では、2つの構成が互いに[ガリレイ変換](https://ja.wikipedia.org/wiki/ガリレイ変換 "wikilink")（座標系の[慣性](../Page/慣性.md "wikilink")変換）により、同一の物理的状況を表している。これらの変換は理論の[対称性の](https://ja.wikipedia.org/wiki/対称性_\(物理学\) "wikilink")[群を形成し](https://ja.wikipedia.org/wiki/群_\(数学\) "wikilink")、物理的状況は個別の数学的構成に対応しているのではなく、この対称群により互いに関連付けられた構成のクラスに対応する。
...
項 \(\partial_\mu\) は、次元 4 のうちの各々で \(\Phi\) の[偏微分](../Page/偏微分.md "wikilink")についての[アインシュタインの縮約記法](https://ja.wikipedia.org/wiki/アインシュタインの縮約記法 "wikilink")を使っている。すると、*G* が *n* 次[直交群](https://ja.wikipedia.org/wiki/直交群 "wikilink") O(n) に属する*定数*[行列](https://ja.wikipedia.org/wiki/行列 "wikilink")であるときにはいつでも、変換
...
\[\ (\partial_\mu \Phi) \mapsto (\partial_\mu \Phi)' = G \partial_\mu \Phi\] この式は、特別なラグランジアンの**大域対称性**を特徴付け、対称群は**ゲージ群**と呼ばれる。数学用語では、**[構造群](https://ja.wikipedia.org/wiki/ファイバーバンドル#概要 "wikilink")**であり、特に(G-structure)の理論と呼ばれる。結局、[ネーターの定理](https://ja.wikipedia.org/wiki/ネーターの定理 "wikilink")は、この変換群の不変性が**カレント**
...
全てではないが、一般に、ゲージ変換は[無限小](../Page/無限小.md "wikilink")ゲージ変換により生成される。例として、[底空間が多様体からリー群への写像が非自明である写像の](https://ja.wikipedia.org/wiki/ファイバーバンドル "wikilink")[ホモトピー](https://ja.wikipedia.org/wiki/ホモトピー "wikilink")類が非自明であるような[コンパクト多様体である](../Page/コンパクト空間.md "wikilink")。例えば、(instanton)を参照。

### ヤン・ミルズ作用

ここで、**ヤン・ミルズ作用**(Yang–Mills action)は

\[\frac{1}{4g^2}\int \operatorname{Tr}[*F\wedge F]\] により与えられる。ここに \* は[ホッジ双対](https://ja.wikipedia.org/wiki/ホッジ双対 "wikilink")を表し、積分は[微分形式](https://ja.wikipedia.org/wiki/微分形式 "wikilink")を使い[微分幾何学](../Page/微分幾何学.md "wikilink")的に定義される。
...
古典理論の対称性のうちのいくつかは、量子理論では保たれないことが分かる。この現象を**[アノマリ](https://ja.wikipedia.org/wiki/量子異常 "wikilink")**と言う。知られているもの列挙すると、
  ...
  - (gauge anomaly)、全ての整合性のある物理理論でキャンセルされるべきアノマリである。[電弱理論](https://ja.wikipedia.org/wiki/電弱理論 "wikilink")では、このキャンセルは、[クォーク](https://ja.wikipedia.org/wiki/クォーク "wikilink")と[レプトンの数が等しいことを要求する](https://ja.wikipedia.org/wiki/レプトン_\(素粒子\) "wikilink")。\<\!--===Anomalies===
...
局所対称性という言葉は、特に[ヤン・ミルズ理論では局所ゲージ対称性と結び付いている](https://ja.wikipedia.org/wiki/ヤン＝ミルズ理論 "wikilink")（[標準模型](../Page/標準模型.md "wikilink")も参照）。そこでは、ラグランジアンがあるコンパクト[リー群](https://ja.wikipedia.org/wiki/リー群 "wikilink")の下に局所的に対称である。局所ゲージ対称性は[光子](../Page/光子.md "wikilink")や[グルオンのような](../Page/グルーオン.md "wikilink")[ボゾンのゲージ場を持っている](../Page/ボース粒子.md "wikilink")。**局所対称性は、常に[保存則](../Page/保存則.md "wikilink")に加えて、[力を導く](../Page/力_\(物理学\).md "wikilink")**。\[6\]

### 例

  - [一般相対論](https://ja.wikipedia.org/wiki/一般相対論 "wikilink")は[重力](../Page/重力.md "wikilink")を生成すると考えられる局所対称性を持っている（(general covariance)、[微分同相](https://ja.wikipedia.org/wiki/微分同相 "wikilink")。\[7\] [特殊相対論](https://ja.wikipedia.org/wiki/特殊相対論 "wikilink")は大域対称性しかもたない（[ローレンツ対称性](https://ja.wikipedia.org/wiki/ローレンツ変換 "wikilink")、あるいはより一般的に[ポアンカレ対称性](https://ja.wikipedia.org/wiki/ポアンカレ群 "wikilink")）。
  - [素粒子物理学](https://ja.wikipedia.org/wiki/素粒子物理学 "wikilink")では、多くの大域対称性（例：[アイソスピン](https://ja.wikipedia.org/wiki/アイソスピン "wikilink")の対称性の[SU(2)](https://ja.wikipedia.org/wiki/SU\(2\) "wikilink")）と、局所対称性（例：[弱い相互作用](https://ja.wikipedia.org/wiki/弱い相互作用 "wikilink")の[SU(2)](https://ja.wikipedia.org/wiki/SU\(2\) "wikilink")）がある。素粒子物理学の[標準模型](../Page/標準模型.md "wikilink")は[ヤン・ミルズ理論](https://ja.wikipedia.org/wiki/ヤン・ミルズ理論 "wikilink")から構成される。
  - [超重力理論](../Page/超重力理論.md "wikilink")の対称群は局所対称性であり、一方、[超対称性](https://ja.wikipedia.org/wiki/超対称性 "wikilink")は大域対称性である。
...
## 関連項目
  ...
  - [ヤン＝ミルズ理論](https://ja.wikipedia.org/wiki/ヤン＝ミルズ理論 "wikilink")（強い相互作用の理論）
