...
8.  **Bachata**
    ...
    <!-- end list -->
      -
        タイトルの「バチャータ」は[ラテンアメリカ](../Page/ラテンアメリカ.md "wikilink")の音楽形式の名前。坂本はラヴェルの「[ボレロ](https://ja.wikipedia.org/wiki/ボレロ "wikilink")」のつもりで作った。左手は同じパターンが延々と続き、右手はアドリブ的に演奏されている。曲としてはラテン的ではなく、ハーモニーがラヴェル的である。
9.  **Chanson**
      - 作曲：坂本龍一
    <!-- end list -->
      -
