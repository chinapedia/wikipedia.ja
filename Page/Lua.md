...
### ゲーム以外
  ...
  - [FlashAir](https://ja.wikipedia.org/wiki/FlashAir "wikilink") - [無線LAN](../Page/無線LAN.md "wikilink")機能を搭載した[東芝](../Page/東芝.md "wikilink")製SDHC[メモリーカード](../Page/メモリーカード.md "wikilink")\[22\]
  ...
  - osm2pgsql - [OpenStreetMap](https://ja.wikipedia.org/wiki/OpenStreetMap "wikilink")のデータを[PostGIS](https://ja.wikipedia.org/wiki/PostGIS "wikilink")に読み込むユーティリティ\[25\]
  ...
  - [ヤマハ](../Page/ヤマハ.md "wikilink")の[ルータ](https://ja.wikipedia.org/wiki/ルータ "wikilink") (RTX1200、RTX810、SRT100、NVR500、FWX120)\[27\]
  ...
  - [VOCALOID](../Page/VOCALOID.md "wikilink")3 - ユーザー側で歌唱合成用データを加工するエフェクタを自作できる\[28\]
...
21. [AutoTouch 公式ホームページ](https://autotouch.net/)
22. [FlashAir Developers - ドキュメント - APIガイド - Lua機能](https://flashair-developers.com/ja/documents/api/lua/)
23.
24.
25.
26.
27.
28. [ボーカロイドストア](http://shop.vocaloidstore.com)でAPIリファレンスを配布している。