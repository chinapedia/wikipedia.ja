...
jcode.plは『*jcode.plオリジナル*と偽らない』ことを条件に再配布並びに改造を許可している。著名な派生に[小飼弾](../Page/小飼弾.md "wikilink")開発の**Jcode.pm**（この場合の先頭**J**は大文字）がある。言語は同じくPerl。主な変更点は次に挙げる通り：
...
## 外部リンク
  ...
  - Jcode.pm 公式サイト（[ja](http://openlab.ring.gr.jp/Jcode/index-j.html)／[en](http://openlab.ring.gr.jp/Jcode/)／[CPAN](http://search.cpan.org/%7Edankogai/)）- [CPAN](../Page/CPAN.md "wikilink")内の配布サイトではEncode.pmも配布
