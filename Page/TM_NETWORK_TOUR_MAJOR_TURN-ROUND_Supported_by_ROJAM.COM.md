> この記事は[TM NETWORK TOUR MAJOR TURN-ROUND Supported by ROJAM.COM](https://ja.wikipedia.org/wiki/TM_NETWORK_TOUR_MAJOR_TURN-ROUND_Supported_by_ROJAM.COM)から翻訳されています。


**TM NETWORK TOUR MAJOR TURN-ROUND Supported by ROJAM.COM**は2000年から2001年にかけて行われた、TM NETWORKの再結成後初となるライブツアー。
...
3.  Still Love Her
4.  Major Turn-Round(1st Impression〜2nd Impression〜3rd impression)
5.  Pale Shelter
