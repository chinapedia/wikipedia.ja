...
**電磁両立性**（でんじりょうりつせい、、EMC）とは、電気・電子機器について、それらから発する[電磁妨害波がほかのどのような機器](https://ja.wikipedia.org/wiki/電波障害 "wikilink")、システムに対しても影響を与えず、またほかの機器、システムからの電磁妨害を受けても自身も満足に動作する耐性である。**電磁共存性**、**電磁的両立性**、**電磁環境両立性**または**電磁（環境）適合性**とも呼ばれる。
...
EMC対策部品メーカとしては[TDK](https://ja.wikipedia.org/wiki/TDK "wikilink")や[村田製作所](https://ja.wikipedia.org/wiki/村田製作所 "wikilink")が代表的である。 EMCを取り扱う技術書としては、[科学情報出版](https://ja.wikipedia.org/wiki/科学情報出版 "wikilink")が発行する日本国内唯一の月刊誌である[月刊EMCや](https://ja.wikipedia.org/wiki/科学情報出版 "wikilink")、EMC専門ポータルサイト[CENDなどが代表的である](https://ja.wikipedia.org/wiki/科学情報出版 "wikilink")。

## 歴史

以前は、軍用を別として、機器やシステムのメーカーはEMCに関する問題にあまり関心がなかった。しかしながら、[デジタル](../Page/デジタル.md "wikilink")機器に使用する[電源](https://ja.wikipedia.org/wiki/電源 "wikilink")[電圧](../Page/電圧.md "wikilink")の低下、[クロック](../Page/クロック.md "wikilink")速度の上昇が進むにつれ、機器の誤動作や作動しないといった問題が発生するなど、電磁妨害の問題が表面化してきた。これによって EMC も注目され始める。

多くの国はこの深刻さを増す問題を意識するようになり、各国の担当組織（アメリカ合衆国の[FCC](../Page/連邦通信委員会.md "wikilink")。ヨーロッパの、、[ETSI](https://ja.wikipedia.org/wiki/ETSI "wikilink")。イギリスの[BSI](../Page/英国規格.md "wikilink")。日本の[VCCI](https://ja.wikipedia.org/wiki/VCCI協会 "wikilink")）は機器や設備などの電磁妨害に関する基準を作成し始めた。さらにEMC規格を含めた世界的な標準規格を制定する取り組みを行っている国際組織もある。最も重要な国際機関は[国際電気標準会議](../Page/国際電気標準会議.md "wikilink")（IEC）である。IECはEMCに関するいくつかの委員会を組織している。「ネットワークを含む設備間の電磁両立性」を担当する「[TC77](https://ja.wikipedia.org/wiki/TC77 "wikilink")」、および電波障害（[CISPR](https://ja.wikipedia.org/wiki/国際無線障害特別委員会 "wikilink")）に関する国際特別委員会がそれに該当する。
