...
**時相論理**（Temporal Logic）とは、[時間](../Page/時間.md "wikilink")との関連で問題を理解し表現するための規則と表記法の体系である。時相論理では、「私は**いつも**腹ペコだ」、「私は**そのうち**腹ペコになる」、「私は何かを食べる**まで**腹ペコだろう」といった文を表現できる。[1950年代](../Page/1950年代.md "wikilink")末にが提唱した[様相論理](https://ja.wikipedia.org/wiki/様相論理 "wikilink")に基づいた時相論理を特に**時制論理**（Tense Logic）と呼ぶことがある。が重要な業績を残した。その後、そこから発展し、[アミール・プヌーリ](../Page/アミール・プヌーリ.md "wikilink")ら[計算機科学](../Page/計算機科学.md "wikilink")者や[論理学](../Page/論理学.md "wikilink")者が研究を進めた。
...
B(\(\phi\)) が[整論理式](https://ja.wikipedia.org/wiki/整論理式 "wikilink")(wff)であれば、単項作用素は全て整論理式である。B(\(\phi\)) と C(\(\phi\)) が整論理式であれば、二項作用素は全て整論理式である。
...
時相論理と密接に関連する論理として、トポロジーや場所や空間的位置を扱う[様相論理](https://ja.wikipedia.org/wiki/様相論理 "wikilink")がある\[7\]\[8\]。
...
## 関連項目
  ...
  - [様相論理](https://ja.wikipedia.org/wiki/様相論理 "wikilink")
