...
[ショートメッセージサービス](https://ja.wikipedia.org/wiki/ショートメッセージサービス "wikilink")である [Pメール](../Page/Pメール.md "wikilink") は、販売時には受信のみが可能で、京セラが配布したユーザーアプリケーションを導入することで送受信可能となる。後継規格であるライトメールには対応していない。
...
## 外部リンク
  ...
  - 「[京セラ製PHSデータ通信端末「データスコープ」が2月20日に発売](http://www.watch.impress.co.jp/pc/docs/article/970214/ds110.htm)」 [PC Watch](../Page/Impress_Watch.md "wikilink")、1997年2月14日。
