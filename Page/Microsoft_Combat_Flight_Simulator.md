...
#### 操縦できる航空機
  ...
  - [ホーカー ハリケーン Mk. I](../Page/ホーカー_ハリケーン.md "wikilink")
  - [スーパーマリン スピットファイア Mk. I](../Page/スーパーマリン_スピットファイア.md "wikilink")
  - [フォッケウルフ Fw 190A-8](../Page/フォッケウルフ_Fw190.md "wikilink")
...
[2000年](../Page/2000年.md "wikilink")[12月1日](../Page/12月1日.md "wikilink")発売。

[太平洋戦争](https://ja.wikipedia.org/wiki/太平洋戦争 "wikilink")が舞台。ベースシステムは前作Combat Flight Simulatorとは異なり次バージョンである[Microsoft Flight Simulator 2000](https://ja.wikipedia.org/wiki/Microsoft_Flight_Simulator#Flight_Simulator_2000 "wikilink")。大幅なグラフィック向上に加え、太平洋戦争当時の日米の名機が操縦できること、オリジナルのミッションが作成できること、自由度が高く航空機や兵器の追加も容易なことなどから人気を博した。現在でもファンの根強い支持を得ている。日本側の考証に[大日本帝国海軍](../Page/大日本帝国海軍.md "wikilink")の[エース・パイロット](https://ja.wikipedia.org/wiki/エース・パイロット "wikilink")である[坂井三郎](../Page/坂井三郎.md "wikilink")[中尉](../Page/中尉.md "wikilink")が起用されたことでも有名。
...
[ヨーロッパ戦線](../Page/ヨーロッパ戦線.md "wikilink")が舞台。ベースシステムは前作Combat Flight Simulator 2と同じく[Microsoft Flight Simulator 2000](https://ja.wikipedia.org/wiki/Microsoft_Flight_Simulator#Flight_Simulator_2000 "wikilink")。前2作とは開発チームが異なり、そのためか異様に重いグラフィックになってしまい、さらには前作までの航空機が追加不可能であること、操作方法が大幅に変更されたこと、多くのバグがあるのに修正が殆どなされなかったことなどから不興を買ってしまった。
...
各社より作品別に専用[アドオン](https://ja.wikipedia.org/wiki/アドオン "wikilink")ソフトが開発され、販売されている。導入することにより、操縦機種やシナリオが増える。

### Microsoft Combat Flight Simulator アドオンソフト

  - マイクロソフト コンバットフライトシミュレータ追加データ集（Microsoft）
      - ドイツ戦線シリーズ
          - 　[STUKA](../Page/Ju_87_\(航空機\).md "wikilink") - 注意：Microsoft Windows7では、動作不可。
  - Combat Pilotシリーズ（[イマジニア](../Page/イマジニア.md "wikilink")）
      - Royal Air Force2000
      - Microsoft Combat Flight Simulator 対応追加キット - 当初、下記のセット構成品は別々に販売されていた。
          - \~ヨーロッパの英雄\~
          - ゼロ戦航空隊 - 注意:[Windows XPでは](../Page/Microsoft_Windows_XP.md "wikilink") Autorun (自動実行) では[インストール](../Page/インストール.md "wikilink")出来ない問題あり（CD-ROM内の\\PCP\\Japanese\\SETUP.EXEを直接実行することによりインストール可能）。
  - 太平洋戦線シリーズ（[トワイライト・エクスプレス](https://ja.wikipedia.org/wiki/トワイライト・エクスプレス "wikilink")）
      - [太平洋戦線](https://ja.wikipedia.org/wiki/太平洋戦線 "wikilink") - 注意:Microsoft Windows XPでは、機体データを[インストール](../Page/インストール.md "wikilink")出来ない問題あり（ミッション・シナリオのインストールは可能）。
      - 太平洋戦線2 [ラバウル航空戦](../Page/ラバウル航空隊.md "wikilink")
      - 太平洋戦線3 [真珠湾攻撃](../Page/真珠湾攻撃.md "wikilink")
      - 太平洋戦線4 [ミッドウェイ海戦](https://ja.wikipedia.org/wiki/ミッドウェイ海戦 "wikilink")
      - 太平洋戦線5 [本土防空戦](../Page/日本本土空襲.md "wikilink") \~[B-29](https://ja.wikipedia.org/wiki/B-29 "wikilink")を迎撃せよ\~
  - [中国ビルマ戦線](../Page/ビルマの戦い.md "wikilink")（トワイライト・エクスプレス） - Wings Over China（Abacus）の日本語版。
  ...
  - コンバットフライトシミュレータ アドオンシリーズ（[旧ペンギンワークス（現エアロシム）](https://ja.wikipedia.org/wiki/エアロシム "wikilink")）
      ...
      - 4 アドリア海の嵐
  - [零式艦上戦闘機](https://ja.wikipedia.org/wiki/零式艦上戦闘機 "wikilink")（旧ペンギンワークス（現エアロシム））
  - [航空自衛隊](../Page/航空自衛隊.md "wikilink")（旧ペンギンワークス（現エアロシム））
  - [蒼きウル](../Page/蒼きウル.md "wikilink")（[GAINAX](../Page/ガイナックス.md "wikilink")）
...
一旦開発が止まってしまったMicrosoft Combat Flight Simulatorであるが、Microsoft Combat Flight Simulator 3の後継としてMicrosoft Combat Flight Simulator 4（CFS4）が計画されているが、まだ開発は始まっていない。マイクロソフトは、CFS4のための3Dプログラマを募集し、[2004年](../Page/2004年.md "wikilink")にはリリースする予定であったが、現在も開発者は見つからない状態である。
...
#### 英語
  ...
  - [Microsoft Combat Flight Simulator](http://www.microsoft.com/games/combatfs1/)
  - [Microsoft Combat Flight Simulator 2](http://www.microsoft.com/games/combatfs2/)
  - [Microsoft Combat Flight Simulator 3](http://www.microsoft.com/games/combatfs3/)

[Category:フライトシミュレーション](https://ja.wikipedia.org/wiki/Category:フライトシミュレーション "wikilink") [Category:マイクロソフトのゲームソフト](https://ja.wikipedia.org/wiki/Category:マイクロソフトのゲームソフト "wikilink")