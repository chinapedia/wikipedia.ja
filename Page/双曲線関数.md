...
[thumb](https://ja.wikipedia.org/wiki/ファイル:Mplwp_hyperbolic_functions.svg "wikilink") [数学](../Page/数学.md "wikilink")において、とは、[三角関数](../Page/三角関数.md "wikilink")と類似の[関数で](https://ja.wikipedia.org/wiki/関数_\(数学\) "wikilink")、標準形の[双曲線](../Page/双曲線.md "wikilink")を[媒介変数表示](https://ja.wikipedia.org/wiki/媒介変数表示 "wikilink")するときなどに現れる。
...
[指数関数](../Page/指数関数.md "wikilink")を[偶関数の部分と](https://ja.wikipedia.org/wiki/偶関数と奇関数 "wikilink")[奇関数の部分に分けた時](https://ja.wikipedia.org/wiki/偶関数と奇関数 "wikilink")、
...
[三角関数](../Page/三角関数.md "wikilink")の場合と同様に次の[加法定理](https://ja.wikipedia.org/wiki/加法定理 "wikilink")が成立する。
...
\end{align}\] したがって、 sinh *x* と cosh *x* はいずれも二階の[線型微分方程式](https://ja.wikipedia.org/wiki/線型微分方程式 "wikilink")
...
双曲線関数の[テイラー展開](../Page/テイラー展開.md "wikilink")あるいは[ローラン展開は](https://ja.wikipedia.org/wiki/ローラン級数 "wikilink")、以下の式で与えられる。ただし、*B*<sub>*n*</sub>, *E*<sub>*n*</sub> はそれぞれ[ベルヌーイ数](../Page/ベルヌーイ数.md "wikilink") (*B*<sub>2</sub> = 1/6, *B*<sub>4</sub> = −1/30, …)、[オイラー数](https://ja.wikipedia.org/wiki/オイラー数 "wikilink") (*E*<sub>0</sub> = 1, *E*<sub>2</sub> = −1, …) である。
...
双曲線関数は以下に示す[無限乗積](https://ja.wikipedia.org/wiki/無限乗積 "wikilink")に展開される。(→[証明](https://ja.wikipedia.org/wiki/三角関数の無限乗積展開 "wikilink"))
...
\end{align}\] このことから、(1−*x*<sup>2</sup>)<sup>1/2</sup> を含む[有理関数](https://ja.wikipedia.org/wiki/有理関数 "wikilink")の原始関数を求めるために *x* = sin *t* などと三角関数を用いた置換[積分](https://ja.wikipedia.org/wiki/積分 "wikilink")を考えると有用である場合が多いのと同様に、(*x*<sup>2</sup>+1)<sup>1/2</sup> を含む有理関数の積分に双曲線関数を用いた置換積分を考えることは有用であることが多い。
...
## 関連項目
  ...
  - [カテナリー曲線](https://ja.wikipedia.org/wiki/カテナリー曲線 "wikilink") - cosh
  - [シグモイド関数](https://ja.wikipedia.org/wiki/シグモイド関数 "wikilink")、[ロジスティック関数](https://ja.wikipedia.org/wiki/ロジスティック関数 "wikilink") - tanh
