...
## 概要
  ...
  - EZアプリ (Java)と比較すると、ゲーム関連の機能を早くから充実していたことなどの理由から、ゲームアプリが充実している。
      ...
      - 注2:V601NやJ-5x（J-SH53を除く）などは非対応。J-SH53、V601SH及び[V601T](https://ja.wikipedia.org/wiki/V601T "wikilink")、[V602T](https://ja.wikipedia.org/wiki/V602T "wikilink")ではアプリによっては非対応もしくは仕様変更となっている（一例:[アークザラッド](https://ja.wikipedia.org/wiki/アークザラッド "wikilink")）。
      - 注3:708SC、730SC、930SC、V8シリーズ、[SoftBank X シリーズは非対応](https://ja.wikipedia.org/wiki/SoftBank_X "wikilink")。また、702NK、702NK II、702MO、702sMO、802SCはQVGAに対応していない。
...
[SoftBank 3G](https://ja.wikipedia.org/wiki/SoftBank_3G "wikilink") は以下のAPIの一部または全部に対応。
  ...
  - [Mobile 3D Graphics API](https://ja.wikipedia.org/wiki/Mobile_3D_Graphics_API "wikilink") (JSR 184)
  - 独自拡張
...
例えば、[SoftBank 942SH](https://ja.wikipedia.org/wiki/SoftBank_942SH "wikilink") は Wireless Messaging API, Mobile 3D Graphics API, VSCL に対応しておらず、3次元グラフィックスは MEXA OPGL ([OpenGL ES](https://ja.wikipedia.org/wiki/OpenGL_ES "wikilink") 1.1）と MEXA Enhanced 3D Graphics（MascotCapsule）が利用可能\[1\]。
...
## 沿革
  ...
  - 2001年[11月28日](../Page/11月28日.md "wikilink") - 公式コンテンツプロバイダー以外の一般の開発者もアプリを開発できるようになり、[2002年](../Page/2002年.md "wikilink")[3月1日](../Page/3月1日.md "wikilink")発売の[J-SH51](https://ja.wikipedia.org/wiki/J-SH51 "wikilink")から利用可能\[3\]
  - [2003年](../Page/2003年.md "wikilink")[10月1日](../Page/10月1日.md "wikilink") - ボーダフォンになり「Vアプリ」に名称変更\[4\]
  - [2006年](https://ja.wikipedia.org/wiki/2006年 "wikilink")[10月1日](../Page/10月1日.md "wikilink") - ボーダフォンがソフトバンクモバイルに社名変更されたことから、名称が「Vアプリ」から「S\!アプリ」に変更された。
...
## 関連項目
  ...
  - [オープンアプリプレイヤー](https://ja.wikipedia.org/wiki/オープンアプリプレイヤー "wikilink")（オープンアプリ）
