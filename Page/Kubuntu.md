...
Kubuntu 8.04以前はKDE 3を搭載していた。Kubuntu 8.04 KDE 4.0 Remix\[4\]及びKubuntu 8.10以降はKDE 4を搭載している。

[2012年](../Page/2012年.md "wikilink")2月7日、[カノニカル](https://ja.wikipedia.org/wiki/カノニカル "wikilink")はKubuntuの金銭的サポートを終了し、完全にコミュニティーベースの開発になった\[5\]。 その後、[Blue SystemsがKubuntuプロジェクトの新たなスポンサーに就いた](https://ja.wikipedia.org/wiki/Blue_Systems "wikilink")\[6\]。
...
## 外部リンク
  ...
  - [Kubuntu 公式サイト](http://www.kubuntu.org/)
  - [Kubuntuguide](http://ubuntuguide.org/wiki/Kubuntuguide) - マニュアル（非公式）、ヒント、FAQ、ソフトウェアのガイドヘルプ
  - [Ubuntu Japanese Team](http://www.ubuntulinux.jp/)

[Category:Ubuntu派生ディストリビューション](https://ja.wikipedia.org/wiki/Category:Ubuntu派生ディストリビューション "wikilink") [Category:KDE](https://ja.wikipedia.org/wiki/Category:KDE "wikilink") [Category:オープンソースソフトウェア](https://ja.wikipedia.org/wiki/Category:オープンソースソフトウェア "wikilink") [Category:2005年のソフトウェア](https://ja.wikipedia.org/wiki/Category:2005年のソフトウェア "wikilink")

1.  [aKademy 2006 - Sponsors](http://conference2006.kde.org/sponsors/#kubuntu)
2.  [Frequently Asked Questions | Kubuntu](http://www.kubuntu.org/faq)
3.
4.  [Kubuntu 8.04 Released](http://www.kubuntu.org/news/8.04-release)
5.
6.