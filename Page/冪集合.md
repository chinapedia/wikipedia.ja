...
集合と呼ぶべき対象を公理的に構成的に与える[公理的集合論](../Page/公理的集合論.md "wikilink")では、集合から作った冪集合が集合と呼ばれるべきもののうちにあることを公理の一つ（[冪集合公理](https://ja.wikipedia.org/wiki/公理的集合論#ZF_公理系 "wikilink")）としてしばしば提示する。
