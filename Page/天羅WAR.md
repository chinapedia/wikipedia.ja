...
井上純弌の代表作である『天羅万象』と『テラ:ザ・ガンスリンガー』の二つの世界で起こった大戦争を描いたTRPG。著者はプロデューサーの井上純弌だが、メインライターとして[小太刀右京](../Page/小太刀右京.md "wikilink")・[三輪清宗](../Page/三輪清宗.md "wikilink")などが加わっている。

## システム

ゲームの基幹システムには『[アルシャード](../Page/アルシャード.md "wikilink")』・『[アルシャードガイア](https://ja.wikipedia.org/wiki/アルシャードガイア "wikilink")』で使用されている共通システム「[スタンダードRPGシステム](../Page/スタンダードRPGシステム.md "wikilink")」（以下、略称の「SRS」で記述）が使用されており、[キャラクターメイキングや](https://ja.wikipedia.org/wiki/キャラクター作成_\(RPG\) "wikilink")[行為判定](../Page/行為判定.md "wikilink")はこれに準ずる。
...
『天羅万象』シリーズの特徴である[ロールプレイ支援システム](../Page/ロールプレイ支援システム.md "wikilink")「業システム」もSRS準拠に改造の上、実装されている。
...
『テラ・ザ・ガンスリンガー』シリーズの特徴である[ヒーローポイント](../Page/ヒーローポイント.md "wikilink")「カラミティ」もSRS準拠に改造の上、実装されている。（ただしカラミティは[サプリメント](https://ja.wikipedia.org/wiki/サプリメント_\(TRPG\) "wikilink")『ロストヘブン』に収録されている選択ルールである）

カラミティとはプレイヤーキャラクターを強制的に騒動に巻き込むためのルールである。カラミティはゲーム中はトランプのジョーカーとして表現される。カラミティとして使用されるジョーカーは合気とは別のものとして[GMが管理し](../Page/ゲームマスター.md "wikilink")、GMは好きなタイミングでカラミティをプレイヤーに与えることができる。
...
ただし、これらのテクノロジーの多くは現在では[ブラックボックス](../Page/ブラックボックス.md "wikilink")となっており、オーバーテクノロジーを模倣しているに過ぎない。応用が効かないことも多く、戦争や輸送など限定的なことに特化した技術になっている。そのため、人々の日常生活における超技術の恩恵は少ない。それが10th-TERRAでの文化レベルと技術レベルの大きな乖離を生み出している。世界の文明レベルそのものは移民初期よりも大きく後退しているといって差し支えない、なお、天羅の神宮家やテラの貴族など、ロストテクノロジーを高いレベルで解明している勢力も存在する。
...
天羅とテラ、それぞれの文化的背景を持った60以上のキャラクタークラスが存在している。武術の流派についても、キャラクタークラスによって表されている。また、クラスの特技とは別に、経験点を消費して誰でも取得できる一般特技も存在する。
  ...
  - 基本ルールブック掲載クラス
      ...
      - サモナー - 「ソロモンの鍵」という奥義書で、[七十二柱の魔神を使役するテラの魔術師](../Page/ゴエティア.md "wikilink")。
      - サルーンガール - 荒くれ男の心を慰める酌婦、娼妓。仲間を支援・回復するクラスである。
      - シャーマン - 精霊と心を通わせるオウガの精霊使い。
      - スチームメイジ - エーテル物理学とも呼ばれる蒸気魔術をあやつるテラの魔術師。「[差分機関](../Page/階差機関.md "wikilink")」を魔術に用いる。
      - 忍者 - 陰陽道を応用した忍術を用いる諜報者で、人を完全なる「道具」として育てあげた超人的存在。
      - 武芸者 - 武芸を身に付け、みずからをひたすら鍛え上げた殺人芸術の継承者。
      - プリーチャー - テラで広く信仰されている一神教の聖職者。[ミサ曲](../Page/ミサ曲.md "wikilink")や[聖書](../Page/聖書.md "wikilink")などを元ネタにした特技を使用する。
  ...
  - サプリメント「ロストヘブン」掲載クラス
      ...
      - ドラグーン - [龍騎兵と呼ばれる銃装騎兵](https://ja.wikipedia.org/wiki/ドラグーン "wikilink")。騎乗攻撃を得意とする。[カウボーイ](../Page/カウボーイ.md "wikilink")なども含まれる。
  ...
  - サプリメント「クロッシングポイント」掲載クラス
      ...
      - 流派：スナイピング - 精神修練・身体能力・知識を高度に複合した[狙撃兵](https://ja.wikipedia.org/wiki/狙撃兵 "wikilink")の能力を表すクラス。[ゲーマーズ・フィールド](../Page/ゲーマーズ・フィールド.md "wikilink")別冊『特集SRS'09』での初出時は流派：スナイパーと表記。
...
『天羅WAR』のキャラクターをモチーフにした[アクションフィギュア](../Page/アクションフィギュア.md "wikilink")が[トイ・インターナショナル](https://ja.wikipedia.org/wiki/トイ・インターナショナル "wikilink")から発売されている。これはTRPG『天羅WAR』が発売されるよりも一年以上も前に発売されたもので、ロケットレンジャーとオートマータが立体化されている（それぞれに二つのバリエーションがある）。
