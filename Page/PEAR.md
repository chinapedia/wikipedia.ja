...
**PEAR** (**PHP Extension and Application Repository**) は[PHPで利用する事ができるライブラリ](../Page/PHP_\(プログラミング言語\).md "wikilink")（パッケージ）を提供しているサービス。 PEARは[PHPで書かれたライブラリを提供しているが](../Page/PHP_\(プログラミング言語\).md "wikilink")、C言語で書かれた拡張ライブラリ (extension) を提供する[PECL](../Page/PECL.md "wikilink")というサービスも存在する。
