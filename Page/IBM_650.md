...
[280px](https://ja.wikipedia.org/wiki/ファイル:IBM_650_at_Texas_A&M.jpg "wikilink") [right](https://ja.wikipedia.org/wiki/ファイル:IBM-650-panel.jpg "wikilink") [280px](https://ja.wikipedia.org/wiki/ファイル:IBM-650-wiring.jpg "wikilink") [280px](https://ja.wikipedia.org/wiki/ファイル:IBM_650_EMMA.jpg "wikilink")（右）、入出力装置（中央）、パンチカードソータ（左）。（[オスロ](https://ja.wikipedia.org/wiki/オスロ "wikilink")、[ノルウェー科学技術博物館](https://ja.wikipedia.org/wiki/ノルウェー科学技術博物館 "wikilink")）\]\] [thumb](https://ja.wikipedia.org/wiki/ファイル:RoehreIBM_090325.jpg "wikilink") [thumb](https://ja.wikipedia.org/wiki/ファイル:BronxScienceProgrammingClassroom1960.jpg "wikilink") での1960年の教室。IBM 650 の命令コード表が黒板の右上にある。\]\] **IBM 650**（アイビーエムろくごーまる）\[1\]は[IBM](../Page/IBM.md "wikilink")の最初の[コンピュータ](../Page/コンピュータ.md "wikilink")のひとつであり、世界初の[大量生産](../Page/大量生産.md "wikilink")されたコンピュータである\[2\]。[1953年](https://ja.wikipedia.org/wiki/1953年 "wikilink")に発表され、[1954年](../Page/1954年.md "wikilink")の初出荷から生産終了の[1962年](../Page/1962年.md "wikilink")までに2000システム以上が製造された。保守サポートは[1969年](https://ja.wikipedia.org/wiki/1969年 "wikilink")に終了。

## 概要

650は主に科学技術計算用とされ、[IBM](../Page/IBM.md "wikilink")の[パンチカード](https://ja.wikipedia.org/wiki/パンチカード "wikilink")機器（[タビュレーティングマシン](https://ja.wikipedia.org/wiki/タビュレーティングマシン "wikilink")の進化した [IBM 604](https://ja.wikipedia.org/wiki/:en:IBM_604 "wikilink") などの機械）のユーザーに対してまともな[コンピュータ](../Page/コンピュータ.md "wikilink")へのアップグレードパスを提供する目的で設計された\[3\]。同時期に科学技術計算用の[IBM 701と](https://ja.wikipedia.org/wiki/IBM_701 "wikilink")、[磁気テープ](../Page/磁気テープ.md "wikilink")装置を基本としたビジネス用の[IBM 702がリリースされたが](https://ja.wikipedia.org/wiki/IBM_702 "wikilink")、650が最も多く製造された。1958年までに800台が販売されたが、これは当時世界で販売されたコンピュータ全体の半分以上を占める台数である。[トーマス・J・ワトソン・ジュニア](../Page/トーマス・J・ワトソン・ジュニア.md "wikilink")はこれを「コンピュータ界の[T型フォード](https://ja.wikipedia.org/wiki/フォード・モデルT "wikilink")」と称した\[4\]。

2アドレス命令形式で、データもアドレスも[二五進法](https://ja.wikipedia.org/wiki/二五進法 "wikilink")の[二進化十進表現](../Page/二進化十進表現.md "wikilink")である\[5\]。メモリは[磁気ドラムメモリ](https://ja.wikipedia.org/wiki/磁気ドラムメモリ "wikilink")である。比較的安価でプログラミングも単純であるため、潜水艦乗組員の能力のモデリング\[6\]から高校でのプログラミング教育まで、様々な用途がここから生まれた。
...
1960年に発表された [IBM 7070](https://ja.wikipedia.org/wiki/IBM_7070 "wikilink") は「トランジスタ化した IBM 650」としてアップグレードパスを提供するよう設計されている。1959年に登場した [IBM 1620](https://ja.wikipedia.org/wiki/IBM_1620 "wikilink") は科学技術計算分野のローエンド用である。どちらも十進方式だが、命令セットの互換性はない。

## 命令セット

IBM 650 の命令は、2桁の命令コード、4桁のデータアドレス、4桁の次命令アドレスで構成される。符号は無視される。[アキュムレータは](https://ja.wikipedia.org/wiki/アキュムレータ_\(コンピュータ\) "wikilink")20桁で、上半分の10桁と下半分の10桁ずつ別に扱われることが多い。符号は全体で1つである。磁気ドラムからデータを読み込むとディストリビュータという一種のレジスタに格納される。実行中命令はプログラムレジスタに保持される。算術演算は1桁相当の加算器を使って行う。浮動小数点演算機構や磁気コアメモリ、インデックスレジスタ、入出力装置を追加すると、命令も追加される。基本モデルには42種類の命令がある。あらゆるオプションを追加すると、全部で97命令となる\[18\]。
