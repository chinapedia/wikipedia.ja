...
[thumb](https://ja.wikipedia.org/wiki/ファイル:Creative_Nomad_MP3_Player.JPG "wikilink")

  - NOMAD
      -
        1999年6月発売。価格は34,800円。
        MP3の再生、FMラジオ、ボイスレコーダ機能を有する。
        接続は[パラレルポート](../Page/パラレルポート.md "wikilink")経由で行う。
        容量は内蔵メモリ32MBと外部メモリとして[スマートメディア](../Page/スマートメディア.md "wikilink")が32MBまで対応している。
        バッテリーは単4電池2本で8時間駆動。

[thumb](https://ja.wikipedia.org/wiki/ファイル:Nomad2.jpg "wikilink")

  - NOMAD II Sports
      -
        2000年2月発売。価格は、26,800円(32MBスマートメディア付属モデル)、38,800円(64MBスマートメディア付属モデル)。
        新たに[WMAの再生やSDMIに対応した](../Page/Windows_Media_Audio.md "wikilink")。
        接続は[USB経由で行うようになった](../Page/ユニバーサル・シリアル・バス.md "wikilink")。
  - NOMAD II MG
      -
...
<!-- end list -->
  ...
  - Digital MP3 Player
      -
        ...
        内蔵メモリ32MBに外部メディアは[MMCが最大](../Page/マルチメディアカード.md "wikilink")64MBまで対応する。
...
<!-- end list -->
  ...
  - Digital MP3 Player LX100 / LX200 / MX100 / MX200
      -
        ...
        LXとMXの違いは[MAC OSに対応しているかどうかの差で](https://ja.wikipedia.org/wiki/MAC_OS "wikilink")、MXはMAC OSに対応している。
        MP3とWMAの再生に対応しており、ADPCM形式でのボイスレコーダ機能も有している。

### MuVoシリーズ

フラッシュメモリモデルおよびマイクロドライブのモデルを有するブランドで、USBマスストレージ対応でエクスプローラから直接曲を転送できるのが特徴である。後に[MuVoシリーズとして独立](https://ja.wikipedia.org/wiki/Creative_MuVo "wikilink")。
...
[thumb](https://ja.wikipedia.org/wiki/ファイル:Nomad.jpg "wikilink") HDDを搭載したシリーズで、[ZENに引き継がれた](../Page/Creative_Zen.md "wikilink")。音楽ファイル転送時には基本的に専用のソフトが必要なのが特徴である。
...
[thumb](https://ja.wikipedia.org/wiki/ファイル:ZenXtra.jpg "wikilink")

  - NOMAD Jukebox ZEN Xtra
      -
        2003年10月発売。
        NOMADシリーズで唯一[MTPに対応するプレイヤー](https://ja.wikipedia.org/wiki/メディア転送プロトコル "wikilink")。
        容量は60GBで液晶画面が従来モデルの1.5倍大きくなった。

## マイクロドライブの問題点

マイクロドライブの発売当時、需要が限定的なため高価だった。対して本製品のマイクロドライブ搭載モデルは、マイクロドライブ単体よりも安価に入手できたため、筐体から取り外すために購入するという行為が問題視された。特にMuVo<sup>2</sup>の4GBモデルが発売された当時には、マイクロドライブを取り外した後の外装部分が大量に[オークション](https://ja.wikipedia.org/wiki/オークション "wikilink")に出回る事になった。

これはマイクロドライブを[デジタルカメラ](../Page/デジタルカメラ.md "wikilink")等で使用するのが目的だったため、バッテリーケース内にある1つのネジの真上に「製品の開封防止ステッカー」という小さい円形のステッカーを貼る対策が施された。分解を行うためには、このステッカーを剥がしてドライバーでネジを回す必要があり、これを行うと一切のメーカーサポートが受けられなくなるという契約が込められた。しかし最初からオーディオとしての利用目的ではなく、デジタルカメラへの流用目的で購入した者は気にすることなく、このステッカーを剥がして分解して取り出していた。このことを菓子の廃棄が社会問題化した[1970年代](../Page/1970年代.md "wikilink")前半の[仮面ライダースナック](../Page/仮面ライダースナック.md "wikilink")や[1980年代](../Page/1980年代.md "wikilink")後半から[1990年代](../Page/1990年代.md "wikilink")前半までの[ビックリマンチョコ](https://ja.wikipedia.org/wiki/ビックリマン#ビックリマンチョコと社会問題 "wikilink")、果ては[2010年代](../Page/2010年代.md "wikilink")の[AKB商法になぞらえる向きもあった](https://ja.wikipedia.org/wiki/AKB48#商品のバリエーション展開 "wikilink")。

後期ロットでは、デジタルカメラでは使用できないタイプのドライブが搭載されるようになった。

## 外部リンク

  - [クリエイティブジャパン](http://jp.creative.com/)
