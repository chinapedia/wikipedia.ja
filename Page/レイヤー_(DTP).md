...
**レイヤー** (*Layer*) とは、[グラフィックソフトウェア](../Page/グラフィックソフトウェア.md "wikilink")などに搭載されている、[画像](../Page/画像.md "wikilink")を[セル画](https://ja.wikipedia.org/wiki/セル画 "wikilink")のように重ねて使うことができる機能のことである。**レイヤ**とも呼ばれる。日本語では層、重ね合わせの意味である。[Adobe Photoshopや](../Page/Adobe_Photoshop.md "wikilink")[Painter](https://ja.wikipedia.org/wiki/Painter "wikilink")などの商用ソフトだけではなく、フリーのグラフィックソフトウェア（[GIMP](../Page/GIMP.md "wikilink")など）にも搭載されているものがある。
...
[ラスタイメージのラスタマスクと](https://ja.wikipedia.org/wiki/ビットマップ画像 "wikilink")[ベクタイメージのベクタマスクがあり](https://ja.wikipedia.org/wiki/ベクタ形式 "wikilink")、ソフトによっては共に備える。
...
基本的な描画モードには以下のようなものがある。名称はソフトによって異なるものもあるが、[Photoshop日本語版と英語版の名称を最初に記した](../Page/Adobe_Photoshop.md "wikilink")。数式は[C言語](../Page/C言語.md "wikilink")風[擬似コード](https://ja.wikipedia.org/wiki/擬似コード "wikilink")で、x が元画像の、y が合成するレイヤーの、[RGB](../Page/RGB.md "wikilink")（など）それぞれの値を表す。

| 名称        | 数式                                                                                                                                        | 用途例                                                   |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| 通常 ()、標準  | y                                                                                                                                         | 普通の重ね合わせ。                                             |
| 乗算 ()     | x\*y                                                                                                                                      | [影](https://ja.wikipedia.org/wiki/影 "wikilink")の合成。   |
| スクリーン ()  | 1-((1-x)\*(1-y))                                                                                                                          | [ハイライトの合成](../Page/鏡面ハイライト.md "wikilink")。            |
| オーバーレイ () | x\<.5 [?](https://ja.wikipedia.org/wiki/条件演算子 "wikilink") 2\*x\*y [:](https://ja.wikipedia.org/wiki/条件演算子 "wikilink") 1-2\*((1-x)\*(1-y)) | [模様](https://ja.wikipedia.org/wiki/模様 "wikilink")の合成。 |
...
## レイヤー機能があるフリーのグラフィックソフトウェア
  ...
  - [Pixia](https://ja.wikipedia.org/wiki/Pixia "wikilink") - Windows用。
