...
**POBox**(「ピーオーボックス」あるいは「ポボックス」、*Predictive Operation Based On eXample*)は、[ユーザインタフェース](../Page/ユーザインタフェース.md "wikilink")の[研究者](https://ja.wikipedia.org/wiki/研究者 "wikilink")で、元[ソニー](../Page/ソニー.md "wikilink")コンピュータサイエンス研究所研究員の[増井俊之](https://ja.wikipedia.org/wiki/増井俊之 "wikilink")が考案・開発した、文章入力補助機能の[ソフトウェア](../Page/ソフトウェア.md "wikilink")である。
...
使い込むほどにユーザの癖を[学習](../Page/学習.md "wikilink")し、極端な場合、1文字入力とカーソル操作で希望する文章の入力が完了する。PDAや携帯電話といった、入力デバイス（[キーボード](https://ja.wikipedia.org/wiki/キーボード_\(コンピュータ\) "wikilink")）空間が制約される環境で真価を発揮する。
...
POBox自体は既述の通り予測変換エンジンだが、[Wnn](https://ja.wikipedia.org/wiki/Wnn "wikilink")シリーズ([オムロン](https://ja.wikipedia.org/wiki/オムロン "wikilink"))との組み合わせで[ソニー](../Page/ソニー.md "wikilink")、[ソニーモバイルコミュニケーションズ](https://ja.wikipedia.org/wiki/ソニーモバイルコミュニケーションズ "wikilink")(旧ソニー・エリクソン・モバイルコミュニケーションズ)製の日本国内向け携帯電話端末に標準で採用され、実質的に[日本語入力システム](../Page/日本語入力システム.md "wikilink")の一種として扱われることもある。ただし初期はWnnの辞書のみを採用し、その後に基幹部分も含め採用された。バージョンもミニWnn、モバイルWnn、AdvancedWnnなどを経てW64Sを含む2009年以降の機種にはiWnnとの組み合わせで搭載されている。カタログなどにもPOBoxの搭載が強調されて掲載される場合もある。
...
一時期は[ジョグダイヤル](https://ja.wikipedia.org/wiki/ジョグダイヤル "wikilink")との組み合わせで「スピードメーラー」などの呼称で搭載されていたが、携帯電話のプラットフォームやユーザインタフェイス共通化のため([KCP](https://ja.wikipedia.org/wiki/KCP "wikilink")および[KCP+](https://ja.wikipedia.org/wiki/KCP+ "wikilink")を参照のこと)ジョグダイヤルは搭載されることはなくなった。
  ...
  - POBox
    以下のようなマイナーバージョンアップが行われたが、名称自体にバージョン名などは付加されなかった。
      -
        ...
        [SO506iS](https://ja.wikipedia.org/wiki/SO506iS "wikilink")・[W21S](https://ja.wikipedia.org/wiki/W21S "wikilink")以降 - モードレス（ひらがな入力時に英数字やカタカナをそのまま変換できる）への対応、単漢字候補が埋もれやすい欠点への対策など入力環境の改善\[6\]。
  - POBox Pro
    搭載機種：[SO705i](https://ja.wikipedia.org/wiki/SO705i "wikilink") / [W43S](https://ja.wikipedia.org/wiki/W43S "wikilink") / [W44S](https://ja.wikipedia.org/wiki/W44S "wikilink") / [W51S](../Page/W51S.md "wikilink") / [ウォークマンケータイ W52S](https://ja.wikipedia.org/wiki/W52S "wikilink") / [W53S](https://ja.wikipedia.org/wiki/W53S "wikilink")
    予測変換ウィンドウにおけるタブの採用など使い勝手が向上した。さらに入力詳細設定で文字入力時の細かい設定ができるようになった。
  - POBox Pro 2.0
    搭載機種：[SO905i](https://ja.wikipedia.org/wiki/SO905i "wikilink") / [Cyber-shotケータイ SO905iCS](https://ja.wikipedia.org/wiki/SO905iCS "wikilink") / [W54S](https://ja.wikipedia.org/wiki/W54S "wikilink") / [Cyber-shotケータイ W61S](https://ja.wikipedia.org/wiki/W61S "wikilink")
    POBox Proより学習機能・予測機能を強化。新たに文字入力後に接続語を予測する「つながり候補」機能が追加された。[2タッチ入力](https://ja.wikipedia.org/wiki/2タッチ入力 "wikilink")（ポケベル打ち）にも対応した。
  - POBox Pro E
    搭載機種：[W62S](https://ja.wikipedia.org/wiki/W62S "wikilink")
    POBox Pro 2.0をベースに、英語の予測変換に対応している。
  - POBox Pro 3.0
    搭載機種：[SO906i](https://ja.wikipedia.org/wiki/SO906i "wikilink") / [フルチェンケータイ re](https://ja.wikipedia.org/wiki/フルチェンケータイ_re "wikilink")(W63S) / [Walkman Phone, Xmini](https://ja.wikipedia.org/wiki/Xmini "wikilink")(W65S)
    POBox Pro 2.0からさらに学習機能・予測機能が進化している。新機能として\[7\]複合語入力に対応した「つなげて学習」、話し言葉を学習、候補に表示する「しゃべり語学習」が追加されている。キーを押し続けることで同じ文字を連続入力できる「つづけて入力」（通称「[ジョジョ打ち](https://ja.wikipedia.org/wiki/ジョジョの奇妙な冒険 "wikilink")」\[8\]\[9\]）、デコレーションメールの色付き文字を学習する「カラフルPOBox」を搭載している。
  - POBox Pro 3.0E
...
[Android](https://ja.wikipedia.org/wiki/Android "wikilink")搭載[スマートフォン](https://ja.wikipedia.org/wiki/スマートフォン "wikilink")・[タブレット向けバージョンで](https://ja.wikipedia.org/wiki/タブレット_\(コンピュータ\) "wikilink")、ソフトウェアキーを用いたタッチパネルでの日本語や記号入力に最適化した、ダイナミック表示を行うQWERTYキーなどのUIが特徴となっている。自作ダウンロード辞書には対応していない。主に[ソニーモバイル](https://ja.wikipedia.org/wiki/ソニーモバイルコミュニケーションズ "wikilink")(旧ソニー・エリクソン)製スマートフォン・タブレット端末、ソニー製タブレット端末に搭載される。
...
### 家電製品
  ...
  - ソニー DCR-IP55([カムコーダ](https://ja.wikipedia.org/wiki/カムコーダ "wikilink"))
  - ソニー DPP-EX50([プリンター](https://ja.wikipedia.org/wiki/プリンター "wikilink"))

## 関連項目

  - [iPhone](https://ja.wikipedia.org/wiki/iPhone "wikilink") - POBoxの開発経験を買われ[2006年](https://ja.wikipedia.org/wiki/2006年 "wikilink")に米[アップルに入社した増井らの手によって](../Page/アップル_\(企業\).md "wikilink")、[日本語入力システム](../Page/日本語入力システム.md "wikilink")の開発が行われた。
