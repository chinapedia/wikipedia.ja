...
コピー対策の一つとして[ドングル](https://ja.wikipedia.org/wiki/ドングル "wikilink")が採用されている。大型で設置に時間がかかるゲームの場合、筐体部分を稼働開始日より早くゲームセンターに到着するように発送し、ドングルのみを稼働開始日に到着するように発送するという手法が取られている。
...
### 主な互換アーキテクチャ
  ...
  - [ファミリーコンピュータ](https://ja.wikipedia.org/wiki/ファミリーコンピュータ "wikilink")
    [任天堂VS.システム](../Page/任天堂VS.システム.md "wikilink")（任天堂）
  - [セガ・マークIII](../Page/セガ・マークIII.md "wikilink")
    SYSTEM E（セガ）
  - [メガドライブ](../Page/メガドライブ.md "wikilink")
    [SYSTEM C](https://ja.wikipedia.org/wiki/セガ・システムC "wikilink")（セガ）
  ...
  - [NEO-GEO](https://ja.wikipedia.org/wiki/NEO-GEO "wikilink")
    [MVS](https://ja.wikipedia.org/wiki/Multi_Video_System "wikilink")（[SNK](../Page/SNK_\(1978年設立の企業\).md "wikilink")）\[2\]
  - [プレイステーション](https://ja.wikipedia.org/wiki/PlayStation_\(ゲーム機\) "wikilink")
    [SYSTEM10](https://ja.wikipedia.org/wiki/SYSTEM10 "wikilink") / [SYSTEM11](../Page/SYSTEM11.md "wikilink") / [SYSTEM12](../Page/SYSTEM12.md "wikilink")（ナムコ）、[ZN-1 / ZN-2](https://ja.wikipedia.org/wiki/ZN-1 "wikilink")（ソニー/ソニー・コンピュータエンタテインメント）、[GX700](https://ja.wikipedia.org/wiki/GX700 "wikilink")（コナミ）、[GV999](https://ja.wikipedia.org/wiki/GV999 "wikilink")（コナミ）、TPSシステム（テクモ）、[FXシステム / G-NETシステム](https://ja.wikipedia.org/wiki/FXシステム "wikilink")（タイトー）
  ...
  - [PlayStation 2](https://ja.wikipedia.org/wiki/PlayStation_2 "wikilink")
    [SYSTEM246 / SYSTEM256 / SYSTEMスーパー256](https://ja.wikipedia.org/wiki/SYSTEM246 "wikilink")（ソニー・コンピュータエンタテインメント/ナムコ）、近年のコナミ製品（『[ポップンミュージック](https://ja.wikipedia.org/wiki/ポップンミュージック "wikilink")』シリーズ、『[ダンスダンスレボリューション](https://ja.wikipedia.org/wiki/Dance_Dance_Revolution "wikilink")』など）で採用。 ※コナミは一部作品でPS2互換基板ではなく業務用に改造したPS2そのものを採用していた。
  - [ドリームキャスト](../Page/ドリームキャスト.md "wikilink")
    [NAOMI / NAOMI2 / SYSTEMSP](https://ja.wikipedia.org/wiki/NAOMI "wikilink")（セガ）、[ATOMISWAVE](https://ja.wikipedia.org/wiki/ATOMISWAVE "wikilink")（サミー）
...
<!-- end list -->
  ...
  - [アルゼ](https://ja.wikipedia.org/wiki/ユニバーサルエンターテインメント "wikilink")（旧 ユニバーサル販売）
...
<!-- end list -->
  ...
  - [FXシステム / G-NETシステム](https://ja.wikipedia.org/wiki/FXシステム "wikilink")
  ...
  - [Taito Type X / Taito Type X+ / Taito Type X2 / Taito Type X Zero / Taito Type X3 / Taito Type X4](https://ja.wikipedia.org/wiki/Taito_Type_X "wikilink")
...
<!-- end list -->
  ...
  - [ZN-1 / ZN-2](https://ja.wikipedia.org/wiki/ZN-1 "wikilink")
...
<!-- end list -->
  ...
  - [Multi Video System](https://ja.wikipedia.org/wiki/Multi_Video_System "wikilink")（MVS）
...
<div style="float:left; vertical-align:top; white-space:nowrap; margin-right:1em">
  ...
  - [セガ・システム16](https://ja.wikipedia.org/wiki/セガ・システム16 "wikilink")
  ...
  - [セガ・システム32](https://ja.wikipedia.org/wiki/セガ・システム32 "wikilink")
  - [セガ・システムC / システムC2](https://ja.wikipedia.org/wiki/セガ・システムC "wikilink")（メガドライブ互換）
...
<div style="float:left; vertical-align:top; white-space:nowrap; margin-right:1em">
  ...
  - [ST-V](https://ja.wikipedia.org/wiki/ST-V "wikilink")（セガサターン互換）
  - [NAOMI / NAOMI2 / SYSTEMSP](https://ja.wikipedia.org/wiki/NAOMI "wikilink")（ドリームキャスト互換）
  - [HIKARU](../Page/SEGAHIKARU.md "wikilink")
  - [Chihiro](https://ja.wikipedia.org/wiki/Chihiro "wikilink")（XBOX互換）
...
<!-- end list -->
  ...
  - ナムコ（後の[バンダイナムコエンターテインメント](../Page/バンダイナムコエンターテインメント.md "wikilink")→[バンダイナムコアミューズメント](https://ja.wikipedia.org/wiki/バンダイナムコアミューズメント "wikilink")）

<div style="float:left; vertical-align:top; white-space:nowrap; margin-right:1em">

  - [SYSTEM 86](https://ja.wikipedia.org/wiki/SYSTEM_86 "wikilink")
  - [SYSTEM I](https://ja.wikipedia.org/wiki/SYSTEM_I "wikilink")
  - [SYSTEM II](https://ja.wikipedia.org/wiki/SYSTEM_II "wikilink")
...
<div style="float:left; vertical-align:top; white-space:nowrap; margin-right:1em">
  ...
  - [SYSTEM21 / SYSTEM21B / SYSTEM21C](https://ja.wikipedia.org/wiki/SYSTEM21 "wikilink")
  ...
  - [SYSTEM10](https://ja.wikipedia.org/wiki/SYSTEM10 "wikilink") / [SYSTEM11](../Page/SYSTEM11.md "wikilink") / [SYSTEM12](../Page/SYSTEM12.md "wikilink")
  - [SYSTEM246 / SYSTEM256 / SYSTEMスーパー256](https://ja.wikipedia.org/wiki/SYSTEM246 "wikilink")
  ...
  - [コナミ](../Page/コナミホールディングス.md "wikilink")（後の[コナミデジタルエンタテインメント](https://ja.wikipedia.org/wiki/コナミデジタルエンタテインメント "wikilink")→[コナミアミューズメント](../Page/コナミアミューズメント.md "wikilink")）
...
<div style="float:left; vertical-align:top; white-space:nowrap; margin-right:1em">
  ...
  - [GX700](https://ja.wikipedia.org/wiki/GX700 "wikilink")
  - MET
  - GVシステム（[GV999](https://ja.wikipedia.org/wiki/GV999 "wikilink")）
  - GQシステム
  - HORNET
  - [タランチュラ](https://ja.wikipedia.org/wiki/3DO_M2#タランチュラ基板（FUP0882ZAM1\) "wikilink")（[M2基板](https://ja.wikipedia.org/wiki/3DO_M2 "wikilink")）
...
<!-- end list -->
  ...
  - SSV（[セタ](https://ja.wikipedia.org/wiki/セタ_\(企業\) "wikilink")、[サミー](https://ja.wikipedia.org/wiki/サミー "wikilink")、[ビスコ](../Page/ビスコ_\(ゲーム会社\).md "wikilink")）
  - [SkoPRO](https://ja.wikipedia.org/wiki/SkoPRO "wikilink")（[AMI](https://ja.wikipedia.org/wiki/エイエムアイ "wikilink")、[サクセス](https://ja.wikipedia.org/wiki/サクセス_\(ゲーム会社\) "wikilink")、[スコーネック](https://ja.wikipedia.org/wiki/スコーネック "wikilink")）
