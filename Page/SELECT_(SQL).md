...
<!-- end list -->
  ...
  -
    行数を返すものであって、**合計値を返すものではない**。合計値を返す場合はSUMを用いる。たとえば、[正規化](https://ja.wikipedia.org/wiki/正規化 "wikilink")を行っていない販売実績（商品番号,商品名,販売日,販売個数）という表から、各商品における合計販売個数を求めようとした場合に
      -
