...
例えば[冪乗](https://ja.wikipedia.org/wiki/冪乗 "wikilink")関数 `pow(x,y) = x ** y` という関数を考えてみよう。0<sup>0</sup>、∞<sup>0</sup>、1<sup>∞</sup> といった式は極限を考えると（∞ × 0 などと同様）だが、[0の0乗](https://ja.wikipedia.org/wiki/0の0乗 "wikilink")は1と定義すべきだという意見もある。
