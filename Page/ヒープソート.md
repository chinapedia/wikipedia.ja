...
**ヒープソート** (**heap sort**) とはリストの並べ替えを[二分ヒープ](https://ja.wikipedia.org/wiki/二分ヒープ "wikilink")木を用いて行う[ソート](../Page/ソート.md "wikilink")の[アルゴリズム](../Page/アルゴリズム.md "wikilink")である\[1\]（[ヒープ領域](https://ja.wikipedia.org/wiki/ヒープ領域 "wikilink")とは無関係であることに注意する）。
...
ヒープの操作の具体的な実装については、[二分ヒープ](https://ja.wikipedia.org/wiki/二分ヒープ "wikilink")の記事を参照すること。
...
ただし以下のように、現代のコンピュータで用いられる高速化技法に適さない特徴があることにも注意する必要がある。
  ...
  - ヒープ構造はメモリへのアクセスが連続しておらず、ランダムアクセスになる。すなわち、[空間的局所性が低い](https://ja.wikipedia.org/wiki/参照の局所性 "wikilink")。
