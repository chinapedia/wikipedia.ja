...
**中間周波数**（ちゅうかんしゅうはすう、Intermediate Frequency：**IF**）とは、[送信機](https://ja.wikipedia.org/wiki/送信機 "wikilink")や[受信機](../Page/受信機.md "wikilink")の中間段階で送信信号あるいは受信信号の周波数を変換した[周波数](../Page/周波数.md "wikilink")である。

## スーパーヘテロダイン受信機

[スーパーヘテロダイン受信機](https://ja.wikipedia.org/wiki/スーパーヘテロダイン受信機 "wikilink")では、[局部発振器](https://ja.wikipedia.org/wiki/局部発振器 "wikilink")（ローカルオシレータ）と目的の信号を**[混合器](https://ja.wikipedia.org/wiki/混合器_\(ヘテロダイン\) "wikilink")**で混合し、それぞれの周波数の差の、濾波、増幅等の処理をして使用する周波数を中間周波数という。中間周波数をミキサによりさらに別の中間周波数に変換する場合があり、その場合、第1中間周波数（1st IF）、第2中間周波数（2nd IF）、…と区別して呼ばれる。
...
| 1928                                                                                      | [RCA](https://ja.wikipedia.org/wiki/RCA "wikilink")           | Radiola 60 | 180          |
| 1929                                                                                      | Remler                                                        | 29         | 130          |
