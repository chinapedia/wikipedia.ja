...
[録音再生](https://ja.wikipedia.org/wiki/録音再生 "wikilink")、保存、[伝送](https://ja.wikipedia.org/wiki/伝送 "wikilink")する過程で、[アナログ信号](https://ja.wikipedia.org/wiki/アナログ信号 "wikilink")である音声データを数値に変換（[標本化](https://ja.wikipedia.org/wiki/標本化 "wikilink")・[量子化](https://ja.wikipedia.org/wiki/量子化 "wikilink")＝[アナログ-デジタル変換](https://ja.wikipedia.org/wiki/アナログ-デジタル変換 "wikilink") ）してデジタルデータとして記録保存し、再生時に[デジタル-アナログ変換](https://ja.wikipedia.org/wiki/デジタル-アナログ変換 "wikilink") (DA変換) してアナログ信号に変換してから[スピーカー](../Page/スピーカー.md "wikilink")などによって音として再生する。これらはデジタルな[音響信号処理](https://ja.wikipedia.org/wiki/音響信号処理 "wikilink")の一種である。

デジタルオーディオにおいて使用されるデジタル信号変換方式として、[パルス符号変調](../Page/パルス符号変調.md "wikilink")（PCM、マルチビットデジタル）および[ΔΣ変調](https://ja.wikipedia.org/wiki/ΔΣ変調 "wikilink")（いわゆる1ビットデジタル）がある。
...
デジタルオーディオの**データ量**は[ビットレート](https://ja.wikipedia.org/wiki/ビットレート "wikilink")とオーディオ長で規定される。最もシンプルには[量子化ビット数](https://ja.wikipedia.org/wiki/量子化ビット数 "wikilink")、[サンプリングレート](https://ja.wikipedia.org/wiki/サンプリングレート "wikilink")、チャンネル数そしてオーディオ長の積となる。例えばステレオCD形式で74分間あるデジタルオーディオは、
...
<!-- end list -->
  ...
  - [ハードディスク・レコーダー](https://ja.wikipedia.org/wiki/ハードディスク・レコーダー "wikilink") （内蔵[HDD](https://ja.wikipedia.org/wiki/ハードディスクドライブ "wikilink")）
  - [ICレコーダー](https://ja.wikipedia.org/wiki/ICレコーダー "wikilink") （内蔵不揮発メモリ、[CF](../Page/コンパクトフラッシュ.md "wikilink")・[SDカードなど](https://ja.wikipedia.org/wiki/SDメモリーカード "wikilink")）
  - [デジタルオーディオプレーヤー](../Page/デジタルオーディオプレーヤー.md "wikilink") （内蔵不揮発メモリ、SDカードなど）
  - [PCオーディオ](https://ja.wikipedia.org/wiki/PCオーディオ "wikilink") （PC内蔵HDD・[SSD](https://ja.wikipedia.org/wiki/ソリッドステートドライブ "wikilink")、外付けHDD、[NAS](../Page/ネットワークアタッチトストレージ.md "wikilink")、CD、[メモリーカード](../Page/メモリーカード.md "wikilink")など様々な記憶媒体使用可）
  - [ネットワークオーディオ](https://ja.wikipedia.org/wiki/ネットワークオーディオ "wikilink") （内蔵HDD、外付けHDD、NASなど様々な記憶媒体使用可）
  - [スマートフォン](https://ja.wikipedia.org/wiki/スマートフォン "wikilink")、[タブレットなど](https://ja.wikipedia.org/wiki/タブレット_\(コンピュータ\) "wikilink") （内蔵不揮発メモリ、SDカードなど）
...
## 参考資料・参考リンク
  ...
  - [デジタルオーディオの基礎から応用（1）：デジタルオーディオで押さえるべき基本 ～その特徴を再確認しよう～](http://ednjapan.com/edn/articles/1204/23/news001.html)（2012年4月23日 [ITmedia](https://ja.wikipedia.org/wiki/ITmedia "wikilink")）
...
## 関連項目
  ...
  - [デジタルオーディオプレーヤー](../Page/デジタルオーディオプレーヤー.md "wikilink")（[携帯音楽プレーヤー](https://ja.wikipedia.org/wiki/携帯音楽プレーヤー "wikilink")のデジタル・オーディオに特化したもの）
  - [ICレコーダー](https://ja.wikipedia.org/wiki/ICレコーダー "wikilink")（携帯型の録音に特化した機器）
