...
[数学](../Page/数学.md "wikilink")の[群論](https://ja.wikipedia.org/wiki/群論 "wikilink")における**類関数**（るいかんすう、）は、[群上で定義される](https://ja.wikipedia.org/wiki/群_\(数学\) "wikilink")[関数であって](https://ja.wikipedia.org/wiki/関数_\(数学\) "wikilink")、共軛類上では定数となるもののことをいう。複素数値の類函数は[コンパクト群](https://ja.wikipedia.org/wiki/コンパクト群 "wikilink")の[表現論で重要である](https://ja.wikipedia.org/wiki/群の表現 "wikilink")。自乗可積分な複素数値類函数は（例えば有限離散群の[群環](../Page/群環.md "wikilink")や[位相群の群環](https://ja.wikipedia.org/wiki/位相群の群環 "wikilink")）の中心元として現れるため、**中心函数** (central function) とも呼ばれる。

が[位相群](https://ja.wikipedia.org/wiki/位相群 "wikilink")のとき、一般に類函数としては[可測あるいはさらに](https://ja.wikipedia.org/wiki/可測函数 "wikilink")[連続であるものに限って言う](https://ja.wikipedia.org/wiki/連続写像 "wikilink")。
...
で、自然に[作用する](https://ja.wikipedia.org/wiki/群作用 "wikilink")。 上の -値類函数はこの[表現の](https://ja.wikipedia.org/wiki/群の表現 "wikilink")[不動点](https://ja.wikipedia.org/wiki/不動点 "wikilink")であり、従ってその全体はベクトル空間  の[部分線型空間](https://ja.wikipedia.org/wiki/部分線型空間 "wikilink")を成す。
...
を[コンパクト群](https://ja.wikipedia.org/wiki/コンパクト群 "wikilink")として、その上の[ハール測度](https://ja.wikipedia.org/wiki/ハール測度 "wikilink")  を平行移動不変な唯一の確率測度として定義する。 は  上の自乗 -可積分函数全体の成す[ヒルベルト空間](../Page/ヒルベルト空間.md "wikilink")とすれば、この空間上に以下の二つの演算を入れることができる:
