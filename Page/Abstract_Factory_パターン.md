...
Abstract Factory パターンの[クラス図](https://ja.wikipedia.org/wiki/クラス図 "wikilink")を以下に挙げる。 [center](https://ja.wikipedia.org/wiki/ファイル:Abstract_Factory_UML_class_diagram.svg "wikilink")
...
ConcreteFactoryは、singletonオブジェクト（[Singleton パターンを参照](https://ja.wikipedia.org/wiki/Singleton_パターン "wikilink")）であることもある。
