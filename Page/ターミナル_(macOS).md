...
ターミナルを起動すると、UNIXとしてのmacOSの標準[CLI](../Page/キャラクタユーザインタフェース.md "wikilink")[シェル](../Page/シェル.md "wikilink")である[Bash](../Page/Bash.md "wikilink")が起動し、UNIXコマンドを打ち込むことができる。もちろん、UNIX用の[アプリケーションをインストールして](../Page/アプリケーションソフトウェア.md "wikilink")、実行することもできる。（ただし、UNIX用のアプリケーションを[インストール](../Page/インストール.md "wikilink")するためには、[MacPorts](https://ja.wikipedia.org/wiki/MacPorts "wikilink")や[Xcode](../Page/Xcode.md "wikilink")といった開発環境のインストールが必要となる。）
