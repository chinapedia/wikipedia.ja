...
ショット雑音の大きさは[光強度や](../Page/強度.md "wikilink")[電流](../Page/電流.md "wikilink")の[平均値](https://ja.wikipedia.org/wiki/平均値 "wikilink")に比例する。普通平均値は[信号そのものを指すが](https://ja.wikipedia.org/wiki/信号_\(電気工学\) "wikilink")、平均値が増えるとき、信号レベルは雑音レベルよりも早く増加する。したがって、多くの場合、ショット雑音は電流や光強度が小さいときにしか問題にならない。

ある時間内に検出される光子数の平均値は光源の強さから決まるが、実際に検出される数は平均値と等しい場合もあれば大きくも小さくもなる。平均値を中心とするその分布は[ポアソン分布](https://ja.wikipedia.org/wiki/ポアソン分布 "wikilink")になる。[事象](https://ja.wikipedia.org/wiki/事象 "wikilink")の数が大きくなるにつれポアソン分布は[正規分布](https://ja.wikipedia.org/wiki/正規分布 "wikilink")に近づくので、非常に多数の光子を測定すると、信号に含まれる光子雑音は正規分布に近づく。 事象の間に相関がない場合、ショット雑音は理想的な[ホワイトノイズ](../Page/ホワイトノイズ.md "wikilink")である。

ポアソン分布の性質から、光子雑音の[標準偏差](../Page/標準偏差.md "wikilink")は光子数の平均の[平方根](../Page/平方根.md "wikilink")に等しいことが示せる。したがって[SN比](https://ja.wikipedia.org/wiki/SN比 "wikilink")は次の式で表される。
...
ショット雑音は平衡状態の電流ゆらぎとは区別すべきである。後者は[電圧](../Page/電圧.md "wikilink")がなく、時間平均すると電流値がゼロである時にも発生する。そのような平衡状態の電流ゆらぎは[ジョンソン・ナイキスト・ノイズと呼ばれる](https://ja.wikipedia.org/wiki/熱雑音 "wikilink")。
...
電荷が完全に時間的に局在しているわけではないが、[時間領域](https://ja.wikipedia.org/wiki/時間領域 "wikilink")で\(q F(t)\)のような分布(\(F(t)\)の時間積分は1とする)を持つ場合には、ノイズ電流の[パワースペクトル密度](https://ja.wikipedia.org/wiki/パワースペクトル密度 "wikilink")は
...
[量子光学](../Page/量子光学.md "wikilink")においては、ショット雑音の原因は検出される光子数のゆらぎである。したがって、ここでもやはり、エネルギー（この場合、[電磁場](../Page/電磁場.md "wikilink")が持つエネルギー）が離散化されている結果として生じるものだと言える。ショット雑音は量子雑音の主体である。光子数個レベルの測定が可能な[光電子増倍管](https://ja.wikipedia.org/wiki/光電子増倍管 "wikilink")の信号にはショット雑音が現れるが、もっと強度の高い光を[フォトダイオード](../Page/フォトダイオード.md "wikilink")と時間分解能の高い[オシロスコープ](https://ja.wikipedia.org/wiki/オシロスコープ "wikilink")を用いて測定している時にも現れる。検出器の[光電流](https://ja.wikipedia.org/wiki/光電流 "wikilink")は光強度(光子の数)に比例するので、測定される電流にはこの種のゆらぎが含まれるのが普通である。

[レーザー](https://ja.wikipedia.org/wiki/レーザー "wikilink")のようなコヒーレント光源の場合には、ショット雑音は強度の平均の平方根に比例する。
