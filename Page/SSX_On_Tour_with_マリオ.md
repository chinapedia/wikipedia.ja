...
## 概要
  ...
  - 走行中にトリックを決める事によりアドレナリンメーターというゲージにポイントが溜まり、ブーストが使えるようになる。
  - 走行中に相手を殴り倒す事によって、ゲージが一気に満タンになる。
  - ゲームキューブ用の今作は、[SSX On Tourとは違い](https://ja.wikipedia.org/wiki/SSX_On_Tour "wikilink")、[任天堂](../Page/任天堂.md "wikilink")のキャラクターである[マリオ](https://ja.wikipedia.org/wiki/マリオ_\(ゲームキャラクター\) "wikilink")、[ルイージ](../Page/ルイージ_\(ゲームキャラクター\).md "wikilink")、[ピーチがキャラクターとして登場している](../Page/ピーチ_\(ゲームキャラクター\).md "wikilink")。これは「[NBAストリートV3](https://ja.wikipedia.org/wiki/NBAストリートV3 "wikilink")」のGC版でも見られる。

## 前作との相違点

  - 今作から[スキー](../Page/スキー.md "wikilink")もプレイできるようになった。
  - PS2版ではトリック時にスローモーションがかかっていたが、スピード感を損なうことから不評であったため、本作ではかからなくなった。
