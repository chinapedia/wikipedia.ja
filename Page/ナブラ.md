...
[ベクトル解析](https://ja.wikipedia.org/wiki/ベクトル解析 "wikilink")における演算子 ∇（ナブラ、）は、ベクトル[微分演算を表し](https://ja.wikipedia.org/wiki/微分作用素 "wikilink")、特に一次元の領域で定義された函数に施すとき、[微分積分学](../Page/微分積分学.md "wikilink")で定義される通常の[微分](../Page/微分.md "wikilink") *D* = d/d*x* と同じになる。多次元の領域上で定義された[場](../Page/場.md "wikilink")に施すときには、[スカラー場](https://ja.wikipedia.org/wiki/スカラー場 "wikilink")の[勾配](https://ja.wikipedia.org/wiki/勾配_\(ベクトル解析\) "wikilink") grad や、ベクトル場に対しては作用のさせ方により[回転](https://ja.wikipedia.org/wiki/回転_\(ベクトル解析\) "wikilink") curl や[発散](https://ja.wikipedia.org/wiki/発散_\(ベクトル解析\) "wikilink") div を与えたりする。

厳密に言えば、∇ は特定の[作用素](https://ja.wikipedia.org/wiki/作用素 "wikilink")を意味するのではなくて、いま挙げたような演算に対する[簡便記法と考えるべきであって](https://ja.wikipedia.org/wiki/数学の表記法 "wikilink")、これにより様々な等式が覚え易く書き易いものとなる。∇ を[偏微分](https://ja.wikipedia.org/wiki/偏微分 "wikilink")作用素を成分とするベクトルと解釈すれば、三種の演算 grad, div, curl(またはrot) は、場と ∇ とのそれぞれ[スカラー](https://ja.wikipedia.org/wiki/スカラー "wikilink")倍、[点乗積](https://ja.wikipedia.org/wiki/ドット積 "wikilink")、[交叉積を形式的に取ったものと見做すことができる](../Page/クロス積.md "wikilink")。これらの形式的な積が、必ずしも他の作用素や積と[可換であることは要求されない](../Page/交換法則.md "wikilink")。

## 定義

座標 (*x*, *y*, *z*) を持つ三次元[デカルト座標空間](https://ja.wikipedia.org/wiki/デカルト座標系 "wikilink") **R**<sup>3</sup> において ∇ は、[偏微分](https://ja.wikipedia.org/wiki/偏微分 "wikilink")作用素を項とするベクトルとして

\[\nabla
= \hat{\boldsymbol{x}} \frac{\partial}{\partial x}
+ \hat{\boldsymbol{y}} \frac{\partial}{\partial y}
+ \hat{\boldsymbol{z}} \frac{\partial}{\partial z}\] で与えられる。ただし、\(\hat{\boldsymbol{x}}, \hat{\boldsymbol{y}}, \hat{\boldsymbol{z}}\) はそれぞれ *x*, *y*, *z* 方向の[単位ベクトル](https://ja.wikipedia.org/wiki/単位ベクトル "wikilink")である。本項では三次元の場合を主に扱うけれども、これは *n*-次元[ユークリッド空間](../Page/ユークリッド空間.md "wikilink") **R**<sup>*n*</sup> に対しても一般化することができて、[直交座標系](../Page/直交座標系.md "wikilink")の座標が (*x*<sub>1</sub>, *x*<sub>2</sub>, …, *x*<sub>*n*</sub>) とすれば
...
長い数式を簡略化するために ∇ が使われることもある。このような使い方をする最も一般的に知られる例は[勾配](https://ja.wikipedia.org/wiki/勾配_\(ベクトル解析\) "wikilink")、[発散](https://ja.wikipedia.org/wiki/発散_\(ベクトル解析\) "wikilink")、[回転](https://ja.wikipedia.org/wiki/回転_\(ベクトル解析\) "wikilink")、[方向微分](https://ja.wikipedia.org/wiki/方向微分 "wikilink")、[ラプラス作用素](https://ja.wikipedia.org/wiki/ラプラス作用素 "wikilink")などであろう。

### 勾配

[スカラー場](https://ja.wikipedia.org/wiki/スカラー場 "wikilink") *f* のベクトル微分は[勾配](https://ja.wikipedia.org/wiki/勾配_\(ベクトル解析\) "wikilink")([:en:gradient](https://ja.wikipedia.org/wiki/:en:gradient "wikilink"))と呼ばれ、
...
[ベクトル場](https://ja.wikipedia.org/wiki/ベクトル場 "wikilink") \(\boldsymbol{v}(x, y, z) = v_x \hat{\boldsymbol{x}}  + v_y \hat{\boldsymbol{y}} + v_z \hat{\boldsymbol{z}}\) の[発散](https://ja.wikipedia.org/wiki/発散_\(ベクトル解析\) "wikilink")([:en:divergence](https://ja.wikipedia.org/wiki/:en:divergence "wikilink"))は
...
= \nabla \times \boldsymbol v\] で表すことができる[ベクトル場](https://ja.wikipedia.org/wiki/ベクトル場 "wikilink")である。各点における回転の値は、その点に中心を持つ小さな風車の軸周りのトルク（回転力）に比例する。
...
ラプラス作用素は現代的な[数理物理学](https://ja.wikipedia.org/wiki/数理物理学 "wikilink")に遍在しており、そのごく一部を挙げるならば[ラプラス方程式](../Page/ラプラス方程式.md "wikilink")、[ポアソン方程式](../Page/ポアソン方程式.md "wikilink")、[熱方程式](https://ja.wikipedia.org/wiki/熱方程式 "wikilink")、[波動方程式](https://ja.wikipedia.org/wiki/波動方程式 "wikilink")、[シュレーディンガー方程式](../Page/シュレーディンガー方程式.md "wikilink")などにおいて現れる。

### テンソル微分

∇をベクトル場に施して、結果が[テンソル](https://ja.wikipedia.org/wiki/テンソル "wikilink")となることもある。ベクトル場 \(\boldsymbol{v}\) の[テンソル微分](https://ja.wikipedia.org/wiki/テンソル微分 "wikilink")は9つの成分を持つ二階テンソルだが、これを[二項積](https://ja.wikipedia.org/wiki/二項積 "wikilink") ⊗ を用いて、簡単に
