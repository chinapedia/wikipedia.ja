...
**Damn Small Linux**（ダム・スモール・リナックス）は、[KNOPPIX](../Page/KNOPPIX.md "wikilink")ベースの[Live CDである](../Page/Live_CD.md "wikilink")。
...
バージョン3までは[Fluxbox](../Page/Fluxbox.md "wikilink")が使われていたが、バージョン4以降は[jwm](https://ja.wikipedia.org/wiki/jwm "wikilink")に変更になった。
