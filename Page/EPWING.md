...
**EPWING**（イーピーウィング）は、[電子辞書](https://ja.wikipedia.org/wiki/電子辞書 "wikilink")の標準形式。EPWINGのサブセット(V1相当)が[JIS X 4081](https://ja.wikipedia.org/wiki/JIS_X_4081 "wikilink")「日本語電子出版検索データ構造」として制定されている。

## 成立の経緯

[1987年](https://ja.wikipedia.org/wiki/1987年 "wikilink")（昭和62年）、[富士通](../Page/富士通.md "wikilink")[片岡正弘](https://ja.wikipedia.org/wiki/片岡正弘 "wikilink")は自社のワープロ[OASYS](../Page/OASYS.md "wikilink") 100用の[広辞苑](https://ja.wikipedia.org/wiki/広辞苑 "wikilink")CD-ROMを[岩波書店](https://ja.wikipedia.org/wiki/岩波書店 "wikilink")、[大日本印刷](https://ja.wikipedia.org/wiki/大日本印刷 "wikilink")などと共同で制作し、この仕様を「**WING**」と名づけた。

[1988年](../Page/1988年.md "wikilink")（昭和63年）に[CD-ROM](../Page/CD-ROM.md "wikilink")の論理フォーマットである[ISO 9660が制定されると](../Page/ISO_9660.md "wikilink")、各社はWINGをISO 9660上に移し、より汎用性を持たせた**EPWING**規約(**E**lectronic **P**ublishing-**WING**:*電子出版WING規格*)第1版(V1)を制定。同時に、電子出版物を共通フォーマットで推進することを目的に、それらを制作する企業で構成される[EPWINGコンソーシアム](http://www.epwing.or.jp/member/member.html) を1991年に結成した。この時に参加した企業は [岩波書店](https://ja.wikipedia.org/wiki/岩波書店 "wikilink")、[大日本印刷](https://ja.wikipedia.org/wiki/大日本印刷 "wikilink")、[凸版印刷](https://ja.wikipedia.org/wiki/凸版印刷 "wikilink")、[富士通](../Page/富士通.md "wikilink")、[ソニー](../Page/ソニー.md "wikilink") である。 [電子ブック (EB)も](https://ja.wikipedia.org/wiki/電子ブック_\(規格\) "wikilink")、WING規格をもとにして拡張されたものである。
...
EPWINGは、続々と拡張され、計6仕様とEPWING STがある([「バージョン情報」](http://www.epwing.or.jp/lineup/version.html))。EPWING STを除けば、それ以前の仕様は内包している。もちろん、新しくなるほど高機能なわけだが、古い仕様であれば、対応している検索ソフトも多い。
  ...
  - EPWING V2
    カラー画像、圧縮音声([WAV](https://ja.wikipedia.org/wiki/WAV "wikilink"))
  - EPWING V3
...
EPWINGのCD-ROMの基本構成(V1)を以下に示す。ルートディレクトリにはCATALOGSというファイルが１つあり、CD-ROMに含まれる辞書(複数の辞書・付録等)とその構成を示す。単一の辞書毎にサブディレクトリが(複数)あり、その下にDATAとGAIJIというサブディレクトリがある。DATAの下のHONMONには、本文データ(図版・音声)や検索インデックスが含まれる。GAIJIの下には、[外字](https://ja.wikipedia.org/wiki/外字 "wikilink")データ(ビットマップ)ファイルが置かれる。外字データファイルのファイル名は製品毎に異なる。
...
EPWINGの主要な検索方法は以下のとおり。ワイルドカードや正規表現は、基本的には使えない(検索ソフトによっては、ある程度対応している場合がある。([「機能紹介」](http://www.epwing.or.jp/about/function.html))。
  ...
  - カラーメニュー
    ビジュアルな画面の該当箇所を選択することで、その項目を検索できる。（例：「[広辞苑](https://ja.wikipedia.org/wiki/広辞苑 "wikilink")第5版・第6版」）

[電子ブック(規格)と違い](https://ja.wikipedia.org/wiki/電子ブック_\(規格\) "wikilink")、ワープロ専用機や汎用のコンピュータで使用することを前提にしており、読みだけでなく、漢字でも検索できる。
...
<!-- end list -->
  ...
  - 『ビジネス技術実用英語大辞典Ｖ５　英和編＆和英編』 プロジェクトポトス (英和2万2千語/和英2万5千語/用例10万9千件)
...
### 市販EPWING検索ソフトウェア
  ...
  - 電子辞典ビューア (EGBRIDGE に付属) - (株)[エルゴソフト](https://ja.wikipedia.org/wiki/エルゴソフト "wikilink")
  ...
  - [対訳君](https://ja.wikipedia.org/wiki/対訳君 "wikilink") (JammingLight搭載) - (株)MCL
  - The翻訳プロフェッショナル/スーパー - [東芝デジタルソリューションズ](https://ja.wikipedia.org/wiki/東芝デジタルソリューションズ "wikilink")(株)
  - [超漢字](https://ja.wikipedia.org/wiki/超漢字 "wikilink")統合辞書 (OS: BTRON3/超漢字４) - パーソナルメディア(株)
  - 本格翻訳5 シリーズ - [ソースネクスト](https://ja.wikipedia.org/wiki/ソースネクスト "wikilink")(株)
  - PC-Transer 翻訳スタジオ - (株)[クロスランゲージ](https://ja.wikipedia.org/wiki/クロスランゲージ "wikilink")
...
### オンラインソフトウェア (Free/Share/Paid)
  ...
  - [Pocket PC](https://ja.wikipedia.org/wiki/Pocket_PC "wikilink")/[Windows CE](https://ja.wikipedia.org/wiki/Windows_CE "wikilink") - [EBPocket](http://ebstudio.info/home/EBPocket.html) (Share/Free), Buckingham EB Player(Charityware)
  - [Zaurus](https://ja.wikipedia.org/wiki/Zaurus "wikilink")/[Linux](https://ja.wikipedia.org/wiki/Linux "wikilink") - qtjiten, Zten, zten改(ztenv), JustReader+
  - [PalmOS](https://ja.wikipedia.org/wiki/PalmOS "wikilink") - WordSeeker(Shareware), Buckingham EB Player(Charityware)
  - [HP200LX](https://ja.wikipedia.org/wiki/HP200LX "wikilink") - [EBR](http://homepage2.nifty.com/egweb/eguyan/ebr-up.htm).exm
  - [Mobile Gear](https://ja.wikipedia.org/wiki/Mobile_Gear "wikilink") - Dicmg
  - [Linux](https://ja.wikipedia.org/wiki/Linux "wikilink")/[FreeBSD](../Page/FreeBSD.md "wikilink") (with GTK) - EBView, gxdic
  - [UNIX](../Page/UNIX.md "wikilink") - eblook, Forest, [Lookup](http://sourceforge.net/projects/lookup)
  - [KDE](https://ja.wikipedia.org/wiki/KDE "wikilink") - KEBook
  - EPOC - pB
  - [BTRON](https://ja.wikipedia.org/wiki/BTRON "wikilink") - 海老 (EBI)
  ...
  - [Android](https://ja.wikipedia.org/wiki/Android "wikilink") - DroidWing (free/paid) ([aokabi.com](http://jp.androlib.com/android.developer.aokabi-com-jAmi.aspx)), [EBAndrioid](http://jp.androlib.com/android.application.com-nesnet-android-eb-AFAA.aspx) (free)(「EB4Jライブラリ」使用), [EBPocket for Android](http://ebstudio.info/manual/EBPocket_android/) (Pro/Free)

<!-- end list -->

  - [BlackBerry](https://ja.wikipedia.org/wiki/BlackBerry "wikilink") - [EBBerry](http://cloudhunter.cocolog-nifty.com/blog/ebberry.html) (「EB4Jライブラリ」使用)
...
[ロゴヴィスタ](https://ja.wikipedia.org/wiki/ロゴヴィスタ "wikilink")・[電子辞典シリーズ](http://www.logovista.co.jp/)（旧[システムソフト](https://ja.wikipedia.org/wiki/システムソフト "wikilink")電子辞典シリーズ）で採用されている辞書データの形式は、同社が[JIS X 4081形式を基本仕様として改良](https://ja.wikipedia.org/wiki/JIS_X_4081 "wikilink")・発展させていったフォーマット。最新版（[『漢字源改訂第四版』](http://www.gakken.jp/jiten/data/detail/1051203/)、2008年12月現在）では独自の拡張方式（既存の未使用の「表の表示タグ」を転用すること）により[ユニコード](https://ja.wikipedia.org/wiki/ユニコード "wikilink")（[JIS第三水準](../Page/JIS_X_0213.md "wikilink")、第四水準、[補助漢字](https://ja.wikipedia.org/wiki/補助漢字 "wikilink")）の表示にも対応した。
...
## 外部リンク
  ...
  - [EPWINGコンソーシアム](http://www.epwing.or.jp/about/about.html), [EPWINGとは？](http://web.archive.org/web/20110722120757/http://www.epwing.or.jp/about/about.html) - [Internet Archive](https://ja.wikipedia.org/wiki/Internet_Archive "wikilink")
  - [富士通 EPWING](http://software.fujitsu.com/jp/epwing/) JIS規格「日本語電子出版検索データ構造([JIS X 4081](https://ja.wikipedia.org/wiki/JIS_X_4081 "wikilink"))」準拠の電子辞書です
  ...
  - [Maximilk](http://hp.vector.co.jp/authors/VA037273/) フリーEPWING電子辞書(EDICT2, WordNet2.0, Webster's 1913, CEDICT, Wadoku, etc.) - [Vector](https://ja.wikipedia.org/wiki/ベクター_\(企業\) "wikilink")
  - [FreePWING](http://www.sra.co.jp/people/m-kasahr/freepwing/) [JIS X 4081](https://ja.wikipedia.org/wiki/JIS_X_4081 "wikilink") 形式の書籍データを生成を行うソフトウェア([Unix](https://ja.wikipedia.org/wiki/Unix "wikilink"), [Linux](https://ja.wikipedia.org/wiki/Linux "wikilink"), [Cygwin](https://ja.wikipedia.org/wiki/Cygwin "wikilink"))
  - [wikipedia-fpw](http://ikazuhiro.s206.xrea.com/staticpages/index.php/wikipedia-fpw) [ウィキペディア日本語版](https://ja.wikipedia.org/wiki/ウィキペディア日本語版 "wikilink")(や、その他の言語版)のダンプデータ（[ダウンロードサイト](http://download.wikimedia.org/jawiki/)）をFreePWINGを利用して[JIS X 4081形式に変換するツール](https://ja.wikipedia.org/wiki/JIS_X_4081 "wikilink")
  - [Boookends](http://sites.google.com/site/boookends/) 「FreePWING/Wikipedia-fpw」で変換した、オフライン版「[ウィキペディア日本語版](https://ja.wikipedia.org/wiki/ウィキペディア日本語版 "wikilink")」(EPWING/[JIS X 4081](https://ja.wikipedia.org/wiki/JIS_X_4081 "wikilink"))や、多言語版(ユニコード対応)を配布。
