...
**Hot Soup Processor**（ホットスーププロセッサー）は、[1995年](https://ja.wikipedia.org/wiki/1995年 "wikilink")から[おにたま](https://ja.wikipedia.org/wiki/おにたま "wikilink")により開発されている[プログラミングツール](https://ja.wikipedia.org/wiki/プログラミングツール "wikilink")、およびその[プログラミング言語](../Page/プログラミング言語.md "wikilink")である。略称は**HSP**。
...
HSP3.xの（ユーザーが実際に入力する）言語仕様に関する主な特徴として、以下のように挙げられる。
  ...
  - [構文の大文字](https://ja.wikipedia.org/wiki/プログラミング言語#構文 "wikilink")・小文字を区別しない。
...
HDLではhs(HDLのコマンドヘルプ)、[html](../Page/HyperText_Markup_Language.md "wikilink")、txt、hsp、as(HSPヘッダファイル)の拡張子が付いたファイルを読み込み・表示することができる\[11\]。

### Online HSP Document Library (OHDL)

[OHDL](http://ohdl.hsproom.me/)はHDLの[CGIへの移植であり](../Page/Common_Gateway_Interface.md "wikilink")、HDLのHTML出力部分を移植し、データベースはHDLにより作られたものを流用している\[12\]。

現在のバージョンは1.32、ドキュメントはHSP3.2b3を使用している\[13\]。
...
一部バージョンにおいて、[アンチウィルス製品で](../Page/アンチウイルスソフトウェア.md "wikilink")[マルウェア](../Page/マルウェア.md "wikilink")と誤認識される現象が報告されている\[14\]\[15\]。
...
12.
13.
14. [HSP ver2.61に対するウィルス誤認識について](http://www.onionsoft.net/hsp/hsp2alert.html)
15. [HSP ver3.1、ver3.2に対するウィルス誤認識について](http://www.onionsoft.net/hsp/hsp3alert.html)