...
このプロジェクトは1996年に[ロスアラモス国立研究所](../Page/ロスアラモス国立研究所.md "wikilink")のDr. M. GalassiとDr. J. Theilerの着想に始まり、[計算物理の専門家集団](../Page/計算物理学.md "wikilink")（Dr G. Jungman、Dr B. Gough、Dr J. Davies、R. Priedhorsky、Dr M. Booth、Dr F. Rossi、Dr D. Eddelbuettelら）を中心に作成された。

線形計算については[BLAS](https://ja.wikipedia.org/wiki/BLAS "wikilink")をサポートしており、CBLAS インターフェイスを実装している。

[Linux](../Page/Linux.md "wikilink")をはじめ、[Unix系](../Page/Unix系.md "wikilink")OSを中心にサポートしている。[Microsoft Visual Studio用のバイナリもある](https://ja.wikipedia.org/wiki/Microsoft_Visual_Studio "wikilink")。
...
2011年現在、年に1〜2回のメンテナンスリリースによるバグ修正対応が基本になっている。一方で[ブロックやスライスといったデータ構造の有用性や](../Page/ブロック_\(データ\).md "wikilink") C++ 対応の是非についての議論も ML 上で行われており、もし議論が収束して開発陣での合意が形成されれば将来のバージョンで反映される可能性があるが、具体的なスケジュールを考慮するような段階ではない。
...
[ベッセル関数](../Page/ベッセル関数.md "wikilink")の値を計算する C プログラムの例を以下に示す\[10\]。
...
## 提供する機能
  ...
  - [多項式の求根](../Page/零点.md "wikilink") (Roots of Polynomials)
  - [特殊関数](https://ja.wikipedia.org/wiki/特殊関数 "wikilink") (Special Functions)
  - [ベクトル](../Page/ベクトル.md "wikilink")・[行列](https://ja.wikipedia.org/wiki/行列_\(数学\) "wikilink") (Vectors and Matrices)
  ...
  - [統計計算](../Page/統計量.md "wikilink") (Statistics)
  - [ヒストグラム](../Page/ヒストグラム.md "wikilink") (Histograms)
  - [N-Tuples](../Page/タプル.md "wikilink")
  ...
  - [IEEE浮動小数点の操作](../Page/IEEE_754.md "wikilink") (IEEE Floating-Point)
