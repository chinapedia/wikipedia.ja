...
定義は、[建物](../Page/建物.md "wikilink")の使用期間中で予想される最大規模の[地震](../Page/地震.md "wikilink")（再現期間475年相当 = 50年間で10 %を超える確率）に対して予想される最大の物的損失額（90 %非超過確率という）の、再調達費に対する割合をいう。ただし、これは広く使用されている定義ではなく、今のところ、地震PMLに統一された明確な定義は無い。
...
現時点で新築すると100億円かかる[建物](../Page/建物.md "wikilink")があったと仮定すると、その[建物](../Page/建物.md "wikilink")の存在する地点に対して予想される最大規模の地震が起きたときにその建物の補修に必要な費用が最大10億円かかると予想されるときには、その[建物](../Page/建物.md "wikilink")の**地震PML**は10 %（最大損失額10億円 ÷ 100億円）となる。
...
通常は[エンジニアリングレポート](https://ja.wikipedia.org/wiki/エンジニアリングレポート "wikilink")（[建物診断](https://ja.wikipedia.org/wiki/建物診断 "wikilink")レポート）に包含される形で**地震PML**レポートが提出されることが多く、特に統一されたものはないが、下記の構成となっていることが多い。
...
## 地震PML算出専門Webサービス
  ...
  - [マザーズDD](https://ja.wikipedia.org/wiki/マザーズDD "wikilink") Due Diligence Data Bank [1](http://www.d3bank.net)

## 出典

  - [地震危険度指標に関する調査研究](http://www.nliro.or.jp/disclosure/q_kenkyu/No01_A.pdf) 損害保険料率算出機構
