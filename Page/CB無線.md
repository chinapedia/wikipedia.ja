> この記事は[CB無線](https://ja.wikipedia.org/wiki/CB無線)から翻訳されています。


**CB無線**とは、一般に、個人が個人的な用務のために行う連絡、または個人事業者や小規模事業者などがそのビジネスのために行う連絡に使用し、かつ低コストで実現できる近距離用の音声通信のための制度またはその制度に基づく無線通信システムをいう。CB無線は世界の多くの国で制度化されており、一般に、CB無線の無線システムの運用は、無線機を購入後、簡易な手続を経て、あるいは何ら手続を行うこと無く開始することができる。
...
## 概要
  ...
  - [アマチュア無線](https://ja.wikipedia.org/wiki/アマチュア無線 "wikilink")との違い
    個人が開設できる無線局によって通信を行うという点では、アマチュア無線に似ているが、アマチュア無線が「金銭上の利益のためでなく、専ら個人的に無線技術に興味を持ち、正当に許可された者が行う自己訓練、通信及び技術研究のための無線通信業務」（国際電気通信連合憲章に規定する[無線通信規則](https://ja.wikipedia.org/wiki/無線通信規則 "wikilink")1.56 アマチュア業務）であることに対して、CB無線による通信は、本来何らかの用務などを達成するために行われるものであって、無線通信に対する興味などにより行うものではない。しかし、CB無線は、一般に誰でも自由に使用できる無線通信であり、また、不特定相手との通信が可能であるため、無線通信に対する興味などからCB無線の無線局を開設する者も存在し、このような者の間ではアマチュア無線に近似した運用が行われており、CB無線の愛好者団体なども多く存在する。
...
## 参考文献
  ...
  - Australian Communications and Media Authority (ACMA) ：http://www.acma.gov.au/web/homepage//pc=home
  - Radio Spectrum Management Group(RSM), Ministry of Economic Development(MED) ： <http://www.rsm.govt.nz/index.html>
  - Office of the Telecommunications Authority (OFTA) of the Hong Kong Special Administrative Region ：http://www.ofta.gov.hk/en/
  - 総務省：www.soumu.go.jp
  - 電波法、電波法施行規則、無線設備規則、総務省告示
