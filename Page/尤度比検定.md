...
[検定統計量](https://ja.wikipedia.org/wiki/検定統計量 "wikilink")とは検定に用いる[統計量](https://ja.wikipedia.org/wiki/統計量 "wikilink")（[標本](https://ja.wikipedia.org/wiki/標本 "wikilink")データの関数）であり、その値が予め決めた[有意水準](https://ja.wikipedia.org/wiki/有意水準 "wikilink")より小さいならば[帰無仮説](https://ja.wikipedia.org/wiki/帰無仮説 "wikilink")を[棄却](https://ja.wikipedia.org/wiki/棄却 "wikilink")する検定を行う。
...
一般の場合には、尤度比 Λ とは、[帰無仮説](https://ja.wikipedia.org/wiki/帰無仮説 "wikilink")が成り立つとした条件下での[尤度関数](https://ja.wikipedia.org/wiki/尤度関数 "wikilink")の最大値を、その条件がない場合の尤度関数の最大値で割った比をいう。帰無仮説が成り立つとすると、普通の[確率分布](../Page/確率分布.md "wikilink")族に対して、 −2 log Λ が特に便利な漸近的分布となる。
...
[Z検定](https://ja.wikipedia.org/wiki/Z検定 "wikilink")\[1\]、[F検定](https://ja.wikipedia.org/wiki/F検定 "wikilink")\[2\]、[ピアソンのカイ二乗検定](https://ja.wikipedia.org/wiki/ピアソンのカイ二乗検定 "wikilink")、[G検定](../Page/G検定.md "wikilink") など多くの普通用いられる検定法は、尤度比の[対数](../Page/対数.md "wikilink")（対数尤度）を用いた検定、もしくはそれの近似とみることができる。

たとえば、帰無仮説が正しく、*n* 個の一連の[独立な同じ分布に従う](../Page/独立_\(確率論\).md "wikilink")[確率変数](https://ja.wikipedia.org/wiki/確率変数 "wikilink")を観測するものとすれば、[標本サイズ](https://ja.wikipedia.org/wiki/標本_\(統計学\) "wikilink") *n* を無限大にすれば[検定統計量](https://ja.wikipedia.org/wiki/検定統計量 "wikilink") −2 log Λ は漸近的に[カイ二乗分布](https://ja.wikipedia.org/wiki/カイ二乗分布 "wikilink")（その[自由度](https://ja.wikipedia.org/wiki/自由度 "wikilink")は Θ と Θ<sub>0</sub> の次元の差に等しい）となる。
