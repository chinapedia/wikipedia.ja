...
[マイクロソフト](../Page/マイクロソフト.md "wikilink")は、[Microsoft Foundation Class](../Page/Microsoft_Foundation_Class.md "wikilink") (MFC) と呼ばれる [Windows](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink") 向けの同様の製品を開発している。MFCは[Windows APIを薄くラップしたC](https://ja.wikipedia.org/wiki/Windows_API "wikilink")++言語専用のクラスライブラリおよびフレームワークであり、マイクロソフトは他にも[Active Template Library](https://ja.wikipedia.org/wiki/Active_Template_Library "wikilink") (ATL) や[Windows Template Library](../Page/Windows_Template_Library.md "wikilink") (WTL) といったC++の[テンプレート機能を活用したクラスライブラリ](../Page/テンプレート_\(プログラミング\).md "wikilink")・フレームワークを開発している。[.NET Framework向けのGUIフレームワークとしては](https://ja.wikipedia.org/wiki/.NET_Framework "wikilink")[Windows Forms](../Page/Windows_Forms.md "wikilink") (WinForms) や[Windows Presentation Foundation](../Page/Windows_Presentation_Foundation.md "wikilink") (WPF) が挙げられる。そのほか、[Windows 8以降のModern](https://ja.wikipedia.org/wiki/Windows_8 "wikilink") UIアプリケーション開発に対応した[Windows Runtime](https://ja.wikipedia.org/wiki/Windows_Runtime "wikilink") (WinRT) も存在する。

[wxWidgets](https://ja.wikipedia.org/wiki/wxWidgets "wikilink")やのような[ウィジェット・ツールキット](https://ja.wikipedia.org/wiki/ウィジェット・ツールキット "wikilink")のように、Macintosh、Windows、[Linux](../Page/Linux.md "wikilink")などの複数のプラットフォーム向けのアプリケーションを同一[ソースコード](../Page/ソースコード.md "wikilink")から作成できる[クロスプラットフォーム](../Page/クロスプラットフォーム.md "wikilink")なフレームワークも多数存在する。[Java](https://ja.wikipedia.org/wiki/Java "wikilink")は標準的なGUIツールキットとして[Swing](../Page/Swing.md "wikilink")を備えている。[Monoに対応したクロスプラットフォームなフレームワークとしては](../Page/Mono_\(ソフトウェア\).md "wikilink")、[Gtk\#や](https://ja.wikipedia.org/wiki/Gtk_Sharp "wikilink")[Xamarin](https://ja.wikipedia.org/wiki/Xamarin "wikilink").Formsが挙げられる。

また、[ウェブアプリケーション](https://ja.wikipedia.org/wiki/ウェブアプリケーション "wikilink")構築のためのアプリケーションフレームワークも多数存在する（[Apache Struts](https://ja.wikipedia.org/wiki/Apache_Struts "wikilink")、[Ruby on Railsなど](../Page/Ruby_on_Rails.md "wikilink")）。
