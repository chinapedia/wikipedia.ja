> この記事は[MediaCoder](https://ja.wikipedia.org/wiki/MediaCoder)から翻訳されています。


**MediaCoder**（メディアコーダー）とはStanley Huangによって開発された、[動画](../Page/動画.md "wikilink")と[音声](https://ja.wikipedia.org/wiki/音声 "wikilink")を[変換](https://ja.wikipedia.org/wiki/変換 "wikilink")することのできるソフトウェアである。かつては[フリーウェア](../Page/フリーウェア.md "wikilink")であった。 内部[エンコーダとして](../Page/エンコード.md "wikilink")[FFmpeg](../Page/FFmpeg.md "wikilink")や[MEncoder](https://ja.wikipedia.org/wiki/MEncoder "wikilink")などを利用している。
...
## その他
  ...
  - 標準で[日本語](../Page/日本語.md "wikilink")表示に対応しているが未翻訳部分が多い。有志が作成している日本語化ファイルを使うと解消される。
...
## 外部リンク
  ...
  - [MediaCoder公式サイト（英語）](http://www.mediacoderhq.com/index.htm)
  - [MediaCoder Wiki](http://www13.atwiki.jp/mediacoder/)
