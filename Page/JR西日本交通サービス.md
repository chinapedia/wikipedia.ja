...
<!-- end list -->
  ...
  - 遠隔センター業務
    JR西日本管内に設置されている「[みどりの券売機プラス](https://ja.wikipedia.org/wiki/指定席券売機#アシストマルス "wikilink")」および「[改札口コールシステム](../Page/駅集中管理システム.md "wikilink")」の遠隔オペレーション業務（[コールセンター](../Page/コールセンター.md "wikilink")運営）を受託している。
