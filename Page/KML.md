...
## KMLを使用するアプリケーション
  ...
  - [Flickr](https://ja.wikipedia.org/wiki/Flickr "wikilink")
  ...
  - [Yahoo\! Pipes](https://ja.wikipedia.org/wiki/Yahoo!_Pipes "wikilink")
