...
主な仕様は上記の2つ。1つはコンテンツを配信するための[フィード](../Page/フィード.md "wikilink")のフォーマットを規定する｢Atom配信フォーマット｣ (Atom Syndication Format)、もう1つはウェブ上のコンテンツを編集するための｢Atom出版プロトコル｣ (Atom Publishing Protocol) で、通称*Atom API*または*AtomPP*とも呼ばれる事がある。
