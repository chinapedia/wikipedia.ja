...
ABIは[アプリケーションプログラミングインタフェース](../Page/アプリケーションプログラミングインタフェース.md "wikilink") (API) とは異なる。APIは[ソースコード](../Page/ソースコード.md "wikilink")とライブラリ間のインタフェースを定義したものであり、同じAPIをサポートしたシステム間では同じソースコードを[コンパイルして利用できる](../Page/コンパイラ.md "wikilink")。一方、ABIは[オブジェクトコードレベルのインタフェースであり](../Page/オブジェクトファイル.md "wikilink")、互換ABIをサポートするシステム間では同じ[実行ファイル](../Page/実行ファイル.md "wikilink")を変更無しで動作させることができる。

## 概要

ABIには、以下のような定義が含まれる。

  - [CPU](../Page/CPU.md "wikilink") - [命令セット](../Page/命令セット.md "wikilink")、[エンディアン](https://ja.wikipedia.org/wiki/エンディアン "wikilink")など。
  - データ - [データ型](../Page/データ型.md "wikilink")、大きさ、配置（[アラインメント](https://ja.wikipedia.org/wiki/データ構造アライメント "wikilink")）など。
  ...
  - [システムコール](../Page/システムコール.md "wikilink") - システムコール番号と具体的なシステムコールの仕組み。
...
他のABIとして例えば[C++](../Page/C++.md "wikilink")の[名前修飾](../Page/名前修飾.md "wikilink")\[2\]や[例外の伝播](../Page/例外処理.md "wikilink")\[3\]や呼出規約があるが、あくまでも同じ[プラットフォーム上のコンパイラ間のABIであり](../Page/プラットフォーム_\(コンピューティング\).md "wikilink")、プラットフォーム間の互換性までは要求されない。
...
あるEABIをサポートする[コンパイラ](../Page/コンパイラ.md "wikilink")で生成した[オブジェクトコードは](../Page/オブジェクトファイル.md "wikilink")、同じEABIをサポートする別のコンパイラで生成したコードと互換性があり、コンパイラが異なっていても同じEABIに対応していればライブラリやオブジェクトコード間でリンク可能である。[アセンブリ言語](../Page/アセンブリ言語.md "wikilink")でコードを書く場合でもEABIに準拠するように書けば、他のコードとのリンクが保証される。
...
EABIが広く使われているCPUアーキテクチャとしては、[PowerPC](../Page/PowerPC.md "wikilink")\[5\]、[ARM](../Page/ARMアーキテクチャ.md "wikilink")\[6\]、[MIPS](../Page/MIPSアーキテクチャ.md "wikilink")\[7\]がある。
...
例えば[RISC](../Page/RISC.md "wikilink")チップにおいては以下のような例がある。
  ...
  - [POWER系](../Page/POWER_\(マイクロプロセッサ\).md "wikilink") : [AIX](../Page/AIX.md "wikilink") 5L / [Solaris](../Page/Solaris.md "wikilink")10g / [Linux](../Page/Linux.md "wikilink")等
  - [MIPS系](../Page/MIPSアーキテクチャ.md "wikilink") : [UX/4800](https://ja.wikipedia.org/wiki/UX/4800 "wikilink") / [Irix](https://ja.wikipedia.org/wiki/Irix "wikilink") 等
  - [Itanium](../Page/Itanium.md "wikilink")系 : [HP-UX](../Page/HP-UX.md "wikilink") / [Linux](../Page/Linux.md "wikilink") 等

最も互換Unix系OSが多いのは、[IA-32](../Page/IA-32.md "wikilink")系であろう。それらOS間でABIを定義して相互にアプリケーションが動作できるようにしようという試みがいくつかあった。しかし、そのような計画が成功したことはない。[Linux](../Page/Linux.md "wikilink")においては、[Linux Standard Base](../Page/Linux_Standard_Base.md "wikilink")（LSB）が同様の試みを行っている（LSBはABI以外にも多くの規定を試みている）。

一方、採用ベンダ数が多く、複数のUnix系OSが乱立していたMIPS系においては、何度もABIの共通化を目指した試みがなされている。

例えば、[1990年代](../Page/1990年代.md "wikilink")中盤〜後半にかけてUNIX[ワークステーション](../Page/ワークステーション.md "wikilink") / [サーバ](../Page/サーバ.md "wikilink")において、[MIPS系CPUを採用した](../Page/MIPSアーキテクチャ.md "wikilink")[NEC](../Page/日本電気.md "wikilink")([UX/4800](https://ja.wikipedia.org/wiki/UX/4800 "wikilink"))、Sony([NEWS](https://ja.wikipedia.org/wiki/NEWS_\(ソニー\) "wikilink"))、[住友電工](../Page/住友電気工業.md "wikilink")（[EWS4800](../Page/EWS4800.md "wikilink")などのNECからの[OEM](../Page/OEM.md "wikilink")品とSUMIStation）、日本タンデムコンピュータ（MIPS系だったNonStopServer）による[OCMP](https://ja.wikipedia.org/wiki/OCMP "wikilink") (Open Computing Environment for MIPS Platform) が定義され、シェアの維持など一定の成果を挙げた。OCMPはMIPS-ABIの日本語対応の側面と[APバス](../Page/APバス.md "wikilink")の標準化による周辺[デバイス](https://ja.wikipedia.org/wiki/デバイス "wikilink")の共通化の側面がある。
