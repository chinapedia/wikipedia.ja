...
**ゴロム符号**（ゴロムふごう、Golomb coding)とは、[南カリフォルニア大学](https://ja.wikipedia.org/wiki/南カリフォルニア大学 "wikilink")の[ソロモン・ゴロム](https://ja.wikipedia.org/wiki/ソロモン・ゴロム "wikilink")によって開発された、[幾何分布](https://ja.wikipedia.org/wiki/幾何分布 "wikilink")に従って出現する整数を最適に符号化することのできる[整数の符号化](https://ja.wikipedia.org/wiki/整数の符号化 "wikilink")手法である。 ゴロム符号と類似の手法にライス符号があるが、ゴロム符号の特別な場合がライス符号になるため、ライス符号のことを**ゴロム・ライス符号**(Golomb-Rice coding)と呼称することが多い。特にライス符号は符号化・復号の計算量が少ないことが特徴。圧縮率は幾何分布の時は[ハフマン符号](../Page/ハフマン符号.md "wikilink")と同一で、それ以外ではそれよりも悪い。
...
整数値の符号化として用いられるほか、画像（動画・静止画）や音声の圧縮で用いられる予測符号化の一部として、予測値との残差を[エントロピー符号](https://ja.wikipedia.org/wiki/エントロピー符号 "wikilink")するのに利用される。
  ...
  - 動画 - [H.264](https://ja.wikipedia.org/wiki/H.264 "wikilink")
