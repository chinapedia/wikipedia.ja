...
今ではC言語によく似た文法の[スクリプト言語](../Page/スクリプト言語.md "wikilink")がいくつもあり、それらに比べればcshはそれほどC言語に似ているとは言えない。しかし80年代から90年代にかけて、特に[AT\&T](../Page/AT&T.md "wikilink")で[スティーブン・ボーン](../Page/スティーブン・ボーン.md "wikilink")が開発した[shと比べたときの違いは著しいと見られていた](../Page/Bourne_Shell.md "wikilink")。次の例は、C shell の[演算子](../Page/演算子.md "wikilink")や構文のわかりやすさを示したものである。
