...
写真測量は、[地形図](https://ja.wikipedia.org/wiki/地形学 "wikilink")、[建築](../Page/建築.md "wikilink")、[工学](../Page/工学.md "wikilink")、[製造](https://ja.wikipedia.org/wiki/製造 "wikilink")、[品質管理](../Page/品質管理.md "wikilink")、警察の捜査、[地質学](../Page/地質学.md "wikilink")など、さまざまな分野で利用されている。写真測量を使えば、[考古学](../Page/考古学.md "wikilink")者は大規模で複雑な遺跡の全体図を容易に作成することができ、[気象学](../Page/気象学.md "wikilink")者は実際の気象データを測定できなくとも竜巻の風速を算出することができる。また、実写と[コンピュータ生成画像を組み合わせた映画の](../Page/Computer_Generated_Imagery.md "wikilink")[ポストプロダクション](https://ja.wikipedia.org/wiki/ポストプロダクション "wikilink")にも写真測量が利用されている。この技術を利用した映画の例には『[ファイト・クラブ](https://ja.wikipedia.org/wiki/ファイト・クラブ_\(映画\) "wikilink")』(DVDの特典映像で詳細な説明がある)がある。
