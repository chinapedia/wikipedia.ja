...
また、Bourne Shell はエラーメッセージのために 2番の[ファイル記述子](../Page/ファイル記述子.md "wikilink")を使うという規定を最初に採用したプログラムでもある。これにより、[エラーメッセージ](https://ja.wikipedia.org/wiki/エラーメッセージ "wikilink")をデータと分離してスクリプトで制御することが容易になった。
