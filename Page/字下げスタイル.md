...
**字下げスタイル**または**インデントスタイル**（[英](../Page/英語.md "wikilink"): **Indent style**）とは、[プログラミングにおいてプログラムの構造を明らかにするために](https://ja.wikipedia.org/wiki/プログラミング_\(コンピュータ\) "wikilink")、コードの[ブロックの](../Page/ブロック_\(プログラミング\).md "wikilink")[字下げ](../Page/字下げ.md "wikilink")をどうするかを決めたものである。本項では[C言語](../Page/C言語.md "wikilink")やそれに類似した言語を主に扱うが、他の[プログラミング言語](../Page/プログラミング言語.md "wikilink")（特に括弧を使用してブロックを記述する言語）にも適用可能である。字下げスタイルは[プログラミング作法](../Page/プログラミング作法.md "wikilink")の一部である。
...
アップルの[Xcode](../Page/Xcode.md "wikilink")はこのスタイルをデフォルトで使っている。

### Java/ActionScript

[Java言語](https://ja.wikipedia.org/wiki/Java言語 "wikilink")は[サン・マイクロシステムズ](../Page/サン・マイクロシステムズ.md "wikilink")が1995年（最終改訂は1999年4月20日）に発表した[Java言語コーディング規約](http://www.oracle.com/technetwork/java/javase/documentation/codeconvtoc-136057.html)に沿って書かれることが多く、これは、K\&Rスタイルをベースに、クラス定義やメソッド定義の最初の中括弧を次の行に置いたりしない物である。また、[ActionScript](../Page/ActionScript.md "wikilink")でもJava言語コーディング規約に類似した書き方が一般的にされる。
...
**[BSD](../Page/BSD.md "wikilink")/オールマン・スタイル**もよく使われる。これは[エリック・オールマン](../Page/エリック・オールマン.md "wikilink")の名が由来である。このスタイルでは、制御文の後の中括弧を次の行に置き、制御文と同じ字下げ位置とする。ブロック内の文は次のレベルに字下げされる。
