...
System V Release 6 は、SCOが2004年末にリリースすると発表したが、結局キャンセルされた\[18\]。[64ビット](../Page/64ビット.md "wikilink")システムをサポートする予定だった\[19\]。
