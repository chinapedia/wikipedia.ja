...
『**人月の神話**』（にんげつのしんわ、）は、[フレデリック・ブルックス](https://ja.wikipedia.org/wiki/フレデリック・ブルックス "wikilink")が著した[ソフトウェア工学](../Page/ソフトウェア工学.md "wikilink")と[ソフトウェアプロジェクト管理](https://ja.wikipedia.org/wiki/ソフトウェアプロジェクト管理 "wikilink")の書籍である。

## 概要

ブルックスの考察は、自身が[IBM](../Page/IBM.md "wikilink") で [OS/360](https://ja.wikipedia.org/wiki/OS/360 "wikilink") という[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink")の開発に携わったときの失敗に基づいている。 [プロジェクト管理者が](https://ja.wikipedia.org/wiki/プロジェクトマネージャ "wikilink")[ソフトウェアプロジェクト管理](https://ja.wikipedia.org/wiki/ソフトウェアプロジェクト管理 "wikilink")において、繰り返し何度もこのような誤りを犯すという傾向があるため、ブルックスは自分の本について、次のような皮肉を述べている。
...
[人月](../Page/人月.md "wikilink")の神話——[狼人間](https://ja.wikipedia.org/wiki/狼人間 "wikilink")を撃つ[銀の弾はない](../Page/銀の弾丸.md "wikilink")
  ...
  - 第6章 命令を伝える
  - 第7章 [バベルの塔](https://ja.wikipedia.org/wiki/バベルの塔 "wikilink")は、なぜ失敗に終わったか
  - 第8章 予告宣言する
  - 第9章 五ポンド袋に詰め込んだ十ポンド
...
以下では、[ブルックスが本書で述べている見解を説明する](https://ja.wikipedia.org/wiki/フレデリック・ブルックス "wikilink")。
...
つまり、人月を使ってスケジュールを見積もることで、その見積もりが失敗し、スケジュールが遅れてしまうのである。そういう事態に陥ってしまった場合、スケジュールの遅れを取り戻すために、プロジェクトの人員を増やすという対策が取られることが多い。しかし、それでは、火に油を注ぐことになってしまうとブルックスは主張する。彼は、それを「[ブルックスの法則](https://ja.wikipedia.org/wiki/ブルックスの法則 "wikilink")」と呼び、以下のように定義している。
...
さらに、基本設計（[アーキテクチャ](https://ja.wikipedia.org/wiki/アーキテクチャ "wikilink")）と実装を分離するためには、次のことが必要である。
...
## 関連項目
  ...
  - [ブルックスの法則](https://ja.wikipedia.org/wiki/ブルックスの法則 "wikilink") - 「遅れているソフトウェアプロジェクトに人員を追加すると、そのプロジェクトはさらに遅れる」という[ブルックスの見解](https://ja.wikipedia.org/wiki/フレデリック・ブルックス "wikilink")。
...
## 参考文献
  ...
  - *The Mythical Man-Month : essays on software engineering*, Brooks, F. P., Addison Wesley, 1975, ISBN 978-0201006506
      - 『ソフトウェア開発の神話』、[フレデリック・フィリップス・ブルックス](https://ja.wikipedia.org/wiki/フレデリック・ブルックス "wikilink")、山内正弥 (訳) 、企画センター、1977年、ISBN 9784873670232
  - *The Mythical Man-Month : essays on software engineering (Anniversary Edition with four new chapters)*, Brooks, F. P., Addison Wesley, 1995, ISBN 978-0201835953
      - 『人月の神話 狼人間を撃つ銀の弾はない』 (原著発行20周年記念増訂版) 、[フレデリック・P・ブルックス Jr.](https://ja.wikipedia.org/wiki/フレデリック・ブルックス "wikilink")、滝沢徹 (訳) 、牧野祐子 (訳) 、宮澤昇 (訳) 、星雲社、アジソン・ウェスレイ・パブリッシャーズ・ジャパン、1996年、ISBN 978-4795296756
