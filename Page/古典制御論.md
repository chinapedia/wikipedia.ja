...
### 解析手法
  ...
  - [根](https://ja.wikipedia.org/wiki/代数方程式#根 "wikilink")（root）または[零点](https://ja.wikipedia.org/wiki/零点 "wikilink") (zero)、[極](../Page/特異点.md "wikilink") (pole)
...
<!-- end list -->
  ...
  - [ゲイン余裕](https://ja.wikipedia.org/wiki/利得_\(電気工学\) "wikilink")、[位相](../Page/位相.md "wikilink")余裕 (gain margin, phase margin)
...
### 制御系設計
  ...
  - [PID制御](https://ja.wikipedia.org/wiki/PID制御 "wikilink") (PID control)
