...
当番組は開始当初から事前収録番組であり、基本的には放送日の２日前～放送当日のいずれかに収録されている（出演者のスケジュール都合で例外あり）。 また、開始当初からラジオでのOA後に、辛坊のYouTubeチャンネル「辛坊の旅」にてスタジオ収録の模様の動画が配信されている。 （但し、著作権の関係上BGM・ジングル含めて音楽は全てカットされている。）
...
**構成作家**
  ...
  - 鍋谷直輝（[ジェットプロダクション](https://ja.wikipedia.org/wiki/ジェットプロダクション "wikilink")代表取締役）

## 主なコーナー

※ここでは通常版（19:55迄）の放送を前提に記載する（番組編成の都合上18:55迄の短縮版で放送される場合がある）。

  - 18:00　オープニング
  - 18:15頃　Jiro's News Pick Up\! 前半
      - 辛坊によるニュース解説コーナー。
...
<!-- end list -->
  ...
  - 19:00　ゲストコーナー
      - ゲストを迎えたトークコーナー。
  - 19:40頃　Jiro's News Pick Up\! 後半
  - 19:52　エンディング

## 外部リンク

  - [辛坊治郎 Sunday Kiss](https://www.kiss-fm.co.jp/sunday_kiss/)

  -
[Category:2019年のラジオ番組_(日本)](https://ja.wikipedia.org/wiki/Category:2019年のラジオ番組_\(日本\) "wikilink") [Category:Kiss-FM_KOBEの番組](https://ja.wikipedia.org/wiki/Category:Kiss-FM_KOBEの番組 "wikilink")