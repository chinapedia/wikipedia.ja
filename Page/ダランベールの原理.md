...
簡単のために一つの質点を考え、その[質量](../Page/質量.md "wikilink")を m とする。それに外界から[力](../Page/力_\(物理学\).md "wikilink") **F** が加わえられ、質点 m が[加速度](../Page/加速度.md "wikilink") *d*<sup>2</sup>**r**/*dt*<sup>2</sup> で運動する場合を考える。このとき、質点の運動を記述する[ニュートンの運動方程式](https://ja.wikipedia.org/wiki/ニュートンの運動方程式 "wikilink")は、
