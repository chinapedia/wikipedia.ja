...
#### L13B
  ...
  -
    3代目フィットに初搭載された[ミラーサイクル](../Page/ミラーサイクル.md "wikilink")エンジン。DOHC化され吸気側では吸気遅閉じのミラーサイクルを実現する広開角カムと通常の狭開角カムを持つVTECを採用。エンジンが低回転時と、高回転高負荷時に狭開角カムを使用する。さらに吸気側に電動VTCを採用し遅閉じ制御やオーバーラップ制御を行う。圧縮比は13.5で、クールドEGRも採用する。
...
#### LEB
  ...
  -
    2代目[フィットハイブリッド向けに初搭載されたミラーサイクルエンジン](https://ja.wikipedia.org/wiki/ホンダ・フィットハイブリッド "wikilink")。上述のL15Bエンジン (NA) をベースに開発された排気量1.5Lのもので、燃料噴射を通常のポート噴射に変更の上ミラーサイクル化されている。組み合わせられるハイブリッドシステムは1モーターの[SPORT HYBRID i-DCDのみであったが](https://ja.wikipedia.org/wiki/Honda_SPORT_HYBRID_Intelligent_Dual_Clutch_Drive "wikilink")、2018年に発売された[クラリティPHEVには](https://ja.wikipedia.org/wiki/ホンダ・クラリティ_フューエル_セル "wikilink")2モーターの[SPORT HYBRID i-MMDが搭載された](https://ja.wikipedia.org/wiki/SPORT_HYBRID_Intelligent_Multi_Mode_Drive "wikilink")。[ヴェゼルおよび](https://ja.wikipedia.org/wiki/ホンダ・ヴェゼル "wikilink")[ジェイド搭載にあたっては本来の筒内燃料噴射との組み合わせとなっている](https://ja.wikipedia.org/wiki/ホンダ・ジェイド "wikilink")。
...
#### L12B
  ...
  - [ジャズ](https://ja.wikipedia.org/wiki/ホンダ・ジャズ "wikilink")（GG1/2/5）
  - [ブリオ](https://ja.wikipedia.org/wiki/ホンダ・ブリオ "wikilink")（アジア新興国専用車種）
  - [ブリオアメイズ](https://ja.wikipedia.org/wiki/ホンダ・ブリオアメイズ "wikilink")（アジア新興国専用車種）
...
#### L13B
  ...
  - [フィット](../Page/ホンダ・フィット.md "wikilink")（GK3/4）
...
<!-- end list -->
  ...
  - フィット（GK5/6）
  - [ヴェゼル](https://ja.wikipedia.org/wiki/ホンダ・ヴェゼル "wikilink")（RU1/2）
  - [シャトル](https://ja.wikipedia.org/wiki/ホンダ・シャトル "wikilink")（GK8/9）
  - [グレイス](https://ja.wikipedia.org/wiki/ホンダ・グレイス "wikilink")（GM6/9）
...
<!-- end list -->
  ...
  - [ステップワゴン](../Page/ホンダ・ステップワゴン.md "wikilink")（RP3/4）
  - [ジェイドRS](https://ja.wikipedia.org/wiki/ホンダ・ジェイド_\(自動車\) "wikilink")（FR5）
  - [CR-V](../Page/ホンダ・CR-V.md "wikilink")（RW1/2）
  - [ヴェゼルツーリング](https://ja.wikipedia.org/wiki/ホンダ・ヴェゼル "wikilink")（RU1）
  - [シビックセダン](../Page/ホンダ・シビック.md "wikilink")（FC1）
...
**VTEC TURBO**
  ...
  - 内径×行程：73.0mm×89.4mm
  - 燃料供給装置形式：筒内直接噴射式（PGM-FI）
  - 参考スペック（FK7 シビックハッチバック）
      - 最高出力：134kW(182PS)/5,500rpm
      - 最大トルク：240N·m(24.5kg·m)/1,900 - 5,000rpm
  - [シビックハッチバック](../Page/ホンダ・シビック.md "wikilink")（FK7）
...
<!-- end list -->
  ...
  - [インサイト](../Page/ホンダ・インサイト.md "wikilink")（ZE2）
  - フィットシャトルハイブリッド（GP2）
  - フィットハイブリッド（GP1)
...
i-VTEC
  ...
  - [CR-Z](../Page/ホンダ・CR-Z.md "wikilink")（ZF2）
  - インサイト（ZE3）
...
<!-- end list -->
  ...
  - [フィットハイブリッド](https://ja.wikipedia.org/wiki/ホンダ・フィットハイブリッド "wikilink")（GP5）
  - [グレイス](https://ja.wikipedia.org/wiki/ホンダ・グレイス "wikilink")（GM4/5）
  - シャトルハイブリッド（GP7/8）
  - クラリティPHEV（ZC5）
  - [インサイト](../Page/ホンダ・インサイト.md "wikilink")（ZE4）
...
#### LFA
  ...
  - 内径×行程：81.0mm×96.7mm
  - 燃料供給装置形式：電子制御燃料噴射式（PGM-FI）
  - 参考スペック（CR6 アコードハイブリッド）
      - 最高出力：105kW(143PS)/6,200rpm
      - 最大トルク：165N·m(16.8kg·m)/3,857 - 8,000rpm
  - アコードハイブリッド（CR6）
  - アコードプラグインハイブリッド（CR5）
...
<!-- end list -->
  ...
  - フィット（GD1/2,GE6/7）
  - [フィットアリア](../Page/ホンダ・フィットアリア.md "wikilink")（GD6/7）
...
## 外部リンク
  ...
  - [テクノロジー・ダイジェスト i-DSI](http://www.honda.co.jp/tech/auto/engine/i-dsl/index.html)（オフィシャル）
  - \[<http://www.honda.co.jp/tech/auto/vtec-turbo/>　テクノロジー図鑑 VTEC TURBO\]（オフィシャル）
