...
「KINTO」というネーミングは、トヨタ自動車社長[豊田章男](https://ja.wikipedia.org/wiki/豊田章男 "wikilink")が、理想の車を「筋斗雲」と称したことに由来し、彼は 「簡単にクルマライフをスタートし、違うクルマに乗りたくなったら乗り換え、不要になったら返却する。必要な時にすぐに現れ、思いのままに移動できる、まさに『筋斗雲』のように使っていただきたいと考え、『KINTO』と名付けました。」と語っている。\[1\]
...
## サービスの特徴
  ...
  - 契約はWEBから申し込み可能。月々定額のクレジット決済で頭金は不要である。
  ...
  - サポカー補助金も通常と同様、対象車種には適用される。
  - 契約満了時は車両を返却するだけでよい。契約期間中の中途解約については、解約金が予め明示されており明瞭である。また、海外転勤、免許返納、運転困難時、死亡の場合には中途解約金なしで解約可能である。
  - トヨタのコネクティッドサービスであるT-Connectサービスに対応している車種では愛車ポイントサービスが受けられ、安全でエコな運転に対してポイントが付与される。
...
## サービスの沿革
  ...
  - 2020年5月 - 「中古車KINTO ONE」を自動車通販サイト「直売カーセンサー」へトライアル掲載開始。
...
1.  [トヨタ自動車、クルマとの新しい関係を提案する新サービスを開始](https://global.toyota/jp/newsroom/corporate/25168997.html)" プレスリリース, トヨタ自動車株式会社, 2018年11月1日。