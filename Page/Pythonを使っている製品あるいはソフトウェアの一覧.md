...
## 統合開発環境
  ...
  - [Boa Constructor](https://ja.wikipedia.org/wiki/Boa_Constructor "wikilink") - クラスプラットフォームのPython開発用IDE
  - [EasyEclipse](https://ja.wikipedia.org/wiki/EasyEclipse "wikilink") - Pythonやその他の言語のためのIDE
  - [Eric Python IDE](https://ja.wikipedia.org/wiki/Eric_Python_IDE "wikilink") - Pythonと[Ruby](../Page/Ruby.md "wikilink")のためのIDE
  - [Geany](https://ja.wikipedia.org/wiki/Geany "wikilink") - Pythonやその他の言語のためのIDE
  - [Komodo IDE](https://ja.wikipedia.org/wiki/Komodo_IDE "wikilink") - Python, Perl, PHP, RubyのためのIDE
  - [PIDA](https://ja.wikipedia.org/wiki/PIDA "wikilink") - Pythonで書かれたIDE。他のテキストエディタを組み込める
  - [PyCharm](https://ja.wikipedia.org/wiki/PyCharm "wikilink") - Python開発用のプロプライエタリなIDE
  - [Pydev](https://ja.wikipedia.org/wiki/Pydev "wikilink") - EclipseをPythonの開発環境にするためのプラグイン
  - [PyScripter](https://ja.wikipedia.org/wiki/PyScripter "wikilink") - Windows用のPython開発用IDE
  - [Python Tools for Visual Studio](https://ja.wikipedia.org/wiki/Python_Tools_for_Visual_Studio "wikilink") - Visual Studio用の[プラグイン](http://pytools.codeplex.com)
  - [Stani's Python Editor](https://ja.wikipedia.org/wiki/Stani's_Python_Editor "wikilink") - Python開発用のクロスプラットフォームのIDE
  - [Webware for Python](https://ja.wikipedia.org/wiki/Webware_for_Python "wikilink") - Webベースのアプリケーションを開発するためのツールスイート
  - [Wing IDE](https://ja.wikipedia.org/wiki/Wing_IDE "wikilink") - Python用IDE
...
## アプリケーション
  ...
  - [Calibre](https://ja.wikipedia.org/wiki/Calibre "wikilink") - オープンソースの電子書籍管理ツール
  ...
  - [OpenStack](https://ja.wikipedia.org/wiki/OpenStack "wikilink") - [クラウドコンピューティング](https://ja.wikipedia.org/wiki/クラウドコンピューティング "wikilink")[IaaS](https://ja.wikipedia.org/wiki/IaaS "wikilink")プラットフォーム
  - OpenTeacher - オープンソースの語彙練習アプリケーション
...
## ビデオゲーム
  ...
  - [Vega Strike](https://ja.wikipedia.org/wiki/Vega_Strike "wikilink") - オープンソースの宇宙シミュレーションゲーム
  - [Jewel Quest 5](https://ja.wikipedia.org/wiki/Jewel_Quest_5 "wikilink") - [Stackless Pythonを使用している](https://ja.wikipedia.org/wiki/Stackless_Python "wikilink")
  - [World of Tanks](https://ja.wikipedia.org/wiki/World_of_Tanks "wikilink") - 大部分の処理にPythonを使用している
...
## グラフィクスフレームワーク
  ...
  - [Pygame](https://ja.wikipedia.org/wiki/Pygame "wikilink") - [SDL](../Page/SDL.md "wikilink")のPython用バインディング
  - [Pyglet](https://ja.wikipedia.org/wiki/Pyglet "wikilink") - クロスプラットフォームのPython用ウインドウ作成/マルチメディアライブラリ
  - [Panda3D](https://ja.wikipedia.org/wiki/Panda3D "wikilink") - Python用3Dゲームエンジン
  - [Python Imaging Library](https://ja.wikipedia.org/wiki/Python_Imaging_Library "wikilink") - 画像を扱うためのライブラリ
...
## GUIフレームワーク
  ...
  - [PyGTK](https://ja.wikipedia.org/wiki/PyGTK "wikilink") - GTK+を使用したクロスプラットフォームのGUIライブラリ
  - [PyQt](https://ja.wikipedia.org/wiki/PyQt "wikilink") - Qtを使用したクロスプラットフォームのGUIライブラリ
  - [PySide](https://ja.wikipedia.org/wiki/PySide "wikilink") - PyQtの代替となるライブラリ
  - [wxPython](https://ja.wikipedia.org/wiki/wxPython "wikilink") - GUIライブラリ [wxWidgets](https://ja.wikipedia.org/wiki/wxWidgets "wikilink") のPython用バインディング
...
## 科学パッケージ
  ...
  - [Mlpy](https://ja.wikipedia.org/wiki/Mlpy "wikilink") ([:en:Mlpy](https://ja.wikipedia.org/wiki/:en:Mlpy "wikilink")) - 機械学習ライブラリ
  - [SimPy](https://ja.wikipedia.org/wiki/SimPy "wikilink") ([:en:SimPy](https://ja.wikipedia.org/wiki/:en:SimPy "wikilink")) - 離散事象シミュレーションパッケージ
  - [stsci python](https://ja.wikipedia.org/wiki/stsci_python "wikilink") ([:en:stsci python](https://ja.wikipedia.org/wiki/:en:stsci_python "wikilink")) - [StScIにより開発された宇宙データ解析基盤のPythonルーチンおよびC拡張](https://ja.wikipedia.org/wiki/宇宙望遠鏡科学研究所 "wikilink")
  - [Veusz](https://ja.wikipedia.org/wiki/Veusz "wikilink") - 科学プロットライブラリ
  - [VisTrails](https://ja.wikipedia.org/wiki/VisTrails "wikilink") ([:en:VisTrails](https://ja.wikipedia.org/wiki/:en:VisTrails "wikilink"))
  - [p4vasp](http://wavemol.org/software/p4vasp) - [Vienna Ab initio Simulation Package](https://ja.wikipedia.org/wiki/Vienna_Ab_initio_Simulation_Package "wikilink") (VASP) 用可視化スイート
  - [Pandas](https://ja.wikipedia.org/wiki/Pandas "wikilink") ([en:Pandas](https://ja.wikipedia.org/wiki/:en:Pandas_\(software\) "wikilink")) - データ解析用のデータ構造を提供するライブラリ
...
## 数学ライブラリ
  ...
  - [Sage](https://ja.wikipedia.org/wiki/Sage_\(数式処理システム\) "wikilink") - 線形代数・数値計算・組合せ数学・微分積分などをサポートする巨大な数学環境。100以上のフリーソフトウェアプロジェクトを統合している
  - [SymPy](https://ja.wikipedia.org/wiki/SymPy "wikilink") - 計算機代数ライブラリ
...
## Pythonをスクリプト環境として組み込んでいるもの
  ...
  - [Autodesk Softimage](https://ja.wikipedia.org/wiki/Autodesk_Softimage "wikilink") (前 Softimage|XSI)
  - [Blender](../Page/Blender.md "wikilink") - 3DCG、アニメーション、ゲーム制作環境
  - [Boxee](https://ja.wikipedia.org/wiki/Boxee "wikilink") - ホームシアターPCソフトウェア
...
## 外部リンク
  ...
  - [Python Package Index](http://pypi.python.org/pypi) 公式のPythonライブラリリポジトリ
  - [ActiveState O'Reilly Python Cookbook](http://aspn.activestate.com/ASPN/Python/Cookbook/) - Pythonを使って色々な作業をする数百のサンプルが載っている
  - [Python 3D Software Collection](http://www.vrplumber.com/py3d.py) - 3Dソフトウェアやゲームを作るのに有用なパッケージの一覧
  - [Useful Modules](http://wiki.python.org/moin/UsefulModules) - 便利なモジュール一覧 (Python.org Wiki)
  - [Organizations Using Python](http://wiki.python.org/moin/OrganizationsUsingPython) - Pythonを利用しているプロジェクトの一覧
  - [Ohloh](http://www.ohloh.net/p?page=2&q=language%3APython&sort=users) - Pythonによるオープンソースプロジェクトの一覧

[Category:製品の一覧](https://ja.wikipedia.org/wiki/Category:製品の一覧 "wikilink") [Category:コンピュータ関連の一覧](https://ja.wikipedia.org/wiki/Category:コンピュータ関連の一覧 "wikilink") [Category:Python](https://ja.wikipedia.org/wiki/Category:Python "wikilink")

1.  <http://www.tacticalgamer.com/wiki/index.php/Official_BF2_Python_Doc>
2.  <http://www.eve-online.com/faq/faq_07.asp>
3.  <http://www.python.org/about/success/usa/>
4.  <http://blog.reddit.com/2005/12/on-lisp.html>
5.  <http://www.python.org/about/quotes>