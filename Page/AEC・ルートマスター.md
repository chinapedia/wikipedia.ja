...
[1990年代](../Page/1990年代.md "wikilink")のLondon Buses Limitedの分割・民営化では9社に引き継がれたが、[2000年代](../Page/2000年代.md "wikilink")に入ると老朽化に加えて
...
イギリスの[左側通行](https://ja.wikipedia.org/wiki/左側通行 "wikilink")が幸いし、日本においてもとりあえず運行可能な条件を備えているため、イベント時のシャトルバスなどに使用するために数台が輸入されている。ただし高さは日本での法規制を超過するため、高さを縮小する改造を行わなかった場合は走行に際してその都度[特認を受けることになり](https://ja.wikipedia.org/wiki/保安基準の緩和 "wikilink")、走行ルートは歩道橋などの走行に支障をきたす建築物がないルートに限定される。また、非常口などは日本の基準に合わせて増設されている（右の画像も参照）。
