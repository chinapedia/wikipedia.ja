...
**eRuby**とは、[Ruby](../Page/Ruby.md "wikilink")の周辺技術の一つで、[HTMLへRubyスクリプトを埋め込む事を可能とする技術である](../Page/HyperText_Markup_Language.md "wikilink")。**embedded Ruby**の略。**ERB**とも表記され、ファイル拡張子も.erbである事が多い。対象としてはHTMLだけでなく、任意の[プレインテキスト](https://ja.wikipedia.org/wiki/プレインテキスト "wikilink")に適用できる。[Ruby on Railsの](../Page/Ruby_on_Rails.md "wikilink")[MVCの内で](../Page/Model_View_Controller.md "wikilink")、Viewの開発言語にも採用されている。
...
さらにこの方式では、CGIや[WEBアプリケーションを作成しようとしたとき](https://ja.wikipedia.org/wiki/ウェブアプリケーション "wikilink")、プログラマーと[WEBデザイナーの分離が難しく](../Page/ウェブデザイナー.md "wikilink")、また[Dreamweaverなどの](../Page/Adobe_Dreamweaver.md "wikilink")[WEBオーサリングツールの利用も不可能となってしまう](../Page/Webオーサリングツール.md "wikilink")。
