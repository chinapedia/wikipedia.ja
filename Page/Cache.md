...
同じ用途で[関係データベース](https://ja.wikipedia.org/wiki/関係データベース "wikilink")と比較したとき、特に複雑なリレーションシップを含むシステムにおいてCachéは遥かに性能が良い（あるいは[スケーラビリティ](https://ja.wikipedia.org/wiki/スケーラビリティ "wikilink")が良い）とされる。この特徴は通常の[関係データベース管理システム](../Page/関係データベース管理システム.md "wikilink") (RDBMS) において[ボトルネック](https://ja.wikipedia.org/wiki/ボトルネック "wikilink")となりがちな[O/Rマッピング](https://ja.wikipedia.org/wiki/O/Rマッピング "wikilink")を必要としない、[MUMPS](https://ja.wikipedia.org/wiki/MUMPS "wikilink")に由来するデータ構造によるものである。
