...
[手続き型言語として](https://ja.wikipedia.org/wiki/手続き型プログラミング "wikilink")、また、[プロトタイプベース](https://ja.wikipedia.org/wiki/プロトタイプベース "wikilink")の[オブジェクト指向言語](https://ja.wikipedia.org/wiki/オブジェクト指向言語 "wikilink")としても利用することができ、[関数型言語](../Page/関数型言語.md "wikilink")、データ駆動型としての要素も併せ持っている。
...
[MITライセンスのもと配布されているため商用プロダクトにも組み込みやすい点も高く評価されている](https://ja.wikipedia.org/wiki/MIT_License "wikilink")。
...
文法的な特徴としては、[Pascal](../Page/Pascal.md "wikilink")によく似た構文を採用していること、[コルーチン](https://ja.wikipedia.org/wiki/コルーチン "wikilink")（[協調的マルチタスク](https://ja.wikipedia.org/wiki/マルチタスク#ノンプリエンプティブ・マルチタスク "wikilink")）のサポート、数値型は[整数](../Page/整数.md "wikilink")と[浮動小数点数](../Page/浮動小数点数.md "wikilink")の区別がないこと、関数を変数として扱えることなどが挙げられる。
...
### Lua
  ...
  - 2011年12月16日 - Lua 5.2.0 リリース。[ビット演算](https://ja.wikipedia.org/wiki/ビット演算 "wikilink")ライブラリをサポート。
...
### ゲーム
  ...
  - [Far Cry](https://ja.wikipedia.org/wiki/Far_Cry "wikilink")
  ...
  - [ソニック・ザ・ヘッジホッグ (2006年のゲーム)](https://ja.wikipedia.org/wiki/ソニック・ザ・ヘッジホッグ_\(2006年のゲーム\) "wikilink")
...
### ゲーム以外
  ...
  - [FlashAir](https://ja.wikipedia.org/wiki/FlashAir "wikilink") - [無線LAN](../Page/無線LAN.md "wikilink")機能を搭載した[東芝](https://ja.wikipedia.org/wiki/東芝 "wikilink")製SDHC[メモリーカード](../Page/メモリーカード.md "wikilink")\[21\]

  - FLOW - 設定に使われている\[22\]

  - [LuaTeX](https://ja.wikipedia.org/wiki/LuaTeX "wikilink")

  - [MediaWiki](https://ja.wikipedia.org/wiki/MediaWiki "wikilink")（[Scribunto拡張により](https://ja.wikipedia.org/wiki/mediawikiwiki:Extension:Scribunto "wikilink")）
  ...
  - [RigidChips](https://ja.wikipedia.org/wiki/RigidChips "wikilink")
  ...
  - [VOCALOID](https://ja.wikipedia.org/wiki/VOCALOID "wikilink")3 - ユーザー側で歌唱合成用データを加工するエフェクタを自作できる\[27\]
