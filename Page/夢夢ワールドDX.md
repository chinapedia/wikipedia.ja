...
『**夢夢ワールドDX**』（ムムワールドデラックス）は、2005年に[SANKYOから発売された](https://ja.wikipedia.org/wiki/三共_\(パチンコ\) "wikilink")[パチスロ](../Page/パチスロ.md "wikilink")機種。ボーナスのストック機能を搭載。『[ボンバーパワフル](https://ja.wikipedia.org/wiki/ボンバーパワフル "wikilink")』同様「[夢夢](https://ja.wikipedia.org/wiki/夢夢 "wikilink")」「ナナ」姉妹が登場する。演出用に大型の液晶画面を搭載しており、リールはその分小さくなっている。
...
『ボンバーパワフル』などとは異なり、[RTテーブルは存在しない](https://ja.wikipedia.org/wiki/リプレイタイム "wikilink")。そのかわりモードが複数存在し、それによりボーナスを放出しやすい状態としにくい状態とに分かれている。[スロットステージ滞在中を除き](https://ja.wikipedia.org/wiki/#スロットステージ "wikilink")、ストック機によくある小役解除なども存在せず、演出ステージ移行のときの抽選により内部で前兆モードに移行すれば、規定のゲーム数消化後にボーナス放出となっている。
...
ボーナスゲーム中の出現キャラによって[連荘](https://ja.wikipedia.org/wiki/連荘 "wikilink")の期待度が変わり、ロボパワフルが出現すれば期待大となる。
