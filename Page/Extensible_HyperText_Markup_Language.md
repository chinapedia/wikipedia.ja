...
**Extensible HyperText Markup Language**（エクステンシブル ハイパーテキスト マークアップ ランゲージ）、略記・略称：**XHTML** （エックスエイチティーエムエル）は、[SGMLで定義されていた](https://ja.wikipedia.org/wiki/Standard_Generalized_Markup_Language "wikilink")[HTMLを](https://ja.wikipedia.org/wiki/HyperText_Markup_Language "wikilink")[XMLの文法で定義しなおした](https://ja.wikipedia.org/wiki/Extensible_Markup_Language "wikilink")[マークアップ言語](https://ja.wikipedia.org/wiki/マークアップ言語 "wikilink")である。その仕様はHTMLと同じく[W3Cによって勧告されていた](https://ja.wikipedia.org/wiki/World_Wide_Web_Consortium "wikilink")。しかし[2007年](https://ja.wikipedia.org/wiki/2007年 "wikilink")にW3C HTML WGを設立すると[WHATWGとの共同作業を行い](https://ja.wikipedia.org/wiki/Web_Hypertext_Application_Technology_Working_Group "wikilink")、[2009年](https://ja.wikipedia.org/wiki/2009年 "wikilink")、W3Cは開発を正式に中止した。HTML5はXMLの書式に従わずとも[MathMLや](https://ja.wikipedia.org/wiki/Mathematical_Markup_Language "wikilink")[SVGなどを埋め込むことが可能である](https://ja.wikipedia.org/wiki/Scalable_Vector_Graphics "wikilink")。
...
XHTMLはXMLアプリケーションである。よって、XMLの文法に従うために、HTMLと異なる部分が存在する。以下は、主な文法上の相違点とソースのサンプルである。
  ...
  - XML宣言を書く
    XML文書であるため、文書の頭にXML宣言を書くことが奨励されている。[文字コード](https://ja.wikipedia.org/wiki/文字コード "wikilink")については、[UTF-8](https://ja.wikipedia.org/wiki/UTF-8 "wikilink")ないし[UTF-16](https://ja.wikipedia.org/wiki/UTF-16 "wikilink")の場合や[HTTPなどのプロトコルで文字コードが指定されている場合は省略可能であるが](../Page/Hypertext_Transfer_Protocol.md "wikilink")、常に付与することが推奨される。
...
<!-- end list -->
  ...
  - 空要素の終了タグも書く
    空要素についても同様に終了タグを付与するか、開始タグの末尾を「/\>」としなければならない。
      ...
      - XMLを解釈できない古い[UAで](https://ja.wikipedia.org/wiki/ユーザーエージェント "wikilink") \<br/\> という表記に対し、"br/" を要素名とみなし無視してしまう可能性があることを考慮し、XHTMLでは \<br /\> のようにスラッシュの前に半角スペースを先行させる表記が一般的である。
...
HTML 4.01をXMLにて再定義したもので、HTML 4.01と同様にStrict、Transitional、Framesetという3種類の[DTDが存在する](https://ja.wikipedia.org/wiki/Document_Type_Definition "wikilink")。

[2000年](../Page/2000年.md "wikilink")[1月26日](https://ja.wikipedia.org/wiki/1月26日 "wikilink")に勧告となり、[2002年](../Page/2002年.md "wikilink")[8月1日](https://ja.wikipedia.org/wiki/8月1日 "wikilink")に改訂版であるSecond Editionが勧告された。
...
その後、[OMA](https://ja.wikipedia.org/wiki/OMA "wikilink")が策定する[XHTML Mobile Profileとの不整合を解消する目的で策定された](https://ja.wikipedia.org/wiki/XHTML_Mobile_Profile "wikilink") XHTML Basic 1.1が[2008年](https://ja.wikipedia.org/wiki/2008年 "wikilink")[7月29日](https://ja.wikipedia.org/wiki/7月29日 "wikilink")に勧告された。

Basic1.1では、Basic1.0から次のような変更が行われている。

  - target属性やscript/style要素、style属性の追加
  - [XForms](https://ja.wikipedia.org/wiki/XForms "wikilink")よりinputmode属性の追加

### XHTML Modularization (Modularization of XHTML, M12n)

XHTMLをその要素の目的や役割ごとに分割し、フレームワーク化したもの。XHTML 1.1やXHTML 2.0は、M12nをベースに構築されている。バージョン1.0が[2001年](../Page/2001年.md "wikilink")[4月10日](https://ja.wikipedia.org/wiki/4月10日 "wikilink")に、バージョン1.1が2008年10月にそれぞれ勧告された。2009年7月現在、バージョン2.0が草案の段階にある。 1.0から1.1ではXML Schemaへの対応などが変更点となった。
...
機能がモジュール化されたXHTML。XHTML 1.0からの主な違いは、次の通りである。
  ...
  - [ルビ](https://ja.wikipedia.org/wiki/ルビ "wikilink")モジュールが導入された。

[2001年](../Page/2001年.md "wikilink")[5月31日](https://ja.wikipedia.org/wiki/5月31日 "wikilink")に仕様が勧告となった。 2010年11月23日にXHTML 1.1 Second Editionが勧告された。エラッタの修正とXML Schemaへの対応が主な変更点となる。
...
XHTML Familyの次期バージョンとして策定されていたが、W3Cは2009年07月03日に策定の打ち切りを決定し、今後は[HTML5](https://ja.wikipedia.org/wiki/HTML5 "wikilink")にリソースを注ぐものとした。理由として、XHTML 2.0の市場はHTML5に比べて非常に小さいことがあげられている。
...
以下にHTML記法とXML記法の違いをいくつか挙げる。
  ...
  - 従来のHTML/XHTMLで許されていたDTDを用いた[文字参照](https://ja.wikipedia.org/wiki/文字参照 "wikilink")が不可能となった。
...
## 関連項目
  ...
  - [SGML](https://ja.wikipedia.org/wiki/Standard_Generalized_Markup_Language "wikilink")
  - [XML](https://ja.wikipedia.org/wiki/Extensible_Markup_Language "wikilink")
