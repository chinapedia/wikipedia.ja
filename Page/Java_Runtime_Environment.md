...
1.  [AndroidのJava実行環境は正式にライセンスされたJREではなく](../Page/Android_\(オペレーティングシステム\).md "wikilink")、また[Dalvik仮想マシン](../Page/Dalvik仮想マシン.md "wikilink")/[Android Runtimeは正式なJava仮想マシンとの互換性がない](https://ja.wikipedia.org/wiki/Android_Runtime "wikilink")。
