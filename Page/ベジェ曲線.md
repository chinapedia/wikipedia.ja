...
**ベジェ曲線**（ベジェきょくせん、）または**ベジエ曲線**とは、 個の制御点から得られる  次[曲線](https://ja.wikipedia.org/wiki/曲線 "wikilink")である。[フランス](https://ja.wikipedia.org/wiki/フランス "wikilink")の[自動車](../Page/自動車.md "wikilink")メーカー、[シトロエン](https://ja.wikipedia.org/wiki/シトロエン "wikilink")社の と[ルノー](https://ja.wikipedia.org/wiki/ルノー "wikilink")社の[ピエール・ベジェ](https://ja.wikipedia.org/wiki/ピエール・ベジェ "wikilink")により独立に考案された。ド・カステリョの方が先んじていたが、その論文が公知とならなかったためベジェの名が冠されている\[1\]。[コンピューター](https://ja.wikipedia.org/wiki/コンピューター "wikilink")上で滑らかな曲線を描くのに2次ベジェ曲線 () や3次ベジェ曲線 () などが広く利用されている。
...
特に、2次だけでなく、3次ベジェ曲線までサポートされていることが多い。これは、始点と第1制御点を結ぶ線分が始点における曲線の接線になり、第2制御点と終点を結ぶ線分が終点における曲線の接線になるため、直感的に理解しやすいことにある。また、始点と第1制御点の距離によって始点付近の曲率が制御できるため、作図を行うソフトウェア（[ドローソフト](https://ja.wikipedia.org/wiki/ドローソフト "wikilink")）で手作業により曲線を描く際に線の形を整えやすい。

[PostScript](../Page/PostScript.md "wikilink")やその[フォント](../Page/フォント.md "wikilink") ([Type1フォント](https://ja.wikipedia.org/wiki/PostScriptフォント#Type_1 "wikilink"))、[SVGや](https://ja.wikipedia.org/wiki/Scalable_Vector_Graphics "wikilink")[HTML5](https://ja.wikipedia.org/wiki/HTML5 "wikilink")の[canvasで](https://ja.wikipedia.org/wiki/canvas要素 "wikilink")3次ベジェ曲線を使うことができる。Adobe Flash Playerも11.0以降では使える。[Microsoft Windowsの](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")[GDI](https://ja.wikipedia.org/wiki/Graphics_Device_Interface "wikilink")/GDI+、[Direct2D](https://ja.wikipedia.org/wiki/Direct2D "wikilink")、[.NET Frameworkの](https://ja.wikipedia.org/wiki/.NET_Framework "wikilink")`System.Drawing.Drawing2D.GraphicsPath`、[WPFの](https://ja.wikipedia.org/wiki/Windows_Presentation_Foundation "wikilink")`System.Windows.Media.BezierSegment`では3次ベジェをサポートする\[2\]\[3\]\[4\]\[5\]\[6\]。

一部は2次ベジェ曲線までのサポートである。[Adobe Flash](../Page/Adobe_Flash.md "wikilink") Playerは10.3までは2次までである。

[AWT](https://ja.wikipedia.org/wiki/Abstract_Window_Toolkit "wikilink")（[Java](https://ja.wikipedia.org/wiki/Java "wikilink") 1.2以降で追加された, の派生クラス）、[Skia](https://ja.wikipedia.org/wiki/Skia "wikilink")の`SkPath`および[Android](https://ja.wikipedia.org/wiki/Android "wikilink")の`android.graphics.Path`は2次と3次のベジェ両方を直接サポートする\[7\]\[8\]\[9\]。
...
## 関連項目
  ...
  - [スプライン曲線](https://ja.wikipedia.org/wiki/スプライン曲線 "wikilink")
