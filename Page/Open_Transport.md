...
**Open Transport** は、[アップルが](../Page/アップル_\(企業\).md "wikilink")[UNIX System Vの](https://ja.wikipedia.org/wiki/UNIX_System_V "wikilink")[STREAMS](https://ja.wikipedia.org/wiki/STREAMS "wikilink")を実装したものの名称。それまでの[MacTCP](https://ja.wikipedia.org/wiki/MacTCP "wikilink")を置き換えた。

Open TransportはMentat Portable Streamsという実装に基づいており、[TCP/IP](https://ja.wikipedia.org/wiki/TCP/IP "wikilink")とシリアル通信を制御する\[1\]。さらに、アップルはこれに[AppleTalk](https://ja.wikipedia.org/wiki/AppleTalk "wikilink")の実装も追加した。
...
このため、Open Transportは[macOS](https://ja.wikipedia.org/wiki/macOS "wikilink")への移行時に捨てられることになった。macOSではより一般的な[ソケットが使われている](../Page/ソケット_\(BSD\).md "wikilink")。Open Transportは[Classic環境で古いアプリケーションを使う際に限定的に使われている](https://ja.wikipedia.org/wiki/Classic_\(ソフトウェア\) "wikilink")。
