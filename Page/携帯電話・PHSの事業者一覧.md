...
### 日本
  ...
  - [NTTドコモ](https://ja.wikipedia.org/wiki/NTTドコモ "wikilink")（NTT docomo）
  - KDDIグループ
...
### グアム
  ...
  - [ドコモパシフィック](https://ja.wikipedia.org/wiki/ドコモパシフィック "wikilink")
...
### フランス
  ...
  - [ブイグテレコム](https://ja.wikipedia.org/wiki/ブイグテレコム "wikilink")
  - [Orange](../Page/Orange_\(通信会社\).md "wikilink")
  - [SFR](https://ja.wikipedia.org/wiki/アルティス_\(通信会社\) "wikilink")
...
### スウェーデン/フィンランド
  ...
  - [テリア](https://ja.wikipedia.org/wiki/テリア_\(企業\) "wikilink")

### チェコ

  - Eurotel Praha（GSM 900/1800）
  - T-Mobile（GSM 900/1800）
  - Vodafone（GSM 900/1800）

### ロシア

  - MTS（МТС） [モバイル・テレシステム](https://ja.wikipedia.org/wiki/モバイル・テレシステム "wikilink")
  - MegaFon（МегаФон）
  - ヴィンペルコム（VimpelCom） - Beeline（БиЛайн）
...
### トルコ
  ...
  - [タークセル](https://ja.wikipedia.org/wiki/タークセル "wikilink")（TKC）
...
### 台湾
  ...
  - [台湾大哥大](https://ja.wikipedia.org/wiki/台湾大哥大 "wikilink")（Taiwan Mobile）
  - [中華電信](../Page/中華電信.md "wikilink")（Chunghwa Telecom）
  - 遠傳電信（Far EasTone）
  - 台湾スター（Taiwan Star Telecom）
  - 亜太電信（Asia Pacific Telecom）

### タイ王国

  - [AIS](https://ja.wikipedia.org/wiki/アドバンスト・インフォ・サービス "wikilink")
  - DTAC - Total Access Communication telenorグループ（ノルウェー）
  - True Move - Orangeとの合弁
  - Happy - dtacのプリペイド携帯
  - a2network
...
### 中国（マカオ）
  ...
  - [數碼通](https://ja.wikipedia.org/wiki/數碼通 "wikilink")澳門（Smartone Macau）
  - 中国電信（China Telecom）

### フィリピン

  - Globe Telecom（GSM 900/1800）
  - Smart Communications（GSM 900/1800）
  - Innove Communications（GSM 900）
  - Digital Telecommunications Phils（GSM 1800）

### ベトナム

  - mobifone
  - Viettel Telecom(Tập đoàn Công nghiệp Viễn thông Quân đội)

### シンガポール

  - [SingTel](../Page/シンガポール・テレコム.md "wikilink")
  - [StarHub](https://ja.wikipedia.org/wiki/スターハブ "wikilink")
  - [M1](https://ja.wikipedia.org/wiki/モバイル・ワン "wikilink")

### マレーシア

  - [Celcom](https://ja.wikipedia.org/wiki/Celcom "wikilink")
  - [Maxis](https://ja.wikipedia.org/wiki/Maxis "wikilink")
  - [Digi](https://ja.wikipedia.org/wiki/Digi "wikilink") - telenorグループ（ノルウェー）

### オーストラリア

  -
  - [オプタス](../Page/オプタス.md "wikilink")（）
...
### ニュージーランド
  ...
  - [Vodafone](https://ja.wikipedia.org/wiki/ボーダフォン・ニュージーランド "wikilink")
  - [two degrees](http://twodegreestelecom.co.nz/)
  - [telecom nz](http://telecom.co.nz/)
  - Skinny
...
### チリ
  ...
  - [Smartcom](https://ja.wikipedia.org/wiki/Smartcom "wikilink")
