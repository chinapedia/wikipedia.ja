...
GW近似という名称は、クーロンポテンシャルを表すダイアグラムが波線つまり  のため  という変数名が使われ、これとグリーン関数の  を合わせて付けられている。

## 歴史と発展

GW近似が初めて登場した当時\[1\]は、通常のバンド計算（LDA）による結果からグリーン関数を非自己無撞着に求めて、LDAの結果からの一定の改善が得られた。その後、自己無撞着な過程を導入すると精度（実験結果との一致が）がむしろ悪くなる傾向があることが分かっている。これを回避し、より正しい結果を導く試みがなされている。更に、GW近似における[全エネルギー](https://ja.wikipedia.org/wiki/全エネルギー "wikilink")の計算も可能となりつつある（[2003年](../Page/2003年.md "wikilink")段階）が、それはLDAによる通常のバンド計算と比べはるかに大量の計算量を要求する（GW近似そのものも計算量は膨大である）。
...
[Category:固体物理学](https://ja.wikipedia.org/wiki/Category:固体物理学 "wikilink") [Category:量子力学](https://ja.wikipedia.org/wiki/Category:量子力学 "wikilink")
