...
[OEM](../Page/OEM.md "wikilink")と開発者には1994年12月\[9\]に、市場には1995年3月\[10\]に、UnixWare 2.0の出荷が開始された。UnixWare 2.0は[UNIX System V release 4.2MPカーネルをベースとし](https://ja.wikipedia.org/wiki/UNIX_System_V#SVR4.2MP "wikilink")、[マルチプロセッシング](https://ja.wikipedia.org/wiki/マルチプロセッシング "wikilink")のサポートが追加された。
