...
近接戦闘に特化したクラス。[甲冑](https://ja.wikipedia.org/wiki/甲冑 "wikilink")と盾で身を固め、剣や鎚、斧などでダメージを与える。[弓を使うことも出来るが](https://ja.wikipedia.org/wiki/弓_\(武器\) "wikilink")、Archeryスキルを習得出来ないため上達することはない。敵に大ダメージを与える[クリティカルヒット](https://ja.wikipedia.org/wiki/クリティカルヒット "wikilink")([会心の一撃](https://ja.wikipedia.org/wiki/会心の一撃 "wikilink"))を放つことが出来る。
...
[剣](../Page/剣.md "wikilink")も[弓も使いこなすことが出来るクラス](https://ja.wikipedia.org/wiki/弓_\(武器\) "wikilink")。[情報収集](https://ja.wikipedia.org/wiki/情報収集 "wikilink")能力にも長け、パーティリーダーにふさわしいクラスである。近接戦闘・間接攻撃のどちらにも威力を発揮し、視野外のモンスターや人の位置を察知する[索敵](https://ja.wikipedia.org/wiki/索敵 "wikilink")(Tracking)スキルを持つ（ダンジョン内では使えない）。「敵に察知される前に敵の位置を知る」ことが出来るため、それらを避けながら狩りを続けることが出来る。
...
攻撃力はそれほど高くないが、Stealthしたまま敵の背後から攻撃するBackstabに成功すれば、敵をスタン（[麻痺](../Page/麻痺.md "wikilink")）出来る上にFighterのクリティカルヒットよりも強い（敵一人につき一撃しか出せないこと、敵の背後をとるのが難しいことから、全体的にはクリティカルヒットの方が使いやすい）。カギの解除は他のクラスでもある程度可能だが、大金が眠るような宝箱はRogueしか外せないものが多い。[罠](https://ja.wikipedia.org/wiki/罠 "wikilink")の解除はRogueのみ可能である。最もプレイヤー数の少ないクラス。初心者には難しいが、最も金儲けがしやすい。
...
プライマリスキルは魔法(Magery/Wizard)、[瞑想](https://ja.wikipedia.org/wiki/瞑想 "wikilink")(Meditation)、毒付加(Poisoning)。毒付加はいずれ[魔法付与](https://ja.wikipedia.org/wiki/魔法付与 "wikilink")(Enchant Weapon)に変わる可能性がある。
...
また、ダメージ回復の重要な手段である[回復薬](https://ja.wikipedia.org/wiki/回復薬 "wikilink")([ポーション](https://ja.wikipedia.org/wiki/ポーション "wikilink"))を作ることができる(Alchemy/Cleric)。低回復薬(Lesser Heal Potion)、中回復薬(Greater Heal Potion)は店でも購入出来るが、最大回復薬(Full Heal Potion)はClericから購入するしかない。最大解毒薬(Full Detoxify Potion)も同じである。

プライマリスキルは僧侶魔法(Magery/Cleric)、調薬(Alchemy/Cleric)、治癒(Healing)。

#### Druid([魔獣](https://ja.wikipedia.org/wiki/魔獣 "wikilink")使い)

強力なペットを引き連れて戦わせるクラス。[調教](https://ja.wikipedia.org/wiki/調教 "wikilink")(Taming)レベルが上がるほど強いペットを仲間にすることができる。 ペットの攻撃はクリティカルヒットのような強力さはないが、疲れ知らずで長時間の戦闘でも武器のように攻撃力が弱るようなこともなく、サーバ不調時のタイムラグにも強い。ペットは成長することでヒットポイントや打撃力、走行速度が増加する。Druid自体、成長すればヒットポイントも高く、打撃戦にも魔法攻撃にも強いがやはり金属鎧を着けると魔法が使えない(魔法が使えないことを別にすれば、ペットへの攻撃コマンドは入力可能なので、Robeクラスの中では鎧を着ていても問題は少ない)。Druidが敵のターゲットを引き受け、ペットが背後から敵を攻撃する手段を使えば延々と冒険を続けることができる。以前は複数のペットを同時に使役出来たが、現在のバージョンでは1匹のみに限定されている。
...
大都市に比べて[城壁](https://ja.wikipedia.org/wiki/城壁 "wikilink")もややみすぼらしく、城門なども存在しないが衛兵がパトロールしている。2006年のアップデートが行われるまでは、全てのプレイヤーがここからスタートする設定であった。周辺にそれほど強力なモンスターも出ず、初心者用に墓場も[Skelton](https://ja.wikipedia.org/wiki/Skelton "wikilink")しか出現しない設定になっているため、今でも初心者プレイヤーが集まっていることが多い。大規模RTQは起こりにくいが、[墓場](https://ja.wikipedia.org/wiki/墓場 "wikilink")や[蟻塚](https://ja.wikipedia.org/wiki/蟻塚 "wikilink")で単発のRTQが起こる。
...
街は山に囲まれた盆地の中にあり、城壁などは存在しない。街というより集落に近く、いくつかのショップは中心部から離れたところに存在する。寺院やポータルは街からとても遠い。本来、[鉱石](https://ja.wikipedia.org/wiki/鉱石 "wikilink")採取(Mining)には有利な地形だが、銀行(Bank)がないため保存に手間がかかり、町中によくモンスターが出現するため常駐しているプレイヤーはほとんどいない。ポータルはBlueが配置されているが山の向こうに位置する為たどり着くのに巨大な岩山を回り込まねばならずかなり苦労する。店舗数が9軒とスタート時に選択できる拠点の中では一番規模が小さい。
