...
## 学術的な記号・単位
  ...
  - **Sv** - 被曝量の単位「**[シーベルト](../Page/シーベルト.md "wikilink")**」の単位記号。
  - **Sv** - 体積輸送量の単位「**[スヴェルドラップ](../Page/スベルドラップ.md "wikilink")**」 () の単位記号。10 m/s。
...
### 固有名詞
  ...
  - [シリコンバレー](../Page/シリコンバレー.md "wikilink") () の略
  - [スーパーバリュー](../Page/スーパーバリュー.md "wikilink") () - 埼玉の大規模小売企業。
  - [サターンV](../Page/サターンV.md "wikilink") () - アメリカの宇宙ロケット。
  - [Google ストリートビュー](https://ja.wikipedia.org/wiki/Google_ストリートビュー "wikilink") ()
  - [社会主義左翼党](https://ja.wikipedia.org/wiki/社会主義左翼党_\(ノルウェー\) "wikilink") () - ノルウェーの政党。
  - [スロヴェニア軍](https://ja.wikipedia.org/wiki/スロヴェニア軍 "wikilink") ([{{lang](https://ja.wikipedia.org/wiki/:en:Military_of_Slovenia "wikilink")) - [スロヴェニア](https://ja.wikipedia.org/wiki/スロヴェニア "wikilink")の軍隊。
  - [ベルギー国家保安庁](https://ja.wikipedia.org/wiki/ベルギー国家保安庁 "wikilink") ([{{nl](https://ja.wikipedia.org/wiki/:en:Belgian_State_Security_Service "wikilink")) - [ベルギー](https://ja.wikipedia.org/wiki/ベルギー "wikilink")の[諜報機関](https://ja.wikipedia.org/wiki/諜報機関 "wikilink")。
...
### 形式名
  ...
  - [スズキ・SV](../Page/スズキ・SV.md "wikilink") - [スズキのオートバイ](../Page/スズキ_\(企業\).md "wikilink")。

  - \- [MGローバー](../Page/MGローバー.md "wikilink")のスポーツカー。

## 関連項目

  - [ラテン文字のアルファベット二文字組み合わせの一覧](../Page/ラテン文字のアルファベット二文字組み合わせの一覧.md "wikilink")
  - [SVで始まる記事の一覧](https://ja.wikipedia.org/wiki/特別:Prefixindex/SV "wikilink")
  - [Sv,svで始まる記事の一覧](https://ja.wikipedia.org/wiki/特別:Prefixindex/Sv "wikilink")