> この記事は[Dec](https://ja.wikipedia.org/wiki/Dec)から翻訳されています。
...
## 算出手法
  ...
  - 国土交通省の道路交通センサスデータを利用する場合:歩行者、自転車、自動二輪車、自動車の平日、休日の1日のDECを計算し、さらに週平均のDECを算出する。
    ハンドカウントによって算出する場合:1日を3時間ずつ４つの時間帯に分け、各時間帯でいずれか15分間、歩行者、自転車、自動二輪車、自動車の平日、休日の2日間計測し、一日のDEC＝15×4×3×4とし、平日のDEC×5＋土日のDEC×2÷7で週平均のDECを算出する。

## 参考文献

  - W.Ronald Lane,Karen Whitehill King,J.Thomas Russell(2005)"Kleppner's Advertising Procedure,"16th ed.pp.355-371.
...
## 関連項目
  ...
  - [延べ視聴率](../Page/延べ視聴率.md "wikilink") - テレビCMの広告効果である到達率・平均接触回数を表す指標
  - [日本ABC協会](../Page/日本ABC協会.md "wikilink") - 新聞・雑誌広告の効果のもととなる発行部数の調査・公表を行う団体

## 外部リンク

  - [日本屋外広告フォーラム](http://www.okugai-forum.jp/index.html)
  - [（株）全日本ネオン協会](http://www.neon-jp.org/)

[Category:広告](https://ja.wikipedia.org/wiki/Category:広告 "wikilink") [Category:看板](https://ja.wikipedia.org/wiki/Category:看板 "wikilink") [Category:道路交通](https://ja.wikipedia.org/wiki/Category:道路交通 "wikilink")