> この記事は[CDDB](https://ja.wikipedia.org/wiki/CDDB)から翻訳されています。
...
CDDBは[1993年](../Page/1993年.md "wikilink")にTi Kanによって開発された。当初は彼の音楽再生ソフトである**xmcd**の機能の一部としてのローカルのデータベースだった。[1994年](../Page/1994年.md "wikilink")、初めて**CDDB**の名を冠したCDDB ver1.1がリリースされた。ユーザーがKanに[電子メール](../Page/電子メール.md "wikilink")を送る事でデータベースの項目追加ができた。

[1995年](https://ja.wikipedia.org/wiki/1995年 "wikilink")、KanとSteve Scherfはインターネットを通じてアクセスできるデータベースを開発、**CDDB Inc.**として運用が開始された。またCDDBは[GNU General Public Licenseで公開された](../Page/GNU_General_Public_License.md "wikilink")。

[1998年](https://ja.wikipedia.org/wiki/1998年 "wikilink")、**CDDB LLC**が発足したが間もなくKan、Scherf、ホスティングを提供していたGraham Toalはこれを[Escientに売却した](https://ja.wikipedia.org/wiki/:en:Escient "wikilink")。

[2000年](../Page/2000年.md "wikilink")、**CDDB Inc.**は**Gracenote**と名称を変更。当初、CDDBへのアクセスはフリーとアナウンスされたにも係らず、ライセンスは変更された。これを受けCDDB同等の[freedb](https://ja.wikipedia.org/wiki/freedb "wikilink")といったフリーサービスも登場した。

[2001年](../Page/2001年.md "wikilink")、Gracenoteは非ライセンスのソフトウェアのアクセスを禁止し、オリジナルのCDDBのバージョン**CDDB1**へのライセンスは無効となった。そして、GracenoteはCDDB1及びfreedbとは非互換の**CDDB2**への移行を推し進めた。CDDB2より2バイト文字に対応し、日本語等も扱えるようになった。

[2008年](https://ja.wikipedia.org/wiki/2008年 "wikilink")、[ソニー](../Page/ソニー.md "wikilink")の米国子会社（ソニー・コーポレーション・オブ・アメリカ）がGracenoteを買収した。
...
## CDDBサービスと利用ソフトウェア
  ...
  - [Gracenote](../Page/Gracenote.md "wikilink")
      ...
      - [iriver Plus](https://ja.wikipedia.org/wiki/iriver_Plus "wikilink")
      ...
      - [RealPlayer](../Page/RealPlayer.md "wikilink") （バージョン10.5まで）
  ...
  - GD3
  - Moozone
  - [Pandora](https://ja.wikipedia.org/wiki/Pandora "wikilink")
