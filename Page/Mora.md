> この記事は[Mora](https://ja.wikipedia.org/wiki/Mora)から翻訳されています。


**mora**（モーラ）は、[ソニー・ミュージックエンタテインメントグループの](https://ja.wikipedia.org/wiki/ソニー・ミュージックエンタテインメント_\(日本\) "wikilink")[レーベルゲート](../Page/レーベルゲート.md "wikilink")が運営する[日本](https://ja.wikipedia.org/wiki/日本 "wikilink")の[音楽配信](../Page/音楽配信.md "wikilink")サービスサイト。

尚、2019年11月より開始した高音質ストリーミング配信サービス**mora qualitas**（モーラ クオリタス）についてもこの項で記載する。
...
2012年のリニューアル以前は、[SME傘下のレコード会社所属アーティストとはmoraの独占配信契約を結んでいたため](https://ja.wikipedia.org/wiki/ソニー・ミュージックエンタテインメント_\(日本\) "wikilink")、所属アーティストの楽曲はmoraでしか購入することが出来なかった。

2012年のリニューアル以降は、他社サービスへの楽曲配信、スマホ対応化、ハイレゾ対応を順次行なっていき、2019年11月より高音質ストリーミング配信サービス「mora qualitas」をPC・Mac向けに開始した。

尚、所属アーティストのmoraとmora qualitasへの楽曲配信は別契約となっており、moraで配信されている楽曲が必ずしもmora qualitasでも配信されているとは限らない。

### 2012年9月まで（OpenMG時代）

2004年3月の開始当初から2012年9月までは、レーベルゲートCD2のファイル音源再生に使用されていた、[ソニー](../Page/ソニー.md "wikilink")の[OpenMG Xを採用した](https://ja.wikipedia.org/wiki/OpenMG "wikilink")「レーベルゲートMQ」方式を使用し、楽曲フォーマットは[ATRAC3](https://ja.wikipedia.org/wiki/ATRAC#ATRAC3_/_ATRAC3plus "wikilink") / ATRAC3plus、ビットレートは132kbpsが中心であった。

このOpenMG XとATRACフォーマットによる楽曲ファイルの利用には制約が多く、[x-アプリ](https://ja.wikipedia.org/wiki/x-アプリ "wikilink")（以前の[SonicStage](https://ja.wikipedia.org/wiki/SonicStage "wikilink")等も含む）などの専用ソフトウェアをインストールしたWindows PCとソニーの[ウォークマン](../Page/ウォークマン.md "wikilink")（2007年以降の海外向け機種(型番の頭がNWZ-)及び国内向けの一部機種(型番の頭がNWD-)を除く）を中心とした一部の機器（詳しくは[ATRAC Audio Deviceを参照](https://ja.wikipedia.org/wiki/ATRAC_Audio_Device "wikilink")）の組み合わせでしか利用できなかった。[2012年](../Page/2012年.md "wikilink")[3月29日](../Page/3月29日.md "wikilink")をもってサービスを終了した[mora winについてもほぼ同様で](https://ja.wikipedia.org/wiki/mora_win "wikilink")、[Microsoft Windows](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink") PCと対応する携帯電話/スマートフォン数機種でしか利用できなかった。仕様上、[macOS](https://ja.wikipedia.org/wiki/macOS "wikilink")や[iOSには非対応だったため](https://ja.wikipedia.org/wiki/iOS_\(アップル\) "wikilink")、[iPod](https://ja.wikipedia.org/wiki/iPod "wikilink")、[iPhone](https://ja.wikipedia.org/wiki/iPhone "wikilink")、[iPad](https://ja.wikipedia.org/wiki/iPad "wikilink")では利用不可能だった。
...
ただし、AACに付加されているメタデータが原因で、[iPhone](https://ja.wikipedia.org/wiki/iPhone "wikilink")や[iPod touchなどの](https://ja.wikipedia.org/wiki/iPod_touch "wikilink")[iOS機器については](https://ja.wikipedia.org/wiki/iOS_\(アップル\) "wikilink")、転送はできるものの再生できない問題が生じており、[iTunes](https://ja.wikipedia.org/wiki/iTunes "wikilink")で再エンコードするなど一手間加える必要があった\[5\]。2012年12月にリリースされた「moraダウンローダー」（[ウェブブラウザ](../Page/ウェブブラウザ.md "wikilink")からの購入・ダウンロード向けサポートソフト）でダウンロードを行うとこの問題は発生しない。

### mora qualitas

2019年11月より高音質ストリーミング配信サービスを開始。配信楽曲数は非公表。当初は2019年春のサービス開始を目指したが、開始が延期となったため、競合するAmazon Music HDが日本国内初のハイレゾ対応ストリーミング配信サービスとなった。

開始当初の対応機種はPC及びMacのみ。2020年2月にiOS/Android用にもアプリを配信開始したことにより、ウォークマン、XPERIAがソニー製品では初めての対応となった。配信楽曲を聴くにはmora qualitasアプリをインストールする必要がある。

最大の特徴として、排他モードを採用しており、競合するAmazon Music HDよりも高音質と言われているが、実際には従前のPCオーディオユーザー向けに用意したモードである。
...
<!-- end list -->
  ...
  -
    それまでレコード会社毎に独立していたEMDサイトが、[iTunes Storeに倣う形で](https://ja.wikipedia.org/wiki/iTunes_Store "wikilink")[ポータルサイト](../Page/ポータルサイト.md "wikilink")のように集約されることになる。
...
<!-- end list -->
  ...
  - [2012年](../Page/2012年.md "wikilink")3月29日 - 「mora win」のサービス終了。
  ...
  - 2012年10月1日 - 「**WALKMAN公式ミュージックストア**」と銘打ち**全面リニューアル**。[AAC](../Page/AAC.md "wikilink")-LC 320Kbps、DRMフリーで配信開始。同時にブラウザ版、スマートフォン用アプリケーションで提供開始。
...
[x-アプリ](https://ja.wikipedia.org/wiki/x-アプリ "wikilink")等の対応ソフトを[ダウンロード](https://ja.wikipedia.org/wiki/ダウンロード "wikilink")の上で、moraサイト上で決済した後で楽曲のダウンロードが可能となっていた。また、楽曲毎に[ウォークマン](../Page/ウォークマン.md "wikilink")等への転送回数やCD作成回数が異なっていた。
...
<tr class="even">
<td><p><a href="https://ja.wikipedia.org/wiki/Media_Go" title="wikilink">Media Go</a><br />
（Ver. 2.5a以降）</p></td>
<td><p>ハイレゾ音源を利用する場合<br />
...
<tr class="odd">
<td><p><a href="https://ja.wikipedia.org/wiki/x-アプリ" title="wikilink">x-アプリ</a><br />
（Ver. 4.0以降）</p></td>
<td><p>ハイレゾ音源を利用する場合（Ver. 6.0以降）<br />
USB-DACやビットパーフェクト再生（<a href="../Page/ASIO.md" title="wikilink">ASIO</a>/<a href="https://ja.wikipedia.org/wiki/WASAPI" title="wikilink">WASAPI</a>）を利用する場合（同上）<br />
2013年以前に発売されたウォークマンを利用している場合<br />
<a href="https://ja.wikipedia.org/wiki/LISMO_Port" title="wikilink">LISMO Port</a>、旧<a href="https://ja.wikipedia.org/wiki/SonicStage" title="wikilink">SonicStage</a>を利用している場合<br />
2012年9月以前に購入したDRM付楽曲を利用している場合</p></td>
<td><p>.mp4</p></td>
<td></td>
</tr>
<tr class="even">
<td><p>moraダウンローダー</p></td>
<td><p><a href="https://ja.wikipedia.org/wiki/iTunes" title="wikilink">iTunes</a>や<a href="https://ja.wikipedia.org/wiki/iOS_(アップル)" title="wikilink">iOS端末を利用する場合</a><br />
ブラウザからダウンロードする場合<br />
<a href="https://ja.wikipedia.org/wiki/macOS" title="wikilink">OS Xでダウンロードする場合</a></p></td>
<td><p>.m4a</p></td>
<td><p>.m4v</p></td>
</tr>
<tr class="odd">
...
2020年5月現在、対応機種はPC及びMac、iOS/Androidの機種のみ。専用アプリのインストールが必須。月額料金は1,980円で、登録後30日間は無料お試し期間も用意される。

  - 配信フォーマット
    [FLAC](../Page/FLAC.md "wikilink") 44.1～192kHz/16Bit〜24bitでのストリーミング配信。一部のアーティスト楽曲は[AAC](../Page/AAC.md "wikilink")-LC 320kbpsでのストリーミング配信。

### 決済方法

以前はSonicStageとWebブラウザでは使用できる決済方法が異なっていたが、2007年5月から、同じ方法となる。

  - [VISA](../Page/Visa.md "wikilink")、[MasterCard](../Page/マスターカード.md "wikilink")、[JCB](../Page/ジェーシービー.md "wikilink")、[AMEX](../Page/アメリカン・エキスプレス.md "wikilink")、[Dinersブランドの](../Page/ダイナースクラブ.md "wikilink")[クレジットカード](../Page/クレジットカード.md "wikilink")、[デビットカード](../Page/デビットカード.md "wikilink")および[プリペイドカード](../Page/プリペイドカード.md "wikilink")\[11\]
  - [Yahoo\!ウォレット](../Page/Yahoo!ウォレット.md "wikilink")
  - [楽天](https://ja.wikipedia.org/wiki/楽天 "wikilink")ペイ
  - [Amazon Pay](../Page/Amazon.co.jp.md "wikilink")
  ...
  - [ドコモケータイ払い](https://ja.wikipedia.org/wiki/NTTドコモ "wikilink") - Androidアプリのみ（現在は利用不可）
  - [ソフトバンクまとめて支払い](https://ja.wikipedia.org/wiki/ソフトバンクモバイル "wikilink") - Androidアプリのみ（現在は利用不可）

[クレジットカード](../Page/クレジットカード.md "wikilink")決済は、1か月分の利用額を1つにまとめ、末日付け請求となる。決済を済ませてもダウンロードしなければ請求されない。各種[電子マネー](../Page/電子マネー.md "wikilink")で決済した場合は8日以降に返金される。楽天Edyは「Edyギフト」で返金されていた。なお、[SonicStage](https://ja.wikipedia.org/wiki/SonicStage "wikilink")、[x-アプリ](https://ja.wikipedia.org/wiki/x-アプリ "wikilink")での楽曲購入は自動的にダウンロード処理に入るため、キャンセルできない。
...
端末の仕様により、ハイレゾ音源の一部の楽曲情報が表示されない場合がある。
  ...
  - [ソニーモバイル](../Page/ソニーモバイルコミュニケーションズ.md "wikilink")
      - [Xperia](https://ja.wikipedia.org/wiki/Xperia "wikilink")シリーズ
          ...
          - [Xperia Z3](https://ja.wikipedia.org/wiki/Sony_Xperia_Z3 "wikilink") ([SO-01G](https://ja.wikipedia.org/wiki/SO-01G "wikilink"), [SOL26](https://ja.wikipedia.org/wiki/SOL26 "wikilink"), [SoftBank 401SO](https://ja.wikipedia.org/wiki/SoftBank_401SO "wikilink"))
          - [Xperia Z3 Compact SO-02G](https://ja.wikipedia.org/wiki/SO-02G "wikilink")



\*[サムスン電子](../Page/サムスン電子.md "wikilink")

  -   - [GALAXYシリーズ](https://ja.wikipedia.org/wiki/Samsung_Galaxy "wikilink")
          - [GALAXY Note 3](https://ja.wikipedia.org/wiki/Samsung_Galaxy_Note_3 "wikilink") ([SC-01F](https://ja.wikipedia.org/wiki/SC-01F "wikilink")、[SCL22](https://ja.wikipedia.org/wiki/SCL22 "wikilink"))
          - [GALAXY J SC-02F](https://ja.wikipedia.org/wiki/SC-02F "wikilink")
          - [GALAXY S5](https://ja.wikipedia.org/wiki/Samsung_Galaxy_S5 "wikilink") ([SC-04F](https://ja.wikipedia.org/wiki/SC-04F "wikilink")、[SCL23](https://ja.wikipedia.org/wiki/SCL23 "wikilink"))
          - [GALAXY Note Edge](https://ja.wikipedia.org/wiki/Samsung_Galaxy_Note_Edge "wikilink") ([SC-01G](https://ja.wikipedia.org/wiki/SC-01G "wikilink")、[SCL24](https://ja.wikipedia.org/wiki/SCL24 "wikilink"))
          - [GALAXY S5 Active SC-02G](https://ja.wikipedia.org/wiki/SC-02G "wikilink")
...
## 関連項目
  ...
  - [mora win](https://ja.wikipedia.org/wiki/mora_win "wikilink") - 2012年3月29日にサービス終了
  - [Playlog](../Page/Playlog.md "wikilink") - 2011年5月にサービス終了
  - [bitmusic](https://ja.wikipedia.org/wiki/bitmusic "wikilink")
  - [MAGIQLIP](https://ja.wikipedia.org/wiki/MAGIQLIP "wikilink")
  ...
  - [モーラその後に](https://ja.wikipedia.org/wiki/モーラその後に "wikilink") - iOS機器で問題の出るメタデータを削除できるフリーソフト
...
## 外部リンク
  ...
  -
  -
  - [レーベルゲート](https://labelgate.com/)

[Category:音楽配信サービス](https://ja.wikipedia.org/wiki/Category:音楽配信サービス "wikilink") [Category:ソニー](https://ja.wikipedia.org/wiki/Category:ソニー "wikilink") [Category:ソニー・ミュージックエンタテインメント_(日本)](https://ja.wikipedia.org/wiki/Category:ソニー・ミュージックエンタテインメント_\(日本\) "wikilink")

1.
2.
3.
4.  現在、これらのソフト内でmoraにアクセスするとリニューアルに伴う当該ソフトでのサービス終了のお知らせとx-アプリ(4.0)のダウンロード及びブラウザ版moraへのリンクが張られた専用ページ（[x-アプリ(3.0以前)](http://mora.jp/etc/versionup_x)/[SonicStage](http://mora.jp/etc/versionup_sonic)/[CONNECT Player](http://mora.jp/etc/versionup_cp)/[LISMO Port(4.4以前)](http://mora.jp/etc/versionup_lismo)）へ飛ぶようになっている。
5.
6.  [Mora、globeの最新アルバム収録曲を256kbpsで配信](http://bb.watch.impress.co.jp/cda/news/13388.html)
7.  Ver.2.5a以降。
8.
9.  DSDIFFのメタデータの格納方法に不備があったためとしている。
10. [PS Vitaの場合](https://ja.wikipedia.org/wiki/PlayStation_Vita "wikilink")、コンテンツ管理アシスタントの参照先をMedia Goの参照先に設定すれば利用可能。
11. [VISAデビットカードおよびワンタイムデビットでの利用は](../Page/デビットカード.md "wikilink")2011年8月31日をもって停止となったが、2012年6月6日の決済システムメンテナンス後から再度利用可能となっている。
