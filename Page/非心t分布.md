...
非心な統計[母数](https://ja.wikipedia.org/wiki/母数 "wikilink")、例えば「 の上位10パーセント値」のようなものの[信頼区間](https://ja.wikipedia.org/wiki/信頼区間 "wikilink")を標本データだけに基いて計算するのに有用である。

## 非心t分布の特徴

*Z* は[分散](../Page/分散_\(確率論\).md "wikilink") 、[平均](../Page/平均.md "wikilink") 0 の[正規分布](https://ja.wikipedia.org/wiki/正規分布 "wikilink") に従う[確率変数](https://ja.wikipedia.org/wiki/確率変数 "wikilink") 、*V* は自由度 νの[カイ二乗分布](https://ja.wikipedia.org/wiki/カイ二乗分布 "wikilink")に従いかつ、*Z* と独立な確率変数、μは実定数としたときに、
...
この非心t分布の[累積分布関数](https://ja.wikipedia.org/wiki/累積分布関数 "wikilink")は、以下の式で与えられる。\[1\]
...
\[I_y\,\!(a,b)\] は、正則化された[不完全ベータ関数](https://ja.wikipedia.org/wiki/不完全ベータ関数 "wikilink"),

\[y=\frac{x^2}{x^2+\nu},\]

\[p_j=\frac{1}{j!}\exp\left\{-\frac{\mu^2}{2}\right\}\left(\frac{\mu^2}{2}\right)^j,\]

\[q_j=\frac{\mu}{\sqrt{2}\Gamma(j+3/2)}\exp\left\{-\frac{\mu^2}{2}\right\}\left(\frac{\mu^2}{2}\right)^j,\] であり、 Φ は、標準正規分布の[累積分布関数](https://ja.wikipedia.org/wiki/累積分布関数 "wikilink")である。
...
\end{cases}\] ここで、 Γ は [ガンマ関数](../Page/ガンマ関数.md "wikilink") 、 *I* は、正則化された[不完全ベータ関数](https://ja.wikipedia.org/wiki/不完全ベータ関数 "wikilink")である。

### 確率密度関数

この非心t分布の[確率密度関数](https://ja.wikipedia.org/wiki/確率密度関数 "wikilink")は\[2\]
...
## 関連事項
  ...
  - [カイ二乗分布](https://ja.wikipedia.org/wiki/カイ二乗分布 "wikilink")
