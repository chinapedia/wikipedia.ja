...
<File:Mandrake> 8.0 install screenshot.png|Installation screen of Linux-Mandrake 8.0 [File:Mandriva_Linux-LE2005.png|Limited](File:Mandriva_Linux-LE2005.png%7CLimited) Edition 2005 - GNOME 2.8 Desktop [File:Mandriva_2006_Screenshot.png|2006](File:Mandriva_2006_Screenshot.png%7C2006) Free Edition - GNOME 2.10 Desktop [File:Mandriva-2007-spring-ja.png|2007](File:Mandriva-2007-spring-ja.png%7C2007) Spring Edition - GNOME 2.18 Desktop [File:Mandriva_2007_screenshot-ja.png|2007](File:Mandriva_2007_screenshot-ja.png%7C2007) Free Edition - GNOME 2.16 Desktop [File:Mandriva_Linux_2011.png|Mandriva](File:Mandriva_Linux_2011.png%7CMandriva) Linux 2011 デスクトップ

[Live CD版のMandriva](../Page/Live_CD.md "wikilink") Oneには、[GNOME](../Page/GNOME.md "wikilink")版と[KDE](../Page/KDE.md "wikilink")版がある。

Image:MandrivaOne 2008.1.jpg|Mandriva Linux One's Live CD
...
[Mandriva_RPMDrake.png](https://ja.wikipedia.org/wiki/File:Mandriva_RPMDrake.png "fig:Mandriva_RPMDrake.png"), Mandriva's graphical package manager\]\] Mandriva Linuxには、rpmdrakeというグラフィカルなパッケージ管理ツールも用意されている。実質的にはurpmiによって内部処理が実行される。
...
[RedHatFamilyTree1210.svg](https://ja.wikipedia.org/wiki/File:RedHatFamilyTree1210.svg "fig:RedHatFamilyTree1210.svg")
...
| 配布版                                                                 | 説明                            |
| ------------------------------------------------------------------- | ----------------------------- |
| [Mageia](https://ja.wikipedia.org/wiki/Mageia "wikilink")           | Mandriva Linuxを母体に開発。オープンソース。 |
...
※[apt-rpm系派生版一覧に掲載](https://ja.wikipedia.org/wiki/:en:List_of_Linux_distributions#apt-rpm_based "wikilink")。も参照。
...
[Category:Mandriva](https://ja.wikipedia.org/wiki/Category:Mandriva "wikilink") [Category:Mandriva_Linux派生ディストリビューション](https://ja.wikipedia.org/wiki/Category:Mandriva_Linux派生ディストリビューション "wikilink") [Category:Red_Hat派生ディストリビューション](https://ja.wikipedia.org/wiki/Category:Red_Hat派生ディストリビューション "wikilink")
