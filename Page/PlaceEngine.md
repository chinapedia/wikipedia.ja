...
GPSは、カーナビや航空機・船舶において既に普及していた。しかし都心のビルの谷間や地下ではＧＰＳの電波を受け取ることが出来ない上、現在地取得に時間がかかるなどのデメリットがあった。 そこで、株式会社[ソニーコンピュータサイエンス研究所](https://ja.wikipedia.org/wiki/ソニーコンピュータサイエンス研究所 "wikilink")インタラクションラボラトリー室長の[暦本純一](https://ja.wikipedia.org/wiki/暦本純一 "wikilink")が、実世界指向インターフェイス研究の一環においてPlaceEngineを発案し,当時ソニーCSL研究員であった末吉隆彦 、塩野崎敦らと共に開発した。
...
## 歴史
  ...
  - [2008年](https://ja.wikipedia.org/wiki/2008年 "wikilink")
      ...
      - [Skype](https://ja.wikipedia.org/wiki/Skype "wikilink")で位置を交換するコミュニケーションツール「おともだちレーダーPlaceEngine for Skype」を公開
...
<!-- end list -->
  ...
  - [PlayStation Portable用PlaceEngine対応ソフト](https://ja.wikipedia.org/wiki/PlayStation_Portable "wikilink")　　
...
<!-- end list -->
  ...
  - [Android](https://ja.wikipedia.org/wiki/Android "wikilink")用ソフトウェア
...
## 動作環境
  ...
  - [パソコン](../Page/パーソナルコンピュータ.md "wikilink")
      ...
      - [Linux](https://ja.wikipedia.org/wiki/Linux "wikilink")（法人向け）
  - ゲーム機
      - PSP/PSP go
  - スマートフォン
      - Android
      - iPhone
      - Windows Mobile
  - [Mylo](https://ja.wikipedia.org/wiki/Mylo "wikilink")
