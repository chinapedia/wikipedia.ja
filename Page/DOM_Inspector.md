...
Thunderbirdは[Mozilla Add-onsにて提供されている専用の](https://ja.wikipedia.org/wiki/Mozilla_Add-ons "wikilink")[DOM Inspector](https://addons.mozilla.org/thunderbird/addon/1806)をインストールすることで利用可能になる。
...
## 関連項目
  ...
  - [拡張機能](https://ja.wikipedia.org/wiki/拡張機能_\(Mozilla\) "wikilink")
