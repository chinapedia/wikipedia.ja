...
<!-- end list -->
  ...
  -
    [産業技術総合研究所](../Page/産業技術総合研究所.md "wikilink")からリリースされている、HTTPブート[クノーピクスのTPM利用版](../Page/KNOPPIX.md "wikilink")。TPMのプラットフォーム検証技術を利用して、[ブート](../Page/ブート.md "wikilink")シーケンスが改ざんされていないかを監視することが可能
