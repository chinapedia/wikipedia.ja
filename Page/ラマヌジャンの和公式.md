...
\end{align}\] であるから、\(|q|<1,|z|<1,|b|<|az|,|b|<1,|a|>|q|\)で収束する。従って、両辺とも\(b\)の関数として考えれば\(b=0\)で[正則であり](https://ja.wikipedia.org/wiki/正則関数 "wikilink")、\(b=q^k\to0\)で両辺が一致するから[一致の定理](https://ja.wikipedia.org/wiki/一致の定理 "wikilink")により大局的にも一致する。
