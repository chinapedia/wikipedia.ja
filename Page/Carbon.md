...
[QuickTime](../Page/QuickTime.md "wikilink")チームがAPIをMac OS Xに移植するために互換レイヤーを作成したものが元型となっている。それが[スティーブ・ジョブズ](../Page/スティーブ・ジョブズ.md "wikilink")の目に留まり、汎用の互換フレームワークのアイディアとして採用された。Toolbox APIの中で明らかにレガシーなもの、あまり使われていないものを廃し、また内部構造が[32ビット](https://ja.wikipedia.org/wiki/32ビット "wikilink")を前提として再設計されている（Toolboxは[16ビット](https://ja.wikipedia.org/wiki/16ビット "wikilink")コードで、[PowerPC](../Page/PowerPC.md "wikilink")の性能の足枷となっていた）。
...
[Mac OS X v10.2から](https://ja.wikipedia.org/wiki/Mac_OS_X_v10.2 "wikilink")[Mac OS X v10.4にかけて](https://ja.wikipedia.org/wiki/Mac_OS_X_v10.4 "wikilink")、CarbonはCocoaを模したHIObject(カスタムコントロールを作成するための機能セット)の導入や、Mac OS X全体の共有基盤といえる[Core Foundationとの互換性強化など](https://ja.wikipedia.org/wiki/Core_Foundation "wikilink")、Cocoa同等の開発基盤として、徐々に構造の近代化が計られた。

しかしながら[Mac OS X v10.5での](https://ja.wikipedia.org/wiki/Mac_OS_X_v10.5 "wikilink")[64ビット](https://ja.wikipedia.org/wiki/64ビット "wikilink")対応はUI部分が見送られ\[1\]、64ビット完全対応にはCocoaへの移行が必須となるなど、アップルはGUI[フロントエンド](https://ja.wikipedia.org/wiki/フロントエンド "wikilink")としてのCarbonを徐々にフェードアウトさせ、Cocoaをメインとする姿勢を強めている。[Mac OS X v10.6では従来Carbonベースだった](https://ja.wikipedia.org/wiki/Mac_OS_X_v10.6 "wikilink")[QuickTime](../Page/QuickTime.md "wikilink")と[Finder](https://ja.wikipedia.org/wiki/Finder "wikilink")がCocoaで作り直されている。将来的にはMac OS XにおけるCarbon APIは[クロスプラットフォーム](https://ja.wikipedia.org/wiki/クロスプラットフォーム "wikilink")の共有基盤を担う低レベルレイヤーとして位置づけられていくことになるとみられる。

なおMac OS XはPowerPC CPUのみならず、[インテル](https://ja.wikipedia.org/wiki/インテル "wikilink")CPU上へも移植された。[Intel Mac版Mac](https://ja.wikipedia.org/wiki/Intel_Mac "wikilink") OS XではCFM Carbonのアプリケーションはネイティブには動作せず、[OS X Lionで廃止された](https://ja.wikipedia.org/wiki/Mac_OS_X_Lion "wikilink")[Rosetta](https://ja.wikipedia.org/wiki/Rosetta "wikilink")と呼ばれる環境の上で動作していた。Intel Mac版Mac OS Xが登場した頃は、CocoaアプリケーションとMach-O Carbonアプリケーションは再コンパイルすることでネイティブに動作するとされていた。[macOS Catalinaでは](https://ja.wikipedia.org/wiki/macOS_Catalina "wikilink")、32bitアプリケーションは動作しない為、CarbonアプリケーションはCocoaでの作り直しが必要であり、Cocoaアプリケーションも64bit化が必須である。
