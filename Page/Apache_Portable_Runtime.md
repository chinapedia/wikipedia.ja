...
APRはもともとは Apache HTTP Server の一部だったが、現在では[Apacheソフトウェア財団](../Page/Apacheソフトウェア財団.md "wikilink")の中の独立したプロジェクトとなっていて、Apache HTTP Server 以外のアプリケーションからもクロスプラットフォームのために使われている。
...
APRに含まれるプラットフォーム非依存の機能：
  ...
  - [ソケットとプロトコル](../Page/ソケット_\(BSD\).md "wikilink")
  - [スレッド](../Page/スレッド_\(コンピュータ\).md "wikilink")、[プロセス](../Page/プロセス.md "wikilink")、[ミューテックス](../Page/ミューテックス.md "wikilink")
