...
単機能のハンドヘルドGPSは、現在位置（[緯度](../Page/緯度.md "wikilink")・[経度](../Page/経度.md "wikilink")）、移動軌跡等を[液晶ディスプレイ](https://ja.wikipedia.org/wiki/液晶ディスプレイ "wikilink")に表示したり、移動軌跡を内蔵[メモリー](https://ja.wikipedia.org/wiki/メモリー "wikilink")に保存する機能を持ったGPS受信機である。地図を入れ替えることで世界各国で活用できるものが多い。米国[ガーミン](https://ja.wikipedia.org/wiki/ガーミン "wikilink")社のeTrexが代表的な製品である。

最近では詳細な地図をインストールすることで細かい路地まで表示したり、移動軌跡を[SDメモリーカード](https://ja.wikipedia.org/wiki/SDメモリーカード "wikilink")に保存できたり、簡単な[ナビゲーション](https://ja.wikipedia.org/wiki/ナビゲーション "wikilink")の機能を持つものなどが登場している。
...
国内、海外を問わずGPS受信機を内蔵した[携帯電話](../Page/携帯電話.md "wikilink")が一般化している。付近の店舗情報を検索したり、さらに[カーナビゲーション](../Page/カーナビゲーション.md "wikilink")、乗換ナビゲーション、徒歩ナビゲーションなどの統合ナビゲーション機能を提供する。児童の誘拐防止など様々な活用がなされている。
...
ハンドヘルドGPSは小型に作る必要があるため、[アンテナ](../Page/アンテナ.md "wikilink")の性能が低くなる。また、携帯して使用するため人体の影響を受けるほか、適正な仰角での保持も難しく、辛うじて実用になる状態であったが、従来よりも高感度なSiRF社のStarIIIチップを採用した製品も登場している。
...
[GPS腕時計](https://ja.wikipedia.org/wiki/GPS腕時計 "wikilink")タイプなど、さらに小型な製品も登場している。

### 業務用途の製品

[測量](../Page/測量.md "wikilink")用、[軍事](../Page/軍事.md "wikilink")用の製品がある。
...
## メーカー
  ...
  - [ガーミン](https://ja.wikipedia.org/wiki/ガーミン "wikilink")（[アメリカ合衆国](https://ja.wikipedia.org/wiki/アメリカ合衆国 "wikilink")）
  - エンペックス気象計
  - GlobalSat（台湾）

[Category:GPS](https://ja.wikipedia.org/wiki/Category:GPS "wikilink")