...
[1986年](https://ja.wikipedia.org/wiki/1986年 "wikilink")に「ロンサム・カーボーイ（Lonesome Car-boy）」から名称を変更した。変更される前にはフラッグシップモデルがカロッツェリア、通常モデルがパイオニア（ロンサム・カーボーイ）という位置付けであった。

カロッツェリアとしても2つのブランドに別れており、先進機能等を採用している[サイバーナビ](https://ja.wikipedia.org/wiki/サイバーナビ "wikilink")シリーズと、簡単操作を重視した[楽ナビ](https://ja.wikipedia.org/wiki/楽ナビ "wikilink")シリーズがある。

2007年からはサイバーナビで、[スマートループ](https://ja.wikipedia.org/wiki/スマートループ "wikilink")渋滞情報を開始している。また、渋滞情報は他社へも提供されている。現在は楽ナビでも使用できる。そして、2013年からはサイバーナビのみで、特定場所の画像を共有できる[スマートループアイが開始されている](https://ja.wikipedia.org/wiki/スマートループ_#スマートループアイ "wikilink")。

過去に存在した[デジタルツーカー](../Page/デジタルツーカー.md "wikilink")（現・[ソフトバンク](https://ja.wikipedia.org/wiki/ソフトバンク "wikilink")）のパイオニア製携帯電話端末に付けられた**CA**の記号は、この「**ca**rrozzeria」から来ている。
...
<!-- end list -->
  ...
  -
    世界初の市販用[GPSカーナビゲーションシステム](../Page/グローバル・ポジショニング・システム.md "wikilink")「AVIC-1」を発売。型番の「AVIC（エービック）」には「Audio Visual Infomation Communication」の意味が込められている。
...
<!-- end list -->
  ...
  -
    [光デジタル伝送方式による最高級デジタルオーディオシステム](../Page/光ケーブル.md "wikilink")「カロッツェリアX」シリーズを発売。
...
<!-- end list -->
  ...
  -
    世界初の[DVD](../Page/DVD.md "wikilink")カーナビゲーションシステム「AVIC-D909」を発売。
    このモデルより、ハイパフォーマンスモデルを「[サイバーナビ](https://ja.wikipedia.org/wiki/サイバーナビ "wikilink")（CYBER NAVI）」、普及モデルを「[楽ナビ](https://ja.wikipedia.org/wiki/楽ナビ "wikilink")」と2系統に分けてラインナップすることとなった。
...
<!-- end list -->
  ...
  -
    ...
    最大144kbpsの高速通信を用いて専用サーバーにアクセスするクライアント／サーバー型システム。[CDMA2000 1X規格通信モジュールを内蔵し](../Page/CDMA2000.md "wikilink")、検索やルート探索などのカーナビゲーションとしての処理はサーバー側で行なう。地図データアップデートも通信経由で行なわれる。
...
<!-- end list -->
  ...
  -
    ...
    通信によるユーザー間の渋滞情報提供機能「スマートループ」を「楽ナビ」および「エアーナビ」でも提供開始。また、サイバーナビと楽ナビの一部機種が[ウィルコム](../Page/ウィルコム.md "wikilink")のデータ通信専用通信モジュールを使用した「カーナビ専用サービス for carrozzeria」に対応。
...
<!-- end list -->
  ...
  -
    フロントカメラなどで構成する「クルーズスカウターユニット」との組み合わせでカメラ映像にナビゲーション情報を取り入れた「[ARナビゲーション](../Page/拡張現実.md "wikilink")」を実現。
...
<!-- end list -->
  ...
  -
    世界初の[電気自動車](../Page/電気自動車.md "wikilink")専用カーナビゲーションシステム「AVIC-ZH09-MEV」を発売開始。
...
<!-- end list -->
  ...
  -
    [レコチョク](https://ja.wikipedia.org/wiki/レコチョク "wikilink")の音楽ストリーミングサービスであるreplayを使用した「ミュージッククルーズチャンネル」をサイバーナビに導入。
...
### カーナビゲーション
  ...
  - [サイバーナビ](https://ja.wikipedia.org/wiki/サイバーナビ "wikilink")
      ...
      - AVIC-XHシリーズ (2007年まで)
  - [楽ナビ](https://ja.wikipedia.org/wiki/楽ナビ "wikilink")
  ...
  - EV用ナビ
      - AVIC-EVシリーズ [電気自動車](../Page/電気自動車.md "wikilink")及び[プラグインハイブリッド](https://ja.wikipedia.org/wiki/プラグインハイブリッド "wikilink")車用。楽ナビのMRZシリーズをベースにした機種もある。
  - Air navi（エアーナビ）
      - AVIC-Tシリーズ
  - ポータブルナビ
      - AVIC-MPシリーズ
...
### スマートフォンリンク
  ...
  - スマートフォンクレイドル
      - SDA-SC500 - 光学センサーを搭載した電動スマートホールドを採用したクレイドル。[qi規格のワイヤレス給電](https://ja.wikipedia.org/wiki/Qi_\(ワイヤレス給電\) "wikilink")(最大10Wの急速充電)にも対応。2系統シガーソケット用USBチャージャーと[USB Type-Cケーブルを付属](https://ja.wikipedia.org/wiki/USB_Type-C "wikilink")。
  - アプリユニット
      - SPHシリーズ
...
### カーオーディオ
  ...
  - [スズキ・ワゴンR](../Page/スズキ・ワゴンR.md "wikilink")純正オーディオシステム
...
### スピーカー
  ...
  - チューンアップトゥイーター
      - STシリーズ
      - Tシリーズ
  - また、過去には[ヘッドレスト](https://ja.wikipedia.org/wiki/ヘッドレスト "wikilink")に装着するユニークな車載スピーカーもラインナップされていた。
...
## 外部リンク
  ...
  - [carrozzeria | カーナビ/カーオーディオ | pioneer](http://pioneer.jp/carrozzeria/)
  - [ブランド＆イベント/カロッツェリアX](http://pioneer.jp/carrozzeria/carrozzeria_x/index.html)

[Category:パイオニアの製品](https://ja.wikipedia.org/wiki/Category:パイオニアの製品 "wikilink") [Category:日本の音響機器メーカー](https://ja.wikipedia.org/wiki/Category:日本の音響機器メーカー "wikilink") [Category:登録商標](https://ja.wikipedia.org/wiki/Category:登録商標 "wikilink") [Category:日本のブランド](https://ja.wikipedia.org/wiki/Category:日本のブランド "wikilink") [Category:カー用品](https://ja.wikipedia.org/wiki/Category:カー用品 "wikilink")