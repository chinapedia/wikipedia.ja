> この記事は[FINAL](https://ja.wikipedia.org/wiki/FINAL)から翻訳されています。
...
#### 外伝作品関連メカニック
  ...
  - 新龍神（しんりゅうじん）
    月龍と闇竜がシンメトリカルドッキングした闇に覆われた新月のような防御型に特化した合体ビークルロボ。月龍が右半身、闇竜が左半身となる。クールな性格同士の合体のためか、穏やかで丁寧な口調の性格となる。設計段階での想定外の合体のため、闇竜を侵食しているトリプルゼロを使って合体している。更にベターマンと合体することで重力制御等の能力を得る。
