...
[インターネット](../Page/インターネット.md "wikilink")における**自律システム** (**autonomous system**) （以下ASと略す）とは、1人の個人、グループ、または組織によって制御される1組の管理ルールによって管理されるネットワークである\[1\]。[インターネット](../Page/インターネット.md "wikilink")に繋がるひとつ（時に複数）の[ルーティングポリシー](https://ja.wikipedia.org/wiki/ルーティングポリシー "wikilink")配下にある[IPネットワークや](../Page/Internet_Protocol.md "wikilink")[ルータ](https://ja.wikipedia.org/wiki/ルータ "wikilink")の集合のことを言う。この新しい定義についての詳細は RFC 1930 を参照のこと。
...
日本では担当RIRである[APNICか](../Page/Asia-Pacific_Network_Information_Centre.md "wikilink")、日本のNIRである[JPNICに申請をし承認を得る](../Page/日本ネットワークインフォメーションセンター.md "wikilink")。 IANAのサイトではAS番号の割り振りを見ることができる\[2\]。
...
2.  [Autonomous System (AS) Numbers (IANA)](https://www.iana.org/assignments/as-numbers/as-numbers.xhtml)