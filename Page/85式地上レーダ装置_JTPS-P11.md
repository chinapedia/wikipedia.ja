...
下記のようなサブシステムから構成されており、JTPS-P11では[73式中型トラック](../Page/73式中型トラック.md "wikilink")に搭載可能なシェルタに、JTPS-P12では[82式指揮通信車](../Page/82式指揮通信車.md "wikilink")ベースの[装輪装甲車](https://ja.wikipedia.org/wiki/装輪装甲車 "wikilink")に収容されている\[1\]。

  - [送信部](../Page/送信機.md "wikilink") JT-P8
...
## 関連項目
  ...
  - [82式地上レーダ装置 JPPS-P10](../Page/82式地上レーダ装置_JPPS-P10.md "wikilink")（地上レーダ装置2号） - より小型で可搬式の戦場監視装置。
