...
[TCP/IP](https://ja.wikipedia.org/wiki/TCP/IP "wikilink")を介した端末エミュレータの接続には[SSH](../Page/Secure_Shell.md "wikilink")、[Telnet](../Page/Telnet.md "wikilink")、[rlogin](https://ja.wikipedia.org/wiki/rlogin "wikilink")等の機能を用いる。rloginとTelnetは、パスワードなども含めて、すべての通信内容を[平文](https://ja.wikipedia.org/wiki/平文 "wikilink")（[暗号化](https://ja.wikipedia.org/wiki/暗号化 "wikilink")されていない状態）で送受信する。極めて限定された用途であれば、それが必ずしも悪いわけではないが、インターネットを介した接続ではあまりに危険な行為である。したがって、近年は、SSHによる接続が一般的である。
...
## 実際の端末エミュレータ
  ...
  - X Window System上で動作するもの
      ...
      - [Konsole](https://ja.wikipedia.org/wiki/Konsole "wikilink") ([KDE](../Page/KDE.md "wikilink"))
  ...
  - Microsoft Windows上で動作するもの
      ...
      - [NetManage](https://ja.wikipedia.org/wiki/NetManage "wikilink")
          ...
          - RUMBA UNIX-HP（VT, [HP3000](https://ja.wikipedia.org/wiki/HP_3000 "wikilink") MPEエミュレータ）
