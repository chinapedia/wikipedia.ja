...
## 解説
  ...
  - ロンドン・レコーディングによる3枚目のアルバム。既発のシングルは収録されなかった。
...
1.  **キャンセル**
      -
        東芝「SUGAR CD」CMソング
2.  **止まらないRAILWAY**
3.  **Lovesong for somebody**
4.  **SHIKASHI**
5.  **Bond street**
6.  **24時間の反抗**
7.  **ルーレット**
8.  **Feel like I'm running**
9.  **NO PROBLEM**
10. **涙をF.O.して**
...
## 参加者クレジット
  ...
  - 作曲
      -
        筒美京平 (\#1,\#2,\#5,\#10)
        Nick Beggs (\#3)
        Gary Stevenson, Rop Curtis, Dave West (\#4)
        Limahr, D.Nakamoto, B.Griffin (\#6)
        John Deacon, Robert Ahwai (\#7)
        Manny Elias, Pete Byrn, Simon Clark (\#8)
        William Robinson (\#9)
  - 編曲
      -
        難波正司 (\#1,\#2,\#5,\#10)
        Guy Fletcher(\#3,\#4,\#6～\#9)
