...
[thumb](https://ja.wikipedia.org/wiki/画像:Ic-photo-Hitachi--HD6473238F10--\(H8-323-MCU\).JPG "wikilink") **H8**シリーズは[日立製作所](../Page/日立製作所.md "wikilink")（現在は[ルネサス エレクトロニクスとして分離](https://ja.wikipedia.org/wiki/ルネサス_エレクトロニクス "wikilink")）が開発した[マイクロコントローラ](https://ja.wikipedia.org/wiki/マイクロコントローラ "wikilink")である。ターゲットは[組み込み](https://ja.wikipedia.org/wiki/組み込み "wikilink")市場であり、様々な機能を内蔵した多岐な製品をシリーズ展開していた。形態としてはマスクROM版・ROMレス版のほかに、[EPROM](../Page/EPROM.md "wikilink")を内蔵したZTAT版のほか、[フラッシュメモリ](../Page/フラッシュメモリ.md "wikilink")を内蔵したF-ZTAT版がある。
