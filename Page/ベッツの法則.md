...
ベッツによる業績が一般的に知られており、最大効率となる値 16/27 = 59.3 %は**ベッツ係数**と呼ばれるが、[イギリス](https://ja.wikipedia.org/wiki/イギリス "wikilink")の[フレデリック・ランチェスター](https://ja.wikipedia.org/wiki/フレデリック・ランチェスター "wikilink")\[2\]も同様の結論を明らかにしている\[3\]。

## 概要

[250px](https://ja.wikipedia.org/wiki/画像:Betz_tube.svg "wikilink") まず途中に羽根車が設置されているチューブ状の[流管](https://ja.wikipedia.org/wiki/流管 "wikilink")を考え、はじめに速度*v*<sub>1</sub> であった流体が羽根車を通過し[仕事をすることによってその速度を減じ](https://ja.wikipedia.org/wiki/仕事_\(物理学\) "wikilink")、一定速度*v*<sub>2</sub> で遠方へ流れていくような状況を仮定する（*v*<sub>1</sub> \> *v*<sub>2</sub> ）。羽根車は薄い円盤状で流管の断面全体を覆っており、その面積は*S* とする。また、[圧力](../Page/圧力.md "wikilink")差は羽根車の回転面前後で局所的に生じているだけで両遠方では互いに等しいとする。
