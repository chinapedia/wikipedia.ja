...
**Windows Management Instrumentation** (**WMI**) は、[Windows Driver Modelへの拡張の一種で](https://ja.wikipedia.org/wiki/Windows_Driver_Model "wikilink")、システムの構成要素について情報収集と通知を行う[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink") (OS) の[インタフェースを提供する](../Page/インタフェース_\(情報技術\).md "wikilink")。WMI は[Distributed Management Task Force](https://ja.wikipedia.org/wiki/Distributed_Management_Task_Force "wikilink") (DMTF) の定めた [Web-Based Enterprise Management](../Page/Web-Based_Enterprise_Management.md "wikilink") (WBEM) と [Common Information Model](../Page/Common_Information_Model.md "wikilink") (CIM) 標準の[マイクロソフト](../Page/マイクロソフト.md "wikilink")による実装である。
...
このような状況から、[IT](../Page/情報技術.md "wikilink")[システム管理](../Page/システム管理.md "wikilink")の分野ではWMIに基づいたスクリプトや自動化プロシージャの開発が盛んになっている。単なるスクリプトだけでなく、[MOM](https://ja.wikipedia.org/wiki/Microsoft_Operations_Manager "wikilink")、[SMS](https://ja.wikipedia.org/wiki/Microsoft_Systems_Management_Server "wikilink")、ADS、[HP](../Page/ヒューレット・パッカード.md "wikilink") [OpenView](../Page/OpenView.md "wikilink") for Windows (HPOV)、[BMCソフトウェア](https://ja.wikipedia.org/wiki/BMCソフトウェア "wikilink")、[CAなどがWMIに基づいて管理情報を提供](https://ja.wikipedia.org/wiki/CA_\(企業\) "wikilink")/操作するユーザインタフェースを管理ソフトウェアに追加している。これによりスクリプト作成ができない管理者も、特にWMIに関する知識を学ばなくともWMIを利用可能となっている。もちろんWMIはスクリプトによって操作可能であるため、スクリプトを使えた方が選択肢は広がる。
