...
これまでNFLのスタジアムといえば、円形または楕円形の客席がフィールドを隙間なく囲むタイプのものが主流だった（[例1](https://ja.wikipedia.org/wiki/:commons:Image:Monstersf49park.png "wikilink")、[例2](https://ja.wikipedia.org/wiki/:commons:Image:Veterans_stade.png "wikilink")、[例3](https://ja.wikipedia.org/wiki/:commons:Image:Caropanters.png "wikilink")）。当スタジアムの客席は3層であるが、そのうち最上部は両エンドと両サイドで4つのセクションに分かれており、それぞれのセクションの間には何もない空間が広がっている。この隙間からはボルチモアの風景を望むことができる。

また、観客がスタジアムの入り口から客席まで移動するスロープ状の通路は、これまではスタジアムの外にあることが多かった（[例4](https://ja.wikipedia.org/wiki/:en:Image:Qualcomm-Stadium.800.jpg "wikilink")）。当スタジアムでは、それをスタジアム内に設置した。
