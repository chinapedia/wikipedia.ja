...
カプコンの[コンピュータRPG](../Page/コンピュータRPG.md "wikilink")シリーズ『[ブレス オブ ファイア](../Page/ブレス_オブ_ファイア.md "wikilink")』のナンバリング第5作。略称は「**ドラクォ**」。
...
オープニングおよびエンディングの[トゥーンレンダリング](../Page/トゥーンレンダリング.md "wikilink")によるアニメーションは[神風動画](../Page/神風動画.md "wikilink")が制作し、主題歌には[鬼束ちひろ](https://ja.wikipedia.org/wiki/鬼束ちひろ "wikilink")の「[Castle・imitation](../Page/Sugar_High.md "wikilink")」が採用された。
...
繰り返しゲームを行うためのシステム。正式名称はScenario OverLay（シナリオ・オーバーレイ）。ゲームオーバーまたはゲーム中で「ギブアップ」を選択した際、最初からまたは最終セーブポイントからゲームをやり直せる。最初からを選択した場合は装備品や所持金・スキル（後述）などの引き継ぐことができるほか、それまでのプレイでは見られなかった場面が追加されることがあり、プレイを繰り返すことでより深く物語を理解できるようになっている。

### D-カウンター

物語のある時点から、画面右上に、本作品においてD-カウンターと呼ばれる数値が常時表示されるようになる。この数値は「[竜](../Page/竜.md "wikilink")」の主人公に対する侵食率を表している。D-カウンターはゲーム中、移動や戦闘をすることで徐々に上昇し、後述するD-ダイブなど、竜の力を使用した場合は数値が大幅に上昇する。一度上昇した数値は一切減少せず、D-カウンターが100パーセントに達するとゲームオーバーになる。
...
戦闘に突入する際、プレイヤー側から剣で払う、銃で撃つなどして接触すると、接触したキャラクターが「EXターン」を獲得し、最初の1ターンだけ多く行動できる。逆に敵からの接触を受けると、敵側に先制攻撃される。一撃で倒せるような余りにも弱い敵を攻撃した際は戦闘を介さず倒すことができ、パーティ経験値のみを獲得できる。
...
<!-- end list -->
  ...
  - 共同体
    今作も共同体システムは登場する。街などにいる[妖精](../Page/妖精.md "wikilink")に話しかけるか、「フェアリドロップ」というアイテムを使用することで共同体へ移動できる。共同体ではアリの姿をした[ディクを作業員として雇用し](https://ja.wikipedia.org/wiki/#ディク "wikilink")、アリの巣を掘るように地中を掘削することで共同体を拡張していく。発見された空間には市場や研究所・銀行など、様々な部屋を設置できる。共同体の市場でのみ入手できるアイテムやスキルもある。
  - セーブ
  ...
  - デンジャールーム
    特定のフィールドに進入する、またはある条件を満たすとすべての出入口が封鎖され、BGMが変化して「デンジャールーム」と呼ばれる状態になる。脱出するには、そのフィールド内にいる敵を倒さなければならない。
  - ココン・ホレ
...
## 主な制作スタッフ
  ...
  - 竹下博信 - プロデューサー
  - 池原まこと - ディレクター
  - [吉川達哉](../Page/吉川達哉.md "wikilink") - キャラクターデザイン
  - [崎元仁](../Page/崎元仁.md "wikilink") - コンポーザー
...
## 主題歌
  ...
  - 「Castle・imitation」
    [作詞](../Page/作詞.md "wikilink") - [鬼束ちひろ](https://ja.wikipedia.org/wiki/鬼束ちひろ "wikilink")
    [作曲](../Page/作曲.md "wikilink") - 鬼束ちひろ
    [編曲](../Page/編曲.md "wikilink") - [羽毛田丈史](../Page/羽毛田丈史.md "wikilink")
    [歌](../Page/歌手.md "wikilink") - 鬼束ちひろ

CMおよびクレジットタイトルで使用されている。本作品の[サウンドトラック](../Page/サウンドトラック.md "wikilink")に、クレジットタイトルで使用された「Castle・imitation (BREATH OF FIRE V DRAGON QUARTER)」が収録されている。また、『[Sugar High](../Page/Sugar_High.md "wikilink")』の初回限定生産盤ボーナス8センチCDと、ベストアルバム『[SINGLES 2000-2003](../Page/SINGLES_2000-2003.md "wikilink")』にオリジナルバージョンが収録されている。
...
### その他
  ...
  - 教えたガール
    右手に[腹話術](../Page/腹話術.md "wikilink")の人形をはめている少女。行く先々で攻略の助言を提供する。
  - ジャジュの鑑定屋
    羽のついた角帽を被り、丸眼鏡をかけている少女。彼女に所定の料金を支払うことで、道中で入手した詳細不明の装備品を鑑定する。道具屋・武器屋と3人で一緒にいることが多い。
  - クリオの道具屋
    回復アイテムや罠に使用する爆弾などの消耗品を販売している少女。[ポンポン](../Page/ポンポン.md "wikilink")がついた帽子を被っている。[関西弁で会話をする](https://ja.wikipedia.org/wiki/近畿方言 "wikilink")。
  - アルマの武器屋
