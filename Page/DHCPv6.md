...
**Dynamic Host Configuration Protocol for IP Version 6**（DHCP for IPv6、**DHCPv6**）とは、[コンピュータ](../Page/コンピュータ.md "wikilink")が[ネットワーク接続する際に必要な情報を自動的に割り当てる](https://ja.wikipedia.org/wiki/コンピュータネットワーク "wikilink")[プロトコル](../Page/プロトコル.md "wikilink")の [IPv6](https://ja.wikipedia.org/wiki/IPv6 "wikilink") と共に用いられる版のことをいう。

[IPv4](https://ja.wikipedia.org/wiki/IPv4 "wikilink") と共に用いられる版は DHCPv4 と呼ばれるが、現在のところは単に [DHCP](https://ja.wikipedia.org/wiki/Dynamic_Host_Configuration_Protocol "wikilink") というときは DHCPv4 を指すことが多い。
...
<!-- end list -->
  ...
  - SIP サーバ・ドメイン名リスト (SIP Servers Domain Name List, 21) - 1 個以上の [SIP](https://ja.wikipedia.org/wiki/Session_Initiation_Protocol "wikilink") サーバのドメイン名を通知するために使用する \[RFC 3319\]。
...
<!-- end list -->
  ...
  - ネットワーク情報サービス (NIS) サーバ IPv6 アドレス・リスト (Network Information Service (NIS) Servers, 27) - 1 個以上の [NIS](https://ja.wikipedia.org/wiki/ネットワーク・インフォメーション・サービス "wikilink") サーバの IPv6 アドレスを通知するために使用する \[RFC 3898\]。
...
<!-- end list -->
  ...
  - SNTP サーバ IPv6 アドレス・リスト (Simple Network Time Protocol (SNTP) Servers, 31) - 1 個以上の [SNTP](https://ja.wikipedia.org/wiki/Simple_Network_Time_Protocol "wikilink") サーバの IPv6 アドレスを通知するために使用する \[RFC 4075\]。
