...
現在、国内では池部楽器店と[神田商会](../Page/神田商会.md "wikilink")がライセンス販売を行っている。
...
1990年代に入り、[今井寿](../Page/今井寿.md "wikilink")（[BUCK-TICK](../Page/BUCK-TICK.md "wikilink")）が使用し始めたことにより再び注目を浴び、1994年に三鷹楽器が東海楽器にストックされていた1980年代製ボディから復活させ販売。この売れ行きが好調だったことから、1996年に東海楽器が生産を再開すると、[HISASHI](../Page/HISASHI.md "wikilink")（[GLAY](../Page/GLAY.md "wikilink")）とのコラボレーションで“TALBO Secret FACTORY”が始動され、この中で更に斬新さが磨かれていくことになった。2003年には三鷹楽器が閉店したことに伴い、担当スタッフが池部楽器店へ移籍。同時にTALBO Secret FACTORYも移管された。
...
<table>
<caption><strong>初期モデル</strong></caption>
<thead>
<tr class="header">
<th><p>出荷時期</p></th>
<th><p>モデル</p></th>
...
<tr class="odd">
<td><p>ハムバッカー P1-26BB×2</p></td>
<td><p>シングル・コイル P2-71B×3</p></td>
<td></td>
<td></td>
<td></td>
</tr>
...
<tr class="odd">
<td><p>トレモロレス・オリジナル</p></td>
<td><p>2点支持式トレモロ・ユニット</p></td>
<td></td>
<td></td>
<td></td>
</tr>
<tr class="even">
<td><p><strong>A-80</strong></p></td>
<td><p>クローム</p></td>
<td><p>A-80D</p></td>
<td><p>A-80S</p></td>
<td><p>PW<br />
...
<table>
<caption><em>' Tokai Talbo モデル</em>'</caption>
<thead>
<tr class="header">
<th><p>出荷時期</p></th>
<th><p>モデル</p></th>
...
<td><p>SSH</p></td>
<td><p>ANV</p></td>
<td><p>東海楽器創立50周年 Talbo</p></td>
</tr>
<tr class="even">
<td><p>1997年半ば</p></td>
<td><p><strong>A-123</strong></p></td>
<td><p>SSS</p></td>
<td><p>MB（メタリック・ブラック）<br />
SG（シルバー・グレー）</p></td>
<td></td>
</tr>
<tr class="odd">
<td><p><strong>A-130</strong></p></td>
<td><p>SSH</p></td>
<td><p>クローム・プレート</p></td>
<td></td>
<td></td>
...
:: Talboと同じくアルミニウム合金のボディで製作された[エレクトリック・ベース](https://ja.wikipedia.org/wiki/エレクトリック・ベース "wikilink")。東海楽器はこのTalbo Bassで、初めて溶接のない1ピースの一体成形ボディを実現した。
...
### 池部楽器
  ...
  - 「TALBO SECRET FACTORY」において、オリジナルモデル・カスタムオーダーなどを受け付けている。
...
:\* [Blazing Fire](https://ja.wikipedia.org/wiki/Blazing_Fire "wikilink") See-Thru Red & Blue（ボディ：アクリル）
...
## 使用ミュージシャン
  ...
  - フクスケ（[メトロノーム](../Page/メトロノーム_\(バンド\).md "wikilink")・[ADAPTER。](https://ja.wikipedia.org/wiki/ADAPTER。 "wikilink")）
  - [アール・ケイト](https://ja.wikipedia.org/wiki/アール・ケイト "wikilink")
  - [魚住有希](https://ja.wikipedia.org/wiki/魚住有希 "wikilink")（[LoVendoЯ](https://ja.wikipedia.org/wiki/LoVendoЯ "wikilink")）

## 外部リンク

  - [東海楽器製造株式会社](http://www1.odn.ne.jp/tokaigakki/)
  - [Tokai Guitar Company Talbo Guitar （英語サイト）](http://www2.wbs.ne.jp/~tokai/mysite1/site2.html)
  - [TALBO シークレット・ファクトリー（池部楽器）](http://www.ikebe-gakki.com/web-ikebe/shibuya-talbo/)
  - [神田商会](http://www.kandashokai.co.jp/talbo/talbo_index.htm)
