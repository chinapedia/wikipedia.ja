...
超伝導状態を実現するためには、電子がペア（対）となって[ボソン化し](../Page/ボース粒子.md "wikilink")、最低エネルギー状態に集団で凝縮（[ボース凝縮](https://ja.wikipedia.org/wiki/ボース凝縮 "wikilink")とみなせる状態）する必要がある。このためには、電子同士がお互い[斥力](https://ja.wikipedia.org/wiki/斥力 "wikilink")を及ぼし合う状態から、何らかの有効な[引力](https://ja.wikipedia.org/wiki/引力 "wikilink")が電子同士に働く状態になる必要がある。

BCS理論では電子-格子相互作用を介して電子同士が[フォノン](../Page/フォノン.md "wikilink")を仮想的に交換（或いはフォノンを介して運動量を交換）することによって、電子同士に引力が働くと考える。この引力によって生じる電子対（スピンは互いに逆向き、かつ対の全運動量がゼロ）を**クーパー対**（クーパーペア）と言う。

この引力的な相互作用が効きうる範囲は、フォノンと関わりの深い[デバイ振動数](https://ja.wikipedia.org/wiki/デバイ振動数 "wikilink")を\(\omega_D\)とし、そのデバイエネルギーを\(\hbar\omega_D\)とすると、[フェルミエネルギー](../Page/フェルミエネルギー.md "wikilink")の上下\(\hbar\omega_D\)の範囲内と考えられる。この時、[金属](../Page/金属.md "wikilink")では通常、\(\epsilon_F \gg \omega_D\)である。
...
となる。\(\sigma\)はスピンの\(\uparrow\)、\(\downarrow\)の指標。\(c^{\dagger}\)は[生成演算子](https://ja.wikipedia.org/wiki/生成演算子 "wikilink")、\(\, c\)は[消滅演算子](https://ja.wikipedia.org/wiki/消滅演算子 "wikilink")である。和\(\textstyle\sum'\)は\(\epsilon_F\)を挟んだ\(2 \hbar w_D\)の範囲内のみで和を取ることを意味する。また、

\= { \\hbar^2 k^2 \\over {2m} } - \\mu </math>}}

である（一電子状態のエネルギー←運動エネルギーの形になっている）。\(m\)は電子の質量、\(\mu\)は化学ポテンシャルである。尚、フェルミエネルギーを

\= 0 </math>}}

として、エネルギーの原点とみなす。

常伝導状態の最低エネルギー状態の波動関数、\(|\phi_0\rangle\)は、電子間に有効的な引力の働く\(-g\)の存在下では最早最低のエネルギー状態でなくなる。この状態（＝超伝導状態）は、以下に示す変分波動関数、

\\right \\rangle = \\prod_{\\mathbf{k}} ( u_{\\mathbf{k}} + v_{\\mathbf{k}} c_{-\\mathbf{k} \\downarrow}^{\\dagger} c_{\\mathbf{k} \\uparrow}^{\\dagger}) \\left | {\\rm {vacuum}} \\right \\rangle </math>}}

を解くことによって求められる。\(|\mathrm{vacuum}\rangle\)は真空状態、\(u_\mathbf{k}\)、\(v_\mathbf{k}\)は変分パラメータであり、

^2 + v_{\\mathbf{k}}^2 = 1 </math>}}

という制限が課されている。変分の結果、\(g\)がどんなに小さくても、\(|\phi_\mathrm{BCS}\rangle\)は、\(|\phi_0\rangle\)よりエネルギーが下がることが示せる。尚、

| c_{\\mathbf{k} \\uparrow} c_{-\\mathbf{k} \\downarrow} | \\phi_{\\rm {BCS}} \\right \\rangle = u_{\\mathbf{k}} v_{\\mathbf{k}} \\ne 0 </math>}}
...
BCS理論から予想される超伝導[転移温度](https://ja.wikipedia.org/wiki/転移温度 "wikilink")の上限は、およそ30 - 40 K（[ケルビン](../Page/ケルビン.md "wikilink")）と考えられている（注：もっと高くなり得ると主張する研究者もいる）。従って、現時点（[2003年](../Page/2003年.md "wikilink")）で[液体窒素温度](https://ja.wikipedia.org/wiki/液体窒素温度 "wikilink")よりも更に高い超伝導転移温度を示す[高温超伝導](../Page/高温超伝導.md "wikilink")を、BCS理論の枠内だけで説明することは多くの研究者は不可能と考えている。電子がクーパー対をつくりボース凝縮していることは確かだが、その駆動力がBCS理論のようにフォノン（電子‐格子相互作用）だけとは考えられていない。ただ現在提案されている理論によって軽重の差があるが、フォノンも高温超伝導を引き起こす機構に何らかの関わりを持っていると考えられている。

高温超伝導における電子間の引力を引き起こす（つまりクーパー対を作る）駆動力としてはスピンのゆらぎ（或いは[マグノン](https://ja.wikipedia.org/wiki/マグノン "wikilink")）などが挙げられる。

  - 関連用語: [ボゴリューボフ変換](https://ja.wikipedia.org/wiki/ボゴリューボフ変換 "wikilink")
...
## 参考文献
  ...
  - [恒藤敏彦](https://ja.wikipedia.org/wiki/恒藤敏彦 "wikilink")著「超伝導の探究」岩波書店 (1995)
