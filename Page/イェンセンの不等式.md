...
**イェンセンの不等式**（いぇんせんのふとうしき、）は、[凸関数](https://ja.wikipedia.org/wiki/凸関数 "wikilink")を使った[不等式](https://ja.wikipedia.org/wiki/不等式 "wikilink")である。

*f*(*x*) を実数上の[凸関数](https://ja.wikipedia.org/wiki/凸関数 "wikilink")とする。
...
[統計学](../Page/統計学.md "wikilink")において、式の下限を評価するさいに、一定の役割を担っている。例えば、[カルバックライブラーダイバージェンスが常に](../Page/カルバック・ライブラー情報量.md "wikilink") 0 より大きいことを証明するときに用いられる。*p*(*x*) が[確率密度関数](https://ja.wikipedia.org/wiki/確率密度関数 "wikilink")の場合を考えると、イェンセンの不等式は次のように書ける。
