...
**ext3**は、third extended file systemの略で、[Linux](../Page/Linux.md "wikilink")の[ファイルシステム](../Page/ファイルシステム.md "wikilink")である。[ジャーナリングファイルシステム](../Page/ジャーナリングファイルシステム.md "wikilink")の一つ。 Linux[カーネル](../Page/カーネル.md "wikilink") 2.4.15より利用が可能になった。
...
改良が年々重ねられていて、速度は徐々に速くなっている。他のファイルシステム、[ReiserFS](../Page/ReiserFS.md "wikilink")や[XFS](../Page/XFS.md "wikilink")と比べ、劣っている部分と勝っている部分がある。
