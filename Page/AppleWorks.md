...
## 関連項目
  ...
  - [iWork](https://ja.wikipedia.org/wiki/iWork "wikilink") - 直接の後継ソフトでは無いが、同じくアップル製の統合ソフトウェア製品。プレゼンテーションソフトの[Keynote](../Page/Keynote.md "wikilink")、ワープロソフトの[Pages](../Page/Pages.md "wikilink")、表計算ソフトの[Numbersで構成される](../Page/Numbers_\(ソフトウェア\).md "wikilink")。建前上、AppleWorks形式のファイル群と互換性があることにはなっているが、互換性は一切ないに等しい。
