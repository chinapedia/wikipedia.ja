...
ID3v2タグはファイルの先頭に配置され、大まかに分けて、ID3v2ヘッダ、拡張ヘッダ、フレーム(複数)、パディング領域の4領域から構成され、この順に並んでいる。以下に各領域ごとの詳細を示す。v2.2はフレームIDが3桁であるため一部異なる
...
| オフセット | 長さ | 説明 |- align="center"| | 0 | 4 | この拡張ヘッダのサイズ |- align="center"| | 4 | 2 | フラグ |- align="center"| | 6 | 4 | パディング領域のサイズ |
| ----- | -- | --------------------- | - | - | ------------------------------ | - | - | ---------------------- | - | - | ----------- |
...
| オフセット | 長さ | 説明 |- align="center"| | 0 | 4 | この拡張ヘッダのサイズ |- align="center"| | 4 | 1 | フラグ長(常に1) |- align="center"| | 5 | 1 | フラグ |
| ----- | -- | --------------------- | - | - | ------------------------------ | - | - | ---------------------------- | - | - | --- |
