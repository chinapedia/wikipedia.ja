...
オンラインからオフラインへの消費者の誘導（いわゆる[O2O](https://ja.wikipedia.org/wiki/O2O "wikilink")）に応用されている。 [大日本印刷](https://ja.wikipedia.org/wiki/大日本印刷 "wikilink")では、QUEMA\[16\]や、音に電子透かしを埋め込んでキャンペーンなどの関連情報を配信するサービスを提供\[17\]している。[NTTアイティ](https://ja.wikipedia.org/wiki/NTTアイティ "wikilink")も同様に、電子透かし入り画像を携帯などのカメラで撮影して、指定したインターネットページへ誘導するソリューション\[18\]を提供している。 [NHKも](https://ja.wikipedia.org/wiki/日本放送協会 "wikilink")、テレビ信号に画面に関連するサイトのURLを透かし情報として多重し、画面を携帯端末カメラで撮影するとそのサイトを自動表示する技術を発表している。\[19\]

## 著作権法上の取り扱い

日本の[著作権法](https://ja.wikipedia.org/wiki/著作権法 "wikilink")では、[著作物](../Page/著作物.md "wikilink")に付された電子透かしを、不正に除去、改変などをすることは、著作権の侵害とみなされる\[20\]（第113条第3項）。
