...
[ノーベル物理学賞](../Page/ノーベル物理学賞.md "wikilink")受賞者で[量子電磁力学](../Page/量子電磁力学.md "wikilink")の創始者の一人である[リチャード・P・ファインマン](https://ja.wikipedia.org/wiki/リチャード・P・ファインマン "wikilink")によって提唱された[ファインマンルール](../Page/ファインマンルール.md "wikilink")に基づいて計算することによって[素粒子](../Page/素粒子.md "wikilink")の振る舞いを記述できる。
...
ファインマンルールとは、与えられた[ラグランジアン密度](https://ja.wikipedia.org/wiki/ラグランジアン密度 "wikilink")からファインマンダイアグラムの 頂点、外線、内線のそれぞれに物理変数からなる因子(factor)を対応させるルールのことである。物理変数からなる因子とは、多くの場合[ベクトル](https://ja.wikipedia.org/wiki/ベクトル "wikilink")や[テンソル](../Page/テンソル.md "wikilink")や[スピノル](https://ja.wikipedia.org/wiki/スピノル "wikilink")である。 このルールに従い、それぞれのダイアグラムに対応する因子をかけ合わせて積分すると、 摂動的に、[S行列](https://ja.wikipedia.org/wiki/S行列 "wikilink")から粒子の[崩壊率](https://ja.wikipedia.org/wiki/崩壊率 "wikilink")(decay rate)、[寿命](../Page/寿命.md "wikilink")、[断面積](https://ja.wikipedia.org/wiki/反応断面積 "wikilink")(cross section)などの観測可能な物理量を計算することができる。
