...
[Mass_potential_well_increasing_mass.gif](https://ja.wikipedia.org/wiki/File:Mass_potential_well_increasing_mass.gif "fig:Mass_potential_well_increasing_mass.gif")スカラー[ポテンシャル](https://ja.wikipedia.org/wiki/ポテンシャル "wikilink")は、[ベクトル解析](https://ja.wikipedia.org/wiki/ベクトル解析 "wikilink")および[物理学](../Page/物理学.md "wikilink")における基本概念である（[ベクトルポテンシャル](https://ja.wikipedia.org/wiki/ベクトルポテンシャル "wikilink")と混同する可能性がない場合、「スカラー」という言葉はしばしば省略される）。スカラーポテンシャルはスカラー場の一例である。[ベクトル場](https://ja.wikipedia.org/wiki/ベクトル場 "wikilink")**F**が与えられると、スカラーポテンシャル *P* は次のように定義される。
...
1.  \(-\int_a^b \mathbf{F}\cdot d\mathbf{l} = P(\mathbf{b})-P(\mathbf{a})\), ここで積分は位置**a**から位置**b**まで通過する[ジョルダン弧上にあり](https://ja.wikipedia.org/wiki/ジョルダン曲線定理 "wikilink")、*P*(**b**)は位置**b**で決まる*P*である。
...
スカラーポテンシャルは物理学および工学の多くの分野で重要な役割を果たしている。[重力ポテンシャル](https://ja.wikipedia.org/wiki/重力ポテンシャル "wikilink")は位置の関数としての、単位質量当たりの重力、すなわち場による[加速度](../Page/加速度.md "wikilink")に関連するスカラーポテンシャルである。重力ポテンシャルは単位質量当たりの重力[ポテンシャルエネルギーである](../Page/位置エネルギー.md "wikilink")。[静電気学](https://ja.wikipedia.org/wiki/静電気学 "wikilink")においては、[電位](../Page/電位.md "wikilink")は[電場](../Page/電場.md "wikilink")、すなわち単位[電荷](../Page/電荷.md "wikilink")当たりの[静電気力に関連するスカラーポテンシャルである](https://ja.wikipedia.org/wiki/クーロンの法則 "wikilink")。この場合、電位は単位電荷当たりの静電ポテンシャルエネルギーである。[流体力学](../Page/流体力学.md "wikilink")において、非回転層状場は[ラプラシアン場にある特別な場合にのみスカラーポテンシャルを持つ](https://ja.wikipedia.org/wiki/調和関数 "wikilink")。核力の側面の1つは[湯川ポテンシャル](../Page/湯川ポテンシャル.md "wikilink")により説明することができる。ポテンシャルは古典力学の[ラグランジアン](https://ja.wikipedia.org/wiki/ラグランジアン "wikilink")と[ハミルトニアン](../Page/ハミルトニアン.md "wikilink")の定式化において重要な役割を果たす。さらに、スカラーポテンシャルは[量子力学](https://ja.wikipedia.org/wiki/量子力学 "wikilink")における基本量である。

全てのベクトル場がスカラーポテンシャルを持つわけではない。そのようなベクトル場は保存的と呼ばれ、物理学における保存力の概念に対応している。非保存力の例としては、摩擦力、磁力、および流体力学におけるソレノイド場速度場がある。しかし、[ヘルムホルツ分解定理により](https://ja.wikipedia.org/wiki/ヘルムホルツの定理 "wikilink")、全てのベクトル場はスカラーポテンシャルおよび対応する[ベクトルポテンシャル](https://ja.wikipedia.org/wiki/ベクトルポテンシャル "wikilink")で記述可能である。電気力学において、電磁スカラーポテンシャルとベクトルポテンシャルはともに[電磁4元ポテンシャルとして知られている](https://ja.wikipedia.org/wiki/電磁ポテンシャル "wikilink")。

## 可積分条件

もし**F**が保存的ベクトル場（非回転、[カールフリー](https://ja.wikipedia.org/wiki/回転_\(ベクトル解析\) "wikilink")、ポテンシャルとも）で、その成分が[連続](https://ja.wikipedia.org/wiki/連続写像 "wikilink")[偏微分](https://ja.wikipedia.org/wiki/偏微分 "wikilink")を持つ場合、基準点に対する**F**の**ポテンシャル**は[線積分](https://ja.wikipedia.org/wiki/線積分 "wikilink")により定義される。
...
[流体力学](../Page/流体力学.md "wikilink")において、平衡状態にあるが一様な重力場の存在下では一様な浮力が重力を相殺するように浸透する。つまり、流体はその平衡状態を維持する。この[浮力](https://ja.wikipedia.org/wiki/浮力 "wikilink")は負の[圧力](../Page/圧力.md "wikilink")勾配である。

\[\mathbf{f_B} = - \nabla p. \,\]

浮力は重力と反対方向の上向きを向いているため、流体内の圧力は下向きに増加する。静的な水域内の圧力は水面下の深さに比例して増加する。一定圧力の面は表面に平行な平面であり、これはゼロ圧力の平面として特徴づけることができる。

液体が（その回転軸が表面に対して垂直である）垂直[渦](https://ja.wikipedia.org/wiki/渦 "wikilink")を有する場合、その渦は圧力場にうぼみを生じさせる。渦の内側の液体の表面は等圧力の表面同様下方向に引っ張られるが、液体表面と平行に保たれる。この効果は渦内部で最も強く、渦軸から離れるにつれて急速に減衰する。
