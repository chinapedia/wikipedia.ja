...
大半は[D16A型と同一構造であり](https://ja.wikipedia.org/wiki/ホンダ・D型エンジン#D16A "wikilink")、吸・排気バルブはそれぞれ2個ずつでアルミ製ロッカーアームで開閉される。DOHC機種と同様に燃焼室の天井中央部へ点火プラグが備え付けられているが、カムシャフトを避ける目的で上側を吸気バルブ側に傾けている。

こちらもPGM-FI仕様と[CVデュアルキャブ仕様があり](https://ja.wikipedia.org/wiki/キャブレター#可変ベンチュリ型 "wikilink")、キャブレターには[空燃比](../Page/空燃比.md "wikilink")をより精密に制御するための2次エアが導入されている（PGM-CARB.：電子制御キャブレター）。
...
:;PGM-FI仕様
  ...
  - [シビック](../Page/ホンダ・シビック.md "wikilink")（AT/EF3/EG5）
  - シビックセダン（AU/EF3/5）
...
:;PGM-FI仕様
  ...
  - シビックフェリオ（EG9/EH1）
  - [シビックシャトル](../Page/ホンダ・シビックシャトル.md "wikilink")（EF3/5）
  - シビックセダン（EF3/5）
...
[en:Honda ZC engine](https://ja.wikipedia.org/wiki/en:Honda_ZC_engine "wikilink") [fr:Honda D engine](https://ja.wikipedia.org/wiki/fr:Honda_D_engine "wikilink")

[Category:本田技研工業のエンジン](https://ja.wikipedia.org/wiki/Category:本田技研工業のエンジン "wikilink")

1.  ピストンスピードは、販売当時の[F1用エンジンと同様約](https://ja.wikipedia.org/wiki/フォーミュラ1カー "wikilink")20m/secであった。
