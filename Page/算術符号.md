...
この符号化は、[データ圧縮](../Page/データ圧縮.md "wikilink")向きで、[JPEG 2000にも](https://ja.wikipedia.org/wiki/JPEG_2000 "wikilink")、別の[アルゴリズム](../Page/アルゴリズム.md "wikilink")で実装されたQ-coderの改良型、MQ-coderとして採用されている。

## 特許問題

[インターネット](https://ja.wikipedia.org/wiki/インターネット "wikilink")で爆発的に普及した、[GIF](https://ja.wikipedia.org/wiki/GIF "wikilink")[画像ファイルフォーマット](https://ja.wikipedia.org/wiki/画像ファイルフォーマット "wikilink")の圧縮アルゴリズム[LZW符号の特許料支払命じられた](https://ja.wikipedia.org/wiki/Lempel–Ziv–Welch "wikilink")（2004年時点で期限切れ）など、データ圧縮の分野においても特許問題は尽きない。算術符号もそのひとつである。

特に算術符号においては「抜け道がないくらいに特許が取られている」などといわれ、[bzipでは公開を断念](../Page/Bzip2.md "wikilink")、JPEG 2000が使用を開始するまでは[ハフマン符号](https://ja.wikipedia.org/wiki/ハフマン符号 "wikilink")で代用したり、あげくは「特許に抵触しない算術符号」として[Range Coderが普及する有り様である](https://ja.wikipedia.org/wiki/Range_Coder "wikilink")。無論まったく使われなかったわけではないが、圧縮技術に興味を持ったり圧縮／復号ツールを開発する者の間では「特許のせいで使うことはできない」と言い続けているのが現状である。
...
1.  [今井秀樹](https://ja.wikipedia.org/wiki/今井秀樹 "wikilink")『情報理論』[昭晃堂](https://ja.wikipedia.org/wiki/昭晃堂 "wikilink")、80頁
