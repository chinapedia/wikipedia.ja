...
01micko によるプロジェクトであり、[Raspbian](https://ja.wikipedia.org/wiki/Raspbian "wikilink") Buster のバイナリパッケージと互換性がある(カーネル 4.19.75)。 x86, x64 以外のアーキテクチャ (armhf 32bit) をサポートする最初の Puppy である。Pi Zero, Pi 1 〜 Pi 4 で動作する。

| バージョン        | リリース日                                         | 備考 |
| ------------ | --------------------------------------------- | -- |
| Raspup 8.2.0 | 2020年[1月1日](../Page/1月1日.md "wikilink")\[36\] |    |
|              |                                               |    |
