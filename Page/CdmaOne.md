...
レイク (rake) 受信とは、[マルチパス](../Page/マルチパス.md "wikilink")による[フェージング](https://ja.wikipedia.org/wiki/フェージング "wikilink")への対策として開発された技術。複数のサブ受信機を使い、別々に[デコード](https://ja.wikipedia.org/wiki/デコード "wikilink")する。各受信機の位相差を検出・補正し再合成する事により、マルチパス環境下においても[S/N比](https://ja.wikipedia.org/wiki/S/N比 "wikilink")の良好な受信を実現する。
