...
本作のストーリーは明確な目標はあるものの、その詳細は前述の情報や、作中に登場するフレーバーテキストから断片的に組み上げられている。このテキストは宮崎によって書かれた。山際はPlayStation.Blogにて本作で最も大切なものとしてプレイヤーと子供たちの関係性を挙げ、これは「物語り」によって断片的な情報が組み合わさることで内容がプレイヤーに伝わるようにしたと語っている。
