...
いくつかの[Linuxディストリビューション](../Page/Linuxディストリビューション.md "wikilink")がこのような用途向けにつくられている。商用では軍事レベルにも対応しているTrusted [Solaris](../Page/Solaris.md "wikilink")、Trusted [IRIX](../Page/IRIX.md "wikilink")、STOP OS、PitBull FSなどがある。

### Linux

  - [Tails](https://ja.wikipedia.org/wiki/Tails_\(オペレーティングシステム\) "wikilink")
  - [Qubes OS](https://ja.wikipedia.org/wiki/Qubes_OS "wikilink")
  - [Alpine Linux](https://ja.wikipedia.org/wiki/Alpine_Linux "wikilink")
...
[Capability-based securityも参照](../Page/Capability-based_security.md "wikilink")。

  - [Genode](https://ja.wikipedia.org/wiki/Genode "wikilink")
  - [Fiasco.OC](https://ja.wikipedia.org/wiki/L4マイクロカーネルファミリー#L4/Fiascoの初期バージョン以降 "wikilink")
  - [seL4](https://ja.wikipedia.org/wiki/L4マイクロカーネルファミリー#高度な保証：seL4 "wikilink")

## 実装

[強制アクセス制御](https://ja.wikipedia.org/wiki/強制アクセス制御 "wikilink")も参照。

### BSDでの実装

  - [OpenBSD](../Page/OpenBSD.md "wikilink")
  - [TrustedBSD](https://ja.wikipedia.org/wiki/FreeBSD#OpenBSM "wikilink")
...
## 関連項目
  ...
  - [オペレーティングシステム\#セキュリティ](https://ja.wikipedia.org/wiki/オペレーティングシステム#セキュリティ "wikilink")
  - [IX (operating system)](../Page/Research_Unix.md "wikilink")
  - [強制アクセス制御](https://ja.wikipedia.org/wiki/強制アクセス制御 "wikilink")
...
1.
2.  [ネット上の匿名性を保護する『Anonym.OS』｜WIRED.jp](https://wired.jp/2006/01/18/%E3%83%8D%E3%83%83%E3%83%88%E4%B8%8A%E3%81%AE%E5%8C%BF%E5%90%8D%E6%80%A7%E3%82%92%E4%BF%9D%E8%AD%B7%E3%81%99%E3%82%8B%E3%80%8Eanonym-os%E3%80%8F/)