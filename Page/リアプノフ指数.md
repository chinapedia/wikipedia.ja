...
[Orbital_instability_(Lyapunov_exponent).png](https://ja.wikipedia.org/wiki/File:Orbital_instability_\(Lyapunov_exponent\).png "fig:Orbital_instability_(Lyapunov_exponent).png") **リアプノフ指数**（リアプノフしすう、）とは、[力学系](https://ja.wikipedia.org/wiki/力学系 "wikilink")においてごく接近した[軌道が離れていく度合いを表す量である](https://ja.wikipedia.org/wiki/力学系#解軌道 "wikilink")。**リャプノフ指数**とも表記される。ロシア人科学者 （[アレクサンドル・リプノーフ](https://ja.wikipedia.org/wiki/アレクサンドル・リャプノフ "wikilink")、）にその名をちなむ\[1\]。

系の[相空間](https://ja.wikipedia.org/wiki/相空間 "wikilink")上の2つの軌道について考える。2つの軌道上の時刻 *t* における点の距離を[ベクトル](https://ja.wikipedia.org/wiki/ベクトル "wikilink") ***δ***(*t*) として、初期状態 *t* = 0 には、これらの軌道は距離 ***δ***(0) だけ離れているとする。***δ***(*t*) を近似的に次のように表す。
...
## 関連項目
  ...
  - [リウヴィルの定理 (物理学)](https://ja.wikipedia.org/wiki/リウヴィルの定理_\(物理学\) "wikilink")
