...
**結晶場理論**（けっしょうばりろん）とは、金属イオンの[\(p\) 軌道](https://ja.wikipedia.org/wiki/P軌道 "wikilink")、[\(d\) 軌道](../Page/D軌道.md "wikilink")、[\(f\) 軌道などのエネルギー準位の](https://ja.wikipedia.org/wiki/F軌道 "wikilink")[分裂](https://ja.wikipedia.org/wiki/分裂 "wikilink")を、配位子の持つ負電荷が作る[静電場](https://ja.wikipedia.org/wiki/静電場 "wikilink")によって説明する理論。
...
= \sum_i r_i^t \sqrt{\frac{4\pi}{2t+1}} Y_{tp} (\theta_i , \phi_i)\] この*A<sub>tp</sub>* を**結晶場パラメータ**という。一般に結晶場の対称性のために、独立な結晶場パラメータの数は限られる。例えば、[点群](https://ja.wikipedia.org/wiki/点群 "wikilink")*C<sub>1</sub>* 、*C<sub>i</sub>* 、*C<sub>s</sub>* の場合を除いて*p = 1* と*p = 5* の成分はゼロになる。
