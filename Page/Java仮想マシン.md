...
エンタープライズ用（デスクトップ用を包含）としては、[オラクル](../Page/オラクル_\(企業\).md "wikilink")、[IBM](../Page/IBM.md "wikilink")、[HPなどの各社から実装系がリリースされている](../Page/ヒューレット・パッカード.md "wikilink")。[OS上でアプリケーションとして動作する形態が一般的である](../Page/オペレーティングシステム.md "wikilink")。
...
## 関連項目
  ...
  - [SableVM](../Page/SableVM.md "wikilink")
