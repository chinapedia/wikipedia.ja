...
[Java](https://ja.wikipedia.org/wiki/Java "wikilink") に関しては、Data Access Object は数々の複雑で多様な [Java 永続性技術](https://ja.wikipedia.org/wiki/Java_Persistence_API "wikilink")（[JDBC](../Page/JDBC.md "wikilink")、[JDO](../Page/Java_Data_Objects.md "wikilink")、[EJB CMP](../Page/Enterprise_JavaBeans.md "wikilink")、[TopLink](https://ja.wikipedia.org/wiki/TopLink "wikilink")、[Hibernate](https://ja.wikipedia.org/wiki/Hibernate "wikilink")、[iBATIS](https://ja.wikipedia.org/wiki/iBATIS "wikilink")など）からアプリケーション本体を隔離するのに利用される。Data Access Object を使うと、基盤となる技術を更新/置換しても、アプリケーションの他の部分を変更する必要がない。
...
## 関連項目
  ...
  - [Data Transfer Object](https://ja.wikipedia.org/wiki/Data_Transfer_Object "wikilink") (DTO)
  - [Service Data Objects](https://ja.wikipedia.org/wiki/Service_Data_Objects "wikilink") (SDO)
