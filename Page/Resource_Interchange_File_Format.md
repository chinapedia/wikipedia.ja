...
（**RIFF**、「資源交換用ファイル形式」の意味）は、タグ付きのデータを格納するための汎用メタファイル形式である。[1991年](../Page/1991年.md "wikilink")、[マイクロソフト](../Page/マイクロソフト.md "wikilink")と[IBM](../Page/IBM.md "wikilink")が提案し、マイクロソフトの[Windows 3.1のマルチメディアファイルのデフォルトフォーマットとして採用された](../Page/Microsoft_Windows_3.x.md "wikilink")。[エレクトロニック・アーツ](https://ja.wikipedia.org/wiki/エレクトロニック・アーツ "wikilink")が[1985年](https://ja.wikipedia.org/wiki/1985年 "wikilink")に策定した[Interchange File Format](https://ja.wikipedia.org/wiki/Interchange_File_Format "wikilink") (IFF、「交換用ファイル形式」の意味) に基づいている。RIFFは[IBM PCが使っている](https://ja.wikipedia.org/wiki/IBM_PC "wikilink")[x86](https://ja.wikipedia.org/wiki/x86 "wikilink")プロセッサに合わせて多[バイト整数を](../Page/バイト_\(情報\).md "wikilink")[リトルエンディアン形式で格納するのに対して](https://ja.wikipedia.org/wiki/エンディアン "wikilink")、IFFは[Amiga](../Page/Amiga.md "wikilink")や[Macintosh](../Page/Macintosh.md "wikilink")で使われていたため、[68kプロセッサのビッグエンディアンを採用していた点が異なる](../Page/MC68000.md "wikilink")。なお、[アップルは](../Page/アップル_\(企業\).md "wikilink")[1988年](../Page/1988年.md "wikilink")にIFFに基づいた[ビッグエンディアンの](https://ja.wikipedia.org/wiki/エンディアン "wikilink")[AIFF](https://ja.wikipedia.org/wiki/AIFF "wikilink")を策定している。

マイクロソフトの実装は、RIFFメタ形式を基盤とした各種[ファイル形式](../Page/ファイルフォーマット.md "wikilink") ([AVI](https://ja.wikipedia.org/wiki/Audio_Video_Interleave "wikilink"), [ANI](https://ja.wikipedia.org/wiki/ANI_\(ファイルフォーマット\) "wikilink"), [WAV](https://ja.wikipedia.org/wiki/WAV "wikilink")) で知られている。

## 概要

RIFFファイルは「チャンク」と呼ばれるものの並びである。形式は[IFF](https://ja.wikipedia.org/wiki/IFF "wikilink")と全く同一であり、上述の通りエンディアンだけが異なる。また、チャンク名の意味も一部異なる。

全てのチャンクは次のような形式である。

  - 4バイト: チャンクの[ASCII](https://ja.wikipedia.org/wiki/ASCII "wikilink")識別子。例えば「fmt」、「data」など。
...
[欧州放送連合](https://ja.wikipedia.org/wiki/欧州放送連合 "wikilink")が開発したRIFF仕様に基づいた多チャンネルファイル形式として[RF64](https://ja.wikipedia.org/wiki/RF64 "wikilink")がある。これは[BWF互換であり](https://ja.wikipedia.org/wiki/Broadcast_Wave_Format "wikilink")、4[ギガバイト](../Page/ギガバイト.md "wikilink")を超えるファイルが構成可能である。

## INFOチャンク

マイクロソフトのWindows 3.1の公式文書によると、ファイルの先頭にINFOチャンクを置くべきとしている。これにより、ファイル内容に関する[メタデータ](https://ja.wikipedia.org/wiki/メタデータ "wikilink")に素早くアクセスでき、ファイルシステムやマルチメディアアプリケーションがファイルの先頭を参照して、作者情報、サムネイル、プレビュー、ファイル形式情報などを取り出せる。
...
## RIFF に基づく主なファイル形式
  ...
  - [WAV](https://ja.wikipedia.org/wiki/WAV "wikilink") （Windowsオーディオ）
  - [AVI](https://ja.wikipedia.org/wiki/Audio_Video_Interleave "wikilink") （Windows動画）
...
## 関連項目
  ...
  - [IFF](https://ja.wikipedia.org/wiki/Interchange_File_Format "wikilink")
  - [AIFF](https://ja.wikipedia.org/wiki/AIFF "wikilink")
  - [FourCC](https://ja.wikipedia.org/wiki/FourCC "wikilink")
  - [BWF](https://ja.wikipedia.org/wiki/Broadcast_Wave_Format "wikilink")
