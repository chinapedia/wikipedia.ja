...
**OpenVZ**（オープンブイジー）は、[Linuxカーネル](../Page/Linuxカーネル.md "wikilink")をベースに開発された [Red Hat Enterprise Linux](https://ja.wikipedia.org/wiki/Red_Hat_Enterprise_Linux "wikilink") (RHEL) 用の[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink") (OS) レベルの[サーバ](../Page/サーバ.md "wikilink")[仮想化](https://ja.wikipedia.org/wiki/仮想化 "wikilink")ソフト。

[Parallels Virtuozzo Containers](../Page/Parallels_Virtuozzo_Containers.md "wikilink") for Linuxのオープンソース版であり、1つの物理サーバ上に複数の独立したLinuxインスタンスを作成することができる。ただし、Linuxカーネルをすべてのインスタンスで共有するため、[Linux](https://ja.wikipedia.org/wiki/Linux "wikilink")以外の環境（[Windowsなど](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")）を動作させることはできない。

## 特徴

[ハイパーバイザ](https://ja.wikipedia.org/wiki/ハイパーバイザ "wikilink")型（ハードウェアレベル）の仮想化ソフトである[VMware](https://ja.wikipedia.org/wiki/VMware "wikilink")や[Xenに比べて](https://ja.wikipedia.org/wiki/Xen_\(仮想化ソフトウェア\) "wikilink")[オーバーヘッド](https://ja.wikipedia.org/wiki/オーバーヘッド "wikilink")が少ないとされ、稼動させる環境数で勝っている。より高密度化できるため、[バーチャル・プライベート・サーバ](https://ja.wikipedia.org/wiki/バーチャル・プライベート・サーバ "wikilink") (VPS) での使用において、コストダウンをはかることができる。
...
公式には[Red Hat Enterprise Linux](https://ja.wikipedia.org/wiki/Red_Hat_Enterprise_Linux "wikilink") (RHEL) にのみ対応している。RHELクローンの[CentOS](https://ja.wikipedia.org/wiki/CentOS "wikilink")でも動作し、[Parallels Virtuozzo Containersの方ではCentOSも公式にサポートしている](../Page/Parallels_Virtuozzo_Containers.md "wikilink")。Linuxカーネルを改造しているため、ディストリビューションおよびそのバージョンに強く依存している。

[Ubuntu](https://ja.wikipedia.org/wiki/Ubuntu "wikilink") 10.04または[Debian](../Page/Debian.md "wikilink") 6.0にインストールするには、RPMファイルをdebに変換することで可能\[2\]\[3\]。 元々のDebian 5.0、6.0ではパッケージに含まれているが、サポートが技術的に困難であるという理由から、Debian 7.0 ではパッケージを廃止予定\[4\]。Debianから派生している[Ubuntu](https://ja.wikipedia.org/wiki/Ubuntu "wikilink")では8.04は含まれているが、10.04ではパッケージに含まれていない\[5\]。
...
それぞれのコンテナは別々に分離されていて、大旨、隔離された物理サーバのように動く。以下の物をそれぞれ隔離して所有している。
  ...
  - デバイス
    必要ならば、コンテナは[ネットワーク](https://ja.wikipedia.org/wiki/コンピュータネットワーク "wikilink")[インタフェース](../Page/インタフェース_\(情報技術\).md "wikilink")、[シリアルポート](../Page/シリアルポート.md "wikilink")、ディスク[パーティション](https://ja.wikipedia.org/wiki/パーティション "wikilink")などリアルデバイスにアクセスすることが出来る。
  - IPCオブジェクト
    共有メモリ、[セマフォ](https://ja.wikipedia.org/wiki/セマフォ "wikilink")、[メッセージパッシングなども独立している](https://ja.wikipedia.org/wiki/メッセージ_\(コンピュータ\) "wikilink")。
...
## 関連項目
  ...
  - [Linux-VServer](https://ja.wikipedia.org/wiki/Linux-VServer "wikilink")
