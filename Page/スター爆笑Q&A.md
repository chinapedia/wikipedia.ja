...
解答者は1ペア計4チームのゲスト（芸能人・著名人）で、司会者が出題する問題に対して、解答者は挙手をして解答権を得て、正解するとぬいぐるみ（[ムーミン](../Page/ムーミン.md "wikilink")のぬいぐるみ等、時期によって変わる｡）が貰えた（ぬいぐるみ1つにつき1点）。問題の出題前には[VTR](https://ja.wikipedia.org/wiki/VTR_\(曖昧さ回避\) "wikilink")（ナレーションは[三ツ矢雄二](../Page/三ツ矢雄二.md "wikilink")が担当）を流したり、エピソードにまつわる写真や品物を登場させたりしていた。最終的に正解数の多いチームから海外旅行（当初はハワイだったが、後にマレーシア）を賭けた抽選会（チャレンジゲーム）に挑戦できた。ボックスの中に赤と白のボールが入っており、引く色を宣言してその色を引くと海外旅行獲得となった。失敗すると次に正解数の多いチームに挑戦権が移り、当たるまで続けられた。当初、箱は前方に窓があり、そこからボールを選び出す様子が出ていたが、後期は箱の中に[CCDカメラが仕込まれており](../Page/CCDイメージセンサ.md "wikilink")、テレビではボールを選ぶ様子が子画面で映し出されていた。
...
## スタッフ
  ...
  - 構成：[豊村剛](../Page/豊村剛.md "wikilink")、三好宏和、岩瀬理恵子、八木伸栄、松浦京子、芳田香織
  ...
  - 美術：[ちとせ舞台](../Page/チトセアート.md "wikilink")
  - 演出：久保田隆
  - スタッフ：駒木純一、青葉典子
  - プロデューサー：宮崎敏夫（IVSテレビ）、山田宏（YTV）
