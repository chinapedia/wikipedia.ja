...
ブラウン運動の数学的モデルは[ウィーナー過程](../Page/ウィーナー過程.md "wikilink")である。連続時間でユークリッド空間に値をとる確率過程の典型例である。ウィーナー過程以外に、[独立増分過程](https://ja.wikipedia.org/wiki/独立増分過程 "wikilink")（レヴィ過程）、[ガウス過程](../Page/ガウス過程.md "wikilink")、[マルチンゲール](https://ja.wikipedia.org/wiki/マルチンゲール "wikilink")、[マルコフ過程](../Page/マルコフ過程.md "wikilink")、[マルコフ連鎖](../Page/マルコフ連鎖.md "wikilink")、[定常過程](../Page/定常過程.md "wikilink")といった確率過程がある。
