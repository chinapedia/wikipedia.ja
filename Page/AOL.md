...
1985年に[Quantum Computer Serviceとして](../Page/クアンタム_\(企業\).md "wikilink")[パソコン通信](../Page/パソコン通信.md "wikilink")サービスを開始し、1989年に[Macintosh](../Page/Macintosh.md "wikilink")において[GUI](https://ja.wikipedia.org/wiki/GUI "wikilink")を用いた専用ソフトで接続する「America Online」サービスが開始された。
...
### 日本における沿革
  ...
  - 2004年8月 - AOLiサービス終了
  - 2006年12月1日 - [アドネットワーク](https://ja.wikipedia.org/wiki/アドネットワーク "wikilink")専業としてアドバタイジングドットコム・ジャパンを三井物産と米アドバタイジング・ドット・コム社（後の米AOLアドバタイジング社）により設立。
  ...
  - 2015年6月 - [ベライゾン・コミュニケーションズ](../Page/ベライゾン・コミュニケーションズ.md "wikilink")によるAOLの買収・子会社化完了。
...
AOLでは[ダイヤルアップ接続](../Page/ダイヤルアップ接続.md "wikilink")を行う為に、専用のソフトウェア「AOL Dialer」が存在し、日本では「AOL接続ソフト」あるいは「AOLダイヤラー」として

[Windows](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")

  - 3.0i [3.1上で動作する](../Page/Microsoft_Windows_3.x.md "wikilink")。
  - 4.0 [95に対応](../Page/Microsoft_Windows_95.md "wikilink")。
  - 5.0
  - 6.0
  - 6.0XP 6.0を[XPに対応させるよう開発された](../Page/Microsoft_Windows_XP.md "wikilink")。
  - 7.0 事実上の最新バージョン。
  - 8.0 [ベータ版](../Page/ベータ版.md "wikilink")として制作、一部のメンバーに配布された。2006年3月まで公式版としての配布は無かった。

[Macintosh](../Page/Macintosh.md "wikilink")（〜[Mac OS 9](https://ja.wikipedia.org/wiki/Classic_Mac_OS#Mac_OS_9 "wikilink")）

  - 3.0
  - 4.0
  - 5.0

[Macintosh](../Page/Macintosh.md "wikilink")（[Mac OS X](https://ja.wikipedia.org/wiki/macOS "wikilink") 〜）
...
[Linspire](../Page/Linspire.md "wikilink")により、「AOL Dialer for Linux」の提供も行われている。 このソフトウェアは、[Linux](../Page/Linux.md "wikilink")上でAOLの[APへのダイヤルアップでの接続を実現するものである](https://ja.wikipedia.org/wiki/アクセスポイント_\(ISP\) "wikilink")。

2007年、日本では「AOL接続ソフト」の配布を中止、手続きのほとんどがコールセンターで行なわれる様になった。後にダイアルアップ接続用「AOLダイアラー」の配布も中止された。

現在AOL Japanポータルサイトでは「[AOLインスタントメッセンジャー](../Page/AOL_Instant_Messenger.md "wikilink")」、「AOLツールバー」等の[ダウンロード](https://ja.wikipedia.org/wiki/ダウンロード "wikilink")が可能である。
...
## 関連項目
  ...
  - [Gencheez](https://ja.wikipedia.org/wiki/Gencheez "wikilink")
...
1.  『[ベライゾンはヤフーの買収を正式完了](http://oneboxnews.com/articles/verizon-completes-yahoo-acquisition-2017-6)』 2017年6月14日 [Onebox News](https://ja.wikipedia.org/wiki/Onebox_News "wikilink")
2.
3.
4.  松尾理也 「AOL、タイムワーナーから分離・独立 変貌ネットに元"覇者"船出」 『[産経新聞](https://ja.wikipedia.org/wiki/産経新聞 "wikilink")』 2009年12月10日付朝刊、東京本社発行15版、8面。
5.