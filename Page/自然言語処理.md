...
他にも次のような課題がある。
  ...
  - [形態素解析](../Page/形態素解析.md "wikilink")
    [中国語](https://ja.wikipedia.org/wiki/中国語 "wikilink")、[日本語](../Page/日本語.md "wikilink")、[タイ語](../Page/タイ語.md "wikilink")といった言語は単語の[わかち書き](../Page/わかち書き.md "wikilink")をしない。そのため、単語の区切りを特定するのにテキストの解析が必要となり、それは非常に複雑な作業となる。
  - 音声における形態素解析
