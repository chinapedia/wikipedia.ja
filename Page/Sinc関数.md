...
いずれの場合も、[可除特異点](https://ja.wikipedia.org/wiki/可除特異点 "wikilink")である 0 での値が必要であればしばしば明示的に sinc(0) = 1 が定義として与えられる。sinc 関数はいたるところ[解析的である](https://ja.wikipedia.org/wiki/解析関数 "wikilink")。
