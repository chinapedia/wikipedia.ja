...
このように人間の[可読性](https://ja.wikipedia.org/wiki/可読性 "wikilink")を求めるならばのほうが優れている。しかし、XMLアプリケーションであるMathMLは本来コンピュータによる数式の意味認識において有利となるよう設計されたものであり、人間がMathMLを直接書いたり編集したりすることは意図していない\[3\]。
...
Webページに組み込んだMathMLは [MathJax](https://ja.wikipedia.org/wiki/MathJax "wikilink")\[7\]を使って表示できる。

ブラウザでのMathMLネイティブサポート（ブラウザのレンダリングエンジンによるMathMLのレンダリング）は進んでいない。対応しているのは、[Gecko](../Page/Gecko.md "wikilink") を採用している [Mozilla Firefox](../Page/Mozilla_Firefox.md "wikilink") などのブラウザ\[8\]、[Safari](../Page/Safari.md "wikilink") 5.1 以降にとどまる。[Presto](../Page/Presto.md "wikilink") を採用している、[Opera](https://ja.wikipedia.org/wiki/Opera "wikilink") 9.50\[9\]〜12.1 においては単体でほとんどの数式の表示が可能となったが、Opera 14 よりレンダリングエンジンが WebKit そして Blink になり非対応となった。

[Google Chrome](https://ja.wikipedia.org/wiki/Google_Chrome "wikilink")、[Microsoft Edge](https://ja.wikipedia.org/wiki/Microsoft_Edge "wikilink")、[Internet Explorer](../Page/Internet_Explorer.md "wikilink") は対応していない。但し、[Internet Explorer](../Page/Internet_Explorer.md "wikilink") では、例えばプラグインの Design Science の [MathPlayer](http://www.dessci.com/en/products/mathplayer/) をインストールすることで MathML を表示できるようになる。
...
8.  [Authoring MathML for Mozilla](http://www.mozilla.org/projects/mathml/authoring.html)
9.  [Opera Desktop Team - Even more work](http://web.archive.org/web/20071118141611/http://my.opera.com/desktopteam/blog/2007/11/16/even-more-work)
10. [MathML で記述した数式を PDF に変換](http://www.antenna.co.jp/AHF/mathmloption.html)
11. [JAWS16.0日本語版](http://www.extra.co.jp/jaws/)
12. [MathFlow](http://www.dessci.com/en/products/mathflow), Dessci.com. Retrieved on 9 May 2012.