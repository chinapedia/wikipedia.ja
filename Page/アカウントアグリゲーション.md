...
**アカウントアグリゲーション(*Account aggregation*)** とは、 [インターネットバンキング](https://ja.wikipedia.org/wiki/インターネットバンキング "wikilink")などに[預金](../Page/預金.md "wikilink")者が保有する、異なる[金融機関](../Page/金融機関.md "wikilink")の複数の[口座](https://ja.wikipedia.org/wiki/口座 "wikilink")の情報を、単一のコンピュータ[スクリーン](../Page/スクリーン.md "wikilink")に集約して表示するサービスの総称。
...
1)2)3)ともにサーバ側で管理する方式を[サーバ型といい](https://ja.wikipedia.org/wiki/#サーバ型 "wikilink")、この場合[Webブラウザを用いてサービス提供され](../Page/ウェブブラウザ.md "wikilink")、主に[ASPサービスとして提供されている](https://ja.wikipedia.org/wiki/アプリケーションサービスプロバイダ "wikilink")。
...
サービス提供者は利用者から各インターネットバンキングサイトの利用者アカウントIDと[パスワード](https://ja.wikipedia.org/wiki/パスワード "wikilink")をあらかじめ預かり、サービス提供者がこれを使って各インターネットバンキングサイトへ接続を行う。 表示されるWeb画面を「**[スクリーンスクレイピング](https://ja.wikipedia.org/wiki/スクリーンスクレイピング "wikilink")**」（[w:en:Screen scraping](https://ja.wikipedia.org/wiki/w:en:Screen_scraping "wikilink")）という技術を使って取得し、これを解析・再構成して利用者のコンピュータスクリーンに表示する。

米国が発祥だが、日本では[ジャパンネット銀行](../Page/ジャパンネット銀行.md "wikilink")や[三菱UFJ銀行](https://ja.wikipedia.org/wiki/三菱UFJ銀行 "wikilink")等の[インターネットバンキング](https://ja.wikipedia.org/wiki/インターネットバンキング "wikilink")サイトや[MSN](../Page/MSN.md "wikilink")、[goo](https://ja.wikipedia.org/wiki/goo "wikilink")等の[ポータルサイト](../Page/ポータルサイト.md "wikilink")で提供されている。

複雑なシステムであり、実際に運用されているものは限られる。

### 日本で運用されているシステム

  - [NTTビズリンク運用](https://ja.wikipedia.org/wiki/NTTグループ#外縁企業 "wikilink")「[Agurippa](https://ja.wikipedia.org/wiki/Agurippa "wikilink")」
    [ソニー銀行](../Page/ソニー銀行.md "wikilink")「人生通帳スタンダード」
    [ジェーシービー](../Page/ジェーシービー.md "wikilink")「安心お知らせメール」
    [マネックス証券](https://ja.wikipedia.org/wiki/マネックス証券 "wikilink")「MONEX ONE」
...
預金者が自分の利用者アカウントIDとパスワードをサービス提供者に預けることに[情報漏洩](https://ja.wikipedia.org/wiki/情報漏洩 "wikilink")の 不安を持ってしまうことに配慮して、預金者の使用する[PCで動作](../Page/パーソナルコンピュータ.md "wikilink") する[アプリケーションとして提供されるものが](../Page/アプリケーションソフトウェア.md "wikilink")、いわゆる「クライアント型」である。 サーバ型と同様にスクリーンスクレイピング技術を使って各金融機関サイトからの情報を 取得し、再構成して表示する。

通常アカウントIDとパスワードは利用者のPCだけに保存されているため、その管理責任は利用者にある。そのため利用者は[スパイウェア](https://ja.wikipedia.org/wiki/スパイウェア "wikilink")や[ファーミング](https://ja.wikipedia.org/wiki/ファーミング "wikilink")などの被害を受けないよう、自らPCの管理に注意を払う必要がある。ただし、サービスによっては情報を暗号化して保存することでそのリスクを低減している。

  - [SBIホールディングス](https://ja.wikipedia.org/wiki/SBIホールディングス "wikilink")提供「[MoneyLook](https://ja.wikipedia.org/wiki/MoneyLook "wikilink")」系
    [ヤフージャパン](https://ja.wikipedia.org/wiki/ヤフージャパン "wikilink")「MoneyLook with Yahoo\!」
    [SBI証券](https://ja.wikipedia.org/wiki/SBI証券 "wikilink")「MoneyLook for SBI証券」
