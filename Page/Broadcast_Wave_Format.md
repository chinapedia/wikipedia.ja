...
**Broadcast Wave Format** (**BWF**) は、[マイクロソフト](../Page/マイクロソフト.md "wikilink")の[WAV](https://ja.wikipedia.org/wiki/WAV "wikilink")[音声ファイルフォーマット](../Page/音声ファイルフォーマット.md "wikilink")の拡張であり、[映画](../Page/映画.md "wikilink")や[テレビ](../Page/テレビ.md "wikilink")で使われている[ノンリニア](https://ja.wikipedia.org/wiki/ノンリニア編集 "wikilink")[デジタルレコーダーの録音フォーマットとしてよく使われている](https://ja.wikipedia.org/wiki/音響機器 "wikilink")。

日本では、これを拡張した**BWF-J**という規格が使われている\[1\]。

## 概要

1997年、[欧州放送連合](https://ja.wikipedia.org/wiki/欧州放送連合 "wikilink")が仕様策定し、2001年と2003年に改定されている。

このフォーマットの目的は、各種コンピュータプラットフォームやアプリケーションでの音声データの円滑な交換を可能にする[メタデータ](https://ja.wikipedia.org/wiki/メタデータ "wikilink")を追加することであった。従って、[メタデータ](https://ja.wikipedia.org/wiki/メタデータ "wikilink")の形式が指定されていて、音響処理においてそれら情報を参照可能になっていて、他の記録との[同期が可能である](https://ja.wikipedia.org/wiki/タイムコード "wikilink")。このメタデータは標準のWAVファイルに追加された拡張チャンク（[RIFF参照](../Page/Resource_Interchange_File_Format.md "wikilink")）に格納される。
