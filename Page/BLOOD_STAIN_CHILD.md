...
### 現メンバー
  ...
  - SADEW - [リードボーカル](https://ja.wikipedia.org/wiki/リードボーカル "wikilink")（2007年1月-2010年6月 / 2018年10月- ）
  - RYU - [リードギター](../Page/リードギター.md "wikilink")（1999年6月- ）

<!-- end list -->

  -
    BLOOD STAIN CHILDのリーダーでありバンドコンセプト等の構築をしている。ほぼ全曲の[作曲](../Page/作曲.md "wikilink")を担当。多種多様なジャンルの音楽の作曲をプロデュースする等、他にも様々な活動をしている。
...
<!-- end list -->
  ...
  - YASU - [ドラムス](../Page/ドラムセット.md "wikilink")（2018年1月- ）

<!-- end list -->

  -
    [Shatter Silence等で活動](https://ja.wikipedia.org/wiki/Shatter_Silence "wikilink")。
...
<!-- end list -->
  ...
  -
    ギリシャ人女性ボーカリスト。ヴィジュアル系バンドのDEATHBIE（[AYABIE](https://ja.wikipedia.org/wiki/AYABIE "wikilink")）のPVマリアの鮮血にも出演している。
...
<!-- end list -->
  ...
  -
    [YOUTHQUAKE](https://ja.wikipedia.org/wiki/YOUTHQUAKE "wikilink")でも活動していた。
...
`at:06/01/2000 color:other layer:back`
`at:01/01/2001 color:other layer:back`
`at:07/17/2002 color:black layer:back`
`at:06/18/2003 color:black layer:back`
...
`bar:Sadew     text:"Sadew"`
`bar:Sophia    text:"Sophia"`
`bar:Kiki      text:"Kiki"`
`bar:Saika     text:"Saika"`
`bar:Ryu       text:"Ryu"`
`bar:Daiki     text:"Daiki"`
`bar:Shiromasa text:"Shiromasa"`
`bar:G.S.R     text:"G.S.R"`
`bar:Ryo       text:"Ryo"`
`bar:Yakky     text:"Yakky"`
`bar:Aki       text:"Aki"`
`bar:Makoto    text:"Makoto"`
`bar:Violator  text:"Violator"`
`bar:Gami      text:"Gami"`
`bar:Yasu      text:"Yasu"`
...
`bar:Sadew     from:04/01/2007 till:06/12/2010   color:vocals `
`bar:Sadew     from:10/07/2018 till:end          color:vocals `
`bar:Sophia    from:09/01/2010 till:07/21/2012   color:vocals`
...
`bar:Yasu      from:01/15/2018 till:end          color:drums`
...
3.  **IDOLATOR**（2005年8月18日）
    ...
    10. TYPE N
    11. LIFE STORY
    12. TRUE BLUE（[LUNA SEAのカバー](../Page/LUNA_SEA.md "wikilink")）
4.  **MOZAIQ**（2007年7月18日）
    ...
    12. EZ DO DANCE（日本盤ボーナストラック [TRF](../Page/TRF.md "wikilink")のカバー）
