...
上記の例において、barはクラスFooの**インスタンス変数**である。それに対して、bazは[クラス変数](../Page/クラス変数.md "wikilink")である。 以下の[プログラム](../Page/プログラム.md "wikilink")で、Foo[クラスを用いて](../Page/クラス_\(コンピュータ\).md "wikilink")[クラス変数](../Page/クラス変数.md "wikilink")と**インスタンス変数**の違いを示す。
...
上記のプログラムにおいて、foo1.bazとfoo2.bazはFooクラスの[クラス変数](../Page/クラス変数.md "wikilink")を表している。 つまり、foo1.bazとfoo2.bazが表している[インスタンス](../Page/インスタンス.md "wikilink")は同一である。 そのため、結果として出力されるfoo1.bazとfoo2.bazの値は同じとなる。 逆に、foo1.barとfoo2.barは**インスタンス変数**であり、独立した[変数である](https://ja.wikipedia.org/wiki/変数_\(プログラミング\) "wikilink")。 そのため、結果として出力されるfoo1.barとfoo2.barは異なった値となる。
