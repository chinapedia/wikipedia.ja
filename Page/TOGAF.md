...
**TOGAF**（）は、[エンタープライズアーキテクチャ](../Page/エンタープライズアーキテクチャ.md "wikilink")の[フレームワーク](https://ja.wikipedia.org/wiki/フレームワーク "wikilink")の1つであり、[情報アーキテクチャ](https://ja.wikipedia.org/wiki/情報アーキテクチャ "wikilink")の設計・計画・実装・管理の包括的アプローチを提供する。アーキテクチャは、ビジネス、アプリケーション、データ、テクノロジーの4段階あるいは4領域にモデル化されている。基盤アーキテクチャにより、アーキテクチャ実装チームは現状と将来の状態を描くことが可能となる。
...
1.  エンタープライズ・ビジネス・アーキテクチャ: ビジネス戦略、管理、組織、主要な[ビジネスプロセス](https://ja.wikipedia.org/wiki/ビジネスプロセス "wikilink")を定義する。
...
BとCの間で、追加の明確化を挿入することができ、それにより完全な[情報アーキテクチャ](https://ja.wikipedia.org/wiki/情報アーキテクチャ "wikilink")を提供する。
...
## 出版物
  ...
  - [TOGAF/MDA Mapping](http://www.opengroup.org/bookstore/catalog/w054.htm)（[OMGの](https://ja.wikipedia.org/wiki/Object_Management_Group "wikilink")[モデル駆動型アーキテクチャ](../Page/モデル駆動型アーキテクチャ.md "wikilink")(MDA)とのマッピング）
