...
### フリーではないもの
  ...
  - [Ultrix](../Page/Ultrix.md "wikilink")
    [DECが同社の](../Page/ディジタル・イクイップメント・コーポレーション.md "wikilink")[VAX](../Page/VAX.md "wikilink")やDECstation向けに出していた4.2BSD/4.3BSDベースのOS。初の[64ビット](https://ja.wikipedia.org/wiki/64ビット "wikilink")実装を行ったUNIXとしても知られている
