...
**SDL** (**Simple DirectMedia Layer**) は、[C言語](../Page/C言語.md "wikilink")で書かれた[クロスプラットフォーム](../Page/クロスプラットフォーム.md "wikilink")のマルチメディアライブラリである。[グラフィック](../Page/グラフィック.md "wikilink")の描画や[サウンド](https://ja.wikipedia.org/wiki/サウンド "wikilink")の再生などの[APIを提供する](../Page/アプリケーションプログラミングインタフェース.md "wikilink")。[Windows](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")、[macOS](https://ja.wikipedia.org/wiki/macOS "wikilink")、[Linux](../Page/Linux.md "wikilink")、[iOS](https://ja.wikipedia.org/wiki/iOS_\(アップル\) "wikilink")、[Androidを公式にサポートしている](../Page/Android_\(オペレーティングシステム\).md "wikilink")。SDL自身はC言語で書かれているが、[インタフェース部は](../Page/インタフェース_\(情報技術\).md "wikilink")[Perl](../Page/Perl.md "wikilink")、[Python](../Page/Python.md "wikilink")、[Ruby](../Page/Ruby.md "wikilink")、[Java](https://ja.wikipedia.org/wiki/Java "wikilink")などの[プログラミング言語](../Page/プログラミング言語.md "wikilink")にも移植されている。SDLそのものは[OS間の違いを吸収するための最低限の抽象化しか提供しないが](../Page/オペレーティングシステム.md "wikilink")、SDLで使える[フォント](../Page/フォント.md "wikilink")や[ネットワーク](../Page/コンピュータネットワーク.md "wikilink")、[スプライトなどの多数の](../Page/スプライト_\(映像技術\).md "wikilink")[ライブラリ](../Page/ライブラリ.md "wikilink")が公開されている。
