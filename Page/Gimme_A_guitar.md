...
前作『[GRACE](../Page/GRACE_\(SONS_OF_ALL_PUSSYSのアルバム\).md "wikilink")』から2か月ぶりとなる2作目のミニアルバム。

前作同様、初回限定盤、通常盤（CD）に[アナログ盤を含めた](../Page/レコード.md "wikilink")3形態でリリースされた。初回限定盤は10,000枚限定販売で、生産完全限定紙ジャケ仕様、通常盤はエンハンスド仕様となっており、ボーナス映像「Bubble shot 2」が収録されている。また、アナログ盤はナンバリング仕様となっている。
