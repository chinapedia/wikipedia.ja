...
**[リテラル](https://ja.wikipedia.org/wiki/リテラル "wikilink")**（）は、変項（命題）か変項の[否定](../Page/否定.md "wikilink")であり、否定演算子はこの形でのみ出現する。全ての変項（またはその否定）を含む論理式を**標準項**と呼び、特に全ての変項（またはその否定）の[論理和](../Page/論理和.md "wikilink")の形式になっている項を**最大項**と呼ぶ。従って、最大項の[論理積](../Page/論理積.md "wikilink")の形式になっている論理式は、CNF である。この形式は、[真理値表](https://ja.wikipedia.org/wiki/真理値表 "wikilink")で出力が「偽」となる行を最大項として取り出したものを論理積で繋いだものであり、その真理値表に対応する論理式となっている。つまり、真理値表で表されるものは全て連言標準形の論理式で表せ、[組合せ回路も連言標準形で表せる](https://ja.wikipedia.org/wiki/論理回路#組合せ回路 "wikilink")。

連言標準形から[節標準形](https://ja.wikipedia.org/wiki/節標準形 "wikilink")を作ることができ、節標準形は[導出](https://ja.wikipedia.org/wiki/導出 "wikilink")に使われる。

[計算複雑性理論](https://ja.wikipedia.org/wiki/計算複雑性理論 "wikilink")における重要な問題の一種として、連言標準形の論理式を「真」にする各変項の真偽の組合せを問う問題がある。これを[充足可能性問題](https://ja.wikipedia.org/wiki/充足可能性問題 "wikilink")(SAT)という。変項が3種類の 3-SAT は[NP完全問題](../Page/NP完全問題.md "wikilink")（3変項以上のSATは全てNP完全）だが、2-SAT は[多項式時間](https://ja.wikipedia.org/wiki/多項式時間 "wikilink")で解く事が出来る。
...
任意の論理式は等価な CNF に変換することができる。これを行うには、[二重否定の除去](https://ja.wikipedia.org/wiki/二重否定の除去 "wikilink")、[ド・モルガンの法則](../Page/ド・モルガンの法則.md "wikilink")、[分配法則](../Page/分配法則.md "wikilink")といった論理的に等価な変換を使う。全ての論理式は CNF に変換できるため、証明に際して全ての論理式が CNF であることを前提とすることが多い。しかし、元の論理式によっては、CNF への変換によって論理式が極めて長大になることもある。例えば、論理式
...
等価性よりも[充足可能性を満たすよう](https://ja.wikipedia.org/wiki/充足可能性問題 "wikilink") CNF に変換することで、論理式のサイズの指数関数的増加を招かない変換方式もある。このような変換方式でのサイズ増加は線形であることが保証されるが、新たな変数を導入する必要がある。たとえば、上の論理式は新たな変数 \(Z_1,\ldots,Z_n\) を導入することにより CNF
