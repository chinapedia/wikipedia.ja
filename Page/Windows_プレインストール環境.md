...
このバージョン以降と以前のバージョンに比して以下の特徴がある。
  ...
  - [WMI](https://ja.wikipedia.org/wiki/WMI "wikilink")アクセス、[Windows Scripting Host](https://ja.wikipedia.org/wiki/Windows_Scripting_Host "wikilink") (WSH)、追加ドライバ、他の[32ビット](../Page/32ビット.md "wikilink")アプリケーション（または[64ビット](https://ja.wikipedia.org/wiki/64ビット "wikilink")版のための64ビットのアプリ）といったような、様々なプラグインを含む起動イメージを作成するよう変更可能である。
