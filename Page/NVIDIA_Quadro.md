...
**Quadro**（クアドロ）は、[NVIDIA](https://ja.wikipedia.org/wiki/NVIDIA "wikilink")社のグラフィックス[アクセラレータ](https://ja.wikipedia.org/wiki/ハードウェアアクセラレーション "wikilink") ([GPU](../Page/Graphics_Processing_Unit.md "wikilink")) の製品群のひとつである。
...
G80コアすなわちDirectX 10世代の[統合型シェーダーアーキテクチャ](https://ja.wikipedia.org/wiki/統合型シェーダーアーキテクチャ "wikilink")を採用した製品以降は[CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")のほか、[OpenCL](https://ja.wikipedia.org/wiki/OpenCL "wikilink")や[DirectCompute](https://ja.wikipedia.org/wiki/DirectCompute "wikilink")といった[GPGPU](https://ja.wikipedia.org/wiki/GPGPU "wikilink") APIにも対応している。Kepler世代以降のQuadroは353.06ドライバーでOpenCL 1.2に正式対応している\[7\]が、それ以前のG80からFermiまではOpenCL 1.1までの対応となる。
...
通常のグラフィックスボード製品とは異なり、独立した筐体に電源および2枚のグラフィックスボードや冷却ファンを内蔵する製品で、[PCI Expressに対応したインターフェースボードをホスト側に導入することで利用する](https://ja.wikipedia.org/wiki/PCI_Express "wikilink")。
...
#### G80(GeForce 8800 GTS)ベース
  ...
  - **Quadro FX 4600**
      ...
      - OpenGL 3.3, DirectX 10, ShaderModel 4.0, [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")対応。
...
### GT2xxベース
  ...
  - **Quadro FX 380 LP**
      ...
      - OpenGL 3.3, DirectX 10.1, ShaderModel 4.1, [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")対応。
      - 消費電力は28W。
  - **Quadro 400**
...
#### GF108(GeForce GT 430)ベース
  ...
  - **Quadro 600**
      ...
      - OpenGL 4.3, DirectX 11, ShaderModel 5.0, [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")対応。1系統のデュアルリンクDVI+DisplayPort。HDCP対応。
      - 消費電力は40W。
...
#### GK107ベース
  ...
  - **Quadro 410** \[19\] \[20\] \[21\] \[22\] \[23\]
      ...
      - OpenGL 4.5, DirectX 12 (FL:11_0), ShaderModel 5.0, [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")対応。[OpenCL](https://ja.wikipedia.org/wiki/OpenCL "wikilink") 1.2。
...
<!-- end list -->
  ...
  - **Quadro K600** \[24\] \[25\]
      ...
      - OpenGL 4.3, DirectX 12 (FL:11_0), ShaderModel 5.0, [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")対応。[OpenCL](https://ja.wikipedia.org/wiki/OpenCL "wikilink") 1.2。
      - 1系統のデュアルリンクDVI、DisplayPort 1.2 (×1)。HDCP対応。
      - 消費電力は41W。
...
<!-- end list -->
  ...
  - **Quadro K420** \[26\] \[27\]
      - CUDAコア数192、コア876MHz、メモリ1GB/128bit/891MHz (1782MHzデータレート) DDR3。
      - OpenGL 4.4, DirectX 12 (FL:11_0), ShaderModel 5.0, [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")対応。[OpenCL](https://ja.wikipedia.org/wiki/OpenCL "wikilink") 1.2。
      - 1系統のデュアルリンクDVI、DisplayPort 1.2 (×1)。HDCP対応。
      - 消費電力は41W。
      - Quadro K600のリネーム品。
...
#### GM200ベース
  ...
  - **Quadro M6000** \[38\] \[39\] \[40\] \[41\]
      ...
      - OpenGL 4.5, DirectX 12 (FL:12_1), [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")対応。[OpenCL](https://ja.wikipedia.org/wiki/OpenCL "wikilink") 1.2。
...
NVIDIA Quadro FXシリーズは、主に[Microsoft DirectX](https://ja.wikipedia.org/wiki/Microsoft_DirectX "wikilink") ([Direct3D](https://ja.wikipedia.org/wiki/Direct3D "wikilink")) に最適化されている同社の3Dゲーム向けグラフィックスカード製品である[NVIDIA GeForceシリーズと比べて](https://ja.wikipedia.org/wiki/NVIDIA_GeForce "wikilink")、[OpenGL](../Page/OpenGL.md "wikilink")に最適化されている。ハードウェア面でも信頼性・安定性や表示精度を重視した設計がなされているほか、ドライバーソフトウェアも（OpenGL APIが利用されることの多い）[Adobe Photoshop](../Page/Adobe_Photoshop.md "wikilink")、[Autodesk](https://ja.wikipedia.org/wiki/Autodesk "wikilink") [3ds Maxや](https://ja.wikipedia.org/wiki/3ds_Max "wikilink")[SolidWorks](https://ja.wikipedia.org/wiki/SolidWorks "wikilink")といったプロフェッショナル向け・業務用途の画像処理ソフトウェア、統合型3DCGソフトウェアやCADソフトウェアに最適化されたものが提供されており、高負荷時のハンドリング性を向上するなど、運用時の安定性を確保できるようになっている\[66\]。

## Quadro FX Mシリーズ

モバイルワークステーション（ノート）に利用されるオンボードタイプのアクセラレータ。ラック積載型のブレード・ワークステーションにも採用される。

### [Centrino](https://ja.wikipedia.org/wiki/Centrino "wikilink")向け
...
OpenGL 2.1, DirectX 10, ShaderModel 4.0, [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink")対応。
...
| ----------------------------------------------------- | ------- | ------ | ---- | --- | ------------------------------------ | --------------------------------------------------------- | --------------------------------------- | ----------- | ----------- | ----------------------------------------------------------- |
| [CUDA](https://ja.wikipedia.org/wiki/CUDA "wikilink") | Tensor  | RT     |      | 容量  | バス幅                                  | 帯域                                                        | 単精度                                     | Tensor      | 帯域 (双方向)    | 対応                                                          |
...
## 関連項目
  ...
  - [NVIDIA GeForce](https://ja.wikipedia.org/wiki/NVIDIA_GeForce "wikilink")
