...
本データベースは膜結合タンパク質の実験的ならびに理論的研究において広く使われた\[14\]\[15\]\[16\]\[17\]\[18\]。しかしながら、膜結合タンパク質の膜中での空間的配置が3次元構造から計算的に予測できない場合、それらの多くのタンパク質の構造はデータベースに含まれていない。実験から得られた構造がタンパク質の全ての膜アンカーリング部位（[両親媒性](../Page/両親媒性分子.md "wikilink")[αヘリックス](https://ja.wikipedia.org/wiki/αヘリックス "wikilink")、露出した非極性残基、あるいは）を欠いている時にこれがあてはまる\[19\]。また、本データベースは蛋白質構造データバンクによって主鎖原子のぎあ提供されている低解像度構造も含まない。脂質二重膜中における低解像度タンパク質構造の計算された空間的配置はPDBTM\[20\]といったその他の情報源で見ることができる。

## 出典

[Category:生物医学データベース](https://ja.wikipedia.org/wiki/Category:生物医学データベース "wikilink") [Category:膜タンパク質](https://ja.wikipedia.org/wiki/Category:膜タンパク質 "wikilink") [Category:長大な項目名](https://ja.wikipedia.org/wiki/Category:長大な項目名 "wikilink")

1.  [ST NetWatch: Protein Databases](http://stke.sciencemag.org/cgi/ul/sigtransUl;CAT_4) review of OPM in Signal Transduction NetWatch list from [Science](https://ja.wikipedia.org/wiki/Science_\(journal\) "wikilink")
2.
3.
4.
5.
...
18.
19.
20. [PDBTM: Protein Data Bank of Transmembrane Proteins](http://pdbtm.enzim.hu/)