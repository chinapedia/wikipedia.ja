...
[流体力学](../Page/流体力学.md "wikilink")における**オイラー方程式**（オイラーほうていしき、）とは、[完全流体](https://ja.wikipedia.org/wiki/完全流体 "wikilink")を記述する[運動方程式](https://ja.wikipedia.org/wiki/運動方程式 "wikilink")である\[1\]。 この方程式は1755年に[レオンハルト・オイラー](https://ja.wikipedia.org/wiki/レオンハルト・オイラー "wikilink")により定式化された。完全流体とは[粘性](https://ja.wikipedia.org/wiki/粘性 "wikilink")を持たない流体である。粘性がないため、境界条件として壁面でのすべりを許す必要がある。 高[マッハ数](../Page/マッハ数.md "wikilink")の[圧縮性流れ](https://ja.wikipedia.org/wiki/圧縮性流れ "wikilink")では、流速が大きいことから粘性や[乱流](https://ja.wikipedia.org/wiki/乱流 "wikilink")の効果は壁面近くの小さな領域にしか現れないため、オイラー方程式を用いて流れの解析が行われる。
...
## 関連項目
  ...
  - [ベルヌーイの定理](https://ja.wikipedia.org/wiki/ベルヌーイの定理 "wikilink")
