...
## 主なプラグイン
  ...
  - DSDP (Device Software Development Platform)
    [組み込み](https://ja.wikipedia.org/wiki/組み込み "wikilink")[デバイスソフトウェア開発を支援するプラグイン](../Page/デバイスドライバ.md "wikilink")。
  ...
  - ADT (Android Development Tools) プラグイン
    [Google](../Page/Google.md "wikilink")が開発した携帯電話用プラットフォームである[Android用のプロジェクトの作成](../Page/Android_\(オペレーティングシステム\).md "wikilink")、ビルド、エミュレータの起動を行うためのプラグインであり、[Google](../Page/Google.md "wikilink")から公式IDEとして認定されていたが、2015年6月に、同年末で開発・サポートを終了することが発表され\[5\]、実際に開発・サポートが終了した。
