...
[2020年](../Page/2020年.md "wikilink")[2月13日](../Page/2月13日.md "wikilink")にマクラーレン・テクノロジーセンターで正式発表された\[1\]。

[前年に加入したテクニカルディレクターの](https://ja.wikipedia.org/wiki/2019年のF1世界選手権 "wikilink")[ジェームス・キー](../Page/ジェームス・キー.md "wikilink")が主導して開発された最初のマシンであり、翌年からパワーユニット(PU)を[メルセデスに変更するため](https://ja.wikipedia.org/wiki/メルセデスAMG_F1 "wikilink")、[ルノーPUを搭載する最後のマシンとなる](../Page/ルノーF1.md "wikilink")\[2\]。

前年の[MCL34をベースに制作されたが](https://ja.wikipedia.org/wiki/マクラーレン・MCL34 "wikilink")\[3\]、ノーズがより細くされて先端部の開口部がなくなり、フロントサスペンションも変更された。[インダクションボックスは電球型に変更され](../Page/エアインテーク.md "wikilink")、一部の冷却部品がサイドポッドからエンジンカバーの下に移動したことに伴って6区画に分けられた\[4\]。カラーリングのパパイヤオレンジとブルーは配置が変更され、軽量化のためにマット塗装を施した\[5\]。
...
### シャシー
  ...
  - 型式: MCL35
  - モノコック: ドライバーコントロールと[燃料電池](../Page/燃料電池.md "wikilink")を組み込んだ[カーボンファイバーコンポジット](https://ja.wikipedia.org/wiki/炭素繊維強化プラスチック "wikilink")
  - 安全構造: コクピット・サバイバルセル（耐衝撃構造）、貫通防止パネル、フロント・インパクト構造、規定されたサイド・インパクト構造、一体型リア・インパクト構造、フロント&リアロール構造、[Halo二次ロール構造](https://ja.wikipedia.org/wiki/Halo_\(フォーミュラカー\) "wikilink")
  - ボディーワーク: エンジンカバー、サイドポッド、フロア、ノーズ、フロントウイング、リアウイングを含むカーボンファイバーコンポジット、ドライバー操作によるドラッグ抵抗低減システム（[DRS](https://ja.wikipedia.org/wiki/ドラッグリダクションシステム "wikilink")）
  - [サスペンション](../Page/サスペンション.md "wikilink")
      - フロント: カーボンファイバー製[ウィッシュボーン](../Page/ダブルウィッシュボーン式サスペンション.md "wikilink")&プッシュロッドサスペンション、[トーションバー](../Page/トーションバー.md "wikilink")&[ダンパーシステム](../Page/ショックアブソーバー.md "wikilink")
      - リア: カーボンファイバー製ウィッシュボーン&プルロッドサスペンション、トーションバー&ダンパーシステム
  - 重量: 746kg（燃料を除く、ドライバーを含む）、重量配分は45.4%:46.4%
  - 電子機器: [マクラーレン](../Page/マクラーレン.md "wikilink")・アプライド シャシー制御とパワーユニット制御、データ収集機器、データ解析およびテレメトリー・システムを含む
  - 計器類: マクラーレン・アプライド ダッシュボード
  - [ブレーキ](../Page/ブレーキ.md "wikilink")システム: [曙ブレーキ工業](../Page/曙ブレーキ工業.md "wikilink")（AKEBONO） ブレーキキャリパー、マスターシリンダー、“[ブレーキ・バイ・ワイヤ](https://ja.wikipedia.org/wiki/ブレーキ・バイ・ワイヤ "wikilink")”ブレーキコントロールシステム、カーボンファイバー製[ディスクブレーキ](../Page/ディスクブレーキ.md "wikilink")・パッド
...
### パワーユニット
  ...
  - 型式: [ルノー](../Page/ルノーF1.md "wikilink") E-Tech 20
  - 最小重量: 145kg
  - パワーユニットコンポーネント：内燃エンジン(ICU)、MGU-K、MGU-H、エネルギー貯蔵装置(ES)、[ターボチャージャー](../Page/ターボチャージャー.md "wikilink")(TC)、コントロールエレクトロニクス(CE)
...
#### エンジン
  ...
  - 最大燃料容量: 110kg
  - [燃料噴射方式](../Page/燃料噴射装置.md "wikilink")：[直接噴射](../Page/ガソリン直噴エンジン.md "wikilink")（1シリンダーあたり1噴射器、最大500[bar](../Page/バール_\(単位\).md "wikilink")）
  - [ターボチャージャー](../Page/ターボチャージャー.md "wikilink"): 単段コンプレッサー、排気タービン、共通シャフト

#### エネルギー回生システム(ERS)

  - 機構: モーター・ジェネレーター・ユニットによるハイブリッド・エネルギー回生。MGU-Kはクランクシャフト、MGU-Hはターボチャージャーに接続
  - エネルギー貯蔵装置(ES): [リチウムイオン](https://ja.wikipedia.org/wiki/リチウムイオン "wikilink")バッテリー（20-25kg）、1周あたり最大4[MJを貯蔵](https://ja.wikipedia.org/wiki/ジュール#メガジュール "wikilink")
  - MGU-K
      - 最高回転数: 50,000rpm
      - 最大出力: 120kW
      - 最大回生量: 1周あたり2MJ
...
### トランスミッション
  ...
  - [ギアボックス](../Page/トランスミッション.md "wikilink"): カーボンファイバーコンポジット製ケース、縦置き
  - ギア数: 前進8速、後退1速
  - ギア操作: 電動油圧式シームレスシフト
  - [ディファレンシャル](https://ja.wikipedia.org/wiki/ディファレンシャル "wikilink"): [遊星歯車構造マルチプレート](../Page/遊星歯車機構.md "wikilink")・リミテッド・スリップ・クラッチ式ディファレンシャル
  - [クラッチ](https://ja.wikipedia.org/wiki/クラッチ "wikilink"): 電動油圧式カーボンファイバー製マルチプレートクラッチ
...
[Category:マクラーレンのF1マシン](https://ja.wikipedia.org/wiki/Category:マクラーレンのF1マシン "wikilink") [Category:2020年のF1マシン](https://ja.wikipedia.org/wiki/Category:2020年のF1マシン "wikilink")
