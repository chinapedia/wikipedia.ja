> この記事は[Clickclickclick.com](https://ja.wikipedia.org/wiki/Clickclickclick.com)から翻訳されています。


**Clickclickclick.com**（クリッククリッククリックドットコム、**CCC**）とは全世界で[クリック](../Page/クリック.md "wikilink")数を競い合うと言う主旨のゲームを開催していた[イギリス](https://ja.wikipedia.org/wiki/イギリス "wikilink")のホームページである\[1\]\[2\]\[3\]。

単に手動でクリックするだけでなく、専用のツールを開発することにより各国とも効率の良いクリックを目指しているのが特徴である\[4\]\[5\]。1ゲームの開催期間は一定ではなく、最短で4日、最長で2週間ほどである。

2017年7月17日のGame536をもってゲームが終了となった。

## 手動での参加方法

ページ内のHome+Clickに行き、認証画面内の英字を入力。するとクリック画面になるので、「CLICK\!」ボタンをクリックすればカウントされる。ある程度クリックすると「Click here to add to total」というボタンが表示され、これをクリックすることで初めてクリック数が自国のカウンターにカウントされる。クリック回数が自国カウンターにカウントされた後は再び認証画面に戻され、以降これを繰り返す。「Click here to add to total」を押さないままクリックを続けることも出来るが998まで行けばカウンターが止まってしまうので、「Click here to add to total」を押して数値を送りまた1から始める必要がある。

昨今ではクリック回数が18回になると「Autoclick\!」ボタンが表示されるようになりこのボタンを押すと何もしなくても自動でクリックされるが、あまりペースは速くない。なお「Autoclick\!」ボタンを使わずに50クリックすると、「Autoclick\!」ボタンが「Turboclick\!」に変わる。このボタンを押すことで「Autoclick\!」より速い自動クリックが行える。

## ツール

参加各国では効率よくクリックするためのツール開発が盛んであり、日本でもさまざまなツール（通称**砲台**）が開発されている\[6\]。また、クリックの過程1回ごとに通過しなければならない認証の文字入力は自動クリックツールにとって障害であり、この障害をどのように突破するかもツール開発の課題となる。
...
なお、Game17途中より認証画面が表示されてから約18秒以内に認証をしなければならないようになっている。

この認証画像を受け取って文字を入力する第三者は**認証人**などと呼ばれる。

## 規制

現在日本の主力となっているクリックツールだが運営サイドはツールを使用したクリックについて否定的な見解を示しており、強力なツールを使い続けた場合に後述の規制（BAN）がされることがある。どちらの規制もIP単位で行われるため、IPを変更すればまた同じようにクリックできる。また、他動認証の文字入力担当は規制を受けていても通常通り行うことができる。

### アクセス禁止

他のプレイヤーは通常通り参加できているのに、サイトにアクセスしてもclickclickclick3.com（主にサーバーが過負荷になったときに飛ばされるURL）に飛ばされる。アク禁または単純にBANとも呼ばれる。

### 99規制

プレイヤーは本来認証1回につき999回クリックできるが、この規制をかけられたプレイヤーは手動・ツールに関わらず99回までしかクリックできなくなる。「99監獄」とも呼ばれる。この規制は必然的に認証の回数を増やすことになり、規制をかけられたプレイヤーが自動クリックツールを使っていた場合には他動認証のリクエストが頻繁に送られる。結果、他動認証で文字入力を担当するプレイヤー（認証人）に大幅な負担をかけることになる。運営側はこれによって他動認証ツールの減速を狙っているとされている。

## リーグ制

ゲームごとに、順位によってポイントが蓄積されていく\[9\]。1位は200p。以降6位までは上位に対し20pずつ減少して加算される。同様に16位までは上位に対し5p減、41位までは2p減となり、以降は0pとなる。

最終的にはゲームによって蓄積されたポイント数で総合優勝が決まる。
...
<tr class="odd">
<td><p>Game35</p></td>
<td><p><a href="https://ja.wikipedia.org/wiki/2008年" title="wikilink">2008年</a>1月4日</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="even">
<td><p>Game88</p></td>
<td><p><a href="../Page/2009年.md" title="wikilink">2009年</a>1月5日</p></td>
<td></td>
<td></td>
<td><p>Other</p></td>
<td></td>
...
<tbody>
<tr class="odd">
<td><p>2007 league（Game1 - 34）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="even">
<td><p>2008 league（Game35 - 87）</p></td>
<td></td>
<td></td>
<td><p>Other</p></td>
<td></td>
...
<tr class="odd">
<td><p>2009 league（Game88 - 139）</p></td>
<td></td>
<td></td>
<td></td>
<td><p>Other</p></td>
...
<tr class="even">
<td><p>2010 league（Game140 - 190）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="odd">
<td><p>2011 league（Game191 - 244）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="even">
<td><p>2012 league（Game245 - 297）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="odd">
<td><p>2013 league（Game298 - 349）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="even">
<td><p>2014 league（Game350 - 402）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="odd">
<td><p>2015 league（Game403 - 455）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="even">
<td><p>2016 league（Game456 - 507）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="odd">
<td><p>2017 league（Game508 - 536）</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
また、台湾でもテレビで紹介されたほか、チリでは新聞にてニュースになったことがある。
...
## 外部リンク
  ...
  - [www.clickclickclick.com](http://www.clickclickclick.com/default.asp)

<!-- end list -->

  - [ClickJapan](http://www.clickjapan.jp/index.html) 日本のクリック参加者のウェブ
  - [ClickJapan@wiki](http://www33.atwiki.jp/clickvip/pages/1.html) 日本のクリック参加者のwiki
  - [Hupper HQ](http://www.hupper.hu/) ハンガリーのクリック参加者のウェブ

[Category:娯楽のウェブサイト](https://ja.wikipedia.org/wiki/Category:娯楽のウェブサイト "wikilink") [Category:ブラウザゲーム](https://ja.wikipedia.org/wiki/Category:ブラウザゲーム "wikilink")

1.  <http://www.clickclickclick.com/>
2.  <http://www.clickjapan.jp/>
3.  <http://www.hupper.hu/>
4.
5.
6.
7.
...
13.
14.
15. ワッチミー\!TV×TV [「ネッ得情報局」9/27（日）vol.5](http://www.watchme.tv/v2/?mid=b2bda5107e30f358ff7e47bd0fe6c828)
16. <http://www33.atwiki.jp/clickvip/pages/32.html>
17.
18.
19.
20.
21.
22.
23. <http://www.cafepress.com/originalgames>