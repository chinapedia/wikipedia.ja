...
上の拡張マクロセット [](../Page/LaTeX.md "wikilink") を日本語に対応させた、 上の拡張マクロセットもある。これを **** と呼ぶ。

アスキーでは、 を含む様々な編集ツール群を開発し、自社の出版業務に使用するとともに、このツール群を “EWB” (Editor's Work Bench) と呼んで公開もしている\[3\]。

### コミュニティ版

一方、2006年以降、アスキーによるおよびの更新は行われていない状況であった。2016年、最新のやへの対応など今後の開発を目指す日本語開発コミュニティがフォークして開発を開始した。

## 派生版

には派生版が存在する。

  - u - 2007年、田中琢爾作。内部を[UTF-8](../Page/UTF-8.md "wikilink")対応させたもの。[TeX Live](https://ja.wikipedia.org/wiki/TeX_Live "wikilink") 2012で取り込まれた。

  - \- 2008年、北川弘典作。と同じくレジストリ数を拡張したもの。[TeX Live](https://ja.wikipedia.org/wiki/TeX_Live "wikilink") 2011で取り込まれた。

派生版については、2012年の北川の講演資料が詳しい\[4\]。
...
## 外部リンク
  ...
  -
  - [日本語TeX開発コミュニティ](https://texjp.org/)

      - [TeX Wiki](https://texwiki.texjp.org/)
      - Github: [Japanese TeX Development Community](https://github.com/texjporg)
      - pLaTeXニュース: [pLaTeX-news - Google ドライブ](https://drive.google.com/drive/folders/0B6Eau41oUFv-V25oeUc1ckxvd2s)（最新版の変更内容について記されている）

  - [the Comprehensive  Archive Network](https://www.ctan.org/) ([CTAN](https://ja.wikipedia.org/wiki/CTAN "wikilink"))
