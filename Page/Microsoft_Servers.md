> この記事は[Microsoft Servers](https://ja.wikipedia.org/wiki/Microsoft_Servers)から翻訳されています。


**Microsoft Servers**は[マイクロソフト](../Page/マイクロソフト.md "wikilink")の[サーバ](../Page/サーバ.md "wikilink")製品群の商標の総称。この中には[Windows](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink")自体を含む。

以前、Microsoft Serversは**Windows Server System**と呼ばれていた。
...
マイクロソフトがいくつかの技術をサーバ製品としてリリースしたが、後にサーバ製品の一部として取り込まれたものがあった。
  ...
  - [Services for UNIX](https://ja.wikipedia.org/wiki/Services_for_UNIX "wikilink")
  - [ターミナル サービス](https://ja.wikipedia.org/wiki/リモート_デスクトップ_サービス "wikilink")
  - [Windows Media Services](https://ja.wikipedia.org/wiki/Windows_Media_Services "wikilink")
  - [Rights Management Services](https://ja.wikipedia.org/wiki/Rights_Management_Services "wikilink")

## 開発が中止されたサーバ製品

  - [Application Center](https://ja.wikipedia.org/wiki/Microsoft_Application_Center "wikilink")
  - [BackOffice Server](https://ja.wikipedia.org/wiki/Microsoft_BackOffice_Server "wikilink")
  - [Content Management Server](https://ja.wikipedia.org/wiki/Microsoft_Office_SharePoint_Server "wikilink")　SharePoint Serverに機能を統合
  - [Proxy Server](https://ja.wikipedia.org/wiki/Microsoft_Internet_Security_and_Acceleration_Server "wikilink")　ISA Serverに統合
  - [Site Server](https://ja.wikipedia.org/wiki/Microsoft_Site_Server "wikilink")
