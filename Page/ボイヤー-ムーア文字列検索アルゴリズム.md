...
<!-- end list -->
  ...
  - [Zhu–Takaoka string matching algorithm](https://ja.wikipedia.org/wiki/:en:Zhu–Takaoka_string_matching_algorithm "wikilink")\[11\]は連続した2つの文字列を用いてマッチングを行う。スキップテーブルを生成する[前処理の段階では遅くなるものの生成そのものは高速であり](../Page/プリプロセッサ.md "wikilink")、[アルファベットやパターンが小規模であるときに高速に処理できる](https://ja.wikipedia.org/wiki/アルファベット_\(計算機科学\) "wikilink")。
...
9.
10.
11. [情報処理学会誌に掲載された論文（英語）](http://ci.nii.ac.jp/els/110002673445.pdf?id=ART0002944519&type=pdf&lang=jp&host=cinii&order_no=&ppv_type=0&lang_sw=&no=1371874255&cp=)