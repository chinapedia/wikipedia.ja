...
**分配係数**（ぶんぱいけいすう、）とは、[化学物質](../Page/化学物質.md "wikilink")の[疎水性](https://ja.wikipedia.org/wiki/疎水性 "wikilink")や[移行性](https://ja.wikipedia.org/wiki/移行性 "wikilink")を表す指標となる[無次元数](https://ja.wikipedia.org/wiki/無次元数 "wikilink")である。対象とする物質が、ある2つの相の接した系中で[平衡状態にある場合を対象として](../Page/化学平衡.md "wikilink")、各相の[濃度](https://ja.wikipedia.org/wiki/濃度 "wikilink")比またはその[常用対数](https://ja.wikipedia.org/wiki/常用対数 "wikilink")で示す。
...
用いる2相が水と油の場合、分配係数は対象物質の水へのなじみにくさ（[疎水性](https://ja.wikipedia.org/wiki/疎水性 "wikilink")）を示す数値となる。疎水性は、薬や毒などの化学物質が生物の体内や自然環境中でどのようにはたらくかを考えるときに重要な要素となるため、多くの物質について分配係数が調べられている。特に、後述する**オクタノール/水分配係数 log *P*** は、化学物質を規制する法律等でも参考とされる数値になっており、国際的な測定方法が定められている。現在では[計算機化学](https://ja.wikipedia.org/wiki/計算機化学 "wikilink")の発展により、実際に測定しなくてもコンピュータで計算して分配係数が予測できるようになりつつある。
...
一方、カフェインの[オクタノール](https://ja.wikipedia.org/wiki/オクタノール "wikilink")中の化学ポテンシャルを *μ*<sub>o</sub> とし、カフェインの活量を *a*<sub>o</sub> とすると、
...
ちなみに、*μ*<sub>w</sub><sup>○</sup>と、*μ*<sub>o</sub><sup>○</sup>はともにカフェイン100%の化学ポテンシャルを意味するため、[理想溶液](../Page/理想溶液.md "wikilink")であるならば同じ値となる。しかしながら、それぞれ水およびオクタノールの希薄溶液において[ヘンリーの法則](https://ja.wikipedia.org/wiki/ヘンリーの法則 "wikilink")が成り立つ範囲の曲線を100%に[補外して求まるものに相当する](../Page/外挿.md "wikilink")。いずれもカフェインとの相互作用のない[ラウールの法則](https://ja.wikipedia.org/wiki/ラウールの法則 "wikilink")に従う理想溶液にはならないだろうから両者は一致しないと思われる。つまり、この理想溶液からのずれが、様々な化合物の分配係数を決定づけているのである。
...
2相中の濃度比をそのまま表す場合は一般的に記号 ***K*<sub>d</sub>** が用いられる。*K*<sub>d</sub> は[土壌](https://ja.wikipedia.org/wiki/土壌 "wikilink")中での[放射性物質](../Page/放射性物質.md "wikilink")の移動\[1\]、[クロマトグラフィー](../Page/クロマトグラフィー.md "wikilink")での固定相・移動相間の分配など、固-液系での場合に使用されることが多い。

一方、生体内での物質挙動など、液-液系を対象とする場合は、*K*<sub>d</sub> の[常用対数](https://ja.wikipedia.org/wiki/常用対数 "wikilink")である **log *P*** や **log *D*** であらわす。どちらも「分配係数」と呼ばれるが、log *P* (partition coefficient) は対象物質の[電離](https://ja.wikipedia.org/wiki/電離 "wikilink")を無視した数値であり、一方 log *D* (distribution coefficient)　は電離を考慮して log *P* に[酸解離定数](https://ja.wikipedia.org/wiki/酸解離定数 "wikilink") (p*K*<sub>a</sub>) などを加味した値であるため、数値が異なる。
...
最も古典的で信頼できる分配係数の算出方法は、対象物質と2種類の溶媒を実際に[フラスコ](https://ja.wikipedia.org/wiki/フラスコ "wikilink")に入れ、よく振りまぜる方法である。フラスコ振盪法による[オクタノール](https://ja.wikipedia.org/wiki/オクタノール "wikilink")/水分配係数の測定法は、「OECD Test Guideline 107」\[4\] や「[JIS](https://ja.wikipedia.org/wiki/JIS "wikilink") Z7260-107」\[5\]によって標準的な方法が詳しく定められており、log *P* が -2 から 4 （場合によっては5）までの試料に適用できる。

大まかな手順としては、よく精製した水とオクタノールを24時間以上混合してそれぞれ[飽和](https://ja.wikipedia.org/wiki/飽和 "wikilink")させ、十分に精製した測定対象物質と共にフラスコに取り温度を保ってよく振盪する。[遠心分離器](https://ja.wikipedia.org/wiki/遠心分離器 "wikilink")にかけ完全に相分離させたら、それぞれの相に含まれる試料量を物質に適した[機器分析](https://ja.wikipedia.org/wiki/機器分析 "wikilink")によって[定量](https://ja.wikipedia.org/wiki/定量 "wikilink")する。[紫外・可視・近赤外分光法](https://ja.wikipedia.org/wiki/紫外・可視・近赤外分光法 "wikilink")などの[分光法](https://ja.wikipedia.org/wiki/分光法 "wikilink")、[ガスクロマトグラフィー](https://ja.wikipedia.org/wiki/ガスクロマトグラフィー "wikilink")や[高速液体クロマトグラフィー](https://ja.wikipedia.org/wiki/高速液体クロマトグラフィー "wikilink")、特に[金属](../Page/金属.md "wikilink")[元素](../Page/元素.md "wikilink")を含む試料では[放射性同位体](../Page/放射性同位体.md "wikilink")を用いて[線量](https://ja.wikipedia.org/wiki/線量 "wikilink")測定するなどの方法が用いられる。オクタノール中の濃度 *C* と水中の濃度 *C* をそれぞれ求め、濃度比 *P* = *C* / *C* またはその常用対数 log *P* を分配係数とする。
...
HPLC法では、既知物質のデータさえ揃っていればフラスコ振盪法にくらべはるかに迅速に分配係数を決定でき、不純物等の影響も少ない。一方、水への[溶解度](../Page/溶解度.md "wikilink")が低いものやカラム[担体](https://ja.wikipedia.org/wiki/担体 "wikilink")と反応するもの、[錯体](../Page/錯体.md "wikilink")など測定中に分解する可能性があるものには適用できないため、予めおよその化学構造や物性がわかっている必要がある。また、分配係数は既知試料データからの[回帰分析](../Page/回帰分析.md "wikilink")によって算出するため、分配係数が既知の複数の物質が必要なこと、構造が大きく異なる化合物では[相関係数](https://ja.wikipedia.org/wiki/相関係数 "wikilink")が異なるため、比較しにくいことなどが欠点である。

## 予測方法

分配係数は、実際に測定しなくても[定量的構造活性相関](https://ja.wikipedia.org/wiki/定量的構造活性相関 "wikilink")[アルゴリズム](../Page/アルゴリズム.md "wikilink")を用いた計算によって求めることができる。[ドラッグデザイン](https://ja.wikipedia.org/wiki/ドラッグデザイン "wikilink")との関わりもあって[ケモインフォマティクス](https://ja.wikipedia.org/wiki/ケモインフォマティクス "wikilink")における重要な研究領域のひとつとなっている。
...
**[データマイニング](../Page/データマイニング.md "wikilink")法**では、[サポートベクターマシン](../Page/サポートベクターマシン.md "wikilink")・[ニューラルネットワーク](../Page/ニューラルネットワーク.md "wikilink")・[決定木](https://ja.wikipedia.org/wiki/決定木 "wikilink")などを用いて、化学構造が近く分配係数が既知の化合物で[学習させることで](https://ja.wikipedia.org/wiki/機械学習 "wikilink")、目的化合物の分配係数を求める。
