...
libavcodecはマルチメディアを扱う多くのオープンソースなアプリケーションやフレームワークにとって欠かせないものである。一般的に良く使われる[MPlayer](../Page/MPlayer.md "wikilink")、[xine](https://ja.wikipedia.org/wiki/xine "wikilink")及び[VLC](https://ja.wikipedia.org/wiki/VLC "wikilink")メディアプレーヤが全サポートプラットフォーム上でたくさんの音声・動画形式を再生可能にするためにメインの内蔵デコードエンジンとしてlibavcodecを使っている。また、[ffdshow](https://ja.wikipedia.org/wiki/ffdshow "wikilink") tryoutsのデコーダにもプライマリなデコードライブラリとして使われている。[GStreamer](../Page/GStreamer.md "wikilink") FFmpeg [plugin](https://ja.wikipedia.org/wiki/plugin "wikilink")\[2\]が一般的に良く使われる[特許を持つフォーマット](https://ja.wikipedia.org/wiki/ソフトウェア特許 "wikilink")(例えば [MPEG-2](../Page/MPEG-2.md "wikilink") (DVD video)、[MPEG-4 ASP](https://ja.wikipedia.org/wiki/MPEG-4_Part_2 "wikilink")、[H.264](https://ja.wikipedia.org/wiki/H.264 "wikilink")や[プロプライエタリ](https://ja.wikipedia.org/wiki/プロプライエタリ "wikilink")なフォーマットである[Windows Media Videoや](https://ja.wikipedia.org/wiki/Windows_Media_Video "wikilink")[VP6](https://ja.wikipedia.org/wiki/VP6 "wikilink")、[RealVideo](https://ja.wikipedia.org/wiki/RealVideo "wikilink")など)を再生するために、[Ubuntu](https://ja.wikipedia.org/wiki/Ubuntu "wikilink")のようなLinuxディストリビューションで使うことができる\[3\]。またlibavcodecはエンコード・デコードの為に[Avidemux](https://ja.wikipedia.org/wiki/Avidemux "wikilink")や[MEncoder](https://ja.wikipedia.org/wiki/MEncoder "wikilink")、[Kdenlive](https://ja.wikipedia.org/wiki/Kdenlive "wikilink")のようなビデオエディタやトランスコーディングアプリケーションにも使われている。
...
libavcodecは以下のフォーマットの動画のデコーダとエンコーダを含む\[4\]:
  ...
  - [FLV1(Sorenson Spark)](https://ja.wikipedia.org/wiki/Flash_Video "wikilink")
  - [Fraps](https://ja.wikipedia.org/wiki/Fraps "wikilink")（デコードのみ）
  - [H.261](https://ja.wikipedia.org/wiki/H.261 "wikilink")
  - [H.263](https://ja.wikipedia.org/wiki/H.263 "wikilink") / H.263-1996
  - H.263+ / H.263-1998 / H.263 version 2
  - [H.264](https://ja.wikipedia.org/wiki/H.264 "wikilink") / AVC / MPEG-4 AVC / MPEG-4 part 10 (デコードのみ、エンコードは[libx264を通して可能](https://ja.wikipedia.org/wiki/x264 "wikilink"))
...
<!-- end list -->
  ...
  - [MPEG-4 Part 2](https://ja.wikipedia.org/wiki/MPEG-4_Part_2 "wikilink") (エンコードは別に[xvidcoreを利用可](https://ja.wikipedia.org/wiki/Xvid "wikilink"))
  ...
  - RL2 video
  - [Sierra](https://ja.wikipedia.org/wiki/Sierra "wikilink") [VMD](https://ja.wikipedia.org/wiki/Sierra_Video_and_Music_Data_File "wikilink") Video
  - [Smacker video](https://ja.wikipedia.org/wiki/Smacker_video "wikilink") (デコードのみ)
  - SMPTE [VC-1](https://ja.wikipedia.org/wiki/VC-1 "wikilink") (デコードのみ)
  ...
  - [Theora](https://ja.wikipedia.org/wiki/Theora "wikilink") (デコードのみ、エンコードは別にlibtheoraを利用可)
  ...
  - [Windows Media Video](https://ja.wikipedia.org/wiki/Windows_Media_Video "wikilink") 7, 8
  - [Windows Media Video](https://ja.wikipedia.org/wiki/Windows_Media_Video "wikilink") 9 (デコードのみ)
...
libavcodecは以下のフォーマットの音声のデコーダとエンコーダを含む\[5\]:
  ...
  - [MP3](../Page/MP3.md "wikilink") (独自デコーダ、エンコードは[LAME](https://ja.wikipedia.org/wiki/LAME "wikilink")を通して)
  ...
  - [TTA](https://ja.wikipedia.org/wiki/TTA "wikilink") (デコードのみ)
  - [Vorbis](https://ja.wikipedia.org/wiki/Vorbis "wikilink") (エンコードは別に[libvorbisencを利用可](https://ja.wikipedia.org/wiki/Vorbis "wikilink"))
  - [WavPack](https://ja.wikipedia.org/wiki/WavPack "wikilink") (デコードのみ)
  - [Windows Media Audio](https://ja.wikipedia.org/wiki/Windows_Media_Audio "wikilink") 1
  - [Windows Media Audio](https://ja.wikipedia.org/wiki/Windows_Media_Audio "wikilink") 2
...
### 動画プレーヤ
  ...
  - [Media Player Classic -Homecinema](https://ja.wikipedia.org/wiki/Media_Player_Classic "wikilink")
...
### マルチメディアフレームワーク
  ...
  - [ffdshow](https://ja.wikipedia.org/wiki/ffdshow "wikilink") ([DirectShow](https://ja.wikipedia.org/wiki/DirectShow "wikilink")フィルタとしてlibavcodecをラップし、ポストプロセスを追加してイメージの品質を改善する。一度インストールすると[Windows Media Player](https://ja.wikipedia.org/wiki/Windows_Media_Player "wikilink")、[Media Player Classic](https://ja.wikipedia.org/wiki/Media_Player_Classic "wikilink")、[Winamp](https://ja.wikipedia.org/wiki/Winamp "wikilink")、[Zoom PlayerなどのWindowsのDirectShowを使用する全ての動画プレーヤが自動的にこれを使うようになる](https://ja.wikipedia.org/wiki/Zoom_Player "wikilink"))
