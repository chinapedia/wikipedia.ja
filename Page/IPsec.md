...
1993年12月、ソフトウェアIP暗号化プロトコル[:en:swIPe (protocol)は](https://ja.wikipedia.org/wiki/:en:swIPe_\(protocol\) "wikilink")[コロンビア大学](https://ja.wikipedia.org/wiki/コロンビア大学 "wikilink")と[AT\&Tベル研究所でジョン](../Page/ベル研究所.md "wikilink")・ヨアニディス他によって研究されていた。

[クリントン政権がwhitehouse](../Page/ビル・クリントン.md "wikilink").govの電子メールを[トラスディド・インフォメーション・システムズにホスティングした資金によって](https://ja.wikipedia.org/wiki/:en:w:Trusted_Information_Systems "wikilink")(1993年6月1日から1995年1月20日)、ウェイ・シューは1994年7月、IPセキュリティの研究に着手、IPプロトコルの機能を拡張し、[BSDIプラットフォーム上にIPSecを開発](https://ja.wikipedia.org/wiki/:en:w:Berkeley_Software_Design "wikilink")、すぐに[SunOS](../Page/SunOS.md "wikilink")、[HP-UX](../Page/HP-UX.md "wikilink")、その他UNIXシステムにも移植した。その成功にもとづいてウェイは[DES](https://ja.wikipedia.org/wiki/DES "wikilink")と[トリプルDES](../Page/トリプルDES.md "wikilink")の計算速度改善にも取り組んだ。アセンブリ言語によるソフトウェア暗号化は[Intel 80386アーキテクチャでは](../Page/Intel_80386.md "wikilink")[T1の通信速度にさえ対応できなかった](https://ja.wikipedia.org/wiki/:en:w:Digital_Signal_1 "wikilink")。ドイツからCryptoカードを輸出、ウェイはさらに今日[プラグアンドプレイ](../Page/プラグアンドプレイ.md "wikilink")と呼ばれる、自動化されたデバイスドライバーも開発し、ハードウェアのCryptoと統合した。T1を超えるスループットを実現した後、ウェイ・シューはついに実用に耐える商品を作成、著名なGauntletファイアーウォールの一部としてリリースした。1994年12月、米国の東海岸、西海岸にある遠隔拠点を結ぶ通信を暗号化するために初めて本番導入された。

一方、IPカプセル化セキュリティ・ペイロード (ESP) \[7\]は[DARPAの資金による研究プロジェクトの一部として](../Page/国防高等研究計画局.md "wikilink")[アメリカ海軍調査研究所](../Page/アメリカ海軍調査研究所.md "wikilink")で研究され、1993年12月、[IETF](https://ja.wikipedia.org/wiki/IETF "wikilink")のSIPP作業部会によってSIPPに対するセキュリティ拡張としてドラフトが公開された\[8\]。この[ESPはもともとISOのネットワーク層セキュリティプロトコル](https://ja.wikipedia.org/wiki/#ESP "wikilink")（NLSP）ではなく、[アメリカ国防総省](../Page/アメリカ国防総省.md "wikilink")のSP3Dプロトコルから派生したものだった。SP3Dプロトコルの仕様は[NISTにより公開されたが](../Page/アメリカ国立標準技術研究所.md "wikilink")、アメリカ国防総省のセキュアデータ・ネットワークシステム・プロジェクトにより設計されたものだった。セキュリティ認証ヘッダ（[AH](https://ja.wikipedia.org/wiki/#AH "wikilink")）の一部は、以前の[Simple Network Management Protocol](../Page/Simple_Network_Management_Protocol.md "wikilink")(SNMP)バージョン2の認証のためのIETF標準策定作業から派生したものである。

1995年、IETFのIPsec作業部会はオープンかつ自由に利用できるバージョンのプロトコル作成を開始、[セキュアデータ・ネットワークシステム](https://ja.wikipedia.org/wiki/セキュアデータ・ネットワークシステム "wikilink")(SDNS)プロジェクトに関する[アメリカ国家安全保障局](../Page/アメリカ国家安全保障局.md "wikilink")の契約の下で開発された。SDNSプロジェクトが定義したセキュリティプロトコル・レイヤー3(SP3)はNISTによって公開され、ISOのネットワーク層セキュリティ・プロトコル(NLSP)\[9\]の基礎にもなった。SP3の鍵管理は鍵管理プロトコル(KMP)によって提供され、これらに続くIPsec委員会の作業のベースラインを提供した。

IPsecは公式には[インターネット・エンジニアリング・タスクフォース](../Page/Internet_Engineering_Task_Force.md "wikilink")(IETF)の[Request for Comments](../Page/Request_for_Comments.md "wikilink")(RFC)の一連の文書として標準化され、さまざまなコンポーネントや拡張に対応している。その文書でプロトコルの名称は*IPsec*と表記すると定められている。\[10\]
