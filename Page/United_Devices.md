...
## 当時の製品ラインナップ
  ...
  - [Grid MP](https://ja.wikipedia.org/wiki/Grid_MP "wikilink") ユーザーのスケーラビリティに応じてさまざまなラインナップをそろえている分散コンピューティングソフトウェア。*Grid MP Workstation*、*Grid MP Cluster*、*Grid MP Enterprise*、*Grid MP Global*が用意されており、規模に応じて選ぶことができる。
  - [MP Insight](https://ja.wikipedia.org/wiki/MP_Insight "wikilink") ユーザーのコンピュータリソースが有効に使われているかどうかを解析するツール。
  - [MP Synergy](https://ja.wikipedia.org/wiki/MP_Synergy "wikilink") 複数のクラスタの[ジョブスケジューラ](https://ja.wikipedia.org/wiki/ジョブスケジューラ "wikilink")を統括してスケジューリングを行なう[メタスケジューラ](https://ja.wikipedia.org/wiki/メタスケジューラ "wikilink")。[Sun Grid Engine](../Page/Sun_Grid_Engine.md "wikilink")、[Platform LSF](https://ja.wikipedia.org/wiki/Platform_LSF "wikilink")、[PBS](https://ja.wikipedia.org/wiki/Portable_Batch_System "wikilink")、[LoadLeveler](https://ja.wikipedia.org/wiki/LoadLeveler "wikilink")、[Grid MPをサポートする](https://ja.wikipedia.org/wiki/Grid_MP "wikilink")。

## 公共の慈善活動

ユナイテッドデバイセズ社は一連の公共のプロジェクトを[慈善](https://ja.wikipedia.org/wiki/慈善 "wikilink")活動の一環として、ウェブサイト[grid.org](https://ja.wikipedia.org/wiki/grid.org "wikilink") 上で行っている。また、それは [Grid MP Global製品の普及を認識させるだけでなく](https://ja.wikipedia.org/wiki/Grid_MP "wikilink")、プラットフォームの[スケーラビリティ](https://ja.wikipedia.org/wiki/スケーラビリティ "wikilink")（拡張性）をもデモンストレーションする[マーケティング](../Page/マーケティング.md "wikilink")ツールの一環でもある。grid.orgのプロジェクトの運用に関係がある費用のいくらかは、これまで[マイクロソフト](../Page/マイクロソフト.md "wikilink")、[インテル](https://ja.wikipedia.org/wiki/インテル "wikilink")、[IBM](../Page/IBM.md "wikilink")を含む複数の企業から一部資金提供がなされてきている。

### 当時のプロジェクト

  - [United Devices Cancer Research Project](../Page/United_Devices_Cancer_Research_Project.md "wikilink") - UDがん研究プロジェクトとも表記される。UD分散コンピューティングを用いて、ガンを治療する可能性のある薬を探していたが、2007年4月27日をもって活動を終了した。
  - [World Community Grid](../Page/World_Community_Grid.md "wikilink") 現在、[Human Proteome Folding Project](https://ja.wikipedia.org/wiki/Human_Proteome_Folding_Project "wikilink") をユナイテッドデバイス社と連携して運用している。

## 公表されていたユーザ

Grid MPを使っている著名な団体のリストが[ユナイテッド　デバイス社のウェブサイト](http://www.ud.com/company/customers/)上に掲載されていた。
