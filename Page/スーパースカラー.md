...
**スーパースカラー**(*superscalar*，スーパースケーラ)とは、[プロセッサ](../Page/プロセッサ.md "wikilink")の[マイクロアーキテクチャ](../Page/マイクロアーキテクチャ.md "wikilink")における用語で、複数の命令を同時にフェッチし、複数の同種のあるいは異種の[実行ユニット](../Page/実行ユニット.md "wikilink")を[並列に動作させ](../Page/並列計算.md "wikilink")、プログラムの持つ[命令レベルの並列性](https://ja.wikipedia.org/wiki/命令レベルの並列性 "wikilink")を利用して性能の向上を図るアーキテクチャである。
...
1.  命令列の本質的な並列性の度合い。つまり、[命令レベルの並列性](https://ja.wikipedia.org/wiki/命令レベルの並列性 "wikilink")の制約。
...
## 関連項目
  ...
  - [投機的実行](https://ja.wikipedia.org/wiki/投機的実行 "wikilink")/[積極的実行](https://ja.wikipedia.org/wiki/積極的実行 "wikilink")
