> この記事は[グローランサーVI](https://ja.wikipedia.org/wiki/グローランサーVI)から翻訳されています。
...
### パーティーメンバー
  ...
  - メークリッヒ
    [声](../Page/声優.md "wikilink")：[四反田マイケル](../Page/四反田マイケル.md "wikilink")
    肉体年齢21歳、身長180cm、体重78kg。
    本作の[主人公](../Page/主人公.md "wikilink")。国際的大企業モノポリス社の持つ私設軍の一員。
    ...
    劇中ではイリステレサやアニータの回想中でのみ喋る。イリステレサ回想の1シーンのみボイスがついており、その場面とドラマCD版ではコマンダー13と同じ[四反田マイケル](../Page/四反田マイケル.md "wikilink")が声を担当。
  ...
  - ルキアス
    ...
    ドラマCDでは「世界の意志（ユーザーへの需要）」によって女体化してしまい、『[グローランサー](../Page/グローランサー.md "wikilink")』のヒロイン・ルイセの声真似をメークリッヒに要求されてしまう。二回ほどメークリッヒに殴ってツッコミを入れるなど気の強さが現れているが、本作のような生意気さはほとんどない。
      - 戦闘スタイル
  ...
  - アニータ
    ...
    父親の道具として過ごし、生きる気力を失いかけていた時にメークリッヒと出会い、彼と接することで生きる希望を取り戻す。そのため、仲間に加わった時点で既に[フラグが立っている](../Page/フラグ_\(ストーリー\).md "wikilink")（好感度上昇のみで攻略可能）。
...
### CD
  ...
  - ドラマCD グローランサーVI
    2007年10月24日発売、[フロンティアワークス](../Page/フロンティアワークス.md "wikilink")/発売元、[ジェネオンエンタテインメント](https://ja.wikipedia.org/wiki/ジェネオンエンタテインメント "wikilink")/販売元
...
各編でのキャラクターの立場や配役、ゲーム本編との性格等の違いについても記載。
  ...
  - ルキアス
    モノポリス学園女子生徒（学園編）
      ...
      -
        学園編では俺っ娘女子として登場。また、声優が同じ[ルイセの台詞をメークリッヒに強要された](../Page/グローランサー.md "wikilink")。カルトGではメークリッヒと共に冒険の旅に出ることを熱望し（要するにヒロイン枠を目指して）奮闘する。
