...
標準パッケージには [C](../Page/C言語.md "wikilink")、[C++](../Page/C++.md "wikilink")、[Objective-C](../Page/Objective-C.md "wikilink")、[Objective-C++](https://ja.wikipedia.org/wiki/Objective-C++ "wikilink")、[Fortran](https://ja.wikipedia.org/wiki/Fortran "wikilink")、[Java](https://ja.wikipedia.org/wiki/Java "wikilink")、[Ada](../Page/Ada.md "wikilink")、[Go](https://ja.wikipedia.org/wiki/Go_\(プログラミング言語\) "wikilink")、[D](../Page/D言語.md "wikilink") のコンパイラ並びにこれらの[ライブラリ](../Page/ライブラリ.md "wikilink")が含まれている。
