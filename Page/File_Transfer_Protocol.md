...
FTPソフトウェアの中には、「モードZ」と呼ばれる[Deflate](../Page/Deflate.md "wikilink")を使用した圧縮モードを実装しているものがある。このモードは[インターネットドラフト](../Page/インターネットドラフト.md "wikilink")に記載されているが、標準化はされていない\[17\]。
