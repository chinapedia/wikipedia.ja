...
**文字コード**（もじコード）とは、[コンピュータ](../Page/コンピュータ.md "wikilink")上で[文字](../Page/文字.md "wikilink")（[キャラクタ](../Page/キャラクタ_\(コンピュータ\).md "wikilink")）を利用する目的で各文字に割り当てられる[バイト表現](../Page/バイト_\(情報\).md "wikilink")。もしくは、バイト表現と文字の対応関係（文字コード体系）のことを指して「文字コード」と呼ぶことも多い。本記事では主に後者について記述する。

## 概説

文字コードとは、コンピュータなどの電子媒体において、文章を画像などの図形データとして扱わずに、[テキスト](../Page/テキスト.md "wikilink")の形式で扱う場合に、その各文字（単一の文字でない場合もある）に対して持っているコードのことである。
...
文字コードの歴史は電気通信の歴史とほぼ等しい。古くは[テレックス](../Page/テレックス.md "wikilink")で用いられた[国際電信アルファベット第2](https://ja.wikipedia.org/wiki/国際電信アルファベット第2 "wikilink")、アメリカ規格協会 (ASA) が定めた [ASCII](https://ja.wikipedia.org/wiki/ASCII "wikilink")、[IBM](../Page/IBM.md "wikilink") によって開発された [EBCDIC](https://ja.wikipedia.org/wiki/EBCDIC "wikilink") 等があった。しかしコンピュータシステムが多くの言語圏で利用されるようになるにつれて文字コードの種類も増大し、現在では100種類以上の代表的な文字コードが存在する。

コンピュータの発展が早かった[英語](../Page/英語.md "wikilink")圏やその他の[アルファベット](https://ja.wikipedia.org/wiki/アルファベット "wikilink")を使用する言語（主に西洋）、[日本語](../Page/日本語.md "wikilink")、[中国語](https://ja.wikipedia.org/wiki/中国語 "wikilink")、[韓国語などは早くから言語固有の文字コードが制定され利用可能になった](../Page/朝鮮語.md "wikilink")。その他の大部分の言語も[Unicode](../Page/Unicode.md "wikilink")の普及とともにコンピュータ上で文字を正常に表現することができるようになりつつある。
...
Unicode文字符号化モデル\[1\]では更に進んで、文字コードは以下の4段階に分けられる。
  ...
  - **抽象文字集合**（）：符号化の対象とする順序のない文字の集合。ただし一般的な「文字」とは異なる場合があり、[書記素](../Page/書記素.md "wikilink")と混同するべきではない\[2\]。

<!-- end list -->

  - **符号化文字集合**（）：抽象文字集合を非負整数に対応させたもの。この非負整数の範囲を符号空間、各値を符号位置といい、抽象文字は対応後、符号化文字となる\[3\]。抽象文字は複数の符号化文字に対応されることもある（[異体字セレクタ](../Page/異体字セレクタ.md "wikilink")）\[4\]。Unicodeでは代用符号位置・非文字符号位置・未割り当て符号位置があるため、すべての符号位置が抽象文字と対応しているわけではない\[5\]。
...
<!-- end list -->
  ...
  -
    この「キャラクタセット」は「[オクテットの並びを](../Page/8ビット.md "wikilink")[文字](../Page/文字.md "wikilink")の並びに変換する方式」等と定義されている\[7\]。MIME で実現する[電子メール](../Page/電子メール.md "wikilink")メッセージなどの処理を主眼に置いた概念である。
...
<!-- end list -->
  ...
  - コードページ
    [IBM](../Page/IBM.md "wikilink")や[マイクロソフト](../Page/マイクロソフト.md "wikilink")は独自に文字コードに番号（[コードページ](../Page/コードページ.md "wikilink")）を振って管理している。
...
外字というユーザが独自に[文字](../Page/文字.md "wikilink")を登録できる領域がある文字コードは複数存在する。[Unicode](../Page/Unicode.md "wikilink") においては 6,400 + 131,072 文字の「[PUA](../Page/外字.md "wikilink") （Private Use Area = 私的領域）」があり、Windows-31J ([Microsoft Windows Codepage 932](../Page/Microsoftコードページ932.md "wikilink")) にも1,880文字の外字領域がある。ユーザが独自にフォントを登録した文字(ユーザ定義文字)は、文書の交換時に特別に同意しない限りは他の環境で読むことができないので、互換性の上で重大な問題を引き起こす事がある。ベンダ拡張文字の場合は、ユーザが表外字でないことを認識せずに利用してしまう事があるため、より重大な問題を引き起こす(例として挙げれば、Windows環境(CP932)のローマ数字がMac環境では化けて表示されるなど)。
...
### 文字符号化方式と文字コード（キャラクタセット）
  ...
  - [シフト符号化表現](https://ja.wikipedia.org/wiki/シフト符号化表現 "wikilink")の文字符号化方式を用いた8ビットの文字コード。
      ...
      - [Windows-31J](../Page/Microsoftコードページ932.md "wikilink") （[Microsoft Windows Codepage 932](../Page/Microsoftコードページ932.md "wikilink") 対応）
...
印刷業界においては、公的な文字コード規格では包摂されている[異体字](https://ja.wikipedia.org/wiki/異体字 "wikilink")や[グリフ](https://ja.wikipedia.org/wiki/グリフ "wikilink")の相違を厳密に区別したいというニーズが強く存在する。 そのため、そのようなニーズに応える文字集合が企業ベースで策定されている。一般的な情報交換に用いられることはない。
  ...
  - [Adobe-Japan1](https://ja.wikipedia.org/wiki/Adobe-Japan1 "wikilink")文字コレクション
      - Adobe-Japan1-0
  ...
  - Adobe-GB1 文字コレクション（[簡体字](https://ja.wikipedia.org/wiki/簡体字 "wikilink")[中国語](https://ja.wikipedia.org/wiki/中国語 "wikilink")）
      - Adobe-GB1-0
      - Adobe-GB1-1
      - Adobe-GB1-2
      - Adobe-GB1-3
      - Adobe-GB1-4
      - Adobe-GB1-5
  - Adobe-CNS1 文字コレクション（[繁体字](../Page/繁体字.md "wikilink")[中国語](https://ja.wikipedia.org/wiki/中国語 "wikilink")）
      - Adobe-CNS1-0
      - Adobe-CNS1-1
      - Adobe-CNS1-2
      - Adobe-CNS1-3
...
以下は、主に[メインフレーム](../Page/メインフレーム.md "wikilink")・[オフコンなどの](../Page/オフィスコンピュータ.md "wikilink")[プロプライエタリな](../Page/プロプライエタリ・ソフトウェア.md "wikilink")[レガシーコンピュータ](https://ja.wikipedia.org/wiki/レガシーコンピュータ "wikilink")やレガシーなシステム、特殊な環境において利用される文字コードを含む。レガシーなものとの連携を目的とする場合を除き、[パソコンで利用されることがないものが多い](../Page/パーソナルコンピュータ.md "wikilink")。
  ...
  - [NEC](../Page/日本電気.md "wikilink")
      ...
      - NEC内部コード(E)
          -
            [ITOS](https://ja.wikipedia.org/wiki/ITOS "wikilink")、[A-VX](https://ja.wikipedia.org/wiki/A-VX "wikilink") 系の[オフコンで利用される](../Page/オフィスコンピュータ.md "wikilink")。JIPS(J) の上1バイトをシフトさせたものに対して上下1バイトをそれぞれ [EBCDIC](https://ja.wikipedia.org/wiki/EBCDIC "wikilink") に変換して得られるコード。
...
### その他の文字コード
  ...
  - 諸橋[大漢和辞典](../Page/大漢和辞典.md "wikilink") - 日本での漢字の収録が最も多い辞典。
  ...
  - 企業・団体のコード
      ...
      - JTBコード - [JTB](../Page/JTB.md "wikilink")が自社の客室予約システム[TRIPS](https://ja.wikipedia.org/wiki/TRIPS "wikilink")で使用していた漢字コード\[9\]
