...
**同期検波** （どうきけんぱ）（coherent detection,synchronous detection）は、[振幅変調](../Page/振幅変調.md "wikilink")や[デジタル変調](../Page/デジタル変調.md "wikilink")など、搬送波を持つ\[1\]変調された信号を、[復調](https://ja.wikipedia.org/wiki/復調 "wikilink")する方法の一つである。[送信機](https://ja.wikipedia.org/wiki/送信機 "wikilink")で[変調](https://ja.wikipedia.org/wiki/変調 "wikilink")するのに使った[搬送波](https://ja.wikipedia.org/wiki/搬送波 "wikilink")と[位相](../Page/位相.md "wikilink")が同期した搬送波を[受信機](../Page/受信機.md "wikilink")側で何らかの方法で作りだし、この搬送波を使って[検波](https://ja.wikipedia.org/wiki/検波 "wikilink")する。
...
一般的な[包絡線検波](https://ja.wikipedia.org/wiki/包絡線検波 "wikilink")の受信機と比較して、USB、LSBの一方を選択して復調することもできることから、[混信](https://ja.wikipedia.org/wiki/混信 "wikilink")の影響などを受けているのが片側の場合にそれを回避できる。
