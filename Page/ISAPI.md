...
**Internet Server Application Programming Interface** (**ISAPI**) は、[マイクロソフト](../Page/マイクロソフト.md "wikilink")の[Windows NT系に付属](../Page/Microsoft_Windows_NT.md "wikilink")（一部除く）する[IISの](../Page/Internet_Information_Services.md "wikilink")[n層API](../Page/多層アーキテクチャ.md "wikilink")。主に[Webサーバ](../Page/Webサーバ.md "wikilink")として利用されている。
...
ISAPI Filtersを利用して、主に以下の様なジョブが利用されている。
  ...
  - 匿名または[基本認証のコントロール](../Page/Basic認証.md "wikilink")
  - 独自のアクセス拒否(HTTP 403)の応答
  - [トラフィック解析](../Page/アクセス解析.md "wikilink")
  - 独自の認証
  - 暗号化や圧縮
...
ISAPIを利用してのアプリケーション開発は、[Visual C++](../Page/Microsoft_Visual_C++.md "wikilink") 4.0からサポートされている。Wizardを利用してISAPIフレームワークを作成できる。開発は主に[MFCを利用して開発する](../Page/Microsoft_Foundation_Class.md "wikilink")。
