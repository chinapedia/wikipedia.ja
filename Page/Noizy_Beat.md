...
<!-- end list -->
  ...
  -
    作詞:[高山征輝](../Page/高山征輝.md "wikilink")（1-11）
    作曲:高山征輝（1-5,8）、後藤康二（6,7,9,10）、[織田哲郎](../Page/織田哲郎.md "wikilink")（11）
    編曲:ZYYG（1-11）
...
## 参加ミュージシャン
  ...
  - 高山征輝 - ボーカル
  - 後藤康二 - ギター、コーラス
  - [加藤直樹](https://ja.wikipedia.org/wiki/加藤直樹_\(ベーシスト\) "wikilink") - ベース、コーラス
