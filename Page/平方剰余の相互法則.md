...
[thumbは](https://ja.wikipedia.org/wiki/ファイル:Disqvisitiones-800.jpg "wikilink")『[整数論](https://ja.wikipedia.org/wiki/Disquisitiones_Arithmeticae "wikilink")』（1801年）で平方剰余の相互法則の最初の証明を公開した。\]\] ****（へいほうじょうよ、）とは、ある[自然数](../Page/自然数.md "wikilink")を法としたときの[平方数](https://ja.wikipedia.org/wiki/平方数 "wikilink")のことであり、**平方剰余の相互法則**（へいほうじょうよのそうごほうそく、）は、ある[整数](../Page/整数.md "wikilink")  が別の整数  の平方剰余であるか否かを判定する[法則](https://ja.wikipedia.org/wiki/法則 "wikilink")である。

## 定義

整数  と  とが[互いに素](https://ja.wikipedia.org/wiki/互いに素 "wikilink")であるとする。合同式
...
\end{cases}\] を、**平方剰余記号**、または[アドリアン＝マリ・ルジャンドル](https://ja.wikipedia.org/wiki/アドリアン＝マリ・ルジャンドル "wikilink")にちなんで**ルジャンドル記号** ([Legendre symbol](https://ja.wikipedia.org/wiki/:en:Legendre_symbol "wikilink"))と呼ぶ。

## 相互法則

**平方剰余の相互法則**は[整数](../Page/整数.md "wikilink")  が[奇](https://ja.wikipedia.org/wiki/奇数 "wikilink")[素数](../Page/素数.md "wikilink")  を法として平方剰余であるか否かを判定する[法則](https://ja.wikipedia.org/wiki/法則 "wikilink")である。
...
\[\left( \frac{ab}{p} \right) = \left( \frac{a}{p} \right)\left( \frac{b}{p} \right)\] が成立する。一般に素数  に対して 1, 2, ..., *p* − 1{{)}}}} は  を法として乗法に関して[群になることが知られているが](https://ja.wikipedia.org/wiki/群_\(数学\) "wikilink")、この式は  から −1, 1{{)}}}} への群[準同型](https://ja.wikipedia.org/wiki/準同型 "wikilink")写像が存在することを示している。よってその写像の[核は位数](../Page/核_\(代数学\).md "wikilink")  の部分群となり、 の要素の半分は平方剰余であり、半分は平方非剰余であることが分かる。

この法則は、[レオンハルト・オイラー](https://ja.wikipedia.org/wiki/レオンハルト・オイラー "wikilink")によって予想され、[カール・フリードリッヒ・ガウス](https://ja.wikipedia.org/wiki/カール・フリードリッヒ・ガウス "wikilink")によって証明された（ガウス日誌によれば、[1796年](../Page/1796年.md "wikilink")[4月8日](https://ja.wikipedia.org/wiki/4月8日 "wikilink")。発表されたのは[1801年](../Page/1801年.md "wikilink")の『[整数論](https://ja.wikipedia.org/wiki/Disquisitiones_Arithmeticae "wikilink")』において）。ガウスはこの法則に対して生涯で7つ（または8つ）の異なる証明を与えた\[1\]。その一つの動機は、三次や四次の相互法則を証明することにあった。現在では240以上もの証明が知られている\[2\]。

三次や四次の相互法則は、[ヤコビ](https://ja.wikipedia.org/wiki/カール・グスタフ・ヤコブ・ヤコビ "wikilink")、[アイゼンシュタインによって独立に証明された](https://ja.wikipedia.org/wiki/フェルディナント・ゴットホルト・マックス・アイゼンシュタイン "wikilink")（[1844年](../Page/1844年.md "wikilink")にアイゼンシュタインが証明を公表）。より高次のまた一般的な代数的整数における一般的な相互法則の証明は（[ヒルベルトの第9問題](https://ja.wikipedia.org/wiki/ヒルベルトの23の問題#第9問題 "wikilink")）、[高木貞治](https://ja.wikipedia.org/wiki/高木貞治 "wikilink")や[エミール・アルティン](https://ja.wikipedia.org/wiki/エミール・アルティン "wikilink")によってなされた。（[アルティン相互法則](https://ja.wikipedia.org/wiki/アルティン相互法則 "wikilink")を参照）

## 平方剰余の相互法則の応用

型の素数は[二個の平方数の和](https://ja.wikipedia.org/wiki/二個の平方数の和 "wikilink")で表すことができる。また逆にある奇素数が二つの平方数の和で表すことができるならば、 型の素数である。
