...
[数学](../Page/数学.md "wikilink")において**被覆**（ひふく、cover）とは、ある[集合](../Page/集合.md "wikilink")がその集合の[部分集合](../Page/部分集合.md "wikilink")の[族で覆われるとき](https://ja.wikipedia.org/wiki/族_\(数学\) "wikilink")、その部分集合の族のことをいう。
...
集合 *S* とその被覆 *U* = {*U*<sub>*i*</sub> | *i* ∈ *I*} に対して
  ...
  - 添字集合 *I* が[有限集合](https://ja.wikipedia.org/wiki/有限集合 "wikilink")である場合、**有限被覆** (finite cover) という。
