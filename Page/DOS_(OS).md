...
[IBM](../Page/IBM.md "wikilink")の[メインフレーム](../Page/メインフレーム.md "wikilink")である[System/360](https://ja.wikipedia.org/wiki/System/360 "wikilink")のディスク装置搭載モデル用に用意されたOSの1つ。System/360の小型機種向けには BOS/360（ベーシック・オペレーティングシステム）、TOS/360（テープ・オペレーティングシステム）、DOS/360（ディスク・オペレーティングシステム）があった。DOS/360は1966年にリリースされ、DOS/VS（ディスク・オペレーティングシステム/仮想記憶）, DOS/VSE, VSE/AF, VSE/SP, VSE/ESA へと発展し、最終的に [z/VSE](https://ja.wikipedia.org/wiki/z/VSE "wikilink") に進化した。
...
## パーソナルコンピュータ用
  ...
  - [Apple DOS](https://ja.wikipedia.org/wiki/Apple_DOS "wikilink") （[\#その他](https://ja.wikipedia.org/wiki/#その他 "wikilink")も参照）
  - [Atari DOS](https://ja.wikipedia.org/wiki/Atari_DOS "wikilink")
  - [Commodore DOS](https://ja.wikipedia.org/wiki/Commodore_DOS "wikilink")
  - [CSI-DOS](https://ja.wikipedia.org/wiki/CSI-DOS "wikilink")
  - [IS-DOS](https://ja.wikipedia.org/wiki/IS-DOS "wikilink")
  - [ProDOS](https://ja.wikipedia.org/wiki/ProDOS "wikilink")
  - [TRS-DOS](https://ja.wikipedia.org/wiki/TRS-DOS "wikilink")
  - [MSX-DOS](../Page/MSX-DOS.md "wikilink")
  - [F-DOS](https://ja.wikipedia.org/wiki/F-DOS "wikilink") （SHARP製の開発ツール）
  - [H-DOS](https://ja.wikipedia.org/wiki/H-DOS "wikilink") （[ハドソン](../Page/ハドソン.md "wikilink")製のDOS）

## その他

### APPLE IIのDISK拡張機能

[アップルコンピュータによる](../Page/アップル_\(企業\).md "wikilink")[Apple IIのDISK拡張機能](../Page/Apple_II.md "wikilink")。

Apple IIの[DISK機能拡張もDOS](https://ja.wikipedia.org/wiki/ディスク "wikilink")3.xと呼ばれている。これは[BASIC](../Page/BASIC.md "wikilink")に付加することを強く意識しているため、一見すると他のマシンで言うところの[DISK-BASIC](https://ja.wikipedia.org/wiki/DISK-BASIC "wikilink")のようだが、[標準入出力](../Page/入出力.md "wikilink")（Apple IIは当時のPCには珍しく、ROM-OSレベルで標準入出力の概念を備えている）を通じて呼び出される独立した機能拡張である。すなわち、BASICのコマンド拡張であるDISK-BASICと異なりBASICからも標準入出力を通じて呼び出さなければならず、他方、BASIC以外の言語からも容易に呼び出すことができる。このようにDOS3.xはDISK-BASIC全盛期においてBASICから独立した独特の実装となっているが、結局はなんらかのプログラム言語の付加機能として機能することを前提としている点で、現在の一般的なDOSの概念とは異なると考えてよいだろう。

### FLEX

[TSC](https://ja.wikipedia.org/wiki/TSC "wikilink")の6800/6809用の[FLEX](https://ja.wikipedia.org/wiki/フレックス "wikilink")

### OS-9

6809用から発展した、[マイクロウェア](https://ja.wikipedia.org/wiki/マイクロウェア "wikilink")の[OS-9](../Page/OS-9.md "wikilink")（OS-9は[リアルタイムオペレーティングシステム](../Page/リアルタイムオペレーティングシステム.md "wikilink")でもある）
...
[Category:DOS](https://ja.wikipedia.org/wiki/Category:DOS "wikilink") [Category:オペレーティングシステム](https://ja.wikipedia.org/wiki/Category:オペレーティングシステム "wikilink")