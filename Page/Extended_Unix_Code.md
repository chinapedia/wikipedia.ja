...
**Extended Unix Code**(EUC)は、[UNIX](../Page/UNIX.md "wikilink")上で使われてきた[文字コード](../Page/文字コード.md "wikilink")の[符号化方式である](https://ja.wikipedia.org/wiki/文字符号化方式 "wikilink")。
  ...
  - [日本語](../Page/日本語.md "wikilink")EUC
      - [JIS X 0208ベース](https://ja.wikipedia.org/wiki/JIS_X_0208 "wikilink") ([EUC-JP](../Page/EUC-JP.md "wikilink"))
      - [JIS X 0213ベース](https://ja.wikipedia.org/wiki/JIS_X_0213 "wikilink") ([EUC-JIS-2004](https://ja.wikipedia.org/wiki/EUC-JIS-2004 "wikilink"))
  - [韓国語EUC](https://ja.wikipedia.org/wiki/朝鮮語 "wikilink") ([EUC-KR](https://ja.wikipedia.org/wiki/EUC-KR "wikilink"))
  ...
  - [繁体字](https://ja.wikipedia.org/wiki/繁体字 "wikilink")中国語EUC ([EUC-TW](https://ja.wikipedia.org/wiki/EUC-TW "wikilink"))
...
[ISO/IEC 2022を基に](https://ja.wikipedia.org/wiki/ISO/IEC_2022 "wikilink")、以下のようなサブセット化を行った体系である。
  ...
  - G0に[ASCII](https://ja.wikipedia.org/wiki/ASCII "wikilink")（主コードセット）を、G1-G3に各言語の[文字集合](https://ja.wikipedia.org/wiki/文字集合 "wikilink")（補助コードセット1-3）を暗黙に指示する。指示のエスケープシーケンスは用いない。
...
UNIXの標準的な日本語コードとして広く使われてきた。UNIX SYSTEM V リリース 4 日本語環境共通規約において、JIS X 201 カタカナとJIS X 212 補助漢字は実装が必須ではないとされていた。このため、特にJIS X 0212は実装されていないことも多い。通信などで用いる場合はこの点に注意が必要である。
  ...
  - G0 - ASCII
  - G1 - [JIS X 0208](https://ja.wikipedia.org/wiki/JIS_X_0208 "wikilink")
  - G2 - [JIS X 0201カタカナ](https://ja.wikipedia.org/wiki/JIS_X_0201 "wikilink")
  - G3 - [JIS X 0212補助漢字](https://ja.wikipedia.org/wiki/JIS_X_0212 "wikilink")
...
JIS X 0213:2004ベースのものをEUC-JIS-2004という（2000年版はEUC-JISX0213）。JIS X 0213の附属書3に記載がある。フリー/オープンソースソフトウェアなどで使われていることがある。
  ...
  - G0 - ASCII
  - G1 - [JIS X 0213](https://ja.wikipedia.org/wiki/JIS_X_0213 "wikilink") 1面
  - G2 - [JIS X 0201カタカナ](https://ja.wikipedia.org/wiki/JIS_X_0201 "wikilink")
  - G3 - [JIS X 0213](https://ja.wikipedia.org/wiki/JIS_X_0213 "wikilink") 2面

## 韓国語EUC

[韓国で広く使われている](https://ja.wikipedia.org/wiki/大韓民国 "wikilink")。EUC-KRともいう。ここで、`KR`は韓国の国・地域コードであって、[朝鮮語](https://ja.wikipedia.org/wiki/朝鮮語 "wikilink")の言語コード (`ko`) ではない。単にKS C 5601といった場合でも、文字集合としてのKS C 5601でなく、EUC-KRのことを指している場合が多い。

  - G0 - ASCII
  - G1 - [KS X 1001](https://ja.wikipedia.org/wiki/KS_X_1001 "wikilink") (KS C 5601)
  - G2 - なし
  - G3 - なし
...
[中国](https://ja.wikipedia.org/wiki/中国 "wikilink")で広く使われている。EUC-CNともいう。ここで、`CN`は中国の国・地域コードであって、簡体字の用字系コード (`Hans`) でも[中国語](https://ja.wikipedia.org/wiki/中国語 "wikilink")の言語コード (`zh`) でもない。単にGB 2312といった場合でも、文字集合としてのGB 2312でなく、EUC-CNのことを指している場合が多い。
...
## 関連項目
  ...
  - [ISO-2022-JP](https://ja.wikipedia.org/wiki/ISO-2022-JP "wikilink")
  - [ISO 3166](https://ja.wikipedia.org/wiki/ISO_3166 "wikilink")
