...
## 単位・記号
  ...
  - [年代測定](https://ja.wikipedia.org/wiki/年代測定 "wikilink")で使われる、年代を表す指標。Before Presentが語源。⇒ [BP (年代測定)](https://ja.wikipedia.org/wiki/BP_\(年代測定\) "wikilink")
  - [ベーシスポイント](https://ja.wikipedia.org/wiki/ベーシスポイント "wikilink")（basis point）の略。1bp = 1‱ = 0.01%。
...
### 形式名
  ...
  - [レガシィツーリングワゴンの](../Page/スバル・レガシィ.md "wikilink")4代目（2003年5月～）の型番。
  - [マツダ・BPエンジン](https://ja.wikipedia.org/wiki/マツダ・B型エンジン#BP "wikilink")

## 他の記号等を付して用いられるもの

  - B-P - [ボーイスカウト](../Page/ボーイスカウト.md "wikilink")の創設者、[ベーデン・パウエルを指す](../Page/ロバート・ベーデン＝パウエル.md "wikilink")。
...
## 関連項目
  ...
  - [BPで始まる記事の一覧](https://ja.wikipedia.org/wiki/特別:Prefixindex/BP "wikilink")
  - [Bp,bpで始まる記事の一覧](https://ja.wikipedia.org/wiki/特別:Prefixindex/Bp "wikilink")