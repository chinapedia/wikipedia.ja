...
**宣言型プログラミング**（）は、対象の性質を宣言してプログラムを構成する[プログラミングパラダイム](https://ja.wikipedia.org/wiki/プログラミングパラダイム "wikilink")、あるいはそのような性質をもったプログラミングパラダイムの総称である。

総称としての宣言型プログラミングは[関数型プログラミング](../Page/関数型言語.md "wikilink")、[論理プログラミング](https://ja.wikipedia.org/wiki/論理プログラミング "wikilink")、[制約プログラミング](../Page/制約プログラミング.md "wikilink")を含む。これらのプログラミングパラダイムは対象を宣言する性質を共有した特徴として持つ。[命令型プログラミング](../Page/命令型プログラミング.md "wikilink")は[CPUや](https://ja.wikipedia.org/wiki/中央演算処理装置 "wikilink")[OSへの命令列と言えるが](../Page/オペレーティングシステム.md "wikilink")、例えば[LISP](https://ja.wikipedia.org/wiki/LISP "wikilink")もコンピュータへの命令列かもしれないが、その理論的基盤は間違いなく[ラムダ計算](../Page/ラムダ計算.md "wikilink")である。そこでこちらでは、その生い立ちや理論的基盤を考慮して分類することにする。
...
総称としての宣言型プログラミングは、[関数型プログラミング](../Page/関数型言語.md "wikilink")、[論理プログラミング](https://ja.wikipedia.org/wiki/論理プログラミング "wikilink")、[制約プログラミング](../Page/制約プログラミング.md "wikilink")の総称である。この立場での「宣言型プログラミング」とは、[数理論理学](../Page/数理論理学.md "wikilink")に基づいて設計されたプログラミング言語のことであり、命令型言語と対立する概念である。関数型言語なら[ラムダ計算](../Page/ラムダ計算.md "wikilink")や[コンビネータ論理](https://ja.wikipedia.org/wiki/コンビネータ論理 "wikilink")、[代数学](../Page/代数学.md "wikilink")などと対応し、論理プログラミングならその式は[ホーン節](https://ja.wikipedia.org/wiki/ホーン節 "wikilink")に対応する。
...
同様に命令型プログラミング言語であっても、プログラムを宣言型のスタイル・パラダイムで書くことは可能である。この場合、宣言的でない詳細をライブラリやフレームワークで[カプセル化](https://ja.wikipedia.org/wiki/カプセル化 "wikilink")するのが一般的である。例えば、単体テストのフレームワークである[JUnit](https://ja.wikipedia.org/wiki/JUnit "wikilink")で[リフレクションを使ったスタイルがある](https://ja.wikipedia.org/wiki/リフレクション_\(情報工学\) "wikilink")。
...
宣言型プログラミングをサポートする関数型/論理型/制約型のプログラミング言語:
  ...
  - 関数: [Erlang](https://ja.wikipedia.org/wiki/Erlang "wikilink")、[Haskell](../Page/Haskell.md "wikilink")、[LISP](https://ja.wikipedia.org/wiki/LISP "wikilink")
  ...
  - 制約: [Oz](https://ja.wikipedia.org/wiki/Oz_\(プログラミング言語\) "wikilink")、[Constraint Handling Rules](https://ja.wikipedia.org/wiki/Constraint_Handling_Rules "wikilink")
...
## 関連項目
  ...
  - [プログラミングパラダイム](https://ja.wikipedia.org/wiki/プログラミングパラダイム "wikilink")
      ...
      - [手続き型プログラミング](https://ja.wikipedia.org/wiki/手続き型プログラミング "wikilink")
  ...
  - [コンピュータ言語](https://ja.wikipedia.org/wiki/コンピュータ言語 "wikilink")
      - [プログラミング言語](../Page/プログラミング言語.md "wikilink")
          - [宣言型言語](https://ja.wikipedia.org/wiki/宣言型プログラミング "wikilink")
