...
MIB内のオブジェクトは、[Abstract Syntax Notation One](https://ja.wikipedia.org/wiki/Abstract_Syntax_Notation_One "wikilink")（ASN.1）のサブセットである "Structure of Management Information Version 2 (SMIv2)" RFC 2578 で定義されている。その[構文解析](../Page/構文解析.md "wikilink")を行うソフトウェアをMIBコンパイラと呼ぶ。
...
IETFの最初の5000の[RFCのうち](../Page/Request_for_Comments.md "wikilink")、318のRFCにMIB定義が含まれている。以下はそのごく一部である。
  ...
  - [ファイバーチャネル](https://ja.wikipedia.org/wiki/ファイバーチャネル "wikilink")
      - **FC-MGMT-MIB**: RFC 4044 [Fibre Channel](https://ja.wikipedia.org/wiki/ファイバーチャネル "wikilink") Management MIB
