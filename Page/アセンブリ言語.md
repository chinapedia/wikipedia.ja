...
[thumb](https://ja.wikipedia.org/wiki/ファイル:Motorola_6800_Assembly_Language.png "wikilink") [MC6800](../Page/MC6800.md "wikilink") のアセンブリ言語のソースコード\]\] **アセンブリ言語**（アセンブリげんご、英: assembly language）とは、[コンピュータ](../Page/コンピュータ.md "wikilink")、[マイクロコントローラ](../Page/マイクロコントローラ.md "wikilink")、その他のプログラム可能な機器を動作させるための[機械語](../Page/機械語.md "wikilink")を人間にわかりやすい形で記述する、代表的な[低水準言語](../Page/低水準言語.md "wikilink")である。なお、英語の *assembly* とは「組立」という意味である。
...
**アセンブラ**は、アセンブリ命令ニーモニックを[オペコード](../Page/オペコード.md "wikilink")に変換し、[シンボル名をメモリ位置や他の実体に変換することで](../Page/識別子.md "wikilink")[オブジェクトコード](https://ja.wikipedia.org/wiki/オブジェクトコード "wikilink")を生成する\[3\]。シンボル名による参照の利用はアセンブラの重要な機能であり、面倒な計算やプログラム修正に伴うアドレスの更新の手間を省くことができる。多くのアセンブラは[マクロ機能を備えており](../Page/マクロ_\(コンピュータ用語\).md "wikilink")、よく使用する命令列を[サブルーチン](../Page/サブルーチン.md "wikilink")呼び出しではなく[インライン展開](../Page/インライン展開.md "wikilink")することができる。
...
もともとワンパスアセンブラは高速であるためよく使われていた。マルチパス動作をするには、[磁気テープ](../Page/磁気テープ.md "wikilink")を巻き戻したり[パンチカード](../Page/パンチカード.md "wikilink")のデッキをセットし直して読み込む必要があったためである。現代のコンピュータではマルチパスであってもそのような遅延は生じない。マルチパスアセンブラは errata がないため、[リンク処理](../Page/リンケージエディタ.md "wikilink")（アセンブラが直接実行コードを生成する場合は[ローダ](../Page/ローダ.md "wikilink")の処理）が高速化される\[4\]。
...
より洗練されたは言語として次のような抽象化を提供する。
  ...
  - [クラス](../Page/クラス_\(コンピュータ\).md "wikilink")、[オブジェクト](../Page/オブジェクト_\(プログラミング\).md "wikilink")、[抽象化](../Page/抽象化_\(計算機科学\).md "wikilink")、[ポリモーフィズム](../Page/ポリモーフィズム.md "wikilink")、[継承](../Page/継承_\(プログラミング\).md "wikilink")\[5\]といった[オブジェクト指向](../Page/オブジェクト指向.md "wikilink")の特徴を備えたアセンブラ\[6\]

#### クロスアセンブラとメタアセンブラ

**クロスアセンブラ**は[クロスコンパイラ](../Page/クロスコンパイラ.md "wikilink")と似ており、あるプラットフォームで動作するが、そのプラットフォームではなく別のプラットフォーム向けのオブジェクトコードを生成するアセンブラを指す。小型の組み込みシステムなど、対象システムでアセンブラを動作させられない場合に使用することが多い。その場合、生成した[機械語](../Page/機械語.md "wikilink")コードを対象システムに転送する何らかの手段が必要である。単に機械語コードをバイト単位に転送することもできるが、[ASCII](https://ja.wikipedia.org/wiki/ASCII "wikilink")表現の転送用フォーマットがメーカーから提供されている（モトローラの[SREC](../Page/S-record.md "wikilink")、インテルの[HEXなど](https://ja.wikipedia.org/wiki/Intel_HEX "wikilink")）。
...
例えば、次の命令は[x86](https://ja.wikipedia.org/wiki/x86 "wikilink")/[IA-32](../Page/IA-32.md "wikilink")プロセッサのもので、[8ビット即値を](../Page/定数_\(プログラミング\).md "wikilink")[レジスタに入れる命令である](../Page/レジスタ_\(コンピュータ\).md "wikilink")。この命令のバイナリコードは 10110 で、その後に3ビットのレジスタを指定する識別子が続く。*AL* レジスタの識別子は 000 なので、次に示す[機械語](../Page/機械語.md "wikilink")は *AL* レジスタに 01100001 というデータをロードする\[9\]。
...
Don French が開発した [VIC-20](../Page/VIC-1001.md "wikilink") 用アセンブラは 1,639 バイトという小ささで、世界一小さいアセンブラと言われている。アドレスをシンボルで表現でき、各種アドレス計算（四則演算、AND、OR、冪乗など）が可能だった\[23\]。

商用製品でアセンブリ言語を使う最大の理由は、使用メモリ量を最小にし、オーバーヘッドを最小にし、性能と信頼性を向上させるためである。1980年代のビジネスソフトでは、例えば[表計算ソフト](../Page/表計算ソフト.md "wikilink") [Lotus 1-2-3](../Page/Lotus_1-2-3.md "wikilink") などはアセンブリ言語で書かれていた。日本では[松などが該当](../Page/松_\(ワープロ\).md "wikilink")\[24\]する。

1990年代に入っても、[コンシューマーゲーム](../Page/コンシューマーゲーム.md "wikilink")の多くはアセンブリ言語で書かれていた。ある業界関係者は、[セガサターン](../Page/セガサターン.md "wikilink")の最高性能を引き出して[プレイステーションに対抗するには](../Page/PlayStation_\(ゲーム機\).md "wikilink")、アセンブリ言語を使うしかなかったとしている\[25\]。ただし一方で、ファミコン時代すでに[メタルスレイダーグローリー](../Page/メタルスレイダーグローリー.md "wikilink")やスーパーファミコンの[MOTHER 2](../Page/MOTHERシリーズ.md "wikilink")・[シムシティ](https://ja.wikipedia.org/wiki/シムシティ#スーパーファミコン版 "wikilink")\[26\]、プレステの[クラッシュ・バンディクーで](https://ja.wikipedia.org/wiki/クラッシュ・バンディクー_\(ゲーム\) "wikilink")\[27\]、開発の一部に[LISP](https://ja.wikipedia.org/wiki/LISP "wikilink")が使われていたという話もあり、アセンブリ言語が全てという世界だった、と認識するのは誤りである。

### 現代における使用

アセンブリ言語と高水準言語を比較した有用性と性能についての議論は、これまでよく行われてきた。アセンブリ言語は、後述するように特定の用途で重要な役割を演じている。しかし、一般的には、[最適化コンパイラは人手で書かれたアセンブリ言語のコードと同等の性能を発揮すると言われている](../Page/コンパイラ最適化.md "wikilink")\[28\]（例外もある\[29\]\[30\]\[31\]）。最近のプロセッサやメモリサブシステムは複雑化してきたため、コンパイラでもアセンブリ言語でも効果的な最適化がますます困難になってきている\[32\]\[33\]。さらに言えば、プロセッサが高性能化するにしたがって[入出力](../Page/入出力.md "wikilink")や[ページングによる遅延が無視できないレベルとなったため](../Page/ページング方式.md "wikilink")、コーディングによる性能追求は多くのプログラマにとって大きな問題ではなくなってきている。
...
開発者がアセンブリ言語を選択する状況として、次のようなものがある。
  ...
  - 極端な最適化を必要とするプログラム（例えば、プロセッサ集約型アルゴリズム内の内側の[ループなど](../Page/ループ_\(プログラミング\).md "wikilink")）。例えば、[コンピュータゲーム](../Page/コンピュータゲーム.md "wikilink")開発においては、システムのハードウェア機能を最大限に発揮するようアセンブリ言語を使うことがある。また大規模な科学シミュレーションでも高度に最適化されたアルゴリズムを必要とする。例えば、[線型代数学](../Page/線型代数学.md "wikilink")の[BLAS](https://ja.wikipedia.org/wiki/Basic_Linear_Algebra_Subprograms "wikilink")\[34\]\[35\]や[離散コサイン変換](../Page/離散コサイン変換.md "wikilink")（例えば[x264](https://ja.wikipedia.org/wiki/x264 "wikilink")のSIMDアセンブリ版\[36\]）がアセンブリ言語で書かれている。
...
同じ系統のプロセッサであっても、複数のアセンブリ言語の方言が存在する。アセンブラによっては他の方言のアセンブリ言語も使用可能な場合がある。例えば、[TASMは](https://ja.wikipedia.org/wiki/Turbo_Assembler "wikilink")[MASM用コードを入力として受け付け可能だが](https://ja.wikipedia.org/wiki/Microsoft_Macro_Assembler "wikilink")、逆は不可能である。と[NASMは文法がほぼ同じだが](../Page/Netwide_Assembler.md "wikilink")、サポートしているマクロが異なるため、相互の翻訳は困難である。いずれも基本機能は同じだが、追加機能に差異がある\[39\]。
