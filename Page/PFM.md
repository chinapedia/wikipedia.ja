> この記事は[PFM](https://ja.wikipedia.org/wiki/PFM)から翻訳されています。


  - [プリズン・フェローシップ・ミニストリーズ](https://ja.wikipedia.org/wiki/プリズン・フェローシップ・ミニストリーズ "wikilink") - Prison Fellowship Ministries
  - [パルス周波数変調](https://ja.wikipedia.org/wiki/パルス周波数変調 "wikilink") - Pulse Frequency Modulation
  ...
  - [ポンテフラクト・モンクヒル駅](https://ja.wikipedia.org/wiki/ポンテフラクト・モンクヒル駅 "wikilink") - Pontefract Monkhill railway station, イングランドの駅コード PFM
  - [ポータブル・フロート・マップ](https://ja.wikipedia.org/wiki/ポータブル・フロート・マップ "wikilink") - Portable Float Map format
  - [パブリック・ファイナンシャル・マネジメント](https://ja.wikipedia.org/wiki/パブリック・ファイナンシャル・マネジメント "wikilink") - Public Financial Management, フィラデルフィアを拠点とする金融アドバイザー
  - [パシフィック・ファスト・メール](https://ja.wikipedia.org/wiki/パシフィック・ファスト・メール "wikilink") - Pacific Fast Mail,真鍮製[鉄道模型](../Page/鉄道模型.md "wikilink")の輸入業者
  - [PFM (医療)](https://ja.wikipedia.org/wiki/PFM_\(医療\) "wikilink") - Patient Flow Management,入退院センター