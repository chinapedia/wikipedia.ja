...
VRML1.0の制定以降、3次元空間を容易に記述できるという点から注目され、[Webブラウザからそのまま使えるさまざまな](../Page/ウェブブラウザ.md "wikilink")[プラグイン](https://ja.wikipedia.org/wiki/プラグイン "wikilink")も提供され、普及も進んだ。 しかし、VRMLの表現能力の限界やモデリングツールの少なさ、操作の難しさなどから、しだいにあまり使われなくなっている。

VRMLの表現能力の限界などから、次世代の仕様として[XMLベースの](../Page/Extensible_Markup_Language.md "wikilink")[X3D](https://ja.wikipedia.org/wiki/X3D "wikilink")を一から作成することとなった。
...
## 関連規格
  ...
  - [X3D](https://ja.wikipedia.org/wiki/X3D "wikilink") （VRML 後継者）
