...
ミトコンドリア膜（またはバクテリア膜）における[電子伝達系](../Page/電子伝達系.md "wikilink")の最後の[酵素](../Page/酵素.md "wikilink")であり、4分子の[シトクロムc](https://ja.wikipedia.org/wiki/シトクロムc "wikilink")からそれぞれ[電子](https://ja.wikipedia.org/wiki/電子 "wikilink")を受け取り、[酸素](../Page/酸素.md "wikilink")1分子に転移させ2分子の[水](../Page/水.md "wikilink")に変換する機能を持つ。この過程では、[マトリックス由来の](https://ja.wikipedia.org/wiki/ミトコンドリアマトリックス "wikilink")4個のプロトンから水が生成されるのと同時に4個のプロトンがマトリックスから[膜間スペースに透過する](https://ja.wikipedia.org/wiki/ミトコンドリア膜間腔 "wikilink")。これにより発生した膜間の[電気化学ポテンシャル](../Page/電気化学ポテンシャル.md "wikilink")の差が[ATP合成酵素](../Page/ATP合成酵素.md "wikilink")によるATP合成に用いられる。
...
反応の概要：
  ...
  -
    <chem>4 </chem>フェロシトクロム<chem> c\\ + 8H^+{}_{in}\\ + O2 -\> 4 </chem>フェリシトクロム<chem> c\\ + 2H2O\\ + 4H^+{}_{out}</chem>

ここで、

  -
    フェロシトクロム<chem> c</chem> = <chem>Fe^{2+}{-}</chem>シトクロム<chem> c</chem>
    フェリシトクロム<chem> c</chem> = <chem>Fe^{3+}{-}</chem>シトクロム<chem> c</chem>
...
[シアニド](https://ja.wikipedia.org/wiki/シアニド "wikilink")、[スルフィド](../Page/スルフィド.md "wikilink")、[アジド](https://ja.wikipedia.org/wiki/アジド "wikilink")および[一酸化炭素](../Page/一酸化炭素.md "wikilink")\[3\]の全てがシトクロム*c*オキシダーゼに結合し、[拮抗的阻害](https://ja.wikipedia.org/wiki/拮抗的阻害 "wikilink")を及ぼし細胞を化学的な[窒息](../Page/窒息.md "wikilink")状態にさせる。また、[メタノール](../Page/メタノール.md "wikilink")（メチル化剤）は[ホルムアルデヒド](../Page/ホルムアルデヒド.md "wikilink")に変換され、こちらも同じように系を阻害する。

## 資料画像

`画像:Cmplx4.PNG|シトクロム`*`c`*`オキシダーゼの構造`
`Image:Komplex IV.png|シトクロム`*`c`*`オキシダーゼの反応機構の模式図`
`画像:Cyt aa3 - part 1 asw.svg|シトクロム`*`c`*`オキシダーゼの酸化還元サイクル`
`ファイル:Mitochondrial electron transport chain—Etc4.svg|電子伝達系`
...
## 関連項目
  ...
  - [呼吸鎖複合体](https://ja.wikipedia.org/wiki/呼吸鎖複合体 "wikilink")
...
## 外部リンク
  ...
  -
  -
[Category:EC_1.9.3](https://ja.wikipedia.org/wiki/Category:EC_1.9.3 "wikilink") [Category:ヘムタンパク質](https://ja.wikipedia.org/wiki/Category:ヘムタンパク質 "wikilink") [Category:細胞呼吸](https://ja.wikipedia.org/wiki/Category:細胞呼吸 "wikilink") [Category:タンパク質複合体](https://ja.wikipedia.org/wiki/Category:タンパク質複合体 "wikilink")
