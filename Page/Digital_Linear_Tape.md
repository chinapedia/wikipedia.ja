...
クァンタムは[2001年](../Page/2001年.md "wikilink")に**Super DLT** (**SDLT**) 規格の、2006年には**DLT-S4**の製品を発売し、DLTtape S4メディアで最大800GB（60MB/秒）までの記録が可能となっている\[1\]。このDLT-S4を最後に新規製品は発表されておらず、クァンタムが扱う磁気テープ製品も[LTOに移行している](https://ja.wikipedia.org/wiki/Linear_Tape-Open "wikilink")。

カートリッジ内部のリールはひとつであり装置側からテープを引き出し、装置側のリールに巻き取りながら読み書きを行う。記録ヘッドは上下に移動しながら複数のトラックに記録する。

## 関連事項

  - [Linear Tape-Open](https://ja.wikipedia.org/wiki/Linear_Tape-Open "wikilink") (LTO, Ultrium)

## 脚注

## 外部リンク

  - [History of DLTtape Technology](http://learning.quantum.com/demo/history.htm) - Quatum: 1984年から2001年までの歴史
