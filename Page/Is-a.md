...
## 関連項目
  ...
  - [has-a](https://ja.wikipedia.org/wiki/has-a "wikilink")

  -
  - [集約](https://ja.wikipedia.org/wiki/集約 "wikilink")、[コンポジション](https://ja.wikipedia.org/wiki/クラス図#コンポジション "wikilink")
  ...
  - [リスコフの置換原則](../Page/リスコフの置換原則.md "wikilink") ([オブジェクト指向プログラミング](../Page/オブジェクト指向プログラミング.md "wikilink"))

  - [ソフトウェア工学](../Page/ソフトウェア工学.md "wikilink")

## 参考文献

  - [Ronald J. Brachman](https://ja.wikipedia.org/wiki/Ronald_J._Brachman "wikilink"); What IS-A is and isn't. An Analysis of Taxonomic Links in Semantic Networks; IEEE Computer, 16 (10); October 1983 [1](http://dblp.uni-trier.de/rec/bibtex/journals/computer/Brachman83)
  - Jean-Luc Hainaut, Jean-Marc Hick, Vincent Englebert, Jean Henrard, Didier Roland: Understanding Implementations of IS-A Relations. ER 1996: 42-57 [2](http://www.informatik.uni-trier.de/~ley/db/conf/er/HainautHEHR96.html)

[Category:オブジェクト指向](https://ja.wikipedia.org/wiki/Category:オブジェクト指向 "wikilink") [Category:知識表現](https://ja.wikipedia.org/wiki/Category:知識表現 "wikilink") [Category:抽象](https://ja.wikipedia.org/wiki/Category:抽象 "wikilink")