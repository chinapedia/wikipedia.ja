...
[テキストエディタ](../Page/テキストエディタ.md "wikilink")は、過去のバージョンに標準添付されていた[ラインエディタ](https://ja.wikipedia.org/wiki/ラインエディタ "wikilink")「[`EDLIN`](https://ja.wikipedia.org/wiki/EDLIN "wikilink")」に加えスクリーンエディタ「」が添付された\[90\]。開発環境として、コマンドラインエディタに加え独自に拡張された構造化BASICコンパイラ[QuickBASIC](../Page/QuickBASIC.md "wikilink")が標準添付されていた。
