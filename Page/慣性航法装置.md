...
本装置の原理は、[加速度計](https://ja.wikipedia.org/wiki/加速度計 "wikilink")で検出する[加速度](../Page/加速度.md "wikilink")を積分することで[速度](../Page/速度.md "wikilink")を、速度を積分することで[距離](../Page/距離.md "wikilink")を求める一方、[ジャイロで](https://ja.wikipedia.org/wiki/ジャイロスコープ "wikilink")[方角を検知し](../Page/方位.md "wikilink")、移動距離と方角の[ベクトルを細分点ごとに合成してゆくことにより](../Page/空間ベクトル.md "wikilink")、起点からの移動距離を算出する。起点の静止位置を入力すれば、移動し始めても自機の位置と速度を常に計算して把握できる。

悪天候や[電波妨害の影響を受けないという長所を持つが](https://ja.wikipedia.org/wiki/ジャミング "wikilink")、長い距離を移動すると誤差が累積されて大きくなるという特徴があるので、[GPSや](../Page/グローバル・ポジショニング・システム.md "wikilink")[距離測定装置](https://ja.wikipedia.org/wiki/距離測定装置 "wikilink")、[超短波全方向式無線標識](https://ja.wikipedia.org/wiki/超短波全方向式無線標識 "wikilink")などによる補正を加えて使用することが多い。[ドップラー・レーダー](https://ja.wikipedia.org/wiki/ドップラー・レーダー "wikilink")航法装置、[無指向性無線標識](https://ja.wikipedia.org/wiki/無指向性無線標識 "wikilink")、[天測航法](https://ja.wikipedia.org/wiki/天測航法 "wikilink")などを補助的に使用することもある。
...
## 外部リンク
  ...
  - [慣性航法装置](http://www.jal.com/ja/jiten/dict/g_page/g298.html) - [日本航空](https://ja.wikipedia.org/wiki/日本航空 "wikilink")
