...
オリンパスのマイクロフォーサーズシステムのミラーレス一眼カメラのうち、OM-Dシリーズに属する機種で、同シリーズのフラッグシップモデルであった[OM-D E-M1 Mark IIの後継機種である](https://ja.wikipedia.org/wiki/オリンパス・OM-D_E-M1_Mark_II "wikilink")。E-M1から画素数、AF・連写性能など多くの進化を遂げた2台目に続く、ミラーレスカメラでは最高峰に位置するカメラとなっている。
...
9.  ユーザーインターフェースを更新、背面にマルチセレクターを装備
