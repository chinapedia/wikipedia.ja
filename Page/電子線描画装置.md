...
**電子線描画装置**（でんしせんびょうがそうち、**電子ビーム描画装置**、**電子ビーム露光装置**、**EB** (*electron beam*) **露光装置**、*Electron Beam Lithography Exposure*）は、電子線加工装置と走査型[電子顕微鏡](https://ja.wikipedia.org/wiki/電子顕微鏡 "wikilink")を応用したもので、主に半導体用[レチクル](https://ja.wikipedia.org/wiki/レチクル "wikilink")作成に用いられる。[電子銃](https://ja.wikipedia.org/wiki/電子銃 "wikilink")から発せられた[電子線](https://ja.wikipedia.org/wiki/電子線 "wikilink")を電子レンズやアパーチャー、デフレクタなどを通し、X-Y-Zステージを微細に制御しながら[マスクブランクスへ照射して目的のパターンを露光する](https://ja.wikipedia.org/wiki/フォトマスク "wikilink")。また、マーク付き[ウェハー](https://ja.wikipedia.org/wiki/ウェハー "wikilink")への直接描画（ダイレクト描画）機能を持つものもある。
...
[thumb](https://ja.wikipedia.org/wiki/ファイル:Masqueur_electronique.GIF "wikilink") [thumb](https://ja.wikipedia.org/wiki/ファイル:Write_on_the_fly_FEPG.JPG "wikilink") 電子線描画装置は[走査型電子顕微鏡](../Page/走査型電子顕微鏡.md "wikilink")（SEM）とほぼ同じ機構を持っており、相違点は微細な移動が行える精密X-Yステージ、高真空制御機構、微細測長機能、温度制御機構、ブランキング機構、ビーム径測定機構、高さ検出器などである。一部のメーカーでは電子顕微鏡を改造してこれらを追加し、電子線描画装置にするサービスがある。
  ...
  - [電子レンズ](https://ja.wikipedia.org/wiki/電子レンズ "wikilink")
    静電偏向、電磁偏向により電子線を縮小または焦点合わせをする。
  - 偏向器（デフレクタ）
    電子線を一定の範囲で任意の位置に照射するために静電偏向器または電磁偏向器を用いる。X-Y-Zステージでは制御が難しい数十um～nm単位のビーム位置補正などを行う。
  - 収差補正
    対物アパーチャーや静電式収差補正電極などにより、各種の[収差](https://ja.wikipedia.org/wiki/収差 "wikilink")を補正する。
  - X-Y-Zステージ
  ...
  - 高真空制御機構
    電子線が通る部分は高真空を安定的に保持しなければならないため、[ロータリーポンプ](../Page/ロータリーポンプ.md "wikilink")、[ターボ分子ポンプ](../Page/ターボ分子ポンプ.md "wikilink")、[イオンポンプ](https://ja.wikipedia.org/wiki/イオンポンプ "wikilink")などを併用して最大で10^-8Pa程度の真空状態を保っている。また、[ペニング真空計](https://ja.wikipedia.org/wiki/ペニング真空計 "wikilink")、[電離真空計](https://ja.wikipedia.org/wiki/電離真空計 "wikilink")などの真空計により常に真空度の確認を行っている。電子銃がT-FEGの場合、電子銃周辺は10^-7Pa程度の真空度が必要である。
  - 温度制御機構
    水冷などにより、動作中に熱の発生する電子レンズやステージ、ガラスマスクやウエハー、増幅器の定温温度制御を行う。

## 主な電子線描画装置メーカー

  - [ニューフレアテクノロジー](https://ja.wikipedia.org/wiki/ニューフレアテクノロジー "wikilink") (NFT)（旧 東芝機械と東芝の合弁企業の独立）
  ...
  - [エリオニクス](https://ja.wikipedia.org/wiki/エリオニクス "wikilink")
...
## 参考文献
  ...
  - [日本電子顕微鏡学会](https://ja.wikipedia.org/wiki/日本電子顕微鏡学会 "wikilink")関東支部 編 『走査電子顕微鏡』 [共立出版](https://ja.wikipedia.org/wiki/共立出版 "wikilink") 2005年10月 ISBN 4-320-07148-4
  ...
  - [横山浩](https://ja.wikipedia.org/wiki/横山浩 "wikilink")・監修 [秋永広幸](https://ja.wikipedia.org/wiki/秋永広幸 "wikilink")・編　『電子線リソグラフィ教本』 [オーム社](https://ja.wikipedia.org/wiki/オーム社 "wikilink") 2007年6月 ISBN 978-4-274-20415-9
  - [裏克己](https://ja.wikipedia.org/wiki/裏克己 "wikilink")・著 『ナノ電子光学』 [共立出版](https://ja.wikipedia.org/wiki/共立出版 "wikilink") 2005年6月 ISBN 4-320-08620-1
