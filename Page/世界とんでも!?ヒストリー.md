...
また、解答者チームは当初はフリップで解答を出していたが、書き直しが多かったためか、中盤から所曰く「書き直しができないようにする」という厳しいルールを設け、それによって解答をライトペンを使って書き、前面のテレビモニターに出す形式に変更された。それによって通常はブルーバックで解答を表示し、正解の時にはレッドバックに切り替えることになった。このライトペンを使って解答を書いてテレビモニターに出す形式は、後期にも継承された。
  ...
  - 逆転タッチヒストリー
    セット中央にある大きな8面スクリーンに、事柄が8項目表示される。その中から指定されたテーマに当てはまる4項目を、解答者全員で協力して制限時間（当初は60秒で固定。後に、60秒に加えてこれまで獲得したゴールド100Gにつき1秒加算、計算上最高では105秒（4500G））以内に全て選ぶクイズ。[フジテレビ系列局で放送されていた](../Page/フジネットワーク.md "wikilink")『[運命GAME](https://ja.wikipedia.org/wiki/運命GAME "wikilink")』の「タッチBINGO」のシステムを。
...
## ハプニング例
  ...
  - （この回は[山田雅人](https://ja.wikipedia.org/wiki/山田雅人 "wikilink")がゲスト、[上岡龍太郎](../Page/上岡龍太郎.md "wikilink")が代行）でフリップでの書き問題時、獲得点に応じて点数を与える（0G=400G、200G=600G、400G=800G）特別ルールを所が提示。全員が同じ答えで正解し、提案した所は解答者チームに大差をつけられて不利になった。
...
## エンディングテーマ
  ...
  - summer-est （[東野純直](https://ja.wikipedia.org/wiki/東野純直 "wikilink")）
...
## スタッフ
  ...
  - タイムキーパー：伊藤裕子
  - リサーチ：T2ファージ
  - ディレクター：井村秀樹、宗片浩寿、[井上晃一](https://ja.wikipedia.org/wiki/井上晃一 "wikilink")、岩城信行、立川英弘、渡邊松太郎
  - 演出：上西浩之、洪龍吉、善本真也
  - プロデューサー：太田正彦・山本清（テレビ朝日）、倉岡修（ビデオ・パック・ニッポン）、奥村正・山本三四郎・善本真也（イースト）
  - 協力：[東通](https://ja.wikipedia.org/wiki/東通 "wikilink")、[アックス](../Page/アックス_\(会社\).md "wikilink")、インターナショナル・クリエイティブ、[砧スタジオ](https://ja.wikipedia.org/wiki/東京メディアシティ "wikilink")、東京サウンド企画
...
## 関連項目
  ...
  - [クイズMONOものがたり](https://ja.wikipedia.org/wiki/クイズMONOものがたり "wikilink") - 本番組以前に同時間帯で放送されていたテレビ朝日・イースト共同製作のクイズ番組。
  - [大改造\!\!劇的ビフォーアフター](../Page/大改造!!劇的ビフォーアフター.md "wikilink") - 本番組終了から7年半後に同時間帯でスタートした所ジョージ司会番組。こちらは朝日放送製作。
  - [デイ・トリッパー](https://ja.wikipedia.org/wiki/デイ・トリッパー "wikilink")（[ビートルズ](../Page/ビートルズ.md "wikilink")） - イントロが解答時のBGMに使われていた。
