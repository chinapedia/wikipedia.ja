...
## 主なAntタスク
  ...
  - javac : Java[ソースコード](../Page/ソースコード.md "wikilink")を[コンパイル](https://ja.wikipedia.org/wiki/コンパイル "wikilink")する。
    ...
    java : Javaプログラムを実行する。
    junit : テストフレームワーク[JUnit](https://ja.wikipedia.org/wiki/JUnit "wikilink")を使ってJavaプログラムを[テストする](../Page/ソフトウェアテスト.md "wikilink")。
    ...
    mkdir : ディレクトリを作成する。
    ftp : [FTP接続を開始して](../Page/File_Transfer_Protocol.md "wikilink")、ファイルの[アップロード](https://ja.wikipedia.org/wiki/アップロード "wikilink")、[ダウンロード](https://ja.wikipedia.org/wiki/ダウンロード "wikilink")などを可能にする。
    ...
    setproxy : [ネットワークに接続するタスクを実行する際に](https://ja.wikipedia.org/wiki/コンピュータネットワーク "wikilink")、[プロキシ](../Page/プロキシ.md "wikilink")サーバのアドレスを設定する。
    ...
    echo : [コンソール](https://ja.wikipedia.org/wiki/コンソール "wikilink")（コマンドライン環境）に文字列を出力する。
