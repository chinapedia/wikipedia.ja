...
[AWT](../Page/Abstract_Window_Toolkit.md "wikilink")（[Java](https://ja.wikipedia.org/wiki/Java "wikilink") 1.2以降で追加された, の派生クラス）、[Skia](https://ja.wikipedia.org/wiki/Skia "wikilink")の`SkPath`および[Android](../Page/Android.md "wikilink")の`android.graphics.Path`は2次と3次のベジェ両方を直接サポートする\[7\]\[8\]\[9\]。
