...
**Quartz**（クオーツ）は、[アップルの](https://ja.wikipedia.org/wiki/アップル_\(企業\) "wikilink")[オペレーティングシステム](../Page/オペレーティングシステム.md "wikilink")  の描画コアエンジン。前身であるの[DPSに代わり](https://ja.wikipedia.org/wiki/Display_PostScript "wikilink")、[PDFベースの描画モデルを採用したもの](https://ja.wikipedia.org/wiki/Portable_Document_Format "wikilink")。三次[ベジェ曲線](https://ja.wikipedia.org/wiki/ベジェ曲線 "wikilink")を描画プリミティブとするベクトル型システムで、との互換性はない。なお、QuickDrawは[Carbon](https://ja.wikipedia.org/wiki/Carbon "wikilink")アプリケーションの互換性のためにも残されている。
...
の機能は、からはを通して、またC/C++言語からはを通して利用できる。またアップルはの[スクリプト言語](../Page/スクリプト言語.md "wikilink")[バインディングのひとつとして](https://ja.wikipedia.org/wiki/言語バインディング "wikilink")のバインディングを公式に用意している。
  ...
  - [解像度](https://ja.wikipedia.org/wiki/解像度 "wikilink")非依存の[ベクトルベース](https://ja.wikipedia.org/wiki/ベクトル画像 "wikilink")・システム
  - [浮動小数点](https://ja.wikipedia.org/wiki/浮動小数点 "wikilink")による[数学](../Page/数学.md "wikilink")[座標](https://ja.wikipedia.org/wiki/座標 "wikilink")系
  - 常時[アンチエイリアシング](https://ja.wikipedia.org/wiki/アンチエイリアス "wikilink")
  - [アルファチャンネル](https://ja.wikipedia.org/wiki/アルファチャンネル "wikilink")のサポート
...
## 関連項目
  ...
  - [ベジェ曲線](https://ja.wikipedia.org/wiki/ベジェ曲線 "wikilink")
