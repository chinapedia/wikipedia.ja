...
2.  **隆福丸**
    ...
    <!-- end list -->
      -
        「りゅうふくまる」と読む。ボーカルの祖父の船の名前。
3.  **トゥータン**
      - 作詞：Hideyuki Shinzato、作曲：Hideyuki Shinzato/Izu
    <!-- end list -->
      -
        沖縄の[方言](../Page/方言.md "wikilink")でトタンの意味。
4.  **男前**
      - 作詞・作曲：Hideyuki Shinzato
5.  **コントロール**
      - 作詞：TUN、作曲：Yuhei
...
10. **☁**
    ...
    <!-- end list -->
      -
        正式なタイトル表記は[雲](../Page/雲.md "wikilink")を模った本作オリジナルの手書き記号。
11. **さあ行こう**
      - 作詞・作曲：TUN
12. **Street Story**
...
5.  **DREAMING**
      -
        監督：須永秀明
6.  **Street Story**
7.  **everyone'sASSE\!\! PHOTOS** (GIFT TRACK)
