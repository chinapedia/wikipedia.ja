...
**プログラム意味論**（）とは、[計算機科学](../Page/計算機科学.md "wikilink")（特に[理論計算機科学](../Page/理論計算機科学.md "wikilink")と分類されることもある）の一分野で、プログラミング言語の[意味と](../Page/意味論.md "wikilink")[計算モデルに関する分野である](https://ja.wikipedia.org/wiki/計算模型 "wikilink")。[形式的なものは](https://ja.wikipedia.org/wiki/形式手法 "wikilink")、**プログラミング言語の形式意味論**とも呼ばれる。標準規格等では形式的でなく意味論を与えているものも多い。
...
形式化にはいくつかの手法があり、以下の 3 種類に大別される:
  ...
  - **[操作的意味論](https://ja.wikipedia.org/wiki/操作的意味論 "wikilink")**: 何らかの変換を施すのではなく、その言語の実行によって直接的に意味を説明する。操作的意味論は[インタプリタ](../Page/インタプリタ.md "wikilink")と対応すると考えることもできるが、表示的意味論の場合と同様に、この場合の「インタプリタの実装」は何らかのコンピュータ上での実装ではなく、数学的な形式化された「インタプリタ」であることが多い。操作的意味論を[抽象機械](https://ja.wikipedia.org/wiki/抽象機械 "wikilink")（例えば[SECDマシン](https://ja.wikipedia.org/wiki/SECDマシン "wikilink")）で定義することも可能で、プログラムの語句の並びが抽象マシンの上で引き起こす状態変化を説明することによって各語句の意味を説明する。あるいは、純粋な[ラムダ計算](../Page/ラムダ計算.md "wikilink")のように、操作的意味論を対象言語の語句の並びの統語的変形過程と定義するようなものもある。
  - **[公理的意味論](https://ja.wikipedia.org/wiki/公理的意味論 "wikilink")**: 語句の並びに「[論理学](../Page/論理学.md "wikilink")的[公理](../Page/公理.md "wikilink")」を適用することによって意味を明らかにする。公理的意味論では語句の意味とそれを表す論理式を区別しない。この場合、プログラムの意味は論理学で証明可能なものと等価である。公理的意味論の典型的な例として[ホーア論理](https://ja.wikipedia.org/wiki/ホーア論理 "wikilink")がある。
...
場合によっては、異なる意味論間の関係を説明する必要が生じる。例えば:
  ...
  - ある言語について、高レベルの抽象機械と低レベルの抽象機械を定義したとする。ここで、後者は前者よりも基本的な操作を含む。両者における操作的意味が[双模倣性](https://ja.wikipedia.org/wiki/双模倣性 "wikilink")によって関連していることを証明する必要が生じるかもしれない。そのような証明は、低レベルの抽象機械が高レベルの抽象機械を「忠実に実装」することを保証する。
...
[コンピュータ科学](https://ja.wikipedia.org/wiki/コンピュータ科学 "wikilink")の中で密接に関連する分野として、[プログラミング言語](../Page/プログラミング言語.md "wikilink")、[型理論](../Page/型理論.md "wikilink")、[コンパイラ](../Page/コンパイラ.md "wikilink")や[インタプリタ](../Page/インタプリタ.md "wikilink")等のプログラミング言語処理系、[形式的検証](../Page/形式的検証.md "wikilink")、[モデル検査](https://ja.wikipedia.org/wiki/モデル検査 "wikilink")などがある。
