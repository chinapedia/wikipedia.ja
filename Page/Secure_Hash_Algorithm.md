...
SHA-3としてKeccakが、[アメリカ国立標準技術研究所](../Page/アメリカ国立標準技術研究所.md "wikilink") (NIST) による公募において、2012年10月2日に選出された\[3\]。2015年8月に、正式版が発行された。これまでのSHAの Merkle–Damgård construction（[:en:Merkle–Damgård construction](https://ja.wikipedia.org/wiki/:en:Merkle–Damgård_construction "wikilink")）とは異なり、ハッシュ値よりも大きな内部状態を持ち、ハッシュ値はその内部状態から「絞り出される」という、「スポンジ構造」を採用している。
