...
## 得意技
  ...
  - ジェノサイド
    デスペナルティー
    [リバースDDTと同型](https://ja.wikipedia.org/wiki/DDT_\(プロレス技\)#リバースDDT "wikilink")。
  - デスペナルティーII
    [垂直落下式リバースDDTと同型](https://ja.wikipedia.org/wiki/DDT_\(プロレス技\)#リバースDDT "wikilink")。

## 入場曲

  - horse will be dust 〜M-version〜（D.B.M.N ドーベルマン） ※[キングレコード](../Page/キングレコード.md "wikilink")「KAIENTAI DOJO」に収録
