...
[確率論](../Page/確率論.md "wikilink")における**独立**（どくりつ、）とは、2つの[事象が何れも起こる](https://ja.wikipedia.org/wiki/事象_\(確率論\) "wikilink")[確率](https://ja.wikipedia.org/wiki/確率 "wikilink")がそれぞれの確率の積に等しくなっていることを言う。この場合は、一方の事象が起こったことが分かっても、他方の事象の確率が変化しないことを意味する。

この「独立」の概念は、2個以上の事象、2個以上の[確率変数](../Page/確率変数.md "wikilink")、2個以上の[試行に対して定義される](https://ja.wikipedia.org/wiki/試行_\(確率論\) "wikilink")。

2つの[確率変数](../Page/確率変数.md "wikilink")が**独立**であるとは、「ある確率変数の値が一定範囲に入る事象」と「別の確率変数の値が別の一定範囲に入る事象」が、考えられるどのような「一定範囲」（「考えられる」とは通常[ボレル集合](https://ja.wikipedia.org/wiki/ボレル集合 "wikilink")族を指す）を定めても事象として独立であることを言う。2つの確率変数が独立である場合は、一方の変数が値をとっても、他方の変数の[確率分布](../Page/確率分布.md "wikilink")が変化しないことを意味する。
