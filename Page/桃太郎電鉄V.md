...
## 前作からの変更点
  ...
  - 本作より、ゲーム中に使われている文字が基本的に等角[フォント](../Page/フォント.md "wikilink")になったため、読みやすくなった。
  - 『7』『jr.』でカードの種類が減っていた傾向がなくなり、本作からはカードの種類が増加傾向にある。
  - 本作より、大半の攻撃系カードを使った際に、ターゲットを指定可能になった。また、刀狩りカードでどのカードを奪うかを指定できるようになるなど、細部のランダム性を排除したものもある。ただしこれまでの作品とは異なり、ランダムにターゲットを指定することはできなくなった。
