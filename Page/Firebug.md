...
Firebugは2006年1月にリリースされた。その後、[Google Chromeに対抗してFirefoxの開発者ツールを充実させる動きが広がり](https://ja.wikipedia.org/wiki/Google_Chrome "wikilink")、Firebugの機能はFirefoxに取り込まれるようになった。2016年にはFirefoxと統合され、拡張機能としてのFirebugはメンテナンスのみが行われていた。2017年11月のFirefox Quantumのリリースとともに開発終了となる\[2\]。
...
## 外部リンク
  ...
  -
  - [Firebug :: Firefox アドオン](https://addons.mozilla.jp/firefox/details/1843)

[Category:拡張機能_(Mozilla)](https://ja.wikipedia.org/wiki/Category:拡張機能_\(Mozilla\) "wikilink") [Category:JavaScript](https://ja.wikipedia.org/wiki/Category:JavaScript "wikilink") [Category:ウェブデザイン](https://ja.wikipedia.org/wiki/Category:ウェブデザイン "wikilink") [Category:Webオーサリングソフト](https://ja.wikipedia.org/wiki/Category:Webオーサリングソフト "wikilink")

1.  [Firebug Lite](https://getfirebug.com/firebuglite)
2.
3.  [Q: What license does Firebug use?](https://getfirebug.com/faq/#What_license_does_Firebug_use)