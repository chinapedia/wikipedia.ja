...
LAPACKはFortran 90以外のプログラミング言語から利用することが可能であり、これを目的とした[言語バインディングのためのライブラリも開発されている](https://ja.wikipedia.org/wiki/束縛_\(情報工学\) "wikilink")。LAPACK 3.4.0よりC言語インターフェースであるLAPACKEが統合された。
