...
特に[MIDI](../Page/MIDI.md "wikilink")に特化しており、多くの[DTMユーザーが参加していた](../Page/デスクトップミュージック.md "wikilink")。既にプロであった人やその後プロになった人も数多い。
...
当時の個人運営の草の根BBSとしては珍しく、[Computer Music Magazineや](https://ja.wikipedia.org/wiki/Computer_Music_Magazine "wikilink")[DTM MagazineといったDTM情報誌の編集部のIDがあった](https://ja.wikipedia.org/wiki/DTMマガジン "wikilink")。

現在では[mixi](https://ja.wikipedia.org/wiki/mixi "wikilink")内に公式のコミュニティがあるのみで、公式・公認のホームページは現存していない。

## ライブラリ

ライブラリには2万曲を超えるMIDIデータや関連する音楽用ソフトウェアが多数登録されていた。 当時としては[商用ネット](https://ja.wikipedia.org/wiki/商用ネット "wikilink")を遙かに上回るデータ量で、MIDIユーザーの聖地であった。
