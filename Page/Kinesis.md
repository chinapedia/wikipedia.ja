...
利点の多いContoured Keyboardだが、一般的な自国（米国）人の平均的な手の大きさに合わせて設計された為か、[日本人](https://ja.wikipedia.org/wiki/日本人 "wikilink")にとってはサイズがやや大きく、一番上端にあるキーを押す際に僅かだがパームレストから手を浮かさなければならない人もいる。（パームレストは手を休める時に使い、タイプ時には手を浮かせることが推奨されている。）また奥行きはフルキーボード並みで横幅はやや狭い程度、高さは通常のキーボードよりも高いため、設置にはかなりの空間を必要とする。

チープなファンクションキーはエルゴノミクスとは言い難く、ファンクションキーを酷使するようなユーザには不向きである。ただ、ファンクションキーはその存在意義に疑問を呈す意見もあり\[2\]、互換性のために搭載したとも考えられる（マクロの入力にも使用する）。

国内に正規代理店はあるが、展示している実店舗が極端に少ないため試用が難しいこと、比較的高価\[3\]であることも欠点といえる。
...
[Maltronは類似した形状のキーボードを販売している](https://ja.wikipedia.org/wiki/:en:Maltron "wikilink")。

格子状配列には[NEC](https://ja.wikipedia.org/wiki/NEC "wikilink")のM式用キーボード\[5\]や[TypeMatrix](https://ja.wikipedia.org/wiki/TypeMatrix "wikilink")などがある。またμTRONキーボードのように右手用キーと左手用キーでずれを逆にし、完全な線対称のキー配置としたキーボードも存在する。
...
## 関連項目
  ...
  - [TypeMatrix](https://ja.wikipedia.org/wiki/TypeMatrix "wikilink") - 格子状の配列やDvorak配列への切り替えなどの持つキーボードを製造している。

## 外部リンク

  - [Kinesis](http://www.kinesis-ergo.com/) - キネシスの公式サイト
  - [株式会社エジクン技研](http://www.edikun.co.jp/) - 日本での正規代理店

[Category:アメリカ合衆国の工業製品メーカー](https://ja.wikipedia.org/wiki/Category:アメリカ合衆国の工業製品メーカー "wikilink") [Category:コンピュータ周辺機器企業](https://ja.wikipedia.org/wiki/Category:コンピュータ周辺機器企業 "wikilink") [Category:ハードウェア](https://ja.wikipedia.org/wiki/Category:ハードウェア "wikilink") [Category:入力機器](https://ja.wikipedia.org/wiki/Category:入力機器 "wikilink")

1.  入門機的な扱いであるEssentialモデルのみリマップ機能は無い
2.  HHKB開発の経緯『[個人用小型キーボードへの長い道](http://member.wide.ad.jp/~wada/bit.hhkbd/hhkbd.html)』
3.  国内での最安モデルであるAdvantage USBの価格が27,980円
4.  <http://ogino-mpe-lab.dana-farber.org/principal-investigator.html> 2015年3月14日閲覧
