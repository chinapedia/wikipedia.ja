...
以下に主な拡張の例を示す:
  ...
  - [Org-mode](../Page/Org-mode.md "wikilink") : 要約を維持しながら、様々なタイプのリストを整理し、プロジェクトを見積もり、そして（[PDF](../Page/Portable_Document_Format.md "wikilink")、[HTML](../Page/HyperText_Markup_Language.md "wikilink")、[OpenDocument](../Page/OpenDocument.md "wikilink")などの）多数のフォーマットのドキュメントを組み合わせる。Org-modeを使う静的サイトジェネレータだけではなく、[文芸的プログラミング](../Page/文芸的プログラミング.md "wikilink")のために利用できるBabelが存在する\[32\]
