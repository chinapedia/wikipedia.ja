...
[フェルナンド・J・コルバト](https://ja.wikipedia.org/wiki/フェルナンド・J・コルバト "wikilink")によれば、[MITの](../Page/マサチューセッツ工科大学.md "wikilink")[Project MACで働いていた](https://ja.wikipedia.org/wiki/Project_MAC "wikilink")1963年、彼のチームがデーモン (daemon) という用語を初めて使ったという。分子をより分けてくれるという物理学や熱力学の空想上の存在である[マクスウェルの悪魔](https://ja.wikipedia.org/wiki/マクスウェルの悪魔 "wikilink") (Maxwell's demon) が発想の元となっている\[4\]\[5\]。
...
> 多くの人々が "daemon" という語と "demon" という語を同等視しており、UNIXと[冥界](https://ja.wikipedia.org/wiki/冥界 "wikilink")の間にある種の[悪魔的関係があるように感じている](https://ja.wikipedia.org/wiki/サタニズム "wikilink")。これは言語道断な誤りである。"daemon" は実際には "demon" のより古い形であり、daemon自体には善または悪への特定の偏向の意味はなく、むしろ個人の性格や個性を説明付ける役割を担っていた。古代ギリシアにおける「個人的daemon」の概念は現代の守護天使に近く、*eudaemonia* は親切な精霊によって助けられたり保護されたりしている状態を意味する。現実にはUNIXシステムではdaemonとdemonの両方が横行しているようだ。(p.403)
...
デーモンを起動する一般的な手法は次の通りである。
  ...
  - [標準ストリーム](https://ja.wikipedia.org/wiki/標準ストリーム "wikilink") (stdin, stdout, stderr) をログファイルまたは[コンソール](https://ja.wikipedia.org/wiki/コンソール "wikilink")または [デーモン_(ソフトウェア)//dev/null](https://ja.wikipedia.org/wiki/デーモン_\(ソフトウェア\)/dev/null "wikilink") にリダイレクトする。
...
## UNIX/Unix系システムでのデーモンの例
  ...
  - [システム管理](../Page/システム管理.md "wikilink")系デーモン - [apmd](https://ja.wikipedia.org/wiki/Advanced_Power_Management "wikilink")、[init](https://ja.wikipedia.org/wiki/init "wikilink")、klogd\[8\]、[launchd](https://ja.wikipedia.org/wiki/launchd "wikilink") ([macOS](https://ja.wikipedia.org/wiki/macOS "wikilink"))、[syslogd](../Page/Syslog.md "wikilink")、[webmin](https://ja.wikipedia.org/wiki/webmin "wikilink")
  - [Network File System](https://ja.wikipedia.org/wiki/Network_File_System "wikilink") 関連デーモン - nfsd、mountd、rquotad
  - 周辺機器関連デーモン - [blued](https://ja.wikipedia.org/wiki/Bluetooth "wikilink") ([macOS](https://ja.wikipedia.org/wiki/macOS "wikilink"))、[cupsd](https://ja.wikipedia.org/wiki/Common_Unix_Printing_System "wikilink")、kerneld（[LKM用デーモン](https://ja.wikipedia.org/wiki/ローダブル・カーネル・モジュール "wikilink")）、[mpd](https://ja.wikipedia.org/wiki/Music_Player_Daemon "wikilink")、[pcmcia](../Page/PCカード.md "wikilink")
  - [通信プロトコル](../Page/通信プロトコル.md "wikilink")[サーバ](../Page/サーバ.md "wikilink") - [bootparamd](../Page/Bootstrap_Protocol.md "wikilink")、[dhcpd](https://ja.wikipedia.org/wiki/Dynamic_Host_Configuration_Protocol "wikilink")、[fingerd](../Page/Fingerプロトコル.md "wikilink")、[ftpd](../Page/File_Transfer_Protocol.md "wikilink")、[httpd](../Page/Hypertext_Transfer_Protocol.md "wikilink")、[inetd](https://ja.wikipedia.org/wiki/inetd "wikilink")、[isdn](../Page/ISDN.md "wikilink")、[named](../Page/BIND.md "wikilink")、[ntpd](../Page/Network_Time_Protocol.md "wikilink")、[portmap](https://ja.wikipedia.org/wiki/ポートマップ "wikilink")、[routed](../Page/ルーティング.md "wikilink")、rpcbind、[snmpd](../Page/Simple_Network_Management_Protocol.md "wikilink")、[squid](https://ja.wikipedia.org/wiki/Squid_\(ソフトウェア\) "wikilink")、[sshd](../Page/Secure_Shell.md "wikilink")、[tcpd](../Page/TCP_Wrapper.md "wikilink")、[telnetd](../Page/Telnet.md "wikilink")、xfsd（[Xフォントサーバ](../Page/X_Window_System.md "wikilink")）、[xinetd](https://ja.wikipedia.org/wiki/xinetd "wikilink")、ypbind
  ...
  - 分散[メモリキャッシュ](https://ja.wikipedia.org/wiki/キャッシュ_\(コンピュータシステム\) "wikilink") - [memcached](https://ja.wikipedia.org/wiki/memcached "wikilink")
