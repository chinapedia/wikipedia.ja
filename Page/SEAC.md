> この記事は[SEAC](https://ja.wikipedia.org/wiki/SEAC)から翻訳されています。
...
加算には864[マイクロ秒](https://ja.wikipedia.org/wiki/マイクロ秒 "wikilink")、乗算には2980マイクロ秒（つまり約3ミリ秒）かかった。

中央機械の重量は3,000[ポンド](../Page/ポンド_\(質量\).md "wikilink")（約1.4[トン](../Page/トン.md "wikilink")）だった\[8\]。

## 利用例

SEACは[テレタイプによって遠隔地から使用することもできた](../Page/テレタイプ端末.md "wikilink")。すなわち、SEACは遠隔利用された最初のコンピュータのうちの1つということになる。SEACは様々な改造を施されながら1964年まで使用された\[9\]。以下のような分野の計算がSEAC上で行われた。

  - [デジタル画像](https://ja.wikipedia.org/wiki/デジタル画像 "wikilink")処理（による）
  - 都市交通シミュレーションの[コンピュータアニメーション](https://ja.wikipedia.org/wiki/コンピュータアニメーション "wikilink")\[10\]\[11\]
...
## 関連項目
  ...
  - [SWAC](https://ja.wikipedia.org/wiki/SWAC "wikilink") (Standards Western Automatic Computer)
  - [真空管式コンピュータ一覧](../Page/真空管式コンピュータ一覧.md "wikilink")
  - [Manchester Baby](https://ja.wikipedia.org/wiki/Manchester_Small-Scale_Experimental_Machine "wikilink")
...
## 外部リンク
  ...
  - [SEAC and the Start of Image Processing at the National Bureau of Standards](http://museum.nist.gov/panels/seac/SEACOVER.HTM) – 米国標準技術局（NIST）のバーチャル博物館
  - [Margaret R. Fox Papers, 1935-1976](http://purl.umn.edu/41420) - [ミネソタ大学](https://ja.wikipedia.org/wiki/ミネソタ大学 "wikilink")[チャールズ・バベッジ研究所](https://ja.wikipedia.org/wiki/チャールズ・バベッジ研究所 "wikilink")所蔵。コレクションには、ENIAC、UNIVACに関するオリジナルの報告書や、多くの初期の国立標準局(NBS)の内部の活動レポートが含まれている。 SEAC、SWAC、DYSEACのメモと履歴。 UNIVAC、LARC、MIDACのプログラミング手順。特許の評価と開示。システムの説明。マーガレット・フォックスの同僚によって書かれたスピーチと記事。サミュエル・アレキサンダー、マーガレット・フォックス、サミュエル・ウィリアムズの対応。Fox Papersのボックス6〜8には、NBSのSEACのドキュメント、レポート、分析が含まれている。
  - [SEAC ("Standards Eastern Automatic Computer") (1950)](http://csrc.lse.ac.uk/history/SEAC-1950.htm) [(Archived)](https://web.archive.org/web/20070723040312/http://csrc.lse.ac.uk/history/SEAC-1950.htm), from *History of Computing: An Encyclopedia of the People and Machines that Made Computer History*, Lexikon Services Publishing
  - [Timeline of Computer History at CHM](http://www.computerhistory.org/timeline/?year=1950)
...
1.
2.  [1955 BRL report](http://ed-thelen.org/comp-hist/BRL-o-s.html#SEAC)
3.
4.
5.
6.
...
10.
11.
12. [Metallography--past, Present, and Future: 75th Anniversary Volume](https://books.google.com/books?id=d2R5dvk9vX4C&pg=PA14&lpg=PA14&dq=George+moore+NBS&source=bl&ots=opT8pF3eHA&sig=oDFGuYnijUd9o4124gk5uW58Fqs&hl=en&sa=X&ved=0CCAQ6AEwAWoVChMI8aaIxqmbyQIVAVcaCh3k_wmb#v=onepage&q=George%20moore%20NBS&f=false), Issue 1165, George F. Vander Voort, p.14