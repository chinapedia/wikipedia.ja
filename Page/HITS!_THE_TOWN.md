...
<!-- end list -->
  ...
  - 2020年4月11日から山口がテレワークでの出演となり、コロコロクイズのサイコロを鬼塚が振ったり、あまがみ神社では山口とビデオ通話をしている端末のカメラにリスナーのメールを写したりと対応をしている。
  - 2020年4月25日のあまがみ神社で、テレワーク出演中の山口との通信が突然切れ、鬼塚がコーナーを強行しようとするも噛まずに普通に読めてしまうため1度CMに入って仕切り直すというハプニングがあった。その後鬼塚は何事もなかったかのようにコーナーの紹介から始めた。
