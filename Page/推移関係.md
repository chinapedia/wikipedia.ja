...
[一階述語論理](https://ja.wikipedia.org/wiki/一階述語論理 "wikilink")でこれを表すと、次のようになる。
...
推移関係の例として以下のものがある。
  ...
  - 「AはBと等しい」（[等式](https://ja.wikipedia.org/wiki/等式 "wikilink")）
  - 「AはBの[部分集合](../Page/部分集合.md "wikilink")である」
  - 「AはBより小さい」、「AはB以下である」（[不等式](https://ja.wikipedia.org/wiki/不等式 "wikilink")）
...
## 関連項目
  ...
  - [反射関係](https://ja.wikipedia.org/wiki/反射関係 "wikilink")
