...
**GeForce**（ジーフォース）は、[NVIDIA](../Page/NVIDIA.md "wikilink")社が製造する [Graphics Processing Unit (GPU)](../Page/Graphics_Processing_Unit.md "wikilink") の[ブランド](../Page/ブランド.md "wikilink")名である
...
GeForce 8シリーズ以降は、[CUDA](../Page/CUDA.md "wikilink")\[6\] \[7\]、[物理演算](https://ja.wikipedia.org/wiki/物理演算 "wikilink")のハードウェアアクセラレーションを可能にする[PhysX](../Page/PhysX.md "wikilink")\[8\]、[OpenCL](../Page/OpenCL.md "wikilink")や[DirectCompute](https://ja.wikipedia.org/wiki/DirectCompute "wikilink")といったGPGPU APIにも対応している。
...
| ------------------------ | ---------------------------------- | ------------------- | ---------- | --- | ------------- | --------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------ | -------------------------------------- |
| SM                       | [CUDA](../Page/CUDA.md "wikilink") | TeX                 | ROP        | L2  | バス幅           | 動作クロック                                              | 容量              | 単精度 (理論値)                                                                                  |                                        |
...
| --------------------------------- | ---------------------------------- | ------------------- | -------- | --------- | --------------- | --------------------------------------------------- | ------------- | ------ | ------------------------------------------------------------------------------------------ | -------------------------------------- |
| SM                                | [CUDA](../Page/CUDA.md "wikilink") | TeX                 | ROP      | L2        | バス幅             | 動作クロック                                              | 帯域            | 容量     | 単精度 (理論値)                                                                                  |                                        |
...
| 製品名                    | コア名 (プロセス)                         | コアクロック \[GPU Boost\] | コア数         | メモリ  | FLOPS         | [SLI](https://ja.wikipedia.org/wiki/SLI "wikilink") | VR        | 最大消費電力 (補助電源) | 接続          | [DirectX](https://ja.wikipedia.org/wiki/DirectX "wikilink") <small>(Feature Level)</small> | [OpenGL](../Page/OpenGL.md "wikilink") |
| ---------------------- | ---------------------------------- | -------------------- | ----------- | ---- | ------------- | --------------------------------------------------- | --------- | ------------- | ----------- | ------------------------------------------------------------------------------------------ | -------------------------------------- |
| SM                     | [CUDA](../Page/CUDA.md "wikilink") | Tensor               | RT          | TeX  | ROP           | L2                                                  | バス幅       | 動作クロック        | 帯域          | 容量                                                                                         | 単精度 (理論値)                              |
