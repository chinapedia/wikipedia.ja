> この記事は[Example.com](https://ja.wikipedia.org/wiki/Example.com)から翻訳されています。
...
## 外部リンク
  ...
  - 以下のURLはICANNのWebサーバに接続され、例示用で、ドキュメント用に自由に使える旨が表示される。
      - [example.com](https://example.com)
      - [example.net](https://example.net)
      - [example.org](https://example.org)
      - [example.edu](https://example.edu)
  - [iana.org](https://www.iana.org/domains/reserved)
  - RFC 2606  - [RFC 2606の日本語訳](https://suika.fam.cx/rfc/ja-translations/rfc2606-ja.html)

[Category:ドメイン名](https://ja.wikipedia.org/wiki/Category:ドメイン名 "wikilink") [Category:1999年設立](https://ja.wikipedia.org/wiki/Category:1999年設立 "wikilink") [Category:プレースホルダー](https://ja.wikipedia.org/wiki/Category:プレースホルダー "wikilink")

1.  RFC 2606, *Reserved Top Level DNS Names*, D. Eastlake, A. Panitz, The [Internet Society](https://ja.wikipedia.org/wiki/Internet_Society "wikilink") (June 1999)