...
主に[Macintosh](../Page/Macintosh.md "wikilink")版が知られ、しばしば「[Macintosh](../Page/Macintosh.md "wikilink")版の[Visual Basic](https://ja.wikipedia.org/wiki/Microsoft_Visual_Basic "wikilink")」と喩えられるが、[Windows版ならびに](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")[Linux](https://ja.wikipedia.org/wiki/Linux "wikilink")/x86版も存在する。また、利用している環境に関わらず、全てのプラットフォーム用の実行バイナリを出力することができるため、双方向の[クロスプラットフォーム](https://ja.wikipedia.org/wiki/クロスプラットフォーム "wikilink")開発が可能である。

なお、Xojoは、[Universal Binaryアプリケーションを作成することのできる](https://ja.wikipedia.org/wiki/Universal_Binary "wikilink")、[サードパーティー](https://ja.wikipedia.org/wiki/サードパーティー "wikilink")開発ツールのひとつである。
...
言語仕様については、BASIC言語をベースにしているため、基本的な命令その他習得の容易さは他の追随を許さない。また、オブジェクト指向的実装についても、[クラスや](../Page/クラス_\(コンピュータ\).md "wikilink")[インタフェースなど](https://ja.wikipedia.org/wiki/インタフェース_\(情報技術\) "wikilink")、[Java](https://ja.wikipedia.org/wiki/Java "wikilink")相当の機能を実現している。

#### マルチメディア機能

マルチメディア機能については[QuickTime](../Page/QuickTime.md "wikilink")の機能をかなり引き出すことが可能であり、[ビルトイン](https://ja.wikipedia.org/wiki/ビルトイン "wikilink")の命令としてQuickTimeムービーを編集する機能も備える。グラフィック周りは、処理の遅さに目をつぶれば、ラスターイメージから[ベクターイメージ](https://ja.wikipedia.org/wiki/ベクターイメージ "wikilink")、3DCGまでを扱え、256階調グレースケール[マスク](https://ja.wikipedia.org/wiki/マスク "wikilink")による[アルファブレンド](https://ja.wikipedia.org/wiki/アルファブレンド "wikilink")も簡単に実現でき、ソフトウェアレベルで[スプライト機能さえも有する](../Page/スプライト_\(映像技術\).md "wikilink")\[1\]。スプライトに関しては一切コーディングすることなくスプライト同士が接触したかを判定することまで可能。画像の透過に関しては、アルファブレンドを有しながら特定の色を透過したり[アルファチャンネル](../Page/アルファチャンネル.md "wikilink")が使えないなど、中途半端な感もある。
...
[サーバ](../Page/サーバ.md "wikilink")や[データベース](../Page/データベース.md "wikilink")の[フロントエンド](https://ja.wikipedia.org/wiki/フロントエンド "wikilink")や、[UNIX](../Page/UNIX.md "wikilink")[シェル](../Page/シェル.md "wikilink")や[DOS](../Page/MS-DOS.md "wikilink")[コマンドラインのGUIフロントエンドの開発するための各種命令も豊富](https://ja.wikipedia.org/wiki/コマンドラインインタプリタ "wikilink")。
...
#### Mac OSの機能への対応
  ...
  - [リソースフォーク](https://ja.wikipedia.org/wiki/リソースフォーク "wikilink")、バイナリデータの[リトルエンディアンと](https://ja.wikipedia.org/wiki/エンディアン "wikilink")[ビッグエンディアンの使い分け](https://ja.wikipedia.org/wiki/エンディアン "wikilink")、255文字までのロングファイルネームなどもサポート
  - キーチェーン・[Spotlight](https://ja.wikipedia.org/wiki/Spotlight "wikilink")・アドレスブックへのアクセスをサポート
...
#### Windowsの機能への対応
  ...
  - [OLE](https://ja.wikipedia.org/wiki/Object_Linking_and_Embedding "wikilink") ([COM](https://ja.wikipedia.org/wiki/Component_Object_Model "wikilink"))、[タスクトレイ](https://ja.wikipedia.org/wiki/タスクトレイ "wikilink")の使用をサポート
  - [MDIのサポート](https://ja.wikipedia.org/wiki/Multiple_Document_Interface "wikilink")
  - [Windows XPのサポート](../Page/Microsoft_Windows_XP.md "wikilink")、GUI部品の[Luna](https://ja.wikipedia.org/wiki/Luna "wikilink")（Windows XP標準の外観）での描画に対応
