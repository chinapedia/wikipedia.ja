...
**二重否定の除去**（にじゅうひていのじょきょ、）は、[論理学](../Page/論理学.md "wikilink")、特に[命題論理](https://ja.wikipedia.org/wiki/命題論理 "wikilink")における[推論規則](https://ja.wikipedia.org/wiki/推論規則 "wikilink")の1つである。いわゆる[二重否定と等価なものを追加したり](../Page/二重否定_\(言語学\).md "wikilink")（二重否定の導入）、二重の否定作用素を削除したり（二重否定の除去）といった操作を[論理式](https://ja.wikipedia.org/wiki/論理式 "wikilink")に施す。
...
これらの規則は[シークエント](https://ja.wikipedia.org/wiki/シークエント "wikilink")の記法を使うと次のようにも表せる。

\[\neg \neg A \vdash A\],

\[A \vdash \neg \neg A\].

これら2つの[推論規則](https://ja.wikipedia.org/wiki/推論規則 "wikilink")に[演繹定理](https://ja.wikipedia.org/wiki/演繹定理 "wikilink")を適用すると、以下の2つの妥当な論理式が得られる。
