...
メカニックデザインまたはイラストレーターとして、[横山宏](../Page/横山宏.md "wikilink")、[杉浦善夫](https://ja.wikipedia.org/wiki/杉浦善夫 "wikilink")、[藤岡建機](../Page/藤岡建機.md "wikilink")、[木下ともたけ](https://ja.wikipedia.org/wiki/木下ともたけ "wikilink")を採用。グラフィックエンジンは [Touchdown Entertainment社の](../Page/Monolith_Productions.md "wikilink") [Lithtech Jupiterエンジン](../Page/Monolith_Productions.md "wikilink")、通信部分の[ミドルウェア](../Page/ミドルウェア.md "wikilink")として[コミュニティーエンジン](../Page/コミュニティーエンジン.md "wikilink")社の[VCE](https://ja.wikipedia.org/wiki/VCE "wikilink")を採用している。
...
操作形態は[メックウォーリアなどに代表される](../Page/メック_\(架空の兵器\).md "wikilink")、いわゆるロボット物FPSタイプ。プレイヤーが人間を操作するFPSと違って旋回がキーボードに割り当てられている。そのためマウスは上半身の旋回及び照準に特化している。また、従来のレベル（もしくはそれに準ずるスキル）によるプレイ制限の厳しいMMORPG業界へ対して一石を投じる設計になっており、レベルの概念はあるもののそれが戦闘能力に直接繋がるわけではないのが特徴。そのため遊ぶ時間があまり取れない人でも楽しめるようになっている。
...
しかし力を失いつつあった国家政府によるこの計画は頓挫し、その遺志は巨大な民間企業**Planet of Fortune**社（以下**POF**）に引き継がれることとなる。[テラフォーミング](../Page/テラフォーミング.md "wikilink")技術と[コールドスリープ](../Page/コールドスリープ.md "wikilink")技術の開発に成功したPOFは、これらを組み合わせて地球外惑星への移民を実行する。
...
ジャンクメタルを[ハードウェア](../Page/ハードウェア.md "wikilink")面で構成するパーツは以下の通り。
  ...
  - アームパーツ
    腕部。左右にわかれており、それぞれに別々のアームパーツを装着することが可能。武装と一体型のものと、[マニピュレーター](../Page/マニピュレーター.md "wikilink")タイプのものがある。武装一体型のアームは一律で手のハードポイントが存在せず、種類によって肩・腕のハードポイントの有無が異なる。マニピュレータータイプは一律で肩・腕・手の三カ所にハードポイントが存在する。
  - オプションパーツ
...
惑星の開発およびそれらに付随する業務を取り仕切る一大[コングロマリット](../Page/コングロマリット.md "wikilink")。現在のところ比肩するもののない巨大な企業である。
...
ジャンクメタルの開発では新素材、新技術を投入したパーツ開発に長けており、他社のメインフレームに自社のパーツを組み合わせて高性能化させるのを主流としている。[アジア](../Page/アジア.md "wikilink")的な無骨さ、茶色や赤、黄土色や抹茶色などを配色した怪しげなシンボルマークなど、POFとは対極のイメージを持つ。
...
北方開拓に乗り出した人類の足がかりとなっている都市であり、更なる開拓を進める人類にとっての希望の街。未だ建設途中であり、街の中では巨大な[シールドマシン](../Page/シールドマシン.md "wikilink")が都市の規模を広げるべく地下を掘りつづけている。
