...
Viをモデルとした派生物には[nvi](https://ja.wikipedia.org/wiki/nvi "wikilink")や[Elvis](../Page/Elvis.md "wikilink")があり、中でも最も機能的に発展したのがVimである。そのVimをモデルとしたプロジェクトもいくつかあるが、Vimの機能群は巨大なため、全てを模倣するのは困難であることから、結局Viクローンと同程度の機能実装にとどまっている。逆にVimの機能を制限して操作の敷居を低くした[Creamという派生物もある](https://ja.wikipedia.org/wiki/Cream_\(テキストエディタ\) "wikilink")。
