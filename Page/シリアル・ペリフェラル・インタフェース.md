...
このような背景から、いくつかのシリアルバス規格が提唱された。 ([I2C](https://ja.wikipedia.org/wiki/I2C "wikilink"), SPI, MicroWireなど)
...
[upright=1.8が](https://ja.wikipedia.org/wiki/File:SPI_8-bit_circular_transfer.svg "wikilink")、チップ間の[リングバッファ](https://ja.wikipedia.org/wiki/リングバッファ "wikilink")を形成する \]\]
...
## 具体的な製品
  ...
  - [リアルタイムクロック](https://ja.wikipedia.org/wiki/リアルタイムクロック "wikilink")
...
## 関連項目
  ...
  - [I2C](https://ja.wikipedia.org/wiki/I2C "wikilink") 2線式
