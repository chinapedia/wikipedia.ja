...
MQは、本来はWebとは無縁の基幹系メッセージキューイング製品で、システム内部のデザインは[DB2](https://ja.wikipedia.org/wiki/DB2 "wikilink")に近いが、システム統合、サーバー間連携などの要ともなるため、WebSphereブランドに移動したと考えられる。

DataStageは、IBMが買収した[Ascential](https://ja.wikipedia.org/wiki/Ascential "wikilink")の[ETL](https://ja.wikipedia.org/wiki/ETL "wikilink")ツールで、これも本来はデータ管理（DB2など）に関連が深い製品と考えられるが、こちらも「業務プロセスの統合ツール」としてWebSphereブランドとなったと考えられる。
...
## 外部リンク
  ...
  - [日本IBM WebSphere](https://www.ibm.com/jp-ja/cloud/info/websphere)
  - [IBMクラウド製品](https://www.ibm.com/jp-ja/cloud/products)
  ...
  - [YouTube: WebSphereチャンネル](http://www.youtube.com/user/IBMWebSphereChannel)
  - [WebSphere Twitter](http://twitter.com/websphere_Japan)
  - [IBM Education Audio Presentations and PDFs](http://publib.boulder.ibm.com/infocenter/ieduasst/v1r1m0/index.jsp)

[Category:IBMのソフトウェア](https://ja.wikipedia.org/wiki/Category:IBMのソフトウェア "wikilink") [Category:アメリカ合衆国のブランド](https://ja.wikipedia.org/wiki/Category:アメリカ合衆国のブランド "wikilink") [Category:ネットワークソフト](https://ja.wikipedia.org/wiki/Category:ネットワークソフト "wikilink") [Category:ビジネスソフト](https://ja.wikipedia.org/wiki/Category:ビジネスソフト "wikilink")
