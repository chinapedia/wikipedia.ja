> この記事は[Earth Television Network](https://ja.wikipedia.org/wiki/Earth_Television_Network)から翻訳されています。


**Earth Television Network GmbH**（アース・テレビジョン・ネットワーク）は、[ドイツ](https://ja.wikipedia.org/wiki/ドイツ "wikilink")・[ミュンヘン](../Page/ミュンヘン.md "wikilink")に本社を置くテレビ[番組制作会社](../Page/番組制作会社.md "wikilink")である。略称は**earthTV**。

## 概要

世界各地の主要都市や観光地に[ライブカメラ](https://ja.wikipedia.org/wiki/ライブカメラ "wikilink")を設置し、その地点の様子を生中継。その映像を元にオリジナル番組を制作し、[通信衛星](../Page/通信衛星.md "wikilink")を通じて世界各国の[放送局](../Page/放送局.md "wikilink")に配信している。また、自社のウェブサイトで無料のオンデマンド配信を行っている。

全てのライブカメラはミュンヘンの本社から遠隔操縦でき、ズームイン・アウトや方向転換もほぼ自由自在。それにより、毎回異なるアングルの映像の提供を実現している。

## 主な番組

### The World LIVE

文字通り、世界各地の今の様子を伝える生中継。1回あたり90秒の番組枠内で5～6箇所のカメラ設置地点をランダムに映し出す。

### Motion Timelapse

あるカメラ設置地点の1日分の映像を収録し、それを1分に圧縮し、高速再生して見せる番組。

## 主なカメラ設置地点

[Earthtv-camera01.jpg](https://ja.wikipedia.org/wiki/File:Earthtv-camera01.jpg "fig:Earthtv-camera01.jpg")
...
番組で使用されているBGMは「earth grooves Vol.1」というCDにまとめられて販売されている。日本からでも[Amazon.de](https://ja.wikipedia.org/wiki/Amazon.de "wikilink")など、主にドイツ国内のインターネット通販サイトから購入できる。

## 外部リンク

  - [earthTV公式サイト（英語）](http://www.earthtv.com/)

[Category:ドイツのメディア](https://ja.wikipedia.org/wiki/Category:ドイツのメディア "wikilink")