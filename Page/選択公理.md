...
**選択公理**（せんたくこうり、、**選出公理**ともいう）とは[公理的集合論](../Page/公理的集合論.md "wikilink")における[公理](../Page/公理.md "wikilink")のひとつで、どれも空でないような[集合](../Page/集合.md "wikilink")を[元とする集合](https://ja.wikipedia.org/wiki/元_\(数学\) "wikilink")（すなわち、集合の集合）があったときに、それぞれの集合から一つずつ元を選び出して新しい集合を作ることができるというものである。[1904年](../Page/1904年.md "wikilink")に[エルンスト・ツェルメロ](https://ja.wikipedia.org/wiki/エルンスト・ツェルメロ "wikilink")によって初めて正確な形で述べられた\[1\]。

## 定義

[空集合](https://ja.wikipedia.org/wiki/空集合 "wikilink")を要素に持たない任意の[集合族](https://ja.wikipedia.org/wiki/集合族 "wikilink")に対して、各要素（それ自体が集合である）から一つずつその要素を選び、新しい集合を作ることができる。あるいは同じことであるが、空でない集合の空でない任意の族 \(\mathcal{A}\) に対して写像 \(f \colon \mathcal{A} \to \textstyle{\bigcup} \mathcal{A}:=\textstyle{\bigcup_{A \in \mathcal{A}}}A\) であって任意の \(x \in \mathcal{A}\) に対し \(f(x) \in x\) なるものが存在する、と[写像](../Page/写像.md "wikilink")を用いて言い換えることが出来る（ここで存在が要求される写像  を****という）。これは次の[命題](https://ja.wikipedia.org/wiki/命題 "wikilink")と[同値](https://ja.wikipedia.org/wiki/同値 "wikilink")である。

  -
    {*A*<sub>*λ*</sub>}<sub>*λ*∈*Λ*</sub> をどれも空集合でないような集合の族とすると、それらの[直積](https://ja.wikipedia.org/wiki/直積集合 "wikilink")\<\!--
      -
...
以下の命題は全て選択公理と同値である。つまり、以下の命題のいずれかを仮定すると選択公理を[証明](https://ja.wikipedia.org/wiki/証明 "wikilink")することができるし、逆に選択公理を仮定すると以下の命題が全て証明できる。
  ...
  - [整列可能定理](https://ja.wikipedia.org/wiki/整列可能定理 "wikilink"):任意の集合は整列可能である。
    ...
    [直積定理](https://ja.wikipedia.org/wiki/直積定理 "wikilink"):[無限](https://ja.wikipedia.org/wiki/無限 "wikilink")個の空集合でない集合の直積は空集合ではない。
    右逆写像の存在:[全射](../Page/全射.md "wikilink")は[右逆写像を有する](https://ja.wikipedia.org/wiki/逆写像 "wikilink")。
    [ケーニッヒ（Julius König）の定理](https://ja.wikipedia.org/wiki/ケーニヒの定理_\(集合論\) "wikilink"):濃度の小さい集合の[直和](https://ja.wikipedia.org/wiki/直和 "wikilink")より、濃度の大きい集合の直積のほうが濃度が大きい。
    ...
    [チコノフの定理](https://ja.wikipedia.org/wiki/チコノフの定理 "wikilink"):[コンパクト空間](https://ja.wikipedia.org/wiki/コンパクト空間 "wikilink")の任意個の積空間はコンパクトになる。
...
選択公理、もしくはそれと同値な命題を適用することで、以下を示すことができる。
  ...
  - [バナッハ＝タルスキーの定理](https://ja.wikipedia.org/wiki/バナッハ＝タルスキーのパラドックス "wikilink")
  - 可算集合の可算個の和は可算である
  - 任意の無限集合は可算集合を含む
  - [ルベーグ非可測集合の存在](https://ja.wikipedia.org/wiki/ルベーグ測度 "wikilink")
  - 任意の[フィルターは極大フィルターに拡大できる](https://ja.wikipedia.org/wiki/フィルター_\(数学\) "wikilink")
  - 全ての体には代数的閉包が存在する。
...
しかし、[ツェルメロによる整列可能定理の証明に反論する過程で](https://ja.wikipedia.org/wiki/エルンスト・ツェルメロ "wikilink")、[エミーユ・ボレル](https://ja.wikipedia.org/wiki/エミーユ・ボレル "wikilink")、[ルネ＝ルイ・ベール](https://ja.wikipedia.org/wiki/ルネ＝ルイ・ベール "wikilink")、[アンリ・ルベーグ](https://ja.wikipedia.org/wiki/アンリ・ルベーグ "wikilink")、[バートランド・ラッセル](https://ja.wikipedia.org/wiki/バートランド・ラッセル "wikilink")などが選択公理の存在に気付き、新たな公理であることが認識されるようになった。確かに、無限個の集合からなる集合族の場合、上のような操作を想定しても「順に選び出す」操作は有限回で終了することはないのだから、このような操作を行えるかどうかは必ずしも明らかではない。

選択公理は、それ自身もまたその否定もほかの公理からは証明できないものであること、すなわち独立であることが示された（[クルト・ゲーデル](https://ja.wikipedia.org/wiki/クルト・ゲーデル "wikilink")、[ポール・コーエン](https://ja.wikipedia.org/wiki/ポール・コーエン_\(数学者\) "wikilink")）が、これは公理的集合論における大きな成果であろう。なお、[ZF（ツェルメロ＝フレンケルの公理系）に](https://ja.wikipedia.org/wiki/公理的集合論#集合の公理系 "wikilink")[一般連続体仮説](https://ja.wikipedia.org/wiki/一般連続体仮説 "wikilink")を加えると選択公理を証明できる\[2\]。従って、一般連続体仮説と選択公理は何れもZFとは独立だが、前者の方がより強い主張であると言える。ZFに選択公理を加えた公理系をZFCと呼ぶ。

## バナッハ＝タルスキーのパラドックスと選択公理

選択公理は「どれかひとつを選んで取り出すことができる」という一見当たり前で直感的な命題に見える。しかし、無限集合においてそのような選択を行えるかどうかは自明ではないという主張もある。

実際、選択公理は、一見、奇怪で非直観的な結果を導く。[バナッハ＝タルスキーのパラドックス](https://ja.wikipedia.org/wiki/バナッハ＝タルスキーのパラドックス "wikilink")はそのような結果の中でも有名なもので、「有限個の部分に分割し、それらを回転・平行移動操作のみを使ってうまく組み替えることで、元の球と同じ半径の球を2つ作ることができる」と、初歩的な概念のみで表現することができる。ただ、ここでの「有限個の分割」は、通常イメージされる単純な分割（包丁でいくつかのパーツに切り分けるようなもの）ではなく、非常に特殊な分割であるため、「"奇怪な分割"をした結果、奇怪な結果（2つに増える）が生じた」にすぎないという側面もある。

なお、[ステファン・バナフ](https://ja.wikipedia.org/wiki/ステファン・バナフ "wikilink")（バナッハ）と[タルスキは論文の冒頭で](https://ja.wikipedia.org/wiki/アルフレト・タルスキ "wikilink")、「証明のなかに、この公理（選択公理）が果たす役割は、注目するに値する」と述べているだけであり、バナッハ＝タルスキーのパラドックスによって選択公理が正しくないと明確に主張したわけではない。

## 代わりとなる公理

選択公理とは矛盾するが、ZFCから選択公理を除いたZFとは矛盾しないような命題は数多く発見されている。たとえばは[強制法](https://ja.wikipedia.org/wiki/強制法 "wikilink")を用いて実数の集合が全て[ルベーグ可測であるようなZFのモデルを構成した](https://ja.wikipedia.org/wiki/ルベーグ測度 "wikilink")。
...
[カントール](../Page/ゲオルク・カントール.md "wikilink")、[ラッセル](https://ja.wikipedia.org/wiki/バートランド・ラッセル "wikilink")、[ボレル](https://ja.wikipedia.org/wiki/エミーユ・ボレル "wikilink")、[ルベーグなどは](https://ja.wikipedia.org/wiki/アンリ・ルベーグ "wikilink")、無意識のうちに可算選択公理を使ってしまっている。
...
1.  [Zermelo, Ernst](https://ja.wikipedia.org/wiki/エルンスト・ツェルメロ "wikilink") (1904). "Beweis, dass jede Menge wohlgeordnet werden kann". Mathematische Annalen 59: 514-16.
2.  [1926年](../Page/1926年.md "wikilink")にと[アルフレト・タルスキ](https://ja.wikipedia.org/wiki/アルフレト・タルスキ "wikilink")が示したが、証明は散逸した。同内容を[1943年](../Page/1943年.md "wikilink")に[ヴァツワフ・シェルピニスキ](https://ja.wikipedia.org/wiki/ヴァツワフ・シェルピニスキ "wikilink")が再発見し[1947年](../Page/1947年.md "wikilink")に出版した。
