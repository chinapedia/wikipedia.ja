...
後継機として2008年11月に[EOS 5D Mark IIが](https://ja.wikipedia.org/wiki/キヤノン_EOS_5D_Mark_II "wikilink")、2012年3月に Mark IIIが発売され、2016年9月からはキヤノン EOS 5D Mark IV が後継機種として発売されている。
...
## 主な仕様
  ...
  - 重量：810g（本体のみ）
  - バッテリーは専用充電式[リチウムイオンバッテリー](../Page/リチウムイオン二次電池.md "wikilink") (型番 : BP-511A / 7.4V / 1390mAh) を本体に1個使用。
  - バッテリーグリップBG-E4（オプション）装着時は、[リチウムイオンバッテリー](../Page/リチウムイオン二次電池.md "wikilink")2個または、[単3形電池ホルダー](../Page/乾電池.md "wikilink")（オプション）にて[単3形電池を](../Page/乾電池.md "wikilink")6個の使用が可能である。縦位置撮影用シャッターボタン、電子ダイヤル、AEロックボタン、AFフレーム選択ボタンが装備され、横位置撮影と同じ使用ができる。バッテリーグリップBG-E4使用時には、カメラ本体のバッテリー蓋はばね式で外せるようになっており、これをバッテリーグリップBG-E4のステー内部に格納できるようになっている。

## 設計上の欠陥

### キヤノン EOS 5D Mark II

2008年11月下旬に発売されたEOS 5Dの後継機。EOSシリーズ初の[フルHDの動画撮影機能を搭載している](https://ja.wikipedia.org/wiki/高精細度 "wikilink")。有効画素数は約2110万画素、最大連写枚数は3.9枚/秒まで向上した
...
画素数：有効約3040万画素35ｍｍフルサイズCMOSセンサー
...
## 外部リンク
  ...
  - [キヤノン EOS 5D](http://web.canon.jp/Camera-muse/camera/dslr/data/2005-2009/2005_eos5d.html)
