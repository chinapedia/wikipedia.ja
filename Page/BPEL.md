...
2007年6月、Active Endpoints、[アドビシステムズ](../Page/アドビシステムズ.md "wikilink")、BEAシステムズ、IBM、[オラクル](../Page/オラクル_\(企業\).md "wikilink")、SAP は[BPEL4People](https://ja.wikipedia.org/wiki/BPEL4People "wikilink") および WS-HumanTask 仕様をリリースした。これは、BPEL プロセスにおいて人間の活動をどのように取り込むか記述するものである。
