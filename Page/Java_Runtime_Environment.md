...
## 関連項目
  ...
  - [Java Development Kit](https://ja.wikipedia.org/wiki/Java_Development_Kit "wikilink")（JDK、Java開発キット）
...
1.  [Android](https://ja.wikipedia.org/wiki/Android "wikilink")のJava実行環境は正式にライセンスされたJREではなく、また[Dalvik仮想マシン](https://ja.wikipedia.org/wiki/Dalvik仮想マシン "wikilink")/[Android Runtimeは正式なJava仮想マシンとの互換性がない](https://ja.wikipedia.org/wiki/Android_Runtime "wikilink")。
