...
6.  **返事はいらない**
      -
        [Single Version](../Page/返事はいらない.md "wikilink")
7.  **生まれた街で**
      -
...
9.  **やさしさに包まれたなら**
      -
        [Single Version](../Page/やさしさに包まれたなら.md "wikilink")
10. **12月の雨**
      -
        アルバム『MISSLIM』より。
11. **魔法の鏡**
...
13. **コバルト・アワー**
      -
        アルバム『[COBALT HOUR](../Page/COBALT_HOUR.md "wikilink")』より。正式なタイトルは英語表記で「COBALT HOUR」。
...
13. **翳りゆく部屋**
      -
        [Single（Original）Mix](../Page/翳りゆく部屋.md "wikilink")

### DISC-3

1.  **あの日にかえりたい**（オリジナルカラオケ）
2.  **きっと言える**（オリジナルカラオケ）
3.  **やさしさに包まれたなら**（オリジナルカラオケ）
4.  **魔法の鏡**（オリジナルカラオケ）
      -
        このアルバムで、タイトルが間違って表記されていた（「魔法の鐘」）。
5.  **ルージュの伝言**（オリジナルカラオケ）
6.  **少しだけ片想い**（オリジナルカラオケ）
7.  **雨のステイション**（オリジナルカラオケ）
8.  **中央フリーウェイ**（オリジナルカラオケ）
9.  **グッド・ラック・アンド・グッド・バイ**（オリジナルカラオケ）
10. **翳りゆく部屋**（オリジナルカラオケ）

<!-- end list -->

  - 全作詞作曲：[荒井由実](../Page/松任谷由実.md "wikilink")
