...
初期型では照準器を兼ねるキャリングハンドルが固定式であることから、取り付けられる光学照準器が制限されていたが、後期型ではキャリングハンドルを脱着式とし、[ピカティニー・レール](../Page/ピカティニー・レール.md "wikilink")付きの物に交換できるよう改良された。ただ、取り付け部直下にコッキングハンドルが存在する基本構造は変わらないため、光学照準機は依然として実際の射線からやや高い位置に離れてしまう。
...
## 欠点と対処
  ...
  - 健康被害
    銃床に機構を組み込む構造故に射撃姿勢をとると顔の位置に機構が存在することになることで健康問題が生じた。
      - 呼吸器系
  ...
  - 弾の相性問題
    初期型のF1はアメリカ軍で使用されているM193弾を想定して設計されたために、標準仕様のNATO弾を使用すると薬莢がちぎれて動作不良を起こす危険がある。鉄製の薬莢のNATO弾を生産し、他国製のNATO弾の使用を禁じて応急対処を行った。後期モデルであるG2へのアップグレードで[STANAG マガジン対応に併せて標準NATO弾も使えるようにしたが](https://ja.wikipedia.org/wiki/STANAG_マガジン "wikilink")、依然F1も現役であるため鉄製薬莢はそのまま使われ続けている。

## バリエーション

[thumbに投影する機能が付与されたため](https://ja.wikipedia.org/wiki/ファイル:FELIN-openphotonet_PICT6047.jpg "wikilink")、遮蔽物に隠れたまま射撃する事も可能\]\]

  - F1
    スタンダードモデル。

      - F1 スナイパー
        キャリングハンドルを[AUGタイプの通常より一回り小さいマウントレールに変更したモデル](https://ja.wikipedia.org/wiki/ステアーAUG "wikilink")。
...
:: G2 コマンドにバーティカルグリップを付けたモデル。[二脚](../Page/二脚.md "wikilink")も外されている。
...
:; G2 スナイパー
  ...
  -
      ...
      -
        F1 スナイパーの[銃身延長モデル](https://ja.wikipedia.org/wiki/銃砲身 "wikilink")。

民生品としてフルオート、3点バーストを排除したものが[フランス](https://ja.wikipedia.org/wiki/フランス "wikilink")国内で300丁、北米用が300丁の計600丁のみ販売されていた。3点バーストの切り替えスイッチ自体は存在するが、機能しない。

## 画像

<File:FAMAS-G2-IMG> 8894-white.jpg|[銃剣](../Page/銃剣.md "wikilink")を装着したFA-MAS G2 <File:FAMAS-img> 1016.jpg|[二脚](../Page/二脚.md "wikilink")を展開した状態 <File:French> Soldier in Afghanistan MOD 45151395.jpg|光学機器を多数搭載したFA-MASを構えるフランス外人部隊兵 [File:Famas.jpg|展示されているFA-MAS](File:Famas.jpg%7C展示されているFA-MAS) <File:FAMAS-img> 1023.jpg|トリガーガードを外側に移動させた状態 [File:DjiboutiSoldats2.jpg|FA-MASを持つ](File:DjiboutiSoldats2.jpg%7CFA-MASを持つ)[ジブチ兵](https://ja.wikipedia.org/wiki/ジブチ軍 "wikilink") <File:FAMAS> Felin 501556 fh000002.jpg|FA-MAS Felin プロトタイプ <File:FAMAS> FELIN.jpg|電子光学機器を外して銃剣を付けたFA-MAS Felin <File:FAMAS-F1> vs G2.svg|FA-MAS F1とG2の比較図 <File:FAMAS-F1> firing APAV40.svg|[APAV40 ライフルグレネードを装着](https://ja.wikipedia.org/wiki/APAV40_ライフルグレネード "wikilink")
...
## 使用国
  ...
  -
  -
フランスおよび旧フランス領諸国以外の採用は、F1型が[アラブ首長国連邦軍](https://ja.wikipedia.org/wiki/アラブ首長国連邦軍 "wikilink")、G2型は[フィリピン](https://ja.wikipedia.org/wiki/フィリピン "wikilink")国家警察の[特殊部隊](../Page/特殊部隊.md "wikilink")[Special Action Forceに採用されている](https://ja.wikipedia.org/wiki/:en:Special_Action_Force "wikilink")。
...
:: 第44話に重武装[警官隊の装備としてG](../Page/警察官.md "wikilink")1が登場。[ホースオルフェノクと](https://ja.wikipedia.org/wiki/仮面ライダー555の登場キャラクター#主人公と主な関係者 "wikilink")[クレインオルフェノクに対して使用される](https://ja.wikipedia.org/wiki/仮面ライダー555の登場キャラクター#主人公と主な関係者 "wikilink")。
...
:; 『[仮面ライダーディケイド](https://ja.wikipedia.org/wiki/仮面ライダーディケイド "wikilink")』
  ...
  -
      ...
      -
        第12話に「[アギトの世界](https://ja.wikipedia.org/wiki/仮面ライダーディケイド#A.R.WORLD "wikilink")」の[警察](../Page/警察.md "wikilink")の装備としてG1が登場。警官隊が[神経断裂弾を装填し](https://ja.wikipedia.org/wiki/仮面ライダークウガ#設定 "wikilink")、未確認生命体に対して使用する。
...
### アニメ・漫画
  ...
  - 『[Project PAPO](../Page/Project_PAPO.md "wikilink")』
  ...
  - 『[クレヨンしんちゃん 電撃\!ブタのヒヅメ大作戦](../Page/クレヨンしんちゃん_電撃!ブタのヒヅメ大作戦.md "wikilink")』
    秘密組織「SML」の装備としてF1が登場。主要人物の1人である「SML」隊員の[コードネーム](../Page/コードネーム.md "wikilink")「筋肉」が、秘密結社「ブタのヒヅメ」の戦闘員たちに対して使用し、「ブタのヒヅメ」幹部のブレイドに対しては、弾切れを起こした上に素早いブレイドの攻撃で[マガジンを交換する暇がないことから](../Page/弾倉.md "wikilink")、そのまま[鈍器](https://ja.wikipedia.org/wiki/鈍器 "wikilink")として使用する。

  - 『[こちら葛飾区亀有公園前派出所](../Page/こちら葛飾区亀有公園前派出所.md "wikilink")』
    「ボルボ式射撃特訓の巻」に登場。

  - 『[遠い海から来たCOO](https://ja.wikipedia.org/wiki/遠い海から来たCOO#アニメーション映画 "wikilink")』
    [フランス軍](../Page/フランス軍.md "wikilink")の[特殊部隊](../Page/特殊部隊.md "wikilink")および水兵が使用する。また、特殊部隊から[鹵獲](../Page/鹵獲.md "wikilink")したものを主人公達も使用する。

  - 『[謎の老婆](https://ja.wikipedia.org/wiki/謎の老婆 "wikilink")』

### ゲーム

  - 『[Far Cry 3](https://ja.wikipedia.org/wiki/Far_Cry_3 "wikilink")』
    『[X operations](../Page/X_operations.md "wikilink")』
    「FAMAS」の名称で登場。装弾数は少ないが、連射速度が非常に高い。
...
:: [ロシア](../Page/ロシア.md "wikilink")[超国家主義](https://ja.wikipedia.org/wiki/超国家主義 "wikilink")派が使用する。3点バースト。

:; 『[CoD:BO](https://ja.wikipedia.org/wiki/コール_オブ_デューティ_ブラックオプス "wikilink")』

:: ハドソンら[CIAが使用する](../Page/中央情報局.md "wikilink")。しかし、ゲームの設定年代が[1960年代](../Page/1960年代.md "wikilink")なので本来は存在しない。

:; 『[CoD:BO3](https://ja.wikipedia.org/wiki/コール_オブ_デューティ_ブラックオプス3 "wikilink")』

:: 「FFAR」の名称で近代化改修を施したものが登場する。
...
:; 『[CoD:MW](https://ja.wikipedia.org/wiki/コール_オブ_デューティ_モダン・ウォーフェア "wikilink")』
  ...
  - 『[スペシャルフォース2](https://ja.wikipedia.org/wiki/スペシャルフォース2 "wikilink")』
    ...
    着剣状態のG2が「Sylph」の名称で登場。ただし、フォアエンドなど外見が若干アレンジされた架空銃である。[リーファの他](https://ja.wikipedia.org/wiki/ソードアート・オンラインの登場人物#リーファ "wikilink")、一部のムービーで[主人公も使用](https://ja.wikipedia.org/wiki/ソードアート・オンラインのコンピュータゲーム作品#主人公 "wikilink")。
...
::; 『[Project Reality（BF2）](https://ja.wikipedia.org/wiki/Project_Reality "wikilink")』
  ...
  -
      ...
      -
        [フランス軍](../Page/フランス軍.md "wikilink")の標準装備としてFA-MAS F1が登場。 スコープは・・Scrome J4からの選択。兵科によってはアイアンサイトも選択可能。
        FA-MAS用のライフルグレネードとして、対人用にAPAV-40を4発、対装甲用にAC-58を1発、煙幕弾にFUM-50を4発携行している。

:; 『[BF3](https://ja.wikipedia.org/wiki/バトルフィールド3 "wikilink")』

:: [DLC](https://ja.wikipedia.org/wiki/ダウンロードコンテンツ "wikilink")「Back to Karkand」にて実装。
...
:; 『[BFH](https://ja.wikipedia.org/wiki/バトルフィールド_ハードライン "wikilink")』
  ...
  - 『[フォートナイト](https://ja.wikipedia.org/wiki/フォートナイト_\(ゲーム\) "wikilink")』
    「バーストアサルトライフル」という名称で宝箱から入手可能。レアリティーは白、緑、青。一回のリロードで装填できる球数が20発になった。（シーズン3への移行で弱体化）現在は2点バーストになっている。（これもシーズン3への移行で弱体化）
  - 『[ドールズフロントライン](https://ja.wikipedia.org/wiki/ドールズフロントライン "wikilink")』
    星4戦術人形([萌え擬人化](../Page/萌え擬人化.md "wikilink"))として、「FAMAS」が登場。
