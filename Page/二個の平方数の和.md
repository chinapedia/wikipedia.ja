...
自然数を高々二個の平方数の和で表す方法の数は、[ヤコビの二平方定理](https://ja.wikipedia.org/wiki/ヤコビの二平方定理 "wikilink")
...
二個の平方数の和で表される自然数の分布について、いくつかの結果が知られている。 [エトムント・ランダウ](https://ja.wikipedia.org/wiki/エトムント・ランダウ "wikilink")と[シュリニヴァーサ・ラマヌジャン](../Page/シュリニヴァーサ・ラマヌジャン.md "wikilink")は独立に、 *x* 以下の自然数のうち二個の平方数の和で表される自然数の個数はある正の定数 *c* について漸近的に
