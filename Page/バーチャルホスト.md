...
1台の物理サーバコンピュータへの複数IPアドレス割り当ては、[NICを複数枚搭載するほかに](https://ja.wikipedia.org/wiki/ネットワークカード "wikilink")、「[IPエイリアス](https://ja.wikipedia.org/wiki/IPエイリアス "wikilink")」という機能によっても実現されている。
