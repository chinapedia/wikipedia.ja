...
\[{\nabla}^2 \psi = 0, \quad \Delta \psi = 0\] のようにも書かれる。ラプラス方程式の解は**[調和関数](https://ja.wikipedia.org/wiki/調和関数 "wikilink")**と呼ばれ、重力場や[静電場](https://ja.wikipedia.org/wiki/静電場 "wikilink")といった物理的な[ベクトル場](https://ja.wikipedia.org/wiki/ベクトル場 "wikilink")の[ポテンシャル](../Page/ポテンシャル.md "wikilink")を与える。
...
**[拡散方程式](https://ja.wikipedia.org/wiki/拡散方程式 "wikilink")**は与えられた領域において時間とともに変化する場を記述する[放物型偏微分方程式](https://ja.wikipedia.org/wiki/放物型偏微分方程式 "wikilink")で、
...
線型偏微分方程式は[基底関数](https://ja.wikipedia.org/wiki/基底関数 "wikilink")の集合で未知関数を展開することにより一般的に解かれる事が多い（たとえば[正弦波](https://ja.wikipedia.org/wiki/正弦波 "wikilink")関数を使った[フーリエ級数](https://ja.wikipedia.org/wiki/フーリエ級数 "wikilink")展開\[10\]）。展開した個々の解の[線型結合](../Page/線型結合.md "wikilink")がもとの方程式の解である。[変数分離法](https://ja.wikipedia.org/wiki/変数分離法 "wikilink")はいくつかの重要な特別の応用をもつ。
...
ある場合には、偏微分方程式は解が、解の知られているある方程式の修正であると考えることで[摂動](../Page/摂動.md "wikilink")解析によって解くことが出来る。別な方法として、単純な[有限差分スキーム](https://ja.wikipedia.org/wiki/差分法 "wikilink") \[12\]\[13\]から複雑な[マルチグリッド法](https://ja.wikipedia.org/wiki/マルチグリッド法 "wikilink")や[有限要素法](../Page/有限要素法.md "wikilink")\[14\]\[15\]\[16\]に至るまでの[数値解析](https://ja.wikipedia.org/wiki/数値解析 "wikilink")の手法が挙げられる。 科学や工学における多くの興味深い問題は[スーパーコンピュータ](../Page/スーパーコンピュータ.md "wikilink")や[高性能計算](https://ja.wikipedia.org/wiki/高性能計算 "wikilink")、[任意精度演算](https://ja.wikipedia.org/wiki/任意精度演算 "wikilink")などを用いてこのような方法で解かれる\[17\]\[18\]\[19\]。
...
## 関連項目
  ...
  - [積分方程式](https://ja.wikipedia.org/wiki/積分方程式 "wikilink")
...
#### 日本
  ...
  - [溝畑茂](https://ja.wikipedia.org/wiki/溝畑茂 "wikilink")
...
### 和書
  ...
  -
  -
  - 熊ノ郷準. (1978). 偏微分方程式. [共立出版](https://ja.wikipedia.org/wiki/共立出版 "wikilink").

  - 偏微分方程式入門、金子晃、[東京大学出版会](https://ja.wikipedia.org/wiki/東京大学出版会 "wikilink")、1998/02。

  - 楕円型・放物型偏微分方程式 (岩波オンデマンドブックス) 村田實、倉田和浩、[岩波書店](../Page/岩波書店.md "wikilink")、2016/12。

  - 偏微分方程式　科学者・技術者のための使いかたと解き方、スタンリー・ファーロウ著　[伊理正夫](https://ja.wikipedia.org/wiki/伊理正夫 "wikilink")・伊理由美訳、[朝倉書店](https://ja.wikipedia.org/wiki/朝倉書店 "wikilink")。

  - 偏微分方程式とフーリエ解析、東京大学基礎工学双書、田辺行人・高見頴郎監修／中村宏樹　著、[東京大学出版会](https://ja.wikipedia.org/wiki/東京大学出版会 "wikilink")。

  - 柴田良弘, & 久保隆徹. (2012). 非線形偏微分方程式. [朝倉書店](https://ja.wikipedia.org/wiki/朝倉書店 "wikilink").

### 洋書

  - Partial Differential Equations (Graduate Studies in Mathematics) Lawrence C. Evans, [American Mathematical Society](https://ja.wikipedia.org/wiki/アメリカ数学会 "wikilink"), 2010/04/.
...
1.  R. Courant, D. Hilbert, ''Methoden Der Mathematischen Physik '', [R. クーラン](https://ja.wikipedia.org/wiki/リヒャルト・クーラント "wikilink"), [D. ヒルベルト](../Page/ダフィット・ヒルベルト.md "wikilink") (著), 丸山 滋弥, 斎藤 利弥 (翻訳)『[数理物理学](https://ja.wikipedia.org/wiki/数理物理学 "wikilink")の方法』[東京図書](https://ja.wikipedia.org/wiki/東京図書 "wikilink")
2.  恒藤敏彦『弾性体と流体』[岩波書店](../Page/岩波書店.md "wikilink")〈物理入門コース 8〉、1983年。。
3.  際本泰士『振動・波動論講義―物理実験を取り入れて』コロナ社、2005年。。
4.  シュレーディンガー方程式I, II (朝倉数学大系) by [谷島賢二](https://ja.wikipedia.org/wiki/谷島賢二 "wikilink") (著), [砂田利一](https://ja.wikipedia.org/wiki/砂田利一 "wikilink") (編集), [増田久弥](https://ja.wikipedia.org/wiki/増田久弥 "wikilink") (編集), 堀田良之 (編集), [朝倉書店](https://ja.wikipedia.org/wiki/朝倉書店 "wikilink").
...
11. [広田良吾](https://ja.wikipedia.org/wiki/広田良吾 "wikilink")『直接法によるソリトンの数理』（[岩波書店](../Page/岩波書店.md "wikilink")、1992年）
...
15. 菊池文雄. (1999). 有限要素法概説 \[新訂版\]. [サイエンス社](https://ja.wikipedia.org/wiki/サイエンス社 "wikilink").
16. 菊池文雄. (1994). 有限要素法の数理. [培風館](https://ja.wikipedia.org/wiki/培風館 "wikilink").
17. 田端正久; 偏微分方程式の[数値解析](https://ja.wikipedia.org/wiki/数値解析 "wikilink"), 2010. [岩波書店](../Page/岩波書店.md "wikilink").
18. 偏微分方程式の数値解法, 編集委員: [伊理正夫](https://ja.wikipedia.org/wiki/伊理正夫 "wikilink")・[杉原厚吉](https://ja.wikipedia.org/wiki/杉原厚吉 "wikilink")・[速水謙](https://ja.wikipedia.org/wiki/速水謙 "wikilink")・今井浩, 神谷紀生 & 北栄輔著, 工系数学講座　第11巻,978-4-320-01610-1, 1998年03月, [共立出版](https://ja.wikipedia.org/wiki/共立出版 "wikilink").
19. 登坂宣好, & 大西和榮. (2003). 偏微分方程式の数値シミュレーション. [東京大学出版会](https://ja.wikipedia.org/wiki/東京大学出版会 "wikilink").