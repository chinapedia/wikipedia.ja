...
1997年にリリースされた当初は[MS-DOS](../Page/MS-DOS.md "wikilink")版として開発されていたが、年内には[Macintosh](../Page/Macintosh.md "wikilink") (**MacMAME**)、[Unix系](../Page/Unix系.md "wikilink")OS (**X/MAME**)、Windows (**MAME32**)に移植された\[3\]。また、1998年には、MAME 0.33のベータ版を基にして、汎用エミュレーターである**MESS**（Multi Emulator Super System）の開発が始まった。2003年よりCPUエミュレーションのが追加されはじめた\[4\]。2005年、MAME 0.99u2で、ギャンブルゲームを実装する**AGEMAME** (旧**MAGE**)がMAMEに統合されはじめた\[5\]。2007年、MAME 0.120でWindows 64bit版が公式に用意された\[6\]。

2010年、MAME 0.136u1で、[SDL](../Page/SDL.md "wikilink")採用のクロスプラットフォームなコマンドライン版である**SDLMAME**がMAMEに統合された\[7\]。2011年、MAME 0.141u1で、ピンボールを実装する**PINMAME**がMAMEに統合されはじめた\[8\]。2012年、MAME 0.146u4でによる[電子回路シミュレーション](https://ja.wikipedia.org/wiki/電子回路シミュレーション "wikilink")に対応した\[9\]。同年、MAME 0.147でMESSのコードベースが統合され、MESSとMAMEの統合版として**UME**（Universal Machine Emulator）がビルドできるようになった。

2015年のMAME 0.162で、MAMEはMESSを吸収してUME相当となった。同年、MAME 0.168でMAMEをJavaScriptへとコンパイルしてWeb上で動かす**JSMESS**がMAMEのコードベースに統合された\[10\]\[11\]。更に同年、MAME 0.171で独自インターフェースの**MEWUI**がMAMEのコードベースに統合された\[12\]ほか、派生版のみに実装されていたAuto-fireに対応し\[13\]\[14\]、また、GPUバックエンドのBGFXが追加された\[15\]。

2016年、MAME 0.172でライセンスが一般的な[オープンソース](../Page/オープンソース.md "wikilink")ライセンスのGPLとなった\[16\]。また、ハイスコアが再実装されたほか、CRTモニタ向けの**GroovyMAME**の拡大縮小周りが統合された\[17\]。同年、MAME 0.177でVGM形式の音源を再生するための、VGM Playerが搭載された。2019年、MAME 0.216でレイテンシを削減する「-lowlatency」オプションが追加された\[18\]。

## 動作

MAMEの動作には、実際の基板上のデータイメージ（ROMイメージ）を用意する必要がある。MAMEは基板のハードウェア構成をソフトウェアでエミュレートすることにより、オリジナルのROMイメージを異なるハードウェア上で動作させることを可能にしている。エミュレートする[CPU](../Page/CPU.md "wikilink")/[MPUは代表的な](../Page/マイクロプロセッサ.md "wikilink")[Z80](../Page/Z80.md "wikilink")や[68000](https://ja.wikipedia.org/wiki/68000 "wikilink")をはじめとして100種類以上、サウンドチップ/[DSPは](../Page/デジタルシグナルプロセッサ.md "wikilink")70種類以上、そのほか多くの[カスタムチップ](https://ja.wikipedia.org/wiki/カスタムチップ "wikilink")もサポートする。また一部のアナログICや[アナログ素子もNetlistでサポートしている](https://ja.wikipedia.org/wiki/アナログ回路#用いられる素子 "wikilink")。
...
以前のMAMEは商用利用を禁止していたが、度々それに違反した利用が発覚している。
  ...
  - 200in1等を謳う製造者不明なエミュ筐体，エミュ台（アーケードゲーム筐体として流通）
...
1.  [Emscripten Javascript and HTML](https://docs.mamedev.org/initialsetup/compilingmame.html#emscripten-javascript-and-html) MAMEdev Team
2.  [3D artwork system \#388](https://github.com/mamedev/mame/issues/388)
3.  [MAME Project History](http://mamedev.org/history.html) MAME project
4.
5.
6.
7.
8.
9.
10. [0.168](https://www.mamedev.org/releases/whatsnew_0168.txt) MAME project 2015年
11. [JSMESS](https://github.com/jsmess/jsmess) JSMESS project
12. [0.171](https://www.mamedev.org/releases/whatsnew_0171.txt) MAME project 2015年
13. [MAMEUIFX v0.171](http://www.emucr.com/2016/02/mameuifx-v0171.html) EmuCR.Com 2016年2月25日
14.
15.
16. [MAME 0.172](https://www.mamedev.org/?p=424) MAME project 2016年3月30日
17. [MAME 0.172](http://mamedev.org/?p=424) MAME project 2016年3月30日
18. [0.216](https://www.mamedev.org/releases/whatsnew_0216.txt) MAME project 2019年11月27日