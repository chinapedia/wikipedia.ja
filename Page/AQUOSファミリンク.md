...
ビエラリンク同様対応機器をHDMIケーブル一本で接続するだけで、映像と音声の出力以外に、対応機器のリモコン一台で他の接続機器の操作が出来る。他の接続機器の操作方法はビエラリンクと似ているが、ビエラリンクとはコンセプトが異なり、[GUIを見ながらテレビのリモコンを活用するビエラリンクに対し](https://ja.wikipedia.org/wiki/グラフィカルユーザインタフェース "wikilink")、AQUOSファミリンクはレコーダーの「ファミリモコン」でのダイレクト操作で他の接続機器の動作ができるようにしている。
...
[Category:インタフェース規格](https://ja.wikipedia.org/wiki/Category:インタフェース規格 "wikilink") [Category:AV機器](https://ja.wikipedia.org/wiki/Category:AV機器 "wikilink") [Category:シャープ](https://ja.wikipedia.org/wiki/Category:シャープ "wikilink")