> この記事は[UnEditor](https://ja.wikipedia.org/wiki/UnEditor)から翻訳されています。
...
なお、HTML編集機能、内蔵ブラウザ機能、一部表示テーマなどを削った簡易版である**DeuxEditor**も公開されている。
...
## 関連項目
  ...
  - [J-cref](../Page/J-cref.md "wikilink") - タブエディタ
  - [テキストエディタの一覧](https://ja.wikipedia.org/wiki/テキストエディタの一覧 "wikilink")

## 外部リンク

[YokkaSoft Webpage（作者のホームページ）](http://www.yokkasoft.net/)
