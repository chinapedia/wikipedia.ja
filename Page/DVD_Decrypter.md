> この記事は[DVD Decrypter](https://ja.wikipedia.org/wiki/DVD_Decrypter)から翻訳されています。


**DVD Decrypter** （ディーブイディー・デクリプター）は、[DVD](../Page/DVD.md "wikilink") の[ディスクイメージを抽出](https://ja.wikipedia.org/wiki/ディスクドライブ仮想化ソフト#イメージファイル "wikilink")（[リッピング](../Page/リッピング.md "wikilink")）することができる[フリーウェア](../Page/フリーウェア.md "wikilink")。[Microsoft Windows](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink") 上で動作する。主に [DVD-Video](../Page/DVD-Video.md "wikilink") の[バックアップ](../Page/バックアップ.md "wikilink")を取るために使う。

[ノルウェー](../Page/ノルウェー.md "wikilink")の[ヨン・ヨハンセン](https://ja.wikipedia.org/wiki/ヨン・ヨハンセン "wikilink")が[1999年](../Page/1999年.md "wikilink")に開発した [DeCSS](../Page/DeCSS.md "wikilink") を元にした [CSS](../Page/Content_Scramble_System.md "wikilink") 解除機能を実装しているため、CSS による暗号化をデコードした上でディスクイメージを抽出できる。またこのソフトウェアには [ISO](../Page/ISO_9660.md "wikilink") 等のイメージの DVD メディア書き込み機能や、ディスクイメージの（リージョンコードエンハンスメントの除去を含む）[リージョンコード変更ツール](https://ja.wikipedia.org/wiki/DVD-Video#リージョンコード "wikilink")、ユーザ操作禁止項目除去ツールなどが付属している。
...
DVD-Video をリッピングして[ハードディスクドライブ](https://ja.wikipedia.org/wiki/ハードディスクドライブ "wikilink")に記録された[ISOイメージ](https://ja.wikipedia.org/wiki/ISOイメージ "wikilink")は、DVD メディアに書き込まなくても[仮想 CD/DVD-ROM ドライブ作成ソフトを用いて](../Page/ディスクドライブ仮想化ソフト.md "wikilink")[Windows Media Player](../Page/Windows_Media_Player.md "wikilink") など[メディアプレーヤー](../Page/メディアプレーヤー.md "wikilink")で再生することができる。
...
## 関連項目
  ...
  - [ImgBurn](../Page/ImgBurn.md "wikilink") - DVD Decrypter作者による後継ソフト。ただし、CSS等解除機能は有しない。
  - [マクロビジョン](https://ja.wikipedia.org/wiki/マクロビジョン "wikilink")
...
[Category:フリーウェア](https://ja.wikipedia.org/wiki/Category:フリーウェア "wikilink") [Category:ライティングソフト](https://ja.wikipedia.org/wiki/Category:ライティングソフト "wikilink") [Category:DVD関連のソフト](https://ja.wikipedia.org/wiki/Category:DVD関連のソフト "wikilink") [Category:DVDリッパー](https://ja.wikipedia.org/wiki/Category:DVDリッパー "wikilink")
