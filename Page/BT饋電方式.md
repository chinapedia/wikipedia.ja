...
誘導障害打ち消しのため、相互に逆向きである帰線電流と架線電流を接近配置させて電磁誘導を相殺して通信障害を抑制することが考えられて、レールの帰線電流を、架線直近の帰線用の電線（負饋電線と称する）に吸い上げる方式として、[巻線](../Page/巻線.md "wikilink")比が1:1で極性が互いに逆方向の**吸上変圧器**（BT: Booster transformer; 以下、吸上変圧器をBTと略する）を、約4 [kmごとに並べ](../Page/キロメートル.md "wikilink")、BTを介してレールに流れる帰線電流を負饋電線に排流するシステムである。BTの働きにより架線電流と負饋電線の電流とは互いに逆方向でかつその絶対値は一致することから誘導障害の大幅な減少が見込まれるシステムである。

架線電流を吸上変圧器の巻線に接続する関係からBTのところで架線を電気的に[絶縁する必要が生じる](https://ja.wikipedia.org/wiki/絶縁_\(電気\) "wikilink")。この絶縁を「ブースターセクション」と呼ぶ。BT一次側の二つの端子を、絶縁されたそれぞれの架線端に接続する。これにより、BTは架線と**[直列](https://ja.wikipedia.org/wiki/直列 "wikilink")に**接続される。BTの二次側も負饋電線へ直列に挿入し、[変電所](https://ja.wikipedia.org/wiki/変電所 "wikilink")から遠い方の二次端子をレールに接続する。すると、架線から車両に向けて流れる電流はBTの一次側を通り、BTの巻数比は1:1であるから、それと同じ大きさの電流が、BTによって強制的にレールから負饋電線に吸い上げられるため、車両から変電所に帰る電流は必ず負饋電線を通ることになる。同時にレールを流れる電流は直近のBTにて吸い上げられるのでレールの[電位](../Page/電位.md "wikilink")上昇を抑えることも可能になる。交流電化の線路ではレールは漏れ電流を少なくする目的で[道床](https://ja.wikipedia.org/wiki/道床 "wikilink")と絶縁体を挟んで締結してあるので、レールを流れる帰線電流は大地に「寄り道せず」、高々1セクションしか帰線電流は流れずBTを介して負饋電線に「吸い上げられる」ことになる。

[thumb](https://ja.wikipedia.org/wiki/ファイル:BT-Feeding.png "wikilink")
...
なお、[東北](https://ja.wikipedia.org/wiki/東北新幹線 "wikilink")・[上越新幹線](https://ja.wikipedia.org/wiki/上越新幹線 "wikilink")の開業にあたって製造された初期の[200系は](../Page/新幹線200系電車.md "wikilink")、特に上越新幹線や将来の[北海道新幹線](https://ja.wikipedia.org/wiki/北海道新幹線 "wikilink")への延伸など、重耐雪装備を考慮した形式だったため、架線への着氷を考慮して0系同様ユニット毎のパンタグラフ設置（12Mで6基）となっていた。しかし営業運転速度の向上に伴う騒音対策（パンタグラフの実使用数の削減）のため、200系1000番台以降では、その後の[E1系などの新型車両のように](../Page/新幹線E1系電車.md "wikilink")、[特高圧引通線](../Page/特高圧引通線.md "wikilink")の採用によってパンタグラフの数を削減している。
...
## 外部リンク
  ...
  - [AT/BT饋電](http://jtqsw192.nobody.jp/FIG/600ac_fd/at_feed.htm)（鉄道解析ごっこ）

[Category:鉄道の電化](https://ja.wikipedia.org/wiki/Category:鉄道の電化 "wikilink") [Category:電力機器](https://ja.wikipedia.org/wiki/Category:電力機器 "wikilink") [Category:配電](https://ja.wikipedia.org/wiki/Category:配電 "wikilink")

1.  しかしながら架線断線事故は防ぎきれなかった
2.  通常時の対地電圧は架線電圧と同じだが、事故時には架線電圧の2倍の電圧がかかる。それを防ぐ変電所の変圧器巻線も考案されたが、構造が複雑になりすぎ、超高圧で受電する現代の変電所設備ではそうした構造はとりづらい。