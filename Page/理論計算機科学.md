...
この分野のテーマの例を以下に挙げる（特に意図や理由のある選出ではない）。
  ...
  - [プログラム意味論](https://ja.wikipedia.org/wiki/プログラム意味論 "wikilink"): [プログラムあるいは](../Page/プログラム_\(コンピュータ\).md "wikilink")[プログラミング言語](../Page/プログラミング言語.md "wikilink")の[形式意味論](https://ja.wikipedia.org/wiki/形式意味論 "wikilink")
...
ACMの学術誌 Transactions on Computation Theory ではこの一覧にさらに[符号理論](../Page/符号理論.md "wikilink")とを加え、[データベース](../Page/データベース.md "wikilink")、[情報検索](https://ja.wikipedia.org/wiki/情報検索 "wikilink")、経済モデル、[ネットワークなどの理論計算機科学的側面をも含めている](https://ja.wikipedia.org/wiki/コンピュータネットワーク "wikilink")\[2\]。このように範囲は広いが、計算機科学の理論畑の人間は応用畑とは違うという意識を持っていることがあり、「[コンピューティング](https://ja.wikipedia.org/wiki/コンピューティング "wikilink")を支えている（より基本的な）科学」を研究しているという意識をもっていることがある\[3\]。これは必ずしも対立を意味するものではなく、むしろ協力関係にあることを意味する。
...
| [数理論理学](../Page/数理論理学.md "wikilink") | [オートマトン](https://ja.wikipedia.org/wiki/オートマトン "wikilink")                                | [数論](../Page/数論.md "wikilink")                                                | [グラフ理論](../Page/グラフ理論.md "wikilink")                                |
...
| [型理論](../Page/型理論.md "wikilink")     | [圏論](https://ja.wikipedia.org/wiki/圏論 "wikilink")                                        | [計算幾何学](https://ja.wikipedia.org/wiki/計算幾何学 "wikilink")                       | [量子計算](../Page/量子コンピュータ.md "wikilink")                              |

## 歴史

アルゴリズムは何千年も前から存在していたが（例えば、2つの数の[最大公約数](../Page/最大公約数.md "wikilink")を求める[ユークリッドの互除法](../Page/ユークリッドの互除法.md "wikilink")は今も使われている）、計算におけるアルゴリズムの定義を定式化したのは[アラン・チューリング](../Page/アラン・チューリング.md "wikilink")、[アロンゾ・チャーチ](https://ja.wikipedia.org/wiki/アロンゾ・チャーチ "wikilink")、[スティーヴン・クリーネで](https://ja.wikipedia.org/wiki/スティーヴン・コール・クリーネ "wikilink")、1938年のことである。一方、[二進法](../Page/二進法.md "wikilink")と数学の[形式体系](../Page/形式体系.md "wikilink")はそれ以前からあり、[ゴットフリート・ライプニッツ](../Page/ゴットフリート・ライプニッツ.md "wikilink")が17世紀に二進法を数学的に定式化し、19世紀に[ジョージ・ブール](https://ja.wikipedia.org/wiki/ジョージ・ブール "wikilink")が[ブール論理](../Page/ブール論理.md "wikilink")/[ブール代数](../Page/ブール代数.md "wikilink")を定式化した。論理的推論と数学的証明は古代から存在したが、1931年[クルト・ゲーデル](https://ja.wikipedia.org/wiki/クルト・ゲーデル "wikilink")は自身の[不完全性定理で](../Page/ゲーデルの不完全性定理.md "wikilink")、公理体系には証明できない限界が存在することを証明した。

それらの発展が[論理学](../Page/論理学.md "wikilink")や[計算可能性](https://ja.wikipedia.org/wiki/計算可能性 "wikilink")の現代的研究をもたらし、全体として理論計算機科学という分野を生み出した。1948年、[クロード・シャノン](../Page/クロード・シャノン.md "wikilink")による『[通信の数学的理論](https://ja.wikipedia.org/wiki/通信の数学的理論 "wikilink")』から生まれた[情報理論](../Page/情報理論.md "wikilink")がこれに加わった。同じ頃[ドナルド・ヘッブ](https://ja.wikipedia.org/wiki/ドナルド・ヘッブ "wikilink")が脳における学習の[数学的モデルを導入した](https://ja.wikipedia.org/wiki/ヘッブの法則 "wikilink")。生物学的データがこの仮説を裏付けつつ、若干の修正が行われていき、[ニューラルネットワーク](../Page/ニューラルネットワーク.md "wikilink")と[並行分散処理が確立された](https://ja.wikipedia.org/wiki/コネクショニズム "wikilink")。
...
## 参考文献
  ...
  - Martin Davis, Ron Sigal, Elaine J. Weyuker, *Computability, complexity, and languages: fundamentals of theoretical computer science*, 2nd ed., Academic Press, 1994, ISBN 0122063821. - [計算理論](../Page/計算理論.md "wikilink")を中心に[プログラム意味論](https://ja.wikipedia.org/wiki/プログラム意味論 "wikilink")なども扱っている。
...
## 外部リンク
  ...
  - [Theory of Computation](http://theory.csail.mit.edu/) [MITコンピュータ科学・人工知能研究所](https://ja.wikipedia.org/wiki/MITコンピュータ科学・人工知能研究所 "wikilink")
