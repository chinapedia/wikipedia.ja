...
5.  **わがままジュリエット**
    ...
    <!-- end list -->
      -
        大部分はプロモーションビデオの映像で、ライヴの映像は最後の方のみ収録されている。
6.  **LIKE A CHILD**
      - 作詞：[松井恒松](https://ja.wikipedia.org/wiki/松井恒松 "wikilink")／作曲・編曲：布袋寅泰
    <!-- end list -->
      -
        松井はこの曲でシンセベースとしてキーボード（[ヤマハ](../Page/ヤマハ.md "wikilink")・[DX7](https://ja.wikipedia.org/wiki/DX7 "wikilink")）を使用している。
7.  **ミス・ミステリー・レディー**
      - 作詞：氷室京介／作曲・編曲：布袋寅泰
    <!-- end list -->
      -
