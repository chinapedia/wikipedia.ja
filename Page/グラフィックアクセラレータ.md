...
特に[1990年代](../Page/1990年代.md "wikilink")前半、[日本](https://ja.wikipedia.org/wiki/日本 "wikilink")で主力であった[PC-9800](../Page/PC-9800シリーズ.md "wikilink")/[9821シリーズにおいて](../Page/PC-9821シリーズ.md "wikilink")、[オンボード](../Page/オンボード.md "wikilink")のグラフィック性能は、当時急速に普及しつつあった[Windowsの](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")[GUIを描画するのに](https://ja.wikipedia.org/wiki/グラフィカルユーザインタフェース "wikilink")[解像度](https://ja.wikipedia.org/wiki/解像度 "wikilink")、色数の点で貧弱であったため、[NECおよび](../Page/日本電気.md "wikilink")[サードパーティー](https://ja.wikipedia.org/wiki/サードパーティー "wikilink")から、Windows使用時の描画性能を向上させるグラフィックアクセラレータがリリースされ、この辺りからウィンドウアクセラレータの呼称が使用されだした。

[PC/AT互換機](https://ja.wikipedia.org/wiki/PC/AT互換機 "wikilink")用のウィンドウアクセラレータとしては、[S3社](../Page/S3_Graphics.md "wikilink")（現SONIC Blue社、チップ開発部門は[VIA Technologies社に売却](../Page/VIA_Technologies.md "wikilink")）のS3-911が先鞭をつけ、S3-924の世代において、Windows 3.1のGDI全てを[ハードウェア](../Page/ハードウェア.md "wikilink")で描画できるように[実装](https://ja.wikipedia.org/wiki/実装 "wikilink")が完了している。[Windows 95登場後](../Page/Microsoft_Windows_95.md "wikilink")、[DirectXがWindowsに実装されるまでは特に変化の無い市場であったが](https://ja.wikipedia.org/wiki/Microsoft_DirectX "wikilink")、それ以後は開発競争が再燃し、高速化、高解像度化、動画再生支援機能、[3D描画機能を実装したものが次々と販売されていった](../Page/3次元コンピュータグラフィックス.md "wikilink")。
...
また機種固有の事情としては、IBM PCはグラフィック機能を[ビデオカード](../Page/ビデオカード.md "wikilink")に独立させ、柔軟に機能向上があったのと比較し、NEC PC-9801は登場時点からすれば比較的高機能ではあったものの、仕様がほぼ固定してしまっていたため、サードパーティー製のグラフィックアクセラレータである GA-1024A が、[美少女ゲーム](https://ja.wikipedia.org/wiki/美少女ゲーム "wikilink")を256色で遊ぶために人気となる、などといった現象を起こしており、前節の「ウィンドウアクセラレータ」なる商品が現れたのも、結局のところそのような「PC-98の特殊事情」であると考えたほうが正直な所であろう。
...
## 関連事項
  ...
  - [VDP](https://ja.wikipedia.org/wiki/VDP "wikilink")
