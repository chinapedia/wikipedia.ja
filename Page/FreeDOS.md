...
FreeDOSは、MS-DOSとほぼ100%の互換性をもっており、従来MS-DOS上で動いていた旧式の[Microsoft Windowsである](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")[Windows 1.0](../Page/Microsoft_Windows_1.0.md "wikilink")/[Windows 2.0](../Page/Microsoft_Windows_2.0.md "wikilink")/[Windows 3.xシステムもFreeDOS上で動作する](../Page/Microsoft_Windows_3.x.md "wikilink")。
