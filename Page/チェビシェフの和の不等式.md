> この記事は[チェビシェフの和の不等式](https://ja.wikipedia.org/wiki/チェビシェフの和の不等式)から翻訳されています。


**チェビシェフの和の不等式**（チェビシェフのわのふとうしき、）は、[パフヌティ・チェビシェフ](../Page/パフヌティ・チェビシェフ.md "wikilink")の名にちなんだ[不等式](../Page/不等式.md "wikilink")である。
...
*f* および *g* を区間 \[0, 1\] で[積分](https://ja.wikipedia.org/wiki/積分 "wikilink")可能な実数値[関数とし](../Page/関数_\(数学\).md "wikilink")、ともに[単調増加もしくは単調減少であると仮定する](https://ja.wikipedia.org/wiki/単調関数 "wikilink")。このとき、
