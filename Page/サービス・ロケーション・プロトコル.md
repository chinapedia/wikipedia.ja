> この記事は[サービス・ロケーション・プロトコル](https://ja.wikipedia.org/wiki/サービス・ロケーション・プロトコル)から翻訳されています。
...
`               SLPBoolean  fresh,`
`               SLPRegReport callback,           // 操作終了時に呼ばれる`[`コールバック`](../Page/コールバック_\(情報工学\).md "wikilink")
...
[Mac OSでは初期のバージョンから](https://ja.wikipedia.org/wiki/Mac_OS "wikilink")[AppleTalk](../Page/AppleTalk.md "wikilink")によりサービス発見が可能であったが、Mac OS 8.5からSLP Version 1も採用された。Mac OS 9ではSLP Version 2に移行した。[Mac OS X v10.2 Jaguarからは](../Page/Mac_OS_X_v10.2.md "wikilink")[Rendezvous(Bonjour)も実装されたためSLPの重要性が希薄になり](../Page/Bonjour.md "wikilink")、[Mac OS X 10.5 LeopardでSLPは廃止された](../Page/Mac_OS_X_v10.5.md "wikilink")。
