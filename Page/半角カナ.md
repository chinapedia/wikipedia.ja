...
[Unicode](../Page/Unicode.md "wikilink")では、全角片仮名 (Fullwidth Katakana) と半角片仮名 (Halfwidth Katakana) が異なる文字として登録されている。類似物として、Unicodeには半角[ハングル](https://ja.wikipedia.org/wiki/ハングル "wikilink") (Halfwidth Hangul) も登録されている。これらの半角文字は、Halfwidth and Fullwidth Forms（U+FF00–FFEF）に入っている。
...
[Unicode](../Page/Unicode.md "wikilink")や[JIS X 0213ではHalfwidth](../Page/JIS_X_0213.md "wikilink") Katakana（半角片仮名）として表記され、これが正式な呼称である。
