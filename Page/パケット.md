...
パケット単位で小分けにして通信を行うことにより、回線を連続して占有することができないため、複数の端末からの送受信データを1本の回線に集められる（[多重化](https://ja.wikipedia.org/wiki/多重化 "wikilink")）、大容量のデータのうち１か所が破損・喪失した際に、ひとつのパケットを[再送](https://ja.wikipedia.org/wiki/再送 "wikilink")するだけで足りる等の利点がある。

## 概要

パケットは、[ISO](https://ja.wikipedia.org/wiki/ISO "wikilink")の[OSI参照モデル](../Page/OSI参照モデル.md "wikilink")では[ネットワーク層](https://ja.wikipedia.org/wiki/ネットワーク層 "wikilink") (Layer 3、[RFC 1122におけるインターネットレイヤ](https://ja.wikipedia.org/wiki/インターネット・プロトコル・スイート "wikilink"))において、通信を行う際の転送単位である。パケットの[ヘッダには](https://ja.wikipedia.org/wiki/ヘッダ_\(コンピュータ\) "wikilink")、送信先・発信元の[IPアドレス](../Page/IPアドレス.md "wikilink")や、パケットの種類や通し番号等の制御情報とユーザデータが記録されており、[ルータはその情報を参照してパケットの振り分けを行う](../Page/ルーター.md "wikilink")。
...
[フレームは](https://ja.wikipedia.org/wiki/フレーム_\(ネットワーク\) "wikilink")、[OSI参照モデル](../Page/OSI参照モデル.md "wikilink")の[データリンク層](https://ja.wikipedia.org/wiki/データリンク層 "wikilink") (Layer 2) の通信で使われるPDUの呼び名である\[5\]。

[フレームリレー](https://ja.wikipedia.org/wiki/フレームリレー "wikilink")のように第3層を含めて使われることもある\[6\]。

[MACフレーム](../Page/MACアドレス.md "wikilink")、[PPPフレーム](https://ja.wikipedia.org/wiki/Point-to-Point_Protocol "wikilink")、[HDLCフレーム等も使われる](https://ja.wikipedia.org/wiki/High-Level_Data_Link_Control "wikilink")。

### パケット

パケットは、[OSI参照モデル](../Page/OSI参照モデル.md "wikilink")の[ネットワーク層](https://ja.wikipedia.org/wiki/ネットワーク層 "wikilink") (Layer 3) の通信で使われるPDUの呼び名である\[7\]。
...
一般的には、これらの用語は、それほど厳密に区別されずに使われている。単にデータを送る単位の意味としてパケットという表現が使われることが多い。 [データリンク層](https://ja.wikipedia.org/wiki/データリンク層 "wikilink") (Layer 2)のデータはフレームで、[ネットワーク層](https://ja.wikipedia.org/wiki/ネットワーク層 "wikilink") (Layer 3)以上のデータはパケットと呼ぶこともある（MACフレームやTCPセグメントのことをパケットと呼ぶなど）\[8\]。

## 課金単位としてのパケット

日本で[移動体通信](https://ja.wikipedia.org/wiki/移動体通信 "wikilink")事業を行う事業者では、[携帯電話](../Page/携帯電話.md "wikilink")や[PHS](../Page/PHS.md "wikilink")での[無線パケット通信](https://ja.wikipedia.org/wiki/無線パケット通信 "wikilink")（データ通信）の利用料金を算出する際に、積算通信量を表す単位として「パケット」という語を用いる。1パケットは128[バイト](../Page/バイト_\(情報\).md "wikilink")\[9\]\[10\]\[11\]であり、これは[全角文字](../Page/マルチバイト文字.md "wikilink")64字に相当する。
...
2.  OSI参照モデルでは、第2層 データリンク層。RFC 1122では、[リンク層](https://ja.wikipedia.org/wiki/リンク層 "wikilink")
