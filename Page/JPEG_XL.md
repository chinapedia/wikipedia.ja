...
、[リファレンス実装](../Page/リファレンス実装.md "wikilink")が公開された。これは[C++](../Page/C++.md "wikilink")で実装されており、[フリーかつオープンソースであり](https://ja.wikipedia.org/wiki/FLOSS "wikilink")、[Apache License 2.0の下で配布されている](https://ja.wikipedia.org/wiki/Apache_License_2.0 "wikilink")\[10\]。
