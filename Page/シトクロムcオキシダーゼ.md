...
反応の概要：
  ...
  -
    <ce>4 </ce>フェロシトクロム<ce> c\\ + 8H^+{}_{in}\\ + O2 -\> 4 </ce>フェリシトクロム<ce> c\\ + 2H2O\\ + 4H^+{}_{out}</ce>

ここで、

  -
    フェロシトクロム<ce> c</ce> = <ce>Fe^{2+}{-}</ce>シトクロム<ce> c</ce>
    フェリシトクロム<ce> c</ce> = <ce>Fe^{3+}{-}</ce>シトクロム<ce> c</ce>
