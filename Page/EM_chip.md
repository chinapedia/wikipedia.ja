...
[Y\!mobile](https://ja.wikipedia.org/wiki/Y!mobile "wikilink")ブランドが[ソフトバンク](https://ja.wikipedia.org/wiki/ソフトバンク "wikilink")株式会社のサービスとなってからやや経った[2015年](../Page/2015年.md "wikilink")[9月30日](../Page/9月30日.md "wikilink")を以て、旧イー・アクセスと旧[ウィルコム](../Page/ウィルコム.md "wikilink")契約(及びY\!mobileブランドで開始された一部を含む)のプランの新規受け付けが停止されたため、新規の発行は不可となった(カード不良時の再発行のみ)。2015年12月には、旧イー・アクセスの3GネットワークがLTE網への完全転換に伴って、2018年1月末を以て停波となることが発表されており、今後は再発行も不可能となる見通しとなっている。
...
データ通信用のEM chipの場合、製造ロットによっては、[海外](../Page/海外.md "wikilink")[ローミング](../Page/ローミング.md "wikilink")非対応のものがあり、利用を希望する場合で該当するEM chipを利用している場合は、カスタマーセンタへの申し込みないしは[ワイモバイルショップでの手続きにて無償交換に応じるとしている](https://ja.wikipedia.org/wiki/Y!mobile#ショップ店 "wikilink")\[2\]\[3\]。音声端末用については、最初から海外ローミングに対応した仕様となっており、利用を希望しない場合は、当該電話機から番号通知をしたうえでカスタマーセンタへ連絡することで止めることが可能である。

ファイル:EM chip black.jpg|黒色/音声端末用（ジェムアルト製） [File:Em3g-sim.jpg|黒色/音声端末用（オベルチュール製](File:Em3g-sim.jpg%7C黒色/音声端末用（オベルチュール製)） [File:Em3g-sim-r.jpg|EM](File:Em3g-sim-r.jpg%7CEM) chipの裏面 ファイル:EM chip red.jpg|赤色/データ通信端末用（ジェムアルト製）

[File:Emlte-paper.jpg|EM](File:Emlte-paper.jpg%7CEM) chip \[LTE\]のパッケージ [File:Emlte-dnp-card.jpg|EM](File:Emlte-dnp-card.jpg%7CEM) chip \[LTE\] カード ファイル:EM Chip LTE.JPG|黒色/LTE対応データ端末用（ジェムアルト製） [File:Emlte-dnp-sim.jpg|黒色/LTE対応データ端末用（大日本印刷製](File:Emlte-dnp-sim.jpg%7C黒色/LTE対応データ端末用（大日本印刷製)） [File:Emlte-dnp-sim-r.jpg|EM](File:Emlte-dnp-sim-r.jpg%7CEM) chip \[LTE\]の裏面

[File:Em-m03-card.jpg|EM](File:Em-m03-card.jpg%7CEM) chip m03 <micro>カード [File:Em-m03-sim.jpg|EM](File:Em-m03-sim.jpg%7CEM) chip m03 <micro>の裏面
...
<!-- end list -->
  ...
  - 当初は、国際ローミングサービスを提供していなかったため、EM chipを[GSM](https://ja.wikipedia.org/wiki/GSM "wikilink")端末などに挿して日本国外で使うこと（[プラスチックローミング](https://ja.wikipedia.org/wiki/プラスチックローミング "wikilink")）はできなかった。
...
[Category:携帯電話_(イー・モバイル)](https://ja.wikipedia.org/wiki/Category:携帯電話_\(イー・モバイル\) "wikilink") [Category:ICカード](https://ja.wikipedia.org/wiki/Category:ICカード "wikilink")

1.  ただし、いくつかのチャンネルでは**「イーエムチップ」**としている場合もあり、公式にも表記のゆれが見られる。製品取扱説明書の多くなど、紙上での公式な文書では「エムチップ」としている。
2.  端子とは反対面のEMマークの下に赤いラインが**入っていないもの**が**非対応**としている([国際ローミング お申し込み方法 | イー・モバイル](http://emobile.jp/service/world_roaming/inquiry.html))
