...
一般的に単一の[集積回路](../Page/集積回路.md "wikilink")上にCPUを搭載している初期の[マイクロコンピュータ](../Page/マイクロコンピュータ.md "wikilink")の多くは、[1975年](../Page/1975年.md "wikilink")頃の[Altair 8800の](../Page/Altair_8800.md "wikilink")[S-100バス](https://ja.wikipedia.org/wiki/S-100バス "wikilink")を皮切りに、単一のシステムバスを使用して構築された\[9\]。[IBM PCは](../Page/IBM_PC.md "wikilink")、1981年に[Industry Standard Architecture](../Page/Industry_Standard_Architecture.md "wikilink")(ISA)バスをシステムバスとして使用した。初期モデルにおけるパッシブバックプレーンは、CPUとRAMを[マザーボード](../Page/マザーボード.md "wikilink")上に配置し、システムバススロットにオプションの[拡張カード](../Page/拡張カード.md "wikilink")のみを配置するという標準に置き換えられた。
