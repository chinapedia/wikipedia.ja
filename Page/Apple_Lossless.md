> この記事は[Apple Lossless](https://ja.wikipedia.org/wiki/Apple_Lossless)から翻訳されています。
...
## 外部リンク
  ...
  - [Apple Lossless Audio Codec](http://alac.macosforge.org/post/welcome-to-the-apple-lossless-audio-codec-project/) - [Mac OS Forge](https://ja.wikipedia.org/wiki/Mac_OS_Forge "wikilink")（公式なソースコード公開サイト）
  - [アップル - iPod + iTunes](http://www.apple.com/jp/itunes/)
  - [refalac](http://sites.google.com/site/qaacpage/)
  - [ALAC Decoder (crazney.net)](http://craz.net/programs/itunes/alac.html)
  - [Apple Lossless decoder (RareWares)](http://www.rarewares.org/lossless.html)
  - [ソニー プレスリリース ウォークマン史上初 ハイレゾリューション・オーディオ音源対応『NW-ZX1』、Fシリーズ](https://www.sony.jp/CorporateCruise/Press/201309/13-0925B/) （新たにFLACやApple Lossless、AIFFなどの高音質コーデックに対応）

[Category:コーデック](https://ja.wikipedia.org/wiki/Category:コーデック "wikilink") [Category:音声ファイルフォーマット](https://ja.wikipedia.org/wiki/Category:音声ファイルフォーマット "wikilink") [Category:音声処理](https://ja.wikipedia.org/wiki/Category:音声処理 "wikilink") [Category:アップルのソフトウェア](https://ja.wikipedia.org/wiki/Category:アップルのソフトウェア "wikilink") [Category:オープンフォーマット](https://ja.wikipedia.org/wiki/Category:オープンフォーマット "wikilink") [Category:可逆圧縮アルゴリズム](https://ja.wikipedia.org/wiki/Category:可逆圧縮アルゴリズム "wikilink")

1.  アップル社ウェブサイトでは「Apple Lossless」の表記([1](https://support.apple.com/kb/PH19454?viewlocale=ja_JP&locale=ja_JP))の他に、Apple ロスレスと表記（[2](http://support.apple.com/kb/PH1489?viewlocale=ja_JP)）される場合もある。
2.  [ReadMe.txt – Apple Lossless Audio Codec](http://alac.macosforge.org/trac/browser/trunk/ReadMe.txt)
3.