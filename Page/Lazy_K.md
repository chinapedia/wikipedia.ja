...
純粋関数型言語として、[チューリング完全](../Page/チューリング完全.md "wikilink")でありながら、絶対必要なエッセンスだけを抜き出したプログラミング言語である。[遅延評価](../Page/遅延評価.md "wikilink")を行う。使用するにも、処理系を実装するにも、[コンビネータ論理](https://ja.wikipedia.org/wiki/コンビネータ論理 "wikilink")の知識が必要である。
