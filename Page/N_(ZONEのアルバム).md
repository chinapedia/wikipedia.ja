...
アルバムタイトルは、バンド名である「ZO**N**E」の3番目のアルファベットから付けられている。初回限定盤では、箱形のスペシャルパッケージ（デジパック）仕様＋楽曲ごとの変形歌詞カード付きとなっている。ジャケットは[バディリードール](https://ja.wikipedia.org/wiki/バディリードール "wikilink")をZONEの4人に見立てて並べているデザイン。なおこれと同じ人形も発売された。

収録曲の構成は全13曲中、シングルでリリース済みの曲が7曲、残り6曲が本作での初収録曲で、内4曲はメンバーそれぞれのソロボーカル曲となっている。
...
6.  **Like**
      -
        MAIKOのソロボーカル曲。コーラスとしてMIYUが参加。
7.  **prayer**
      -
        MIYUのソロボーカル曲。
8.  **[白い花](../Page/白い花_\(ZONEの曲\).md "wikilink")　\<acoustic ver.\>**
      -
        8枚目のシングル。アコースティックバージョンで収録されている。このバージョンのボーカルはMIYUとMIZUHO\[1\]。
9.  **[true blue](https://ja.wikipedia.org/wiki/true_blue/恋々・・・ "wikilink")**
      -
        9枚目のシングルの両A面の1曲目。
10. **[僕の手紙](https://ja.wikipedia.org/wiki/僕の手紙 "wikilink")**
      -
        11枚目のシングル。
...
12. **[H・A・N・A・B・I 〜君がいた夏〜](https://ja.wikipedia.org/wiki/H・A・N・A・B・I_〜君がいた夏〜 "wikilink")**
      -
        10枚目のシングル。
13. **[secret base 〜君がくれたもの〜](https://ja.wikipedia.org/wiki/secret_base_〜君がくれたもの〜 "wikilink") \<LIVE ver.\>**
