...
PSIは、キャラクターの[レベル上昇](../Page/レベル_\(ロールプレイングゲーム\).md "wikilink")、またはイベントによって覚える。3ではレベル上昇の代わりに「マップ上で突然体調が悪くなり（じわーっと ねつっぽくなる）、治ると同時に覚える」という方法がとられている。
...
なお、必殺ワザ以外のPSI、もしくはPSIで強化した体術にも「PK～」と付いているものがあるが、本項では割愛する。
  ...
  - PKフラッシュ
    2作目『[DX](../Page/大乱闘スマッシュブラザーズDX.md "wikilink")』以降のネスのみ使用。
