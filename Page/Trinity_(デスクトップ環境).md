...
Trinityの初期のリリースにおいては、バージョン付けのスキームはKDE 3.5のそれをベースにしていた。R14.0リリースは新たなバージョン付のスキームを導入したが、これはKDEにバージョン番号のみで比べられるのを避けるとともに、新しいテーマの導入のためであった\[4\]。この新しいテーマは"KDE Lineart"に基づく。

これに先立ち、Trinityは、KDE 3.5のテーマと、"KDE 3.5"のブランディングを"TDE"ブランディングに置き換えるなどして維持した\[5\]。
...
## 外部リンク
  ...
  - [Exe GNU/Linux official website](http://exegnulinux.net/)
  - [Q4OS official website](http://www.q4os.org/)
  - [Trinity Desktop Environment Wiki](https://wiki.trinitydesktop.org/Trinity_Desktop_Environment)
