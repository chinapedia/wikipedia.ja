...
[ニンテンドーWi-Fiコネクション](https://ja.wikipedia.org/wiki/ニンテンドーWi-Fiコネクション "wikilink")の実装により[インターネット](https://ja.wikipedia.org/wiki/インターネット "wikilink")接続を用いて世界中のプレイヤーと対戦が行えた\[1\]。Wi-Fiコネクション対応の作品としては日本では2作目、世界全体では初\[2\]。また、新たなモードとして「ミッションラン」が登場。
...
日本国内の売上はこれまでの最高であった『[スーパーマリオカート](https://ja.wikipedia.org/wiki/スーパーマリオカート "wikilink")』を上回り、シリーズ最高となっている。
...
前作『[ダブルダッシュ\!\!](https://ja.wikipedia.org/wiki/マリオカート_ダブルダッシュ!! "wikilink")』と同様、特定の条件を満たすことで「ミラー」モードが出現する（スピードは150ccと同じだが、コースが左右反転する）。
...
:\*\* ライトステップPC
  ...
  -
    ミニターボの持続時間は平均的だが、スピードは遅い。加速は高めで、ドリフトは全キャラ中最高ランク。中でも「ライトステップPC」は最強のドリフト性能を持つ。ハンドリングは平均的。
      - **[ドンキーコング](https://ja.wikipedia.org/wiki/ドンキーコング_\(ゲームキャラクター・2代目\) "wikilink")** - 重量級
          - ジャングルカーゴ
          - スタンダードDK
          - ワイルドライフ
    ...
    ドンキーコングと性能が似ており、最高速はドンキーコングより速いが、ハンドリングは鈍い。加速とハンドリングの性能は全カート中最低ランクである。重量級の中で最も重く\[6\]、悪路に入ると大きく減速するが、敵カートからの体当たりにも強い。「ハリケーン」は「HVC-BLS」と並んで全カート中最高のスピード性能を誇るが、ミニターボの持続時間が最も短く、0.3秒程度しか続かない。これは「カロン・カノン」のおよそ4分の1である。
      - **[デイジー](https://ja.wikipedia.org/wiki/デイジー_\(ゲームキャラクター\) "wikilink")** - 中量級・隠しキャラ
          - フラウリィ
          - スタンダードDS
          - ライトステップDS
...
:\*\* ストリームライン
  ...
  -
    ...
    スピードがやや遅めだが軽量級の中では最も速い。尚且つ加速とハンドリングが非常に優れており、ドリフトもルイージより高めである。「エッグ・ワン」は「カロン・カノン」に次ぐミニターボ持続時間の長さ（1.1秒以上）を誇り、直線でミニターボを続けていれば常に加速し続けられる。
      - **[カロン](https://ja.wikipedia.org/wiki/カロン_\(ゲームキャラクター\) "wikilink")** - 軽量級・新キャラ・隠しキャラ
          - バニッシュ
          - スタンダードKA
          - カロン・カノン
    スピード性能は最低ランクだが、全キャラ中最も軽く、加速とハンドリングはトップクラスで悪路での減速も非常に少ない。「カロン・カノン」はもっとも軽いカートだが、ミニターボの持続時間が最も長く、1.2秒以上も効果が続く。
      - **[HVC-012](https://ja.wikipedia.org/wiki/ファミリーコンピュータ_ロボット "wikilink")** \[7\] - 重量級・新キャラ・隠しキャラ
          - HVC-BLS
          - スタンダードRB
          - HVC-LGS
    スピード性能と重さはクッパと並んで最高で、重量級でもっともハンドリング性能が高いが、ドリフト性能は全キャラ中最低クラス。[ブロックセットを模した](https://ja.wikipedia.org/wiki/ファミリーコンピュータ_ロボット#ブロックセット "wikilink")「HVC-BLS」は、「ハリケーン」と並んで最高のスピード性能を誇る。
      - **[ヘイホー](https://ja.wikipedia.org/wiki/ヘイホー_\(ゲームキャラクター\) "wikilink")** - 軽量級・新キャラ・DSダウンロードプレイのみ登場
...
（）内はそのステージで操作するプレイヤーキャラ。
  ...
  - レベル3…クリキング（キノピオ）
    『[マリオストーリー](https://ja.wikipedia.org/wiki/マリオストーリー "wikilink")』を初出とする、[クリボー](../Page/クリボー.md "wikilink")の仲間の王様。「GC・ベビィパーク」を先に3周回ればクリア、クリキングにゴールされるとミッション失敗となる。
    クリキングは周回ごとにスピードを上げていき、3周目ではクリキング専用のショートカットをする。妨害としてクリボーを吐き出すが、キノピオを抜くとキノコを出すこともある。なお、クリキングに激突してもダメージは受けない（クリボーだとダメージになる）。
  - レベル4…[キングテレサ](https://ja.wikipedia.org/wiki/キングテレサ "wikilink")（ピーチ）
    『[ルイージマンション](../Page/ルイージマンション.md "wikilink")』を初出とする、[テレサ達の王様](https://ja.wikipedia.org/wiki/テレサ_\(ゲームキャラクター\) "wikilink")。キングテレサの妨害をかわしてコインを50個集めるとクリア。妨害によって消されたコインは、キングテレサに触れると復活する。
  - レベル5…ボムキング（ワリオ）
  ...
  - レベル7…[ハナチャン](https://ja.wikipedia.org/wiki/ハナチャン_\(ゲームキャラクター\) "wikilink")（マリオ）
...
### その他のキャラクター
  ...
  - [サンボ](https://ja.wikipedia.org/wiki/サンボ_\(ゲームキャラクター\) "wikilink")
  ...
  - [バブル](https://ja.wikipedia.org/wiki/バブル_\(ゲームキャラクター\) "wikilink")
...
アイテムの効果などの詳細は、[マリオカートシリーズのアイテムを参照](https://ja.wikipedia.org/wiki/マリオカートシリーズ#アイテム "wikilink")。
  ...
  - [ゲッソー](https://ja.wikipedia.org/wiki/ゲッソー "wikilink") - シリーズ初登場
  - サンダー
  - スター
...
#### キノコカップ
  ...
  - エイトクロスサーキット★☆（8-Cross Circuit / 英名：Figure-8 Circuit）-（任天堂公式最速記録 1'30"571）
    ...
    最初の[サーキット](https://ja.wikipedia.org/wiki/サーキット "wikilink")系コースの中で、唯一キャラクターの名前が入らないコース。また、現時点では本作のキノコカップのコースで唯一、再収録されたことが無いコースでもある。
...
#### フラワーカップ
  ...
  - サンサンさばく☆（Sun Sun Desert / 英名：Desert Hills）-（任天堂公式最速記録 1'26"585）<Wii>
    ...
    いたるところでサンボが立ちはだかり、2周目からは太陽による[ファイアスネークの投下で進路を妨害する](https://ja.wikipedia.org/wiki/バブル_\(ゲームキャラクター\) "wikilink")。
  - モンテタウン☆ （Monte Town / 英名：Delfino Square）-（任天堂公式最速記録 1'50"914）<Wii>
    『[スーパーマリオサンシャイン](https://ja.wikipedia.org/wiki/スーパーマリオサンシャイン "wikilink")』のドルピックタウンを彷彿させる、小さい街中を走るコース。
...
#### スターカップ
  ...
  - DKスノーマウンテン☆ （DK Snow Mountain / 英名：DK Pass）-（任天堂公式最速記録 2'09"458）\<7、ツアー\>
    前半は狭い[アイスバーンを崖に沿って登り](https://ja.wikipedia.org/wiki/路面凍結 "wikilink")、後半は広い雪道を下る雪山のコース。
    障害物として[雪だるま](https://ja.wikipedia.org/wiki/雪だるま "wikilink")がいるほか、正面や背後から雪玉が転がってくる。特定のアイテムが無条件に入手できるボックスがある。
...
#### スペシャルカップ
  ...
  - ワリオスタジアム☆ （Wario Stadium）-（任天堂公式最速記録 2'09"916）\<8\>
    [モトクロス](https://ja.wikipedia.org/wiki/モトクロス "wikilink")のような凸凹コース。
...
本作では各カップごとのコースの出典元が『[スーパーマリオカート](https://ja.wikipedia.org/wiki/スーパーマリオカート "wikilink")』、『[64](https://ja.wikipedia.org/wiki/マリオカート64 "wikilink")』、『[アドバンス](https://ja.wikipedia.org/wiki/マリオカートアドバンス "wikilink")』、『[ダブルダッシュ\!\!](https://ja.wikipedia.org/wiki/マリオカート_ダブルダッシュ!! "wikilink")』の順で固定されている。
...
#### こうらカップ
  ...
  - 64・モーモーファーム★☆ （N64 Moo Moo Farm）-（任天堂公式最速記録 1'14"032）
    [牧場](https://ja.wikipedia.org/wiki/牧場 "wikilink")を走るコース。凸凹した路面は見通しが悪い。地面から飛び出すチョロプーに触れるとクラッシュする。
...
## 攻略本
  ...
  - Nintendo DREAM 任天堂ゲーム攻略本 マリオカートDS ISBN 4839919836 - [毎日コミュニケーションズ](https://ja.wikipedia.org/wiki/毎日コミュニケーションズ "wikilink")（発売日:[2006年](https://ja.wikipedia.org/wiki/2006年 "wikilink")[1月12日](../Page/1月12日.md "wikilink")）
...
## 関連項目
  ...
  - [ナインティナイン](https://ja.wikipedia.org/wiki/ナインティナイン "wikilink") - テレビCMのイメージキャラクター。[矢部浩之](https://ja.wikipedia.org/wiki/矢部浩之 "wikilink")がルイージ役で、[岡村隆史](https://ja.wikipedia.org/wiki/岡村隆史 "wikilink")がマリオ役。
...
5.  クラクションの音は『[マリオカート64](https://ja.wikipedia.org/wiki/マリオカート64 "wikilink")』に登場した「キノピオハイウェイ」のタンクローリーのクラクションが使用されている。
