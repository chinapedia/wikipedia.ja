...
MIMEのフォーマットに則っているため、[US-ASCII以外の](https://ja.wikipedia.org/wiki/ASCII "wikilink")[テキスト](../Page/テキスト.md "wikilink")データや画像などの[バイナリ](../Page/バイナリ.md "wikilink")データは[Quoted-printable](https://ja.wikipedia.org/wiki/Quoted-printable "wikilink")か[Base64](../Page/Base64.md "wikilink")でエンコードする。
...
ウェブページをMHTMLで保存できる機能をもつ[実装](https://ja.wikipedia.org/wiki/実装 "wikilink")系は、Internet Explorerの他、[Microsoft Office](../Page/Microsoft_Office.md "wikilink") ([Word](../Page/Microsoft_Word.md "wikilink")、[Excel](https://ja.wikipedia.org/wiki/Microsoft_Excel "wikilink")、[PowerPoint](https://ja.wikipedia.org/wiki/Microsoft_PowerPoint "wikilink")、[Access](https://ja.wikipedia.org/wiki/Microsoft_Access "wikilink"))、[Opera](https://ja.wikipedia.org/wiki/Opera "wikilink")、[Vivaldiなどがある](https://ja.wikipedia.org/wiki/Vivaldi_\(ウェブブラウザ\) "wikilink")。[Mozilla Firefox](../Page/Mozilla_Firefox.md "wikilink")、[Google Chromeでも設定をしたり](https://ja.wikipedia.org/wiki/Google_Chrome "wikilink")、拡張機能を導入することで扱えるようになる。
...
## 関連項目
  ...
  - [MIME](https://ja.wikipedia.org/wiki/Multipurpose_Internet_Mail_Extensions "wikilink")
