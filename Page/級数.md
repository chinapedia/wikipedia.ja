...
となる。このほかに、[解析接続](https://ja.wikipedia.org/wiki/解析接続 "wikilink")などの手法により、みかけ上発散している級数に対して

  -
    \(1 + 2 + 3 + \cdots = -\frac{1}{12}\)　（[1+2+3+4+…](https://ja.wikipedia.org/wiki/1+2+3+4+… "wikilink")を参照のこと）
...
[自然数](../Page/自然数.md "wikilink")によって項が添字づけられている場合には[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")と[条件収束](https://ja.wikipedia.org/wiki/条件収束 "wikilink")とのふたつの収束性の概念を定義することができる。各項が[絶対値](https://ja.wikipedia.org/wiki/絶対値 "wikilink")（[ノルム](../Page/ノルム.md "wikilink")）の定義された体系に属する級数 ∑ *a*<sub>*n*</sub> は、有限個の項の[絶対値](https://ja.wikipedia.org/wiki/絶対値 "wikilink")を足して得られる正数列が有界である場合、

  -
    \(\sum_{i=1}^n |a_i| < {}^\exist M \quad ({}^\forall n)\)

その級数は**[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")** () していると言われる。最初の有限個の項の絶対値をそれぞれ足して得られる数の列がコーシー列になっているようなとき、およびそのときに限り[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")が成り立っている。

最初の有限個の項を足して得られる部分和の列が収束しているような級数 ∑ *a*<sub>*n*</sub> は**[条件収束](https://ja.wikipedia.org/wiki/条件収束 "wikilink")** () あるいは単に収束していると言われる。

  -
    \(s_n = \sum_{i=1}^n a_i \to {}^\exists s \quad (n \rightarrow \infty)\)

[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")している級数は[条件収束](https://ja.wikipedia.org/wiki/条件収束 "wikilink")している。しばしば「[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")でない収束」の意味で単に「[条件収束](https://ja.wikipedia.org/wiki/条件収束 "wikilink")」と呼ぶことがある。[条件収束](https://ja.wikipedia.org/wiki/条件収束 "wikilink")級数の和の値は一般に数列の項の並びに依存して決まる。数列 {*a*<sub>*n*</sub>} の項を任意に並べ替えてできる数列 {*a*<sub>σ(*n*)</sub>} の和が、置換 σ の取り方に依らずもとの数列の和に等しいとき、しばしば級数 ∑ *a*<sub>*n*</sub> は**[無条件収束](https://ja.wikipedia.org/wiki/無条件収束 "wikilink")** () しているといわれる。[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")級数は[無条件収束](https://ja.wikipedia.org/wiki/無条件収束 "wikilink")する。[無条件収束](https://ja.wikipedia.org/wiki/無条件収束 "wikilink")でない（[実数](../Page/実数.md "wikilink")項の）収束級数は、適当な置換を選んで並べ替えることにより、任意の（[実数](../Page/実数.md "wikilink")）値に収束または発散させることができる。

[整数](../Page/整数.md "wikilink")の集合など、[整列](https://ja.wikipedia.org/wiki/整列集合 "wikilink")[可算集合](../Page/可算集合.md "wikilink")ではない[添字集合](https://ja.wikipedia.org/wiki/添字集合 "wikilink") *I* によって項が数え上げられた級数 ∑<sub>*i* ∈ *I*</sub> *a*<sub>*i*</sub> に関しても以下のように収束性の概念を定めることができる。添字集合の有限部分集合のなす[直系について](https://ja.wikipedia.org/wiki/帰納極限 "wikilink")、対応する項の和が収束 i.e.

  -
    \(\varinjlim_{F}\sum_{F \subset I: |F| < \infty;\atop i \in F} a_i = {}^\exist s\)

しているとき、級数 ∑<sub>*i* ∈ *I*</sub> *a*<sub>*i*</sub> は[条件収束](https://ja.wikipedia.org/wiki/条件収束 "wikilink")しているといい、各項の[絶対値](https://ja.wikipedia.org/wiki/絶対値 "wikilink")を考えられて

  -
    \(\sum_{F \subset I: |F| < \infty;\atop i \in F} |a_i| < \infty\)

となっているとき ∑<sub>*i* ∈ *I*</sub> *a*<sub>*i*</sub> [絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")していると言われる。
...
（これはもちろん[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")する級数でもある）。条件を弱めて各項を非負としても良い。
...
[交代級数](https://ja.wikipedia.org/wiki/交代級数 "wikilink")は項が0に収束するならば収束する。
  ...
  - [ライプニッツの収束判定法](https://ja.wikipedia.org/wiki/:en:alternating_series_test "wikilink") (Leibniz criterion):[交項級数](https://ja.wikipedia.org/wiki/交項級数 "wikilink") ∑ *a*<sub>*n*</sub> は |*a*<sub>*n*</sub>| が単調減少で 0 に収束するならば収束する。
    ...
    [実数](../Page/実数.md "wikilink")を各項にもつ級数\(\sum a_n\)は、\(\limsup \sqrt[n]{|a_n|} < 1\)ならば[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")し、逆にこの量が1より大きければ発散する。

  - [ダランベールの収束判定法](https://ja.wikipedia.org/wiki/ダランベールの収束判定法 "wikilink"):連続する項の比の絶対値が1より小さな極限を持つ級数は[絶対収束](https://ja.wikipedia.org/wiki/絶対収束 "wikilink")し、逆に1より大きな極限を持つ級数は発散する。
    [比較判定法](https://ja.wikipedia.org/wiki/比較判定法 "wikilink"):|*a*<sub>*n*</sub>| \< *b*<sub>*n*</sub>(*n*=1,2,…)が成り立つとき、\(\sum_{n=1}^{\infty}b_n\)を優級数、\(\sum_{n=1}^{\infty}a_n\)を劣級数という。優級数が収束するならば劣級数は絶対収束する。（対偶により）劣級数が発散すれば優級数も発散する。
...
[ライプニッツの収束判定法が適用できるとき](https://ja.wikipedia.org/wiki/:en:alternating_series_test "wikilink")、打切り誤差（剰余項）を厳密に評価できる\[3\]\[4\]。この技法は[ベッセル関数](https://ja.wikipedia.org/wiki/ベッセル関数 "wikilink")にも適用できる\[5\]。
...
以下に重要な級数の例を挙げる。
  ...
  - [冪級数](https://ja.wikipedia.org/wiki/冪級数 "wikilink")は各項を[単項式](../Page/単項式.md "wikilink")とする級数である。
      -
        [アーベルの定理は](https://ja.wikipedia.org/wiki/アーベルの連続性定理 "wikilink")、数列級数の収束と、その[母関数](https://ja.wikipedia.org/wiki/母関数 "wikilink")である[正則関数](https://ja.wikipedia.org/wiki/正則関数 "wikilink")の値の収束値との間の関係を与えている。
  - [ローラン級数](https://ja.wikipedia.org/wiki/ローラン級数 "wikilink")は単項式の次数として負の[自然数](../Page/自然数.md "wikilink")を許した二方向への無限和であり、[自然数](../Page/自然数.md "wikilink")と異なる[添字集合](https://ja.wikipedia.org/wiki/添字集合 "wikilink")によって項が与えられる例になっている。
  - [テイラー級数](https://ja.wikipedia.org/wiki/テイラー級数 "wikilink")は滑らかな関数の、冪級数としての表現を与えている。
  - [フーリエ級数](https://ja.wikipedia.org/wiki/フーリエ級数 "wikilink")は各項を[三角関数](../Page/三角関数.md "wikilink")とする級数による関数の表示を与えている。
...
\[\int_E \sum_{n=0}^\infty f_n(x)\,dx = \sum_{n=0}^\infty \int_E f_n(x)\,dx\] である。[滑らかな関数](https://ja.wikipedia.org/wiki/滑らかな関数 "wikilink")を項に持つ関数項級数の一様収束極限に対する**項別微分**可能性も同様である。収束冪級数の収束はその収束域において一様で、各項の冪関数は可積分かつ連続的微分可能であるから、収束冪級数は項別積分可能かつ項別微分可能であり、その原始関数および導関数はもとの冪級数と同じ収束域もつ冪級数として得られる。
...
さらに一般に、任意の[位相アーベル群](https://ja.wikipedia.org/wiki/位相アーベル群 "wikilink")（[分離](../Page/ハウスドルフ空間.md "wikilink")[位相群](https://ja.wikipedia.org/wiki/位相群 "wikilink")を成す[可換群](https://ja.wikipedia.org/wiki/可換群 "wikilink")）における収束級数の概念を定義することができる。この場合も具体的には、級数 ∑ *x*<sub>*n*</sub> が *x* に収束するということを、その部分和の列が *x* に収束することを以って定める。
...
任意の集合 *I* と[位相アーベル群](https://ja.wikipedia.org/wiki/位相アーベル群 "wikilink") *X* に対して、*I* で添字付けられた *X* の元の族 *a*: *I* → *X* を考える。**F** を *I* の有限部分集合全体の成す部分集合族とすると、**F** は集合の包含関係に関する[半順序集合](https://ja.wikipedia.org/wiki/半順序集合 "wikilink")として、[交わりと](../Page/共通部分_\(数学\).md "wikilink")[結びをもつ](https://ja.wikipedia.org/wiki/合併_\(集合論\) "wikilink")[有向集合](https://ja.wikipedia.org/wiki/有向集合 "wikilink")となることに注意する。このとき、族 *a* の和 *S* は極限
...
となるようにできることをいう。**F** は[全順序集合](https://ja.wikipedia.org/wiki/全順序集合 "wikilink")ではないから、これは「部分和の[数列の極限](https://ja.wikipedia.org/wiki/数列の極限 "wikilink")」というのとは異なり、[有向点族](https://ja.wikipedia.org/wiki/有向点族 "wikilink")（ネット）の極限と考えなければならない。
...
を満たす。位相アーベル群 *X* が[完備である場合には](https://ja.wikipedia.org/wiki/完備距離空間 "wikilink")、族 *a* が *X* において無条件総和可能であることと、後述する「コーシーネット条件」を満たすことが[同値](https://ja.wikipedia.org/wiki/同値 "wikilink")になる。また、*X* が完備で (*a*<sub>*i*</sub>)<sub>*i*∈*I*</sub> が *X* において無条件総和可能ならば、*I* の任意の部分集合 *J* に対して対応する部分族 (*a*<sub>*j*</sub>)<sub>*j*∈*J*</sub> もまた無条件総和可能である。
...
1.  [高木貞治](../Page/高木貞治.md "wikilink"). 定本解析概論. [岩波書店](https://ja.wikipedia.org/wiki/岩波書店 "wikilink").
2.
3.
4.  [杉浦光夫](https://ja.wikipedia.org/wiki/杉浦光夫 "wikilink"). 解析入門 I, [東京大学出版会](https://ja.wikipedia.org/wiki/東京大学出版会 "wikilink").
