...
LAVIEとは[フランス語](https://ja.wikipedia.org/wiki/フランス語 "wikilink")で[生命](../Page/生命.md "wikilink")（La Vie）という意味である。

## ラインアップ

[LaVieの機種一覧](https://ja.wikipedia.org/wiki/LaVieの機種一覧 "wikilink")（PC-9821シリーズのノートパソコン「98NOTE Lavie」、PC98-NXシリーズのノートパソコン「LaVie NXシリーズ」も含む）を参照

## 加熱による異臭問題

2008年6月10日NECは「LaVie L/F」「LaVie G タイプL/タイプF」の一部製品で液晶ディスプレイ接続部余裕が少ない状態で組み立てられたことにより異臭・発煙する可能性があると発表した。
