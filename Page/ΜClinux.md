...
## 関連項目
  ...
  - [uClibc](https://ja.wikipedia.org/wiki/uClibc "wikilink")

## 外部リンク

  - [μClinux ホームページ](http://uclinux.org/)
  - [ucdot - forum for μClinux and Embedded Linux](http://www.ucdot.org/)
  - [The μClinux Directory](http://uclinux.home.at/)
  - [μClinux guide, but little bit older doc.](http://uldp.home.at/)
  - [μClinux - Setting up the Development Environment](http://www.beyondlogic.org/uClinux/uClinux.htm)
  - [Deeply Embedded Linux - A practical Example](http://www.ucdot.org/archive/deep/deeply-embedded-linux.html)
  - [Getting started with μClinux](http://www.cyberguard.info/snapgear/tb20020807.html)
  - [μClinux 2.4.19 port for the Sony PSP](http://df38.dot5hosting.com/~remember/chris/)
  - [Document site for μClinux port on blackfin processor, but most of the docs are pretty common](http://docs.blackfin.uclinux.org/)
  - [uClinux for H8/300 series Porting Project](http://uclinux-h8.sourceforge.jp/)
  - [uClinux](http://www.takamisawa.org/uC/uClinux.html)

[Category:OSのカーネル](https://ja.wikipedia.org/wiki/Category:OSのカーネル "wikilink") [Category:組み込みOSの製品](https://ja.wikipedia.org/wiki/Category:組み込みOSの製品 "wikilink") [Category:Linux](https://ja.wikipedia.org/wiki/Category:Linux "wikilink")
