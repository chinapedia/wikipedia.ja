...
## 交換機の種類
  ...
  - 同期デジタルヒエラルキー（SONET/SDH：Synchronous Optical NETwork/[Synchronous Digital Hierarchy](https://ja.wikipedia.org/wiki/Synchronous_Digital_Hierarchy "wikilink")）交換機
  - [フレームリレー](https://ja.wikipedia.org/wiki/フレームリレー "wikilink")交換機
