...
[thumb](https://ja.wikipedia.org/wiki/ファイル:AdditiveColorMixiing.svg "wikilink") [thumb](https://ja.wikipedia.org/wiki/ファイル:Spectrum4websiteEval.png "wikilink") ([色収差](https://ja.wikipedia.org/wiki/色収差 "wikilink"))\]\] [thumb](https://ja.wikipedia.org/wiki/ファイル:Synthese-.svg "wikilink") **色空間**（いろくうかん、）は、立方的に記述される[色](../Page/色.md "wikilink")の[空間](../Page/空間.md "wikilink")である。**カラースペース**ともいう。色を秩序立てて配列する形式であり、色を[座標](https://ja.wikipedia.org/wiki/座標 "wikilink")で指示できる。色の構成方法は多様であり、色の見え方には観察者同士の差異もあることから、色を[定量的](https://ja.wikipedia.org/wiki/定量的 "wikilink")に表すには、幾つかの[規約](https://ja.wikipedia.org/wiki/規約 "wikilink")を設けることが要請される。また、色空間が表現できる色の範囲を[色域](https://ja.wikipedia.org/wiki/色域 "wikilink")という。色空間は3種類か4種類の[数値](https://ja.wikipedia.org/wiki/数値 "wikilink")を組み合わせることが多い。色空間が数値による場合、その変数はチャンネルと呼ばれる。
...
**表色系**は、心理的[概念](https://ja.wikipedia.org/wiki/概念 "wikilink")あるいは心理物理的概念に従い、色を定量的に表す体系である。通常は3つの方向性を具える空間で表現され、色空間を構成する。
...
数学的には3つの[変数があれば](https://ja.wikipedia.org/wiki/変数_\(数学\) "wikilink")、すべての色を表現できると言える。しかし、すべての色を表示できる必要がない状況や、そのほか実用の便宜のために、2変数以下、あるいは4変数以上を用いる色空間もある。また変数の取り方もさまざまなものがあり、目的に応じて多種多様な規格が存在する。
...
Uniform Color Spaceのこと。色空間上での[距離](https://ja.wikipedia.org/wiki/距離 "wikilink")・間隔が、知覚的な色の距離・間隔に類似するよう設計されている空間。色の物理的な差異よりも、人間の知覚上での差異に主眼を置いた色空間。工業的には、工業製品の色彩の管理に要請される。
...
CIE（[国際照明委員会](https://ja.wikipedia.org/wiki/国際照明委員会 "wikilink")）が定める表色系。 [thumb](https://ja.wikipedia.org/wiki/ファイル:CIExy1931.png "wikilink")
  ...
  - RGB表色系
    原色をR（[赤](https://ja.wikipedia.org/wiki/赤 "wikilink")、700nm）、G（[緑](https://ja.wikipedia.org/wiki/緑 "wikilink")、546.1nm）、B（[青](https://ja.wikipedia.org/wiki/青 "wikilink")、435.8nm）とする表色系を、CIEのRGB表色系という。のパソコンにおいては最も多く用いられる。ディスプレイデバイスなどへの出力指示などに用いられる。
...
マンセル表色系が心理的考察に基づいているのに対し、オストワルト表色系は心理物理学的考察に基づいている。現在でもデザイン分野などで利用される。ドイツの化学者の[ヴィルヘルム・オストヴァルト](https://ja.wikipedia.org/wiki/ヴィルヘルム・オストヴァルト "wikilink")による。
...
DIN表色系はM.リヒターたちの色差に関する研究を踏まえ均等色空間の実現を目指した表色系である。1955年に[DINに採用され](https://ja.wikipedia.org/wiki/ドイツ工業規格 "wikilink")、色票集も刊行されている。色は色相、明度、飽和度で表現される。ヘリングの反対色説に則るが、合衆国のマンセル表色系と異なり、色相は[黄から始まる](https://ja.wikipedia.org/wiki/黄色 "wikilink")。これは[ゲーテの思想との縁故が指摘](../Page/ヨハン・ヴォルフガング・フォン・ゲーテ.md "wikilink")\[1\]されている。
...
視覚上では、色は[光の三原色](https://ja.wikipedia.org/wiki/光の三原色 "wikilink")に近い、3波長に対応した[網膜](https://ja.wikipedia.org/wiki/網膜 "wikilink")の[錐体細胞](https://ja.wikipedia.org/wiki/錐体細胞 "wikilink")が受け取って知覚される。これには若干の個人差があり、また実際問題として純粋な3波長を用意することが難しい場合が多いため、混色系の色空間にはさまざまな種類のものがある。さまざまな表色系が存在するが、それぞれの表色系ごとに、赤・緑・青の基準が定められている。

コンピュータで同時に表示可能な色数は、ビデオメモリにおいて各[ピクセル](https://ja.wikipedia.org/wiki/ピクセル "wikilink")に何[ビット](../Page/ビット.md "wikilink")の情報を割り振るかにより決定される。メモリが高価だった頃には表示色はかなり限られていたが、ではRGB各8ビットの計24ビットを割り振ることで、1677万7216色の表示を可能にしている。これは、ほとんどの人間の目で識別可能な限界とされ、[フルカラー](https://ja.wikipedia.org/wiki/フルカラー "wikilink")やトゥルーカラーなどと呼ばれる。しかし24ビットでは画像編集の過程で劣化が無視できないため、内部的にはRGB各16ビットの計48ビットなど、より多ビットで扱うことがある。
...
基準となっている平面は[xyY色空間で](https://ja.wikipedia.org/wiki/#xyY "wikilink")、全ての色空間を包摂できる。xyYは均等色空間ではないため、面積の大きさが知覚上での色の多様さとは直接対応しない点に注意。\]\]
  ...
  - sRGB
    [国際電気標準会議](https://ja.wikipedia.org/wiki/国際電気標準会議 "wikilink") (IEC) が定めた国際標準規格。一般的な[モニタ](https://ja.wikipedia.org/wiki/ディスプレイ_\(コンピュータ\) "wikilink")、[プリンタ](https://ja.wikipedia.org/wiki/プリンター "wikilink")、[デジタルカメラ](../Page/デジタルカメラ.md "wikilink")などではこの規格に準拠しており、互いの機器をsRGBに則った色調整を行なう事で、入力時と出力時の色の差異を少なくする事が可能になる。
  - Adobe RGB
    **Adobe RGB**は[Adobe Systemsによって提唱された色空間の定義で](https://ja.wikipedia.org/wiki/アドビシステムズ "wikilink")、sRGBよりも広い（特に緑が広い）RGB色再現領域を持ち、印刷や色校正などでの適合性が高く、[DTP](../Page/DTP.md "wikilink")などの分野では標準的に使用されている。
  - DCI-P3
    [デジタルシネマ](https://ja.wikipedia.org/wiki/デジタルシネマ "wikilink")向けの広い色域（特に赤が広い）を持つ色空間。[Digital Cinema Initiativesが提唱](https://ja.wikipedia.org/wiki/:en:Digital_Cinema_Initiatives "wikilink")。
  - ITU-R BT.2020
...
#### RGBA
  ...
  -
    RGBA（もしくはARGB）はRGBの色空間に加えて、[アルファチャンネル](https://ja.wikipedia.org/wiki/アルファチャンネル "wikilink")も色決定に考慮させる。これは、透過（透明度）を表現するものである（厳密には色空間ではない）。

### CMY

は印刷の過程で利用する[減法混合](https://ja.wikipedia.org/wiki/減法混合 "wikilink")の表現法である。絵具の三原色。基本色は白で、それに色の度合いを加えて、黒色にしていく。すなわち、始めは白いキャンバスから始め、インクを加えて暗くしていく（反射光を減らす、すなわち減法）ということである。CMYには、[シアン](https://ja.wikipedia.org/wiki/シアン_\(色\) "wikilink")()、[マゼンタ](https://ja.wikipedia.org/wiki/マゼンタ "wikilink") ()、[イエロー](https://ja.wikipedia.org/wiki/イエロー "wikilink") () インクの数値が含まれている。

  - [CMYK](https://ja.wikipedia.org/wiki/CMYK "wikilink")
    理論上、をすべて均等に混ぜると黒色になるが、インクや紙の特性上、のインクを混ぜて綺麗な黒色を作るのは技術的に困難であり、通常はすべてを混ぜても濁った茶色にしかならない。そこで、黒（）の発色を良くするために、別途黒インクを用いるようになったのがである。キー・プレート () とは画像の輪郭など細部を示すために用いられた印刷板のことであり、通常黒インクのみが用いられた。なお、**K**は"blac**K**"の略とされることが多いが、これは俗説で本来誤りであり、ブラックは**Bk**と書く。 日本の印刷業界では黒インクを「スミ（[墨](https://ja.wikipedia.org/wiki/墨 "wikilink")）」と呼ぶことがある。印刷物では、黒は文字などで多用されるため、インクの節約にもなるので、現在ではもっとも使われている。
...
[HSVはコンピュータ上で絵を描く場合や](https://ja.wikipedia.org/wiki/HSV色空間 "wikilink")、色見本として使われる。これは、色を[色相](https://ja.wikipedia.org/wiki/色相 "wikilink")（色味）と[彩度](https://ja.wikipedia.org/wiki/彩度 "wikilink")という観点から考える場合、加法混合や減法混合よりも自然で直感的だからである。HSVには[色相](https://ja.wikipedia.org/wiki/色相 "wikilink") (hue)、[彩度](https://ja.wikipedia.org/wiki/彩度 "wikilink") (saturation)、[明度](https://ja.wikipedia.org/wiki/明度 "wikilink") (value) が含まれている。HSB (hue, saturation, brightness) とも呼ばれる。

### HLS

[HLSは](https://ja.wikipedia.org/wiki/HLS色空間 "wikilink")、HSL、HSIなどとも呼ばれる。[色相](https://ja.wikipedia.org/wiki/色相 "wikilink") (hue)、[彩度](https://ja.wikipedia.org/wiki/彩度 "wikilink") (saturation)、[輝度](https://ja.wikipedia.org/wiki/輝度 "wikilink") (luminance) よりなる、HSVに近い表現法である。明度と輝度との違いは値の算出方法である。HSVでは純色と白が同じ明度で表される六角錐モデルだったのに対し、HLSでは純色の輝度を50%とする双六角錐モデルで表現する。

## 放送用

### YIQ

YIQは、[NTSC](https://ja.wikipedia.org/wiki/NTSC "wikilink")の内部処理で使用されるコンポーネント方式である。通常は外部には出力されず、機器内部で使用されるが、過去には[松下電器](https://ja.wikipedia.org/wiki/松下電器 "wikilink")が開発したMビジョン[VTR](https://ja.wikipedia.org/wiki/VTR "wikilink")が、テープにYIQ信号をコンポーネント記録していたという例もある。現在使用されている色差コンポーネント信号のクロマ成分（Cb,Cr）に対して33°回転した色相となり、I軸とQ軸は直交する。
...
欧州を中心に（米日及び米の影響が強い範囲以外で）使用されている[PAL](https://ja.wikipedia.org/wiki/PAL "wikilink")は、クロマにIQ成分の代わりにUV成分を使う。これは現在使用されているCb,Cr（あるいはPb,Pr）成分に近いものであり、IQ方式とは色相が異なる。
...
赤 (Red) と緑 (Green) の強度で色を指定する方法。赤と緑の合成は、RGB色空間と同様に、加算により行なわれる。青 (Blue) がないので、青成分を含む色が正しく表現できない。初期の[テクニカラー](https://ja.wikipedia.org/wiki/テクニカラー "wikilink")フィルムで使われていた。RGK色空間はRG色空間にキー（Key, インクの黒、CMYK色空間でも使われる）を追加した色空間である。
...
## 関連項目
  ...
  - [カラーチャート](https://ja.wikipedia.org/wiki/カラーチャート "wikilink")
