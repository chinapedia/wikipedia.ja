...
ソフト形態は以下のものがある。
  ...
  - TAPE:[カセットテープ](../Page/コンパクトカセット.md "wikilink")。別売りのデータレコーダーを使用する。
    ROM:[ROMカートリッジ](../Page/ロムカセット.md "wikilink")。メガROM（1メガbit以上に容量を拡張したROMカートリッジ）もここに含まれる。
    DISK:3.5インチ[フロッピーディスク](../Page/フロッピーディスク.md "wikilink")。

さらに、主流ではないソフト形態としては以下のものがある。

  - QD:[クイックディスク](../Page/クイックディスク.md "wikilink")。
    BEE CARD:[BEE CARD](https://ja.wikipedia.org/wiki/BEE_CARD "wikilink")。ハドソンと三菱樹脂が共同開発したICカード型のROMカートリッジ。MSX本体へは別売のアダプタを介して接続する。
    LD:[レーザーディスク](../Page/レーザーディスク.md "wikilink")。再生には別売インタフェースと対応LDプレイヤーが必要。[レーザーディスク\#ゲームへの利用](https://ja.wikipedia.org/wiki/レーザーディスク#ゲームへの利用 "wikilink")を参照。
    VHD:[VHD](../Page/VHD.md "wikilink")ディスク。再生には別売インタフェースと対応VHDプレイヤーが必要。[VHDpc_INTER_ACTION](https://ja.wikipedia.org/wiki/VHDpc_INTER_ACTION "wikilink")を参照。
...
## 1983年
  ...
  - アンプルソフトウエア
    ...
    ブギウギジャングル（ROM）
  - オーク
    アニマル・ケアテーカー/ザ・セブンス・デイ（TAPE）
  - クロストーク
    コンドリ（ROM）
    ジョーキングマン（ROM）
  - [コナミ](https://ja.wikipedia.org/wiki/コナミ "wikilink")
    [けっきょく南極大冒険](../Page/けっきょく南極大冒険.md "wikilink")（ROM）
    [スーパーコブラ](https://ja.wikipedia.org/wiki/スーパーコブラ "wikilink")（ROM）
    [タイムパイロット](../Page/タイムパイロット.md "wikilink")（ROM）
    ビデオハスラー（ROM）
    [フロッガー](../Page/フロッガー_\(ゲーム\).md "wikilink")（ROM）
  ...
  - セントラル教育
    ...
    ぶつけっこ（TAPE）
    野菜マインド（TAPE）
  - [チャンピオンソフト](../Page/アリスソフト.md "wikilink")
    おみくじ（TAPE）
  ...
  - [ハドソン](../Page/ハドソン.md "wikilink")
    明るい農園/ファイアーボール（TAPE）
    雨の日は大忙し/スーパードアーズ（TAPE）
    ガンマン/サブマリンシューター（TAPE）
    キラーステーション/バイオテック（TAPE）
    シーボンバー/HELP（TAPE）
...
## 1984年
  ...
  - [JDS](https://ja.wikipedia.org/wiki/JDS_\(企業\) "wikilink")
    プロ野球スーパーシミュレーション（TAPE）

  - MIA
    ザ・コンバット・ポーカー/ストンボール（TAPE）
  ...
  - [アクティビジョン](../Page/アクティビジョン.md "wikilink")/ポニーキャニオン
    ...
    [ピットフォール](../Page/ピットフォール.md "wikilink")（ROM）
  ...
  - アスキー
    ...
    [イリーガスエピソードIV（ROM）](https://ja.wikipedia.org/wiki/イリーガス_EpisodeIV "wikilink")
    ...
    [テセウス（ROM）](https://ja.wikipedia.org/wiki/テセウス_\(ゲーム\) "wikilink")
    ...
    [ボコスカウォーズ](../Page/ボコスカウォーズ.md "wikilink")（ROM）
  ...
  - [キティレコード](https://ja.wikipedia.org/wiki/キティレコード "wikilink")
    [みゆきメモリアル](../Page/みゆき_\(漫画\).md "wikilink")（TAPE）
  ...
  - コナミ
    ...
    [ハイパースポーツ2](https://ja.wikipedia.org/wiki/ハイパーオリンピック'84 "wikilink")（ROM）

    ぽんぽこぱん（ROM）

    わんぱくアスレチック（ROM）

  - コナミ/[ソニー](../Page/ソニー.md "wikilink")
    [ハイパーオリンピック](../Page/ハイパーオリンピック.md "wikilink")I（ROM）

    [ハイパーオリンピック](../Page/ハイパーオリンピック.md "wikilink")II（ROM）

  - コナミ/[レーザーディスク社](../Page/NBCユニバーサル・エンターテイメントジャパン.md "wikilink")
  ...
  - 新紀元社
    アドベンチャーゲームシリーズ1幽霊船（TAPE）

    アドベンチャーゲームシリーズ2宝島（TAPE）

  - [シンキングラビット](../Page/シンキングラビット.md "wikilink")/アスキー
    [倉庫番](../Page/倉庫番.md "wikilink")（ROM）

  - スタジオGEN/アスキー
    BANANA（ROM）

  - [ストラットフォード・コンピューターセンター](../Page/ストラットフォード・コンピューターセンター.md "wikilink")
    [黄金の墓](https://ja.wikipedia.org/wiki/黄金の墓 "wikilink")（TAPE/DISK）

    [ムー大陸の謎](https://ja.wikipedia.org/wiki/ムー大陸の謎 "wikilink")（TAPE）
  ...
  - ソニー
    ...
    [ジュノファースト](https://ja.wikipedia.org/wiki/ジュノファースト "wikilink")（ROM）
  ...
  - [テクノポリス](../Page/テクノポリス_\(雑誌\).md "wikilink")/[徳間書店](../Page/徳間書店.md "wikilink")
    [ナウシカ・ゲーム](https://ja.wikipedia.org/wiki/風の谷のナウシカ#ゲーム "wikilink")（ROM）

  - [電波新聞社](../Page/電波新聞社.md "wikilink")
    [ムーンパトロール](https://ja.wikipedia.org/wiki/ムーンパトロール "wikilink")（ROM）
  ...
  - [東芝EMI](../Page/EMIミュージック・ジャパン.md "wikilink")
    ...
    [五目ならべ](https://ja.wikipedia.org/wiki/五目ならべ "wikilink")（ROM）
    ...
    [花札](../Page/花札.md "wikilink")（ROM）

    [フラッシュスプラッシュ](https://ja.wikipedia.org/wiki/フラッシュスプラッシュ "wikilink")（ROM）
  ...
  - [ナムコ](../Page/バンダイナムコエンターテインメント.md "wikilink")
    ...
    [ワープ&ワープ](https://ja.wikipedia.org/wiki/ワープ&ワープ "wikilink")（2月19日、ROM）
  ...
  - [日本コロムビア](../Page/日本コロムビア.md "wikilink")
    ...
    [Mr.Do\!](https://ja.wikipedia.org/wiki/Mr.Do! "wikilink")（ROM）

  - ハドソン
    カラーボール（ROM）

    [デゼニランド](../Page/デゼニランド.md "wikilink")（TAPE）

    [ファイヤーレスキュー](https://ja.wikipedia.org/wiki/ファイヤーレスキュー "wikilink")（ROM）

  - ハドソン/アスキー
    [インディアンの冒険](https://ja.wikipedia.org/wiki/インディアンの冒険 "wikilink")（ROM）

    [忍者影](https://ja.wikipedia.org/wiki/忍者影 "wikilink")（ROM）

  - [ハドソン](../Page/ハドソン.md "wikilink")/[東芝](../Page/東芝.md "wikilink")
    [ひつじやーい](https://ja.wikipedia.org/wiki/ひつじやーい "wikilink")（ROM）

  - ハドソン/[日本ソフトバンク](https://ja.wikipedia.org/wiki/日本ソフトバンク "wikilink")
    [イタサンドリアス](https://ja.wikipedia.org/wiki/イタサンドリアス "wikilink")（TAPE）

    [MJ-05](https://ja.wikipedia.org/wiki/MJ-05 "wikilink")（TAPE）

    [カエルシューター](https://ja.wikipedia.org/wiki/カエルシューター "wikilink")（TAPE）

    [かみなりぼうや](https://ja.wikipedia.org/wiki/かみなりぼうや "wikilink")（TAPE）

    [来なさい\!](https://ja.wikipedia.org/wiki/来なさい! "wikilink")（TAPE）

    [キャノンボール](https://ja.wikipedia.org/wiki/キャノンボール_\(コンピュータゲーム\) "wikilink")（ROM）

    [ギャングマン](https://ja.wikipedia.org/wiki/ギャングマン "wikilink")（TAPE）

    [銀行強盗](https://ja.wikipedia.org/wiki/銀行強盗_\(コンピュータゲーム\) "wikilink")（TAPE）

    [ゴルフ狂](https://ja.wikipedia.org/wiki/ゴルフ狂_\(ゲーム\) "wikilink")（ROM）

    [ザ・スパイダー](https://ja.wikipedia.org/wiki/ザ・スパイダー "wikilink")（TAPE）

    [三次元ボンバーマン](https://ja.wikipedia.org/wiki/三次元ボンバーマン "wikilink")（TAPE）

    [ジャン狂](../Page/ジャン狂.md "wikilink")（ROM）

    [スカイダイバー](https://ja.wikipedia.org/wiki/スカイダイバー "wikilink")（TAPE）

    [スクエアガーデン](https://ja.wikipedia.org/wiki/スクエアガーデン "wikilink")（TAPE）

    [ゼロファイター](https://ja.wikipedia.org/wiki/ゼロファイター "wikilink")（TAPE）

    [ディメンジョナル・ウォーズ](https://ja.wikipedia.org/wiki/ディメンジョナル・ウォーズ "wikilink")（TAPE）
    ...
    [パワーフェイル](https://ja.wikipedia.org/wiki/パワーフェイル "wikilink")（TAPE）

    [ヒヨコファイター](https://ja.wikipedia.org/wiki/ヒヨコファイター "wikilink")（TAPE）

    [ベジタブルクラッシュ](https://ja.wikipedia.org/wiki/ベジタブルクラッシュ "wikilink")（TAPE）

    [暴走特急SOS](https://ja.wikipedia.org/wiki/暴走特急SOS "wikilink")（TAPE）

    [爆弾男](https://ja.wikipedia.org/wiki/爆弾男_\(ゲーム\) "wikilink")（ROM）

    [ポリスドッグ](https://ja.wikipedia.org/wiki/ポリスドッグ "wikilink")（TAPE）

    [ミスターバタフライ](https://ja.wikipedia.org/wiki/ミスターバタフライ "wikilink")（TAPE）

  - [パナソフト（松下電器産業）](https://ja.wikipedia.org/wiki/パナソニック "wikilink")
    パナソフトのベースボール（MSXベースボール）（ROM）

  - [バンダイ](../Page/バンダイ.md "wikilink")
    [ウルトラマン](../Page/ウルトラマン.md "wikilink")（ROM）

    [機動戦士ガンダム](../Page/機動戦士ガンダム.md "wikilink")（ROM）
  ...
  - ポニーキャニオン
    [さよならジュピター](../Page/さよならジュピター.md "wikilink")（TAPE）

    チャンピオンズ（TAPE）

    [超人ロック](../Page/超人ロック.md "wikilink")（TAPE）

    [南極物語](../Page/南極物語.md "wikilink")（TAPE）

    [フルーツパニック](https://ja.wikipedia.org/wiki/フルーツパニック "wikilink")（TAPE）
  ...
  - マスティール/アスキー
    ...
    [アストロロボSASA](../Page/アストロロボSASA.md "wikilink")（ROM）
  ...
  - レーザーディスク社
    [アストロンベルト](https://ja.wikipedia.org/wiki/アストロンベルト "wikilink")（LD）

    ストライクミッション（LD）

    ミステリーディスク殺しの迷路（LD+TAPE）

    ミステリーディスク殺人はいかが（LD+TAPE）
...
## 1985年
  ...
  - HAL研究所
    ...
    [カラ丸珍道中](https://ja.wikipedia.org/wiki/カラ丸珍道中 "wikilink")（ROM）
    [キュースター](https://ja.wikipedia.org/wiki/キュースター "wikilink")（ROM）
    [てつまん](https://ja.wikipedia.org/wiki/てつまん "wikilink")（ROM）
  ...
  - T\&E SOFT
    [ハイドライド](https://ja.wikipedia.org/wiki/ハイドライドシリーズ#ハイドライド "wikilink")（ROM）※MSX1版
    ハイドライド（TAPE/DISK）※MSX2版
    [レイドック](../Page/レイドック.md "wikilink")（DISK）
    [惑星メフィウス](https://ja.wikipedia.org/wiki/惑星メフィウス "wikilink")（TAPE）
  - T\&E SOFT/[日本ビクター](../Page/日本ビクター.md "wikilink")
    惑星メフィウス（[VHD](../Page/VHD.md "wikilink")）
  - ZAP/アスキー
    グライダー（ROM）
    フェアリー（ROM）
  ...
  - アクティビジョン/ポニーキャニオン
    ...
    [ロックンボルト](https://ja.wikipedia.org/wiki/ロックンボルト "wikilink")（ROM）
  - アスキー
    クィーンズゴルフ（ROM）
    クィーンズゴルフジョイパック（TAPE）
    [サンダーボール](https://ja.wikipedia.org/wiki/サンダーボール "wikilink")（ROM）
    ステッパー（ROM）
    [倉庫番](../Page/倉庫番.md "wikilink")ツールキット（TAPE）
    [ぺんぎんくんWARS](https://ja.wikipedia.org/wiki/ぺんぎんくんWARS "wikilink")（ROM）
  - アートサプライ
    ドッキング（TAPE）
  - イエローホーン/アスキー
    [ウォーロイド](https://ja.wikipedia.org/wiki/ウォーロイド "wikilink")（ROM）
    レッドゾーン（ROM）
  - 宇宙堂
    [雀華](https://ja.wikipedia.org/wiki/雀華 "wikilink")（ROM）
  - [エニックス](https://ja.wikipedia.org/wiki/エニックス "wikilink")
    [ウイングマン](../Page/ウイングマン.md "wikilink")（TAPE）
    ザース（TAPE）
    [ドアドア](../Page/ドアドア.md "wikilink")mk2（ROM）
    ファランクス（TAPE）
    [ポートピア連続殺人事件](../Page/ポートピア連続殺人事件.md "wikilink")（TAPE）
  - オメガシステム
    ブリッツ（TAPE）
    ベルリン（TAPE）
    Uボート（TAPE）
  ...
  - [光栄](../Page/コーエー.md "wikilink")
    ...
    [信長の野望](../Page/信長の野望_\(初代\).md "wikilink")（ROM）
  - コスモスコンピューター
  ...
  - [コンプティーク](../Page/コンプティーク.md "wikilink")
    [オイルズ・ウェル](https://ja.wikipedia.org/wiki/オイルズ・ウェル "wikilink")（ROM）
    [グロックスリベンジ](https://ja.wikipedia.org/wiki/グロックスリベンジ "wikilink")（ROM）
    [ダムバスター](https://ja.wikipedia.org/wiki/ダムバスター "wikilink")（ROM）
    [チャンピオンバルダーダッシュ](https://ja.wikipedia.org/wiki/チャンピオンバルダーダッシュ "wikilink")（ROM）
    [ハイスト](https://ja.wikipedia.org/wiki/ハイスト "wikilink")（ROM）
    [ブルース・リー](../Page/ブルース・リー.md "wikilink")（ROM）
  - シャノアール/アスキー
    プロフェッショナル麻雀（ROM）
  - [スクウェア](../Page/スクウェア_\(ゲーム会社\).md "wikilink")
    [ドラゴンスレイヤー](../Page/ドラゴンスレイヤー_\(ゲーム\).md "wikilink")（ROM）
  - [セガ](https://ja.wikipedia.org/wiki/セガ "wikilink")/ポニーキャニオン
    [どきどきペンギンランド](https://ja.wikipedia.org/wiki/どきどきペンギンランド "wikilink")（ROM）
  - ソニー/テクノソフト
    [バックギャモン](../Page/バックギャモン.md "wikilink")（ROM）
  - ソニー
    [アルファスクアドロン](https://ja.wikipedia.org/wiki/アルファスクアドロン "wikilink")（ROM）
    MSX実戦囲碁（DISK）
    MSX将棋（ROM）
    頑張れトラックボーイペイロード（ROM）
    [コスモエクスプローラ](https://ja.wikipedia.org/wiki/コスモエクスプローラ "wikilink")（ROM）
    コンピューターチェス（ROM）
    コンピュータービリヤード（ROM）
    サイオン（ROM）
    スーパーゲームコレクション（DISK）
  ...
  - [ソフトスタジオWING](https://ja.wikipedia.org/wiki/ソフトスタジオWING "wikilink")
    [銀河戦士ダイモス](https://ja.wikipedia.org/wiki/銀河戦士ダイモス "wikilink")（TAPE）
    白と黒の伝説［百鬼編］（TAPE）
    モリコ脅迫事件（TAPE）
  - ソフトプロ
    EXCITING PACK（TAPE）
    [ビジゴス](https://ja.wikipedia.org/wiki/ビジゴス "wikilink")（TAPE）
  ...
  - 東芝EMI
    [宇宙戦士「隼」](https://ja.wikipedia.org/wiki/宇宙戦士「隼」 "wikilink")（ROM）
    [功夫大君](https://ja.wikipedia.org/wiki/功夫大君 "wikilink")（ROM）
    [クエスト・太古の恋物語](https://ja.wikipedia.org/wiki/クエスト・太古の恋物語 "wikilink")（ROM）
    将棋名人（ROM）
    [人魚伝説](https://ja.wikipedia.org/wiki/人魚伝説_\(映画\) "wikilink")（ROM）
    パチコン（ROM）
    ブロッケードランナー（ROM）
  - [徳間書店](../Page/徳間書店.md "wikilink")
    For MSX SPECIAL（TAPE）
    For MSX SPECIALII（TAPE）
  - トモソフトインターナショナル
    [007“ア・ビュー・トゥ・ア・キル”](https://ja.wikipedia.org/wiki/007_美しき獲物たち "wikilink")（TAPE）
    （TAPE）
    （TAPE）
    フライトパース737（TAPE）
  - ナムコ/日本ビクター
    [ゼビウス](../Page/ゼビウス.md "wikilink")マップ（VHD）
  - ナムコ
    [ミニゴルフ](https://ja.wikipedia.org/wiki/ミニゴルフ_\(コンピューターゲーム\) "wikilink")（[4月6日](../Page/4月6日.md "wikilink")、ROM）
  - [日本エレクトロニクス](https://ja.wikipedia.org/wiki/日本エレクトロニクス "wikilink")
    [ジグソーパズル](../Page/ジグソーパズル.md "wikilink")（ROM）
  - 日本コロムビア
    ウェディングベル（TAPE）
    オストリッチ（TAPE）
    THEこいこいAND花合わせ（TAPE）
  ...
  - [日本テレネット](../Page/日本テレネット_\(ゲーム会社\).md "wikilink")
    ...
    パイパー（TAPE）
  - 日本ビクター
    [サンダーストーム](../Page/サンダーストーム.md "wikilink")（VHD）
    ザ・プレイヤー・クラブ（VHD）
    アリスの科学実験室（VHD）
    ビデオすくらんぶる（VHD）
    VROOM（VHD）
  ...
  - バンダイ
    [キン肉マン コロシアムデスマッチ](../Page/キン肉マン_コロシアムデスマッチ.md "wikilink")（ROM）
  - パックスソフトニカ
    ベースボール（TAPE）
    麻雀秘伝（TAPE）
  ...
  - ピクセル
    ゼータ2,000（TAPE）
  - ボーステック
    [EGGY](https://ja.wikipedia.org/wiki/EGGY "wikilink")（TAPE）★
    マクロスカウントダウン（ROM）
    [妖怪探偵ちまちま](https://ja.wikipedia.org/wiki/妖怪探偵ちまちま "wikilink")（ROM）
  - ポニーキャニオン
    [ガンバレ\!味覚の国の大戦争](https://ja.wikipedia.org/wiki/ガンバレ!味覚の国の大戦争 "wikilink")（TAPE）
    [クルゼーダー](https://ja.wikipedia.org/wiki/クルゼーダー "wikilink")（ROM）
    [ゴルゴ13狼の巣](https://ja.wikipedia.org/wiki/ゴルゴ13狼の巣 "wikilink")（ROM/TAPE）
    [ザクソン](https://ja.wikipedia.org/wiki/ザクソン "wikilink")（ROM）
    シーソー（ROM）
    [G.P.ワールド](https://ja.wikipedia.org/wiki/G.P.ワールド "wikilink")（ROM）
    [ズーム909](https://ja.wikipedia.org/wiki/ズーム909 "wikilink")（ROM）
    [スパルタンX](../Page/スパルタンX.md "wikilink")（TAPE）
    [戦闘メカザブングル ブルーゲールPART1](https://ja.wikipedia.org/wiki/戦闘メカザブングル_ブルーゲールPART1 "wikilink")（TAPE）
    [チェッカーズ インTANTANたぬき](https://ja.wikipedia.org/wiki/CHECKERS_IN_TAN_TAN_たぬき "wikilink")（ROM）
    チャレンジダービー（ROM）
    チャンピオンサッカー（ROM）
    チャンピオンプロレス（ROM）
    チャンピオンボクシング（ROM）
  ...
  - ポリシー
    [サファリX](https://ja.wikipedia.org/wiki/サファリX "wikilink")（TAPE）
    [タイムトレック](https://ja.wikipedia.org/wiki/タイムトレック "wikilink")（TAPE）
  - マイクロキャビン
    [ウォーリィ](https://ja.wikipedia.org/wiki/ウォーリィ "wikilink")（TAPE）
    SHOGI（ROM）
    ディスクウォーリア（TAPE）
    [は〜りぃふぉっくす雪の魔王編](https://ja.wikipedia.org/wiki/は〜りぃふぉっくす雪の魔王編 "wikilink")（ROM/TAPE）
    ハッピーフレット（TAPE）
    飛車（ROM/TAPE）
    リザード（TAPE）
    レスフリックス（TAPE）
  - マジカルズゥ
    ...
    ミュージカルズゥ（TAPE）
  - マスティール/アスキー
    [アクトマン](https://ja.wikipedia.org/wiki/アクトマン "wikilink")（ROM）
    アンジェロ（ROM）
    JUMP（ROM）
    タティカ（ROM）
  - メルソフト
    ...
    まるで孫悟空（TAPE）
  - レーザーディスク社
    [インター・ステラ](https://ja.wikipedia.org/wiki/インター・ステラ "wikilink")（LD）
    [エシュズオルンミラ](https://ja.wikipedia.org/wiki/エシュズオルンミラ "wikilink")（LD）
    [コスモスサーキット](https://ja.wikipedia.org/wiki/コスモスサーキット "wikilink")（LD）
    [スターファイターズ](https://ja.wikipedia.org/wiki/スターファイターズ "wikilink")（LD）
    [日本海大海戦・海ゆかば](https://ja.wikipedia.org/wiki/日本海大海戦・海ゆかば "wikilink")（LD）
    [ローリングブラスター](https://ja.wikipedia.org/wiki/ローリングブラスター "wikilink")（LD）
  - レーベンプロ
...
## 1986年
  ...
  - BPS/アスキー
    [ブラックオニキスII](https://ja.wikipedia.org/wiki/ブラックオニキスII "wikilink")（ROM）
  - [GA夢](https://ja.wikipedia.org/wiki/GA夢 "wikilink")/[ホット・ビィ](../Page/ホット・ビィ.md "wikilink")
    ザ・ブラックバス（TAPE）
  - HAL研究所
    ダンクショット（ROM）
    ブルとマイティー危機一髪（ROM）
  ...
  - アスキー
    [キャッスルエクセレント](https://ja.wikipedia.org/wiki/キャッスルエクセレント "wikilink")（ROM）
    [ザ・キャッスル](../Page/ザ・キャッスル.md "wikilink")（ROM）
    [J.P.ウィンクル](../Page/J.P.ウィンクル.md "wikilink")（ROM）
    [新ベストナインプロ野球](https://ja.wikipedia.org/wiki/新ベストナインプロ野球 "wikilink")（DISK）
    [ダンジョンマスター](../Page/ダンジョンマスター_\(MSX\).md "wikilink")（ROM）
    TZRグランプリライダー（ROM）
  - エニックス
  ...
  - オメガシステム
    ...
    ゆき（TAPE）
  - カシオ計算機
    [伊賀忍法帖満月城の戦い](https://ja.wikipedia.org/wiki/伊賀忍法帖満月城の戦い "wikilink")（ROM）
    [エクゾイドZ](https://ja.wikipedia.org/wiki/エクゾイドZ "wikilink")（ROM）
    エクゾイドZエリア5（ROM）
    賢者の石（ROM）
    [仔猫の大冒険](https://ja.wikipedia.org/wiki/仔猫の大冒険 "wikilink")（ROM）
    [シンドバッド7つの冒険](https://ja.wikipedia.org/wiki/シンドバッド7つの冒険 "wikilink")（ROM）
  ...
  - 光栄
    ...
    [信長の野望](https://ja.wikipedia.org/wiki/信長の野望 "wikilink")（DISK）
  - コスモスコンピューター
    [超戦士ザイダーバトルオブペガス](https://ja.wikipedia.org/wiki/超戦士ザイダーバトルオブペガス "wikilink")（ROM）
  - コナミ
  ...
  - サムソンSOFT
    ガイア（TAPE）
  - [ザインソフト](https://ja.wikipedia.org/wiki/ザインソフト "wikilink")
    アラモ（ROM）
    スーパートリトーン（ROM）
    トリトーン（ROM/TAPE）
  ...
  - ソニー
    ...
    雀聖（ROM）
    渋滞パニックトラフィック（ROM）
    [チャンピオンシップロードランナー](../Page/ロードランナー.md "wikilink")（ROM）
    ニューアダム&イブ（DISK）
    プレイボール（ROM）
    [魔法使いウィズ](https://ja.wikipedia.org/wiki/魔法使いウィズ_\(ゲーム\) "wikilink")（ROM）
    [ミッドナイトブラザーズずっこけ探偵](https://ja.wikipedia.org/wiki/ミッドナイトブラザーズずっこけ探偵 "wikilink")（ROM）
  - ソフトスタジオWING
    白と黒の伝説\[輪廻転生編\]（TAPE）
    日曜日に宇宙人が……?（DISK）
  - タイトー
    [影の伝説](../Page/影の伝説.md "wikilink")（ROM）
    [ジャイロダイン](../Page/ジャイロダイン.md "wikilink")（ROM）
  - デービーソフト
    [クロスブレイム](https://ja.wikipedia.org/wiki/クロスブレイム "wikilink")（ROM）
    [らぷてっく](https://ja.wikipedia.org/wiki/らぷてっく "wikilink")2（ROM）
  - テクノソフト
    [ばってんタヌキの大冒険](https://ja.wikipedia.org/wiki/ばってんタヌキの大冒険 "wikilink")（ROM）
  - テクノポリス
    プロフェッショナルベースボール（ROM）
  - 電波新聞社
    [デーモンクリスタル](https://ja.wikipedia.org/wiki/デーモンクリスタル "wikilink")（ROM）
    [バーガータイム ハンバーガー](https://ja.wikipedia.org/wiki/バーガータイム "wikilink")（ROM）
  - 東芝EMI
    軍人将棋軍神マース（ROM）
    スカーレット7（ROM）
    天才ラビアン大奮戦（ROM）
  ...
  - 東宝
    モンスターズフェア（ROM）
  - 徳間書店
    [ロットロット](https://ja.wikipedia.org/wiki/ロットロット "wikilink")（ROM）
  - トモソフトインターナショナル
    [忍者タイガー](https://ja.wikipedia.org/wiki/忍者タイガー "wikilink")（TAPE）
  - ナムコ
    [ドルアーガの塔](../Page/ドルアーガの塔.md "wikilink")（ROM）
  - 日本デクスタ
    ガンフライト（ROM）
    [シティコネクション](../Page/シティコネクション_\(ゲーム\).md "wikilink")（ROM）
    [ナイトシェード](https://ja.wikipedia.org/wiki/ナイトシェード "wikilink")（ROM）
    [ナイトロアー](https://ja.wikipedia.org/wiki/ナイトロアー "wikilink")（ROM）
    [忍者じゃじゃ丸くん](../Page/忍者じゃじゃ丸くん.md "wikilink")（ROM）
  - 日本テレネット
    アルバトロス（ROM）
    [ファイナルゾーンウルフ](https://ja.wikipedia.org/wiki/ファイナルゾーンウルフ "wikilink")（ROM）
    [夢幻戦士ヴァリス](../Page/夢幻戦士ヴァリス.md "wikilink")（ROM）
  - 日本ビクター
    [TIME GAL](../Page/タイムギャル.md "wikilink")（VHD）
    [ロードブラスター](../Page/ロードブラスター.md "wikilink")（VHD）
    バーディトライ（VHD）
  - [日本ファルコム](../Page/日本ファルコム.md "wikilink")
    [ロマンシア](../Page/ロマンシア.md "wikilink")（ROM）※MSX1版
    ロマンシア（ROM）※MSX2版
  - パックスソフトニカ
    アタックフォー（ROM）
  - パック・イン・ビデオ
    [スーパーランボースペシャル](https://ja.wikipedia.org/wiki/スーパーランボースペシャル "wikilink")（ROM）
    [スペースキャンプ](https://ja.wikipedia.org/wiki/スペースキャンプ "wikilink")（ROM）
  - ハドソン
    [スターソルジャー](../Page/スターソルジャー.md "wikilink")（BEE CARD）
    [高橋名人の冒険島](../Page/高橋名人の冒険島.md "wikilink")（BEE CARD）
  ...
  - ピクセル
    サンダーボルト（TAPE）
  - ビクター音楽産業
    [ナイルの涙](https://ja.wikipedia.org/wiki/ナイルの涙 "wikilink")（ROM）
    ペガサス（ROM）
    ポイントX占領作戦（ROM）
    [ミクとしおりのニャンニャンプロレス](https://ja.wikipedia.org/wiki/ミクとしおりのニャンニャンプロレス "wikilink")（ROM）
    モールモール（ROM）
  ...
  - ポニーキャニオン
    ...
    将棋（ROM）
    谷川浩司の将棋指南（ROM）
    [チャンピオンアイスホッケー](https://ja.wikipedia.org/wiki/チャンピオンアイスホッケー "wikilink")（ROM）
    [チャンピオン剣道](https://ja.wikipedia.org/wiki/チャンピオン剣道 "wikilink")（ROM）
    [忍者プリンセス](https://ja.wikipedia.org/wiki/忍者プリンセス "wikilink")（ROM）
    [バック トゥ・ザ フューチャー](https://ja.wikipedia.org/wiki/バック・トゥ・ザ・フューチャーシリーズ#ゲーム "wikilink")（ROM）※MSX1版
    [バック トゥ・ザ フューチャー™ アドベンチャー](https://ja.wikipedia.org/wiki/バック・トゥ・ザ・フューチャーシリーズ#ゲーム "wikilink")（DISK）※MSX2版
    [ハングオン](../Page/ハングオン_\(ゲーム\).md "wikilink")（ROM）
    [バンクパニック](https://ja.wikipedia.org/wiki/バンクパニック "wikilink")（ROM）
    ヒランヤの謎（DISK）
    ポリスストーリー（ROM）
  - マイクロキャビン
    棋太平（ROM/DISK）
  ...
  - ランドコンピュータ
    日本縦断（DISK）
  - レーザーディスク社
    [宇宙から見た地球](https://ja.wikipedia.org/wiki/宇宙から見た地球 "wikilink")（LD）
...
## 1989年
  ...
  - BIT2
    [秘録 首斬り館](https://ja.wikipedia.org/wiki/秘録_首斬り館_〜逐電屋藤兵衛〜 "wikilink")（5月12日、DISK）
    サウルスランチ（12月11日、DISK）
  - BPS
    テトリス（9月8日、ROM）※DISK版は1988年発売
  - DRO SOFT(スペイン)
    Aaargh\!（TAPE）
  - GA夢/ホットビィ
    悶々怪物（ROM）
  ...
  - アスキー
    [ウィザードリィ](../Page/ウィザードリィ.md "wikilink")2ダイヤモンドの騎士（11月22日、DISK）
    [カオスエンジェルズ](../Page/カオスエンジェルズ.md "wikilink")（5月19日、DISK）
    琉球（8月8日、DISK）
  - アダルティン/スタジオパンサー
  ...
  - ウインキーソフト
    アメリカンサクセス（DISK）
  - ウェンディマガジン
    [ピンクソックス](https://ja.wikipedia.org/wiki/PINK_SOX "wikilink")（12月1日、DISK）
  - ウルフチーム
    アークスII（12月21日、DISK）
    ガウディバルセロナの風（7月28日、DISK）
    ミッドガルツ（5月26日、DISK）※MSX2+版
    ミッドガルツSIDE-A（6月30日、DISK）※MSX2版
    ミッドガルツSIDE-B（6月30日、DISK）※MSX2版
  - エニックス
    [アンジェラス 〜悪魔の福音〜](https://ja.wikipedia.org/wiki/アンジェラス_〜悪魔の福音〜 "wikilink")（6月30日、DISK）
  - [エルフ](../Page/エルフ_\(ブランド\).md "wikilink")
    ぴんきぃ・ぽんきぃ第1集（8月11日、DISK）
    ぴんきぃ・ぽんきぃ第2集（8月11日、DISK）
    ぴんきぃ・ぽんきぃ第3集（8月11日、DISK）
    プライベートスクール（4月19日、DISK）
  - クリスタルソフト
    クリムゾンII（7月19日、DISK）
  - グレイト
    美しき獲物たちV（DISK）
    美しき獲物たちVI（DISK）
    ガールズパラダイス楽園の天使たち（9月15日、DISK）
    世紀末種蒔伝説少女遊戯（DISK）
    トワイライトゾーンIII長くて甘い夜（8月11日、DISK）
    気分はぱすてるたっち（12月14日、DISK）
    パピットショウ（5月20日、DISK）
  - ゲームアーツ
  ...
  - コナミ
    ...
    [ゴーファーの野望 エピソードII](https://ja.wikipedia.org/wiki/ゴーファーの野望_エピソードII "wikilink")（ROM）★
    コナミゲームコレクション番外編（DISK）
    [魂斗羅](https://ja.wikipedia.org/wiki/魂斗羅 "wikilink")（5月26日、ROM）★
  ...
  - コンパイル
    ...
    ディスクステーション6号（8月8日、DISK）
    ディスクステーション7号（10月8日、DISK）
    ディスクステーション1月号（12月11日、DISK）
    ディスクステーションスペシャル春号（DISK）
    ディスクステーションスペシャル初夏号（5月2日、DISK）
    ディスクステーションスペシャル夏休み号（7月8日、DISK）
    ディスクステーションスペシャル秋号（9月8日、DISK）
    ディスクステーションスペシャルクリスマス号（11月7日、DISK）
  - コンピューターブレイン
    テレフォンクラブストーリー（11月1日、DISK）
  - ザインソフト
    ガルフストリーム（7月13日、DISK）
    トリトーン2（DISK）
    ハイデッガー（DISK）
  - システムソフト
    銀河（6月23日、DISK）
    [上海II](../Page/上海_\(ゲーム\).md "wikilink")（10月30日、DISK）
    [マスターオブモンスターズ](../Page/マスターオブモンスターズ.md "wikilink")（DISK）
    マスターオブモンスターズマップコレクション（DISK）
  - ジャスト
    コスモスクラブ（DISK）
    デリンジャー（DISK）
  ...
  - スタジオパンサー
    ...
    天九牌（DISK）
    天九牌スペシャル桃源の宴（12月27日、DISK）
  - 全流通
    [艶談・源平争乱記いろはにほへと](https://ja.wikipedia.org/wiki/艶談・源平争乱記いろはにほへと "wikilink")（DISK）
    [艶談・徳川興隆記ごらくいん](https://ja.wikipedia.org/wiki/艶談・源平争乱記いろはにほへと#艶談・徳川興隆記ごらくいん "wikilink")（DISK）
    [艶談・歴史絵巻ぬかたのおおきみ](https://ja.wikipedia.org/wiki/艶談・源平争乱記いろはにほへと#艶談・歴史絵巻ぬかたのおおきみ "wikilink")（12月21日、DISK）
    禁断のパラダイス（9月20日、DISK）
  - ソニー
    プレイボールIII（12月21日、DISK）
    メンバーシップゴルフ（12月21日、DISK）
  - ソフトスタジオWING
    [怨霊戦記](https://ja.wikipedia.org/wiki/怨霊戦記 "wikilink")（6月1日、DISK）
    魔宮殿（12月22日、DISK）
  - チャンピオンソフト
    ポップレモン（4月22日、DISK）
    タウビート（4月27日、DISK）
  - データウエスト
    第4のユニット3デュアルターゲット（DISK）
    MistyVol.1（10月24日、DISK）
    MistyVol.2（11月24日、DISK）
  - デービーソフト
    [今夜も朝までPOWERFULまあじゃん2データ集全2巻](../Page/今夜も朝までPOWERFULまぁじゃん.md "wikilink")（6月28日、DISK）
  - 徳間書店
    MSXFANファンダムライブラリ5（5月26日、DISK）
    MSXFANファンダムライブラリ6（11月25日、DISK）
    死体置場で夕食を（9月13日、DISK）
  - ドット企画
    グラムキャッツ（DISK）
    スーパークイズ（12月20日、DISK）
  - ナツメ
    三つ目がとおる（4月20日、ROM）
  - ナムコ
    [パックマニア](../Page/パックマニア.md "wikilink")（3月28日、ROM/DISK）
    [プロ野球ファミリースタジアム ホームランコンテスト](https://ja.wikipedia.org/wiki/プロ野球ファミリースタジアム_\(MSX2\)#ホームランコンテスト "wikilink")（4月29日、DISK）
    [プロ野球ファミリースタジアム ペナントレース](https://ja.wikipedia.org/wiki/プロ野球ファミリースタジアム_\(MSX2\) "wikilink")（11月21日、ROM）
  - [日本クリエイト](../Page/ニホンクリエイト.md "wikilink")
    野球道（DISK）
  - 日本テレネット
    [夢幻戦士ヴァリス](../Page/夢幻戦士ヴァリス.md "wikilink")II（8月5日、DISK）
    めいず君（6月10日、DISK）
  - 日本ファルコム
    [ワンダラーズフロムイース](../Page/イースIII.md "wikilink")（10月20日、DISK）
  - ハート電子産業
    DOLLパラゴンセクサドール（12月8日、DISK）
  - パック・イン・ビデオ
    ザ・ゴルフ（5月21日、DISK）※ROM版は1988年発売
    ザ・ゴルフコース集（DISK）
    シルヴィアーナ（9月15日、DISK）
  - パナソフト
    DISKPAC（DISK）
  - ハミングバードソフト
    アグニの石（6月17日、DISK）
    [ラプラスの魔](https://ja.wikipedia.org/wiki/ラプラスの魔_\(コンピュータゲーム\) "wikilink")（4月15日、DISK）
  - ビクター音楽産業
    釣りキチ三平釣り仙人編（ROM）
    [やじうまペナントレース](https://ja.wikipedia.org/wiki/やじうまペナントレース "wikilink")（8月21日、DISK）
  - ファミリーソフト
    韋駄天いかせ男1麦子に逢いたい（6月15日、DISK）
    韋駄天いかせ男2人生の意味（6月15日、DISK）
    韋駄天いかせ男3戦後編（7月8日、DISK）
  - フェアリーテール
    [リップスティックアドベンチャー](https://ja.wikipedia.org/wiki/リップスティックアドベンチャー "wikilink")（5月30日、DISK）
  - ブロダーバンドジャパン
    ディアブロ（DISK）
  - ヘルツ
    ハイディフォス（7月1日、DISK）
  - ボーステック
    [銀河英雄伝説](../Page/銀河英雄伝説_\(ゲーム\).md "wikilink")（11月9日、DISK）
    銀河英雄伝説パワーアップ&シナリオ集（12月14日、DISK）
    ファンタジーIIIニカデモスの怒り（6月10日、DISK）
  - ポニーキャニオン
    アークティック（7月21日、ROM）
    [ウルティマ](../Page/ウルティマ.md "wikilink")I（9月21日、DISK）
    [ウルティマ](../Page/ウルティマ.md "wikilink")II（DISK）
    [ウルティマ](../Page/ウルティマ.md "wikilink")III（DISK）
    [A列車で行こう](../Page/A列車で行こうシリーズ.md "wikilink")（8月21日、ROM）
    熱血柔道（ROM）
  ...
  - マイティマイコンシステム
    プロの碁パート2（DISK）
  - [もものきはうす](../Page/コンパイル_\(企業\).md "wikilink")
    ピーチアップ創刊号（11月25日、DISK）
  - リバーヒルソフト
    JBハロルドの事件簿\#4～D.C.コネクション（7月28日、DISK）
  - ログインソフト
    学園ドラマ（DISK）
    LASER FIGHT（DISK）
...
## 1990年
  ...
  - [カクテルソフト](../Page/カクテル・ソフト.md "wikilink")
    [きゃんきゃんバニースペリオール](../Page/きゃんきゃんバニーシリーズ.md "wikilink")（7月11日、DISK）
...
## 1991年
  ...
  - BIT2
    サウルスランチMIDI\#1（4月25日、DISK）※カシオCSM-1用、ローランドCM-32L用
    サウルスランチMIDI\#1（6月25日、DISK）※カワイPhm用
    サウルスランチVol.4（9月13日、DISK）
    サウルスランチVol.5（11月14日、DISK）
  - GA夢/ホットビィ
    [スーパー上海ドラゴンズアイ](../Page/上海_\(ゲーム\).md "wikilink")（12月16日、DISK）
  - HARD
    ソープランドストーリーIIメモリー（DISK）
  - MEDO
    エストランド物語（6月8日、DISK）
  - アスキー
    ダンジョンハンター（1月8日、ROM）
  - アリスソフト
    [D.P.S. SG set2](../Page/D.P.S..md "wikilink")（5月15日、DISK）
    [D.P.S. SG data2](../Page/D.P.S..md "wikilink")（5月15日、DISK）
    [闘神都市](https://ja.wikipedia.org/wiki/闘神都市 "wikilink")（12月15日、DISK）
    [ランスII反逆の少女達](../Page/Rance.md "wikilink")（DISK）
  - ウェンディマガジン
    ピンクソックス4（1月15日、DISK）
    ピンクソックス5（4月16日、DISK）
    ピンクソックス6（7月6日、DISK）
    ピンクソックス7（10月4日、DISK）
    ピンクソックスプレゼンツ（12月13日、DISK）
    ピンクソックスマニア（12月13日、DISK）
    どしふんスペシャル（12月13日、DISK）
    ピンクソックスマニア2（DISK）
    ピンクソックスマニア3（DISK）
  - ウルフチーム
    NIKO2（12月25日、DISK）
  - エルフ
    ドラゴンナイトII（1月31日、DISK）
    RAY・GUN（4月11日、DISK）
  - カクテルソフト
    イルミナ\!（4月26日、DISK）
  ...
  - コンパイル
    ...
    ディスクステーション21号（1月11日、DISK）
    ディスクステーション22号（2月8日、DISK）
    ディスクステーション23号（3月8日、DISK）
    ディスクステーション24号（4月9日、DISK）
    ディスクステーション25号（5月10日、DISK）
    ディスクステーション26号（6月11日、DISK）
    ディスクステーション27号（7月9日、DISK）
    ディスクステーション28号（8月9日、DISK）
    ディスクステーション29号（9月6日、DISK）
    ディスクステーション30号（10月9日、DISK）
  ...
  - 全流通
    宇宙翔けるビジネスマン（2月5日、DISK）
    アズ・ユー・ライク やりたい放題3（2月5日、DISK）
  - ソフトスタジオWING
    白と黒の伝説総集編（DISK）
  - [ディーオー](../Page/ディーオー.md "wikilink")
    星の砂物語（3月5日、DISK）
  - ディスカバリー
    スィートエモーション（12月18日、DISK）
  - データウエスト
    MistyVol.7（1月25日、DISK）
  - テクノポリス
    キミだけに愛を…（9月21日、DISK）
    ドラゴンアイズ（3月2日、DISK）
  - 日本クリエイト
    野球道IIデータブック'91（5月17日、DISK）
  - バーディソフト
    CAL（DISK）
    CALII（11月8日、DISK）
  ...
  - ハート電子産業
    毎日がえっち（8月2日、DISK）
  - ファミリーソフト
    [聖戦士ダンバイン](../Page/聖戦士ダンバイン.md "wikilink")（1月19日、DISK）
  - フェアリーテール
    フェアリーテール海賊版（6月2日、DISK）
    X・na（3月20日、DISK）
    [校内写生](https://ja.wikipedia.org/wiki/校内写生 "wikilink")1巻（9月13日、DISK）
    校内写生2巻（9月13日、DISK）
    校内写生3巻（9月13日、DISK）
    [ドラゴンシティX指定](https://ja.wikipedia.org/wiki/ドラゴンシティX指定 "wikilink")（2月22日、DISK）
    舞（12月22日、DISK）
    私をゴルフに連れてって（4月12日、DISK）
    ギゼ\!（12月28日、DISK）
  - ブラザー工業
    [ソーサリアン](../Page/ソーサリアン.md "wikilink")（8月10日、DISK）※パッケージ版
    ソーサリアン（8月30日、DISK）※タケル版
    [戦国ソーサリアン](../Page/ソーサリアン.md "wikilink")（12月20日、DISK）※タケル版
  - ボーステック
    銀河英雄伝説IIDXkit（6月14日、DISK）
    銀河英雄伝説IIDXset（7月12日、DISK）
    ファンタジーIV英雄の血脈（1月30日、DISK）
  - ポニーキャニオン
  ...
  - もものきはうす
    ピーチアップ8号（1月25日、DISK）
    ピーチアップ総集編（3月26日、DISK）
    ピーチアップ総集編II(笑)（11月26日、DISK）

## 1992年

  - BIT2
    サウルスランチVol.6（2月13日、DISK）
    サウルスランチMIDI\#2（6月12日、DISK）
    サウルスランチMIDI\#3（9月25日、DISK）※ローランドCM-32L用
    サウルスランチMIDI\#4（11月13日、DISK）※ローランドCM-32L用
  - MSXマガジン
    クイッピー（DISK）
    Dante2（DISK）
    Dante優秀作品CROSS KINGDOM（DISK）
    Dante優秀作品THANCHE-LAND（DISK）
  - アスキー
    エアホッケー（5月6日、DISK）
    シューティングコレクション（5月6日、DISK）
  - アトリエタカ
    2021SNOOKY\!（1月1日、DISK）※通販のみ
  - アリスソフト
    [D.P.S. SG set3](../Page/D.P.S..md "wikilink")（2月15日、DISK）
    [D.P.S. SG data3](../Page/D.P.S..md "wikilink")（DISK）
    Dr.STOP！（DISK）
  - ウェンディマガジン
    ピンクソックス8（4月24日、DISK）※初回ロットのみジグソーパズル付き。
    YUKA・ユカの不思議な体験
  - エルフ
    [ELLE](../Page/ELLE_\(アダルトゲーム\).md "wikilink")（2月17日、DISK）
  - カクテルソフト
    [卒業写真/美姫](https://ja.wikipedia.org/wiki/卒業写真/美姫 "wikilink")（3月26日、DISK）
  - 光栄
    [蒼き狼と白き牝鹿・元朝秘史](../Page/蒼き狼と白き牝鹿・元朝秘史.md "wikilink")（ROM/DISK）
    [ヨーロッパ戦線](../Page/ヨーロッパ戦線.md "wikilink")（4月2日、ROM/4月2日、DISK）
  - ディスカバリー
    ミラージュ（DISK）
  - テクノポリス
    コンチネンタル（3月20日、DISK）
  ...
  - フェアリーテール
    狂った果実（6月12日、DISK）
    [デッド・オブ・ザ・ブレイン](https://ja.wikipedia.org/wiki/デッド・オブ・ザ・ブレイン "wikilink")（7月17日、DISK）
    夢二・浅草綺譚（8月7日、DISK）
  - フェアリーテール/サンタ・フェ
    美少女大図鑑（DISK）
  - ブラザー工業
    ...
    BURAI下巻完結編（10月30日、DISK）
  - ボーステック
    [らんま1/2](https://ja.wikipedia.org/wiki/らんま1/2 "wikilink")飛龍伝説（6月12日、DISK）
  - ポニーテールソフト
    ポッキー2（7月、DISK）
  - マイクロキャビン
...
::ANMA'S AMUSEMENT DISK（11月19日、DISK）

::DECALOGUE（11月20日、DISK）

:;PASTELHOPE

::Bubble Utilize（8月25日、DISK）
...
::THE ARROW OF DIRECTION Ver.2（10月2日、DISK）
...
## 1993年
  ...
  - カクテルソフト
    ...
    美姫（DISK）
  - ガイナックス
    MIGHTYバトルスキンパニック（2月5日、DISK）
  - 徳間書店
    ほほ梅麿のCGコレクション1（5月8日、DISK）
  - ドット企画
    グラムキャッツ2（DISK）
  - ハミングバードソフト
    ロードス島戦記&福神漬（DISK）
  - ファミリーソフト
    MSXトレイン2（9月3日、DISK）
  - マイクロキャビン
    キャンペーン版大戦略IIかすたまキット（3月13日、DISK）
  - ログインソフト
    エレメンタルサーガ（DISK）
    ピエロット（DISK）
    ファンタジードリーム（DISK）
...
::PROLOGUEすちゃらかディスク（DISK）

::PROLOGUEすちゃらかディスク2（DISK）

::PROLOGUEすちゃらかディスク3（DISK）

::PROLOGUEすちゃらかディスク4（DISK）
...
::ACTION PUZZLE SET（DISK）

:;NGDプロジェクト

::Networkers Gift Disk（DISK）
...
::South Town's ☆HeroII（DISK）

::South Town's Hero'turbo（DISK）
...
::ACTION GAME SET（DISK）

::魔法使いコッピー ver2.0（DISK）

:;NGDプロジェクト

::Networkers Gift Disk\#2（DISK）

::Networkers Gift Disk\#3（DISK）
...
::Destiny2～innocent wish～（DISK）

:;STG工房T.M

::HIT AND AWAY DX（DISK）

:;SYNTAX

::RS決定版音楽集ECHIKUSO5（DISK）

::RS決定版音楽集ECHIKUSO6（DISK）

::RSDM\#3（DISK）

::RSDM\#4（DISK）

::R・SYSTEM傑作選 第2集（DISK）

::緊急Nマガ増刊号\#4（DISK）

::シャドウヒーロー1・2・3・4（DISK）
...
::Networkers Gift Disk\#4-TOOL（DISK）

::Networkers Gift Disk\#4-ART（DISK）

:;PASTELHOPE

::THE BEST OF HAMARAJA NIGHT（DISK）

::PH.SOUND COLLECTION（DISK）
...
::ETERNAL STRIKER（DISK）

:;Sign House

::Destiny3～reality～（DISK）
...
::パンフ\#4(おうちでTAKERUMSX簡易版)（DISK）

::SYNTAXイベントディスクセット（DISK）
...
::White Mouse Graphic Collection Vol.1（DISK）
...
::MSX同人WORLD TAKERU EDITION（DISK）
...
[Category:MSX/MSX2用ソフト](https://ja.wikipedia.org/wiki/Category:MSX/MSX2用ソフト "wikilink") [Category:ゲーム機別ゲームタイトル一覧](https://ja.wikipedia.org/wiki/Category:ゲーム機別ゲームタイトル一覧 "wikilink")
