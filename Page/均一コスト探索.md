...
均一コスト探索は一般のグラフ探索を行う[ダイクストラ法](../Page/ダイクストラ法.md "wikilink")の特殊なケースである。[ダイクストラ法](../Page/ダイクストラ法.md "wikilink")は[A\*](https://ja.wikipedia.org/wiki/A* "wikilink")アルゴリズムの特殊なケースで[ヒューリスティクス](../Page/ヒューリスティクス.md "wikilink")を定数関数にした場合と同じである。[幅優先探索](../Page/幅優先探索.md "wikilink")は均一コスト探索の特殊なケースであり、辺のコストが全て同じ場合と同じである。
