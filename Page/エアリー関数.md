...
[物理科学](https://ja.wikipedia.org/wiki/物理科学 "wikilink")における**エアリー函数**（エアリーかんすう、）あるいは**第一種エアリー函数** (*Airy function of the first kind*) **** は、[イギリス](https://ja.wikipedia.org/wiki/イギリス "wikilink")の[天文学者](../Page/天文学者.md "wikilink")[ジョージ・ビドル・エアリー](https://ja.wikipedia.org/wiki/ジョージ・ビドル・エアリー "wikilink") (1801–92) に因んで名づけられた[特殊函数](https://ja.wikipedia.org/wiki/特殊函数 "wikilink")である。この函数  および**第二種エアリー函数**とも呼ばれる関連の函数（A を次の文字 B に変えて、故に冗談めかしてベアリー (**B**iry) 函数とも）**** は、**エアリー方程式**あるいは**ストークス方程式**と呼ばれる[微分方程式](../Page/微分方程式.md "wikilink")
...
エアリー函数はまた、[虹](https://ja.wikipedia.org/wiki/虹 "wikilink")のような。歴史的にはこれがエアリーがこの特殊函数を導入するに至った数学的問題であった。またエアリー函数はや[天文学](../Page/天文学.md "wikilink")においても重要である。つまり、エアリー函数は（[顕微鏡](../Page/顕微鏡.md "wikilink")や[望遠鏡](../Page/望遠鏡.md "wikilink")の解像限界よりも小さな）によって与えられる[回折](https://ja.wikipedia.org/wiki/回折 "wikilink")や[干渉のパターンを記述する](https://ja.wikipedia.org/wiki/干渉_\(物理学\) "wikilink")。
...
負の引数に対して、エアリー関数は[ベッセル関数](https://ja.wikipedia.org/wiki/ベッセル関数 "wikilink")と
...
エアリー関数の名の由来は、[イギリス人](https://ja.wikipedia.org/wiki/イギリス人 "wikilink")[天文学者](../Page/天文学者.md "wikilink")・[物理学者](https://ja.wikipedia.org/wiki/物理学者 "wikilink")の[ジョージ・ビドル・エアリー](https://ja.wikipedia.org/wiki/ジョージ・ビドル・エアリー "wikilink") (1801–1892) である。エアリーは[光学](../Page/光学.md "wikilink")の初期研究 (Airy 1838) においてこの函数に遭遇した。"" という表記は[ハロルド・ジェフリース](https://ja.wikipedia.org/wiki/ハロルド・ジェフリース "wikilink")によるものである。エアリーはイギリス[王室天文官](https://ja.wikipedia.org/wiki/王室天文官 "wikilink")を1835年から1881年まで務めた人物である。

## 関連項目

  - [ウィッテン予想](https://ja.wikipedia.org/wiki/ウィッテン予想 "wikilink"): [コンツェヴィッチによる証明にエアリー関数の行列値への一般化が使われている](../Page/マキシム・コンツェビッチ.md "wikilink")。
