...
## GR
  ...
  - [Graphic Right](https://ja.wikipedia.org/wiki/ISO/IEC_2022 "wikilink") - [文字コード](../Page/文字コード.md "wikilink")での符号空間領域名

  - [ジャイアントロボ](../Page/ジャイアントロボ.md "wikilink")に登場する巨大ロボ。なお、一般的にジャイアントロボとして知られているのはGR-1である。
  ...
  - と  の[IATA航空会社コード](https://ja.wikipedia.org/wiki/IATA航空会社コード "wikilink")

  - [スポーツ](../Page/スポーツ.md "wikilink")競技で大会記録（Game Record）の略号

  - グループ(group)の略号

  - [TDNET](https://ja.wikipedia.org/wiki/TDNET "wikilink")（適時開示情報閲覧サービス）での[グリーンシート](https://ja.wikipedia.org/wiki/グリーンシート "wikilink")銘柄制度の略

  - [汎用レジスタ](https://ja.wikipedia.org/wiki/レジスタ_\(コンピュータ\)#汎用レジスタ（ジェネラルレジスタ） "wikilink")(General Register)

## Gr

  - [グラスホフ数](https://ja.wikipedia.org/wiki/グラスホフ数 "wikilink") () - 流体力学で扱う無次元数
