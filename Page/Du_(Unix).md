...
他のUnixとUnix-likeなオペレーティングシステムはさらなるオプションを追加していることがある。BSDとGNUの`du`は`-h`オプションを指定すると、適切な[SI接頭辞](../Page/SI接頭辞.md "wikilink")を付けた単位を追加して（例えば10[MB](../Page/メガバイト.md "wikilink")）、ユーザが読みやすいフォーマットでディスク使用量を表示する。
