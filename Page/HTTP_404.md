...
[Internet Explorer](../Page/Internet_Explorer.md "wikilink")（IE6以前）では、512バイト以下の場合は送信された404用のページを表示せずに、代わりに「親切な」エラーページを表示する。この動作を変えるには、「インターネットオプション」の「詳細設定」で「HTTP[エラーメッセージ](../Page/エラーメッセージ.md "wikilink")を簡易表示する」のチェックをはずす。
