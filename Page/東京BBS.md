...
主に草の根BBSで流通する[フリーソフト](https://ja.wikipedia.org/wiki/フリーソフト "wikilink")や[CGデータ等では](../Page/コンピュータグラフィックス.md "wikilink")、データにアクセスすることが主宰者の収入に繋がる有料ネットへ転載されることを嫌う風潮があり、[Q2回線導入後の東京BBSもこの有料ネットに当たるのだが](../Page/ダイヤルQ2.md "wikilink")、転載条件には「有料ネットへの転載は禁止、ただし東京BBSを除く」といった記述もよく見られた。(ただし、東京BBSのみを禁止するような逆の条件も一部にあった。)
...
出火直後、炎上する建物の画像が他の草の根ネットや、[ニフティサーブ](https://ja.wikipedia.org/wiki/ニフティサーブ "wikilink")(現在の[@nifty](https://ja.wikipedia.org/wiki/ニフティ#@nifty "wikilink"))などに投稿され、被害の甚大さとパソコン通信時代の終焉を物語るかのような様相を呈した。
...
## 外部リンク
  ...
  - [TOKYO BBS　スピリチュアルコンベンション事務局](http://www.tokyobbs.or.jp/)
  - [東京BBS連絡掲示版](http://6721.teacup.com/tokyobbs/bbs) - かつての利用者が集う。スパム広告がある。
