...
また、この番組は期間限定の位置付けで放送されていた。これは、長野オリンピックの公式映像を番組で使用するためにはニュース以外では「レギュラー番組に限る」という規定があったためで、結果、県内局で地元オリンピックの情報を伝えようとすると当該番組のような「レギュラー番組」を作る必要があった。長野オリンピックの閉幕と同時に番組はその使命を終えて終了したが、その1年後の1999年4月からは再び伊東と中西のコンビで『[陽司★美恵子 ゆうがたget\!](../Page/ゆうがたGet!.md "wikilink")』が放送されており、。
