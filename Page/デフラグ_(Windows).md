...
MS-DOS 6.x/[Windows 9x系では](../Page/Windows_9x系.md "wikilink")[シマンテック](../Page/シマンテック.md "wikilink")製のツールが収録されている。
...
### Windows 8/8.1/10
  ...
  - SSD・フラッシュストレージに対し[TRIM](../Page/TRIM.md "wikilink")が実行される。（これはデフラグメンテーションではなく、フラッシュストレージをより効率良く利用するための操作である。）
