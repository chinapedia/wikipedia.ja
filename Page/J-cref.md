> この記事は[J-cref](https://ja.wikipedia.org/wiki/J-cref)から翻訳されています。
...
現在、作者が新しく開発した[Ginnie](https://ja.wikipedia.org/wiki/Ginnie "wikilink")に移行している。そのため、J-crefはシェアウェアという位置づけ自体は変更がないが、一切の制限が無くなっている。ライセンスキー登録を促すダイアログも廃止されている。
...
J-crefには、以下の機能が存在する。
  ...
  - ファイルタイプのキーワード１を元に補完定義ファイルを作成する機能。

## 外部リンク

  - [kntware.net（作者のホームページ）](http://kntware.net/software/)
  - [Vectorシェアレジ](http://www.vector.co.jp/soft/winnt/writing/se383122.html)
