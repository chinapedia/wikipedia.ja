...
同値の基本的な性質は以下のとおり。\(\Rightarrow\)は[論理包含](https://ja.wikipedia.org/wiki/論理包含演算 "wikilink")（ならば）、\(\land\)は[論理積](../Page/論理積.md "wikilink")（かつ）。
...
他にも次のような性質がある。\(\lnot\) は[否定](../Page/否定.md "wikilink")、\(\veebar\) は[排他的論理和](../Page/排他的論理和.md "wikilink")。
