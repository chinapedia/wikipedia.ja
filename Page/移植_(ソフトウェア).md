...
様々な設計思想に基いたコンピュータが、様々なメーカーから発売されており、またそれらコンピュータ上で動作するプログラムを記述するための[プログラミング言語](../Page/プログラミング言語.md "wikilink")も多岐に渡っている。移植性は、OS自体の違いというよりも、システムコールやコマンドなどの違い（例えば[Linux](../Page/Linux.md "wikilink")、[GNU Hurd](../Page/GNU_Hurd.md "wikilink")、[FreeBSD](../Page/FreeBSD.md "wikilink")、[macOS](https://ja.wikipedia.org/wiki/macOS "wikilink")、[Plan 9などの](../Page/Plan_9_from_Bell_Labs.md "wikilink")[POSIX](../Page/POSIX.md "wikilink")、およびそれ以外) 、CPUおよび命令セット（[機械語](../Page/機械語.md "wikilink")）の違い ([ARM](https://ja.wikipedia.org/wiki/ARMアーキテクチャ "wikilink"), [x86](https://ja.wikipedia.org/wiki/x86 "wikilink"), [x64](https://ja.wikipedia.org/wiki/x64 "wikilink"))、拡張命令、ビット長（[8ビット](../Page/8ビット.md "wikilink")、[16ビット](../Page/16ビット.md "wikilink")、[32ビット](../Page/32ビット.md "wikilink")、[64ビット](https://ja.wikipedia.org/wiki/64ビット "wikilink")、[128ビット](https://ja.wikipedia.org/wiki/128ビット "wikilink")、256ビットなど）、そして利用できるライブラリの違いに左右される。例えば、同じPOSIXのGNU/Linux, FreeBSD, macOS間の移植性は比較的高い。また[Win32 APIを備える](https://ja.wikipedia.org/wiki/Windows_API "wikilink")[Microsoft Windowsシリーズ間の移植性も比較的高い](https://ja.wikipedia.org/wiki/Microsoft_Windows "wikilink")。
...
かつて[8ビット御三家](../Page/8ビット御三家.md "wikilink")のように主要なプラットフォームが平行進化の形で複数存在し市場を争っていた時代には、メーカーの開発陣に余力のある場合に、例えば[DAIVA](../Page/DAIVA.md "wikilink")のように、新製品のソフトウェアを複数機種向けに平行して開発して、ほぼ同時発売することもしばしば行われた。また、余り規模が大きくない企業でも[レリクス](../Page/レリクス.md "wikilink")のように、1機種向けに先行販売して、雪崩式に次機種向けに移植作業を続行、次々に多機種展開するメーカーも見られた。また[テグザー](https://ja.wikipedia.org/wiki/テグザー "wikilink")などのように、外注やライセンス提供で結果的に多機種展開したケースも見られる。

ゲームの移植で独特の問題となるのは操作デバイスである。[コントローラのボタン数やその配置](../Page/ゲームコントローラ.md "wikilink")、アナログ的入力の有無などは機種ごとに異なるので、違和感の無い操作を再現するために移植先にあわせたアレンジや調整が必要となる場合がある。各機種間の[フレームレート](https://ja.wikipedia.org/wiki/フレームレート "wikilink")、[画面解像度](../Page/画面解像度.md "wikilink")の違いも大きな問題となりうる。このような移植対象のゲーム機（[コンシューマーゲーム](../Page/コンシューマーゲーム.md "wikilink")）の性能や仕様上の違いによるゲーム内容の変更といったことも、かつては頻繁に行なわれていた。
...
[Category:ソフトウェア](https://ja.wikipedia.org/wiki/Category:ソフトウェア "wikilink") [Category:コンピュータアーキテクチャ](https://ja.wikipedia.org/wiki/Category:コンピュータアーキテクチャ "wikilink") [Category:コンピュータ史](https://ja.wikipedia.org/wiki/Category:コンピュータ史 "wikilink") [Category:リメイクゲーム](https://ja.wikipedia.org/wiki/Category:リメイクゲーム "wikilink")
