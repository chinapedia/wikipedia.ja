...
**サービスパック**（SP）は、対象[ソフトウェア](../Page/ソフトウェア.md "wikilink")への修正などを[インストール](../Page/インストール.md "wikilink")可能な単一パッケージとして配布するものである。[マイクロソフト](../Page/マイクロソフト.md "wikilink")など多くの企業が、個別の[パッチ](https://ja.wikipedia.org/wiki/パッチ "wikilink")を積み上げ、ある期限が来るとサービスパックとしてリリースしている。パッチを個別に多数インストールするよりもミスが発生しにくく、ネットワーク上の複数のコンピュータに適用することも容易である。

サービスパックには番号が振られていることが多く、SP1、SP2、SP3 などといった略称がよく使われている\[1\]。まれなケースとして、単なる[バグ](https://ja.wikipedia.org/wiki/バグ "wikilink")修正だけでなく[Windows XP](../Page/Microsoft_Windows_XP.md "wikilink") の[SP2のように新規機能も含んでいることがある](https://ja.wikipedia.org/wiki/Microsoft_Windows_XP#Service_Pack_2 "wikilink")。
