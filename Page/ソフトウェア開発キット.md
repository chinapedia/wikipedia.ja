...
上位レベルの[ウィジェット・ツールキット](https://ja.wikipedia.org/wiki/ウィジェット・ツールキット "wikilink")や[アプリケーションフレームワーク](../Page/アプリケーションフレームワーク.md "wikilink")は、一般的に各プラットフォーム用のSDKに用意されている下位レベルのAPIを利用して実装される。これらは通例SDKには分類されないが、公式にサポートされる上位レベルAPIとしてSDKの中に含まれていることもある。

## 実例

  - [マイクロソフト](../Page/マイクロソフト.md "wikilink")の[Windows SDK](https://ja.wikipedia.org/wiki/Microsoft_Windows_SDK "wikilink")、旧[DirectX](https://ja.wikipedia.org/wiki/Microsoft_DirectX "wikilink") SDK、[.NET Framework](https://ja.wikipedia.org/wiki/.NET_Framework "wikilink") SDK、[.NET Core](https://ja.wikipedia.org/wiki/.NET_Core "wikilink") SDK

  - [Java](https://ja.wikipedia.org/wiki/Java "wikilink")

      - [オラクル](https://ja.wikipedia.org/wiki/オラクル_\(企業\) "wikilink")（旧[サン・マイクロシステムズ](../Page/サン・マイクロシステムズ.md "wikilink")）の[JDK](../Page/Java_Development_Kit.md "wikilink")
  ...
  - [オートデスク](https://ja.wikipedia.org/wiki/オートデスク "wikilink")の[FBX](https://ja.wikipedia.org/wiki/FBX "wikilink") SDK
