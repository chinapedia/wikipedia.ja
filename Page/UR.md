...
## UR
  ...
  - 診療・治療の[内部監査](../Page/内部監査.md "wikilink") (utilization review)

  - [Underground Resistance](../Page/アンダーグラウンド・レジスタンス.md "wikilink") - [マッドマイク率いる音楽ユニット](https://ja.wikipedia.org/wiki/マイク・バンクス "wikilink")。

  - [都市再生機構](../Page/都市再生機構.md "wikilink") (Urban Renaissance Agency) - 住宅開発のための独立行政法人。愛称はUR都市機構。
  ...
  - [ユニバーサルロケット](https://ja.wikipedia.org/wiki/ユニバーサルロケット "wikilink") (, ) - ソ連のロケットのシリーズ。[UR-100](https://ja.wikipedia.org/wiki/UR-100 "wikilink")、[UR-200](https://ja.wikipedia.org/wiki/UR-200 "wikilink")、[UR-500がある](https://ja.wikipedia.org/wiki/プロトンロケット "wikilink")。

  - [基底表示](https://ja.wikipedia.org/wiki/基底表示 "wikilink") () - 音声学での[音素](../Page/音素.md "wikilink")表記。

  - [ウーリ州](../Page/ウーリ州.md "wikilink") () の[スイス州コード](https://ja.wikipedia.org/wiki/ISO_3166-2:CH "wikilink")

  - [マクセル UR](https://ja.wikipedia.org/wiki/マクセル_UR "wikilink")　[マクセル](https://ja.wikipedia.org/wiki/マクセル "wikilink")（旧・日立マクセル）が製造・販売するオーディオカセットテープのブランド。

  - ライトノベル『[ソードアート・オンライン](https://ja.wikipedia.org/wiki/ソードアート・オンライン "wikilink")』に登場する架空のオンラインゲーム『ユナイタル・リング』の略称。
