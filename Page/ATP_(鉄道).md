> この記事は[ATP \(鉄道\)](https://ja.wikipedia.org/wiki/ATP_\(鉄道\))から翻訳されています。
...
## 概要
  ...
  - ATPは、運転士（動力車操縦者）の[ヒューマンエラー](../Page/ヒューマンエラー.md "wikilink")から列車を保護し、事故を回避するためのシステムである。
  - [列車](../Page/列車.md "wikilink")が停止[信号を越えて進行しようとした場合](../Page/鉄道信号機.md "wikilink")（信号[冒進](../Page/冒進.md "wikilink")）、あるいは指示された速度を超過した場合に、運転士に警告するために光と音を使用し、運転士がこれらの警告に応答しなければ、自動的に列車を停止、または制限速度以下に減速させる。
  - 日本ではATSやATCという言葉が用いられ、日本国外で用いられているATPという名称自体あまり馴染みが無い。 自動列車保安装置に関する考え方に大きな差があるため、単純に訳をすることは難しい。
...
<!-- end list -->
  ...
  - [MRT](https://ja.wikipedia.org/wiki/マス・ラピッド・トランジット_\(シンガポール\) "wikilink")（[東西線](../Page/MRT東西線.md "wikilink")、[南北線](https://ja.wikipedia.org/wiki/MRT南北線 "wikilink")）
...
1.  [三菱重工技報 Vol.47 No.2 (2010)](http://www.mhi.co.jp/technology/review/pdf/472/472002.pdf)
2.  <http://www.bombardier.com/en/transportation/products-services/rail-control-solutions/main-line-solutions/interflo-250/atp--taiwan?docID=0901260d80012896>
3.  <http://www.bombardier.com/en/transportation/products-services/rail-control-solutions/main-line-solutions/interflo-250/korean-national-railroad?docID=0901260d8001288a>