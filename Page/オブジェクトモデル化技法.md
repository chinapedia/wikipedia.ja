...
**オブジェクトモデル化技法** (オブジェクトモデルかぎほう、**OMT**; ) は、[オブジェクト指向ソフトウェア開発方法論であり](https://ja.wikipedia.org/wiki/オブジェクト指向開発方法論 "wikilink")、1990年頃に[ジェームズ・ランボー](../Page/ジェームズ・ランボー.md "wikilink")、マイケル・ブラハ、ウィリアム・プレメラニ、フレデリック・エディ、ウィリアム・ローレンセンなどの人々によって開発された。 ジェームズ・ランボーたちは著書『オブジェクト指向方法論OMT モデル化と設計』 (原著は1990年刊、日本語訳は1992年刊) で OMT を説明している。 現在では OMT は、
  ...
  - 開発手法は、OMTとOOSEとともに、ジェームズ・ランボーが在籍する [Rational Software](https://ja.wikipedia.org/wiki/ラショナル "wikilink") のもとで [Unified Process](https://ja.wikipedia.org/wiki/Unified_Process "wikilink") (UP) に統合された。
...
7.  [トレードオフ](https://ja.wikipedia.org/wiki/トレードオフ "wikilink")の存在する各条件に対し優先順位を設定する。\[4\]

### 実装

OMT では難しい決定判断は既に設計過程で終了しているため、[実装](https://ja.wikipedia.org/wiki/実装 "wikilink")は機械的かつ直接的に行うことができるとする\[5\]。 ただし実装に際しては、留意すべき指針がある。
...
こうした状況のもとで1994年に OMT の提唱者の一人ジェームズ・ランボーが、[ゼネラル・エレクトリック](https://ja.wikipedia.org/wiki/ゼネラル・エレクトリック "wikilink") (GE) からグラディ・ブーチの在籍する [Rational Software](https://ja.wikipedia.org/wiki/ラショナル "wikilink") に移籍し、開発方法論を統合する作業に着手した。 さらに1995年には Rational Software は、イヴァー・ヤコブソンが在籍する [Objectory AB](https://ja.wikipedia.org/wiki/Objectory_AB "wikilink") を買収した。 Rational Software において、ランボーとブーチとヤコブソンはそれぞれの[オブジェクト指向ソフトウェア開発方法論](https://ja.wikipedia.org/wiki/オブジェクト指向ソフトウェア開発方法論 "wikilink")を統合する作業を行った。 Rational Software で開発方法論を統合する作業の過程で、モデル図の記法と開発手法をまとめて統一するのではなく、モデル図の記法の統一と開発手法の統一の2つの作業に分割して作業する方針を採ることになった。

  - 統一したモデル図の記法の名前は [UML](../Page/統一モデリング言語.md "wikilink") (Unified Modeling Language; 統一モデリング言語) といい、OMG ([Object Management Group](https://ja.wikipedia.org/wiki/Object_Management_Group "wikilink")) のもとで Rational Software は他の企業と共同で開発を引き続き行い、1997年に UML 1.1 として標準化された。OMT のモデル図の概念と記法の多くが UML に引き継がれている。現在の UML の最新版はこの UML 2.0 であり、現在も OMG のもとで開発が進められている。
...
OMT の分析段階で作成するモデル図の概念と記法の多くが [UML](../Page/統一モデリング言語.md "wikilink") (Unified Modeling Language; 統一モデリング言語) に引き継がれている。
  ...
  - オブジェクトモデル図は、UML の[クラス図](https://ja.wikipedia.org/wiki/クラス図 "wikilink")と良く似ている。
