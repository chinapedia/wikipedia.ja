...
[初等数学](https://ja.wikipedia.org/wiki/初等数学 "wikilink")において、因数定理や[代数学の基本定理](../Page/代数学の基本定理.md "wikilink")を習っていない場合、[二次方程式の解の公式](https://ja.wikipedia.org/wiki/二次方程式の解の公式 "wikilink")から根と係数の関係を導くという方法がとられることがある。
