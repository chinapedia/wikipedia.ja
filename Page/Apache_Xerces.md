...
## 外部リンク
  ...
  - [Apache Xerces プロジェクト](http://xerces.apache.org/)
      - [Xerces2 Java プロジェクト](http://xml.apache.org/xerces2-j/)
          - [Xerces Javadocs](http://xerces.apache.org/xerces-j/apiDocs/)
      - [Xerces C++ プロジェクト](http://xml.apache.org/xerces-c/)
      - [Xerces Perl プロジェクト](http://xerces.apache.org/xerces-p/)
  - [Tutorial: XML with Xerces for Java](http://totheriver.com/learn/xml/xmltutorial.html)
  - [Stylus Studio support for Xerces](http://www.stylusstudio.com/xml/xerces.html)

[Category:XML](https://ja.wikipedia.org/wiki/Category:XML "wikilink") [Category:Java](https://ja.wikipedia.org/wiki/Category:Java "wikilink") [Category:C++](https://ja.wikipedia.org/wiki/Category:C++ "wikilink") [Category:オープンソースソフトウェア](https://ja.wikipedia.org/wiki/Category:オープンソースソフトウェア "wikilink") [Category:Apacheソフトウェア財団](https://ja.wikipedia.org/wiki/Category:Apacheソフトウェア財団 "wikilink") [Category:IBMのソフトウェア](https://ja.wikipedia.org/wiki/Category:IBMのソフトウェア "wikilink")
