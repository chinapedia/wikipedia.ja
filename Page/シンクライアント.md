...
世の中で「シンクライアント」という用語が使われ始めたのは、1996年のことである。きっかけとなったのは[オラクルで](https://ja.wikipedia.org/wiki/オラクル_\(企業\) "wikilink")、「NC（[Network Computer](https://ja.wikipedia.org/wiki/ネットワークコンピュータ "wikilink")）」という呼称を用いて新しい端末の[コンセプトモデル](https://ja.wikipedia.org/wiki/コンセプトモデル "wikilink")を打ち出した。さらに数か月後には[サン・マイクロシステムズ](../Page/サン・マイクロシステムズ.md "wikilink")から「Java Station」という呼称で、同様のコンセプトモデルが発表された。
...
上述したとおり、デビュー後しばらくは普及しなかった狭義のシンクライアントであるが、2004年頃から「低価格」とは全く別の利点に注目が集まるようになった。それはセキュリティ面での利点である。この頃から、企業内で管理している[個人情報](../Page/個人情報.md "wikilink")などが外部に流出する事件が発生し、これの対策に企業は取り組むようになってきた。多数の社員が使うパソコンに重要情報が保存されている現状では、セキュリティ対策が困難である一方で、狭義のシンクライアントの端末側にデータを持てない特性が、[情報漏洩](https://ja.wikipedia.org/wiki/情報漏洩 "wikilink")対策に効果的であるとして注目を集めるようになったのである。

日本においてシンクライアントへの注目が一気に高まったのは、[2005年](https://ja.wikipedia.org/wiki/2005年 "wikilink")[1月3日](../Page/1月3日.md "wikilink")の[日本経済新聞](../Page/日本経済新聞.md "wikilink")の一面トップ記事において「[日立製作所](../Page/日立製作所.md "wikilink")がパソコン利用を全廃する」との見出しが出されたことによる\[5\]。記事中では、セキュリティ対策のために、データが保存できない新型端末\[6\]に徐々に移行し、最終的にパソコンの利用を全廃していくと紹介されている。それまでシンクライアントは、企業情報システムに関心のある一部の人達の中で話題になるのみであったが、この記事をきっかけにして広く一般にも知られるところとなった。その後、[朝日新聞](https://ja.wikipedia.org/wiki/朝日新聞 "wikilink")のような一般紙や、[NHKのニュースでも紹介された](https://ja.wikipedia.org/wiki/日本放送協会 "wikilink")。
...
サーバ側にOSイメージをおいておき、端末起動時には[PXEを用いてネットワーク経由でOSをブートする方式](../Page/Preboot_Execution_Environment.md "wikilink")。実際のアプリケーションの処理は端末側で行う。一般的には、[Linux](../Page/Linux.md "wikilink")や[macOS](https://ja.wikipedia.org/wiki/macOS "wikilink")（[NetBoot](https://ja.wikipedia.org/wiki/NetBoot "wikilink")）などの、[UNIX](../Page/UNIX.md "wikilink") / [Unix系](../Page/Unix系.md "wikilink")OSが使われることが多い。[Ardence](https://ja.wikipedia.org/wiki/Ardence "wikilink")やe-tools社のLanPC2、ネットブート社の[VHD Pro](http://www.vhdsoft.jp/)は、数少ないWindowsをベースとしたネットワークブート方式のシステムである。
...
サーバベース方式における機能集約とマルチユーザの得失と、ブレードPC方式のシングルユーザーと機能重複の得失の組み合わせと看做せる、後発の仕組み。高性能サーバ上で[VMware](../Page/VMware.md "wikilink")や[Xenなどの](https://ja.wikipedia.org/wiki/Xen_\(仮想化ソフトウェア\) "wikilink")[ハイパーバイザ](../Page/ハイパーバイザ.md "wikilink")を使用して[仮想マシンを多数実行することにより](../Page/仮想機械.md "wikilink")、機能集約を実現する。ユーザーは個々の仮想マシンに接続してシングルユーザーのクライアントOSを使用する。
...
一方、ストレージ環境については、サーバの立ち上げが非常に簡単になった一方で、ストレージ領域を用意する手間や運用管理が複雑になるなどのデメリットが生じてきている。実際、多くの共有ストレージに発生するムダな空き容量の問題は解決されないままである。しかし、近年、主要な[ストレージ](https://ja.wikipedia.org/wiki/ストレージ "wikilink")ベンダー（EMC、[Netapp](../Page/ネットアップ.md "wikilink")、ヒューレット・パッカード）を中心に仮想技術を駆使した[ネットワーク](https://ja.wikipedia.org/wiki/コンピュータネットワーク "wikilink")[ストレージ](https://ja.wikipedia.org/wiki/ストレージ "wikilink")を展開し、これらの問題解決に取り組んでいる。
...
## 関連項目
  ...
  - [クラウドゲーム](https://ja.wikipedia.org/wiki/クラウドゲーム "wikilink") - シンクライアントの技術を使ったゲーム配信。
  - [電気通信大学](../Page/電気通信大学.md "wikilink") - 教育用計算機としてシンクライアント(IED)が導入されている
  - [コンピュータネットワーク](https://ja.wikipedia.org/wiki/コンピュータネットワーク "wikilink") - 仮想デスクトップ用に高機能なネットワークストレージを活用することが一般的である。
