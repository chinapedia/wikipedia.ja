...
『**マリオテニスGB**』（マリオテニスジービー、*Mario Tennis*）は、[キャメロット製作](https://ja.wikipedia.org/wiki/キャメロット_\(ゲーム会社\) "wikilink")、[任天堂](../Page/任天堂.md "wikilink")発売の[ゲームボーイカラー](../Page/ゲームボーイカラー.md "wikilink")専用[スポーツゲーム](https://ja.wikipedia.org/wiki/スポーツゲーム "wikilink")。[マリオテニス](https://ja.wikipedia.org/wiki/マリオテニス "wikilink")の第2作目。『[マリオテニス64](https://ja.wikipedia.org/wiki/マリオテニス64 "wikilink")』で初登場をした[ワルイージ](../Page/ワルイージ.md "wikilink")唯一の8ビット作品であり、さらに海外版は8ビット最後の[マリオシリーズ](../Page/マリオシリーズ.md "wikilink")であった\[1\]。
...
[バーチャルコンソール](https://ja.wikipedia.org/wiki/バーチャルコンソール "wikilink")(VC)版では、64版との連動機能が削除されており、ストーリーモードで育成したキャラクターのデータ交換や連動を必須とする隠し要素の解禁などは行えなくなっている。
...
いずれもストーリーモードで登場する。一部を除いてエキシビションでも使用可能だが、COMの強さレベルは選択不可（「さいきょう」相当で固定）で、対戦ステータスにも記録は残らない。
  ...
  - [アレックス](https://ja.wikipedia.org/wiki/マリオシリーズのキャラクター一覧#アレックス "wikilink") ☆○
    ...
    『[マリオテニスアドバンス](https://ja.wikipedia.org/wiki/マリオテニスアドバンス "wikilink")』のストーリーモードにも登場。アカデミーのコーチに就任している。
...
## 外部リンク
  ...
  - [マリオテニスGB](https://www.nintendo.co.jp/titles/50010000014752) - [ニンテンドー3DS](https://ja.wikipedia.org/wiki/ニンテンドー3DS "wikilink")[バーチャルコンソール](https://ja.wikipedia.org/wiki/バーチャルコンソール "wikilink")
