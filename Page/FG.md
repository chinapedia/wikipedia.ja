...
## 記号・単位
  ...
  - **Fg** - [ファゴット](../Page/ファゴット.md "wikilink") () の楽器記号

## 略語・略称

### 一般名詞

  - [官能基](https://ja.wikipedia.org/wiki/官能基 "wikilink") ()-有機化学において種々側鎖としての表記
  - [金融持株会社](../Page/金融持株会社.md "wikilink") (Financial Group)
  - フィールドゴール - [アメリカンフットボール](../Page/アメリカンフットボール.md "wikilink")の得点方法
  - [筐体接地](https://ja.wikipedia.org/wiki/筐体接地 "wikilink") () - [接地](../Page/接地.md "wikilink")の種類
  - [最終比重](../Page/比重_\(ビール\).md "wikilink") () - [ビール](../Page/ビール.md "wikilink")[醸造](../Page/醸造.md "wikilink")での測定値

### 固有名詞

  - [FUNKY GRAMMAR UNIT](../Page/FUNKY_GRAMMAR_UNIT.md "wikilink") - ヒップホップミュージシャンの団体
  - [ストリートファイターZERO ファイターズ ジェネレーション](../Page/ストリートファイターZERO_ファイターズ_ジェネレーション.md "wikilink")
  - [material SNS fg](https://ja.wikipedia.org/wiki/material_SNS_fg "wikilink") （エフジー） - フィギュアや模型など、立体物の製作・撮影・閲覧を楽しむ[ソーシャル・ネットワーキング・サービス](../Page/ソーシャル・ネットワーキング・サービス.md "wikilink")
  - [fg](https://ja.wikipedia.org/wiki/fg_\(UNIX\) "wikilink") (**f**ore**g**round) コンピュータのUNIX系システムにおけるジョブ（プロセス）管理コマンド

### 形容詞

  - 有限生成 (finitely generated, f.g.) - 数学用語。さまざまな代数的対象に対して使われるが、例えば[有限生成加群](https://ja.wikipedia.org/wiki/有限生成加群 "wikilink")を参照
...
## 関連項目
  ...
  - [FGで始まる記事の一覧](https://ja.wikipedia.org/wiki/特別:Prefixindex/FG "wikilink")
  - [Fg,fgで始まる記事の一覧](https://ja.wikipedia.org/wiki/特別:Prefixindex/Fg "wikilink")