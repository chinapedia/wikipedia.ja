...
## 作品解説
  ...
  - 毎回テーマに沿ってDEENのアナザーサイドを見せていくシングルの第2弾。
...
## タイアップ
  ...
  - TBS系『[ワンダフル](../Page/ワンダフル_\(テレビ番組\).md "wikilink")』内ミニドラマ2000年9月度主題歌
...
## 参加ミュージシャン
  ...
  - 作曲
      - DEEN(\#1.、\#2.、\#6.)
      - 池森秀一（\#3.、\#4.）
      - [宇津本直紀](../Page/宇津本直紀.md "wikilink")（\#4.）
      - [織田哲郎](../Page/織田哲郎.md "wikilink")（\#5.）
  - 編曲
      - 田川伸治(\#1.)
      - DEEN（\#2.〜\#6.）
  - DEEN
  ...
  - ゲスト
      ...
      - KEIJI FUJINUMA：Drums（\#2.〜\#5.）
      - GOOD-DAYS：Gang Chorus（\#4.）
      - SHIRO SASAKI：Trumpet（\#3.） 他...
