...
上記のいずれにも該当しない忍術。
  ...
  - 忍法・超獣偽画（にんぽう・ちょうじゅうぎが）（万能、攻撃、補助、上忍）
    【サイ、山中いのじん】白紙の巻物から筆と墨を取り出し、その巻物に動物などの絵を描きそれを実体化し相手に襲いかからせる。文字を実体化して情報伝達に使うことも可能。現在、[狛犬](../Page/狛犬.md "wikilink")・蛇・巨大な鳥・[鼠が登場](../Page/ネズミ.md "wikilink")。アニメには[蛞蝓](../Page/ナメクジ.md "wikilink")・コウモリ\[91\]・龍、劇場版では[梟も登場](https://ja.wikipedia.org/wiki/フクロウ "wikilink")。ただし、墨であるがゆえに雨天では使えないという弱点がある。いのじんが使うものは「**超獣偽画・現代**」\[92\]で、ポップ系のタッチで描かれている。
      - 忍法・墨流し（にんぽう・すみながし）
