...
なお、[携帯電話IP接続サービス](../Page/携帯電話IP接続サービス.md "wikilink")（[iモード](https://ja.wikipedia.org/wiki/iモード "wikilink")など）の電子メールでは、携帯電話網と[インターネット](../Page/インターネット.md "wikilink")との接続部分（[ゲートウェイ](../Page/ゲートウェイ.md "wikilink")）にて、半角カタカナ→全角カタカナの変換が行われていた。
