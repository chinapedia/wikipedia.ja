...
**線形探索**（せんけいたんさく、）は、[検索](../Page/検索.md "wikilink")の[アルゴリズム](../Page/アルゴリズム.md "wikilink")の一つ。 [リストや](https://ja.wikipedia.org/wiki/リスト_\(抽象データ型\) "wikilink")[配列](https://ja.wikipedia.org/wiki/配列 "wikilink")に入ったデータに対する検索を行うにあたって、 先頭から順に比較を行い、それが見つかれば終了する。
...
## 関連項目
  ...
  - [二分探索](https://ja.wikipedia.org/wiki/二分探索 "wikilink")
