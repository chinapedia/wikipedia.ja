...
他にもフリーなものも商用製品としても、様々なXディスプレイマネージャが開発されており、単なる画面管理以上の機能を持つものが多い。
  ...
  - [KDM](../Page/KDEディスプレイマネージャ.md "wikilink") ([KDE](../Page/KDE.md "wikilink")) - [ウィンドウマネージャ](../Page/ウィンドウマネージャ.md "wikilink")や[デスクトップ環境](https://ja.wikipedia.org/wiki/デスクトップ環境 "wikilink")をログイン時にグラフィカルに選択可能
