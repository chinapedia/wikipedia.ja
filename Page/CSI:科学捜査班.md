...
### レギュラー
  ...
  - サラ・サイドル (Sara Sidle)
    ...
    第15シーズン最終話後に放送された最終章（事実上のラストエピソード）にてラッセルの後任としてCSIチーフに就任、グリッソムとの付き合いを再開しラスベガスエピソードは完結、15年の幕を降ろす。(キャサリンの発言「サラが辞退したら主任に・・・」から、サラは主任を蹴ってグリッソムに付いて行った可能性もある)
  - ジム・ブラス (Jim Brass)
  ...
  - デヴィッド・ホッジス (David Hodges)
    ...
    吹き替えでは、何故かグリッソムを「**大将**」（[サー](../Page/ナイト.md "wikilink")《Sir》）と呼ぶ。会話の波長が合わないためか、グリッソムもホッジスに対しては、無駄話を無理矢理断ち切るなどそっけなく接しているが、彼自身は上司を心から尊敬しているようで、第7シーズン「模型の鍵」ではCSIメンバーが捜査に出ている間にラボメンバーを集め、グリッソムが解決に悩んでいた『殺人模型』を解析し連続殺人事件の解決の糸口を見つけた。また、グリッソムがCSIを去る時は最後まで引き留めようとしていた。
