> この記事は[BUGGY CRASH NIGHT](https://ja.wikipedia.org/wiki/BUGGY_CRASH_NIGHT)から翻訳されています。


**BUGGY CRASH NIGHT**（**バギー クラッシュ ナイト**）は、[FM802](../Page/FM802.md "wikilink")にて毎週土曜日の25:00〜26:00に、[GLAY](../Page/GLAY.md "wikilink")のJIROがパーソナリティーを務める[ラジオ番組](../Page/ラジオ番組.md "wikilink")である。
...
日曜日の放送時から、既に公式サイトは設立されており、リスナーからのイラスト掲載やストリーミング放送も行っていた（トーク部分のみ）。当初はJIRO直筆のFAXメッセージも掲載されていた。

土曜日に移動してからは、直筆メッセージのコンテンツは削除されたものの、リスナーからのイラスト掲載やストリーミング放送は継続中で、関西圏以外のエリアでも放送を楽しむ事ができる。また、近年は「延長戦」と題した放送後記も合わせて配信されている。
