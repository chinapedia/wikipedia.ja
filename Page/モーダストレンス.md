...
**モーダストレンス**（）は、**間接証明**（indirect proof）や**[対偶による証明](https://ja.wikipedia.org/wiki/対偶_\(論理学\) "wikilink")**（proof by contradiction）の正式な名称である。[ラテン語](../Page/ラテン語.md "wikilink")で「否定によって肯定する様式」の意。**後件否定**（denying the consequent）とも呼ぶが[妥当な](https://ja.wikipedia.org/wiki/妥当性 "wikilink")[論証](https://ja.wikipedia.org/wiki/論証 "wikilink")形式であり、似たような名称の妥当でない論証形式（[後件肯定](../Page/後件肯定.md "wikilink")や[前件否定](../Page/前件否定.md "wikilink")）とは異なる。
...
[自然演繹](https://ja.wikipedia.org/wiki/自然演繹 "wikilink")の記法では次のようになる。
...
モーダストレンスは、[カール・ポパー](https://ja.wikipedia.org/wiki/カール・ポパー "wikilink")が[反証可能性](../Page/反証可能性.md "wikilink")について論じる際に使われ、有名になった。

## モーダスポネンスとの関係

モーダストレンスは、[条件文](https://ja.wikipedia.org/wiki/条件文 "wikilink")型の前提に対して[対偶をとることで](https://ja.wikipedia.org/wiki/対偶_\(論理学\) "wikilink")[モーダスポネンス](../Page/モーダスポネンス.md "wikilink")に変換可能である。例えば、次のようになる。
