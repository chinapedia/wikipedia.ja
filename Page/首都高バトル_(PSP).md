...
## ゲームモード
  ...
  - チームランブル-首都高にあるチームに所属し、チームメンバー、或いはチームリーダーとなって首都高完全制覇を目指す。バトル形式はSPバトル。ライブモニターからライバルを選ぶ。最初に選べるチームは３つだが、一度ゲームを攻略すれば全てのチームから選ぶことができる。
  - タイムアタック-首都高速道路の規定区間を走り最速タイムを目指すモード。ゴーストカーは無い。
  - リプレイシアター-SPバトル、タイムアタックのリプレイを見る。

## 登場車種

  - ☆のついた車種はエアロパーツ・ライトなどの組み合わせで、JGTCカーに似た仕様にできる。
...
1.  [日産・シルビア](../Page/日産・シルビア.md "wikilink") K's (S14)
...
1.  [三菱・ランサーエボリューション](../Page/三菱・ランサーエボリューション.md "wikilink") V GSR (CP9A) ※エアロパーツ、ライトなどの組み合わせで、エボVIや競技用ベース車のRSに似た仕様にできる。
2.  三菱・ランサーエボリューション VIII MR GSR (CT9A) ※エアロパーツ、ライトなどの組み合わせで、エボVIIやエボIX、WRカーに似た仕様にできる。
3.  [三菱・GTO](https://ja.wikipedia.org/wiki/三菱・GTO "wikilink") Twin Turbo MR (Z15A)
...
1.  [スバル・インプレッサ](../Page/スバル・インプレッサ.md "wikilink") WRX Sti Version-VI (GC8) ※エアロパーツの組み合わせで、22B-STi Ver.やWRカーに似た仕様にできる。
2.  スバル・インプレッサ WRX Sti specC(GDB) ※エアロパーツ、ライトなどの組み合わせで、WRカーに似た仕様にできる。
3.  [スバル・レガシィ](../Page/スバル・レガシィ.md "wikilink") B4 2.0GT SpecB (BL5)

### カスタムカー

一部のワンダラーのメンバーが搭乗する車両。プレイヤーが施すことのできないチューンアップやカラーリングが施されている。一度勝利すればスカウトの成功・失敗は関係なく売り出される。

車両形式は\[ベース車の型式\]Cu(Customの略)\[ライバルの英語名の略記\]である。(例:BNR34CuEM)

今までと異なりデチューンされずに売り出され、購入後のチューニング・セッティングは一切不可能。また購入可能なマシンとワンダラーのマシンではデザインが異なる。ワンダラー仕様のデザインはタイムアタックでのみ仕様可能。(ただし特定のボタン入力が必要)

  - ランサーエボリューションベース

<!-- end list -->

  - Hard Weapon(CT9A)-外観が戦車のようになっている(ライバルリストに「ミリタリーマニア」と書かれている)。ワンダラータイプとプレイヤータイプでは、迷彩柄の配色が異なる。
...
<!-- end list -->
  ...
  - Death Driver(S15)-リアウイングレス仕様。ホイールが特別製。バイナル以外相違点は無い。
  - Melancholy Angel(S15)-D.Speed製のエアロを装備。ホイールが特別製。バイナルの色が違うだけでなく、ワンダラータイプにのみ特別なステッカーが貼ってある。
  - これらの2台は表記上の性能が全く同じである。ボディカラーこそ違うがバイナルも似ている。
...
<!-- end list -->
  ...
  - Jack Knife(RPS13)-RPS13[シルエイティ](https://ja.wikipedia.org/wiki/シルエイティ "wikilink")(S13フェイス)。プレイヤータイプは赤一色なのに対し、ワンダラータイプは黄色にステッカー・バイナルつきである。
...
<!-- end list -->
  ...
  - Midnight Rose(Z15A)-[Veilside](https://ja.wikipedia.org/wiki/Veilside "wikilink")風のボディキットを装着。赤一色に紫の偏光のプレイヤータイプに対し、ワンダラータイプは紫にバラ模様のバイナル入りである。
...
<!-- end list -->
  ...
  - Exhaust EVE-[Abflug](https://ja.wikipedia.org/wiki/Abflug "wikilink")製のコンプリートカー、スープラS900。ヘッドライトのガラスカバーの透過度が高い。青一色のプレイヤータイプに対し、ワンダラータイプは紫にバイナル入りである。フロントにあるステッカーもワンダラータイプ限定である。
...
<!-- end list -->
  ...
  - [NSXベース](../Page/ホンダ・NSX.md "wikilink")

<!-- end list -->

  - Nightmare(NA2)-諸事情により、公道系レースゲームに実車名を出すことを許可しない自動車会社、[本田技研工業のスーパーカー](https://ja.wikipedia.org/wiki/ホンダ "wikilink")。プレイヤーの乗れるNSX並びにホンダ車はこれだけである。ソーサリー製のエアロを装着しており、ヘッドライト及びテールランプはドレスアップ済み。ボディカラーが違うだけでなく、ワンダラータイプにあるステッカーがプレイヤータイプにはない。

### リーダーカー

チームのリーダーが搭乗する車両。購入はできないが、タイムアタックで特定のタイムを更新すると使用可能。カスタムカーと同様、プレイヤーが施すことのできないチューンやカラーリングが施されている。

  - ランサーエボリューションベース

<!-- end list -->

  - Naniwa's Warship-「NO LOSER」リーダー搭乗。迷彩塗装。
...
<!-- end list -->
  ...
  - Crimson Stardust-「FINE DRIVE」リーダー搭乗。赤色。
...
<!-- end list -->
  ...
  - Mr Othello-「GALAXY RACERS」リーダー搭乗。ボンネットはカーボンになっており、ルーフ全体もカーボンルック化されている。白色。
...
<!-- end list -->
  ...
  - Silver Nobleman-「R.R.」リーダー搭乗。漫画『[頭文字D](../Page/頭文字D.md "wikilink")』に登場するFC3Sに似ている。白色。
...
<!-- end list -->
  ...
  - Immovable Chief- 「[SHINSEN-GUMI](../Page/新選組.md "wikilink")」リーダー搭乗。水色。
...
<!-- end list -->
  ...
  - Fullmoon Lunatic- 「SPEED MASTER」リーダー搭乗。紺色。
