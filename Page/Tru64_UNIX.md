...
HPによる[コンパック](../Page/コンパック.md "wikilink")の買収に伴い、Tru64 UNIXを廃止してその最も特徴的な機能（[ファイルシステム](../Page/ファイルシステム.md "wikilink")など）をHP固有の[UNIX](../Page/UNIX.md "wikilink")である[HP-UX](../Page/HP-UX.md "wikilink")へ移植することを発表した。このファイルシステムはクラスタ環境で同時に両ノードからmount可能など先進的なものだった。しかしながら、[2004年](../Page/2004年.md "wikilink")12月の時点では、HPはこのプロジェクトをキャンセルしたようであり、替わりに[Veritas File Systemを利用することを選択して](https://ja.wikipedia.org/wiki/Veritas_File_System "wikilink")、Tru64 UNIXの残りの先進的な機能も放棄してしまった。この過程で、多く残っていたTru64 UNIXの開発者も冗長となりレイオフされた。

## 外部リンク

  - [日本HP Tru64 UNIX](http://h50146.www5.hp.com/products/software/oe/tru64unix/)

  - [Tru64.org](http://www.tru64.org/)

  -
[Category:Unix系オペレーティングシステム](https://ja.wikipedia.org/wiki/Category:Unix系オペレーティングシステム "wikilink") [Category:ディジタル・イクイップメント・コーポレーション](https://ja.wikipedia.org/wiki/Category:ディジタル・イクイップメント・コーポレーション "wikilink") [Category:ヒューレット・パッカードの製品](https://ja.wikipedia.org/wiki/Category:ヒューレット・パッカードの製品 "wikilink")