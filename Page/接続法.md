...
**接続法**（せつぞくほう、、、、、、）は、[インド・ヨーロッパ語族](../Page/インド・ヨーロッパ語族.md "wikilink")に属する[言語](../Page/言語.md "wikilink")での[法の](https://ja.wikipedia.org/wiki/法_\(文法\) "wikilink")1つ。勧告・命令・禁止・願望・後悔など、願われたことや考えられたことを述べる[法](https://ja.wikipedia.org/wiki/法_\(文法\) "wikilink") (mood) である。対語は[直説法](https://ja.wikipedia.org/wiki/直説法 "wikilink") (indicative mood)。
...
主な使い方としては、
  ...
  - [命令法](https://ja.wikipedia.org/wiki/命令法 "wikilink")の代用（特に[一人称](../Page/一人称.md "wikilink")[複数](https://ja.wikipedia.org/wiki/複数 "wikilink")や[三人称](https://ja.wikipedia.org/wiki/三人称 "wikilink")の活用を使う[敬称](https://ja.wikipedia.org/wiki/敬称 "wikilink")[二人称](../Page/二人称.md "wikilink")への命令）
  - 意見や不確実な概念などの表現
...
仮定法過去 (subjunctive past, past subjunctive) とは、[動詞](../Page/動詞.md "wikilink")および[助動詞](https://ja.wikipedia.org/wiki/助動詞 "wikilink")の過去形を用いて現在の事実とは反対の仮定、想像、実現不可能な願望を表現する。be動詞は、wereを用いる。ただし、実際に過去の[時制](https://ja.wikipedia.org/wiki/時制 "wikilink")を表しているわけではなく、あくまで過去形を使うことから来る命名である。

1\. ifに導かれる条件節などで用いる場合（省略形や[分詞構文](https://ja.wikipedia.org/wiki/分詞構文 "wikilink")を用いる場合もある。仮定法過去完了も同様）
...
1\. 期待、願望、主張、命令、要求、提案などを表す動詞に伴う[that-節](https://ja.wikipedia.org/wiki/That節 "wikilink")
...
以下で述べるように時制の一致における用法を除いて、現在の事実とは反対の仮定、想像、実現不可能な願望を表現する。ただし、実際に過去の[時制](https://ja.wikipedia.org/wiki/時制 "wikilink")を表しているわけではなく、あくまで直説法点過去の3人称複数における活用の語幹を使うことから来る命名である。 なお、接続法過去の語尾は-ra型と-se型の2種類があるが、現在では-ra型が用いられることが多い。-se型の活用はやや文語的な表現。
...
## 関連項目
  ...
  - [条件法](https://ja.wikipedia.org/wiki/条件法 "wikilink")
  - [命令法](https://ja.wikipedia.org/wiki/命令法 "wikilink")
  - [不定詞](https://ja.wikipedia.org/wiki/不定詞 "wikilink") - 文法的な意味は接続法と似ているが、接続法と違って主語をとらない（ポルトガル語やガリシア語の[人称不定詞](https://ja.wikipedia.org/wiki/人称不定詞 "wikilink")のように主語をとる例もある）。具体的な用法は言語によって異なる。「不定法」という法を考える場合もある。
