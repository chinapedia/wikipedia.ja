> この記事は[PyMOL](https://ja.wikipedia.org/wiki/PyMOL)から翻訳されています。


**PyMOL**（パイモル）は[オープンソース](../Page/オープンソース.md "wikilink")の分子グラフィックスツールである。[ウォーレン・デラノ](https://ja.wikipedia.org/wiki/ウォーレン・デラノ "wikilink")により開発され、個人経営のソフトフェア会社であるデラノ・サイエンティフィック (DeLano Scientific LLC) によって商品化された。現在はSchrödinger社によって商品化されている。PyMOLは小さな分子に加えて[タンパク質](../Page/タンパク質.md "wikilink")など[生体高分子](https://ja.wikipedia.org/wiki/生体高分子 "wikilink")の高品質な3Dイメージを作成でき、科学雑誌の表紙を飾ったPyMOLのタンパク質画像も多く存在している。

[構造生物学](../Page/構造生物学.md "wikilink")の分野ではオープンソースで利用できる数少ないソフトフェアのうちの1つである。名称の一部Pyは記述言語である[Python](../Page/Python.md "wikilink")に因む。
...
[Category:画像処理ソフト](https://ja.wikipedia.org/wiki/Category:画像処理ソフト "wikilink") [Category:Python](https://ja.wikipedia.org/wiki/Category:Python "wikilink") [Category:分子モデリングソフトウェア](https://ja.wikipedia.org/wiki/Category:分子モデリングソフトウェア "wikilink") [Category:フリー化学ソフトウェア](https://ja.wikipedia.org/wiki/Category:フリー化学ソフトウェア "wikilink")

1.  [APBS](http://www.poissonboltzmann.org/apbs/)
