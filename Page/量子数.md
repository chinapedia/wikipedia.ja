...
[量子力学](https://ja.wikipedia.org/wiki/量子力学 "wikilink")においてとは、[量子状態](../Page/量子状態.md "wikilink")を区別するための数のこと。
...
\[m_l = 0, \dots, \pm (l-1), \pm l\] [パウリの排他原理](../Page/パウリの排他原理.md "wikilink")によれば「四つの量子数（*n*, *l*, *m*<sub>l</sub>, *m*<sub>s</sub>）で決まる一つの量子状態にはただ一つの[電子](https://ja.wikipedia.org/wiki/電子 "wikilink")しか入ることができない」。これは一般に[半整数](https://ja.wikipedia.org/wiki/半整数 "wikilink")スピンの[フェルミ粒子](../Page/フェルミ粒子.md "wikilink")（電子など）には当てはまるが、[整数](../Page/整数.md "wikilink")スピンの[ボーズ粒子](https://ja.wikipedia.org/wiki/ボーズ粒子 "wikilink")（[光子](../Page/光子.md "wikilink")など）には当てはまらない。
...
多電子系の場合でも[有効核電荷](https://ja.wikipedia.org/wiki/有効核電荷 "wikilink")の概念を用いれば水素原子型に帰着できる。

## 主量子数

主量子数 *n* は、電子の[波動関数](../Page/波動関数.md "wikilink")が原子半径方向の[定常波](https://ja.wikipedia.org/wiki/定常波 "wikilink")を表す量子数と考えることができる。[水素原子](../Page/水素原子.md "wikilink")のように[中心力](../Page/中心力.md "wikilink")だけを考えればよいモデルでは、固有値*ε<sub>n</sub>*（電子に許されるエネルギー）は主量子数 *n* だけの関数になり、次のようにとびとびの値になる。
