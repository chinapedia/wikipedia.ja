...
**Qt**（ キュート）とは、[クロスプラットフォーム](../Page/クロスプラットフォーム.md "wikilink")[アプリケーションフレームワーク](https://ja.wikipedia.org/wiki/アプリケーションフレームワーク "wikilink")である。とによって開発されている。

## 性能

キュー・ティーと発音されることもあるが公式にはキュートである。[GUIツールキットとして広く知られているQtであるが](https://ja.wikipedia.org/wiki/ウィジェット・ツールキット "wikilink")、コンソールツールやサーバのような非GUIプログラムでも広く使用されている。
...
#### Qt Essentials
  ...
  - Qt Core
    [GUI向け以外のコアとなる](https://ja.wikipedia.org/wiki/グラフィカルユーザインタフェース "wikilink")[クラス](https://ja.wikipedia.org/wiki/クラス "wikilink")を保持する。
  - Qt Gui
...
#### Qt Add-Ons
  ...
  - Qt Bluetooth
    [Bluetooth](https://ja.wikipedia.org/wiki/Bluetooth "wikilink")ハードウェアへのアクセスを提供する。
  - Qt Canvas 3D
  ...
  - Qt Gamepad
    Qtアプリケーションの[ゲームパッド](https://ja.wikipedia.org/wiki/ゲームパッド "wikilink")ハードウェアのサポートを可能にする。
...
Qt/UNIX上では[GCC](../Page/GNUコンパイラコレクション.md "wikilink")、Qt/Windowsでは[Microsoft Visual Studio上のコンパイラが使える他](https://ja.wikipedia.org/wiki/Microsoft_Visual_Studio "wikilink")、[MinGW](https://ja.wikipedia.org/wiki/MinGW "wikilink")等のコンパイラでの開発も可能である。
...
2009年3月にLGPLが適用となるバージョン4.5が発表された。これはTrolltech社がNOKIA社に買収されたことにともなうもので、組み込み実績の多いQtを[プロプライエタリなソフトウェアでもより使用しやすくするためである](../Page/プロプライエタリ・ソフトウェア.md "wikilink")。バージョン4.5においても、Qtの商用ライセンスは存続し、LGPLですら許容できない（[リバースエンジニアリング](https://ja.wikipedia.org/wiki/リバースエンジニアリング "wikilink")禁止条項を含むなど）場合は商用ライセンスを使用する必要がある。
...
## Qtを使用している主なソフトウェア
  ...
  - [Muse](https://ja.wikipedia.org/wiki/Muse "wikilink") - シーケンサ
  - [MuseScore](https://ja.wikipedia.org/wiki/MuseScore_\(楽譜作成ソフト\) "wikilink") - [楽譜作成ソフトウェア](../Page/楽譜作成ソフトウェア.md "wikilink")
  - [Nuke](https://ja.wikipedia.org/wiki/Nuke "wikilink") - [デジタル合成](https://ja.wikipedia.org/wiki/デジタル合成 "wikilink")ソフト
  ...
  - [Rosegarden](../Page/Rosegarden.md "wikilink") - [DAWソフトウェア](https://ja.wikipedia.org/wiki/デジタル・オーディオ・ワークステーション "wikilink")
  - [Skype](https://ja.wikipedia.org/wiki/Skype "wikilink") - コミュニケーションソフト
  - [モバイルWnn](https://ja.wikipedia.org/wiki/Wnn "wikilink") - [日本語入力](https://ja.wikipedia.org/wiki/日本語入力 "wikilink")システム
