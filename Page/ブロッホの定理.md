...
[量子力学](https://ja.wikipedia.org/wiki/量子力学 "wikilink")や[物性物理学](../Page/物性物理学.md "wikilink")における**ブロッホの定理**（ブロッホのていり、）とは、[ハミルトニアン](https://ja.wikipedia.org/wiki/ハミルトニアン "wikilink")が空間的な周期性（[並進対称性](https://ja.wikipedia.org/wiki/並進対称性 "wikilink")）をもつ場合に、その[固有関数](https://ja.wikipedia.org/wiki/固有関数 "wikilink")が満たす性質を表した定理のこと。[1928年](../Page/1928年.md "wikilink")に、[フェリックス・ブロッホ](https://ja.wikipedia.org/wiki/フェリックス・ブロッホ "wikilink")によって導出された。
...
[周期ポテンシャル](https://ja.wikipedia.org/wiki/周期関数 "wikilink")\(V(\boldsymbol{r}) = V(\boldsymbol{r}+\boldsymbol{R})\) 中の一電子の[量子力学](https://ja.wikipedia.org/wiki/量子力学 "wikilink")的な[ハミルトニアン](https://ja.wikipedia.org/wiki/ハミルトニアン "wikilink")演算子を\(\hat{H}\)とする。すなわち、

\[\hat{H}=-\frac{\hbar^2}{2m}\nabla^2+V(\boldsymbol{r})\] このとき、格子が3方向に基本格子ベクトル\(\boldsymbol{a}_1\), \(\boldsymbol{a}_2\), \(\boldsymbol{a}_3\)を持ち、格子ベクトル\(\boldsymbol{R}\) を

\[\boldsymbol{R}=n_1\boldsymbol{a}_1+n_2\boldsymbol{a}_2+n_3\boldsymbol{a}_3\] （\(n_1\), \(n_2\), \(n_3\)：整数） とすると、\(\hat{H}\) の[固有関数](https://ja.wikipedia.org/wiki/固有関数 "wikilink")として次のような形の関数を選ぶことができる。
...
簡単のため1次元で考える。原子間の距離\(a\) で規則正しく並んだ1次元の結晶を考えると、結晶中の電子が感じる[ポテンシャル](https://ja.wikipedia.org/wiki/ポテンシャル "wikilink")は次のような周期性を持つ。

\[\dotsb = V(x-2a) = V(x-a) = V(x) = V(x+a) = V(x+2a) = \dotsb\] 結晶中の電子を表す[ハミルトニアン](https://ja.wikipedia.org/wiki/ハミルトニアン "wikilink")は、次のように位置に依存する演算子である。
...
結晶中に多数ある電子を考えるときに１電子の波動関数を用いる有効性については、[密度汎関数理論](https://ja.wikipedia.org/wiki/密度汎関数理論 "wikilink")によって保障されている。
