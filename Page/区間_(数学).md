...
と  を含めた  と  の間にある実数全体の成す区間はしばしば  と書かれる。この二数は、この区間の**端点** (*endpoints*) と言う。[小数点](https://ja.wikipedia.org/wiki/小数点 "wikilink")にコンマを用いる国や桁の区切りにコンマを用いるような場合などでは、紛れの無いように区間の端点の区切りに[セミコロン](../Page/セミコロン.md "wikilink")を用いることもある。

区間の端点のそれぞれがその集合に含まれないことを指し示すために、対応する方の角括弧を丸括弧に変えたり逆向けにしたりする記法が用いられる。両記法とも[国際規格](../Page/国際規格.md "wikilink")[ISO 31-11にも記載がある](https://ja.wikipedia.org/wiki/ISO_31-11 "wikilink")。で書けば
...
のとき、これは各辺が座標軸に平行な[矩形](https://ja.wikipedia.org/wiki/矩形 "wikilink")領域（各区間の長さが等しければ[正方形](../Page/正方形.md "wikilink")領域）として見ることができ、同様に  のとき、軸に平行な[直方体](https://ja.wikipedia.org/wiki/直方体 "wikilink")領域（同様に[立方体](https://ja.wikipedia.org/wiki/立方体 "wikilink")領域）となる。高次元の場合にも、 個の区間の直積は有界な -次元[超立方体](../Page/超立方体.md "wikilink")またはである。
