...
全作詞:[新藤晴一](https://ja.wikipedia.org/wiki/新藤晴一 "wikilink")／全編曲：[ak.homma](../Page/本間昭光.md "wikilink")、ポルノグラフィティ（一部除く）

1.  **Mugen** (4:14)
      - 作曲:ak.homma
    <!-- end list -->
      -
        タイトルの「Mugen」は「無限」と「夢幻」の2つの意味をもち、両単語は歌詞の中に使われている\[1\]。
        カタカナ表記の「ムゲン」という案があったが、[アルファベット](https://ja.wikipedia.org/wiki/アルファベット "wikilink")表記のシングルがなかったので、アルファベットになったという逸話がある。
...
## タイアップ
  ...
  - 2002 FIFAワールドカップ NHK放送イメージソング（\#2）

## 収録アルバム

  - 『[WORLDILLIA](../Page/WORLDILLIA.md "wikilink")』（\#1,2）
  - 『[PORNO GRAFFITTI BEST RED'S](../Page/PORNO_GRAFFITTI_BEST_RED'S.md "wikilink")』（\#1,2）
