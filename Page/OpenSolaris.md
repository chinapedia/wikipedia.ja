> この記事は[OpenSolaris](https://ja.wikipedia.org/wiki/OpenSolaris)から翻訳されています。
...
` | latest_release_date = 2009年6月1日`
` | source_model = `[`オープンソース`](../Page/オープンソース.md "wikilink")
` | working_state = 開発終了、`[`Illumos`](https://ja.wikipedia.org/wiki/Illumos "wikilink")が後継
` | kernel_type = `[`モノリシックカーネル`](../Page/モノリシックカーネル.md "wikilink")
` | ui = `[`Java``   ``Desktop``   ``System`](../Page/Java_Desktop_System.md "wikilink")
` | license =  `[`CDDL`](../Page/Common_Development_and_Distribution_License.md "wikilink")
...
OpenIndianaは[オラクルの支援は得ていない](../Page/オラクル_\(企業\).md "wikilink")。これは[Red Hat Enterprise Linuxと](../Page/Red_Hat_Enterprise_Linux.md "wikilink")[CentOS](../Page/CentOS.md "wikilink")の関係と相似する（OpenIndiana自身のFAQでもそう述べている）。同プロジェクトいわく、"Fork"ではなく"Spork"（[先割れスプーン](../Page/先割れスプーン.md "wikilink")）とのことである。
...
### 年表
  ...
  - [2010年](https://ja.wikipedia.org/wiki/2010年 "wikilink")[4月16日](../Page/4月16日.md "wikilink")、[オラクルより](../Page/オラクル_\(企業\).md "wikilink")、CD配布プログラムが廃止され、以降はダウンロードのみになる\[4\]。
  ...
  - 2010年9月14日、OpenSolarisの後継となり、Solaris互換のフリーなOSを開発することを目的とする[OpenIndiana](https://ja.wikipedia.org/wiki/OpenIndiana "wikilink")プロジェクトの設立が発表された\[8\]。

## ライセンス

[OSI承認の](../Page/Open_Source_Initiative.md "wikilink")[CDDL](../Page/Common_Development_and_Distribution_License.md "wikilink")(Common Development and Distribution License)を用いている。これはサン・マイクロシステムズが特許訴訟対策を考慮して[MPL](../Page/Mozilla_Public_License.md "wikilink")(Mozilla Public License)を修正した[オープンソース](../Page/オープンソース.md "wikilink")ライセンスである。
...
## 外部リンク
  ...
  - [OpenSolaris公式サイト](http://www.opensolaris.org/)
  - [OpenSolaris Project: 日本ポータル](http://jp.opensolaris.org/)
  - [OpenSolaris – 概要 - サン・マイクロシステムズ](http://jp.sun.com/practice/software/solaris/opensolaris/index.jsp)

[Category:Unix系オペレーティングシステム](https://ja.wikipedia.org/wiki/Category:Unix系オペレーティングシステム "wikilink") [Category:サン・マイクロシステムズ](https://ja.wikipedia.org/wiki/Category:サン・マイクロシステムズ "wikilink") [Category:フリーソフトウェアOS](https://ja.wikipedia.org/wiki/Category:フリーソフトウェアOS "wikilink") [Category:2008年のソフトウェア](https://ja.wikipedia.org/wiki/Category:2008年のソフトウェア "wikilink")

1.  [Press Release - OpenIndiana - OpenIndiana Wiki](http://wiki.openindiana.org:8080/display/oi/Press+Release)
2.  [サン・マイクロシステムズ、ファイルシステム「ZFS」のソースコードを公開](http://japan.cnet.com/news/ent/story/0,2000056022,20091173,00.htm)
3.  [サン、Solarisのオープンソース版「OpenSolaris 2008.05」を正式リリース](http://www.computerworld.jp/topics/osst/107109.html)
4.  [Oracle、OpenSolaris CD配布プログラムを廃止](https://news.mynavi.jp/news/2010/04/16/045/index.html)
5.  [【中国ＯＳＳ】ＯｐｅｎＳｏｌａｒｉｓ、Ｏｒａｃｌｅと分裂か](http://news.searchina.ne.jp/disp.cgi?y=2010&d=0419&f=it_0419_003.shtml)
6.  [2010 08 23 OGB Agenda](http://wiki.genunix.org:8080/wiki/index.php/2010_08_23_OGB_Agenda)
7.  [Motion concerning dissolution of the OGB](http://mail.opensolaris.org/pipermail/ogb-discuss/2010-August/008012.html)
8.