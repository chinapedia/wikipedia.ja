...
なお、次世代機である[Wii UはWiiConnect](https://ja.wikipedia.org/wiki/Wii_U "wikilink")24には対応していない。
...
新しいWiiチャンネルや[本体アップデートの配信開始日には](https://ja.wikipedia.org/wiki/Wiiのシステムアップデート "wikilink")、任天堂からお知らせメッセージが配信される。

## データの送受信

### ゲームソフトとの連動

ゲーム内で作成したデータを他のWiiユーザーとやり取りすることができる。

マリオカートWiiでは、フレンドとのゴースト送受信などをすることができる
