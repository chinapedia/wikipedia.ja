...
**アーキテクチャ記述言語**（Architecture Description Language、**ADL**）とは、[ソフトウェアアーキテクチャ](https://ja.wikipedia.org/wiki/ソフトウェアアーキテクチャ "wikilink")や[システムアーキテクチャ](https://ja.wikipedia.org/wiki/システムアーキテクチャ "wikilink")を記述するための[コンピュータ言語](https://ja.wikipedia.org/wiki/コンピュータ言語 "wikilink")または概念モデルである。[ソフトウェア開発者](https://ja.wikipedia.org/wiki/ソフトウェア開発者 "wikilink")がアーキテクチャについてやり取りする場合や、開発者と発注元との認識あわせに使う。また[エンタープライズモデリング](https://ja.wikipedia.org/wiki/エンタープライズモデリング "wikilink")でも使われる。

[ソフトウェア工学](../Page/ソフトウェア工学.md "wikilink")分野では、Acme（[CMUが開発](https://ja.wikipedia.org/wiki/カーネギーメロン大学 "wikilink")）、[AADL](https://ja.wikipedia.org/wiki/:en:Architecture_Analysis_and_Design_Language "wikilink")（[SAEが標準化](https://ja.wikipedia.org/wiki/SAE_International "wikilink")）、C2（[UCIが開発](https://ja.wikipedia.org/wiki/カリフォルニア大学アーバイン校 "wikilink")）、[Darwin](https://ja.wikipedia.org/wiki/:en:Darwin_\(ADL\) "wikilink")（[インペリアル・カレッジ・ロンドン](https://ja.wikipedia.org/wiki/インペリアル・カレッジ・ロンドン "wikilink")が開発）、[Wright](https://ja.wikipedia.org/wiki/:en:Wright_\(ADL\) "wikilink")（CMUが開発）などがある。
...
事業体モデリングの分野では企業レベルのアーキテクチャ記述言語が開発されている。例えば、[ArchiMate](https://ja.wikipedia.org/wiki/:en:ArchiMate "wikilink")（[The Open Group](https://ja.wikipedia.org/wiki/The_Open_Group "wikilink")）、DEMO、ABACUS（[シドニー工科大学](https://ja.wikipedia.org/wiki/シドニー工科大学 "wikilink")が開発）などがある。これらは必ずしもソフトウェアコンポーネントなどを記述しないが、アプリケーションのアーキテクチャをソフトウェア技術者に伝えるのに使われる。
...
## 具体例
  ...
  - [ABACUS](http://www.avolution.com.au) ([UTS](https://ja.wikipedia.org/wiki/シドニー工科大学 "wikilink"))
  - [Aesop (CMU)](http://www.cs.cmu.edu/afs/cs/project/able/www/aesop/aesop_home.html)
  - [AADL](http://www.aadl.info/) ([SAE](https://ja.wikipedia.org/wiki/SAE_International "wikilink"))
  - [C2 SADL](http://www.ics.uci.edu/pub/arch/) ([UCI](https://ja.wikipedia.org/wiki/カリフォルニア大学アーバイン校 "wikilink"))
