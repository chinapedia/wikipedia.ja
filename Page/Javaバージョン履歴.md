...
[Javaプラットフォーム](../Page/Javaプラットフォーム.md "wikilink")は1996年1月の初リリース以来、これまでに14回のメジャーバージョン改訂を行っている。Javaプラットフォームは[Java言語](https://ja.wikipedia.org/wiki/プログラミング言語Java "wikilink")、[実行環境](https://ja.wikipedia.org/wiki/Java実行環境 "wikilink")、[開発環境](../Page/Java_Development_Kit.md "wikilink")、その他テクノロジの総称である。本稿ではJavaプラットフォームの基軸である[スタンダード版のバージョン履歴を説明する](../Page/Java_Platform,_Standard_Edition.md "wikilink")。その他にも[エンタープライズ版](../Page/Java_Platform,_Enterprise_Edition.md "wikilink")、[マイクロ版](../Page/Java_Platform,_Micro_Edition.md "wikilink")、[カード版といった周辺エディションが存在し](../Page/Java_Card.md "wikilink")、それぞれが個別にメジャーバージョン改訂を行っているが、いずれもスタンダード版改訂を基準にしてそれに後発する時系列でリリースされている。

## バージョン一覧

#### JDK 1.0 (1996年1月23日)

Javaプラットフォームの初回バージョンは「Java Development Kit」通称「JDK」とネーミングされ、通称とバージョン値を合わせたものが製品名にされた。当初のメジャーバージョン値は小数点第一位だった。まだ国際化対応はされず英語版のみだった\[1\]。
...
大幅な技術刷新により「Java 2」ブランドに改められた。製品仕様の確立で「Platform」に改められた。エディションの分化で「Standard」が付加された。こうして「Java 2 Platform, Standard Edition」の通称「J2SE」が製品名になった。ここからコードネームが付けられるようになった\[3\]。翌年にEnterprise版「J2EE 1.2」とMicro版「J2ME 1.2」もリリースされた。
...
「Java 2」が「Java」に戻されて通称が「J2SE」から「Java SE」になった。バージョン値から小数点以下が外された。なおマイナーバージョン更新では再び小数点以下が付けられた。他エディションも「Java EE 5」「Java ME 5」になった。仮想マシンを含めた既存機能の改善と洗練に力が注がれた。
...
ここからメジャーバージョンは一定の新機能蓄積を待たずに公開する毎年3月と9月の年2回定期リリース制に変更された\[13\]。従来の長期サポート（LTS）が無くなり半年間限定になった。
...
JSR 383にて仕様規定\[14\]。ここから追加機能の大半は規範テクノロジ相当のJSR（仕様要求）ではなく、拡張テクノロジ相当のJEP（改良提案）になった。
