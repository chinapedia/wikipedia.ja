...
開始当初の対応機種はPC及びMacのみ。スマートフォン向けのアプリの供給が予定されている。配信楽曲を聴くにはmora qualitasアプリをインストールする必要がある。
...
2020年1月現在、対応機種はPC及びMacのみ。専用アプリのインストールが必須。

  - 配信フォーマット
    [FLAC](../Page/FLAC.md "wikilink") 44.1～192kHz/24bitでのストリーミング配信。一部のアーティスト楽曲は[AAC](../Page/AAC.md "wikilink")-LC 320kbpsでのストリーミング配信。
