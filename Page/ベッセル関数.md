...
**ベッセル関数**（ベッセルかんすう、）とは、最初に[スイス](../Page/スイス.md "wikilink")の数学者[ダニエル・ベルヌーイ](../Page/ダニエル・ベルヌーイ.md "wikilink")によって定義され、[フリードリヒ・ヴィルヘルム・ベッセル](https://ja.wikipedia.org/wiki/フリードリヒ・ヴィルヘルム・ベッセル "wikilink")にちなんで名づけられた[関数](../Page/関数_\(数学\).md "wikilink")。円筒関数と呼ばれることもある。以下に示す、ベッセルの[微分方程式](../Page/微分方程式.md "wikilink")における\(y(x)\)の[特殊解](https://ja.wikipedia.org/wiki/特殊解 "wikilink")の1つである。
...
ベッセル解は、[ラプラス方程式](../Page/ラプラス方程式.md "wikilink")または、[ヘルムホルツ方程式](../Page/ヘルムホルツ方程式.md "wikilink")の、円柱座標系または極座標系における分離解として見出される。したがって、ベッセル関数は、[電波伝播](https://ja.wikipedia.org/wiki/電波伝播 "wikilink")や[静電位差](https://ja.wikipedia.org/wiki/静電位差 "wikilink")などの解を求めるときに重要なものとなっている。（円柱座標系においては、整数次数\(\alpha=n\)のベッセル関数が解として得られる。極座標系においては、半整数次数\(\alpha=n+1/2\)のベッセル関数が解として得られる。）
例えば、
