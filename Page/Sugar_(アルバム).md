...
2.  **[Over Drive](https://ja.wikipedia.org/wiki/本日、未熟者/Over_Drive "wikilink")**
      -
...
4.  **[ひかりのまち](https://ja.wikipedia.org/wiki/ひかりのまち/ラン・フリー\(スワン・ダンスを君と\) "wikilink")**
      -
...
1.  **青春 SEI SYuN** 〜感動〜
    ...
    <!-- end list -->
      -
        ドラマ「歌姫」の劇中に使用され、[ストリングス](https://ja.wikipedia.org/wiki/ストリングス "wikilink")をメインとした伴奏である。
2.  **青春 SEI SYuN** 〜Action〜
    ...
    <!-- end list -->
      -
        同じくドラマ「歌姫」の劇中で使用され、基本的にオリジナルバージョンと同じ伴奏であるが、メロディーラインが[エレキギターの伴奏になり](https://ja.wikipedia.org/wiki/エレクトリックギター "wikilink")、ストリングスが強調されている。
3.  **青春 SEI SYuN** 〜せつない〜
      -
        編曲：沢田完
    <!-- end list -->
...
4.  **[宙船](https://ja.wikipedia.org/wiki/宙船/do!_do!_do! "wikilink")**（そらふね）〜jumble version〜
    ...
    <!-- end list -->
      - 35thシングルの1曲目のアコースティックバージョン
    <!-- end list -->
      -
        ライブでよく演奏される[アレンジで](../Page/編曲.md "wikilink")、出だしのサビのみシングルの初回限定盤にも収録された。以降はオリジナルバージョンに近いアレンジに戻る。オリジナルと比較すると、[ブラスとストリングスがカットされた事によりバンドの演奏が前面に押しだされ](../Page/金管楽器.md "wikilink")、シンプルな印象を受ける。ラストのサビではオリジナルにないメンバー全員のコーラスが追加されている。
5.  **本日、未熟者** 〜unplugged〜
      -
        編曲：沢田完
    <!-- end list -->
      - 37thシングルの1曲目のアコースティックバージョン
    <!-- end list -->
      -
        長瀬が以前「[ミュージックステーション](https://ja.wikipedia.org/wiki/ミュージックステーション "wikilink")」にソロで出演した際にこのバージョンを演奏した。また、同番組で演奏した際には省かれた2番も収録されている。
...
1.  「**[何度も夢の中でくり返すラブ･ソング](https://ja.wikipedia.org/wiki/何度も夢の中でくり返すラブ・ソング/溢れる想い "wikilink")**」SCHOOL FESTIVAL from [TOKIO Special GIGs 2006](https://ja.wikipedia.org/wiki/TOKIO_Special_GIGs_2006_〜Get_Your_Dream〜 "wikilink")
2.  「**sugar**」Recording

[Category:2008年のアルバム](https://ja.wikipedia.org/wiki/Category:2008年のアルバム "wikilink") [Category:TOKIOのアルバム](https://ja.wikipedia.org/wiki/Category:TOKIOのアルバム "wikilink") [Category:ユニバーサルミュージックジャパンのアルバム](https://ja.wikipedia.org/wiki/Category:ユニバーサルミュージックジャパンのアルバム "wikilink")