...
ハードディスク内蔵タイプ。2019年発売の[iPod touch (第7世代)](https://ja.wikipedia.org/wiki/iPod_touch_\(第7世代\) "wikilink")256GBモデル登場まで、系列で最大の保存容量を有していた。2014年9月に販売終了。
...
全面タッチパネルによるユーザインターフェースをもち、[無線LAN](../Page/無線LAN.md "wikilink")によるウェブブラウズ、アプリケーションの追加などが可能。シリーズで唯一を採用し、に準じた仕様である。 2019年モデル[iPod touch (第7世代)はiPod史上最大のストレージである](https://ja.wikipedia.org/wiki/iPod_touch_\(第7世代\) "wikilink")256GBを有する。[Apple Storeで販売中](../Page/Apple_Store.md "wikilink")。(2020/04/29現在)
